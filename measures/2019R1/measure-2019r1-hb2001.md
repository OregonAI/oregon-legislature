...
jurisdiction: oregon
id: measure-2019r1-hb2001
title: 'HB 2001 (2019R1): Requires cities with population greater than 10,000 or within Metro to allow
  duplexes in lands zoned for single-family dwellings within urban growth boundary.'
doc_type: dataset_doc
citation: 2019 Regular Session House Bill 2001
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2019R1/Downloads/MeasureDocument/HB2001/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 861784653678ec9c0f5f256283b9bbf9972b9c234710e1716e9f62f300e3641c
snapshot_id: measure-2019r1-hb2001-enrolled
status: current
...
catch_line: Requires cities with population greater than 10,000 or within Metro to allow duplexes in lands
  zoned for single-family dwellings within urban growth boundary.
minority_catch_line: null
measure_summary: "\tRequires cities with population greater than 10,000 <b>or within Metro</b> to allow\
  \ duplexes in lands zoned for single-family dwellings within urban growth boundary. Requires Metro counties\
  \ and cities and cities with population greater than 25,000 to allow middle housing in lands zoned for\
  \ residential uses within urban growth boundary. Requires Land Conservation and Development Commission\
  \ to draft model ordinances. Requires cities and counties to amend their comprehensive plan and land\
  \ use regulations to conform with requirements or to directly apply model ordinance developed by commission.\
  \ \n\tAppropriates moneys to Department of Land Conservation and Development to provide technical assistance\
  \ to local governments in implementing middle housing regulations and to plan improvement of urban services\
  \ supporting middle housing. \n\tRequires local governments to support density expectations with findings\
  \ when updating regulations to accommodate housing need. \n\tRequires cities to include number of permits\
  \ issued and units produced of accessory dwelling units and middle housing in report to Department of\
  \ Land Conservation and Development. \n\tRequires Department of Consumer and Business Services to establish\
  \ alternate approval standards for low-rise middle housing conversions. Requires department to report\
  \ on rules and standards to an interim committee of the Legislative Assembly by January 1, 2020. \n\t\
  Prohibits enforcement of new restrictions that would prohibit the construction of middle housing in\
  \ governing documents for planned communities or instruments \t<i>conveying</i>]<b> affecting</b> title\
  \ to real property. \n\tProhibits conditioning approval of accessory dwelling unit within urban growth\
  \ boundary on off-street parking availability or owner occupancy. \n\tDeclares emergency, effective\
  \ on passage."
...
lc_number: 2887
measure_created_date: '2018-12-21T10:10:42'
measure_modified_date: '2020-12-08T13:22:55'
...
# HB 2001 — 2019 Regular Session (2019R1)

## At a glance

- **Measure:** House Bill 2001, 2019 Regular Session (2019R1)
- **LC number:** 2887
- **Created:** 2018-12-21T10:10:42
- **Metadata last modified (upstream):** 2020-12-08T13:22:55
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 38819 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2019R1/Downloads/MeasureDocument/HB2001/Enrolled>.

## Summary

**Catchline:** Requires cities with population greater than 10,000 or within Metro to allow duplexes in lands zoned for single-family dwellings within urban growth boundary.
...
Requires cities with population greater than 10,000 <b>or within Metro</b> to allow duplexes in lands zoned for single-family dwellings within urban growth boundary. Requires Metro counties and cities and cities with population greater than 25,000 to allow middle housing in lands zoned for residential uses within urban growth boundary. Requires Land Conservation and Development Commission to draft model ordinances. Requires cities and counties to amend their comprehensive plan and land use regulations to conform with requirements or to directly apply model ordinance developed by commission. 
 ...
 Requires local governments to support density expectations with findings when updating regulations to accommodate housing need. 
 ...
 Requires Department of Consumer and Business Services to establish alternate approval standards for low-rise middle housing conversions. Requires department to report on rules and standards to an interim committee of the Legislative Assembly by January 1, 2020. 
 Prohibits enforcement of new restrictions that would prohibit the construction of middle housing in governing documents for planned communities or instruments  <i>conveying</i>]<b> affecting</b> title to real property. 
 Prohibits conditioning approval of accessory dwelling unit within urban growth boundary on off-street parking availability or owner occupancy. 
...
SECTION 4.
(1) Notwithstanding section 3 (1) or (3) of this 2019 Act, the Department  of
...
dation must  demonstrate that the assumed housing capacity has been achieved in areas that
...
SECTION 14.
(1) Sections 2, 12 and 13 of this 2019 Act and the amendments to ORS
...
- From bill text (Enrolled version): ORS 192.245, ORS 195.033, ORS 195.065, ORS 197.295, ORS 197.296, ORS 197.303, ORS 197.312, ORS 197.475, ORS 197.522, ORS 197.628, ORS 197.646, ORS 197.732, ORS 227.175, ORS 307.515, ORS 308.450, ORS 320.192, ORS 320.195, ORS 447.020, ORS 447.145, ORS 455.030, ORS 455.035, ORS 455.110, ORS 455.112, ORS 455.148, ORS 455.210, ORS 455.610, ORS 455.690, ORS 90.100, ORS 94.550

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `861784653678ec9c0f5f256283b9bbf9972b9c234710e1716e9f62f300e3641c` (snapshot `_meta/snapshots/measure-2019r1-hb2001-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2019R1/Downloads/MeasureDocument/HB2001/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `ba9f40f75605a163ee34a803c74ba5600cdf6f79f13d6905f6ca41d15e7625b0` (snapshot `_meta/snapshots/measure-2019r1-hb2001-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2019R1/Downloads/MeasureDocument/HB2001/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2019R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2001` (part of the batched per-session fetch), sha256 `ae6df4298c0af5cc5dddaadd86050dfbe3c0b9a75f4a0da8096eff6dafa219d2` of the shared session snapshot `_meta/snapshots/measures-2019r1.json`.

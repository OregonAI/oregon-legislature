...
jurisdiction: oregon
id: measure-2019r1-sb611
title: 'SB 611 (2019R1): Declares policy of state to use zero-based budgeting in developing biennial budget
  plan.'
doc_type: dataset_doc
citation: 2019 Regular Session Senate Bill 611
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2019R1/Downloads/MeasureDocument/SB611/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e3b24a4d0aa09dc09bc677f4575f1bb044cb9a6cc4098232cd2adf44c158f68c
snapshot_id: measure-2019r1-sb611-introduced
status: current
...
# SB 611 — 2019 Regular Session (2019R1)

## At a glance

- **Measure:** Senate Bill 611, 2019 Regular Session (2019R1)
- **LC number:** 2220
- **Created:** 2019-01-02T10:41:04
- **Metadata last modified (upstream):** 2020-06-26T19:41:22
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 2791 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2019R1/Downloads/MeasureDocument/SB611/Introduced>.
...
Declares policy of state to use zero-based budgeting in developing biennial budget plan. 
 ...
 Applies to biennia beginning on or after July 1, 2021.
...
SECTION 1.
Section 2 of this  2019 Act is added to and made a part of ORS 291.201 to
291.222.
...
SECTION 3.
Section 2 of this 2019 Act applies  to agency request budgets prepared for
biennia beginning on or after July 1, 2021.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `e3b24a4d0aa09dc09bc677f4575f1bb044cb9a6cc4098232cd2adf44c158f68c` (snapshot `_meta/snapshots/measure-2019r1-sb611-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2019R1/Downloads/MeasureDocument/SB611/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2019R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 611` (part of the batched per-session fetch), sha256 `ae6df4298c0af5cc5dddaadd86050dfbe3c0b9a75f4a0da8096eff6dafa219d2` of the shared session snapshot `_meta/snapshots/measures-2019r1.json`.

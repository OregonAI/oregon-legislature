...
jurisdiction: oregon
id: measure-2024r1-hb4117
title: 'HB 4117 (2024R1): Authorizes the Oregon Government Ethics Commission to issue advisory opinions
  on the application of the public meetings law to actual or hypothetical circumstances.'
doc_type: dataset_doc
citation: 2024 Regular Session House Bill 4117
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/HB4117/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 2a764a68bdd83cbbd95b05c354ed973fbc9901ea223fa91ec57a5993ddf7a587
snapshot_id: measure-2024r1-hb4117-enrolled
status: current
...
catch_line: Authorizes the Oregon Government Ethics Commission to issue advisory opinions on the application
  of the public meetings law to actual or hypothetical circumstances.
minority_catch_line: null
measure_summary: "\tDigest: Allows OGEC and OGEC staff to give advice on the public meetings law. (Flesch\
  \ Readability Score: 69.9). \n\tAuthorizes the Oregon Government Ethics Commission to issue advisory\
  \ opinions on the application of the public meetings law to actual or hypothetical circumstances. Authorizes\
  \ the executive director of the commission to issue staff advisory opinions or written or oral staff\
  \ advice on the application of the public meetings law to actual or hypothetical circumstances. Permits\
  \ other commission staff to issue written or oral staff advice on the public meetings law. \n\tDeclares\
  \ an emergency, effective on passage."
relating_to: Relating to public meetings; and declaring an emergency.
relating_to_full: Relating to public meetings; and declaring an emergency.
at_the_request_of: null
lc_number: 145
measure_created_date: '2024-01-14T10:11:17'
...
# HB 4117 — 2024 Regular Session (2024R1)

## At a glance

- **Measure:** House Bill 4117, 2024 Regular Session (2024R1)
- **LC number:** 145
- **Created:** 2024-01-14T10:11:17
- **Metadata last modified (upstream):** 2024-03-25T11:00:23
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 14774 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/HB4117/Enrolled>.

## Summary

**Catchline:** Authorizes the Oregon Government Ethics Commission to issue advisory opinions on the application of the public meetings law to actual or hypothetical circumstances.

**Relating to:** Relating to public meetings; and declaring an emergency.

Digest: Allows OGEC and OGEC staff to give advice on the public meetings law. (Flesch Readability Score: 69.9). 
 Authorizes the Oregon Government Ethics Commission to issue advisory opinions on the application of the public meetings law to actual or hypothetical circumstances. Authorizes the executive director of the commission to issue staff advisory opinions or written or oral staff advice on the application of the public meetings law to actual or hypothetical circumstances. Permits other commission staff to issue written or oral staff advice on the public meetings law. 
 Declares an emergency, effective on passage.

**RelatingToFull (verbatim upstream field):** Relating to public meetings; and declaring an emergency.
...
The commission may impose a penalty under ORS 244.350 or 244.360 on  the person who requested
...
- From bill text (Enrolled version): ORS 192.610, ORS 192.640, ORS 192.650, ORS 192.660, ORS 192.672, ORS 244.280, ORS 244.282, ORS 244.284, ORS 244.290, ORS 244.350, ORS 332.061, ORS 441.015, ORS 453.005, ORS 671.338, ORS 676.175

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `2a764a68bdd83cbbd95b05c354ed973fbc9901ea223fa91ec57a5993ddf7a587` (snapshot `_meta/snapshots/measure-2024r1-hb4117-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/HB4117/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `708888a6dfa376ee2a84bf1660ee84712fa8af1b842a09aa56a68a339ab48387` (snapshot `_meta/snapshots/measure-2024r1-hb4117-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/HB4117/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2024R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 4117` (part of the batched per-session fetch), sha256 `1183bfeb8d41d57221d38a5a407738949976c2ace30f86900a3204ea31696ad5` of the shared session snapshot `_meta/snapshots/measures-2024r1.json`.

...
jurisdiction: oregon
id: measure-2024r1-sb1541
title: 'SB 1541 (2024R1): Creates new circuit court judge positions in certain judicial districts.'
doc_type: dataset_doc
citation: 2024 Regular Session Senate Bill 1541
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/SB1541/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 31fc884aea9288920eb777b56e1201dee5051db47a949d382e353a9dd30f51a0
snapshot_id: measure-2024r1-sb1541-enrolled
status: current
...
catch_line: Creates new circuit court judge positions in certain judicial districts.
minority_catch_line: null
measure_summary: "\tDigest: The Act adds new circuit court judges. Two of the judges start on July 1,\
  \ 2024, and one judge starts on July 1, 2025. (Flesch Readability Score: 67.7). \n\tCreates new circuit\
  \ court judge positions in certain judicial districts. \n\tTakes effect July 1, 2024."
relating_to: Relating to judicial positions; prescribing an effective date.
relating_to_full: Relating to judicial positions; creating new provisions; amending ORS 3.012; and prescribing
  an effective date.
at_the_request_of: (at the request of Chief Justice Meagan A. Flynn for Judicial Department)
lc_number: 211
measure_created_date: '2024-01-12T13:34:50'
...
# SB 1541 — 2024 Regular Session (2024R1)

## At a glance

- **Measure:** Senate Bill 1541, 2024 Regular Session (2024R1)
- **At the request of:** (at the request of Chief Justice Meagan A. Flynn for Judicial Department)
- **LC number:** 211
- **Created:** 2024-01-12T13:34:50
- **Metadata last modified (upstream):** 2024-03-28T12:50:20
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 8277 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/SB1541/Enrolled>.

## Summary

**Catchline:** Creates new circuit court judge positions in certain judicial districts.

**Relating to:** Relating to judicial positions; prescribing an effective date.
...
**RelatingToFull (verbatim upstream field):** Relating to judicial positions; creating new provisions; amending ORS 3.012; and prescribing an effective date.
...
CHAPTER .................................................
AN ACT
Relating to  judicial positions; creating new provisions; amending ORS 3.012; and prescribing an ef-
fective  date.
...
(a) The first judicial district consists of Jackson County and has [ 10] 11 judges.
...
(t) The twentieth judicial district consists of Washington County and has [ 15] 16 judges.
...
Enrolled Senate Bill 1541 (SB 1541-A) Page 1
...
SECTION 2.
 ORS 3.012, as amended by section 1 of this 2024 Act, is amended to read:
3.012. (1) The  judicial districts, the counties constituting the judicial districts and the number
of circuit court judges for each judicial district are as follows:
...
established by ORS 3.041.
SECTION 3.
The amendments to ORS  3.012 by section 2 of this 2024 Act become operative
on July 1, 2025.
...
biennium ending June 30, 2025, for judicial compensation,  is increased by $579,865, for the
purpose of carrying out the amendments to ORS 3.012 by sections 1 and 2 of this 2024 Act.
Enrolled Senate Bill 1541 (SB 1541-A) Page 2
...
biennium ending June 30, 2025,  for operations, is increased by $1,331,184, for the purpose of
carrying out the amendments to ORS 3.012 by sections 1 and 2 of this 2024 Act.
SECTION 6. This 2024 Act takes effect on July 1, 2024.
...
Enrolled Senate Bill 1541 (SB 1541-A) Page 3
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `31fc884aea9288920eb777b56e1201dee5051db47a949d382e353a9dd30f51a0` (snapshot `_meta/snapshots/measure-2024r1-sb1541-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/SB1541/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `a67263bce1cd26908c225aa6c1eb036a75f6079311aad2bbb484b1e882122581` (snapshot `_meta/snapshots/measure-2024r1-sb1541-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/SB1541/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2024R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1541` (part of the batched per-session fetch), sha256 `1183bfeb8d41d57221d38a5a407738949976c2ace30f86900a3204ea31696ad5` of the shared session snapshot `_meta/snapshots/measures-2024r1.json`.

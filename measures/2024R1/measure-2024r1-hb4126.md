...
jurisdiction: oregon
id: measure-2024r1-hb4126
title: 'HB 4126 (2024R1): Repeals the prohibition on local rent control.'
doc_type: dataset_doc
citation: 2024 Regular Session House Bill 4126
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/HB4126/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 8e23a86c012c0dc4d22a58b5685515b6d127a35cbe0c79f7e6adc54c4fb9f2ae
snapshot_id: measure-2024r1-hb4126-introduced
status: current
...
measure_summary: "\tDigest: Allows cities and counties to impose rent control. The Act goes into effect\
  \ when the Governor signs it. (Flesch Readability Score: 70.8). \n\tRepeals the prohibition on local\
  \ rent control. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to local rent control; declaring an emergency.
relating_to_full: Relating to local rent control; amending ORS 197A.465 and section 9, chapter 552, Oregon
  Laws 2021; repealing ORS 91.225; and declaring an emergency.
at_the_request_of: null
lc_number: 178
measure_created_date: '2024-01-14T11:09:50'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2024R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 4126>.

# HB 4126 — 2024 Regular Session (2024R1)

## At a glance

- **Measure:** House Bill 4126, 2024 Regular Session (2024R1)
- **LC number:** 178
- **Created:** 2024-01-14T11:09:50
- **Metadata last modified (upstream):** 2024-02-05T12:19:15
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 16062 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/HB4126/Introduced>.

## Summary

**Catchline:** Repeals the prohibition on local rent control.

**Relating to:** Relating to local rent control; declaring an emergency.
...
**RelatingToFull (verbatim upstream field):** Relating to local rent control; amending ORS 197A.465 and section 9, chapter 552, Oregon Laws 2021; repealing ORS 91.225; and declaring an emergency.

## Full text

82nd OREGON LEGISLATIVE ASSEMBLY--2024 Regular Session
House Bill 4126
Sponsored by Representatives CHAICHI, GAMBA; Representatives HARTMAN, PHAM K (Presession filed.)
SUMMARY
The following summary  is not prepared by the sponsors of the measure and is not a part of the body thereof subject
to consideration by  the Legislative Assembly. It is an editor’s brief statement of the essential features of the
measure as introduced. The statement includes a measure digest written in compliance with applicable readability
standards.
Digest: Allows  cities and counties to impose rent control. The Act goes into effect when the
Governor signs it. (Flesch Readability Score: 70.8).
Repeals the prohibition on local rent control.
Declares an emergency, effective on passage.
A BILL FOR AN ACT
Relating to local rent control; amending ORS  197A.465 and section 9, chapter 552, Oregon Laws
2021; repealing ORS 91.225; and declaring an emergency.
Be It Enacted by the People of the State of Oregon:
SECTION 1.
ORS 91.225 is repealed.
SECTION 2.  ORS 197A.465 is amended to read:
...
ture, or that requires a new multifamily structure to be  designated for sale or rent as affordable
housing.
...
or county, in  exchange for providing the requisite number of housing units within the multifamily
structure to be sold or rented at below-market rates.
...
dards, conditions and procedures  as provided in paragraph (a) of this subsection, a city or county
may adopt and apply an  alternative approval process for applications and permits for residential
development based on approval criteria regulating, in whole or in part, appearance  or aesthetics
...
SECTION 3.
 Section 9, chapter 552, Oregon Laws 2021, as amended by  section 104, chapter 13,
...
implement ORS [ 197.758] 197A.420 and the amendments to ORS [ 197.312] 197A.395 and 197A.425 by
section 7, chapter 639, Oregon Laws 2019.
...
- From `RelatingToFull`: ORS 197A.465, ORS 91.225
- From bill text (Introduced version): ORS 101.020, ORS 195.065, ORS 197.250, ORS 197.296, ORS 197A.465, ORS 215.402, ORS 215.416, ORS 215.427, ORS 326.695, ORS 332.002, ORS 334.003, ORS 456.270, ORS 91.225

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `8e23a86c012c0dc4d22a58b5685515b6d127a35cbe0c79f7e6adc54c4fb9f2ae` (snapshot `_meta/snapshots/measure-2024r1-hb4126-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/HB4126/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2024R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 4126> (part of the batched per-session fetch), sha256 `1183bfeb8d41d57221d38a5a407738949976c2ace30f86900a3204ea31696ad5` of the shared session snapshot `_meta/snapshots/measures-2024r1.json`.

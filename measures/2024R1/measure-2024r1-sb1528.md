...
jurisdiction: oregon
id: measure-2024r1-sb1528
title: 'SB 1528 (2024R1): Authorizes cities and counties to adopt a program for awarding grants to developers
...
citation: 2024 Regular Session Senate Bill 1528
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/SB1528/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 55784a798950ea72c724a0edc8e2e2e3ec5c39634b70c272e4c806543e5a30da
snapshot_id: measure-2024r1-sb1528-introduced
status: current
...
lc_number: 155
measure_created_date: '2024-01-12T10:06:26'
measure_modified_date: '2024-02-26T11:32:06'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 29331
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2024R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1528`.

# SB 1528 — 2024 Regular Session (2024R1)

## At a glance

- **Measure:** Senate Bill 1528, 2024 Regular Session (2024R1)
- **At the request of:** (at the request of Senate Interim Committee on Housing and Development)
- **LC number:** 155
- **Created:** 2024-01-12T10:06:26
- **Metadata last modified (upstream):** 2024-02-26T11:32:06
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 29331 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/SB1528/Introduced>.
...
2024 Act.
SECTION 15. This 2024 Act takes effect on the 91st day after the date on which  the 2024
...
- From bill text (Introduced version): ORS 192.245, ORS 197A.420, ORS 215.501, ORS 293.250, ORS 293.701, ORS 311.395

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `55784a798950ea72c724a0edc8e2e2e3ec5c39634b70c272e4c806543e5a30da` (snapshot `_meta/snapshots/measure-2024r1-sb1528-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/SB1528/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2024R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1528` (part of the batched per-session fetch), sha256 `1183bfeb8d41d57221d38a5a407738949976c2ace30f86900a3204ea31696ad5` of the shared session snapshot `_meta/snapshots/measures-2024r1.json`.

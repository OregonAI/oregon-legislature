...
jurisdiction: oregon
id: measure-2024r1-hb4142
title: 'HB 4142 (2024R1): Provides that when a person is charged with committing a new felony sex crime
  while on pretrial release for a felony sex crime, the person is only eligible for release after a hearing
  during which the court determines whether security release may be denied, and if security release is
  allowed, the person must deposit the full security amount set by the court.'
doc_type: dataset_doc
citation: 2024 Regular Session House Bill 4142
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/HB4142/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 16900500522fc6cfd25a8a0aa62aa52a1b34906436344b8746509db4e652cb46
snapshot_id: measure-2024r1-hb4142-introduced
status: current
...
catch_line: Provides that when a person is charged with committing a new felony sex crime while on pretrial
  release for a felony sex crime, the person is only eligible for release after a hearing during which
  the court determines whether security release may be denied, and if security release is allowed, the
  person must deposit the full security amount set by the court.
minority_catch_line: null
measure_summary: "\tDigest: The Act restricts pretrial release for persons who commit a new felony sex\
  \ crime while on pretrial release for a felony sex crime. The Act goes into effect when the Governor\
  \ signs it. (Flesch Readability Score: 61.9). \n\tProvides that when a person is charged with committing\
  \ a new felony sex crime while on pretrial release for a felony sex crime, the person is only eligible\
  \ for release after a hearing during which the court determines whether security release may be denied,\
  \ and if security release is allowed, the person must deposit the full security amount set by the court.\
  \ \n\tDeclares an emergency, effective on passage."
relating_to: Relating to pretrial release for felony sex crimes; declaring an emergency.
relating_to_full: Relating to pretrial release for felony sex crimes; amending ORS 135.230, 135.233, 135.240
  and 135.280; and declaring an emergency.
...
# HB 4142 — 2024 Regular Session (2024R1)

## At a glance

- **Measure:** House Bill 4142, 2024 Regular Session (2024R1)
- **LC number:** 84
- **Created:** 2024-01-14T14:00:06
- **Metadata last modified (upstream):** 2024-02-05T12:19:15
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 16740 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/HB4142/Introduced>.

## Summary

**Catchline:** Provides that when a person is charged with committing a new felony sex crime while on pretrial release for a felony sex crime, the person is only eligible for release after a hearing during which the court determines whether security release may be denied, and if security release is allowed, the person must deposit the full security amount set by the court.

**Relating to:** Relating to pretrial release for felony sex crimes; declaring an emergency.

Digest: The Act restricts pretrial release for persons who commit a new felony sex crime while on pretrial release for a felony sex crime. The Act goes into effect when the Governor signs it. (Flesch Readability Score: 61.9). 
...
**RelatingToFull (verbatim upstream field):** Relating to pretrial release for felony sex crimes; amending ORS 135.230, 135.233, 135.240 and 135.280; and declaring an emergency.

## Full text

82nd OREGON LEGISLATIVE ASSEMBLY--2024 Regular Session
House Bill 4142
Sponsored by Representative BOICE, Senator SMITH  DB, Representatives WRIGHT, HIEB, OSBORNE, OWENS;
Representatives BREESE-IVERSON, MANNIX, NERON, RESCHKE,  STOUT, Senators FINDLEY, HANSELL,
LINTHICUM, THATCHER, WEBER (Presession filed.)
SUMMARY
...
- From `RelatingToFull`: ORS 135.230, ORS 135.233, ORS 135.240, ORS 135.280
- From bill text (Introduced version): ORS 133.030, ORS 135.230, ORS 135.233, ORS 135.240, ORS 135.265, ORS 135.280, ORS 153.061, ORS 163.415, ORS 163.425, ORS 163.427, ORS 163A.005, ORS 25.230, ORS 25.715, ORS 40.015

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `16900500522fc6cfd25a8a0aa62aa52a1b34906436344b8746509db4e652cb46` (snapshot `_meta/snapshots/measure-2024r1-hb4142-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2024R1/Downloads/MeasureDocument/HB4142/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2024R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 4142` (part of the batched per-session fetch), sha256 `1183bfeb8d41d57221d38a5a407738949976c2ace30f86900a3204ea31696ad5` of the shared session snapshot `_meta/snapshots/measures-2024r1.json`.

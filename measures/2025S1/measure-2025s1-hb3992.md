...
jurisdiction: oregon
id: measure-2025s1-hb3992
title: 'HB 3992 (2025S1): Modifies an appropriation from the General Fund to the Emergency Board.'
doc_type: dataset_doc
citation: 2025 1st Special Session House Bill 3992
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025S1/Downloads/MeasureDocument/HB3992/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 99fca5ebf002a8b72b86d674c66211b3211401e929357f960b1aea6b528c56b4
snapshot_id: measure-2025s1-hb3992-enrolled
status: current
...
catch_line: Modifies an appropriation from the General Fund to the Emergency Board.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes budget changes for certain state agencies. (Flesch Readability\
  \ Score: 66.1). \n\tModifies an appropriation from the General Fund to the Emergency Board. \n\tModifies\
  \ limitations on expenditures for certain biennial expenses for specified state agencies. \n\tAppropriates\
  \ moneys from the General Fund to specified state agencies for specified biennial expenses. \n\tDeclares\
...
lc_number: 6
measure_created_date: '2025-08-28T12:19:23'
measure_modified_date: '2025-12-11T12:06:03'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025S1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3992`.

# HB 3992 — 2025 1st Special Session (2025S1)

## At a glance

- **Measure:** House Bill 3992, 2025 1st Special Session (2025S1)
- **LC number:** 6
- **Created:** 2025-08-28T12:19:23
- **Metadata last modified (upstream):** 2025-12-11T12:06:03
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 7702 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025S1/Downloads/MeasureDocument/HB3992/Enrolled>.

## Summary

**Catchline:** Modifies an appropriation from the General Fund to the Emergency Board.

**Relating to:** Relating to state financial administration; and declaring an emergency.

Digest: The Act makes budget changes for certain state agencies. (Flesch Readability Score: 66.1). 
 Modifies an appropriation from the General Fund to the Emergency Board. 
 Modifies limitations on expenditures for certain biennial expenses for specified state agencies. 
 Appropriates moneys from the General Fund to specified state agencies for specified biennial expenses. 
...
Passed by House September 1, 2025
..................................................................................
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `99fca5ebf002a8b72b86d674c66211b3211401e929357f960b1aea6b528c56b4` (snapshot `_meta/snapshots/measure-2025s1-hb3992-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025S1/Downloads/MeasureDocument/HB3992/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `ff365c9a91e94d1b0122a404850dab3992646ae60695ec27e0cdb6208bfa00e9` (snapshot `_meta/snapshots/measure-2025s1-hb3992-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025S1/Downloads/MeasureDocument/HB3992/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025S1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3992` (part of the batched per-session fetch), sha256 `eb335b0218a6910c22858e3f35719df423c1ec9ecb833564b4615ea07b2560b7` of the shared session snapshot `_meta/snapshots/measures-2025s1.json`.

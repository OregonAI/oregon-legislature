...
jurisdiction: oregon
id: measure-2025r1-hb2258
title: 'HB 2258 (2025R1): Authorizes the Land Conservation and Development Commission to adopt rules requiring
  local governments to approve certain land use applications for residential developments using building
  plans preapproved by the Department of Consumer and Business Services.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2258
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2258/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 25ff5afccdb54dd7ee1863130fed429cb871185e49173f89d7405f4dbe813e10
snapshot_id: measure-2025r1-hb2258-enrolled
status: current
...
catch_line: Authorizes the Land Conservation and Development Commission to adopt rules requiring local
  governments to approve certain land use applications for residential developments using building plans
  preapproved by the Department of Consumer and Business Services.
minority_catch_line: null
measure_summary: "\tDigest: This Act lets LCDC and DCBS preapprove housing plans. (Flesch Readability\
  \ Score: 75.5). \n\tAuthorizes the Land Conservation and Development Commission to adopt rules requiring\
  \ local governments to approve certain land use applications for residential developments using building\
  \ plans preapproved by the Department of Consumer and Business Services. Requires adoption of initial\
  \ rules by January 1, 2027. <b>Increases appropriation of planning program moneys for rulemaking.</b>\
  \ \n\tAuthorizes the Department of Consumer and Business Services to develop a process to preapprove\
...
# HB 2258 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2258, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of House Interim Committee on Housing and Homelessness)
- **LC number:** 1824
...
- **Full text below:** Enrolled version, 7338 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2258/Enrolled>.

## Summary

**Catchline:** Authorizes the Land Conservation and Development Commission to adopt rules requiring local governments to approve certain land use applications for residential developments using building plans preapproved by the Department of Consumer and Business Services.

**Relating to:** Relating to housing; and declaring an emergency.

Digest: This Act lets LCDC and DCBS preapprove housing plans. (Flesch Readability Score: 75.5). 
 Authorizes the Land Conservation and Development Commission to adopt rules requiring local governments to approve certain land use applications for residential developments using building plans preapproved by the Department of Consumer and Business Services. Requires adoption of initial rules by January 1, 2027. <b>Increases appropriation of planning program moneys for rulemaking.</b> 
 Authorizes the Department of Consumer and Business Services to develop a process to preapprove residential building plans. 
 Declares an emergency, effective on passage.
...
- From bill text (Enrolled version): ORS 197A.420, ORS 455.062, ORS 455.685, ORS 90.100

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `25ff5afccdb54dd7ee1863130fed429cb871185e49173f89d7405f4dbe813e10` (snapshot `_meta/snapshots/measure-2025r1-hb2258-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2258/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `b6aaa2f411c76dc6340213e57274dfb0636f9ea113bd3327ddf1666ef0ab782a` (snapshot `_meta/snapshots/measure-2025r1-hb2258-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2258/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2258> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3582
title: 'HB 3582 (2025R1): Modifies the qualifications for certain statutes of limitations for civil actions
  based on allowing, permitting or encouraging child abuse and sexual assault.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3582
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3582/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 3d2c7dba096fed46b92c3d5595fdde69e4a68b7fbda53ed2a079be9f92735408
snapshot_id: measure-2025r1-hb3582-enrolled
status: current
...
catch_line: Modifies the qualifications for certain statutes of limitations for civil actions based on
  allowing, permitting or encouraging child abuse and sexual assault.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act changes the law about the time limit for some claims based on allowing,\
  \ permitting or encouraging child abuse and sexual assault. The Act gets rid of the time limit for claims\
  \ based on child sexual abuse or sexual assault. (Flesch Readability Score: 64.2).</b> \n\t[<i>Digest:\
  \ The Act gets rid of the time limit for filing claims based on sexual assault or child sexual abuse.\
  \ (Flesch Readability Score: 76.2).</i>] \n\t<b>Modifies the qualifications for certain statutes of\
  \ limitations for civil actions based on allowing, permitting or encouraging child abuse and sexual\
  \ assault. \n\tProspectively</b> eliminates the statute of limitations for civil actions based on sexual\
  \ assault or child sexual abuse. \n\t<b>Declares an emergency, effective on passage.</b>"
relating_to: Relating to statutes of limitation; and declaring an emergency.
relating_to_full: Relating to statutes of limitation; and declaring an emergency.
at_the_request_of: null
lc_number: 4007
measure_created_date: '2025-02-13T10:24:36'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3582`.

# HB 3582 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3582, 2025 Regular Session (2025R1)
- **LC number:** 4007
- **Created:** 2025-02-13T10:24:36
- **Metadata last modified (upstream):** 2025-07-25T10:52:12
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 6748 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3582/Enrolled>.

## Summary

**Catchline:** Modifies the qualifications for certain statutes of limitations for civil actions based on allowing, permitting or encouraging child abuse and sexual assault.
...
**RelatingToFull (verbatim upstream field):** Relating to statutes of limitation; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 12.110, ORS 12.115, ORS 12.117, ORS 12.118, ORS 163.435, ORS 167.007, ORS 167.008

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `3d2c7dba096fed46b92c3d5595fdde69e4a68b7fbda53ed2a079be9f92735408` (snapshot `_meta/snapshots/measure-2025r1-hb3582-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3582/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `bf94d4ef31e2457cfd0cb840be5434d891ad5f5317b791bfe5d06953cade69e4` (snapshot `_meta/snapshots/measure-2025r1-hb3582-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3582/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3582` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

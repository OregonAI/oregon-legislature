...
jurisdiction: oregon
id: measure-2025r1-hb3409
title: 'HB 3409 (2025R1): Allows insurers offering policies or certificates of health insurance and pharmacy
  benefit managers to require that a claim for reimbursement of a prescription drug include a modifier
  or other indicator that the drug is a 340B drug unless certain requirements are met.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3409
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3409/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f00e716ea2434bdc34498fc5d58f40393bf1d857fd55d5f3d3ac55b4e2f6b7bc
snapshot_id: measure-2025r1-hb3409-enrolled
status: current
...
catch_line: Allows insurers offering policies or certificates of health insurance and pharmacy benefit
  managers to require that a claim for reimbursement of a prescription drug include a modifier or other
  indicator that the drug is a 340B drug unless certain requirements are met.
minority_catch_line: Modifies the income thresholds and subtraction amounts that apply to federal taxable
  income for amounts paid for certain medical care expenses by certain individual taxpayers and requires
  annual adjustments of these amounts based on the U.S. City Average Consumer Price Index.
measure_summary: "\t<b>Digest: Makes rules for some insurers and PBMs about 340B drugs. (Flesch Readability\
  \ Score: 61.3).</b> \n\t[<i>Digest: The Act tells OHA to study health care. (Flesch Readability Score:\
  \ 92.9).</i>] \n\t[<i>Requires the Oregon Health Authority to study health care. Directs the authority\
  \ to submit findings to the interim committees of the Legislative Assembly related to health not later\
  \ than September 15, 2026.</i>] \n\t[<i>Sunsets on January 2, 2027.</i>] \n\t<b>Allows insurers offering\
  \ policies or certificates of health insurance and pharmacy benefit managers to require that a claim\
  \ for reimbursement of a prescription drug include a modifier or other indicator that the drug is a\
  \ 340B drug unless certain requirements are met. \n\tTakes effect on the 91st day following adjournment\
  \ sine die.</b>"
...
measure_modified_date: '2026-02-25T12:04:31'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3409>.

# HB 3409 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3409, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Representative Ben Bowman)
- **LC number:** 3278
- **Created:** 2025-01-23T14:33:43
- **Metadata last modified (upstream):** 2026-02-25T12:04:31
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 20468 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3409/Enrolled>.

## Summary

**Catchline:** Allows insurers offering policies or certificates of health insurance and pharmacy benefit managers to require that a claim for reimbursement of a prescription drug include a modifier or other indicator that the drug is a 340B drug unless certain requirements are met.
...
- From bill text (Enrolled version): ORS 414.025, ORS 414.312, ORS 414.353, ORS 414.688, ORS 442.015, ORS 443.400, ORS 443.705, ORS 689.005, ORS 689.515, ORS 731.106, ORS 735.530, ORS 735.532, ORS 735.534, ORS 735.540, ORS 743A.001, ORS 743A.062, ORS 743B.005, ORS 744.702, ORS 750.005, ORS 750.055

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `f00e716ea2434bdc34498fc5d58f40393bf1d857fd55d5f3d3ac55b4e2f6b7bc` (snapshot `_meta/snapshots/measure-2025r1-hb3409-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3409/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `c066f8df58e8e43ef560dd1df846ee8999bc0d1e2f5af26a91c7939c765e6cd1` (snapshot `_meta/snapshots/measure-2025r1-hb3409-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3409/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3409> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

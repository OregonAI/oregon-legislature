...
jurisdiction: oregon
id: measure-2025r1-sb837
title: 'SB 837 (2025R1): Modifies laws governing the emergency health care provider registry to allow
  a broader range of volunteer services and allow deployment of volunteers outside of declared emergencies.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 837
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB837/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 6a396258914976457fd06c9e27e283664d65ff961acc4645fd33295d42aa51be
snapshot_id: measure-2025r1-sb837-enrolled
status: current
...
catch_line: Modifies laws governing the emergency health care provider registry to allow a broader range
  of volunteer services and allow deployment of volunteers outside of declared emergencies.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes the health care volunteer registry known as SERV-OR. The Act\
  \ allows more types of people to join and allows for the use of volunteers outside of a declared emergency.\
  \ (Flesch Readability Score: 63.6). \n\tModifies laws governing the emergency health care provider registry\
  \ to allow a broader range of volunteer services and allow deployment of volunteers outside of declared\
  \ emergencies. \n\tRequires the Oregon Health Authority to provide workers' compensation coverage for\
  \ volunteers who provide services in other states pursuant to certain interstate agreements."
relating_to: Relating to a volunteer registry.
relating_to_full: Relating to a volunteer registry.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 837>.

# SB 837 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 837, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 20308 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB837/Enrolled>.

## Summary

**Catchline:** Modifies laws governing the emergency health care provider registry to allow a broader range of volunteer services and allow deployment of volunteers outside of declared emergencies.
...
**RelatingToFull (verbatim upstream field):** Relating to a volunteer registry.
...
Enrolled Senate Bill 837 (SB 837-A) Page 1
(b) Indicate that the [ health care provider ] individual is registered [ as an Oregon emergency
...
Enrolled Senate Bill 837 (SB 837-A) Page 2
...
Enrolled Senate Bill 837 (SB 837-A) Page 3
to 30.300 for the purposes of any claims arising out of services that are provided under  ORS
...
Enrolled Senate Bill 837 (SB 837-A) Page 4
(B) There is an immediate  need for a consistent response from the state in order to adequately
...
state.
Enrolled Senate Bill 837 (SB 837-A) Page 5
...
Enrolled Senate Bill 837 (SB 837-A) Page 6
...
- From bill text (Enrolled version): ORS 183.335, ORS 30.260, ORS 332.075, ORS 401.165, ORS 401.651, ORS 401.654, ORS 401.655, ORS 401.656, ORS 401.657, ORS 401.658, ORS 401.661, ORS 401.664, ORS 401.667, ORS 431.003, ORS 431A.015, ORS 433.441, ORS 442.015, ORS 656.039, ORS 656.047, ORS 676.160

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `6a396258914976457fd06c9e27e283664d65ff961acc4645fd33295d42aa51be` (snapshot `_meta/snapshots/measure-2025r1-sb837-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB837/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `98945817a0d571aa8b7d6b83f131daa29112726f0ab010579ba9671c1b8a2d46` (snapshot `_meta/snapshots/measure-2025r1-sb837-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB837/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 837> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

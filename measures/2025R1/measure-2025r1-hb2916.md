...
jurisdiction: oregon
id: measure-2025r1-hb2916
title: 'HB 2916 (2025R1): Modifies the qualifications of the fire instructor representative member of
  the Fire Policy Committee of the Board on Public Safety Standards and Training.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2916
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2916/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: acf3c94c0748fa16b990c98fe5fd0e3a3284d728249f5241a6e6f55798cc638b
snapshot_id: measure-2025r1-hb2916-enrolled
status: current
...
catch_line: Modifies the qualifications of the fire instructor representative member of the Fire Policy
  Committee of the Board on Public Safety Standards and Training.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes the needs for the fire instructor on the Fire Policy Committee.\
  \ (Flesch Readability Score: 61.8). \n\tModifies the qualifications of the fire instructor representative\
  \ member of the Fire Policy Committee of the Board on Public Safety Standards and Training."
relating_to: Relating to the Fire Policy Committee.
relating_to_full: Relating to the Fire Policy Committee.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2916`.

# HB 2916 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2916, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 10712 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2916/Enrolled>.

## Summary

**Catchline:** Modifies the qualifications of the fire instructor representative member of the Fire Policy Committee of the Board on Public Safety Standards and Training.
...
**RelatingToFull (verbatim upstream field):** Relating to the Fire Policy Committee.
...
officer; and
Enrolled House Bill 2916 (HB 2916-INTRO) Page 1
...
patcher; and
Enrolled House Bill 2916 (HB 2916-INTRO) Page 2
(ii) Is not related within the second  degree by affinity or consanguinity to a person who is em-
...
Enrolled House Bill 2916 (HB 2916-INTRO) Page 3
...
Enrolled House Bill 2916 (HB 2916-INTRO) Page 4
...
- From bill text (Enrolled version): ORS 181A.375, ORS 181A.840, ORS 703.401, ORS 703.430

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `acf3c94c0748fa16b990c98fe5fd0e3a3284d728249f5241a6e6f55798cc638b` (snapshot `_meta/snapshots/measure-2025r1-hb2916-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2916/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `b125a0a23d3dea84e12971fc5c5d9b2cefb7e133bd22b9eb8a331a0cc1beac09` (snapshot `_meta/snapshots/measure-2025r1-hb2916-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2916/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2916` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

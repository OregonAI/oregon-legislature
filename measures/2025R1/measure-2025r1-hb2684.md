...
jurisdiction: oregon
id: measure-2025r1-hb2684
title: 'HB 2684 (2025R1): Requires that a school integrated pest management plan be reviewed at least
  once every five years.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2684
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2684/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: d74286889a95e28dd3548645a3bd07f37fdbf046f205af5480b2e59390cf95d9
snapshot_id: measure-2025r1-hb2684-enrolled
status: current
...
catch_line: Requires that a school integrated pest management plan be reviewed at least once every five
  years.
minority_catch_line: null
measure_summary: "\tDigest: This Act changes laws for school IPM plans. (Flesch Readability Score: 100.0).\
  \ \n\tRequires that a school integrated pest management plan be reviewed at least once every five years<b>.</b>\
  \ [<i>and made available to the public on a website. Provides that a low-impact pesticide list shall\
  \ be included in an integrated pest management plan.</i>]<b> Requires that the school integrated pest\
  \ management plan and the list of low-impact pesticides be made available to the public on a website.</b>"
relating_to: Relating to integrated pest management.
relating_to_full: Relating to integrated pest management.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2684>.

# HB 2684 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2684, 2025 Regular Session (2025R1)
- **LC number:** 674
...
- **Full text below:** Enrolled version, 9711 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2684/Enrolled>.

## Summary

**Catchline:** Requires that a school integrated pest management plan be reviewed at least once every five years.
...
**RelatingToFull (verbatim upstream field):** Relating to integrated pest management.
...
- From bill text (Enrolled version): ORS 332.331, ORS 334.003, ORS 341.005, ORS 634.700, ORS 634.705, ORS 634.740, ORS 634.750

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `d74286889a95e28dd3548645a3bd07f37fdbf046f205af5480b2e59390cf95d9` (snapshot `_meta/snapshots/measure-2025r1-hb2684-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2684/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `9416662e4491671b0df09cc877401a7ffc9a381fc2998d03a6bd3aeb3194f4b8` (snapshot `_meta/snapshots/measure-2025r1-hb2684-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2684/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2684> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

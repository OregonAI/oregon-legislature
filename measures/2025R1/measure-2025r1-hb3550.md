...
jurisdiction: oregon
id: measure-2025r1-hb3550
title: 'HB 3550 (2025R1): Exempts from certain laws governing certain employment conditions minor league
  baseball players who are subject to a collective bargaining agreement that provides for payment of wages
  and other working conditions.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3550
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3550/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ba829a93fc54071b8500723cde18d3fcb07cf3ded548d7fa1e7ba2f8852a7213
snapshot_id: measure-2025r1-hb3550-enrolled
status: current
...
catch_line: Exempts from certain laws governing certain employment conditions minor league baseball players
  who are subject to a collective bargaining agreement that provides for payment of wages and other working
  conditions.
minority_catch_line: null
measure_summary: "\tDigest: The Act exempts certain sports players from some state laws about working\
  \ conditions. (Flesch Readability Score: 63.4). \n\tExempts from certain laws governing certain employment\
  \ conditions minor league baseball players who are subject to a collective bargaining agreement that\
  \ provides for payment of wages and other working conditions."
relating_to: Relating to an exemption for certain minor league baseball players from certain laws governing
  employment conditions.
relating_to_full: Relating to an exemption for certain minor league baseball players from certain laws
  governing employment conditions.
at_the_request_of: null
lc_number: 4256
measure_created_date: '2025-02-10T10:03:57'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3550>.

# HB 3550 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3550, 2025 Regular Session (2025R1)
- **LC number:** 4256
- **Created:** 2025-02-10T10:03:57
- **Metadata last modified (upstream):** 2025-06-11T17:12:27
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 7675 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3550/Enrolled>.

## Summary

**Catchline:** Exempts from certain laws governing certain employment conditions minor league baseball players who are subject to a collective bargaining agreement that provides for payment of wages and other working conditions.
...
**RelatingToFull (verbatim upstream field):** Relating to an exemption for certain minor league baseball players from certain laws governing employment conditions.
...
Enrolled House Bill 3550 (HB 3550-INTRO) Page 1
...
Enrolled House Bill 3550 (HB 3550-INTRO) Page 2
...
Enrolled House Bill 3550 (HB 3550-INTRO) Page 3
...
- From bill text (Enrolled version): ORS 30.970, ORS 443.705, ORS 65.001, ORS 652.050, ORS 653.010, ORS 653.020, ORS 653.025

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `ba829a93fc54071b8500723cde18d3fcb07cf3ded548d7fa1e7ba2f8852a7213` (snapshot `_meta/snapshots/measure-2025r1-hb3550-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3550/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `efbb3161ae0841981dc4075d2fbe428bcf48f87dfcf26eb2e20eb24a3ad46420` (snapshot `_meta/snapshots/measure-2025r1-hb3550-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3550/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3550> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

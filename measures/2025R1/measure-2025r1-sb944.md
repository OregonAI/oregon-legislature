...
jurisdiction: oregon
id: measure-2025r1-sb944
title: 'SB 944 (2025R1): Modifies independent living requirements for older foster children.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 944
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB944/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c62e1ae4231d6c1ef2eba886078811f4b2edec7576d93728db1bd095acf333a8
snapshot_id: measure-2025r1-sb944-enrolled
status: current
...
measure_summary: "\tDigest: The Act removes a requirement that an older foster child must pay rent if\
  \ living alone. The Act allows DHS to exempt certain older foster children from having to have a criminal\
  \ background check. (Flesch Readability Score: 60.1). \n\tModifies independent living requirements for\
  \ older foster children. \n\tAuthorizes the Department of Human Services to exempt an individual placed\
  \ in a household by the department before the individual turned 18 from applicable background check\
  \ requirements after the individual attains 18 years of age."
relating_to: Relating to older foster children.
relating_to_full: Relating to older foster children.
at_the_request_of: null
lc_number: 3799
measure_created_date: '2025-01-23T10:06:56'
...
# SB 944 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 944, 2025 Regular Session (2025R1)
- **LC number:** 3799
- **Created:** 2025-01-23T10:06:56
- **Metadata last modified (upstream):** 2025-06-20T13:19:42
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 6469 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB944/Enrolled>.

## Summary

**Catchline:** Modifies independent living requirements for older foster children.
...
**RelatingToFull (verbatim upstream field):** Relating to older foster children.
...
- From bill text (Enrolled version): ORS 181A.195, ORS 181A.215, ORS 418.016, ORS 418.475, ORS 419B.400

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `c62e1ae4231d6c1ef2eba886078811f4b2edec7576d93728db1bd095acf333a8` (snapshot `_meta/snapshots/measure-2025r1-sb944-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB944/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `5d46254e3a7f0f20ffe5c3678c0745fe199c1e370e6db447f5d2b9934ed0e8e8` (snapshot `_meta/snapshots/measure-2025r1-sb944-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB944/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 944` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

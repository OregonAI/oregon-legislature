...
jurisdiction: oregon
id: measure-2025r1-hb2512
title: 'HB 2512 (2025R1): Directs the Department of Education, in conjunction with various education stakeholders,
  to develop, administer and maintain a statewide data system for the education workforce in this state.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2512
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2512/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 10ab0b3cf2dd482981185fd8209f328119d748a8b87fcf86a562edcc4c8e18f9
snapshot_id: measure-2025r1-hb2512-introduced
status: current
...
catch_line: Directs the Department of Education, in conjunction with various education stakeholders, to
  develop, administer and maintain a statewide data system for the education workforce in this state.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells the ODE to develop and maintain a data system for the education\
  \ workforce in the state. (Flesch Readability Score: 62.8). \n\tDirects the Department of Education,\
  \ in conjunction with various education stakeholders, to develop, administer and maintain a statewide\
  \ data system for the education workforce in this state."
relating_to: Relating to educator workforce data solutions.
relating_to_full: Relating to educator workforce data solutions.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2512`.

# HB 2512 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2512, 2025 Regular Session (2025R1)
...
- **Full text below:** Introduced version, 5525 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2512/Introduced>.

## Summary

**Catchline:** Directs the Department of Education, in conjunction with various education stakeholders, to develop, administer and maintain a statewide data system for the education workforce in this state.
...
**RelatingToFull (verbatim upstream field):** Relating to educator workforce data solutions.
...
- From bill text (Introduced version): ORS 342.443, ORS 342.676, ORS 343.961

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `10ab0b3cf2dd482981185fd8209f328119d748a8b87fcf86a562edcc4c8e18f9` (snapshot `_meta/snapshots/measure-2025r1-hb2512-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2512/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2512` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

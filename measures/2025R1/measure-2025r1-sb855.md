...
jurisdiction: oregon
id: measure-2025r1-sb855
title: 'SB 855 (2025R1): Requires the Oregon Racing Commission to adopt rules establishing civil penalties
  for violation of laws, rules or directives relating to race meets.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 855
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB855/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f2d8601f760d6b035e4cec6d45fed11aa2a7312311e49bd8b960b5d1ed6d6bf5
snapshot_id: measure-2025r1-sb855-enrolled
status: current
...
catch_line: Requires the Oregon Racing Commission to adopt rules establishing civil penalties for violation
  of laws, rules or directives relating to race meets.
minority_catch_line: null
measure_summary: "\tDigest: Persons can be penalized for breaking laws relating to race meets. The Act\
  \ requires the ORC to adopt rules about the penalties. The Act increases the maximum amount of the penalties.\
  \ (Flesch Readability Score: 62.6). \n\tRequires the Oregon Racing Commission to adopt rules establishing\
  \ civil penalties for violation of laws, rules or directives relating to race meets. Increases the maximum\
  \ amount of the civil penalties."
relating_to: Relating to civil penalties related to racing.
relating_to_full: Relating to civil penalties related to racing.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 855>.

# SB 855 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 855, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 5539 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB855/Enrolled>.

## Summary

**Catchline:** Requires the Oregon Racing Commission to adopt rules establishing civil penalties for violation of laws, rules or directives relating to race meets.
...
**RelatingToFull (verbatim upstream field):** Relating to civil penalties related to racing.
...
- From bill text (Enrolled version): ORS 183.605, ORS 462.405

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `f2d8601f760d6b035e4cec6d45fed11aa2a7312311e49bd8b960b5d1ed6d6bf5` (snapshot `_meta/snapshots/measure-2025r1-sb855-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB855/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `16847e2aa4592027ab3f2a6e4d8f17fbc8bdde018aa8e81ee3c8fa1c3287baa8` (snapshot `_meta/snapshots/measure-2025r1-sb855-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB855/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 855> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

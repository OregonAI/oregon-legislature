...
jurisdiction: oregon
id: measure-2025r1-sb1121
title: 'SB 1121 (2025R1): Creates the crime of unlawful disclosure of private information.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1121
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1121/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 1140ace5f5c3a3e2b67c6b90c8cb128fe17d8cb4a83d39880989205ee78ad91c
snapshot_id: measure-2025r1-sb1121-enrolled
status: current
...
catch_line: Creates the crime of unlawful disclosure of private information.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act creates a new crime about disclosing private data. The Act also\
  \ extends the time for some media to cure violations of a data privacy law. The Act goes into effect\
  \ when the Governor signs it. (Flesch Readability Score: 66.2).</b> \n\t[<i>Digest: The Act creates\
  \ a new crime about disclosing private data. The Act also exempts some media from a data privacy law.\
  \ (Flesch Readability Score: 63.2).</i>] \n\tCreates the crime of unlawful disclosure of private information.\
  \ Punishes by a maximum of six months' imprisonment, $2,500 fine, or both. \n\t[<i>Creates an exception\
  \ in a consumer data privacy law for</i>]<b> Extends the time period, to July 1, 2026, during which\
  \ </b>specified noncommercial educational broadcast stations<b> may cure violations of a consumer data\
  \ privacy law</b>. \n\t<b>Declares an emergency, effective on passage.</b>"
relating_to: Relating to the disclosure of private information; and declaring an emergency.
relating_to_full: Relating to the disclosure of private information; and declaring an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1121`.

# SB 1121 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1121, 2025 Regular Session (2025R1)
- **LC number:** 1690
...
- **Full text below:** Enrolled version, 6220 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1121/Enrolled>.

## Summary

**Catchline:** Creates the crime of unlawful disclosure of private information.
...
**RelatingToFull (verbatim upstream field):** Relating to the disclosure of private information; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 161.005, ORS 163.732, ORS 180.095, ORS 30.866, ORS 646A.570, ORS 646A.578, ORS 646A.589

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `1140ace5f5c3a3e2b67c6b90c8cb128fe17d8cb4a83d39880989205ee78ad91c` (snapshot `_meta/snapshots/measure-2025r1-sb1121-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1121/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `4cc95a2ce9703298aea865834c8eeebd1a872f88e1ca095b3f6a8b2346c98269` (snapshot `_meta/snapshots/measure-2025r1-sb1121-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1121/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1121` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

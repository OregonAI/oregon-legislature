...
jurisdiction: oregon
id: measure-2025r1-hb2587
title: 'HB 2587 (2025R1): Removes the percentage cap on the amount of moneys that are distributed from
  the State School Fund to school districts for students eligible for special education as a child with
  a disability.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2587
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2587/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e0dbec600e319b1bc50fc8c43874a59c5626578d856fa25a36ff08b355533b69
snapshot_id: measure-2025r1-hb2587-introduced
status: current
...
measure_summary: "\tDigest: Takes away the cap on the amount of state moneys that a school district may\
  ...
  \ districts for students eligible for special education as a child with a disability. \n\tDeclares an\
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2587`.

# HB 2587 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2587, 2025 Regular Session (2025R1)
- **LC number:** 3569
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:23:46
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6931 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2587/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `e0dbec600e319b1bc50fc8c43874a59c5626578d856fa25a36ff08b355533b69` (snapshot `_meta/snapshots/measure-2025r1-hb2587-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2587/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2587` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hjr1
title: 'HJR 1 (2025R1): Proposes an amendment to the Oregon Constitution to require approval by the Legislative
  Assembly of any new fees or fee increases adopted by a state agency. Requires that bills approving new
  or increased fees be approved by a three-fifths supermajority of each chamber of the Legislative Assembly.'
doc_type: dataset_doc
citation: 2025 Regular Session House Joint Resolution 1
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJR1/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: bb1c0486b6ced6b0c5f5bc51c2d5e83452198bf0a299fe17a55d833238463777
snapshot_id: measure-2025r1-hjr1-introduced
status: current
...
catch_line: Proposes an amendment to the Oregon Constitution to require approval by the Legislative Assembly
  of any new fees or fee increases adopted by a state agency. Requires that bills approving new or increased
  fees be approved by a three-fifths supermajority of each chamber of the Legislative Assembly.
minority_catch_line: null
measure_summary: "\tDigest: The measure says that if a state agency wants to charge a new fee or increase\
  \ a fee, the Legislative Assembly has to agree. The measure requires 3/5 of the members of each chamber\
  \ to agree. (Flesch Readability Score: 69.3). \n\tProposes an amendment to the Oregon Constitution to\
  \ require approval by the Legislative Assembly of any new fees or fee increases adopted by a state agency.\
  \ Requires that bills approving new or increased fees be approved by a three-fifths supermajority of\
  \ each chamber of the Legislative Assembly. \n\tRefers the proposed amendment to the people for their\
  \ approval or rejection at the next regular general election."
relating_to: Proposing an amendment to the Oregon Constitution relating to fees.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HJR' and MeasureNumber eq 1`.

# HJR 1 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Joint Resolution 1, 2025 Regular Session (2025R1)
- **LC number:** 222
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-21T15:38:30
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 3104 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJR1/Introduced>.

## Summary

**Catchline:** Proposes an amendment to the Oregon Constitution to require approval by the Legislative Assembly of any new fees or fee increases adopted by a state agency. Requires that bills approving new or increased fees be approved by a three-fifths supermajority of each chamber of the Legislative Assembly.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `bb1c0486b6ced6b0c5f5bc51c2d5e83452198bf0a299fe17a55d833238463777` (snapshot `_meta/snapshots/measure-2025r1-hjr1-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJR1/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HJR' and MeasureNumber eq 1` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hr3
title: 'HR 3 (2025R1): Recognizes and honors the history of Black drag in Oregon.'
doc_type: dataset_doc
citation: 2025 Regular Session House Resolution 3
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HR3/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 02fe24f6223add66fdfd56a8bc1cc848a28401c1b04eb0072dcf8508f550d719
snapshot_id: measure-2025r1-hr3-enrolled
status: current
...
catch_line: Recognizes and honors the history of Black drag in Oregon.
minority_catch_line: null
measure_summary: "\tDigest: Honors the history of Black drag in Oregon. (Flesch Readability Score: 61.2).\
  \ \n\tRecognizes and honors the history of Black drag in Oregon."
relating_to: Recognizing and honoring the history of Black drag in Oregon.
relating_to_full: null
at_the_request_of: null
lc_number: 4195
measure_created_date: '2025-02-10T15:24:58'
measure_modified_date: '2025-06-19T15:31:36'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HR' and MeasureNumber eq 3>.

# HR 3 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Resolution 3, 2025 Regular Session (2025R1)
- **LC number:** 4195
- **Created:** 2025-02-10T15:24:58
- **Metadata last modified (upstream):** 2025-06-19T15:31:36
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 11187 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HR3/Enrolled>.

## Summary

**Catchline:** Recognizes and honors the history of Black drag in Oregon.

**Relating to:** Recognizing and honoring the history of Black drag in Oregon.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `02fe24f6223add66fdfd56a8bc1cc848a28401c1b04eb0072dcf8508f550d719` (snapshot `_meta/snapshots/measure-2025r1-hr3-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HR3/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `7aeaaed8ccb43b6b1c82a05bbb18cf6619ad9cd006b8f5bfbbb2a428e7338304` (snapshot `_meta/snapshots/measure-2025r1-hr3-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HR3/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HR' and MeasureNumber eq 3> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

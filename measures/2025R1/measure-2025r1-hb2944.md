...
jurisdiction: oregon
id: measure-2025r1-hb2944
title: 'HB 2944 (2025R1): Directs the Employment Relations Board to impose civil penalties against a public
  employer that has a history of failing to comply with certain requirements under the Public Employee
  Collective Bargaining Act.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2944
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2944/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: cc247730a2e514dbf5cbf413902dd14d03d60be974a567408e4f953f202f9c59
snapshot_id: measure-2025r1-hb2944-enrolled
status: current
...
catch_line: Directs the Employment Relations Board to impose civil penalties against a public employer
  that has a history of failing to comply with certain requirements under the Public Employee Collective
  Bargaining Act.
minority_catch_line: Directs the Employment Relations Board to impose civil penalties against a public
  employer that has a history of failing to comply with certain requirements under the Public Employee
  Collective Bargaining Act.
measure_summary: "\tDigest: The Act makes changes to the PECBA. The Act creates penalties for violating\
  \ certain provisions of the PECBA. (Flesch Readability Score: 61.4). \n\tDirects the Employment Relations\
  \ Board to impose civil penalties against a public employer that has a history of failing to comply\
  \ with certain requirements under the Public Employee Collective Bargaining Act. <b>Provides that a\
  \ violation resulting from certain events is not subject to a civil penalty.</b> \n\tPermits the board\
  \ to consider extenuating circumstances when determining the amount of the civil penalty to impose."
...
relating_to_full: Relating to penalties for failure to comply with certain requirements under the laws
  governing public employee collective bargaining.
at_the_request_of: null
lc_number: 3115
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2026-02-25T11:53:39'
...
# HB 2944 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2944, 2025 Regular Session (2025R1)
- **LC number:** 3115
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-02-25T11:53:39
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 11012 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2944/Enrolled>.

## Summary

**Catchline:** Directs the Employment Relations Board to impose civil penalties against a public employer that has a history of failing to comply with certain requirements under the Public Employee Collective Bargaining Act.
...
**RelatingToFull (verbatim upstream field):** Relating to penalties for failure to comply with certain requirements under the laws governing public employee collective bargaining.
...
- From bill text (Enrolled version): ORS 164.377, ORS 197.488, ORS 240.060, ORS 240.065, ORS 240.080, ORS 240.123, ORS 243.650, ORS 243.670, ORS 243.672, ORS 243.676, ORS 243.804, ORS 243.806, ORS 84.004

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `cc247730a2e514dbf5cbf413902dd14d03d60be974a567408e4f953f202f9c59` (snapshot `_meta/snapshots/measure-2025r1-hb2944-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2944/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `f672944dea818661b85a536874c8091be07d0c8813f31d3c89c3a79f170aa899` (snapshot `_meta/snapshots/measure-2025r1-hb2944-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2944/Introduced>.

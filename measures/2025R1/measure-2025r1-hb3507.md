...
jurisdiction: oregon
id: measure-2025r1-hb3507
title: 'HB 3507 (2025R1): Requires the Housing and Community Services Department to amend specified down
  payment assistance programs to increase eligibility by January 1, 2026.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3507
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3507/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 41b0e1c909c20f0fb95c3eb2c5dc2d615314690ba802394d34a739a8e77d700b
snapshot_id: measure-2025r1-hb3507-introduced
status: current
...
catch_line: Requires the Housing and Community Services Department to amend specified down payment assistance
  programs to increase eligibility by January 1, 2026.
minority_catch_line: null
measure_summary: "\tDigest: Amends OHCS's HOAP and CRO-DPA programs to reach more home owners. (Flesch\
  \ Readability Score: 80.3). \n\tRequires the Housing and Community Services Department to amend specified\
  \ down payment assistance programs to increase eligibility by January 1, 2026. Amends department home\
  \ ownership programs to expand eligibility to moderate income households. \n\tTakes effect on the 91st\
  \ day following adjournment sine die."
relating_to: Relating to Housing and Community Services Department home ownership programs; prescribing
  an effective date.
relating_to_full: Relating to Housing and Community Services Department home ownership programs; creating
  new provisions; amending ORS 458.655 and 458.658; and prescribing an effective date.
at_the_request_of: null
lc_number: 2502
measure_created_date: '2025-02-03T09:48:20'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3507`.

# HB 3507 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3507, 2025 Regular Session (2025R1)
- **LC number:** 2502
- **Created:** 2025-02-03T09:48:20
- **Metadata last modified (upstream):** 2025-02-06T13:22:13
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7487 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3507/Introduced>.

## Summary

**Catchline:** Requires the Housing and Community Services Department to amend specified down payment assistance programs to increase eligibility by January 1, 2026.
...
**RelatingToFull (verbatim upstream field):** Relating to Housing and Community Services Department home ownership programs; creating new provisions; amending ORS 458.655 and 458.658; and prescribing an effective date.
...
- From `RelatingToFull`: ORS 458.655, ORS 458.658
- From bill text (Introduced version): ORS 291.002, ORS 294.187, ORS 458.610, ORS 458.655, ORS 458.658

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `41b0e1c909c20f0fb95c3eb2c5dc2d615314690ba802394d34a739a8e77d700b` (snapshot `_meta/snapshots/measure-2025r1-hb3507-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3507/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3507` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

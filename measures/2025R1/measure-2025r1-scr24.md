...
jurisdiction: oregon
id: measure-2025r1-scr24
title: 'SCR 24 (2025R1): Recognizes and honors Brian Edward Flowers (1974-2023) for his service to Gresham
  and to this state.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Concurrent Resolution 24
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR24/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5ef0068a37944e1500c052c8bd871afe80e8c029d6fbe580f14988da635d8eaa
snapshot_id: measure-2025r1-scr24-enrolled
status: current
...
catch_line: Recognizes and honors Brian Edward Flowers (1974-2023) for his service to Gresham and to this
  state.
minority_catch_line: null
measure_summary: "\tDigest: Pays respect to Brian Flowers for his service to Gresham and to this state.\
  \ (Flesch Readability Score: 77.8). \n\tRecognizes and honors Brian Edward Flowers (1974-2023) for his\
  \ service to Gresham and to this state."
relating_to: Recognizing and honoring Brian Edward Flowers for his service to Gresham and to this state.
relating_to_full: null
at_the_request_of: null
lc_number: 4620
measure_created_date: '2025-02-21T14:43:50'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SCR' and MeasureNumber eq 24`.

# SCR 24 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Concurrent Resolution 24, 2025 Regular Session (2025R1)
- **LC number:** 4620
- **Created:** 2025-02-21T14:43:50
- **Metadata last modified (upstream):** 2025-05-29T11:25:44
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 2948 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR24/Enrolled>.

## Summary

**Catchline:** Recognizes and honors Brian Edward Flowers (1974-2023) for his service to Gresham and to this state.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `5ef0068a37944e1500c052c8bd871afe80e8c029d6fbe580f14988da635d8eaa` (snapshot `_meta/snapshots/measure-2025r1-scr24-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR24/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `cfbab74d1b3829160d93d7f2476daa30194a227fddb9f2dfa5c17960b3e66a93` (snapshot `_meta/snapshots/measure-2025r1-scr24-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR24/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SCR' and MeasureNumber eq 24` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

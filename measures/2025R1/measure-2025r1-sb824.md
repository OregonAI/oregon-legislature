...
jurisdiction: oregon
id: measure-2025r1-sb824
title: 'SB 824 (2025R1): Requires certain carriers that offer health benefit plans in this state to report
  additional information to the Department of Consumer and Business Services and requires the department
  to keep this information confidential.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 824
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB824/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 77f3a5fe7736ac0f4e4d658a0f1b039a7d39ac07c58e4a86a98b6e79aa8b9e07
snapshot_id: measure-2025r1-sb824-enrolled
status: current
...
catch_line: Requires certain carriers that offer health benefit plans in this state to report additional
  information to the Department of Consumer and Business Services and requires the department to keep
  this information confidential.
minority_catch_line: null
measure_summary: "\t<b>Digest: Tells insurers in this state to give more information to DCBS and tells\
  \ DCBS not to share what they receive from insurers. (Flesch Readability Score: 61.4).</b> \n\t[<i>Digest:\
  \ Tells DCBS to study the impact of federal laws about health insurance on state laws. (Flesch Readability\
  \ Score: 61.8).</i>] \n\t[<i>Requires the Department of Consumer and Business Services to study federal\
  \ laws and regulations affecting health insurance and evolving conditions in the insurance market that\
  \ require periodic updates to state laws. Directs the department to submit findings to the interim committees\
  \ of the Legislative Assembly related to health care not later than September 15, 2026.</i>] \n\t<b>Requires\
  \ certain carriers that offer health benefit plans in this state to report additional information to\
  \ the Department of Consumer and Business Services and requires the department to keep this information\
  \ confidential.</b>"
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 824`.

# SB 824 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 824, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 8646 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB824/Enrolled>.

## Summary

**Catchline:** Requires certain carriers that offer health benefit plans in this state to report additional information to the Department of Consumer and Business Services and requires the department to keep this information confidential.
...
- From bill text (Enrolled version): ORS 192.245, ORS 705.137, ORS 743A.168, ORS 743B.005, ORS 743B.427

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `77f3a5fe7736ac0f4e4d658a0f1b039a7d39ac07c58e4a86a98b6e79aa8b9e07` (snapshot `_meta/snapshots/measure-2025r1-sb824-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB824/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `f776ff326ffb166905f182b7721a2157cacc46b545bece8bc5636bfda23014e6` (snapshot `_meta/snapshots/measure-2025r1-sb824-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB824/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 824` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

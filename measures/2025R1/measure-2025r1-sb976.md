...
jurisdiction: oregon
id: measure-2025r1-sb976
title: 'SB 976 (2025R1): Allows an individual to verify whether cattle are pregnant without holding a
  valid license issued by the Oregon State Veterinary Medical Examining Board under certain circumstances.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 976
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB976/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 906a2e12b6f63513101ab366ba16bfc322d16aa69c58d91ff8579976b0602cb6
snapshot_id: measure-2025r1-sb976-enrolled
status: current
...
measure_summary: "\tDigest: The Act says a person might be allowed to check and see if cows are pregnant,\
  \ even if the person is not a veterinarian. Allows the ODA to adopt rules to explain when this is okay.\
  ...
  \ circumstances. Permits the State Department of Agriculture to adopt rules. \n\t[<i>Establishes the\
  \ Task Force on Equine Dentistry. Directs the task force to report on findings to the interim committees\
  \ of the Legislative Assembly related to agriculture no later than December 15, 2025.</i>] \n\tDeclares\
  \ an emergency, effective on passage."
relating_to: Relating to providing animal health care; and declaring an emergency.
relating_to_full: Relating to providing animal health care; and declaring an emergency.
at_the_request_of: null
lc_number: 4418
measure_created_date: '2025-02-03T10:56:40'
measure_modified_date: '2025-10-01T13:16:22'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 976`.

# SB 976 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 976, 2025 Regular Session (2025R1)
- **LC number:** 4418
- **Created:** 2025-02-03T10:56:40
- **Metadata last modified (upstream):** 2025-10-01T13:16:22
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 7104 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB976/Enrolled>.
...
**RelatingToFull (verbatim upstream field):** Relating to providing animal health care; and declaring an emergency.
...
Enrolled Senate Bill 976 (SB 976-B) Page 1
...
on its passage.
Enrolled Senate Bill 976 (SB 976-B) Page 2
...
Enrolled Senate Bill 976 (SB 976-B) Page 3
...
- From bill text (Enrolled version): ORS 167.322, ORS 496.004, ORS 596.321, ORS 686.020, ORS 686.040

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `906a2e12b6f63513101ab366ba16bfc322d16aa69c58d91ff8579976b0602cb6` (snapshot `_meta/snapshots/measure-2025r1-sb976-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB976/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `3de600d0f9132728b036a251da076d29c66b36735d65c99666b2d175e1137de8` (snapshot `_meta/snapshots/measure-2025r1-sb976-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB976/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 976` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

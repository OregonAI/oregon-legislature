...
jurisdiction: oregon
id: measure-2025r1-hb2081
title: 'HB 2081 (2025R1): Directs the Oregon Investment Council and the State Treasurer to take certain
  actions to manage the risks of climate change to the Public Employees Retirement Fund.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2081
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2081/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c2ff207e2b65a70da10a9be575eb54cdc1adb3bdf9e57db1deaa1afcf23a6f86
snapshot_id: measure-2025r1-hb2081-enrolled
status: current
...
catch_line: Directs the Oregon Investment Council and the State Treasurer to take certain actions to manage
  the risks of climate change to the Public Employees Retirement Fund.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act requires the OIC and the State Treasurer to take actions to manage\
  \ climate risks to the PERS fund. (Flesch Readability Score: 76.5).</b> \n\t[<i>Digest: The Act directs\
  \ the LRO to study the state financial system. (Flesch Readability Score: 72.6).</i>] \n\t[<i>Requires\
  \ the Legislative Revenue Officer to study the state financial system. Directs the Legislative Revenue\
  \ Officer to submit findings to the interim committees of the Legislative Assembly related to revenue\
  \ not later than December 1, 2026.</i>] \n\t<b>Directs the Oregon Investment Council and the State Treasurer\
  \ to take certain actions to manage the risks of climate change to the Public Employees Retirement Fund.\
  \ \n\tTakes effect on the 91st day following adjournment sine die.</b>"
relating_to: Relating to state finance; and prescribing an effective date.
relating_to_full: Relating to state finance; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2081`.

# HB 2081 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2081, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 5095 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2081/Enrolled>.

## Summary

**Catchline:** Directs the Oregon Investment Council and the State Treasurer to take certain actions to manage the risks of climate change to the Public Employees Retirement Fund.
...
**RelatingToFull (verbatim upstream field):** Relating to state finance; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 192.355, ORS 238.660, ORS 293.721, ORS 293.726

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `c2ff207e2b65a70da10a9be575eb54cdc1adb3bdf9e57db1deaa1afcf23a6f86` (snapshot `_meta/snapshots/measure-2025r1-hb2081-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2081/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `34a7f233e2ebace0c84e3853e571537b8a3d2ae1127edf6e622caaac033975cb` (snapshot `_meta/snapshots/measure-2025r1-hb2081-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2081/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2081` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hcr18
title: 'HCR 18 (2025R1): Recognizes and honors the League of Oregon Cities on the 100th anniversary of
  its founding.'
doc_type: dataset_doc
citation: 2025 Regular Session House Concurrent Resolution 18
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR18/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c5055145f8364397c01f0c7f69ea5f7e6bd8e542917f674bb67f65d88cf323f4
snapshot_id: measure-2025r1-hcr18-enrolled
status: current
...
catch_line: Recognizes and honors the League of Oregon Cities on the 100th anniversary of its founding.
minority_catch_line: null
measure_summary: "\tDigest: Pays honor to the League of Oregon Cities as it reaches its 100th year. (Flesch\
  \ Readability Score: 65.7). \n\tRecognizes and honors the League of Oregon Cities on the 100th anniversary\
  \ of its founding."
relating_to: Recognizing and honoring the League of Oregon Cities on the 100th anniversary of its founding.
relating_to_full: null
at_the_request_of: null
lc_number: 4097
measure_created_date: '2025-02-12T13:14:28'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 18>.

# HCR 18 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Concurrent Resolution 18, 2025 Regular Session (2025R1)
- **LC number:** 4097
- **Created:** 2025-02-12T13:14:28
- **Metadata last modified (upstream):** 2025-05-06T14:15:38
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 4430 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR18/Enrolled>.

## Summary

**Catchline:** Recognizes and honors the League of Oregon Cities on the 100th anniversary of its founding.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `c5055145f8364397c01f0c7f69ea5f7e6bd8e542917f674bb67f65d88cf323f4` (snapshot `_meta/snapshots/measure-2025r1-hcr18-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR18/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `59d05fb2bf1f6171d6c1fa67c4209b12a7a992c4a5b47dd82b2f4bb434d6958d` (snapshot `_meta/snapshots/measure-2025r1-hcr18-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR18/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 18> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

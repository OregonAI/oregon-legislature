...
jurisdiction: oregon
id: measure-2025r1-hb2551
title: 'HB 2551 (2025R1): Directs the governing board of a public university to ensure that background
  information about special campus security officers is requested from the Department of Public Safety
  Standards and Training and reviewed before commissioning the officer.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2551
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2551/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c47eb744c411ae90f2a2e411373f904eb809ef055174c2b02b193aa79c6b1c62
snapshot_id: measure-2025r1-hb2551-enrolled
status: current
...
catch_line: Directs the governing board of a public university to ensure that background information about
  special campus security officers is requested from the Department of Public Safety Standards and Training
  and reviewed before commissioning the officer.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells a public university to look at data from DPSST about a person\
  \ who wants to be a campus security officer. The Act says that DPSST can share the data. (Flesch Readability\
  \ Score: 61.0). \n\tDirects the governing board of a public university to [<i>request and review</i>]\
  \ <b>ensure that</b> background information about special campus security officers <b>is requested from\
  \ the Department of Public Safety Standards and Training and reviewed</b> before commissioning the officer.\
  \ \n\tAllows the department [<i>of Public Safety Standards and Training</i>] to share information about\
  \ applicants with a public university."
relating_to: Relating to security on campus.
relating_to_full: Relating to security on campus.
...
# HB 2551 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2551, 2025 Regular Session (2025R1)
- **LC number:** 1225
...
- **Full text below:** Enrolled version, 6752 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2551/Enrolled>.

## Summary

**Catchline:** Directs the governing board of a public university to ensure that background information about special campus security officers is requested from the Department of Public Safety Standards and Training and reviewed before commissioning the officer.

**Relating to:** Relating to security on campus.

Digest: The Act tells a public university to look at data from DPSST about a person who wants to be a campus security officer. The Act says that DPSST can share the data. (Flesch Readability Score: 61.0). 
 Directs the governing board of a public university to [<i>request and review</i>] <b>ensure that</b> background information about special campus security officers <b>is requested from the Department of Public Safety Standards and Training and reviewed</b> before commissioning the officer. 
 Allows the department [<i>of Public Safety Standards and Training</i>] to share information about applicants with a public university.

**RelatingToFull (verbatim upstream field):** Relating to security on campus.
...
shall ensure that:
Enrolled House Bill 2551 (HB 2551-A) Page 1
(a) Vehicles used by private security professionals or  special campus security officers in the
...
providers.
Enrolled House Bill 2551 (HB 2551-A) Page 2
...
Enrolled House Bill 2551 (HB 2551-A) Page 3
...
- From bill text (Enrolled version): ORS 131.605, ORS 133.225, ORS 163.715, ORS 163A.005, ORS 181A.840, ORS 181A.972, ORS 352.002, ORS 352.118

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `c47eb744c411ae90f2a2e411373f904eb809ef055174c2b02b193aa79c6b1c62` (snapshot `_meta/snapshots/measure-2025r1-hb2551-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2551/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `97d11895fca7107d30b0d9919f941aab77a15db76cbff5c0c3ace9efa02ceb7a` (snapshot `_meta/snapshots/measure-2025r1-hb2551-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2551/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2551` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb1086
title: 'SB 1086 (2025R1): Requires the Director of the Department of Consumer and Business Services to
...
citation: 2025 Regular Session Senate Bill 1086
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1086/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b2224e1132a82a24acb58d20acbec8d4ab034af9c06677d164bd7f7c3e2d13e5
snapshot_id: measure-2025r1-sb1086-enrolled
status: current
...
catch_line: Requires the Director of the Department of Consumer and Business Services to assist and provide
  support to the Oregon Building Officials Association to develop a proposal for establishing an apprenticeship
  program for building inspectors.
minority_catch_line: null
measure_summary: "\t<b>Digest: Tells DCBS to help a group of building officials to develop a plan to set\
  \ up a program to train people to inspect buildings. (Flesch Readability Score: 62.6).</b> \n\t[<i>Digest:\
  \ Tells the director of DCBS to set up an apprentice program to train people to inspect buildings. (Flesch\
  \ Readability Score: 60.1).</i>] \n\tRequires the Director of the Department of Consumer and Business\
  \ Services to<b> assist and provide support to the Oregon Building Officials Association to develop\
  \ a proposal for</b> [<i>establish</i>]<b> establishing</b> an apprenticeship program for building inspectors.\
  \ \n\t<b>Sunsets on January 2, 2027.</b> \n\tTakes effect on the 91st day following adjournment sine\
  \ die."
relating_to: Relating to an apprenticeship program for building inspectors; and prescribing an effective
  date.
relating_to_full: Relating to an apprenticeship program for building inspectors; and prescribing an effective
  date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1086`.

# SB 1086 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1086, 2025 Regular Session (2025R1)
- **LC number:** 4527
...
- **Full text below:** Enrolled version, 5303 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1086/Enrolled>.

## Summary

**Catchline:** Requires the Director of the Department of Consumer and Business Services to assist and provide support to the Oregon Building Officials Association to develop a proposal for establishing an apprenticeship program for building inspectors.
...
**RelatingToFull (verbatim upstream field):** Relating to an apprenticeship program for building inspectors; and prescribing an effective date.
...
455.740.
Enrolled Senate Bill 1086 (SB 1086-A) Page 1
...
Enrolled Senate Bill 1086 (SB 1086-A) Page 2
...
- From bill text (Enrolled version): ORS 455.720, ORS 455.740, ORS 660.002

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `b2224e1132a82a24acb58d20acbec8d4ab034af9c06677d164bd7f7c3e2d13e5` (snapshot `_meta/snapshots/measure-2025r1-sb1086-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1086/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `879977d21afd8ba95efe54b049284ac1e1d2a2a90190a404af25ae7386a92eab` (snapshot `_meta/snapshots/measure-2025r1-sb1086-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1086/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1086` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

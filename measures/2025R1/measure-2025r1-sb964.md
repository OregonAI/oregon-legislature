...
jurisdiction: oregon
id: measure-2025r1-sb964
title: 'SB 964 (2025R1): Defines "postal indicator" as an official mark stamped on an envelope by the
  United States Postal Service for purposes of determining the date or time at which a ballot was mailed.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 964
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB964/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 20950d6c114de3c2b2cea203e58db659214c4b072d167231d03f3b6ca2cd54c4
snapshot_id: measure-2025r1-sb964-introduced
status: current
...
catch_line: Defines "postal indicator" as an official mark stamped on an envelope by the United States
  Postal Service for purposes of determining the date or time at which a ballot was mailed.
minority_catch_line: null
measure_summary: "\tDigest: The Act defines a postmark for ballot envelopes. (Flesch Readability Score:\
  \ 61.2). \n\tDefines \"postal indicator\" as an official mark stamped on an envelope by the United States\
  \ Postal Service for purposes of determining the date or time at which a ballot was mailed."
relating_to: Relating to the definition of postal indicator for ballot envelopes.
relating_to_full: Relating to the definition of postal indicator for ballot envelopes; amending ORS 254.470.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 964`.

# SB 964 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 964, 2025 Regular Session (2025R1)
- **LC number:** 4581
- **Created:** 2025-01-28T16:08:43
- **Metadata last modified (upstream):** 2025-01-30T13:16:37
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 12624 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB964/Introduced>.

## Summary

**Catchline:** Defines "postal indicator" as an official mark stamped on an envelope by the United States Postal Service for purposes of determining the date or time at which a ballot was mailed.

**Relating to:** Relating to the definition of postal indicator for ballot envelopes.

Digest: The Act defines a postmark for ballot envelopes. (Flesch Readability Score: 61.2). 
 Defines "postal indicator" as an official mark stamped on an envelope by the United States Postal Service for purposes of determining the date or time at which a ballot was mailed.

**RelatingToFull (verbatim upstream field):** Relating to the definition of postal indicator for ballot envelopes; amending ORS 254.470.
...
Postal Service for purposes of determining the date or time at which a ballot was mailed.
A BILL FOR AN ACT
Relating to the definition of postal indicator for ballot envelopes; amending ORS 254.470.
...
ballot, identified by the Secretary of State by rule, ] an official mark stamped on an envelope over
the postage stamp by the  United States Postal Service  that demonstrates the date or time at
which a ballot was mailed.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `20950d6c114de3c2b2cea203e58db659214c4b072d167231d03f3b6ca2cd54c4` (snapshot `_meta/snapshots/measure-2025r1-sb964-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB964/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 964` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

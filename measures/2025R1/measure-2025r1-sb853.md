...
jurisdiction: oregon
id: measure-2025r1-sb853
title: 'SB 853 (2025R1): Increases the maximum amount of certain license fees charged by the Oregon Racing
  Commission.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 853
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB853/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ca48c3c733a8e1f7f605f05db3c6929abfdfc24b103bc5d211b74acf4bfa652a
snapshot_id: measure-2025r1-sb853-enrolled
status: current
...
catch_line: Increases the maximum amount of certain license fees charged by the Oregon Racing Commission.
minority_catch_line: null
measure_summary: "\tDigest: The Act increases the amount that the ORC may charge for licenses. (Flesch\
  \ Readability Score: 74.8). \n\tIncreases the maximum amount of certain license fees charged by the\
  \ Oregon Racing Commission. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to Oregon Racing Commission license fees; and declaring an emergency.
relating_to_full: Relating to Oregon Racing Commission license fees; and declaring an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 853>.

# SB 853 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 853, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 5126 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB853/Enrolled>.

## Summary

**Catchline:** Increases the maximum amount of certain license fees charged by the Oregon Racing Commission.
...
**RelatingToFull (verbatim upstream field):** Relating to Oregon Racing Commission license fees; and declaring an emergency.
...
year.
Enrolled Senate Bill 853 (SB 853-INTRO) Page 1
...
Enrolled Senate Bill 853 (SB 853-INTRO) Page 2
...
- From bill text (Enrolled version): ORS 462.020, ORS 462.070, ORS 462.157, ORS 462.725

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `ca48c3c733a8e1f7f605f05db3c6929abfdfc24b103bc5d211b74acf4bfa652a` (snapshot `_meta/snapshots/measure-2025r1-sb853-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB853/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `838d427eb76685b572e131fbf366a01c1d9748bc1f0794c1e0b3b7e6b10d7d19` (snapshot `_meta/snapshots/measure-2025r1-sb853-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB853/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 853> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

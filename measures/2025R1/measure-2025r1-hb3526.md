...
jurisdiction: oregon
id: measure-2025r1-hb3526
title: 'HB 3526 (2025R1): Establishes a cause of action for a buyer in a real estate transaction if the
  seller fails to provide the results of required well tests.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3526
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3526/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b11caa11147fbbaa58c69c746933a979002a11fde495835303cb8847b78791d7
snapshot_id: measure-2025r1-hb3526-introduced
status: current
...
catch_line: Establishes a cause of action for a buyer in a real estate transaction if the seller fails
  to provide the results of required well tests.
minority_catch_line: null
measure_summary: "\tDigest: This Act says that a buyer of real estate may sue the seller if the seller\
  \ does not give the buyer well test results. (Flesch Readability Score: 76.7). \n\tEstablishes a cause\
  \ of action for a buyer in a real estate transaction if the seller fails to provide the results of required\
  \ well tests. Modifies well testing requirements to require that a seller provide a copy of well test\
  \ results to the Department of Environmental Quality. \n\tModifies the form of the seller's property\
  \ disclosure statement."
relating_to: Relating to exempt wells that supply water for domestic purposes.
relating_to_full: Relating to exempt wells that supply water for domestic purposes; amending ORS 105.464
  and 448.271.
at_the_request_of: null
lc_number: 2561
measure_created_date: '2025-02-06T12:27:03'
measure_modified_date: '2025-04-02T21:24:13'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 22004
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3526`.

# HB 3526 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3526, 2025 Regular Session (2025R1)
- **LC number:** 2561
- **Created:** 2025-02-06T12:27:03
- **Metadata last modified (upstream):** 2025-04-02T21:24:13
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 22004 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3526/Introduced>.

## Summary

**Catchline:** Establishes a cause of action for a buyer in a real estate transaction if the seller fails to provide the results of required well tests.
...
**RelatingToFull (verbatim upstream field):** Relating to exempt wells that supply water for domestic purposes; amending ORS 105.464 and 448.271.

## Full text

83rd OREGON LEGISLATIVE ASSEMBLY--2025 Regular Session
House Bill 3526
Sponsored by Representatives  HARTMAN, OWENS, HELM; Representatives GAMBA, WALTERS, Senators MAN-
NING JR, MEEK
SUMMARY
...
standards.
Digest: This Act says that a buyer of real estate may sue the seller if the seller  does not give
the buyer well test results. (Flesch Readability Score: 76.7).
Establishes a cause of action for  a buyer in a real estate transaction if the seller fails to provide
the results of required well tests. Modifies well testing requirements to require that a seller provide
a copy of well test results to the Department of Environmental Quality.
Modifies the form of the seller’s property disclosure statement.
A BILL FOR AN ACT
Relating to exempt wells that  supply water for domestic purposes; amending ORS 105.464 and
448.271.
Be It Enacted by the People of the State of Oregon:
SECTION 1.
 ORS 448.271 is amended to read:
448.271. (1) In any transaction for the sale or exchange of real estate  that includes [ a well ] an
exempt well that supplies ground water for domestic purposes, the seller of the real  estate shall[ ,
upon accepting an offer to  purchase that real estate, ] have the exempt well tested for arsenic, nitrates
and total coliform  bacteria. The Oregon Health Authority also may, by rule, require additional tests
for specific contaminants in specific areas of public health concern. The seller shall submit  the re-
sults of the tests  required under this section to the [ authority] Department of Environmental
Quality and to the buyer . [within 90 days of receiving the results of the tests. ]
(2)(a) A buyer has a cause of action against a seller for damages if:
(A) The seller did not provide  the results of the test to the buyer as required by this
section; and
(B) An exempt well required to be tested under this section contains,  at levels in excess
of any maximum contaminant level, arsenic, nitrates or total coliform bacteria, or any other
contaminant if testing is required by the authority in a specific area of public health concern.
(b) Any cause of action granted by this subsection is barred unless the cause  of action
is commenced within five years of the date that the transaction closed.
[(2)] (3) The failure of a seller to comply with the provisions of this section does not  invalidate
an instrument of conveyance executed in the transaction.
(4) As used in this section, “exempt well” means a  well used for exempt purposes under
ORS 537.545 (1)(b) or (d).
SECTION 2.
...
including E. coli [ ]Chemical contents test ,
including arsenic and nitrates [ ]Yes [ ]No [ ]Unknown [ ]NA
*If yes, have you included the results with
this statement and provided the results to the
Department of Environmental Quality (DEQ)? [ ]Yes [ ]No
...
- From `RelatingToFull`: ORS 105.464, ORS 448.271
- From bill text (Introduced version): ORS 105.462, ORS 105.464, ORS 105.465, ORS 105.470, ORS 105.475, ORS 448.271, ORS 537.545

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `b11caa11147fbbaa58c69c746933a979002a11fde495835303cb8847b78791d7` (snapshot `_meta/snapshots/measure-2025r1-hb3526-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3526/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3526` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

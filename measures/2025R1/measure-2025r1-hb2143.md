...
jurisdiction: oregon
id: measure-2025r1-hb2143
title: 'HB 2143 (2025R1): Defines "five-needle protocol."'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2143
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2143/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 46d64894fae420aa74d7862e3a9f2a8d40d198d5c5132387c8d27dc5f5096a2b
snapshot_id: measure-2025r1-hb2143-enrolled
status: current
...
catch_line: Defines "five-needle protocol."
minority_catch_line: null
measure_summary: "\tDigest: The Act says what the \"five-needle protocol\" is and who can perform it.\
  \ (Flesch Readability Score: 71.7). \n\tDefines \"five-needle protocol.\" [<i>Allows an individual with\
  \ required training to provide the five-needle protocol and exempts the individual from the requirement\
  \ to obtain a license to practice acupuncture.</i>] <b>Allows the Oregon Medical Board to establish\
  \ a registry of individuals who are qualified to provide the five-needle protocol. Provides that only\
  \ an individual included on the registry may provide the five-needle protocol. Creates an exception.\
  \ Exempts an individual included on the registry from the requirement to obtain a license to practice\
  \ acupuncture. \n\tTakes effect on the 91st day following adjournment sine die.</b>"
relating_to: Relating to five-needle protocol; and prescribing an effective date.
relating_to_full: Relating to five-needle protocol; and prescribing an effective date.
at_the_request_of: null
lc_number: 663
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2026-04-14T12:38:13'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2143`.

# HB 2143 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2143, 2025 Regular Session (2025R1)
- **LC number:** 663
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-04-14T12:38:13
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 6613 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2143/Enrolled>.

## Summary

**Catchline:** Defines "five-needle protocol."
...
**RelatingToFull (verbatim upstream field):** Relating to five-needle protocol; and prescribing an effective date.
...
otherwise indicate that the individual is authorized  to practice acupuncture, as defined in
ORS 677.757.
...
- From bill text (Enrolled version): ORS 181A.195, ORS 677.757, ORS 677.759, ORS 677.761

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `46d64894fae420aa74d7862e3a9f2a8d40d198d5c5132387c8d27dc5f5096a2b` (snapshot `_meta/snapshots/measure-2025r1-hb2143-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2143/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `54183d9761b1db4f8eb63905109ff33c635a5762f5d7511ba517cf81f4195a33` (snapshot `_meta/snapshots/measure-2025r1-hb2143-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2143/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2143` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

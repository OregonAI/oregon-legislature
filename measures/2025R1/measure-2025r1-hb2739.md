...
jurisdiction: oregon
id: measure-2025r1-hb2739
title: 'HB 2739 (2025R1): Provides that a registered owner may request that the registration card issued
  for a vehicle include that the owner, or a person operating the vehicle, has limited English language
  proficiency.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2739
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2739/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: cde0f4a44262bc19386d7739f26ba319f3400ec56c17403767cea89f5e18bf61
snapshot_id: measure-2025r1-hb2739-introduced
status: current
...
catch_line: Provides that a registered owner may request that the registration card issued for a vehicle
  include that the owner, or a person operating the vehicle, has limited English language proficiency.
minority_catch_line: null
measure_summary: "\tDigest: The Act allows car owners to ask for a note on their vehicle reg card if they\
  \ or a person driving the car has a difficult time with the English language. (Flesch Readability Score:\
...
relating_to_full: Relating to motor vehicles; amending ORS 803.370 and 803.500.
...
# HB 2739 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2739, 2025 Regular Session (2025R1)
- **LC number:** 3751
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:32:38
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6028 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2739/Introduced>.

## Summary

**Catchline:** Provides that a registered owner may request that the registration card issued for a vehicle include that the owner, or a person operating the vehicle, has limited English language proficiency.

**Relating to:** Relating to motor vehicles.

Digest: The Act allows car owners to ask for a note on their vehicle reg card if they or a person driving the car has a difficult time with the English language. (Flesch Readability Score: 63.4). 
 Provides that a registered owner may request that the registration card issued for a vehicle include that the owner, or a person operating the vehicle, has limited English language proficiency.

**RelatingToFull (verbatim upstream field):** Relating to motor vehicles; amending ORS 803.370 and 803.500.
...
- From `RelatingToFull`: ORS 803.370, ORS 803.500
- From bill text (Introduced version): ORS 192.846, ORS 802.250, ORS 802.253, ORS 803.120, ORS 803.200, ORS 803.355, ORS 803.360, ORS 803.370, ORS 803.500, ORS 806.020, ORS 819.012, ORS 825.410

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `cde0f4a44262bc19386d7739f26ba319f3400ec56c17403767cea89f5e18bf61` (snapshot `_meta/snapshots/measure-2025r1-hb2739-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2739/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2739> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

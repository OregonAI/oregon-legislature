...
jurisdiction: oregon
id: measure-2025r1-hb3646
title: 'HB 3646 (2025R1): Adds entities in which employees of the entity own at least 50 percent of the
  ownership interest in the entity directly or through an employee stock ownership plan to the list of
  sources to which a contracting agency may give preference in procuring goods or services for public
  contracts.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3646
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3646/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: dc5c897602be9f2d4cec67b0d2734bfa3b00cc098db11b2c11ad7529d7eb4a3c
snapshot_id: measure-2025r1-hb3646-enrolled
status: current
...
catch_line: Adds entities in which employees of the entity own at least 50 percent of the ownership interest
  in the entity directly or through an employee stock ownership plan to the list of sources to which a
  contracting agency may give preference in procuring goods or services for public contracts.
minority_catch_line: null
measure_summary: "\tDigest: Lets state agencies that buy goods or services prefer doing so from businesses\
  \ owned by their employees. (Flesch Readability Score: 60.1). \n\tAdds entities in which employees of\
  \ the entity own at least 50 percent of the ownership interest in the entity directly or through an\
  \ employee stock ownership plan to the list of sources to which a contracting agency may give preference\
  \ in procuring goods or services for public contracts. \n\tTakes effect on the 91st day following adjournment\
  \ sine die."
relating_to: Relating to contract preferences in public procurement for employee-owned businesses; and
  prescribing an effective date.
relating_to_full: Relating to contract preferences in public procurement for employee-owned businesses;
  and prescribing an effective date.
at_the_request_of: null
lc_number: 3680
measure_created_date: '2025-02-18T15:12:25'
measure_modified_date: '2026-04-14T12:32:53'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3646`.

# HB 3646 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3646, 2025 Regular Session (2025R1)
- **LC number:** 3680
- **Created:** 2025-02-18T15:12:25
- **Metadata last modified (upstream):** 2026-04-14T12:32:53
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 5853 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3646/Enrolled>.

## Summary

**Catchline:** Adds entities in which employees of the entity own at least 50 percent of the ownership interest in the entity directly or through an employee stock ownership plan to the list of sources to which a contracting agency may give preference in procuring goods or services for public contracts.
...
**RelatingToFull (verbatim upstream field):** Relating to contract preferences in public procurement for employee-owned businesses; and prescribing an effective date.
...
Enrolled House Bill 3646 (HB 3646-INTRO) Page 1
[(c)] (d) The contracting agency by order may set a higher  cost  percentage than the  cost  per-
...
Enrolled House Bill 3646 (HB 3646-INTRO) Page 2
...
- From bill text (Enrolled version): ORS 279A.010, ORS 279A.055, ORS 279A.065, ORS 279A.128, ORS 279C.320, ORS 60.027, ORS 60.754

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `dc5c897602be9f2d4cec67b0d2734bfa3b00cc098db11b2c11ad7529d7eb4a3c` (snapshot `_meta/snapshots/measure-2025r1-hb3646-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3646/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `543efe8fbc9c17528799ea37ef73268fe018752e24b617d8fac652ec6fe49f73` (snapshot `_meta/snapshots/measure-2025r1-hb3646-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3646/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3646` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2643
title: 'HB 2643 (2025R1): Permits a motor vehicle drawing a trailer to also draw a farm trailer under
  specified conditions.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2643
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2643/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 669d9b8e49fbd02114a40404bf6de47825468181f444b872ac927667b977af61
snapshot_id: measure-2025r1-hb2643-introduced
status: current
...
catch_line: Permits a motor vehicle drawing a trailer to also draw a farm trailer under specified conditions.
minority_catch_line: null
measure_summary: "\tDigest: The Act says that a truck that pulls a trailer may also pull a farm trailer.\
  \ However, the farm trailer must have a hitch that does not swivel and must not be longer than eight\
  \ feet in length. (Flesch Readability Score: 85.1). \n\tPermits a motor vehicle drawing a trailer to\
  \ also draw a farm trailer under specified conditions."
relating_to: Relating to combinations of vehicles.
relating_to_full: Relating to combinations of vehicles; amending ORS 818.100 and 818.120.
at_the_request_of: null
lc_number: 3651
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T13:08:56'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 12623
...
# HB 2643 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2643, 2025 Regular Session (2025R1)
- **LC number:** 3651
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T13:08:56
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 12623 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2643/Introduced>.

## Summary

**Catchline:** Permits a motor vehicle drawing a trailer to also draw a farm trailer under specified conditions.
...
**RelatingToFull (verbatim upstream field):** Relating to combinations of vehicles; amending ORS 818.100 and 818.120.
...
LC 3651
door  hinges  and turning signal brackets may exceed the maximum allowable width described in Ta-
...
and is intended as an integral part of the recreational vehicle. “Appurtenance” does not  include an
...
- From `RelatingToFull`: ORS 818.100, ORS 818.120
- From bill text (Introduced version): ORS 267.010, ORS 801.026, ORS 810.060, ORS 818.080, ORS 818.090, ORS 818.100, ORS 818.110, ORS 818.120, ORS 818.200

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `669d9b8e49fbd02114a40404bf6de47825468181f444b872ac927667b977af61` (snapshot `_meta/snapshots/measure-2025r1-hb2643-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2643/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2643` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

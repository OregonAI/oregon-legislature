...
jurisdiction: oregon
id: measure-2025r1-hb2316
title: 'HB 2316 (2025R1): Allows designation by the Oregon Department of Administrative Services of certain
  state-owned and locally nominated lands within an urban growth boundary as home start lands to be used
  for affordable housing.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2316
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2316/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 15c0ea01390dab60dffad50d7dcea837cb94c0c258d6d74cf4a2f458f26c8331
snapshot_id: measure-2025r1-hb2316-enrolled
status: current
...
catch_line: Allows designation by the Oregon Department of Administrative Services of certain state-owned
  and locally nominated lands within an urban growth boundary as home start lands to be used for affordable
  housing.
minority_catch_line: null
measure_summary: "\tDigest: This Act allows DAS to designate certain state and local lands within UGBs\
  \ as home start lands for low cost housing. Home start lands are exempt from certain land use laws and\
  \ exempt from property taxes for up to five years. (Flesch Readability Score: 72.7). \n\tAllows designation\
  \ by the Oregon Department of Administrative Services of certain state-owned and locally nominated lands\
  \ within an urban growth boundary as home start lands to be used for affordable housing. Exempts home\
  \ start lands from local land use laws. \n\tAllows the department to transfer state-owned home start\
  \ lands to a developer exempted from ordinary transfer processes once the lands are subject to an affordable\
  \ housing covenant. \n\tEstablishes the Home Start Lands Fund to implement the program and to provide\
  \ loans and grants to develop affordable housing on home start lands or to provide public services for\
  \ residents. Allows the department to collaborate with the Housing Accountability and Production Office\
  \ and requires collaboration with the Department of State Lands to implement the program. \n\tExempts\
  \ home start lands from property tax assessments for a period of up to five years under certain conditions.\
...
relating_to_full: Relating to lands designated for housing; and prescribing an effective date.
...
# HB 2316 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2316, 2025 Regular Session (2025R1)
- **LC number:** 1266
...
- **Full text below:** Enrolled version, 27299 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2316/Enrolled>.

## Summary

**Catchline:** Allows designation by the Oregon Department of Administrative Services of certain state-owned and locally nominated lands within an urban growth boundary as home start lands to be used for affordable housing.
...
**RelatingToFull (verbatim upstream field):** Relating to lands designated for housing; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 197.015, ORS 197.797, ORS 197.830, ORS 197A.400, ORS 197A.420, ORS 215.010, ORS 223.299, ORS 270.100, ORS 273.251, ORS 307.100, ORS 307.110, ORS 308.010, ORS 456.270, ORS 674.310, ORS 94.550

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `15c0ea01390dab60dffad50d7dcea837cb94c0c258d6d74cf4a2f458f26c8331` (snapshot `_meta/snapshots/measure-2025r1-hb2316-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2316/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `d073849f97f7e9452b8729d8c67d5c9dc5aa64a22eb8e110e4440dffe0f0dad3` (snapshot `_meta/snapshots/measure-2025r1-hb2316-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2316/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2316` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2564
title: 'HB 2564 (2025R1): Revises the insurance rate review process.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2564
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2564/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 47b031cb756fc07800004b7d714acd6f2c8d804bfeecd6a197aa6b938b83d5fa
snapshot_id: measure-2025r1-hb2564-enrolled
status: current
...
catch_line: Revises the insurance rate review process.
minority_catch_line: null
measure_summary: "\tDigest: Makes some changes to the process for reviewing insurance rates. (Flesch Readability\
  \ Score: 61.3). \n\tRevises the insurance rate review process."
relating_to: Relating to the insurance rate review process.
relating_to_full: Relating to the insurance rate review process.
...
# HB 2564 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2564, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 11389 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2564/Enrolled>.

## Summary

**Catchline:** Revises the insurance rate review process.
...
**RelatingToFull (verbatim upstream field):** Relating to the insurance rate review process.
...
- From bill text (Enrolled version): ORS 183.484, ORS 192.610, ORS 742.003, ORS 742.005, ORS 742.007, ORS 743.004, ORS 743.015, ORS 743.018, ORS 743.019, ORS 743.022, ORS 743.025, ORS 743.535, ORS 743B.003, ORS 743B.005, ORS 743B.013

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `47b031cb756fc07800004b7d714acd6f2c8d804bfeecd6a197aa6b938b83d5fa` (snapshot `_meta/snapshots/measure-2025r1-hb2564-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2564/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `8315f3948c7ea5a200b18f958c79ca2151453816391053b441921d17e8970304` (snapshot `_meta/snapshots/measure-2025r1-hb2564-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2564/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2564` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

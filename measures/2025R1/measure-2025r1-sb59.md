...
jurisdiction: oregon
id: measure-2025r1-sb59
title: 'SB 59 (2025R1): Allows specified production of food in planned communities by lot owners and their
  tenants.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 59
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB59/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: fda1db2766ad17c00bf2d066eb40307708acab55e8e884ea5b6f5a9c3417be7a
...
measure_summary: "\tDigest: This Act allows HOA members or their tenants to grow a garden or raise hens\
  \ or bees. (Flesch Readability Score: 85.0). \n\tAllows specified production of food in planned communities\
  \ by lot owners and their tenants."
relating_to: Relating to producing food in planned communities.
relating_to_full: Relating to producing food in planned communities; amending ORS 94.779.
...
# SB 59 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 59, 2025 Regular Session (2025R1)
...
- **Full text below:** Introduced version, 6428 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB59/Introduced>.

## Summary

**Catchline:** Allows specified production of food in planned communities by lot owners and their tenants.
...
**RelatingToFull (verbatim upstream field):** Relating to producing food in planned communities; amending ORS 94.779.
...
- From `RelatingToFull`: ORS 94.779
- From bill text (Introduced version): ORS 329A.250, ORS 329A.500, ORS 659A.421, ORS 90.335, ORS 94.779

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `fda1db2766ad17c00bf2d066eb40307708acab55e8e884ea5b6f5a9c3417be7a` (snapshot `_meta/snapshots/measure-2025r1-sb59-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB59/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 59` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

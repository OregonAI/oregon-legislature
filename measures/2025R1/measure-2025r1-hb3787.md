...
jurisdiction: oregon
id: measure-2025r1-hb3787
title: 'HB 3787 (2025R1): Prohibits restaurants and retailers from providing reusable plastic checkout
  bags to consumers.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3787
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3787/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b234c9e16f49d30a71bb430641bc6054521acc31649f661f57b7a6e787ca5ffb
snapshot_id: measure-2025r1-hb3787-introduced
status: current
...
catch_line: Prohibits restaurants and retailers from providing reusable plastic checkout bags to consumers.
minority_catch_line: null
measure_summary: "\tDigest: This Act stops restaurants and stores from giving plastic checkout bags that\
  \ can be reused to consumers. (Flesch Readability Score: 70.1). \n\tProhibits restaurants and retailers\
  \ from providing reusable plastic checkout bags to consumers."
relating_to: Relating to checkout bags.
relating_to_full: Relating to checkout bags; amending ORS 459A.755, 459A.757 and 459A.759.
at_the_request_of: null
lc_number: 3588
measure_created_date: '2025-02-25T13:27:50'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3787>.

# HB 3787 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3787, 2025 Regular Session (2025R1)
- **LC number:** 3588
- **Created:** 2025-02-25T13:27:50
- **Metadata last modified (upstream):** 2025-03-05T10:27:45
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7030 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3787/Introduced>.

## Summary

**Catchline:** Prohibits restaurants and retailers from providing reusable plastic checkout bags to consumers.
...
**RelatingToFull (verbatim upstream field):** Relating to checkout bags; amending ORS 459A.755, 459A.757 and 459A.759.
...
- From `RelatingToFull`: ORS 459A.755, ORS 459A.757, ORS 459A.759
- From bill text (Introduced version): ORS 174.116, ORS 413.500, ORS 459.993, ORS 459A.755, ORS 459A.757, ORS 459A.759

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `b234c9e16f49d30a71bb430641bc6054521acc31649f661f57b7a6e787ca5ffb` (snapshot `_meta/snapshots/measure-2025r1-hb3787-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3787/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3787> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

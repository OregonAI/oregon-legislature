...
jurisdiction: oregon
id: measure-2025r1-hb2035
title: 'HB 2035 (2025R1): Prohibits the Teacher Standards and Practices Commission from collecting a late
  application fee for the renewal or reinstatement of a substitute teaching license.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2035
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2035/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 053eb1c30653bf0ee18f00e10f240187b81dbf94c540ea2ea8a0bbc06646366c
snapshot_id: measure-2025r1-hb2035-introduced
status: current
...
catch_line: Prohibits the Teacher Standards and Practices Commission from collecting a late application
  fee for the renewal or reinstatement of a substitute teaching license.
minority_catch_line: null
measure_summary: "\tDigest: Prohibits TSPC from charging a substitute teacher for late fees for the teacher\
  \ to have a license. (Flesch Readability Score: 60.1). \n\tProhibits the Teacher Standards and Practices\
  \ Commission from collecting a late application fee for the renewal or reinstatement of a substitute\
  \ teaching license. \n\tTakes effect on July 1, 2026."
relating_to: Relating to fees for substitute teaching licenses; prescribing an effective date.
relating_to_full: Relating to fees for substitute teaching licenses; creating new provisions; amending
  ORS 342.127; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2035`.

# HB 2035 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2035, 2025 Regular Session (2025R1)
- **LC number:** 131
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-21T08:16:07
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5286 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2035/Introduced>.

## Summary

**Catchline:** Prohibits the Teacher Standards and Practices Commission from collecting a late application fee for the renewal or reinstatement of a substitute teaching license.

**Relating to:** Relating to fees for substitute teaching licenses; prescribing an effective date.

Digest: Prohibits TSPC from charging a substitute teacher for late fees for the teacher to have a license. (Flesch Readability Score: 60.1). 
 Prohibits the Teacher Standards and Practices Commission from collecting a late application fee for the renewal or reinstatement of a substitute teaching license. 
 Takes effect on July 1, 2026.

**RelatingToFull (verbatim upstream field):** Relating to fees for substitute teaching licenses; creating new provisions; amending ORS 342.127; and prescribing an effective date.
...
- From `RelatingToFull`: ORS 342.127
- From bill text (Introduced version): ORS 181A.195, ORS 342.125, ORS 342.127, ORS 342.175

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `053eb1c30653bf0ee18f00e10f240187b81dbf94c540ea2ea8a0bbc06646366c` (snapshot `_meta/snapshots/measure-2025r1-hb2035-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2035/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2035` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

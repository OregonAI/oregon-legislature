...
jurisdiction: oregon
id: measure-2025r1-sb659
title: 'SB 659 (2025R1): Prohibits the amount of tuition that is waived for qualified students from being
  reduced by the amount of specified student aid received by the qualified students.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 659
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB659/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: d9e2b108fcab3bd256b0da894cd6e17c313edc2c2a578fddcd3f6df32f867a47
snapshot_id: measure-2025r1-sb659-introduced
status: current
...
# SB 659 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 659, 2025 Regular Session (2025R1)
...
- **Full text below:** Introduced version, 5094 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB659/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `d9e2b108fcab3bd256b0da894cd6e17c313edc2c2a578fddcd3f6df32f867a47` (snapshot `_meta/snapshots/measure-2025r1-sb659-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB659/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 659> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3321
title: 'HB 3321 (2025R1): Directs the Alcohol and Drug Policy Commission to develop and implement plans,
  including a statewide primary prevention strategy, that address the entire youth continuum of care and
  are designed to prevent the onset of substance use.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3321
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3321/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 3de1a1e037094213327139b17d1c457ed546f5af0488cbf02010e24621fdce67
snapshot_id: measure-2025r1-hb3321-enrolled
status: current
...
catch_line: Directs the Alcohol and Drug Policy Commission to develop and implement plans, including a
  statewide primary prevention strategy, that address the entire youth continuum of care and are designed
  to prevent the onset of substance use.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells the ADPC to create a statewide strategy for preventing substance\
  \ use. (Flesch Readability Score: 65.7). \n\tDirects the Alcohol and Drug Policy Commission to develop\
  \ and implement plans, including a statewide primary prevention strategy, that address the entire youth\
  \ continuum of care and are designed to prevent the onset of substance use. Requires the commission\
  \ to report to the Legislative Assembly on the commission's findings and recommendations no later than\
  \ September 15, 2026. \n\tDirects the commission, in collaboration with the Oregon Health and Science\
  \ University, to provide education and technical assistance to providers of youth substance use disorder\
  \ treatment and early intervention."
relating_to: Relating to primary prevention of substance use.
relating_to_full: Relating to primary prevention of substance use.
at_the_request_of: null
lc_number: 1062
measure_created_date: '2025-01-15T10:47:33'
...
# HB 3321 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3321, 2025 Regular Session (2025R1)
- **LC number:** 1062
- **Created:** 2025-01-15T10:47:33
- **Metadata last modified (upstream):** 2025-08-07T14:21:52
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 4885 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3321/Enrolled>.

## Summary

**Catchline:** Directs the Alcohol and Drug Policy Commission to develop and implement plans, including a statewide primary prevention strategy, that address the entire youth continuum of care and are designed to prevent the onset of substance use.
...
**RelatingToFull (verbatim upstream field):** Relating to primary prevention of substance use.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `3de1a1e037094213327139b17d1c457ed546f5af0488cbf02010e24621fdce67` (snapshot `_meta/snapshots/measure-2025r1-hb3321-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3321/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `86fa8eeb89f55c818ba10b70c02eb0345fa38fa03c2ee0639d115b90f7619b20` (snapshot `_meta/snapshots/measure-2025r1-hb3321-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3321/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3321` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

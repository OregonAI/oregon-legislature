...
jurisdiction: oregon
id: measure-2025r1-sjm8
title: 'SJM 8 (2025R1): Requests that the Federal Trade Commission and the National Institute of Standards
  and Technology coordinate on and provide to manufacturers of electronic devices voluntary criteria for
  a one through ten repair score that may be displayed to consumers at the point of sale.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Joint Memorial 8
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJM8/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4d6ca7f9c02bf7b89133442d6006070114a8a039b15dfb2525d5a4d5fb87ad47
snapshot_id: measure-2025r1-sjm8-introduced
status: current
...
catch_line: Requests that the Federal Trade Commission and the National Institute of Standards and Technology
  coordinate on and provide to manufacturers of electronic devices voluntary criteria for a one through
  ten repair score that may be displayed to consumers at the point of sale.
minority_catch_line: null
measure_summary: "\tDigest: Asks the FTC and the NIST to create a score system that ranks for consumers\
  \ how easy or hard it is to repair tech devices. (Flesch Readability Score: 76.5). \n\tRequests that\
  \ the Federal Trade Commission and the National Institute of Standards and Technology coordinate on\
  \ and provide to manufacturers of electronic devices voluntary criteria for a one through ten repair\
  \ score that may be displayed to consumers at the point of sale."
relating_to: Requesting the FTC and the NIST to coordinate on a repair score for consumer electronic devices.
relating_to_full: null
at_the_request_of: null
lc_number: 1813
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T14:47:08'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 6596
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SJM' and MeasureNumber eq 8`.

# SJM 8 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Joint Memorial 8, 2025 Regular Session (2025R1)
- **LC number:** 1813
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T14:47:08
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6596 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJM8/Introduced>.

## Summary

**Catchline:** Requests that the Federal Trade Commission and the National Institute of Standards and Technology coordinate on and provide to manufacturers of electronic devices voluntary criteria for a one through ten repair score that may be displayed to consumers at the point of sale.
...
LC 1813
Whereas a study cited in the FTC’s May 2021 report “Nixing the Fix: An FTC  Report to Con-
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `4d6ca7f9c02bf7b89133442d6006070114a8a039b15dfb2525d5a4d5fb87ad47` (snapshot `_meta/snapshots/measure-2025r1-sjm8-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJM8/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SJM' and MeasureNumber eq 8` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

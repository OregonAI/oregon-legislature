...
jurisdiction: oregon
id: measure-2025r1-hb2541
title: 'HB 2541 (2025R1): Provides certain agricultural workers with rights to express breast milk in
  the workplace.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2541
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2541/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: fb1a05c5a6d1d64f52a811168603f0a10e03fc83cf2a917c57329c05b927767f
snapshot_id: measure-2025r1-hb2541-enrolled
status: current
...
catch_line: Provides certain agricultural workers with rights to express breast milk in the workplace.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes laws regarding expressing breast milk at work. The Act takes\
  \ effect when the Governor signs it. (Flesch Readability Score: 76.9). \n\tProvides certain agricultural\
  \ workers with rights to express breast milk in the workplace. \n\tDeclares an emergency, effective\
  \ on passage."
relating_to: Relating to rights of certain agricultural workers to express milk in the workplace; and
  declaring an emergency.
relating_to_full: Relating to rights of certain agricultural workers to express milk in the workplace;
...
# HB 2541 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2541, 2025 Regular Session (2025R1)
- **LC number:** 3394
...
- **Full text below:** Enrolled version, 6225 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2541/Enrolled>.

## Summary

**Catchline:** Provides certain agricultural workers with rights to express breast milk in the workplace.

**Relating to:** Relating to rights of certain agricultural workers to express milk in the workplace; and declaring an emergency.

Digest: The Act changes laws regarding expressing breast milk at work. The Act takes effect when the Governor signs it. (Flesch Readability Score: 76.9). 
 Provides certain agricultural workers with rights to express breast milk in the workplace. 
 Declares an emergency, effective on passage.

**RelatingToFull (verbatim upstream field):** Relating to rights of certain agricultural workers to express milk in the workplace; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 653.020, ORS 653.077

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `fb1a05c5a6d1d64f52a811168603f0a10e03fc83cf2a917c57329c05b927767f` (snapshot `_meta/snapshots/measure-2025r1-hb2541-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2541/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `4d8efcef16ce6491daf2671d708f8705cd2953178c07c39a82291066f2968e0f` (snapshot `_meta/snapshots/measure-2025r1-hb2541-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2541/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2541` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

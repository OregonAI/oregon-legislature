...
jurisdiction: oregon
id: measure-2025r1-sb7
title: 'SB 7 (2025R1): Repeals the provision of law that prohibits transit workers from striking.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 7
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB7/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c035279f4eaa8ea34891620bacd8786f7e56c47432c206c782f6318df237ad3d
snapshot_id: measure-2025r1-sb7-introduced
status: current
...
catch_line: Repeals the provision of law that prohibits transit workers from striking.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes the law so that transit workers can strike. (Flesch Readability\
  \ Score: 87.9). \n\tRepeals the provision of law that prohibits transit workers from striking."
relating_to: Relating to strikes by transit workers.
relating_to_full: Relating to strikes by transit workers; amending ORS 243.726, 243.742 and 243.752; and
  repealing ORS 243.738.
at_the_request_of: null
lc_number: 4641
measure_created_date: '2025-03-05T15:00:38'
measure_modified_date: '2025-03-06T13:17:43'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 7737
...
# SB 7 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 7, 2025 Regular Session (2025R1)
- **LC number:** 4641
- **Created:** 2025-03-05T15:00:38
- **Metadata last modified (upstream):** 2025-03-06T13:17:43
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7737 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB7/Introduced>.

## Summary

**Catchline:** Repeals the provision of law that prohibits transit workers from striking.

**Relating to:** Relating to strikes by transit workers.

Digest: The Act changes the law so that transit workers can strike. (Flesch Readability Score: 87.9). 
 Repeals the provision of law that prohibits transit workers from striking.

**RelatingToFull (verbatim upstream field):** Relating to strikes by transit workers; amending ORS 243.726, 243.742 and 243.752; and repealing ORS 243.738.
...
standards.
Digest: The Act  changes the law so that transit workers can strike. (Flesch Readability Score:
87.9).
Repeals the provision of law that prohibits transit workers from striking.
A BILL FOR AN ACT
Relating to strikes by transit workers; amending ORS 243.726, 243.742 and 243.752;  and repealing
ORS 243.738.
Be It Enacted by the People of the State of Oregon:
SECTION 1.
ORS 243.738 is repealed.
SECTION 2.  ORS 243.726 is amended to read:
...
240.123, 243.650 to 243.809 and 341.290, providing  for compulsory arbitration, shall be liberally con-
strued.
...
SECTION 4.  ORS 243.752 is amended to read:
...
- From `RelatingToFull`: ORS 243.726, ORS 243.738, ORS 243.742, ORS 243.752
- From bill text (Introduced version): ORS 240.060, ORS 240.065, ORS 240.080, ORS 240.123, ORS 243.650, ORS 243.672, ORS 243.698, ORS 243.702, ORS 243.706, ORS 243.712, ORS 243.722, ORS 243.726, ORS 243.736, ORS 243.738, ORS 243.742, ORS 243.746, ORS 243.752, ORS 33.015

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `c035279f4eaa8ea34891620bacd8786f7e56c47432c206c782f6318df237ad3d` (snapshot `_meta/snapshots/measure-2025r1-sb7-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB7/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 7` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

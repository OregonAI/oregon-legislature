...
jurisdiction: oregon
id: measure-2025r1-hb3187
title: 'HB 3187 (2025R1): Makes it an unlawful employment practice for an employer to require or request
  disclosure of certain information regarding age and attendance or graduation dates.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3187
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3187/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: dcd43dfa651eefb5b440590c5f1c19e789e0c6ae898c0ef0dc34186c3275a64b
snapshot_id: measure-2025r1-hb3187-enrolled
status: current
...
catch_line: Makes it an unlawful employment practice for an employer to require or request disclosure
  of certain information regarding age and attendance or graduation dates.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes laws with respect to discrimination based on age. The Act\
  \ takes effect 91 days after adjournment. (Flesch Readability Score: 61.2). \n\t[<i>Clarifies the meaning\
  \ of \"because of age\" for purposes of employment discrimination law. Permits observing the terms of\
  \ a bona fide seniority system or bona fide employee benefit plan when taking an employment action.</i>]\
  \ \n\tMakes it an unlawful employment practice for an employer to require or request disclosure of certain\
  \ information regarding age and attendance or graduation dates. Provides exceptions. \n\tRemoves the\
  \ provision allowing age limits for the purpose of selecting apprentices to bring such conduct within\
  \ the scope of the unlawful discrimination statute. \n\tTakes effect on the 91st day following adjournment\
  \ sine die."
relating_to: Relating to age-based employment discrimination; and prescribing an effective date.
relating_to_full: Relating to age-based employment discrimination; and prescribing an effective date.
at_the_request_of: (at the request of AARP)
lc_number: 567
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3187>.

# HB 3187 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3187, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of AARP)
- **LC number:** 567
...
- **Full text below:** Enrolled version, 14593 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3187/Enrolled>.

## Summary

**Catchline:** Makes it an unlawful employment practice for an employer to require or request disclosure of certain information regarding age and attendance or graduation dates.
...
**RelatingToFull (verbatim upstream field):** Relating to age-based employment discrimination; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 192.311, ORS 419A.260, ORS 654.001, ORS 654.062, ORS 654.412, ORS 659A.030, ORS 659A.805, ORS 659A.820, ORS 660.002

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `dcd43dfa651eefb5b440590c5f1c19e789e0c6ae898c0ef0dc34186c3275a64b` (snapshot `_meta/snapshots/measure-2025r1-hb3187-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3187/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `0ec5097be8ae2a4373450269b8ca5e66abd50f29858283957a40e5a7efcd1deb` (snapshot `_meta/snapshots/measure-2025r1-hb3187-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3187/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3187> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

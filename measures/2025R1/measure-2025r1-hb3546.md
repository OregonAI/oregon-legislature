...
jurisdiction: oregon
id: measure-2025r1-hb3546
title: 'HB 3546 (2025R1): Directs the Public Utility Commission to provide for a classification of service
  for large energy use facilities.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3546
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3546/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ad6e91615780a711b595d25c2c7193d4080bc31688f36c6834fefd2581766731
snapshot_id: measure-2025r1-hb3546-enrolled
status: current
...
catch_line: Directs the Public Utility Commission to provide for a classification of service for large
  energy use facilities.
minority_catch_line: null
measure_summary: "\tDigest: Tells the PUC to provide for a class of service for facilities that use large\
  \ amounts of energy. (Flesch Readability Score: 66.3). \n\tDirects the Public Utility Commission to\
  \ provide for a classification of service for large energy use facilities. Requires any tariff schedule\
  \ adopted for the class to allocate the costs of serving large energy use facilities to the facilities\
  \ and mitigate the risks to other classes of retail electricity consumers. Defines \"large energy use\
  \ facility.\" \n\tDirects the commission to require an electric company to use a contract when providing\
  \ electricity service to a large energy use facility. Requires the contract to meet certain requirements\
  \ and conditions. \n\tDirects the commission to report each even-numbered year to the interim committees\
  \ of the Legislative Assembly related to energy on trends in load requirements and other implications\
  \ from large energy use facilities. Sunsets January 2, 2035. \n\tDeclares an emergency, effective on\
  \ passage."
relating_to: Relating to large energy use facilities; and declaring an emergency.
relating_to_full: Relating to large energy use facilities; and declaring an emergency.
at_the_request_of: null
lc_number: 1547
measure_created_date: '2025-02-10T09:01:03'
measure_modified_date: '2026-04-15T10:20:14'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3546`.

# HB 3546 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3546, 2025 Regular Session (2025R1)
- **LC number:** 1547
- **Created:** 2025-02-10T09:01:03
- **Metadata last modified (upstream):** 2026-04-15T10:20:14
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 9809 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3546/Enrolled>.

## Summary

**Catchline:** Directs the Public Utility Commission to provide for a classification of service for large energy use facilities.
...
**RelatingToFull (verbatim upstream field):** Relating to large energy use facilities; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 192.245, ORS 469A.205, ORS 469A.410, ORS 757.230, ORS 757.600, ORS 757.603

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `ad6e91615780a711b595d25c2c7193d4080bc31688f36c6834fefd2581766731` (snapshot `_meta/snapshots/measure-2025r1-hb3546-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3546/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `5c4856d8d712c2022728f7b65b22cc227ca9f3d5e6808e5769e680ff0e7d20b4` (snapshot `_meta/snapshots/measure-2025r1-hb3546-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3546/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3546` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

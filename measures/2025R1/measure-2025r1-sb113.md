...
jurisdiction: oregon
id: measure-2025r1-sb113
title: 'SB 113 (2025R1): Specifies how a person who holds a certified public accountant license from out
  of state may obtain a certificate to act as a certified public accountant in Oregon.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 113
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB113/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 610f181ccbfb818d67cbe0a92174e411a5e63431fb4716ed1637889b5999d229
snapshot_id: measure-2025r1-sb113-introduced
status: current
...
catch_line: Specifies how a person who holds a certified public accountant license from out of state may
  obtain a certificate to act as a certified public accountant in Oregon.
minority_catch_line: null
measure_summary: "\tDigest: The Act clarifies the process for CPAs from out of state to become CPAs in\
  \ Oregon. (Flesch Readability Score: 74.2). \n\tSpecifies how a person who holds a certified public\
  \ accountant license from out of state may obtain a certificate to act as a certified public accountant\
  \ in Oregon."
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 113>.

# SB 113 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 113, 2025 Regular Session (2025R1)
...
- **Full text below:** Introduced version, 3963 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB113/Introduced>.

## Summary

**Catchline:** Specifies how a person who holds a certified public accountant license from out of state may obtain a certificate to act as a certified public accountant in Oregon.
...
- From bill text (Introduced version): ORS 673.010, ORS 673.150

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `610f181ccbfb818d67cbe0a92174e411a5e63431fb4716ed1637889b5999d229` (snapshot `_meta/snapshots/measure-2025r1-sb113-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB113/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 113> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

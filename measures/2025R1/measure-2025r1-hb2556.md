...
jurisdiction: oregon
id: measure-2025r1-hb2556
title: 'HB 2556 (2025R1): Designates Portland State University as Oregon''s Urban Research University.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2556
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2556/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c5373c181f59330f54c9de17f16a956c57f9d57d71e8a8a55ed8f53d801c924b
snapshot_id: measure-2025r1-hb2556-enrolled
status: current
...
catch_line: Designates Portland State University as Oregon's Urban Research University.
minority_catch_line: null
measure_summary: "\tDigest: The Act names PSU as this state's urban research school. (Flesch Readability\
  \ Score: 86.7). \n\tDesignates Portland State University as Oregon's Urban Research University."
relating_to: Relating to Portland State University designation.
relating_to_full: Relating to Portland State University designation.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2556>.

# HB 2556 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2556, 2025 Regular Session (2025R1)
- **LC number:** 1620
...
- **Full text below:** Enrolled version, 7242 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2556/Enrolled>.

## Summary

**Catchline:** Designates Portland State University as Oregon's Urban Research University.
...
**RelatingToFull (verbatim upstream field):** Relating to Portland State University designation.
...
Enrolled House Bill 2556 (HB 2556-INTRO) Page 1
Whereas Portland State University was awarded  a 5-year grant under its Asian American and
...
Enrolled House Bill 2556 (HB 2556-INTRO) Page 2
...
Enrolled House Bill 2556 (HB 2556-INTRO) Page 3
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `c5373c181f59330f54c9de17f16a956c57f9d57d71e8a8a55ed8f53d801c924b` (snapshot `_meta/snapshots/measure-2025r1-hb2556-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2556/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `f0af3d24ed373a3d77879b8bce9fef6ba2dea1a131148bc00a6fc60c22c1173c` (snapshot `_meta/snapshots/measure-2025r1-hb2556-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2556/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2556> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

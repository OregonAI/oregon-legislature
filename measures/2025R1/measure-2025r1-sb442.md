...
jurisdiction: oregon
id: measure-2025r1-sb442
title: 'SB 442 (2025R1): Establishes the COFA Shared Services Office to assist COFA citizens in applying
  for and accessing benefits and services.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 442
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB442/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a32e2f8991ada1d6a1dcaa0c21fe0fcf19bd61f6b170725d1c3a301674ff4d33
snapshot_id: measure-2025r1-sb442-introduced
status: current
...
catch_line: Establishes the COFA Shared Services Office to assist COFA citizens in applying for and accessing
  benefits and services.
minority_catch_line: null
measure_summary: "\tDigest: The Act creates the COFA Shared Services Office. (Flesch Readability Score:\
  \ 82.3). \n\tEstablishes the COFA Shared Services Office to assist COFA citizens in applying for and\
  \ accessing benefits and services. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to services for COFA citizens; prescribing an effective date.
relating_to_full: Relating to services for COFA citizens; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 442`.

# SB 442 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 442, 2025 Regular Session (2025R1)
- **LC number:** 235
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-04-15T09:52:15
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4448 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB442/Introduced>.

## Summary

**Catchline:** Establishes the COFA Shared Services Office to assist COFA citizens in applying for and accessing benefits and services.
...
**RelatingToFull (verbatim upstream field):** Relating to services for COFA citizens; and prescribing an effective date.
...
LC 235
by COFA citizens, about the office’s services.
...
- From bill text (Introduced version): ORS 192.245, ORS 414.025, ORS 414.665

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `a32e2f8991ada1d6a1dcaa0c21fe0fcf19bd61f6b170725d1c3a301674ff4d33` (snapshot `_meta/snapshots/measure-2025r1-sb442-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB442/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 442` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb485
title: 'SB 485 (2025R1): Modifies the exemption from taxable estate for the value of natural resource
  property as applicable to forestland.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 485
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB485/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 95e151ec75c76c415907edb899f0fd6c6d061a6ab79a7b0888f33e573d08ff3c
...
catch_line: Modifies the exemption from taxable estate for the value of natural resource property as applicable
  to forestland.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act would expand the conditions under which small forestlands are exempt\
  \ from estate tax. (Flesch Readability Score: 61.8).</b> \n\t[<i>Digest: The Act would repeal the estate\
  \ tax. (Flesch Readability Score: 90.9).</i>] \n\t[<i>Provides that the Oregon estate tax is imposed\
  \ only on the estates of decedents dying on or before January 1, 2025.</i>] \n\t<b>Modifies the exemption\
  \ from taxable estate for the value of natural resource property as applicable to forestland. Limits\
  \ the exemption to small forestland owners and allows an exemption based on active management appropriate\
  \ for the current phase of the forest management cycle. \n\tApplies to estates of decedents dying on\
  \ or after January 1, 2026.</b> \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to estate tax; and prescribing an effective date.
relating_to_full: Relating to estate tax; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 485`.

# SB 485 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 485, 2025 Regular Session (2025R1)
- **LC number:** 1746
...
- **Full text below:** Enrolled version, 6429 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB485/Enrolled>.

## Summary

**Catchline:** Modifies the exemption from taxable estate for the value of natural resource property as applicable to forestland.
...
**RelatingToFull (verbatim upstream field):** Relating to estate tax; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 118.005, ORS 118.140, ORS 118.145

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `95e151ec75c76c415907edb899f0fd6c6d061a6ab79a7b0888f33e573d08ff3c` (snapshot `_meta/snapshots/measure-2025r1-sb485-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB485/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `b173783ea473e39563de1f3f4838b85591beb86d38a367789ba79cb5d295d2b8` (snapshot `_meta/snapshots/measure-2025r1-sb485-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB485/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 485` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3519
title: 'HB 3519 (2025R1): Directs the Department of Education to provide oversight of a program that coordinates
  an in-state and a national cultural exchange for students of this state.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3519
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3519/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 8daae75eeb906a0732cd36167e12c8df302c44524556466a936686c7a53c978a
snapshot_id: measure-2025r1-hb3519-introduced
status: current
...
catch_line: Directs the Department of Education to provide oversight of a program that coordinates an
  in-state and a national cultural exchange for students of this state.
minority_catch_line: null
measure_summary: "\tDigest: Creates a program to provide for a cultural exchange for students. (Flesch\
  \ Readability Score: 64.9). \n\tDirects the Department of Education to provide oversight of a program\
  \ that coordinates an in-state and a national cultural exchange for students of this state. Prescribes\
  \ the requirements of the program. Directs the department to transfer moneys from the Statewide Education\
  \ Initiatives Account for the program. \n\tDeclares an emergency, effective July 1, 2025."
relating_to: Relating to a cultural exchange program; declaring an emergency.
relating_to_full: Relating to a cultural exchange program; creating new provisions; amending ORS 327.254;
  and declaring an emergency.
at_the_request_of: null
lc_number: 2252
measure_created_date: '2025-02-05T13:57:55'
...
# HB 3519 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3519, 2025 Regular Session (2025R1)
- **LC number:** 2252
- **Created:** 2025-02-05T13:57:55
- **Metadata last modified (upstream):** 2025-02-11T09:09:21
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 11676 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3519/Introduced>.

## Summary

**Catchline:** Directs the Department of Education to provide oversight of a program that coordinates an in-state and a national cultural exchange for students of this state.

**Relating to:** Relating to a cultural exchange program; declaring an emergency.

Digest: Creates a program to provide for a cultural exchange for students. (Flesch Readability Score: 64.9). 
 Directs the Department of Education to provide oversight of a program that coordinates an in-state and a national cultural exchange for students of this state. Prescribes the requirements of the program. Directs the department to transfer moneys from the Statewide Education Initiatives Account for the program. 
 Declares an emergency, effective July 1, 2025.

**RelatingToFull (verbatim upstream field):** Relating to a cultural exchange program; creating new provisions; amending ORS 327.254; and declaring an emergency.
...
LC 2252
committees of  the Legislative Assembly related to education on the number of students,
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `8daae75eeb906a0732cd36167e12c8df302c44524556466a936686c7a53c978a` (snapshot `_meta/snapshots/measure-2025r1-hb3519-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3519/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3519` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

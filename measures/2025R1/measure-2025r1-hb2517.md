...
jurisdiction: oregon
id: measure-2025r1-hb2517
title: 'HB 2517 (2025R1): Directs the State Board of Education to adopt by rule criteria by which a school
  district is required to participate in an intensive program for school districts with the highest needs
  or may choose to participate in the program.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2517
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2517/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 30f99051fd96484d8c337a5168d9c72742eddcaeda4b2f5d9db0fdcbea6bc8f6
snapshot_id: measure-2025r1-hb2517-introduced
status: current
...
catch_line: Directs the State Board of Education to adopt by rule criteria by which a school district
  is required to participate in an intensive program for school districts with the highest needs or may
  choose to participate in the program.
minority_catch_line: null
measure_summary: "\tDigest: Tells the State Board of Education to adopt rules for the intensive program\
  \ for school districts. (Flesch Readability Score: 63.6). \n\tDirects the State Board of Education to\
  \ adopt by rule criteria by which a school district is required to participate in an intensive program\
  \ for school districts with the highest needs or may choose to participate in the program."
relating_to: Relating to intensive program for school districts with the highest needs.
relating_to_full: Relating to intensive program for school districts with the highest needs; amending
  ORS 327.222.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2517`.

# HB 2517 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2517, 2025 Regular Session (2025R1)
...
- **Full text below:** Introduced version, 5773 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2517/Introduced>.

## Summary

**Catchline:** Directs the State Board of Education to adopt by rule criteria by which a school district is required to participate in an intensive program for school districts with the highest needs or may choose to participate in the program.

**Relating to:** Relating to intensive program for school districts with the highest needs.

Digest: Tells the State Board of Education to adopt rules for the intensive program for school districts. (Flesch Readability Score: 63.6). 
 Directs the State Board of Education to adopt by rule criteria by which a school district is required to participate in an intensive program for school districts with the highest needs or may choose to participate in the program.

**RelatingToFull (verbatim upstream field):** Relating to intensive program for school districts with the highest needs; amending ORS 327.222.
...
LC 1955
(4) A school district that [ agrees to participate ] participates in the intensive program shall:
...
- From `RelatingToFull`: ORS 327.222
- From bill text (Introduced version): ORS 327.137, ORS 327.141, ORS 327.195, ORS 327.201, ORS 327.222

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `30f99051fd96484d8c337a5168d9c72742eddcaeda4b2f5d9db0fdcbea6bc8f6` (snapshot `_meta/snapshots/measure-2025r1-hb2517-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2517/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2517` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

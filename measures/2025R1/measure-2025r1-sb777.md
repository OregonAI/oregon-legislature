...
jurisdiction: oregon
id: measure-2025r1-sb777
title: 'SB 777 (2025R1): Directs the State Department of Agriculture to modify the methodology under which
  participating counties award grants for wolf depredation compensation.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 777
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB777/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 95d61901fe78a0d5deae6de805470387cffb3f59e89cb8525ba5114a5683373b
snapshot_id: measure-2025r1-sb777-enrolled
status: current
...
catch_line: Directs the State Department of Agriculture to modify the methodology under which participating
  counties award grants for wolf depredation compensation.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act tells the State DOA to change the methods used to determine wolf\
  \ attack loss grants. The Act requires counties to report to the DOA and the DOA to report to the legislature\
  \ on payments made. (Flesch Readability Score: 76.2).</b> \n\t[<i>Digest: The Act provides that payments\
  \ for injury to livestock or working dogs must be based on fair market value and other factors. The\
  \ Act caps payments. The Act removes payment for lost livestock. (Flesch Readability Score: 70.9).</i>]\
  \ \n\t[<i>Provides that compensation for injury to livestock or working dogs under the wolf depredation\
  \ compensation and financial assistance grant program must be based on fair market value and other factors.\
  \ Caps compensation at $25,000 per animal. Removes the provision authorizing compensation for missing\
  \ livestock.</i>] \n\t<b>Directs the State Department of Agriculture to modify the methodology under\
  \ which participating counties award grants for wolf depredation compensation. Establishes reporting\
  \ requirements for counties and for the department to report to the Legislative Assembly on financial\
  \ assistance provided under the program.</b>"
relating_to: Relating to the depredation of livestock.
relating_to_full: Relating to the depredation of livestock.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 777>.

# SB 777 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 777, 2025 Regular Session (2025R1)
- **LC number:** 1671
...
- **Full text below:** Enrolled version, 10306 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB777/Enrolled>.

## Summary

**Catchline:** Directs the State Department of Agriculture to modify the methodology under which participating counties award grants for wolf depredation compensation.
...
**RelatingToFull (verbatim upstream field):** Relating to the depredation of livestock.
...
- From bill text (Enrolled version): ORS 192.245, ORS 610.150, ORS 610.155

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `95d61901fe78a0d5deae6de805470387cffb3f59e89cb8525ba5114a5683373b` (snapshot `_meta/snapshots/measure-2025r1-sb777-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB777/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `fb6fbee56c599d42372bbee5a6a14521e5715df27e9aa729ec77f93b1c8ffb10` (snapshot `_meta/snapshots/measure-2025r1-sb777-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB777/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 777> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

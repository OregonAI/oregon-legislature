...
jurisdiction: oregon
id: measure-2025r1-sb1128
title: 'SB 1128 (2025R1): Provides that a police officer or firefighter member of the Public Employees
  Retirement System is considered disabled if the member is unable to perform the work the member performed
  at the time the member became disabled.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1128
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1128/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 69de33153f32977f3be5cb0f616298de90701df14b7e45372c6dc2c0eb038528
snapshot_id: measure-2025r1-sb1128-introduced
status: current
...
catch_line: Provides that a police officer or firefighter member of the Public Employees Retirement System
  is considered disabled if the member is unable to perform the work the member performed at the time
  the member became disabled.
minority_catch_line: null
measure_summary: "\tDigest: The Act says that a police officer or firefighter member is disabled for PERS\
  \ if the member can't go back to the job they had. (Flesch Readability Score: 63.0). \n\tProvides that\
  \ a police officer or firefighter member of the Public Employees Retirement System is considered disabled\
  \ if the member is unable to perform the work the member performed at the time the member became disabled."
relating_to: Relating to disability under the Public Employees Retirement System.
relating_to_full: Relating to disability under the Public Employees Retirement System; creating new provisions;
  and amending ORS 238.320, 238.325, 238.340, 238A.155 and 238A.235.
at_the_request_of: null
lc_number: 4425
measure_created_date: '2025-02-25T10:29:56'
measure_modified_date: '2025-03-03T15:31:34'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 25351
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1128`.

# SB 1128 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1128, 2025 Regular Session (2025R1)
- **LC number:** 4425
- **Created:** 2025-02-25T10:29:56
- **Metadata last modified (upstream):** 2025-03-03T15:31:34
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 25351 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1128/Introduced>.

## Summary

**Catchline:** Provides that a police officer or firefighter member of the Public Employees Retirement System is considered disabled if the member is unable to perform the work the member performed at the time the member became disabled.

**Relating to:** Relating to disability under the Public Employees Retirement System.

Digest: The Act says that a police officer or firefighter member is disabled for PERS if the member can't go back to the job they had. (Flesch Readability Score: 63.0). 
...
**RelatingToFull (verbatim upstream field):** Relating to disability under the Public Employees Retirement System; creating new provisions; and amending ORS 238.320, 238.325, 238.340, 238A.155 and 238A.235.
...
in the  system shall receive separation benefits or service retirement benefits as provided in this
chapter.]
...
SECTION 6.
The amendments to ORS 238.320, 238.325, 238.340, 238A.155 and 238A.235 by
...
- From `RelatingToFull`: ORS 238.320, ORS 238.325, ORS 238.340, ORS 238A.155, ORS 238A.235
- From bill text (Introduced version): ORS 238.320, ORS 238.325, ORS 238.340, ORS 238.390, ORS 238.395, ORS 238A.100, ORS 238A.140, ORS 238A.155, ORS 238A.160, ORS 238A.165, ORS 238A.180, ORS 238A.185, ORS 238A.235, ORS 238A.353

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `69de33153f32977f3be5cb0f616298de90701df14b7e45372c6dc2c0eb038528` (snapshot `_meta/snapshots/measure-2025r1-sb1128-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1128/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1128` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

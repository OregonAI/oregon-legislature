...
jurisdiction: oregon
id: measure-2025r1-sb1148
title: 'SB 1148 (2025R1): Prohibits disability income insurers from requiring a person to use or apply
  for other available benefits for which the person is eligible prior to being eligible for disability
  benefits offered by the insurer.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1148
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1148/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ec907104ecc20e05debfa3216de7f2d049137e6d19ceef4d593a7d6ad82456d9
snapshot_id: measure-2025r1-sb1148-enrolled
status: current
...
catch_line: Prohibits disability income insurers from requiring a person to use or apply for other available
  benefits for which the person is eligible prior to being eligible for disability benefits offered by
  the insurer.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes changes to laws with respect to certain insurance policies.\
  \ (Flesch Readability Score: 60.7). \n\tProhibits disability income insurers from requiring a person\
  \ to use <b>or apply for</b> other available benefits for which the person is eligible prior to being\
  \ eligible for disability benefits offered by the insurer."
relating_to: Relating to disability income insurance policies.
relating_to_full: Relating to disability income insurance policies.
at_the_request_of: null
lc_number: 4455
measure_created_date: '2025-02-25T14:20:32'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1148`.

# SB 1148 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1148, 2025 Regular Session (2025R1)
- **LC number:** 4455
- **Created:** 2025-02-25T14:20:32
- **Metadata last modified (upstream):** 2025-06-06T16:06:36
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 12918 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1148/Enrolled>.

## Summary

**Catchline:** Prohibits disability income insurers from requiring a person to use or apply for other available benefits for which the person is eligible prior to being eligible for disability benefits offered by the insurer.
...
**RelatingToFull (verbatim upstream field):** Relating to disability income insurance policies.
...
- From bill text (Enrolled version): ORS 743B.260

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `ec907104ecc20e05debfa3216de7f2d049137e6d19ceef4d593a7d6ad82456d9` (snapshot `_meta/snapshots/measure-2025r1-sb1148-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1148/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `706e852fc9d75c246e36e8a5856d5f6a217976f8134134dfc91d633b453afab6` (snapshot `_meta/snapshots/measure-2025r1-sb1148-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1148/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1148` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

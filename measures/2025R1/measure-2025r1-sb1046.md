...
jurisdiction: oregon
id: measure-2025r1-sb1046
title: 'SB 1046 (2025R1): Directs the State Department of Fish and Wildlife to provide the Secretary of
  State with electronic records containing the legal name, age, residence and citizenship information
  and electronic signature of each person who may qualify as an elector as prescribed by the secretary
  by rule.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1046
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1046/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4092e3ae8a8bd475625031c58a48995cba4aa50b7aabfc1e36615a3c294331e5
snapshot_id: measure-2025r1-sb1046-introduced
status: current
...
catch_line: Directs the State Department of Fish and Wildlife to provide the Secretary of State with electronic
  records containing the legal name, age, residence and citizenship information and electronic signature
  of each person who may qualify as an elector as prescribed by the secretary by rule.
minority_catch_line: null
measure_summary: "\tDigest: The Act directs the DFW to provide the SOS with certain data on persons who\
  \ may qualify to vote in this state. (Flesch Readability Score: 72.9). \n\tDirects the State Department\
  \ of Fish and Wildlife to provide the Secretary of State with electronic records containing the legal\
  \ name, age, residence and citizenship information and electronic signature of each person who may qualify\
  \ as an elector as prescribed by the secretary by rule. Directs the secretary to register as an elector\
  \ each nonregistered person whose electronic records the secretary receives from the State Department\
  \ of Fish and Wildlife and who is qualified to vote. \n\tBecomes operative on June 1, 2027."
relating_to: Relating to voter registration through the State Department of Fish and Wildlife.
relating_to_full: Relating to voter registration through the State Department of Fish and Wildlife; creating
  new provisions; and amending ORS 247.002, 247.012, 247.014 and 247.017.
...
# SB 1046 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1046, 2025 Regular Session (2025R1)
- **LC number:** 3880
- **Created:** 2025-02-13T08:16:51
- **Metadata last modified (upstream):** 2025-02-18T13:31:46
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 11593 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1046/Introduced>.

## Summary

**Catchline:** Directs the State Department of Fish and Wildlife to provide the Secretary of State with electronic records containing the legal name, age, residence and citizenship information and electronic signature of each person who may qualify as an elector as prescribed by the secretary by rule.
...
**RelatingToFull (verbatim upstream field):** Relating to voter registration through the State Department of Fish and Wildlife; creating new provisions; and amending ORS 247.002, 247.012, 247.014 and 247.017.
...
LC 3880
may by rule develop, and require the availability or use of, any form or application  the department
...
1 to 4 of this 2025 Act become operative on June 1, 2027.
...
- From `RelatingToFull`: ORS 247.002, ORS 247.012, ORS 247.014, ORS 247.017
- From bill text (Introduced version): ORS 247.002, ORS 247.012, ORS 247.014, ORS 247.017, ORS 247.018, ORS 247.019, ORS 247.125, ORS 247.171, ORS 247.208

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `4092e3ae8a8bd475625031c58a48995cba4aa50b7aabfc1e36615a3c294331e5` (snapshot `_meta/snapshots/measure-2025r1-sb1046-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1046/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1046> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

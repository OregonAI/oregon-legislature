...
jurisdiction: oregon
id: measure-2025r1-hb2687
title: 'HB 2687 (2025R1): Removes a provision that excluded certain temporary agricultural workers from
  grant eligibility.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2687
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2687/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 87daa2dc3b0f1dc159007a390d0e713adde0b55aa83b5c05e136c90ff955a87d
snapshot_id: measure-2025r1-hb2687-introduced
status: current
...
catch_line: Removes a provision that excluded certain temporary agricultural workers from grant eligibility.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes the requirements to qualify for a certain grant program. The\
  \ Act takes effect 91 days after sine die. (Flesch Readability Score: 67.2). \n\tRemoves a provision\
  \ that excluded certain temporary agricultural workers from grant eligibility. \n\tTakes effect on the\
  \ 91st day following adjournment sine die."
relating_to: Relating to a grant program for improving the health and safety of agricultural workforce
  housing; prescribing an effective date.
relating_to_full: Relating to a grant program for improving the health and safety of agricultural workforce
  housing; amending section 67, chapter 13, Oregon Laws 2023; and prescribing an effective date.
...
# HB 2687 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2687, 2025 Regular Session (2025R1)
- **LC number:** 3675
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:27:44
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4146 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2687/Introduced>.

## Summary

**Catchline:** Removes a provision that excluded certain temporary agricultural workers from grant eligibility.
...
**RelatingToFull (verbatim upstream field):** Relating to a grant program for improving the health and safety of agricultural workforce housing; amending section 67, chapter 13, Oregon Laws 2023; and prescribing an effective date.
...
LC 3675
[(e)] (d) Must comply with any adopted rules, as described in subsection (2)(b) of this section.
...
- From bill text (Introduced version): ORS 315.163, ORS 658.730, ORS 658.750

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `87daa2dc3b0f1dc159007a390d0e713adde0b55aa83b5c05e136c90ff955a87d` (snapshot `_meta/snapshots/measure-2025r1-hb2687-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2687/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2687> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3547
title: 'HB 3547 (2025R1): Exempts institutions for mental diseases from the requirement to obtain a certificate
  of need from the Oregon Health Authority.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3547
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3547/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a15f3f86a79dcab34287db393ea4cae7918a20a2499686a9e0cd6bb7d26fb769
snapshot_id: measure-2025r1-hb3547-introduced
status: current
...
catch_line: Exempts institutions for mental diseases from the requirement to obtain a certificate of need
  from the Oregon Health Authority.
minority_catch_line: null
measure_summary: "\tDigest: The Act creates an exemption from the certificate of need process. (Flesch\
  \ Readability Score: 64.9). \n\tExempts institutions for mental diseases from the requirement to obtain\
  \ a certificate of need from the Oregon Health Authority. \n\tTakes effect on the 91st day following\
  \ adjournment sine die."
relating_to: Relating to certificates of need; prescribing an effective date.
relating_to_full: Relating to certificates of need; amending ORS 442.315; and prescribing an effective
  date.
at_the_request_of: null
lc_number: 4088
measure_created_date: '2025-02-10T09:12:57'
...
# HB 3547 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3547, 2025 Regular Session (2025R1)
- **LC number:** 4088
- **Created:** 2025-02-10T09:12:57
- **Metadata last modified (upstream):** 2025-02-12T13:30:13
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6468 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3547/Introduced>.

## Summary

**Catchline:** Exempts institutions for mental diseases from the requirement to obtain a certificate of need from the Oregon Health Authority.

**Relating to:** Relating to certificates of need; prescribing an effective date.

Digest: The Act creates an exemption from the certificate of need process. (Flesch Readability Score: 64.9). 
...
**RelatingToFull (verbatim upstream field):** Relating to certificates of need; amending ORS 442.315; and prescribing an effective date.
...
standards.
Digest: The Act creates an exemption from the certificate of need process.  (Flesch Readability
Score: 64.9).
Exempts institutions for mental diseases from the requirement to obtain a certificate of  need
from the Oregon Health Authority.
Takes effect on the 91st day following adjournment sine die.
A BILL FOR AN ACT
Relating to certificates of need; amending ORS 442.315; and prescribing an effective date.
...
intermediate care service or facility is:
(a) Excluded pursuant to ORS 441.065; or
(b) An institution for mental diseases, as defined in 42 U.S.C. 1396d(i) .
...
- From `RelatingToFull`: ORS 442.315
- From bill text (Introduced version): ORS 441.065, ORS 442.315, ORS 442.470

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `a15f3f86a79dcab34287db393ea4cae7918a20a2499686a9e0cd6bb7d26fb769` (snapshot `_meta/snapshots/measure-2025r1-hb3547-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3547/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3547` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2375
title: 'HB 2375 (2025R1): Requires a person who is developing or repowering a wind energy facility to
  apply to the Federal Aviation Administration and, if applicable, the Federal Communications Commission,
  for approval for the installation and use of light-mitigating technology systems and, if approved, install
  the systems within 24 months or as soon as reasonably practicable thereafter.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2375
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2375/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 73f2433ffc6b64f8c9cd8f521c3d0868c680aba2a299bd991e87685feb2dc504
snapshot_id: measure-2025r1-hb2375-enrolled
status: current
...
catch_line: Requires a person who is developing or repowering a wind energy facility to apply to the Federal
  Aviation Administration and, if applicable, the Federal Communications Commission, for approval for
  the installation and use of light-mitigating technology systems and, if approved, install the systems
  within 24 months or as soon as reasonably practicable thereafter.
minority_catch_line: null
measure_summary: "\t<b>Digest: Makes a person who builds or updates a wind power facility apply to the\
  \ FAA or FCC to put in a system to reduce lighting. (Flesch Readability Score: 63.3).</b> \n\t[<i>Digest:\
  \ Makes a person who builds or updates a wind power facility apply to the FAA to put in a system to\
  \ reduce lighting. (Flesch Readability Score: 62.1).</i>] \n\tRequires a person who is developing or\
  \ repowering a wind energy facility to apply to the Federal Aviation Administration <b>and, if applicable,\
  \ the Federal Communications Commission, for approval</b> for <b>the</b> installation <b>and use</b>\
  \ of [<i>a</i>] light-mitigating technology [<i>system</i>] <b>systems</b> and, if approved, install\
  \ the [<i>system</i>] <b>systems</b> within 24 months<b> or as soon as reasonably practicable thereafter</b>.\
  \ \n\t<b>Prohibits a county or city from allowing or permitting a wind energy facility if the person\
  \ seeking to develop or repower the wind energy facility does not apply for approval for the installation\
  \ and use of light-mitigating technology systems.</b>"
relating_to: Relating to wind energy facilities.
relating_to_full: Relating to wind energy facilities.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2375`.

# HB 2375 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2375, 2025 Regular Session (2025R1)
- **LC number:** 666
...
- **Full text below:** Enrolled version, 5698 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2375/Enrolled>.

## Summary

**Catchline:** Requires a person who is developing or repowering a wind energy facility to apply to the Federal Aviation Administration and, if applicable, the Federal Communications Commission, for approval for the installation and use of light-mitigating technology systems and, if approved, install the systems within 24 months or as soon as reasonably practicable thereafter.
...
**RelatingToFull (verbatim upstream field):** Relating to wind energy facilities.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `73f2433ffc6b64f8c9cd8f521c3d0868c680aba2a299bd991e87685feb2dc504` (snapshot `_meta/snapshots/measure-2025r1-hb2375-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2375/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `0d3062b05e8145f80fad25d27f190797f783cf9917cb1612cf1bcffaf469e2ec` (snapshot `_meta/snapshots/measure-2025r1-hb2375-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2375/Introduced>.

...
jurisdiction: oregon
id: measure-2025r1-hb2055
title: 'HB 2055 (2025R1): Provides that when offering a service with age restrictions, a private entity
  is allowed to swipe a driver''s license to verify a person''s age, regardless of how old the person
  looks.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2055
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2055/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 25d4f1b4194f9c3bbb3b9e679b3f61b0bfea5ae4553a7081a2c1b326afbfc53a
snapshot_id: measure-2025r1-hb2055-introduced
status: current
...
catch_line: Provides that when offering a service with age restrictions, a private entity is allowed to
  swipe a driver's license to verify a person's age, regardless of how old the person looks.
minority_catch_line: null
measure_summary: "\tDigest: The Act says that a private entity may swipe a driver's license to confirm\
  \ a person's age, regardless of how old the person looks. (Flesch Readability Score: 62.6). \n\tProvides\
  \ that when offering a service with age restrictions, a private entity is allowed to swipe a driver's\
  \ license to verify a person's age, regardless of how old the person looks."
relating_to: Relating to swiping driver licenses.
relating_to_full: Relating to swiping driver licenses; amending ORS 807.750.
at_the_request_of: null
lc_number: 3119
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-02-23T21:20:55'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2055`.

# HB 2055 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2055, 2025 Regular Session (2025R1)
- **LC number:** 3119
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-02-23T21:20:55
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 8498 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2055/Introduced>.

## Summary

**Catchline:** Provides that when offering a service with age restrictions, a private entity is allowed to swipe a driver's license to verify a person's age, regardless of how old the person looks.

**Relating to:** Relating to swiping driver licenses.

Digest: The Act says that a private entity may swipe a driver's license to confirm a person's age, regardless of how old the person looks. (Flesch Readability Score: 62.6). 
...
**RelatingToFull (verbatim upstream field):** Relating to swiping driver licenses; amending ORS 807.750.
...
standards.
Digest: The Act says that a private entity may swipe a driver’s  license to confirm a person’s
age, regardless of how old the person looks. (Flesch Readability Score: 62.6).
Provides that when offering a service with age restrictions, a  private entity is allowed to swipe
a driver’s license to verify a person’s age, regardless of how old the person looks.
A BILL FOR AN ACT
...
- From `RelatingToFull`: ORS 807.750
- From bill text (Introduced version): ORS 475.230, ORS 689.005, ORS 706.008, ORS 807.400, ORS 807.750

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `25d4f1b4194f9c3bbb3b9e679b3f61b0bfea5ae4553a7081a2c1b326afbfc53a` (snapshot `_meta/snapshots/measure-2025r1-hb2055-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2055/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2055` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb821
title: 'SB 821 (2025R1): Removes the deadline by which the State Board of Parole and Post-Prison Supervision
  is required to assess existing sex offender registrants into a risk level.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 821
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB821/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b9041231a157922162036270c3b5b13dcd340252e78bb5a0f4ee742a2c70c48b
snapshot_id: measure-2025r1-sb821-introduced
status: current
...
catch_line: Removes the deadline by which the State Board of Parole and Post-Prison Supervision is required
  to assess existing sex offender registrants into a risk level.
minority_catch_line: null
measure_summary: "\tDigest: The Act takes away the deadline for the parole board to assess some sex offenders\
  \ into a risk level. The Act also repeals the sunset on the law that makes the board report to the legislature\
  \ on risk level assessments every two years. (Flesch Readability Score: 61.0). \n\tRemoves the deadline\
  \ by which the State Board of Parole and Post-Prison Supervision is required to assess existing sex\
  \ offender registrants into a risk level. \n\tRepeals the sunset on the requirement that the board report\
  \ biennially to the Legislative Assembly on risk assessments."
relating_to: Relating to sex offender risk levels.
relating_to_full: Relating to sex offender risk levels; amending section 7, chapter 708, Oregon Laws 2013,
  and section 2, chapter 430, Oregon Laws 2019; and repealing section 22, chapter 430, Oregon Laws 2019.
...
measure_modified_date: '2025-01-17T14:42:50'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 7693
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 821`.

# SB 821 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 821, 2025 Regular Session (2025R1)
...
- **Metadata last modified (upstream):** 2025-01-17T14:42:50
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7693 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB821/Introduced>.

## Summary

**Catchline:** Removes the deadline by which the State Board of Parole and Post-Prison Supervision is required to assess existing sex offender registrants into a risk level.
...
**RelatingToFull (verbatim upstream field):** Relating to sex offender risk levels; amending section 7, chapter 708, Oregon Laws 2013, and section 2, chapter 430, Oregon Laws 2019; and repealing section 22, chapter 430, Oregon Laws 2019.
...
- From bill text (Introduced version): ORS 137.765, ORS 163A.010, ORS 163A.100, ORS 163A.105, ORS 163A.110, ORS 163A.115, ORS 163A.125, ORS 163A.200, ORS 163A.225, ORS 192.245

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `b9041231a157922162036270c3b5b13dcd340252e78bb5a0f4ee742a2c70c48b` (snapshot `_meta/snapshots/measure-2025r1-sb821-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB821/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 821` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

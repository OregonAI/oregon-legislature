...
jurisdiction: oregon
id: measure-2025r1-sb1024
title: 'SB 1024 (2025R1): Expands authority of the Department of Transportation to enter into intergovernmental
  agreements with cities and counties to remove personal property left on property that is owned by the
  department.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1024
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1024/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 3e17c72d65ca603d2a87277dbec18ca2183d3d37b1d84d1b2a985850eb68c4b1
snapshot_id: measure-2025r1-sb1024-introduced
status: current
...
catch_line: Expands authority of the Department of Transportation to enter into intergovernmental agreements
  with cities and counties to remove personal property left on property that is owned by the department.
minority_catch_line: null
measure_summary: "\tDigest: The Act lets ODOT work with cities and counties to remove things left in the\
  \ highway right of way. (Flesch Readability Score: 80.6). \n\tExpands authority of the Department of\
  \ Transportation to enter into intergovernmental agreements with cities and counties to remove personal\
  \ property left on property that is owned by the department."
relating_to: Relating to removal of personal property on highway right of way.
relating_to_full: Relating to removal of personal property on highway right of way; amending ORS 195.515.
at_the_request_of: null
lc_number: 3762
measure_created_date: '2025-02-11T10:50:51'
measure_modified_date: '2025-06-28T16:43:45'
...
# SB 1024 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1024, 2025 Regular Session (2025R1)
- **LC number:** 3762
- **Created:** 2025-02-11T10:50:51
- **Metadata last modified (upstream):** 2025-06-28T16:43:45
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4731 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1024/Introduced>.

## Summary

**Catchline:** Expands authority of the Department of Transportation to enter into intergovernmental agreements with cities and counties to remove personal property left on property that is owned by the department.
...
**RelatingToFull (verbatim upstream field):** Relating to removal of personal property on highway right of way; amending ORS 195.515.
...
LC 3762
or department will not remove personal property.
...
- From `RelatingToFull`: ORS 195.515
- From bill text (Introduced version): ORS 195.505, ORS 195.515, ORS 377.650, ORS 377.653, ORS 377.655, ORS 810.010

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `3e17c72d65ca603d2a87277dbec18ca2183d3d37b1d84d1b2a985850eb68c4b1` (snapshot `_meta/snapshots/measure-2025r1-sb1024-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1024/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1024` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

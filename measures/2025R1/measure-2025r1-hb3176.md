...
jurisdiction: oregon
id: measure-2025r1-hb3176
title: 'HB 3176 (2025R1): Requires home health agencies and home hospice programs to establish home health
  and home hospice staffing committees to develop staffing plans.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3176
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3176/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 600c80e52a275bd0fc343eec31403babd730145b599c9c7460d5d4c6729f09df
snapshot_id: measure-2025r1-hb3176-introduced
status: current
...
catch_line: Requires home health agencies and home hospice programs to establish home health and home
  hospice staffing committees to develop staffing plans.
minority_catch_line: null
measure_summary: "\tDigest: The Act requires certain home health care entities to adopt staffing plans.\
  \ (Flesch Readability Score: 67.7). \n\tRequires home health agencies and home hospice programs to establish\
  \ home health and home hospice staffing committees to develop staffing plans. Imposes penalties for\
  \ certain violations. Requires the Oregon Health Authority to post the staffing plans to the authority's\
  \ website and establish an online portal for filing complaints regarding violations. Prescribes a complaint\
  \ process. Adds enforcement tools for the authority to enforce the home health and home hospice staffing\
  \ requirements. Permits employees or exclusive representatives of employees of home health agencies\
  \ and home hospice programs to seek enforcement by the Bureau of Labor and Industries of rules adopted\
  \ by the bureau regarding meal periods and rest periods. \n\tTakes effect on the 91st day following\
  \ adjournment sine die."
relating_to: Relating to staffing plans for home health care entities; prescribing an effective date.
relating_to_full: Relating to staffing plans for home health care entities; creating new provisions; amending
  ORS 653.258; and prescribing an effective date.
at_the_request_of: null
lc_number: 194
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-28T14:38:39'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 61754
...
# HB 3176 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3176, 2025 Regular Session (2025R1)
- **LC number:** 194
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-28T14:38:39
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 61754 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3176/Introduced>.

## Summary

**Catchline:** Requires home health agencies and home hospice programs to establish home health and home hospice staffing committees to develop staffing plans.
...
**RelatingToFull (verbatim upstream field):** Relating to staffing plans for home health care entities; creating new provisions; amending ORS 653.258; and prescribing an effective date.
...
(Definitions)
SECTION 1.
As used in sections 1 to 12 of this 2025 Act:
...
(Staffing Committees)
SECTION 2.
(1)(a) For each home health agency licensed under  ORS 443.015 there shall
...
(Staffing Plans)
SECTION 3.
(1) Each home  health agency shall implement a written staffing plan for
...
health care staff.
SECTION 4.
(1) A home health staffing committee established  pursuant to section 2 of
...
SECTION 5.
(1) For purposes of  this section, “epidemic” means the occurrence of a group
...
(Records)
SECTION 6.
A home health agency shall  keep and maintain records necessary to dem-
...
SECTION 9.
(1) As used in this  section, “valid complaint” means a complaint containing
...
SECTION 10.
(1) Following the  receipt of a complaint and completion of an investigation
...
SECTION 11.
(1) Civil penalties imposed by  the Oregon Health Authority for a violation
...
SECTION 12.
The Oregon Health Authority may adopt rules necessary to carry  out
...
(Staffing Committees)
SECTION 14.
(1)(a) For each home hospice program licensed under ORS 443.860 there
...
(Staffing Plans)
SECTION 15.
(1) Each home hospice program shall implement a written  staffing plan for
...
SECTION 16.
(1) A home hospice staffing committee established pursuant to section 14
...
(Modification in Case of Emergency or Epidemic)
SECTION 17.
(1) For purposes of this section, “epidemic” means the occurrence of a
...
(Records)
SECTION 18.
A home  hospice program shall keep and maintain records necessary to
...
SECTION 26.
 ORS 653.258 is amended to read:
...
APPLICABILITY
SECTION 27.
(1)(a) A home health staffing committee established under  section 2 of this
...
- From `RelatingToFull`: ORS 653.258
- From bill text (Introduced version): ORS 183.415, ORS 183.417, ORS 183.745, ORS 401.165, ORS 410.600, ORS 441.760, ORS 441.790, ORS 443.014, ORS 443.015, ORS 443.045, ORS 443.305, ORS 443.860, ORS 653.256, ORS 653.258, ORS 653.261

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `600c80e52a275bd0fc343eec31403babd730145b599c9c7460d5d4c6729f09df` (snapshot `_meta/snapshots/measure-2025r1-hb3176-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3176/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3176` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

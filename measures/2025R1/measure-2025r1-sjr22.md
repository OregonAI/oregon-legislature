...
jurisdiction: oregon
id: measure-2025r1-sjr22
title: 'SJR 22 (2025R1): Proposes an amendment to the Oregon Constitution directing the Legislative Assembly
...
citation: 2025 Regular Session Senate Joint Resolution 22
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR22/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: edbadaf0e7b7476e0cf56010a2fdf79a67b9f05a9111c6beb6c5f3ba373b782d
snapshot_id: measure-2025r1-sjr22-introduced
status: current
...
measure_modified_date: '2025-01-17T14:47:53'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 4888
...
# SJR 22 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Joint Resolution 22, 2025 Regular Session (2025R1)
- **LC number:** 2968
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T14:47:53
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4888 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR22/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `edbadaf0e7b7476e0cf56010a2fdf79a67b9f05a9111c6beb6c5f3ba373b782d` (snapshot `_meta/snapshots/measure-2025r1-sjr22-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR22/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SJR' and MeasureNumber eq 22` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3385
title: 'HB 3385 (2025R1): Modifies the statute that governs the fee schedule for public records filed
  with a county clerk.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3385
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3385/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c3f614252a7685ad5ffbb8124d8e2bb7a81928b457efee25996826d30f23f0f7
snapshot_id: measure-2025r1-hb3385-enrolled
status: current
...
catch_line: Modifies the statute that governs the fee schedule for public records filed with a county
  clerk.
minority_catch_line: null
measure_summary: "\tDigest: Exempts public records filed with a county clerk from the fee schedule. (Flesch\
  \ Readability Score: 74.8). \n\tModifies the statute that governs the fee schedule for public records\
  \ filed with a county clerk."
relating_to: Relating to public record fees.
relating_to_full: Relating to public record fees.
...
# HB 3385 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3385, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 5719 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3385/Enrolled>.

## Summary

**Catchline:** Modifies the statute that governs the fee schedule for public records filed with a county clerk.
...
**RelatingToFull (verbatim upstream field):** Relating to public record fees.
...
- From bill text (Enrolled version): ORS 192.311, ORS 192.324, ORS 205.320, ORS 247.973, ORS 80.100

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `c3f614252a7685ad5ffbb8124d8e2bb7a81928b457efee25996826d30f23f0f7` (snapshot `_meta/snapshots/measure-2025r1-hb3385-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3385/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `67a0a6f099378d7f7aa827588451a106e596c3694243706b675e6a20f7846ad9` (snapshot `_meta/snapshots/measure-2025r1-hb3385-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3385/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3385> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

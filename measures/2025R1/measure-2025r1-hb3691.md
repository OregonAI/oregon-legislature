...
jurisdiction: oregon
id: measure-2025r1-hb3691
title: 'HB 3691 (2025R1): Prohibits the claiming of an earned income tax credit by a taxpayer using an
  individual taxpayer identification number in lieu of a Social Security number.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3691
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3691/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f7171d47f637dffe996365885d942ce06b125d8617ef2bec3586fbcfa8edced6
snapshot_id: measure-2025r1-hb3691-introduced
status: current
...
catch_line: Prohibits the claiming of an earned income tax credit by a taxpayer using an individual taxpayer
  identification number in lieu of a Social Security number.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes it so that a taxpayer must have a Social Security number to\
  \ claim an earned income tax credit. (Flesch Readability Score: 64.6). \n\tProhibits the claiming of\
  \ an earned income tax credit by a taxpayer using an individual taxpayer identification number in lieu\
  \ of a Social Security number. \n\tApplies to tax years beginning on or after January 1, 2026. \n\t\
  Extends the sunset for the credit. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to requiring the use of a Social Security number to claim an earned income tax credit;
  prescribing an effective date.
relating_to_full: Relating to requiring the use of a Social Security number to claim an earned income
  tax credit; creating new provisions; amending ORS 315.266 and section 6, chapter 880, Oregon Laws 2007;
  and prescribing an effective date.
at_the_request_of: null
lc_number: 4397
measure_created_date: '2025-02-21T11:56:52'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3691`.

# HB 3691 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3691, 2025 Regular Session (2025R1)
- **LC number:** 4397
- **Created:** 2025-02-21T11:56:52
- **Metadata last modified (upstream):** 2025-04-02T11:27:41
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5274 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3691/Introduced>.

## Summary

**Catchline:** Prohibits the claiming of an earned income tax credit by a taxpayer using an individual taxpayer identification number in lieu of a Social Security number.
...
**RelatingToFull (verbatim upstream field):** Relating to requiring the use of a Social Security number to claim an earned income tax credit; creating new provisions; amending ORS 315.266 and section 6, chapter 880, Oregon Laws 2007; and prescribing an effective date.
...
LC 4397
[(5)] (4) If a change in the status of a taxpayer from resident to nonresident or  from nonresident
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `f7171d47f637dffe996365885d942ce06b125d8617ef2bec3586fbcfa8edced6` (snapshot `_meta/snapshots/measure-2025r1-hb3691-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3691/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3691` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

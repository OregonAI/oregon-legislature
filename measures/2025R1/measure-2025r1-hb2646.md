...
jurisdiction: oregon
id: measure-2025r1-hb2646
title: 'HB 2646 (2025R1): Creates the crime of unlawful disclosure of private information.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2646
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2646/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 1811f6366ca8edcfc35cac6442d15431a20379b0fedffe79f6f7a9af6eeeeea3
snapshot_id: measure-2025r1-hb2646-introduced
status: current
...
measure_summary: "\tDigest: The Act creates a new crime about disclosing private data. (Flesch Readability\
  \ Score: 69.7). \n\tCreates the crime of unlawful disclosure of private information. Punishes by a maximum\
  \ of six months' imprisonment, $2,500 fine, or both."
relating_to: Relating to the disclosure of private information.
relating_to_full: Relating to the disclosure of private information; creating new provisions; and amending
  ORS 161.005.
at_the_request_of: null
lc_number: 3650
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T13:09:01'
...
# HB 2646 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2646, 2025 Regular Session (2025R1)
- **LC number:** 3650
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T13:09:01
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4085 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2646/Introduced>.
...
**RelatingToFull (verbatim upstream field):** Relating to the disclosure of private information; creating new provisions; and amending ORS 161.005.
...
- From bill text (Introduced version): ORS 161.005, ORS 163.732, ORS 30.866

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `1811f6366ca8edcfc35cac6442d15431a20379b0fedffe79f6f7a9af6eeeeea3` (snapshot `_meta/snapshots/measure-2025r1-hb2646-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2646/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2646` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hcr24
title: 'HCR 24 (2025R1): In memoriam: Hendrik Pieter "Henk" Pander, 1937-2023.'
doc_type: dataset_doc
citation: 2025 Regular Session House Concurrent Resolution 24
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR24/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 56306d4af78737264059bfefa646ea3f96ecf3bb14881dfc4f3cbe157568536d
snapshot_id: measure-2025r1-hcr24-enrolled
status: current
...
catch_line: 'In memoriam: Hendrik Pieter "Henk" Pander, 1937-2023.'
minority_catch_line: null
measure_summary: "\tDigest: Honors the life and memory of Henk Pander. (Flesch Readability Score: 71.8).\
  \ \n\tIn memoriam: Hendrik Pieter \"Henk\" Pander, 1937-2023."
relating_to: 'In memoriam: Hendrik Pieter "Henk" Pander.'
relating_to_full: null
at_the_request_of: null
lc_number: 4390
measure_created_date: '2025-02-25T12:49:01'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 24>.

# HCR 24 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Concurrent Resolution 24, 2025 Regular Session (2025R1)
- **LC number:** 4390
- **Created:** 2025-02-25T12:49:01
- **Metadata last modified (upstream):** 2025-06-12T15:59:06
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 4864 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR24/Enrolled>.

## Summary

**Catchline:** In memoriam: Hendrik Pieter "Henk" Pander, 1937-2023.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `56306d4af78737264059bfefa646ea3f96ecf3bb14881dfc4f3cbe157568536d` (snapshot `_meta/snapshots/measure-2025r1-hcr24-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR24/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `a1537562498bd4c734473ed2085dde7fa47caabe29ba24b4595a3e6075612173` (snapshot `_meta/snapshots/measure-2025r1-hcr24-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR24/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 24> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

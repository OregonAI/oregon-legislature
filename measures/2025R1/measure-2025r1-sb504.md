...
jurisdiction: oregon
id: measure-2025r1-sb504
title: 'SB 504 (2025R1): Requires the Land Conservation and Development Commission to adopt rules by January
  1, 2028, to provide guidance on nonstructural, nature-based solutions for shoreline stabilization.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 504
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB504/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 45652260ae1d6b56636cc61d2ecff2380e0ff40d67124b55bccf5023d81d844e
snapshot_id: measure-2025r1-sb504-enrolled
status: current
...
catch_line: Requires the Land Conservation and Development Commission to adopt rules by January 1, 2028,
  to provide guidance on nonstructural, nature-based solutions for shoreline stabilization.
minority_catch_line: null
measure_summary: "\tDigest: This Act makes LCDC, ODSL and OPRD adopt rules for nature-based solutions\
  \ to protect the coast. (Flesch Readability Score: 63.6). \n\tRequires the Land Conservation and Development\
  \ Commission to adopt rules by January 1, 2028, to provide guidance on nonstructural, nature-based solutions\
  \ for shoreline stabilization. <b>Appropriates moneys from the General Fund to the Department of Land\
  \ Conservation and Development for the purpose of adopting rules.</b> Allows the Department of State\
  \ Lands and the State Parks and Recreation Department to adopt conforming rules by January 1, 2029."
relating_to: Relating to bioengineering for the protection of coastal resources.
relating_to_full: Relating to bioengineering for the protection of coastal resources.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 504`.

# SB 504 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 504, 2025 Regular Session (2025R1)
- **LC number:** 3519
...
- **Full text below:** Enrolled version, 4395 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB504/Enrolled>.

## Summary

**Catchline:** Requires the Land Conservation and Development Commission to adopt rules by January 1, 2028, to provide guidance on nonstructural, nature-based solutions for shoreline stabilization.
...
**RelatingToFull (verbatim upstream field):** Relating to bioengineering for the protection of coastal resources.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `45652260ae1d6b56636cc61d2ecff2380e0ff40d67124b55bccf5023d81d844e` (snapshot `_meta/snapshots/measure-2025r1-sb504-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB504/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `78656d1d59a2b5e62f1c0fe3c5823bc38b3a6ffd5e307e6cd6786b5b894b0118` (snapshot `_meta/snapshots/measure-2025r1-sb504-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB504/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 504` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

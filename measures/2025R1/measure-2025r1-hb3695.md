...
jurisdiction: oregon
id: measure-2025r1-hb3695
title: 'HB 3695 (2025R1): Requires school districts to excuse a student for a released time course.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3695
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3695/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 08fbf3dff9b4974e82b49de99d27cdfdbd544446a43810b3a4a95c6dbbe0264f
...
catch_line: Requires school districts to excuse a student for a released time course.
minority_catch_line: null
measure_summary: "\tDigest: Tells school districts to adopt a policy to allow students to attend a released\
  \ time course. (Flesch Readability Score: 63.6). \n\tRequires school districts to excuse a student for\
  \ a released time course. Prescribes the requirements for released time courses."
relating_to: Relating to excusal for religious instruction.
relating_to_full: Relating to excusal for religious instruction; creating new provisions; and amending
  ORS 339.420.
at_the_request_of: null
lc_number: 4096
measure_created_date: '2025-02-21T12:54:12'
measure_modified_date: '2025-04-02T15:40:37'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 4459
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3695>.

# HB 3695 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3695, 2025 Regular Session (2025R1)
- **LC number:** 4096
- **Created:** 2025-02-21T12:54:12
- **Metadata last modified (upstream):** 2025-04-02T15:40:37
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4459 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3695/Introduced>.

## Summary

**Catchline:** Requires school districts to excuse a student for a released time course.
...
**RelatingToFull (verbatim upstream field):** Relating to excusal for religious instruction; creating new provisions; and amending ORS 339.420.
...
LC 4096
(D) The qualifications of the course instructor, which must align with  the school
...
- From `RelatingToFull`: ORS 339.420
- From bill text (Introduced version): ORS 327.061, ORS 332.002, ORS 332.172, ORS 339.420

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `08fbf3dff9b4974e82b49de99d27cdfdbd544446a43810b3a4a95c6dbbe0264f` (snapshot `_meta/snapshots/measure-2025r1-hb3695-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3695/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3695> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2952
title: 'HB 2952 (2025R1): Requires more information to be included on a certificate of a notarial act
  and certain other documents.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2952
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2952/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 68e7e4de24fd055362d820a7adc49df09997e52a0bfa2aba5e963c1d8802074a
snapshot_id: measure-2025r1-hb2952-introduced
status: current
...
catch_line: Requires more information to be included on a certificate of a notarial act and certain other
  documents.
minority_catch_line: null
measure_summary: "\tDigest: The Act says that more data needs to be included on a some documents. The\
  \ Act lets a county clerk not accept a document that may be fraudulent. (Flesch Readability Score: 74.0).\
  \ \n\tRequires more information to be included on a certificate of a notarial act and certain other\
  \ documents. \n\tAuthorizes a county clerk to refuse to accept a document that has any characteristic\
  \ suggesting it may be fraudulent."
relating_to: Relating to documents.
relating_to_full: Relating to documents; creating new provisions; and amending ORS 87.018, 194.280, 194.285,
  205.160, 205.232 and 205.234.
at_the_request_of: null
lc_number: 2854
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-27T10:44:24'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 13472
...
# HB 2952 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2952, 2025 Regular Session (2025R1)
- **LC number:** 2854
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:44:24
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 13472 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2952/Introduced>.

## Summary

**Catchline:** Requires more information to be included on a certificate of a notarial act and certain other documents.
...
**RelatingToFull (verbatim upstream field):** Relating to documents; creating new provisions; and amending ORS 87.018, 194.280, 194.285, 205.160, 205.232 and 205.234.
...
- From `RelatingToFull`: ORS 194.280, ORS 194.285, ORS 205.160, ORS 205.232, ORS 205.234, ORS 87.018
- From bill text (Introduced version): ORS 100.115, ORS 194.225, ORS 194.230, ORS 194.235, ORS 194.240, ORS 194.280, ORS 194.285, ORS 194.360, ORS 205.125, ORS 205.160, ORS 205.180, ORS 205.232, ORS 205.234, ORS 205.236, ORS 205.327, ORS 87.001, ORS 87.018, ORS 87.093, ORS 92.010, ORS 93.030, ORS 93.260

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `68e7e4de24fd055362d820a7adc49df09997e52a0bfa2aba5e963c1d8802074a` (snapshot `_meta/snapshots/measure-2025r1-hb2952-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2952/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2952` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

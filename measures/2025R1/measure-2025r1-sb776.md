...
jurisdiction: oregon
id: measure-2025r1-sb776
title: 'SB 776 (2025R1): Instructs the State Department of Fish and Wildlife to identify certain areas
...
citation: 2025 Regular Session Senate Bill 776
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB776/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 2c75eacba1c4b7580ae7280928d3968bc041f5d0199909b85c93691c586b288b
snapshot_id: measure-2025r1-sb776-introduced
status: current
...
# SB 776 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 776, 2025 Regular Session (2025R1)
- **LC number:** 1666
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T11:08:04
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4691 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB776/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `2c75eacba1c4b7580ae7280928d3968bc041f5d0199909b85c93691c586b288b` (snapshot `_meta/snapshots/measure-2025r1-sb776-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB776/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 776> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2189
title: 'HB 2189 (2025R1): Provides that a person shall receive a written warning for a first offense of
  speeding or running a red light if the conduct was captured by photo radar or photo red light cameras.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2189
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2189/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: d7c6c36e5ab0efceb3d3f8d1ac2e39322946583f3efcadf7f6b2849028424223
snapshot_id: measure-2025r1-hb2189-introduced
status: current
...
catch_line: Provides that a person shall receive a written warning for a first offense of speeding or
  running a red light if the conduct was captured by photo radar or photo red light cameras.
minority_catch_line: null
measure_summary: "\tDigest: The Act says that if a person speeds or runs a red light and is caught by\
  \ a photo radar or a photo red light camera, the person must get a warning and not a ticket. (Flesch\
  \ Readability Score: 64.5). \n\tProvides that a person shall receive a written warning for a first offense\
  \ of speeding or running a red light if the conduct was captured by photo radar or photo red light cameras."
relating_to: Relating to traffic violations.
relating_to_full: Relating to traffic violations; creating new provisions; and amending ORS 810.436, 810.437
  and 810.444.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2189>.

# HB 2189 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2189, 2025 Regular Session (2025R1)
- **LC number:** 3954
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-22T16:25:46
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 18383 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2189/Introduced>.

## Summary

**Catchline:** Provides that a person shall receive a written warning for a first offense of speeding or running a red light if the conduct was captured by photo radar or photo red light cameras.
...
**RelatingToFull (verbatim upstream field):** Relating to traffic violations; creating new provisions; and amending ORS 810.436, 810.437 and 810.444.
...
cating that compliance with traffic control devices is enforced through cameras.
...
rental agreement or lease, and if the business or public agency provides  the driver license number,
...
the vehicle when the citation was issued and delivered as provided in this section.
(4) A person issued a citation under subsection (1)  of this section may respond to the citation
...
- From `RelatingToFull`: ORS 810.436, ORS 810.437, ORS 810.444
- From bill text (Introduced version): ORS 131.505, ORS 133.005, ORS 153.102, ORS 153.105, ORS 810.180, ORS 810.434, ORS 810.436, ORS 810.437, ORS 810.438, ORS 810.444, ORS 811.111, ORS 811.265, ORS 84.001

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `d7c6c36e5ab0efceb3d3f8d1ac2e39322946583f3efcadf7f6b2849028424223` (snapshot `_meta/snapshots/measure-2025r1-hb2189-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2189/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2189> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

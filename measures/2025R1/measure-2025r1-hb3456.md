...
jurisdiction: oregon
id: measure-2025r1-hb3456
title: 'HB 3456 (2025R1): Requires district school boards and public library boards to adopt policies
  to provide for Internet safety for students and minors.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3456
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3456/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 67f8d867f6aa8c0d5cc2f68d6814e3d21aa6143e83d7c2fc1073202b9424a3b6
snapshot_id: measure-2025r1-hb3456-introduced
status: current
...
catch_line: Requires district school boards and public library boards to adopt policies to provide for
  Internet safety for students and minors.
minority_catch_line: null
measure_summary: "\tDigest: Tells schools and libraries to have a policy for Internet use by minors. (Flesch\
  \ Readability Score: 63.4). \n\tRequires district school boards and public library boards to adopt policies\
  \ to provide for Internet safety for students and minors. Prescribes the requirements of the policies."
relating_to: Relating to Internet safety policies for minors.
relating_to_full: Relating to Internet safety policies for minors.
at_the_request_of: null
lc_number: 1894
measure_created_date: '2025-01-28T14:51:06'
measure_modified_date: '2025-03-22T12:15:38'
...
# HB 3456 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3456, 2025 Regular Session (2025R1)
- **LC number:** 1894
- **Created:** 2025-01-28T14:51:06
- **Metadata last modified (upstream):** 2025-03-22T12:15:38
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 3976 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3456/Introduced>.

## Summary

**Catchline:** Requires district school boards and public library boards to adopt policies to provide for Internet safety for students and minors.
...
**RelatingToFull (verbatim upstream field):** Relating to Internet safety policies for minors.
...
- From bill text (Introduced version): ORS 327.103, ORS 357.400, ORS 357.621, ORS 357.790

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `67f8d867f6aa8c0d5cc2f68d6814e3d21aa6143e83d7c2fc1073202b9424a3b6` (snapshot `_meta/snapshots/measure-2025r1-hb3456-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3456/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3456` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

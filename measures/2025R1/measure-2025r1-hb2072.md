...
jurisdiction: oregon
id: measure-2025r1-hb2072
title: 'HB 2072 (2025R1): Extends certain taxes on the privilege of harvesting merchantable forest products
  on forestlands.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2072
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2072/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 11357d71463278ea207727ba01c67bc6f6632c0d6ba6e89ffcf255c967c1c0b2
snapshot_id: measure-2025r1-hb2072-enrolled
status: current
...
relating_to: Relating to forest products harvest taxation; prescribing an effective date; and providing
  for revenue raising that requires approval by a three-fifths majority.
relating_to_full: Relating to forest products harvest taxation; prescribing an effective date; and providing
  for revenue raising that requires approval by a three-fifths majority.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2072>.

# HB 2072 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2072, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 5759 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2072/Enrolled>.
...
**RelatingToFull (verbatim upstream field):** Relating to forest products harvest taxation; prescribing an effective date; and providing for revenue raising that requires approval by a three-fifths majority.
...
Enrolled House Bill 2072 (HB 2072-A) Page 1
...
Enrolled House Bill 2072 (HB 2072-A) Page 2
...
- From bill text (Enrolled version): ORS 321.005, ORS 321.015, ORS 321.145, ORS 321.152, ORS 350.520, ORS 477.760, ORS 526.215, ORS 526.225

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `11357d71463278ea207727ba01c67bc6f6632c0d6ba6e89ffcf255c967c1c0b2` (snapshot `_meta/snapshots/measure-2025r1-hb2072-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2072/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `487b52c0587027c5b0edbb427110349e293a0bb8de2f20b7e9017be62dd4c000` (snapshot `_meta/snapshots/measure-2025r1-hb2072-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2072/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2072> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

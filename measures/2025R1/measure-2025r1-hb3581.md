...
jurisdiction: oregon
id: measure-2025r1-hb3581
title: 'HB 3581 (2025R1): Removes the statute of limitations for most felony sex crimes.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3581
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3581/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: adb36d764a3a0374a3bed388701829e667746a7a01bd97f74d6230390b33e831
snapshot_id: measure-2025r1-hb3581-introduced
status: current
...
catch_line: Removes the statute of limitations for most felony sex crimes.
minority_catch_line: null
measure_summary: "\tDigest: The Act removes the statute of limitations for most felony sex crimes. The\
  \ Act takes effect on the 91st day after sine die. (Flesch Readability Score: 73.7). \n\tRemoves the\
  \ statute of limitations for most felony sex crimes. \n\tTakes effect on the 91st day following adjournment\
  \ sine die.\t."
relating_to: Relating to sex crime statutes of limitation; prescribing an effective date.
relating_to_full: Relating to sex crime statutes of limitation; creating new provisions; amending ORS
  131.125; and prescribing an effective date.
at_the_request_of: null
lc_number: 3349
measure_created_date: '2025-02-13T10:22:08'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3581`.

# HB 3581 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3581, 2025 Regular Session (2025R1)
- **LC number:** 3349
- **Created:** 2025-02-13T10:22:08
- **Metadata last modified (upstream):** 2025-02-20T10:59:34
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 12917 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3581/Introduced>.

## Summary

**Catchline:** Removes the statute of limitations for most felony sex crimes.
...
**RelatingToFull (verbatim upstream field):** Relating to sex crime statutes of limitation; creating new provisions; amending ORS 131.125; and prescribing an effective date.
...
LC 3349
(q) Using a child in a display of sexually explicit conduct under ORS 163.670.
...
- From `RelatingToFull`: ORS 131.125
- From bill text (Introduced version): ORS 131.125, ORS 132.560, ORS 163.187, ORS 163.205, ORS 163.266, ORS 163.355, ORS 163.365, ORS 163.375, ORS 163.385, ORS 163.395, ORS 163.405, ORS 163.408, ORS 163.411, ORS 163.413, ORS 163.415, ORS 163.425, ORS 163.427, ORS 163.429, ORS 163.432, ORS 163.433, ORS 163.452, ORS 163.525, ORS 163.670, ORS 163.684, ORS 163.686, ORS 163.688, ORS 163.689, ORS 163.700, ORS 163.701, ORS 164.055, ORS 164.057, ORS 164.075, ORS 164.395, ORS 164.405, ORS 164.415, ORS 165.013, ORS 165.055, ORS 165.800, ORS 166.087, ORS 167.012, ORS 167.017, ORS 167.057, ORS 167.075, ORS 167.080

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `adb36d764a3a0374a3bed388701829e667746a7a01bd97f74d6230390b33e831` (snapshot `_meta/snapshots/measure-2025r1-hb3581-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3581/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3581` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb92
title: 'SB 92 (2025R1): Allows a community solar project with a nameplate capacity of five megawatts or
  less to participate in the community solar program.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 92
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB92/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 284f05f7fef57a4ef68105f2961dc0b63c222c76a33cf59feb3d2e078d14e46f
snapshot_id: measure-2025r1-sb92-introduced
status: current
...
catch_line: Allows a community solar project with a nameplate capacity of five megawatts or less to participate
  in the community solar program.
minority_catch_line: null
measure_summary: "\tDigest: Allows a project to partake in the community solar program that is five megawatts\
  \ or less. Allows a project and its subscribers to be in different service areas of the state. Sets\
  \ a cap on the total capacity of the program and raises the cap over time. (Flesch Readability Score:\
  \ 61.3). \n\tAllows a community solar project with a nameplate capacity of five megawatts or less to\
  \ participate in the community solar program. Allows a community solar project and its subscribers to\
  \ be located in different electric company service territories. \n\tEstablishes, beginning in 2026,\
  \ an initial cap on the total generating capacity of the community solar projects participating in the\
  \ program at no less than 4.5 percent of an electric company's system peak in the calendar year 2016.\
  \ Increases the cap by an additional 2 percent each year up to 14.5 percent beginning in 2031 and each\
  \ subsequent year. \n\tDirects the Public Utility Commission to adopt a schedule establishing penalties\
  \ that may be imposed on an electric company for unreasonably delaying the interconnection process for\
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 92`.

# SB 92 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 92, 2025 Regular Session (2025R1)
...
- **Full text below:** Introduced version, 10158 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB92/Introduced>.

## Summary

**Catchline:** Allows a community solar project with a nameplate capacity of five megawatts or less to participate in the community solar program.
...
establishing penalties that may be imposed on an electric company for  unreasonably delaying
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `284f05f7fef57a4ef68105f2961dc0b63c222c76a33cf59feb3d2e078d14e46f` (snapshot `_meta/snapshots/measure-2025r1-sb92-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB92/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 92` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

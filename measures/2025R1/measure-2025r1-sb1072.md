...
jurisdiction: oregon
id: measure-2025r1-sb1072
title: 'SB 1072 (2025R1): Requires a county clerk to verify that a person''s political party affiliation
  is not changed when the person updates that person''s address with the Department of Transportation,
  unless the person has requested the change as provided by law.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1072
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1072/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5e0c04d64fed444dd0a0a242fdbfe86ef608a8f1053aa17dd0377f1504fd7353
snapshot_id: measure-2025r1-sb1072-introduced
status: current
...
catch_line: Requires a county clerk to verify that a person's political party affiliation is not changed
  when the person updates that person's address with the Department of Transportation, unless the person
  has requested the change as provided by law.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells a county clerk to make sure a person's party is not changed\
  \ when the person updates an address with ODOT, unless the person asks for the change. (Flesch Readability\
  \ Score: 66.4). \n\tRequires a county clerk to verify that a person's political party affiliation is\
  \ not changed when the person updates that person's address with the Department of Transportation, unless\
  \ the person has requested the change as provided by law."
relating_to: Relating to political party affiliation.
relating_to_full: Relating to political party affiliation; amending ORS 247.017.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1072>.

# SB 1072 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1072, 2025 Regular Session (2025R1)
- **LC number:** 3816
- **Created:** 2025-02-20T09:41:09
- **Metadata last modified (upstream):** 2025-02-26T10:32:53
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4001 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1072/Introduced>.

## Summary

**Catchline:** Requires a county clerk to verify that a person's political party affiliation is not changed when the person updates that person's address with the Department of Transportation, unless the person has requested the change as provided by law.
...
**RelatingToFull (verbatim upstream field):** Relating to political party affiliation; amending ORS 247.017.
...
- From `RelatingToFull`: ORS 247.017
- From bill text (Introduced version): ORS 247.017

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `5e0c04d64fed444dd0a0a242fdbfe86ef608a8f1053aa17dd0377f1504fd7353` (snapshot `_meta/snapshots/measure-2025r1-sb1072-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1072/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1072> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

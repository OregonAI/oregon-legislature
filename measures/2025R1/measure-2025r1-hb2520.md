...
jurisdiction: oregon
id: measure-2025r1-hb2520
title: 'HB 2520 (2025R1): Allows a credit against income taxes for up to three years for employment of
  qualified military veterans if the wage requirement is met.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2520
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2520/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 59a0ec09a07c205f93ef9a2ed115e078b47c3ab7ed0b30d7f77ea0fb8c7a7608
snapshot_id: measure-2025r1-hb2520-introduced
status: current
...
catch_line: Allows a credit against income taxes for up to three years for employment of qualified military
  veterans if the wage requirement is met.
minority_catch_line: null
measure_summary: "\tDigest: Allows a taxpayer to claim, for up to three years, a credit against their\
  \ income tax if the taxpayer employs a qualified veteran. Requires the taxpayer to pay at least the\
  \ required wage. (Flesch Readability Score: 61.9). \n\tAllows a credit against income taxes for up to\
  \ three years for employment of qualified military veterans if the wage requirement is met. \n\tApplies\
  \ to tax years beginning on or after January 1, 2027, and before January 1, 2033. \n\tTakes effect on\
  \ the 91st day following adjournment sine die."
relating_to: Relating to tax credits for employment of qualified military veterans; prescribing an effective
  date.
relating_to_full: Relating to tax credits for employment of qualified military veterans; and prescribing
  an effective date.
...
# HB 2520 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2520, 2025 Regular Session (2025R1)
- **LC number:** 1331
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:01:05
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6205 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2520/Introduced>.

## Summary

**Catchline:** Allows a credit against income taxes for up to three years for employment of qualified military veterans if the wage requirement is met.
...
**RelatingToFull (verbatim upstream field):** Relating to tax credits for employment of qualified military veterans; and prescribing an effective date.
...
LC 1331
the credit allowed under this section  shall equal $750 per qualified military veteran employed
...
- From bill text (Introduced version): ORS 314.085, ORS 314.440, ORS 316.117, ORS 653.025

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `59a0ec09a07c205f93ef9a2ed115e078b47c3ab7ed0b30d7f77ea0fb8c7a7608` (snapshot `_meta/snapshots/measure-2025r1-hb2520-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2520/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2520` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

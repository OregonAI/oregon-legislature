...
jurisdiction: oregon
id: measure-2025r1-sb782
title: 'SB 782 (2025R1): Increases the minimum amount of grant funds that a county may receive to fund
  a behavioral health deflection program.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 782
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB782/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: bf2a1d6f998f9077ce7c522e23083521e6390ca4f7f36dadcdd043e11a12edb7
snapshot_id: measure-2025r1-sb782-introduced
status: current
...
catch_line: Increases the minimum amount of grant funds that a county may receive to fund a behavioral
  health deflection program.
minority_catch_line: null
measure_summary: "\tDigest: The Act increases the amount of grant funds a county may receive to fund a\
  \ deflection program. (Flesch Readability Score: 65.1). \n\tIncreases the minimum amount of grant funds\
  \ that a county may receive to fund a behavioral health deflection program."
relating_to: Relating to behavioral health deflection programs.
relating_to_full: Relating to behavioral health deflection programs; amending section 76, chapter 70,
  Oregon Laws 2024.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 782>.

# SB 782 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 782, 2025 Regular Session (2025R1)
- **LC number:** 1753
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T11:09:41
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7530 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB782/Introduced>.

## Summary

**Catchline:** Increases the minimum amount of grant funds that a county may receive to fund a behavioral health deflection program.

**Relating to:** Relating to behavioral health deflection programs.

Digest: The Act increases the amount of grant funds a county may receive to fund a deflection program. (Flesch Readability Score: 65.1). 
 Increases the minimum amount of grant funds that a county may receive to fund a behavioral health deflection program.

**RelatingToFull (verbatim upstream field):** Relating to behavioral health deflection programs; amending section 76, chapter 70, Oregon Laws 2024.
...
standards.
Digest: The Act increases the amount of grant funds a county may receive  to fund a deflection
program. (Flesch Readability Score: 65.1).
Increases the minimum amount of grant funds that  a county may receive to fund a behavioral
health deflection program.
A BILL FOR AN ACT
Relating to behavioral health deflection programs;  amending section 76, chapter 70, Oregon Laws
2024.
...
- From bill text (Introduced version): ORS 430.230, ORS 430.234, ORS 430.388, ORS 430.389, ORS 430.620

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `bf2a1d6f998f9077ce7c522e23083521e6390ca4f7f36dadcdd043e11a12edb7` (snapshot `_meta/snapshots/measure-2025r1-sb782-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB782/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 782> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

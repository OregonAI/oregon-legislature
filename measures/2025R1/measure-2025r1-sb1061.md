...
jurisdiction: oregon
id: measure-2025r1-sb1061
title: 'SB 1061 (2025R1): Requires the Director of the Oregon State University Extension Service to establish
  a lumber grading training pilot program.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1061
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1061/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5a5cc7142ee5a73fc53c35e8468bb8a206607d45c073c3e980153ba2d2ed3253
snapshot_id: measure-2025r1-sb1061-enrolled
status: current
...
catch_line: Requires the Director of the Oregon State University Extension Service to establish a lumber
  grading training pilot program.
minority_catch_line: null
measure_summary: "\tDigest: The Act requires the creation of a lumber grading training program. The Act\
  \ requires DCBS to create a process for certain people to obtain lumber from those who have gone through\
  \ the program. (Flesch Readability Score: 69.5). \n\tRequires the Director of the Oregon State University\
  \ Extension Service to establish a lumber grading training pilot program. Establishes the requirements\
  \ of the pilot program. \n\tRequires the Department of Consumer and Business Services to establish a\
  \ process by which specified individuals may obtain lumber from an individual who is certified as having\
  \ completed the lumber grading training pilot program. \n\tSunsets the pilot program on January 2, 2033."
relating_to: Relating to a lumber grading training program.
relating_to_full: Relating to a lumber grading training program.
at_the_request_of: null
lc_number: 1679
measure_created_date: '2025-02-18T09:57:34'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1061>.

# SB 1061 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1061, 2025 Regular Session (2025R1)
- **LC number:** 1679
- **Created:** 2025-02-18T09:57:34
- **Metadata last modified (upstream):** 2025-08-13T10:24:03
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 5659 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1061/Enrolled>.

## Summary

**Catchline:** Requires the Director of the Oregon State University Extension Service to establish a lumber grading training pilot program.
...
**RelatingToFull (verbatim upstream field):** Relating to a lumber grading training program.
...
Enrolled Senate Bill 1061 (SB 1061-B) Page 1
(b) “Third-party graded lumber” means lumber  bearing a valid grade stamp from a
...
Enrolled Senate Bill 1061 (SB 1061-B) Page 2
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `5a5cc7142ee5a73fc53c35e8468bb8a206607d45c073c3e980153ba2d2ed3253` (snapshot `_meta/snapshots/measure-2025r1-sb1061-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1061/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `c2eac042f923567efed1cc2759952b473015022e6229988e1d1cb4f866d16353` (snapshot `_meta/snapshots/measure-2025r1-sb1061-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1061/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1061> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

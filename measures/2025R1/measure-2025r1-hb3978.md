...
jurisdiction: oregon
id: measure-2025r1-hb3978
title: 'HB 3978 (2025R1): Prohibits a research facility from using public funds to directly fund medically
  unnecessary laboratory research on dogs or cats that is classified under certain pain and distress categories.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3978
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3978/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 10534a20be4af4c67a6eaf01939a9077e864234f2fa3915c151eec8e0d09644d
snapshot_id: measure-2025r1-hb3978-introduced
status: current
...
measure_summary: "\tDigest: The Act concerns lab research on dogs, cats and primates that are not human.\
  \ The Act creates a task force to stop research on primates that are not human. The Act takes effect\
  \ when it is signed. (Flesch Readability Score: 91.4). \n\tProhibits a research facility from using\
  \ public funds to directly fund medically unnecessary laboratory research on dogs or cats that is classified\
  \ under certain pain and distress categories. \n\tProhibits a person from conducting research or testing\
  \ on nonhuman primates at the Oregon National Primate Research Center. \n\tEstablishes the Task Force\
  \ on Planning the Elimination of Research on Nonhuman Primates. Directs the task force to draft a plan\
  \ for eliminating the breeding of, and research on, nonhuman primates at the Oregon National Primate\
  \ Research Center. Exempts the task force from public meetings law requirements. Sunsets the task force\
  \ in 2041."
relating_to: Relating to animals; declaring an emergency.
relating_to_full: Relating to animals; creating new provisions; amending ORS 192.690 and 353.090; and
  declaring an emergency.
at_the_request_of: null
lc_number: 4950
measure_created_date: '2025-05-23T10:24:30'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3978`.

# HB 3978 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3978, 2025 Regular Session (2025R1)
- **LC number:** 4950
- **Created:** 2025-05-23T10:24:30
- **Metadata last modified (upstream):** 2025-05-29T08:31:58
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 17901 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3978/Introduced>.
...
**RelatingToFull (verbatim upstream field):** Relating to animals; creating new provisions; amending ORS 192.690 and 353.090; and declaring an emergency.
...
powers necessary for the performance of the functions of the offices as the president of  the
...
- From `RelatingToFull`: ORS 192.690, ORS 353.090
- From bill text (Introduced version): ORS 174.111, ORS 192.245, ORS 192.345, ORS 192.610, ORS 192.690, ORS 292.495, ORS 350.426, ORS 353.090, ORS 36.252, ORS 418.747, ORS 418.785, ORS 441.055, ORS 469.530, ORS 609.410

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `10534a20be4af4c67a6eaf01939a9077e864234f2fa3915c151eec8e0d09644d` (snapshot `_meta/snapshots/measure-2025r1-hb3978-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3978/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3978` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

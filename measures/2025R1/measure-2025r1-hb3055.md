...
jurisdiction: oregon
id: measure-2025r1-hb3055
title: 'HB 3055 (2025R1): Requires school districts to comply with statewide summative assessment participation
  requirements and to demonstrate improved student achievement on statewide summative assessments to be
  eligible for state funding related to the High School Graduation and College and Career Readiness Act.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3055
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3055/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 163b79d5e4df73839cff27076efd6af05689bae322a22878a933f045ebe3ac19
snapshot_id: measure-2025r1-hb3055-introduced
status: current
...
catch_line: Requires school districts to comply with statewide summative assessment participation requirements
  and to demonstrate improved student achievement on statewide summative assessments to be eligible for
  state funding related to the High School Graduation and College and Career Readiness Act.
minority_catch_line: null
measure_summary: "\tDigest: Requires each school district to have students take tests and improve test\
  \ scores for the school district to receive certain state moneys. (Flesch Readability Score: 69.1).\
  \ \n\tRequires school districts to comply with statewide summative assessment participation requirements\
  \ and to demonstrate improved student achievement on statewide summative assessments to be eligible\
  \ for state funding related to the High School Graduation and College and Career Readiness Act. \n\t\
  Eliminates the directive to the Department of Education to apply for a waiver of state assessment requirements\
  \ under federal law."
relating_to: Relating to statewide summative assessments.
relating_to_full: Relating to statewide summative assessments; creating new provisions; amending ORS 327.883;
  and repealing ORS 329.482.
at_the_request_of: null
lc_number: 619
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T13:20:05'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 5924
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3055`.

# HB 3055 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3055, 2025 Regular Session (2025R1)
- **LC number:** 619
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T13:20:05
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5924 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3055/Introduced>.

## Summary

**Catchline:** Requires school districts to comply with statewide summative assessment participation requirements and to demonstrate improved student achievement on statewide summative assessments to be eligible for state funding related to the High School Graduation and College and Career Readiness Act.
...
**RelatingToFull (verbatim upstream field):** Relating to statewide summative assessments; creating new provisions; amending ORS 327.883; and repealing ORS 329.482.
...
- From `RelatingToFull`: ORS 327.883, ORS 329.482
- From bill text (Introduced version): ORS 327.859, ORS 327.874, ORS 327.883, ORS 329.482

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `163b79d5e4df73839cff27076efd6af05689bae322a22878a933f045ebe3ac19` (snapshot `_meta/snapshots/measure-2025r1-hb3055-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3055/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3055` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

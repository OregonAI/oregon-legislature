...
jurisdiction: oregon
id: measure-2025r1-sb747
title: 'SB 747 (2025R1): Requires persons with ownership interests in at least 200 acres of irrigated
  land used for agriculture to annually report information about fertilizer application to the State Department
  of Agriculture.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 747
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB747/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 2f2e45fe560152c6b5150d70bbcd55633134a2734c47908ec29c67b9b405838f
snapshot_id: measure-2025r1-sb747-introduced
status: current
...
catch_line: Requires persons with ownership interests in at least 200 acres of irrigated land used for
  agriculture to annually report information about fertilizer application to the State Department of Agriculture.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells certain persons to report the use of fertilizer on farmland.\
  \ The Act allows agencies to take certain actions about the reports. (Flesch Readability Score: 60.7).\
  \ \n\tRequires persons with ownership interests in at least 200 acres of irrigated land used for agriculture\
  \ to annually report information about fertilizer application to the State Department of Agriculture.\
  \ Authorizes the department and the Department of Environmental Quality to take certain actions related\
  \ to the information. Directs the State Department of Agriculture to report on the information to committees\
  \ or interim committees of the Legislative Assembly related to agriculture on or before September 15\
  \ of each odd-numbered year. \n\tAuthorizes the imposition of civil penalties for a violation."
relating_to: Relating to the application of fertilizer.
relating_to_full: Relating to the application of fertilizer; creating new provisions; and amending ORS
  561.995.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 747>.

# SB 747 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 747, 2025 Regular Session (2025R1)
- **LC number:** 1782
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:48:56
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4823 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB747/Introduced>.

## Summary

**Catchline:** Requires persons with ownership interests in at least 200 acres of irrigated land used for agriculture to annually report information about fertilizer application to the State Department of Agriculture.
...
**RelatingToFull (verbatim upstream field):** Relating to the application of fertilizer; creating new provisions; and amending ORS 561.995.
...
LC 1782
riculture shall  report, in the manner provided by ORS 192.245, to committees or interim
...
- From `RelatingToFull`: ORS 561.995
- From bill text (Introduced version): ORS 183.745, ORS 192.245, ORS 561.590, ORS 561.990, ORS 561.995, ORS 633.311

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `2f2e45fe560152c6b5150d70bbcd55633134a2734c47908ec29c67b9b405838f` (snapshot `_meta/snapshots/measure-2025r1-sb747-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB747/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 747> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

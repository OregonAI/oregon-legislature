...
jurisdiction: oregon
id: measure-2025r1-sb414
title: 'SB 414 (2025R1): Modifies the crime of unlawful dissemination of an intimate image to include
  the disclosure of a computer-generated explicit likeness.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 414
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB414/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a14ad8f0a626540748ddf7ec999ec44fe0400b92cb183c1cdf134191821a31eb
snapshot_id: measure-2025r1-sb414-introduced
status: current
...
catch_line: Modifies the crime of unlawful dissemination of an intimate image to include the disclosure
  of a computer-generated explicit likeness.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes it a crime to disclose fake intimate images. The Act goes into\
  \ effect when the Governor signs it. (Flesch Readability Score: 75.3). \n\tModifies the crime of unlawful\
  \ dissemination of an intimate image to include the disclosure of a computer-generated explicit likeness.\
  \ \n\tDeclares an emergency, effective on passage."
relating_to: Relating to the unlawful dissemination of intimate images; declaring an emergency.
relating_to_full: Relating to the unlawful dissemination of intimate images; amending ORS 163.472; and
...
# SB 414 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 414, 2025 Regular Session (2025R1)
- **LC number:** 840
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-24T09:08:02
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4613 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB414/Introduced>.

## Summary

**Catchline:** Modifies the crime of unlawful dissemination of an intimate image to include the disclosure of a computer-generated explicit likeness.
...
**RelatingToFull (verbatim upstream field):** Relating to the unlawful dissemination of intimate images; amending ORS 163.472; and declaring an emergency.
...
LC 840
[(c)] (d) “Information content provider” has the meaning given that term in 47 U.S.C. 230(f).
...
- From `RelatingToFull`: ORS 163.472
- From bill text (Introduced version): ORS 163.305, ORS 163.472

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `a14ad8f0a626540748ddf7ec999ec44fe0400b92cb183c1cdf134191821a31eb` (snapshot `_meta/snapshots/measure-2025r1-sb414-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB414/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 414> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

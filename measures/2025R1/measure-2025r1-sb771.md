...
jurisdiction: oregon
id: measure-2025r1-sb771
title: 'SB 771 (2025R1): Directs the Oregon Business Development Department to develop and administer
  a program for awarding grants to rodeo organizations based in communities with a population of 12,000
  or less to fund certain capital projects on existing rodeo property.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 771
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB771/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 1329e39db25603f2937964ba3bdeb62f4fbceae2555dda5ab51e460761a665e1
snapshot_id: measure-2025r1-sb771-introduced
status: current
...
catch_line: Directs the Oregon Business Development Department to develop and administer a program for
  awarding grants to rodeo organizations based in communities with a population of 12,000 or less to fund
  certain capital projects on existing rodeo property.
minority_catch_line: null
measure_summary: "\tDigest: The Act would set up a grant program for capital repairs at small-town rodeos.\
  \ (Flesch Readability Score: 65.7). \n\tDirects the Oregon Business Development Department to develop\
  \ and administer a program for awarding grants to rodeo organizations based in communities with a population\
  \ of 12,000 or less to fund certain capital projects on existing rodeo property."
relating_to: Relating to funding for rodeo repairs.
relating_to_full: Relating to funding for rodeo repairs.
...
# SB 771 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 771, 2025 Regular Session (2025R1)
- **LC number:** 1232
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-03-06T15:15:38
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5544 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB771/Introduced>.

## Summary

**Catchline:** Directs the Oregon Business Development Department to develop and administer a program for awarding grants to rodeo organizations based in communities with a population of 12,000 or less to fund certain capital projects on existing rodeo property.

**Relating to:** Relating to funding for rodeo repairs.

Digest: The Act would set up a grant program for capital repairs at small-town rodeos. (Flesch Readability Score: 65.7). 
...
**RelatingToFull (verbatim upstream field):** Relating to funding for rodeo repairs.
...
LC 1232
(B) Offer a grant agreement to a successful applicant rodeo organization.
...
- From bill text (Introduced version): ORS 293.250

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `1329e39db25603f2937964ba3bdeb62f4fbceae2555dda5ab51e460761a665e1` (snapshot `_meta/snapshots/measure-2025r1-sb771-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB771/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 771` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

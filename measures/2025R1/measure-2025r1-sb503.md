...
jurisdiction: oregon
id: measure-2025r1-sb503
title: 'SB 503 (2025R1): Allows a recreational vehicle used to provide temporary security of farm use
  to be sited on lands zoned for exclusive farm use.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 503
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB503/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: faf12e378fce3800f075873018476d8a83550c5c19c03cb65180c29869945ae1
snapshot_id: measure-2025r1-sb503-introduced
status: current
...
catch_line: Allows a recreational vehicle used to provide temporary security of farm use to be sited on
  lands zoned for exclusive farm use.
minority_catch_line: null
measure_summary: "\tDigest: This Act allows the temporary use of RVs for security on farm land. (Flesch\
  \ Readability Score: 63.4). \n\tAllows a recreational vehicle used to provide temporary security of\
  \ farm use to be sited on lands zoned for exclusive farm use."
relating_to: Relating to security on farms.
relating_to_full: Relating to security on farms; amending ORS 215.213 and 215.283.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 503`.

# SB 503 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 503, 2025 Regular Session (2025R1)
- **LC number:** 2215
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-03-27T11:49:37
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 62635 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB503/Introduced>.

## Summary

**Catchline:** Allows a recreational vehicle used to provide temporary security of farm use to be sited on lands zoned for exclusive farm use.

**Relating to:** Relating to security on farms.

Digest: This Act allows the temporary use of RVs for security on farm land. (Flesch Readability Score: 63.4). 
 Allows a recreational vehicle used to provide temporary security of farm use to be sited on lands zoned for exclusive farm use.

**RelatingToFull (verbatim upstream field):** Relating to security on farms; amending ORS 215.213 and 215.283.
...
standards.
Digest: This Act allows the  temporary use of RVs for security on farm land. (Flesch Readability
Score:  63.4).
Allows a recreational vehicle used to provide  temporary security of farm use to be sited on
lands zoned for exclusive farm use.
A BILL FOR AN ACT
Relating to security on farms; amending ORS 215.213 and 215.283.
...
(cc) A  recreational vehicle for the use by individuals providing security to protect a farm
use. The use is allowed only on a temporary basis,  for no more than five months per year,
and as necessary to protect farm equipment or crops.
...
(aa) A recreational vehicle for the use by individuals providing security to protect a  farm
use. The use is allowed only on a temporary  basis, for no more than five months per year,
and as necessary to protect farm equipment or crops.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `faf12e378fce3800f075873018476d8a83550c5c19c03cb65180c29869945ae1` (snapshot `_meta/snapshots/measure-2025r1-sb503-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB503/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 503` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

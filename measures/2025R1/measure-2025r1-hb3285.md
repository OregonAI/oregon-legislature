...
jurisdiction: oregon
id: measure-2025r1-hb3285
title: 'HB 3285 (2025R1): Directs the Oregon Department of Emergency Management to identify long-term
  recovery groups operating in Oregon and to provide grants for their support.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3285
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3285/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 350b7b1908ed5ad5d542036fdd93c6263a1521aa41dd8f75e5ebd9bb74defd84
snapshot_id: measure-2025r1-hb3285-introduced
status: current
...
catch_line: Directs the Oregon Department of Emergency Management to identify long-term recovery groups
  operating in Oregon and to provide grants for their support.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells ODEM to support local groups that help prepare for emergencies.\
  \ (Flesch Readability Score: 63.4). \n\tDirects the Oregon Department of Emergency Management to identify\
  \ long-term recovery groups operating in Oregon and to provide grants for their support. \n\tEstablishes\
  \ the Long-Term Recovery Group Fund. Continuously appropriates moneys in the fund to the department\
  \ for the support of long-term recovery groups operating in areas experiencing an emergency. \n\tDeclares\
...
lc_number: 2992
measure_created_date: '2025-01-12T15:48:26'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3285`.

# HB 3285 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3285, 2025 Regular Session (2025R1)
- **LC number:** 2992
- **Created:** 2025-01-12T15:48:26
- **Metadata last modified (upstream):** 2025-01-27T08:02:20
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4726 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3285/Introduced>.

## Summary

**Catchline:** Directs the Oregon Department of Emergency Management to identify long-term recovery groups operating in Oregon and to provide grants for their support.

**Relating to:** Relating to long-term recovery groups; declaring an emergency.

Digest: The Act tells ODEM to support local groups that help prepare for emergencies. (Flesch Readability Score: 63.4). 
 ...
 Establishes the Long-Term Recovery Group Fund. Continuously appropriates moneys in the fund to the department for the support of long-term recovery groups operating in areas experiencing an emergency. 
...
LC 2992
1 of this 2025 Act to long-term recovery groups for staffing and operations.
SECTION 3.
In addition to and not in lieu of any other appropriation, there is appropri-
ated to the Oregon Department of  Emergency Management, for the biennium beginning July
1, 2025, out of the General Fund, the  amount of $18,000,000 to provide grants under section
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `350b7b1908ed5ad5d542036fdd93c6263a1521aa41dd8f75e5ebd9bb74defd84` (snapshot `_meta/snapshots/measure-2025r1-hb3285-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3285/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3285` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

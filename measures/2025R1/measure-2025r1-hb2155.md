...
jurisdiction: oregon
id: measure-2025r1-hb2155
title: 'HB 2155 (2025R1): Expands the confidential use of vehicle accident reports to include law enforcement
  agencies for investigatory purposes.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2155
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2155/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a47a8a846e49d863ba574f9bba105533f70e7a4143ec9aa94c8883d91e40b4c3
snapshot_id: measure-2025r1-hb2155-enrolled
status: current
...
catch_line: Expands the confidential use of vehicle accident reports to include law enforcement agencies
  for investigatory purposes.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act allows law enforcement to use car accident reports to help them\
  \ with their work. (Flesch Readability Score: 68.9).</b> \n\t[<i>Digest: The Act says that ODOT must\
  \ study speed bumps. (Flesch Readability Score: 94.3).</i>] \n\t[<i>Requires the Department of Transportation\
  \ to study the development of uniform standards for speed bump height and markings.</i>] \n\t[<i>Sunsets\
  \ January 2, 2027.</i>] \n\t<b>Expands the confidential use of vehicle accident reports to include law\
  \ enforcement agencies for investigatory purposes.</b>"
...
measure_modified_date: '2026-04-15T10:24:35'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2155`.

# HB 2155 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2155, 2025 Regular Session (2025R1)
...
- **Metadata last modified (upstream):** 2026-04-15T10:24:35
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 12485 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2155/Enrolled>.

## Summary

**Catchline:** Expands the confidential use of vehicle accident reports to include law enforcement agencies for investigatory purposes.

**Relating to:** Relating to transportation.

<b>Digest: The Act allows law enforcement to use car accident reports to help them with their work. (Flesch Readability Score: 68.9).</b> 
 ...
 <b>Expands the confidential use of vehicle accident reports to include law enforcement agencies for investigatory purposes.</b>
...
- From bill text (Enrolled version): ORS 181A.010, ORS 181A.220, ORS 746.265, ORS 801.040, ORS 801.041, ORS 801.042, ORS 802.050, ORS 802.175, ORS 802.177, ORS 802.200, ORS 802.220, ORS 802.230, ORS 802.240, ORS 803.600, ORS 805.060, ORS 809.220, ORS 810.010, ORS 810.375, ORS 810.460, ORS 811.725, ORS 811.730, ORS 811.747, ORS 813.220, ORS 819.110, ORS 821.150, ORS 821.320, ORS 822.205, ORS 822.230, ORS 98.812

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `a47a8a846e49d863ba574f9bba105533f70e7a4143ec9aa94c8883d91e40b4c3` (snapshot `_meta/snapshots/measure-2025r1-hb2155-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2155/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `1fdc576c44bd72581111ffcefecfb7f68d5a36ad07d896a5c28983102bf92b06` (snapshot `_meta/snapshots/measure-2025r1-hb2155-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2155/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2155` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

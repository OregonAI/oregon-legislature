...
jurisdiction: oregon
id: measure-2025r1-hb3570
title: 'HB 3570 (2025R1): Appropriates moneys to the Oregon Business Development Department to update
  the inventory of community infrastructure project needs related to the production of new housing and
  prepare reports on the inventory update and the processes and programs for maintaining inventories of,
  and providing funding for, drinking water, wastewater and stormwater infrastructure projects.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3570
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3570/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 1afe8a93b70a8bf55c35ea3906cb16abb1d1f5af75a44c91ae31c9519a04095c
snapshot_id: measure-2025r1-hb3570-introduced
status: current
...
catch_line: Appropriates moneys to the Oregon Business Development Department to update the inventory
  of community infrastructure project needs related to the production of new housing and prepare reports
  on the inventory update and the processes and programs for maintaining inventories of, and providing
  funding for, drinking water, wastewater and stormwater infrastructure projects.
minority_catch_line: null
measure_summary: "\tDigest: The Act would fund an update by Business Oregon of the infrastructure that\
  \ is needed for new housing. The Act would also have the agency draft two reports, one on the update\
  \ and one on water-related works. (Flesch Readability Score: 60.0). \n\tAppropriates moneys to the Oregon\
  \ Business Development Department to update the inventory of community infrastructure project needs\
  \ related to the production of new housing and prepare reports on the inventory update and the processes\
  \ and programs for maintaining inventories of, and providing funding for, drinking water, wastewater\
  \ and stormwater infrastructure projects. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to community infrastructure inventory; declaring an emergency.
relating_to_full: Relating to community infrastructure inventory; and declaring an emergency.
at_the_request_of: null
lc_number: 4393
measure_created_date: '2025-02-12T10:59:53'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3570`.

# HB 3570 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3570, 2025 Regular Session (2025R1)
- **LC number:** 4393
- **Created:** 2025-02-12T10:59:53
- **Metadata last modified (upstream):** 2025-02-20T10:59:04
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 9767 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3570/Introduced>.

## Summary

**Catchline:** Appropriates moneys to the Oregon Business Development Department to update the inventory of community infrastructure project needs related to the production of new housing and prepare reports on the inventory update and the processes and programs for maintaining inventories of, and providing funding for, drinking water, wastewater and stormwater infrastructure projects.

**Relating to:** Relating to community infrastructure inventory; declaring an emergency.
...
**RelatingToFull (verbatim upstream field):** Relating to community infrastructure inventory; and declaring an emergency.
...
LC 4393
(d) Organizations representing cities, counties, special  districts, economic development
...
(f) Provides a high-level overview of how funding sources for infrastructure projects may
...
- From bill text (Introduced version): ORS 192.245, ORS 284.754, ORS 285B.636, ORS 352.808

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `1afe8a93b70a8bf55c35ea3906cb16abb1d1f5af75a44c91ae31c9519a04095c` (snapshot `_meta/snapshots/measure-2025r1-hb3570-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3570/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3570` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3899
title: 'HB 3899 (2025R1): Lowers the thresholds above which, in applicable circumstances, controllers
  are subject to regulation in processing consumers'' personal data.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3899
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3899/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e73bbdd4e06b9fcc490f7dd8febff298be9b7309a00d840ee98e8046a6e8d559
snapshot_id: measure-2025r1-hb3899-introduced
status: current
...
catch_line: Lowers the thresholds above which, in applicable circumstances, controllers are subject to
  regulation in processing consumers' personal data.
minority_catch_line: null
measure_summary: "\tDigest: Changes some of the laws that apply to the use of personal data of consumers.\
  \ (Flesch Readability Score: 67.5). \n\tLowers the thresholds above which, in applicable circumstances,\
  \ controllers are subject to regulation in processing consumers' personal data. Prohibits controllers\
  \ from processing sensitive data for the purposes of targeted advertising or profiling a consumer in\
  \ furtherance of decisions that produce legal effects or effects of similar significance. Prohibits\
  \ a controller from selling sensitive data for any reason."
relating_to: Relating to requirements that apply to persons that process consumer personal data.
relating_to_full: Relating to requirements that apply to persons that process consumer personal data;
  amending ORS 646A.572 and 646A.578.
at_the_request_of: null
lc_number: 4535
measure_created_date: '2025-02-26T13:10:50'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3899>.

# HB 3899 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3899, 2025 Regular Session (2025R1)
- **LC number:** 4535
- **Created:** 2025-02-26T13:10:50
- **Metadata last modified (upstream):** 2025-03-05T10:33:48
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 20887 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3899/Introduced>.

## Summary

**Catchline:** Lowers the thresholds above which, in applicable circumstances, controllers are subject to regulation in processing consumers' personal data.

**Relating to:** Relating to requirements that apply to persons that process consumer personal data.
...
**RelatingToFull (verbatim upstream field):** Relating to requirements that apply to persons that process consumer personal data; amending ORS 646A.572 and 646A.578.
...
- From `RelatingToFull`: ORS 646A.572, ORS 646A.578
- From bill text (Introduced version): ORS 174.109, ORS 646A.570, ORS 646A.572, ORS 646A.574, ORS 646A.576, ORS 646A.578, ORS 646A.602, ORS 646A.622, ORS 706.008, ORS 725.010, ORS 731.104, ORS 731.106, ORS 744.602, ORS 744.710

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `e73bbdd4e06b9fcc490f7dd8febff298be9b7309a00d840ee98e8046a6e8d559` (snapshot `_meta/snapshots/measure-2025r1-hb3899-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3899/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3899> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

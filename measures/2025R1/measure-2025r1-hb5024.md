...
jurisdiction: oregon
id: measure-2025r1-hb5024
title: 'HB 5024 (2025R1): Appropriates moneys from the General Fund to the Oregon Business Development
  Department for certain biennial expenses.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 5024
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB5024/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f27727f631c5086119e9270d60a2fa0e1f56d43e3b87a7a323474cb7f53efe91
snapshot_id: measure-2025r1-hb5024-enrolled
status: current
...
measure_summary: "\tDigest: The Act creates an agency budget. (Flesch Readability Score: 73.8). \n\tAppropriates\
  \ moneys from the General Fund to the Oregon Business Development Department for certain biennial expenses.\
  \ \n\tLimits biennial expenditures from fees, moneys or other revenues, including Miscellaneous Receipts,\
  \ but excluding lottery funds and federal funds, collected or received by the department for certain\
  \ purposes. \n\tLimits biennial expenditures by the department from specified funds for specified purposes.\
...
measure_modified_date: '2026-05-11T13:23:58'
...
# HB 5024 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 5024, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Oregon Department of Administrative Services)
- **LC number:** 9024
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-05-11T13:23:58
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 8627 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB5024/Enrolled>.

## Summary

**Catchline:** Appropriates moneys from the General Fund to the Oregon Business Development Department for certain biennial expenses.
...
Digest: The Act creates an agency budget. (Flesch Readability Score: 73.8). 
 ...
 Limits biennial expenditures from fees, moneys or other revenues, including Miscellaneous Receipts, but excluding lottery funds and federal funds, collected or received by the department for certain purposes. 
 Limits biennial expenditures by the department from specified funds for specified purposes. 
 Limits biennial expenditures by the department from lottery moneys for certain purposes. 
 Limits biennial expenditures by the department from federal funds for certain purposes. 
...
(4) Oregon Film and Video Office .. $ 1,541,600
...
- From bill text (Enrolled version): ORS 285A.167, ORS 285A.188, ORS 285A.198, ORS 285A.213, ORS 285A.708, ORS 285B.092, ORS 285B.133, ORS 285B.215, ORS 285B.455, ORS 285B.563, ORS 285B.758, ORS 777.267

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `f27727f631c5086119e9270d60a2fa0e1f56d43e3b87a7a323474cb7f53efe91` (snapshot `_meta/snapshots/measure-2025r1-hb5024-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB5024/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `4b60e9fc45c1f076b3aff21ce557176913d2e7cbfd4b599844d577ab9f553d20` (snapshot `_meta/snapshots/measure-2025r1-hb5024-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB5024/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 5024` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sjr1
title: 'SJR 1 (2025R1): Proposes an amendment to the Oregon Constitution directing the Legislative Assembly
  to enact a property tax relief program for the owner-occupied primary residences of certain seniors.
  Refers the proposed amendment to the people for their approval or rejection at the next regular general
  election.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Joint Resolution 1
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR1/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0f37bc4fb9e8215b8be9dd20b95e4d36354e32eff5baa775f819a90ade681f0d
snapshot_id: measure-2025r1-sjr1-introduced
status: current
...
catch_line: Proposes an amendment to the Oregon Constitution directing the Legislative Assembly to enact
  a property tax relief program for the owner-occupied primary residences of certain seniors. Refers the
  proposed amendment to the people for their approval or rejection at the next regular general election.
minority_catch_line: null
measure_summary: "\tDigest: The measure would direct the legislature to pass laws to provide a property\
  \ tax break for the homes of seniors. It takes effect only if the people vote for it. (Flesch Readability\
  \ Score: 70.3). \n\tProposes an amendment to the Oregon Constitution directing the Legislative Assembly\
  \ to enact a property tax relief program for the owner-occupied primary residences of certain seniors.\
  \ \n\tRefers the proposed amendment to the people for their approval or rejection at the next regular\
  \ general election."
relating_to: Proposing an amendment to the Oregon Constitution relating to a property tax relief program
  for the owner-occupied primary residences of certain seniors.
...
measure_modified_date: '2025-01-17T14:47:10'
...
# SJR 1 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Joint Resolution 1, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Sweet Home City Councilor Angelita Sanchez)
- **LC number:** 3019
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T14:47:10
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4949 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR1/Introduced>.

## Summary

**Catchline:** Proposes an amendment to the Oregon Constitution directing the Legislative Assembly to enact a property tax relief program for the owner-occupied primary residences of certain seniors. Refers the proposed amendment to the people for their approval or rejection at the next regular general election.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `0f37bc4fb9e8215b8be9dd20b95e4d36354e32eff5baa775f819a90ade681f0d` (snapshot `_meta/snapshots/measure-2025r1-sjr1-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR1/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SJR' and MeasureNumber eq 1` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2186
title: 'HB 2186 (2025R1): Allows virtual public charter schools to be eligible for grants distributed
  from the Student Investment Account.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2186
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2186/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 6138e130261624328d057b43914bfdeb16c755d9d89b41d256e4b7ad5e026ee3
snapshot_id: measure-2025r1-hb2186-introduced
status: current
...
catch_line: Allows virtual public charter schools to be eligible for grants distributed from the Student
  Investment Account.
minority_catch_line: null
measure_summary: "\tDigest: Allows virtual public charter schools to receive a SIA grant. (Flesch Readability\
  \ Score: 61.3). \n\tAllows virtual public charter schools to be eligible for grants distributed from\
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2186`.

# HB 2186 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2186, 2025 Regular Session (2025R1)
- **LC number:** 1128
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-22T16:25:46
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 11951 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2186/Introduced>.

## Summary

**Catchline:** Allows virtual public charter schools to be eligible for grants distributed from the Student Investment Account.
...
Digest: Allows virtual public charter schools to receive a SIA grant. (Flesch Readability Score: 61.3). 
 Allows virtual public charter schools to be eligible for grants distributed from the Student Investment Account. 
 Declares an emergency, effective on passage.
...
standards.
Digest: Allows virtual public charter schools to receive a SIA grant.  (Flesch Readability Score:
61.3).
Allows virtual public charter schools to be eligible  for grants distributed from the Student In-
vestment Account.
Declares an emergency, effective on passage.
A BILL FOR AN ACT
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `6138e130261624328d057b43914bfdeb16c755d9d89b41d256e4b7ad5e026ee3` (snapshot `_meta/snapshots/measure-2025r1-hb2186-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2186/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2186` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

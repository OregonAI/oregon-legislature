...
jurisdiction: oregon
id: measure-2025r1-hb3034
title: 'HB 3034 (2025R1): Modifies the role of the Oregon Housing Stability Council in designing policy
  for Emergency Housing Account programs.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3034
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3034/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 430dfbe76cac2e1036395a61b371233e69d53aa2f702b77277b577a32863ce57
snapshot_id: measure-2025r1-hb3034-enrolled
status: current
...
catch_line: Modifies the role of the Oregon Housing Stability Council in designing policy for Emergency
  Housing Account programs.
minority_catch_line: null
measure_summary: "\tDigest: This Act changes the funding and use of a housing account. (Flesch Readability\
  \ Score: 80.3). \n\tModifies the role of the Oregon Housing Stability Council in designing policy for\
  \ Emergency Housing Account programs."
relating_to: Relating to the Emergency Housing Account.
relating_to_full: Relating to the Emergency Housing Account.
...
# HB 3034 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3034, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 6478 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3034/Enrolled>.

## Summary

**Catchline:** Modifies the role of the Oregon Housing Stability Council in designing policy for Emergency Housing Account programs.
...
**RelatingToFull (verbatim upstream field):** Relating to the Emergency Housing Account.
...
geographic area;
Enrolled House Bill 3034 (HB 3034-INTRO) Page 1
...
Enrolled House Bill 3034 (HB 3034-INTRO) Page 2
...
Enrolled House Bill 3034 (HB 3034-INTRO) Page 3
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `430dfbe76cac2e1036395a61b371233e69d53aa2f702b77277b577a32863ce57` (snapshot `_meta/snapshots/measure-2025r1-hb3034-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3034/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `981177080d68d51894ac3590ff5d8f46a82fd1ea9074a7d918d2ff469ce6e466` (snapshot `_meta/snapshots/measure-2025r1-hb3034-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3034/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3034> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

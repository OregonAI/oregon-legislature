...
jurisdiction: oregon
id: measure-2025r1-hb3130
title: 'HB 3130 (2025R1): Requires a member of a district school board to file an economic interest statement
  only if the member receives a stipend from the district school board.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3130
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3130/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ac7ecbc9e38824ee3cbadf5322194d2a6b2ffc50261499dc3b6631125374d769
snapshot_id: measure-2025r1-hb3130-introduced
status: current
...
catch_line: Requires a member of a district school board to file an economic interest statement only if
  the member receives a stipend from the district school board.
minority_catch_line: null
measure_summary: "\tDigest: Provides that a school board member does not have to file an SEI if the member\
  \ does not receive a stipend from the school district. (Flesch Readability Score: 76.5). \n\tRequires\
  \ a member of a district school board to file an economic interest statement only if the member receives\
  \ a stipend from the district school board."
relating_to: Relating to economic interest statements filed by district school board members.
relating_to_full: Relating to economic interest statements filed by district school board members; amending
  ORS 244.050.
at_the_request_of: null
lc_number: 2637
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T13:22:12'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 9581
...
# HB 3130 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3130, 2025 Regular Session (2025R1)
- **LC number:** 2637
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T13:22:12
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 9581 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3130/Introduced>.

## Summary

**Catchline:** Requires a member of a district school board to file an economic interest statement only if the member receives a stipend from the district school board.

**Relating to:** Relating to economic interest statements filed by district school board members.

Digest: Provides that a school board member does not have to file an SEI if the member does not receive a stipend from the school district. (Flesch Readability Score: 76.5). 
...
**RelatingToFull (verbatim upstream field):** Relating to economic interest statements filed by district school board members; amending ORS 244.050.

## Full text

83rd OREGON LEGISLATIVE ASSEMBLY--2025 Regular Session
House Bill 3130
Sponsored by Representative OWENS; Representatives MCINTIRE, WRIGHT (Presession filed.)
SUMMARY
The following summary  is not prepared by the sponsors of the measure and is not a part of the body thereof subject
to consideration by  the Legislative Assembly. It is an editor’s brief statement of the essential features of the
measure as introduced. The statement includes a measure digest written in compliance with applicable readability
standards.
Digest: Provides that a school board member does not  have to file an SEI if the member does
not receive a stipend from the school district. (Flesch Readability Score: 76.5).
Requires a member of a district  school board to file an economic interest statement only if the
member receives a stipend from the district school board.
A BILL FOR AN ACT
Relating to economic interest  statements filed by district school board members; amending ORS
244.050.
...
district  who receives a stipend as provided by ORS 332.018 .
...
- From bill text (Introduced version): ORS 199.410, ORS 244.050, ORS 244.060, ORS 244.070, ORS 244.090, ORS 244.350, ORS 332.018, ORS 352.002, ORS 441.525, ORS 465.600, ORS 777.005

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `ac7ecbc9e38824ee3cbadf5322194d2a6b2ffc50261499dc3b6631125374d769` (snapshot `_meta/snapshots/measure-2025r1-hb3130-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3130/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3130` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

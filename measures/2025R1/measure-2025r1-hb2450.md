...
jurisdiction: oregon
id: measure-2025r1-hb2450
title: 'HB 2450 (2025R1): Directs the Department of Early Learning and Care, upon request of one member
  of the Legislative Assembly from each major political party, to prepare a child care impact statement
  for proposed legislation or a state measure.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2450
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2450/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e5aab4d3b3eb97f150f14ea5c98b55edb46c33975c29d5c68d4645403bb7cefa
snapshot_id: measure-2025r1-hb2450-introduced
status: current
...
catch_line: Directs the Department of Early Learning and Care, upon request of one member of the Legislative
  Assembly from each major political party, to prepare a child care impact statement for proposed legislation
  or a state measure.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells the DELC to prepare a child care impact statement in certain\
  \ situations. (Flesch Readability Score: 67.5). \n\tDirects the Department of Early Learning and Care,\
  \ upon request of one member of the Legislative Assembly from each major political party, to prepare\
  \ a child care impact statement for proposed legislation or a state measure. Requires the Secretary\
  \ of State to print a child care impact statement for a state measure in the voters' pamphlet."
relating_to: Relating to child care impact statements.
relating_to_full: Relating to child care impact statements; creating new provisions; and amending ORS
  251.170, 251.185 and 329A.020.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2450>.

# HB 2450 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2450, 2025 Regular Session (2025R1)
- **LC number:** 1063
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-23T09:50:57
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 12016 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2450/Introduced>.

## Summary

**Catchline:** Directs the Department of Early Learning and Care, upon request of one member of the Legislative Assembly from each major political party, to prepare a child care impact statement for proposed legislation or a state measure.
...
**RelatingToFull (verbatim upstream field):** Relating to child care impact statements; creating new provisions; and amending ORS 251.170, 251.185 and 329A.020.
...
- From `RelatingToFull`: ORS 251.170, ORS 251.185, ORS 329A.020
- From bill text (Introduced version): ORS 137.685, ORS 174.109, ORS 250.125, ORS 250.141, ORS 251.026, ORS 251.055, ORS 251.065, ORS 251.067, ORS 251.167, ORS 251.170, ORS 251.185, ORS 251.245, ORS 251.255, ORS 251.285, ORS 260.345, ORS 329A.020, ORS 329A.100, ORS 329A.250, ORS 341.005

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `e5aab4d3b3eb97f150f14ea5c98b55edb46c33975c29d5c68d4645403bb7cefa` (snapshot `_meta/snapshots/measure-2025r1-hb2450-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2450/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2450> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

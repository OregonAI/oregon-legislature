...
jurisdiction: oregon
id: measure-2025r1-sb87
title: 'SB 87 (2025R1): Permits the Electrical and Elevator Board to enter into agreements with municipalities
  to share responsibility for enforcing the Electrical Safety Law.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 87
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB87/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ff56e4388de8facfe586e757d71c4161fb3591c37e11ad5b9cf74de9979f55f9
snapshot_id: measure-2025r1-sb87-introduced
status: current
...
catch_line: Permits the Electrical and Elevator Board to enter into agreements with municipalities to
  share responsibility for enforcing the Electrical Safety Law.
minority_catch_line: null
measure_summary: "\tDigest: Lets a state agency agree with a local agency how to share duties for enforcing\
  \ the Electrical Safety Law. Sets higher fines for not obeying the building code. Lets the state agency\
  \ that governs contractors keep more of the money it collects as fines for breaking the law. (Flesch\
  \ Readability Score: 60.1). \n\tPermits the Electrical and Elevator Board to enter into agreements with\
  \ municipalities to share responsibility for enforcing the Electrical Safety Law. Permits the Construction\
  \ Contractors Board to retain a higher percentage of the proceeds of civil penalties the Construction\
  \ Contractors Board imposes. Raises the amount of a civil penalty that the Department of Consumer and\
  \ Business Services may impose for a violation of the state building code from $5,000 per violation\
  \ to $7,500."
relating_to: Relating to the authority of agencies that regulate building safety in this state.
relating_to_full: Relating to the authority of agencies that regulate building safety in this state; creating
  new provisions; and amending ORS 455.185, 455.895 and 701.255.
at_the_request_of: null
lc_number: 1363
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-02-10T10:28:49'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 11756
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 87`.

# SB 87 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 87, 2025 Regular Session (2025R1)
- **LC number:** 1363
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-02-10T10:28:49
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 11756 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB87/Introduced>.

## Summary

**Catchline:** Permits the Electrical and Elevator Board to enter into agreements with municipalities to share responsibility for enforcing the Electrical Safety Law.
...
**RelatingToFull (verbatim upstream field):** Relating to the authority of agencies that regulate building safety in this state; creating new provisions; and amending ORS 455.185, 455.895 and 701.255.
...
LC 1363
garding whether to enter into  or consent to  an agreement  under subsection (1) of this section, and
...
each manufactured  dwelling or with respect to each failure or refusal to allow or perform an act
...
- From `RelatingToFull`: ORS 455.185, ORS 455.895, ORS 701.255
- From bill text (Introduced version): ORS 174.109, ORS 183.745, ORS 446.003, ORS 446.566, ORS 446.995, ORS 447.992, ORS 455.095, ORS 455.097, ORS 455.148, ORS 455.150, ORS 455.153, ORS 455.156, ORS 455.185, ORS 455.895, ORS 479.510, ORS 479.820, ORS 479.850, ORS 479.854, ORS 479.855, ORS 479.995, ORS 480.670, ORS 693.165, ORS 693.992, ORS 701.255, ORS 701.992

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `ff56e4388de8facfe586e757d71c4161fb3591c37e11ad5b9cf74de9979f55f9` (snapshot `_meta/snapshots/measure-2025r1-sb87-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB87/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 87` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

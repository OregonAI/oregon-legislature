...
jurisdiction: oregon
id: measure-2025r1-sb376
title: 'SB 376 (2025R1): Defines "rural" for purposes of the rural health care provider incentive program.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 376
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB376/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 6324c0bbbb58a3e72e9f91dd4a8d6a4aa39d1e09f1599034e5ab26042290f289
snapshot_id: measure-2025r1-sb376-introduced
status: current
...
catch_line: Defines "rural" for purposes of the rural health care provider incentive program.
minority_catch_line: null
measure_summary: "\tDigest: The Act says what \"rural\" means for the rural health care provider incentive\
  \ program. (Flesch Readability Score: 65.7). \n\tDefines \"rural\" for purposes of the rural health\
  \ care provider incentive program."
relating_to: Relating to health care provider incentives.
relating_to_full: Relating to health care provider incentives; amending ORS 676.454.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 376`.

# SB 376 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 376, 2025 Regular Session (2025R1)
...
- **Full text below:** Introduced version, 5172 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB376/Introduced>.

## Summary

**Catchline:** Defines "rural" for purposes of the rural health care provider incentive program.
...
**RelatingToFull (verbatim upstream field):** Relating to health care provider incentives; amending ORS 676.454.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `6324c0bbbb58a3e72e9f91dd4a8d6a4aa39d1e09f1599034e5ab26042290f289` (snapshot `_meta/snapshots/measure-2025r1-sb376-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB376/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 376` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

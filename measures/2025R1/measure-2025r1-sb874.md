...
jurisdiction: oregon
id: measure-2025r1-sb874
title: 'SB 874 (2025R1): Removes the term "Oriental medicine" and similar terms, and replaces them with
  "Traditional Eastern medicine."'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 874
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB874/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 51259e6586cf125a04f364db1182e37f1879cf3d9d988bb18aeaaf4b5872754b
snapshot_id: measure-2025r1-sb874-enrolled
status: current
...
catch_line: Removes the term "Oriental medicine" and similar terms, and replaces them with "Traditional
  Eastern medicine."
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act gets rid of the term \"Oriental medicine.\" (Flesch Readability\
  \ Score: 75.5).</b> \n\t[<i>Digest: The Act says what the term \"Oriental medicine\" means. (Flesch\
  \ Readability Score: 75.5).</i>] \n\t[<i>Defines \"Oriental medicine.\"</i>] <b>Removes the term \"\
  Oriental medicine\" and similar terms, and replaces them with \"Traditional Eastern medicine.\" Defines\
  \ \"Traditional Eastern medicine.\"</b>"
relating_to: Relating to Oriental medicine.
relating_to_full: Relating to Oriental medicine.
at_the_request_of: (at the request of Governor Tina Kotek for Oregon Medical Board)
lc_number: 551
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2026-02-25T12:30:00'
...
# SB 874 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 874, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Governor Tina Kotek for Oregon Medical Board)
- **LC number:** 551
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-02-25T12:30:00
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 14752 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB874/Enrolled>.

## Summary

**Catchline:** Removes the term "Oriental medicine" and similar terms, and replaces them with "Traditional Eastern medicine."
...
**RelatingToFull (verbatim upstream field):** Relating to Oriental medicine.
...
Enrolled Senate Bill 874 (SB 874-A) Page 1
[(8)] (7) “Fellow” means an individual who  has not qualified under ORS 677.100 (1) and (2) and
...
Enrolled Senate Bill 874 (SB 874-A) Page 2
[(1)(a) “Acupuncture”  means an Oriental health care practice used to promote health and to treat
...
Enrolled Senate Bill 874 (SB 874-A) Page 3
...
business.
Enrolled Senate Bill 874 (SB 874-A) Page 4
...
Enrolled Senate Bill 874 (SB 874-A) Page 5
...
- From bill text (Enrolled version): ORS 441.025, ORS 677.010, ORS 677.060, ORS 677.100, ORS 677.235, ORS 677.275, ORS 677.757, ORS 677.759, ORS 677.761, ORS 677.780, ORS 677.805, ORS 677.814

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `51259e6586cf125a04f364db1182e37f1879cf3d9d988bb18aeaaf4b5872754b` (snapshot `_meta/snapshots/measure-2025r1-sb874-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB874/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `089703f3ce76db667dfe0349b288863b19eab8664f87201ca8c8d74f99676e9f` (snapshot `_meta/snapshots/measure-2025r1-sb874-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB874/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 874> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

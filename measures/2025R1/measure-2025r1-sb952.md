...
jurisdiction: oregon
id: measure-2025r1-sb952
title: 'SB 952 (2025R1): Requires the Governor to appoint a United States Senator when a vacancy in the
  office occurs.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 952
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB952/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b80b05233872c121404c03ff5a6557e0f3eecc26685531dd7f4224a2a5a77f21
snapshot_id: measure-2025r1-sb952-enrolled
status: current
...
measure_summary: "\tDigest: The Act requires the Governor to appoint a U.S. Senator when a vacancy happens\
  ...
  \ Readability Score: 62.8). \n\tRequires the Governor to appoint a United States Senator when a vacancy\
  \ in the office occurs. Requires that the appointed Senator be of the same political party as the elected\
  \ Senator who vacated the office.<b> Prohibits the Governor from appointing the Governor to fill the\
  \ vacancy.</b> \n\tRequires the Governor to call a special election within a specified period after\
  \ the vacancy occurs. Requires the appointment to end when a replacement is elected."
relating_to: Relating to vacancies in the United States Senate.
relating_to_full: Relating to vacancies in the United States Senate.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 952`.

# SB 952 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 952, 2025 Regular Session (2025R1)
- **LC number:** 3858
...
- **Full text below:** Enrolled version, 4121 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB952/Enrolled>.
...
**RelatingToFull (verbatim upstream field):** Relating to vacancies in the United States Senate.
...
Enrolled Senate Bill 952 (SB 952-A) Page 1
(e) The Governor may not appoint the Governor to fill a vacancy  in the office of United
States Senator.
...
Enrolled Senate Bill 952 (SB 952-A) Page 2
...
- From bill text (Enrolled version): ORS 188.120, ORS 236.100

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `b80b05233872c121404c03ff5a6557e0f3eecc26685531dd7f4224a2a5a77f21` (snapshot `_meta/snapshots/measure-2025r1-sb952-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB952/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `e5ee0387fe1bd88801b67ac9eb5b7c59750f3193ab45e2b257b36b320908a7b6` (snapshot `_meta/snapshots/measure-2025r1-sb952-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB952/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 952` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

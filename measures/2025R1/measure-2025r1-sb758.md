...
jurisdiction: oregon
id: measure-2025r1-sb758
title: 'SB 758 (2025R1): Applies the prevailing rate of wage to certain off-site custom work fabricated,
  assembled or produced in accordance with specifications for a particular public works.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 758
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB758/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c81f20292cfc58c9d2ddba137f35f7028f520c59d13f9df23415d3ccd2c4a094
snapshot_id: measure-2025r1-sb758-introduced
status: current
...
catch_line: Applies the prevailing rate of wage to certain off-site custom work fabricated, assembled
  or produced in accordance with specifications for a particular public works.
...
measure_summary: "\tDigest: Makes a certain wage apply to custom work done off site but for a particular\
  ...
  \ certain off-site custom work fabricated, assembled or produced in accordance with specifications for\
  \ a particular public works. Specifies examples of such custom work. \n\tTakes effect on the 91st day\
  \ following adjournment sine die."
relating_to: Relating to the application of a prevailing rate of wage to offsite custom work for use in
  public works; prescribing an effective date.
relating_to_full: Relating to the application of a prevailing rate of wage to offsite custom work for
  use in public works; creating new provisions; amending ORS 279C.800; and prescribing an effective date.
at_the_request_of: null
lc_number: 2077
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T14:40:45'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 9185
...
# SB 758 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 758, 2025 Regular Session (2025R1)
- **LC number:** 2077
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T14:40:45
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 9185 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB758/Introduced>.

## Summary

**Catchline:** Applies the prevailing rate of wage to certain off-site custom work fabricated, assembled or produced in accordance with specifications for a particular public works.
...
**RelatingToFull (verbatim upstream field):** Relating to the application of a prevailing rate of wage to offsite custom work for use in public works; creating new provisions; amending ORS 279C.800; and prescribing an effective date.
...
that are specifically for use in a public works or  that become part of the public works, ex-
...
- From `RelatingToFull`: ORS 279C.800
- From bill text (Introduced version): ORS 174.109, ORS 279A.065, ORS 279C.800, ORS 279C.810, ORS 279C.815, ORS 352.002, ORS 456.055

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `c81f20292cfc58c9d2ddba137f35f7028f520c59d13f9df23415d3ccd2c4a094` (snapshot `_meta/snapshots/measure-2025r1-sb758-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB758/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 758` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

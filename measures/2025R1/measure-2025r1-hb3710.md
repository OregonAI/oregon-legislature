...
jurisdiction: oregon
id: measure-2025r1-hb3710
title: 'HB 3710 (2025R1): Directs the State Parks and Recreation Department to place a monument within
  the State Capitol State Park commemorating the Ten Commandments.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3710
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3710/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: bf15d14a292944a08ca3fd62acb3f3061d4a506cf4b607f9bddca3f2137791eb
snapshot_id: measure-2025r1-hb3710-introduced
status: current
...
catch_line: Directs the State Parks and Recreation Department to place a monument within the State Capitol
  State Park commemorating the Ten Commandments.
minority_catch_line: null
measure_summary: "\tDigest: This Act tells the State Parks and Recreation Department to put a monument\
  \ to the Ten Commandments in the State Capitol State Park. (Flesch Readability Score: 62.1). \n\tDirects\
  \ the State Parks and Recreation Department to place a monument within the State Capitol State Park\
  \ commemorating the Ten Commandments."
relating_to: Relating to the Ten Commandments.
relating_to_full: Relating to the Ten Commandments.
at_the_request_of: null
lc_number: 4288
measure_created_date: '2025-02-23T20:00:48'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3710`.

# HB 3710 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3710, 2025 Regular Session (2025R1)
- **LC number:** 4288
- **Created:** 2025-02-23T20:00:48
- **Metadata last modified (upstream):** 2025-02-28T08:27:36
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5137 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3710/Introduced>.

## Summary

**Catchline:** Directs the State Parks and Recreation Department to place a monument within the State Capitol State Park commemorating the Ten Commandments.

**Relating to:** Relating to the Ten Commandments.

Digest: This Act tells the State Parks and Recreation Department to put a monument to the Ten Commandments in the State Capitol State Park. (Flesch Readability Score: 62.1). 
...
**RelatingToFull (verbatim upstream field):** Relating to the Ten Commandments.
...
the Ten Commandments on government property in Van Orden v. Perry
, 545 U.S. 677 (2005); and
...
SECTION 1.
(1) The State Parks  and Recreation Department shall permit and arrange for
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `bf15d14a292944a08ca3fd62acb3f3061d4a506cf4b607f9bddca3f2137791eb` (snapshot `_meta/snapshots/measure-2025r1-hb3710-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3710/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3710` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2461
title: 'HB 2461 (2025R1): Changes notice requirements and requirements related to facilities and technology
  for motions to allow remote location testimony.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2461
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2461/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 2612a7380fdf1b965a5c5a1bc66ae82a27109fd6717c4ae203c172a044d314c4
snapshot_id: measure-2025r1-hb2461-enrolled
status: current
...
catch_line: Changes notice requirements and requirements related to facilities and technology for motions
  to allow remote location testimony.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes some new rules for remote location testimony. (Flesch Readability\
  \ Score: 61.3). \n\tChanges notice requirements and requirements related to facilities and technology\
  \ for motions to allow remote location testimony."
relating_to: Relating to remote location testimony.
relating_to_full: Relating to remote location testimony.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2461>.

# HB 2461 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2461, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 8630 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2461/Enrolled>.

## Summary

**Catchline:** Changes notice requirements and requirements related to facilities and technology for motions to allow remote location testimony.
...
**RelatingToFull (verbatim upstream field):** Relating to remote location testimony.
...
- From bill text (Enrolled version): ORS 107.700, ORS 107.717, ORS 107.718, ORS 163.760, ORS 163.765, ORS 163.770, ORS 45.400

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `2612a7380fdf1b965a5c5a1bc66ae82a27109fd6717c4ae203c172a044d314c4` (snapshot `_meta/snapshots/measure-2025r1-hb2461-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2461/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `88c8619d73c81850384627e8f2a2470e05d3673a912beab18866a3ba1cdffc70` (snapshot `_meta/snapshots/measure-2025r1-hb2461-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2461/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2461> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

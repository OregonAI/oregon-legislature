...
jurisdiction: oregon
id: measure-2025r1-hb3522
title: 'HB 3522 (2025R1): Allows an owner or landlord to evict a squatter.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3522
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3522/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f3d27112af5015f78bcde7b7a6d12701480ec1e8fcd3cce90611a82a3f71b36a
snapshot_id: measure-2025r1-hb3522-enrolled
status: current
...
measure_summary: "\tDigest: This Act allows the eviction of a squatter. (Flesch Readability Score: 66.1).\
  \ \n\tAllows an owner <b>or landlord</b> to evict a squatter."
relating_to: Relating to evictions of squatters.
relating_to_full: Relating to evictions of squatters.
at_the_request_of: null
lc_number: 572
measure_created_date: '2025-02-06T11:50:12'
measure_modified_date: '2026-04-15T10:33:32'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3522`.

# HB 3522 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3522, 2025 Regular Session (2025R1)
- **LC number:** 572
- **Created:** 2025-02-06T11:50:12
- **Metadata last modified (upstream):** 2026-04-15T10:33:32
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 24653 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3522/Enrolled>.

## Summary

**Catchline:** Allows an owner or landlord to evict a squatter.

**Relating to:** Relating to evictions of squatters.

Digest: This Act allows the eviction of a squatter. (Flesch Readability Score: 66.1). 
 Allows an owner <b>or landlord</b> to evict a squatter.

**RelatingToFull (verbatim upstream field):** Relating to evictions of squatters.
...
- From bill text (Enrolled version): ORS 105.100, ORS 105.110, ORS 105.115, ORS 105.120, ORS 105.123, ORS 105.126, ORS 105.130, ORS 105.135, ORS 105.137, ORS 105.140, ORS 105.836, ORS 107.705, ORS 109.697, ORS 147.380, ORS 147.450, ORS 163.732, ORS 174.101, ORS 18.946, ORS 197.492, ORS 446.003, ORS 671.560, ORS 699.005, ORS 830.700, ORS 86.782, ORS 90.100, ORS 90.148, ORS 90.243, ORS 90.262, ORS 90.295, ORS 90.315, ORS 90.320, ORS 90.385, ORS 90.392, ORS 90.427, ORS 90.505, ORS 90.510, ORS 90.562, ORS 90.730, ORS 90.765, ORS 91.120, ORS 91.122, ORS 93.930

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `f3d27112af5015f78bcde7b7a6d12701480ec1e8fcd3cce90611a82a3f71b36a` (snapshot `_meta/snapshots/measure-2025r1-hb3522-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3522/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `ebcf865cd8d4dd68084328e171c371a98d3115fb2b97267ba41202dc06d92d3e` (snapshot `_meta/snapshots/measure-2025r1-hb3522-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3522/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3522` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

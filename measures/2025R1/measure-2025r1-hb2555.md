...
jurisdiction: oregon
id: measure-2025r1-hb2555
title: 'HB 2555 (2025R1): Changes the name of the Family Sentencing Alternative Pilot Program to the Family
  Sentencing Alternative Program.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2555
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2555/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 9c4aa50d995fc8071f181ac4dd310b3c0fc2fc890ec3a0f22c98044112a53736
snapshot_id: measure-2025r1-hb2555-enrolled
status: current
...
catch_line: Changes the name of the Family Sentencing Alternative Pilot Program to the Family Sentencing
  Alternative Program.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes changes to a pilot program for family sentencing in court. (Flesch\
  \ Readability Score: 63.4). \n\tChanges the name of the Family Sentencing Alternative Pilot Program\
  \ to the Family Sentencing Alternative Program. Makes the program permanent. Modifies eligibility requirements\
  \ for the program to include all sentences for which a defendant is eligible for a downward dispositional\
  \ departure. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to sentencing; and declaring an emergency.
relating_to_full: Relating to sentencing; and declaring an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2555`.

# HB 2555 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2555, 2025 Regular Session (2025R1)
- **LC number:** 3509
...
- **Full text below:** Enrolled version, 7493 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2555/Enrolled>.

## Summary

**Catchline:** Changes the name of the Family Sentencing Alternative Pilot Program to the Family Sentencing Alternative Program.
...
**RelatingToFull (verbatim upstream field):** Relating to sentencing; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 137.540, ORS 137.717, ORS 192.245, ORS 421.168

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `9c4aa50d995fc8071f181ac4dd310b3c0fc2fc890ec3a0f22c98044112a53736` (snapshot `_meta/snapshots/measure-2025r1-hb2555-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2555/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `3831495ce45d62c5871d76ce0b650e3bf0f847ee4f6ff45b39c430b82950c740` (snapshot `_meta/snapshots/measure-2025r1-hb2555-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2555/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2555` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

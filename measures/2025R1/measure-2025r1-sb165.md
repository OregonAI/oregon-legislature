...
jurisdiction: oregon
id: measure-2025r1-sb165
title: 'SB 165 (2025R1): Amends the requirements for the State Land Board to assert title to historically
  filled lands or assert a right to minerals or geothermal resources in historically filled lands.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 165
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB165/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4873056c2598cc6ee3a19dec7b1786489884053f1286de0f46ebda491687634a
snapshot_id: measure-2025r1-sb165-enrolled
status: current
...
catch_line: Amends the requirements for the State Land Board to assert title to historically filled lands
  or assert a right to minerals or geothermal resources in historically filled lands.
minority_catch_line: null
measure_summary: "\tDigest: This Act amends and repeals laws about the State Land Board's power to claim\
  \ title to historically filled lands. (Flesch Readability Score: 62.8). \n\tAmends the requirements\
  \ for the State Land Board to assert title to historically filled lands<b> or assert a right to minerals\
  \ or geothermal resources in historically filled lands</b>. Repeals<b>, on January 2, 2029,</b> the\
  \ provisions related to assertion of title to historically filled lands by the State Land Board that\
  \ are required to be completed before December 31, 2025. \n\t<b>Declares an emergency, effective on\
  \ passage.</b>"
relating_to: Relating to historically filled lands; and declaring an emergency.
relating_to_full: Relating to historically filled lands; and declaring an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 165`.

# SB 165 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 165, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 6960 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB165/Enrolled>.

## Summary

**Catchline:** Amends the requirements for the State Land Board to assert title to historically filled lands or assert a right to minerals or geothermal resources in historically filled lands.
...
**RelatingToFull (verbatim upstream field):** Relating to historically filled lands; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 273.117, ORS 273.775, ORS 273.780, ORS 274.905, ORS 274.915, ORS 274.950, ORS 274.952, ORS 274.954, ORS 274.956, ORS 522.005

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `4873056c2598cc6ee3a19dec7b1786489884053f1286de0f46ebda491687634a` (snapshot `_meta/snapshots/measure-2025r1-sb165-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB165/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `72eb5040b388e64953a2c4f67c67f9ff88f54d68c992cc4cc1f9083b008d1923` (snapshot `_meta/snapshots/measure-2025r1-sb165-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB165/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 165` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

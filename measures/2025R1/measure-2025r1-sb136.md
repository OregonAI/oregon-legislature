...
jurisdiction: oregon
id: measure-2025r1-sb136
title: 'SB 136 (2025R1): Authorizes the Department of Human Services, under specified circumstances, to
  revoke, suspend or impose conditions on the license, certificate or endorsement of a provider of services
  to individuals with intellectual or developmental disabilities.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 136
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB136/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: be1914bed1b8a006cc761d35c50ea3a446fac3579a04caa78e650adf4192f132
snapshot_id: measure-2025r1-sb136-enrolled
status: current
...
catch_line: Authorizes the Department of Human Services, under specified circumstances, to revoke, suspend
  or impose conditions on the license, certificate or endorsement of a provider of services to individuals
  with intellectual or developmental disabilities.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act tells DHS when it may impose sanctions on a licensed I/DD services\
  \ provider. (Flesch Readability Score: 74.2).</b> \n\t[<i>Digest: The Act tells DHS when it may revoke\
  \ the license of an I/DD services provider. (Flesch Readability Score: 79.5).</i>] \n\t[<i>Requires</i>]\
  \ <b>Authorizes</b> the Department of Human Services, under specified circumstances, to revoke<b>, suspend\
  \ or impose conditions on</b> the license, certificate or endorsement of a provider of services to individuals\
  \ with intellectual or developmental disabilities. [<i>Authorizes the department, under specified circumstances,\
  \ to revoke, suspend or impose conditions on the license, certificate or endorsement of a provider.</i>]."
relating_to: Relating to developmental disabilities services providers.
relating_to_full: Relating to developmental disabilities services providers.
...
# SB 136 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 136, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 5618 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB136/Enrolled>.

## Summary

**Catchline:** Authorizes the Department of Human Services, under specified circumstances, to revoke, suspend or impose conditions on the license, certificate or endorsement of a provider of services to individuals with intellectual or developmental disabilities.
...
**RelatingToFull (verbatim upstream field):** Relating to developmental disabilities services providers.
...
Enrolled Senate Bill 136 (SB 136-B) Page 2
...
- From bill text (Enrolled version): ORS 443.705, ORS 443.830

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `be1914bed1b8a006cc761d35c50ea3a446fac3579a04caa78e650adf4192f132` (snapshot `_meta/snapshots/measure-2025r1-sb136-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB136/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `946a6f4db0f475e9896a571d92aa682d77e4e14383767765c8454c50b65f8f60` (snapshot `_meta/snapshots/measure-2025r1-sb136-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB136/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 136` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

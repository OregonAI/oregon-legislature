...
jurisdiction: oregon
id: measure-2025r1-hb3184
title: 'HB 3184 (2025R1): Provides that a homestead may not be sold on execution to satisfy a judgment
  that does not exceed the amount of the homestead exemption.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3184
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3184/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e0afd961307b70013d763eb86c1162903cb500bad2efbcbe48bd8f01576f7d7f
snapshot_id: measure-2025r1-hb3184-introduced
status: current
...
catch_line: Provides that a homestead may not be sold on execution to satisfy a judgment that does not
  exceed the amount of the homestead exemption.
minority_catch_line: null
measure_summary: "\tDigest: The Act says that a homestead may not be sold on execution for a judgment\
  \ that is not more than the amount of the homestead exemption. (Flesch Readability Score: 60.0). \n\t\
  Provides that a homestead may not be sold on execution to satisfy a judgment that does not exceed the\
  \ amount of the homestead exemption."
relating_to: Relating to the homestead exemption.
relating_to_full: Relating to the homestead exemption; creating new provisions; and amending ORS 18.395,
  18.908 and 18.912.
at_the_request_of: (at the request of Oregon Consumer Justice)
lc_number: 2763
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T13:23:44'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 11385
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3184`.

# HB 3184 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3184, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Oregon Consumer Justice)
- **LC number:** 2763
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T13:23:44
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 11385 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3184/Introduced>.

## Summary

**Catchline:** Provides that a homestead may not be sold on execution to satisfy a judgment that does not exceed the amount of the homestead exemption.

**Relating to:** Relating to the homestead exemption.
...
**RelatingToFull (verbatim upstream field):** Relating to the homestead exemption; creating new provisions; and amending ORS 18.395, 18.908 and 18.912.
...
LC 2763
decreases  in  the cost of living for the previous calendar year, based on changes in the Consumer
...
sum bid for the homestead exceeds the sum of the costs of the sale and the  amount of the applicable
...
the motion.
(2) The court shall authorize sale of the property pursuant to a motion filed under  ORS 18.906
...
- From `RelatingToFull`: ORS 18.395, ORS 18.908, ORS 18.912
- From bill text (Introduced version): ORS 18.395, ORS 18.904, ORS 18.906, ORS 18.908, ORS 18.912, ORS 18.960, ORS 446.003, ORS 830.700

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `e0afd961307b70013d763eb86c1162903cb500bad2efbcbe48bd8f01576f7d7f` (snapshot `_meta/snapshots/measure-2025r1-hb3184-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3184/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3184` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

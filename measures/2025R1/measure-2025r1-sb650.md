...
jurisdiction: oregon
id: measure-2025r1-sb650
title: 'SB 650 (2025R1): Provides, for purposes of ad valorem property taxation, a specially assessed
  value for the owner-occupied primary residences of individuals who are at least 65 years of age.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 650
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB650/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 3cde195bbd123f48591fe8c2411f0e785f1f0f29d15b8d3d427c2241d95e0de3
snapshot_id: measure-2025r1-sb650-introduced
status: current
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 650`.

# SB 650 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 650, 2025 Regular Session (2025R1)
...
- **Full text below:** Introduced version, 6627 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB650/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `3cde195bbd123f48591fe8c2411f0e785f1f0f29d15b8d3d427c2241d95e0de3` (snapshot `_meta/snapshots/measure-2025r1-sb650-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB650/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 650` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3127
title: 'HB 3127 (2025R1): Requires use of the state electronic reporting system to report deaths to the
  Center for Health Statistics.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3127
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3127/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 2d0ca967f2c5add37642ab9d8a73f17e244ccb321bb636d7709819a9323d427b
snapshot_id: measure-2025r1-hb3127-enrolled
status: current
...
catch_line: Requires use of the state electronic reporting system to report deaths to the Center for Health
  Statistics.
minority_catch_line: null
measure_summary: "\tDigest: The Act would tell people to report deaths to the state using an electronic\
  \ system. (Flesch Readability Score: 67.5). \n\tRequires use of the state electronic reporting system\
  \ to report deaths to the Center for Health Statistics. \n\t[<i>Takes effect July 1, 2027.</i>]."
relating_to: Relating to reports of death.
relating_to_full: Relating to reports of death.
...
# HB 3127 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3127, 2025 Regular Session (2025R1)
- **LC number:** 1862
...
- **Full text below:** Enrolled version, 13816 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3127/Enrolled>.

## Summary

**Catchline:** Requires use of the state electronic reporting system to report deaths to the Center for Health Statistics.
...
**RelatingToFull (verbatim upstream field):** Relating to reports of death.
...
- From bill text (Enrolled version): ORS 146.095, ORS 146.100, ORS 247.570, ORS 432.035, ORS 432.133

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `2d0ca967f2c5add37642ab9d8a73f17e244ccb321bb636d7709819a9323d427b` (snapshot `_meta/snapshots/measure-2025r1-hb3127-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3127/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `b322ab1557af371a00c368ebe1422ef407aabbdf4d45ae8af099df9c444e7172` (snapshot `_meta/snapshots/measure-2025r1-hb3127-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3127/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3127> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

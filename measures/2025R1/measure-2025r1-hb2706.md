...
jurisdiction: oregon
id: measure-2025r1-hb2706
title: 'HB 2706 (2025R1): Extends a dismantler certificate validity period by one year.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2706
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2706/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 3bf72c205f090cfe3bf1b37fbe5bbdce01d70819687a16bdbf1096e341f601c4
snapshot_id: measure-2025r1-hb2706-enrolled
status: current
...
catch_line: Extends a dismantler certificate validity period by one year.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act says that a dismantler certificate is good for two years. (Flesch\
  \ Readability Score: 74.8).</b> \n\t[<i>Digest: The Act tells ODOT to give car dealers at least two\
  \ days' notice before going to see the dealer's records. The Act makes some exceptions. (Flesch Readability\
  \ Score: 82.4).</i>] \n\t[<i>Directs the Department of Transportation to provide two days' notice to\
  \ vehicle dealers and dismantlers before inspecting records unless the department is responding to a\
  \ complaint.</i>] \n\t<b>Extends a dismantler certificate validity period by one year. Increases the\
  \ fee for a certificate.</b>"
relating_to: Relating to businesses regulated by the Department of Transportation.
relating_to_full: Relating to businesses regulated by the Department of Transportation.
...
# HB 2706 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2706, 2025 Regular Session (2025R1)
- **LC number:** 3117
...
- **Full text below:** Enrolled version, 5573 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2706/Enrolled>.

## Summary

**Catchline:** Extends a dismantler certificate validity period by one year.
...
**RelatingToFull (verbatim upstream field):** Relating to businesses regulated by the Department of Transportation.
...
- From bill text (Enrolled version): ORS 819.480, ORS 822.020, ORS 822.040, ORS 822.084, ORS 822.100, ORS 822.110, ORS 822.115, ORS 822.120, ORS 822.125, ORS 822.140, ORS 822.205, ORS 822.210, ORS 822.310, ORS 822.515, ORS 822.700

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `3bf72c205f090cfe3bf1b37fbe5bbdce01d70819687a16bdbf1096e341f601c4` (snapshot `_meta/snapshots/measure-2025r1-hb2706-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2706/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `117ad39da6dd85536215e51e15ac8cf7c16333798fef6de9bfd3ef3ad2789e87` (snapshot `_meta/snapshots/measure-2025r1-hb2706-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2706/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2706` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

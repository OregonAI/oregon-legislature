...
jurisdiction: oregon
id: measure-2025r1-hb3564
title: 'HB 3564 (2025R1): Modifies provisions relating to demands for correction or retraction of a defamatory
  statement published in an electronic newspaper, magazine or other periodical.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3564
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3564/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0a2758de52767656cbf8855c67964cf5d595aedabb19de3cc62658bec75cdeea
snapshot_id: measure-2025r1-hb3564-enrolled
status: current
...
catch_line: Modifies provisions relating to demands for correction or retraction of a defamatory statement
  published in an electronic newspaper, magazine or other periodical.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act changes the law about how a publisher must correct or retract a\
  \ statement in a digital paper. (Flesch Readability Score: 61.6).</b> \n\t[<i>Digest: The Act changes\
  \ the law about how to ask a publisher to correct or retract a statement. (Flesch Readability Score:\
  \ 65.1).</i>] \n\tModifies provisions relating to demands for correction or retraction of a [<i>published</i>]\
  \ defamatory statement<b> published in an electronic newspaper, magazine or other periodical</b>."
relating_to: Relating to published defamatory statements.
relating_to_full: Relating to published defamatory statements.
at_the_request_of: null
lc_number: 4328
measure_created_date: '2025-02-11T13:32:25'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3564>.

# HB 3564 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3564, 2025 Regular Session (2025R1)
- **LC number:** 4328
- **Created:** 2025-02-11T13:32:25
- **Metadata last modified (upstream):** 2025-07-25T10:52:12
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 4552 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3564/Enrolled>.

## Summary

**Catchline:** Modifies provisions relating to demands for correction or retraction of a defamatory statement published in an electronic newspaper, magazine or other periodical.
...
**RelatingToFull (verbatim upstream field):** Relating to published defamatory statements.
...
- From bill text (Enrolled version): ORS 31.205, ORS 31.210, ORS 31.215

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `0a2758de52767656cbf8855c67964cf5d595aedabb19de3cc62658bec75cdeea` (snapshot `_meta/snapshots/measure-2025r1-hb3564-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3564/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `bdab7c227f510785b8d6f640b4680c23156380e51718a725c24b9d531dcf8cc6` (snapshot `_meta/snapshots/measure-2025r1-hb3564-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3564/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3564> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2060
title: 'HB 2060 (2025R1): Directs the Department of Education to establish and maintain a registry for
  nonlicensed tutors.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2060
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2060/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 3189ca707f028b0ff1280dd1a2faeb62963e4f6623adc876864ac1cb02f37c4f
snapshot_id: measure-2025r1-hb2060-introduced
status: current
...
catch_line: Directs the Department of Education to establish and maintain a registry for nonlicensed tutors.
minority_catch_line: null
measure_summary: "\tDigest: Directs ODE to have a registry for tutors. (Flesch Readability Score: 71.8).\
...
relating_to: Relating to a tutor registry.
relating_to_full: Relating to a tutor registry; creating new provisions; and amending ORS 332.505.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2060`.

# HB 2060 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2060, 2025 Regular Session (2025R1)
- **LC number:** 170
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-04-11T18:05:01
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 8437 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2060/Introduced>.

## Summary

**Catchline:** Directs the Department of Education to establish and maintain a registry for nonlicensed tutors.

**Relating to:** Relating to a tutor registry.

Digest: Directs ODE to have a registry for tutors. (Flesch Readability Score: 71.8). 
 Directs the Department of Education to establish and maintain a registry for nonlicensed tutors. Authorizes school districts to contract with a nonlicensed tutor only if the tutor is registered.

**RelatingToFull (verbatim upstream field):** Relating to a tutor registry; creating new provisions; and amending ORS 332.505.
...
tutors who are not licensed through the Teacher Standards and Practices Commission.
(2) Any person providing tutoring  services may submit an application to become regis-
tered as a tutor. The application must include the name of the person, any third-party  or-
ganizations through which the person provides tutoring services and an indication of whether
the person provides tutoring services online. The department may request additional infor-
mation for purposes of verifying a person’s  identification and ensuring current contact in-
formation for the person.
(3) The department shall deny a person’s inclusion  on the registry, or shall remove the
person from the registry, upon a finding of:
(a) A substantiated report under ORS 339.370 to 339.400;
(b) Gross neglect of duty;
(c) Gross unfitness; or
(d) Any false statement knowingly made  on an application to become registered as a tu-
tor.
(4) A finding made under subsection (3) of this section may be based  on an investigation
conducted by a school district, by the department or  by a third-party organization through
which the person currently is providing tutoring services or had  previously provided tutoring
services.
(5) A person who is denied  inclusion on the registry or who is removed from the registry
may appeal the department’s decision as a contested case under ORS chapter 183.
(6) The department shall  make the registry accessible by school districts and by members
of the public.
SECTION 2.
...
- From `RelatingToFull`: ORS 332.505
- From bill text (Introduced version): ORS 174.111, ORS 174.116, ORS 332.505, ORS 339.370, ORS 342.120, ORS 659.850

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `3189ca707f028b0ff1280dd1a2faeb62963e4f6623adc876864ac1cb02f37c4f` (snapshot `_meta/snapshots/measure-2025r1-hb2060-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2060/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2060` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

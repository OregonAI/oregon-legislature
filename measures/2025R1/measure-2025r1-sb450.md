...
jurisdiction: oregon
id: measure-2025r1-sb450
title: 'SB 450 (2025R1): Designates November 14 of each year as Ruby Bridges Walk to School Day.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 450
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB450/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 9c662a1ae8a549682373f4468e12a99750d014c9f11801a11da395615c31529a
snapshot_id: measure-2025r1-sb450-enrolled
status: current
...
catch_line: Designates November 14 of each year as Ruby Bridges Walk to School Day.
minority_catch_line: null
measure_summary: "\tDigest: Makes November 14 of each year Ruby Bridges Walk to School Day. (Flesch Readability\
  \ Score: 74.8). \n\tDesignates November 14 of each year as Ruby Bridges Walk to School Day. \n\tDeclares\
  \ an emergency, effective on passage."
relating_to: Relating to Ruby Bridges Walk to School Day; and declaring an emergency.
relating_to_full: Relating to Ruby Bridges Walk to School Day; and declaring an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 450`.

# SB 450 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 450, 2025 Regular Session (2025R1)
- **LC number:** 2875
...
- **Full text below:** Enrolled version, 3975 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB450/Enrolled>.

## Summary

**Catchline:** Designates November 14 of each year as Ruby Bridges Walk to School Day.
...
**RelatingToFull (verbatim upstream field):** Relating to Ruby Bridges Walk to School Day; and declaring an emergency.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `9c662a1ae8a549682373f4468e12a99750d014c9f11801a11da395615c31529a` (snapshot `_meta/snapshots/measure-2025r1-sb450-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB450/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `117e125c935f5c9389b5ab50b9bcfd2a7802d55b6cafb34184f869af9ce1ac6a` (snapshot `_meta/snapshots/measure-2025r1-sb450-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB450/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 450` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

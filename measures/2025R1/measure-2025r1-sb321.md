...
jurisdiction: oregon
id: measure-2025r1-sb321
title: 'SB 321 (2025R1): Directs the Teacher Standards and Practices Commission to establish by rule a
  substitute teaching license and a restricted substitute teaching license.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 321
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB321/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b6e84a3041b01e9ac0394ec930fc4f265e2274dc9d6c2c7b32d9ec4feaa0e3f3
snapshot_id: measure-2025r1-sb321-introduced
status: current
...
catch_line: Directs the Teacher Standards and Practices Commission to establish by rule a substitute teaching
  license and a restricted substitute teaching license.
minority_catch_line: null
measure_summary: "\tDigest: The Act would make the TSPC create by rule two types of licenses for people\
  \ who want to be a substitute teacher. The Act would make the TSPC create by rule a way for people with\
  \ a restricted substitute teaching license to get a regular substitute teaching license. (Flesch Readability\
  ...
  \ substitute teaching license. \n\tDirects the commission, in consultation with the Oregon Substitute\
  \ Teachers Association, to report to the interim committees of the Legislative Assembly related to education\
  \ no later than December 15, 2025. \n\tDeclares an emergency, effective July 1, 2025."
relating_to: Relating to the licensure of substitute teachers; declaring an emergency.
relating_to_full: Relating to the licensure of substitute teachers; creating new provisions; amending
...
# SB 321 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 321, 2025 Regular Session (2025R1)
...
- **Full text below:** Introduced version, 9033 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB321/Introduced>.

## Summary

**Catchline:** Directs the Teacher Standards and Practices Commission to establish by rule a substitute teaching license and a restricted substitute teaching license.

**Relating to:** Relating to the licensure of substitute teachers; declaring an emergency.

Digest: The Act would make the TSPC create by rule two types of licenses for people who want to be a substitute teacher. The Act would make the TSPC create by rule a way for people with a restricted substitute teaching license to get a regular substitute teaching license. (Flesch Readability Score: 60.8). 
 ...
 Directs the commission, in consultation with the Oregon Substitute Teachers Association, to report to the interim committees of the Legislative Assembly related to education no later than December 15, 2025. 
 Declares an emergency, effective July 1, 2025.

**RelatingToFull (verbatim upstream field):** Relating to the licensure of substitute teachers; creating new provisions; amending ORS 342.125; and declaring an emergency.
...
- From bill text (Introduced version): ORS 181A.195, ORS 192.245, ORS 339.374, ORS 342.120, ORS 342.125, ORS 342.127, ORS 342.130, ORS 342.143

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `b6e84a3041b01e9ac0394ec930fc4f265e2274dc9d6c2c7b32d9ec4feaa0e3f3` (snapshot `_meta/snapshots/measure-2025r1-sb321-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB321/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 321` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

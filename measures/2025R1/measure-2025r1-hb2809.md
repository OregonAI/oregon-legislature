...
jurisdiction: oregon
id: measure-2025r1-hb2809
title: 'HB 2809 (2025R1): Increases the upper limit on pesticide registration fees.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2809
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2809/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 753dc58558c56eafb7325eaf214522909d7618b7b9ef1fb50f93fa7a669b3730
snapshot_id: measure-2025r1-hb2809-enrolled
status: current
...
catch_line: Increases the upper limit on pesticide registration fees.
minority_catch_line: null
measure_summary: "\tDigest: This Act increases the upper limit on the fee to register a pesticide. (Flesch\
...
relating_to: Relating to pesticide registration fees; and prescribing an effective date.
relating_to_full: Relating to pesticide registration fees; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2809`.

# HB 2809 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2809, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 5434 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2809/Enrolled>.

## Summary

**Catchline:** Increases the upper limit on pesticide registration fees.

**Relating to:** Relating to pesticide registration fees; and prescribing an effective date.

Digest: This Act increases the upper limit on the fee to register a pesticide. (Flesch Readability Score: 63.4). 
 Increases the upper limit on pesticide registration fees. 
 Takes effect on the 91st day following adjournment sine die.

**RelatingToFull (verbatim upstream field):** Relating to pesticide registration fees; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 468B.180, ORS 634.016, ORS 634.306, ORS 634.322

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `753dc58558c56eafb7325eaf214522909d7618b7b9ef1fb50f93fa7a669b3730` (snapshot `_meta/snapshots/measure-2025r1-hb2809-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2809/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `1b5b5d75ac855ab738f6f211a846a3e524fe7a8a225d0c3b1441680fe7b71c00` (snapshot `_meta/snapshots/measure-2025r1-hb2809-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2809/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2809` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3330
title: 'HB 3330 (2025R1): Provides protections for a person who refuses to participate in a procedure
  related to abortion, physician-assisted suicide or gender-affirming treatment if the refusal is based
  on a person''s ethical, moral or religious convictions.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3330
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3330/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f4864f0fd1e6a4cea56c019cd6a75b64aea3e0937547022fdd5bcebbb0ccdaf9
snapshot_id: measure-2025r1-hb3330-introduced
status: current
...
catch_line: Provides protections for a person who refuses to participate in a procedure related to abortion,
  physician-assisted suicide or gender-affirming treatment if the refusal is based on a person's ethical,
  moral or religious convictions.
minority_catch_line: null
measure_summary: "\tDigest: The Act expands laws that protect a health care worker's right to object to\
  \ taking part in certain health care treatments. (Flesch Readability Score: 72.7). \n\tProvides protections\
  \ for a person who refuses to participate in a procedure related to abortion, physician-assisted suicide\
  \ or gender-affirming treatment if the refusal is based on a person's ethical, moral or religious convictions.\
  \ \n\tAllows a health care facility to refuse to perform a procedure related to abortion, physician-assisted\
  \ suicide or gender-affirming treatment. \n\tAllows a person to bring an action for damages and equitable\
  \ relief against a health care facility, health professional regulatory agency, employer or school for\
  \ a violation. Directs a court to award attorney fees to a prevailing plaintiff."
relating_to: Relating to participation in medical procedures.
relating_to_full: Relating to participation in medical procedures.
at_the_request_of: null
lc_number: 1685
measure_created_date: '2025-01-16T11:41:17'
measure_modified_date: '2025-01-27T08:05:21'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 9278
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3330`.

# HB 3330 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3330, 2025 Regular Session (2025R1)
- **LC number:** 1685
- **Created:** 2025-01-16T11:41:17
- **Metadata last modified (upstream):** 2025-01-27T08:05:21
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 9278 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3330/Introduced>.

## Summary

**Catchline:** Provides protections for a person who refuses to participate in a procedure related to abortion, physician-assisted suicide or gender-affirming treatment if the refusal is based on a person's ethical, moral or religious convictions.

**Relating to:** Relating to participation in medical procedures.

Digest: The Act expands laws that protect a health care worker's right to object to taking part in certain health care treatments. (Flesch Readability Score: 72.7). 
 ...
 Allows a person to bring an action for damages and equitable relief against a health care facility, health professional regulatory agency, employer or school for a violation. Directs a court to award attorney fees to a prevailing plaintiff.

**RelatingToFull (verbatim upstream field):** Relating to participation in medical procedures.
...
SECTION 2.
(1) An employer may not discriminate against an  employee or prospective
NOTE: Matter in  boldfaced type in an amended section is new;  matter [ italic and bracketed] is existing law to be omitted.
New sections are in  boldfaced type.
LC 1685
employee by refusing to  reasonably accommodate the ethical, moral or religious objection
...
SECTION 3.
(1) Notwithstanding ORS 435.240, a health care facility is not required to:
...
SECTION 4.
(1)(a) A person who alleges discrimination in violation of  section 2 of this
...
- From bill text (Introduced version): ORS 127.800, ORS 435.225, ORS 435.240

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `f4864f0fd1e6a4cea56c019cd6a75b64aea3e0937547022fdd5bcebbb0ccdaf9` (snapshot `_meta/snapshots/measure-2025r1-hb3330-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3330/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3330` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

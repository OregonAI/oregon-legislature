...
jurisdiction: oregon
id: measure-2025r1-sb143
title: 'SB 143 (2025R1): Increases the percentage points of the employer tax rate that are used to determine
  the amount of wages paid into the Supplemental Employment Department Administration Fund each calendar
  quarter.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 143
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB143/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a1d4be68a0f5780ece45d8a8ae31eb5d0f7b7ff2dcf8731e38f24c87ccdee8b6
snapshot_id: measure-2025r1-sb143-enrolled
status: current
...
catch_line: Increases the percentage points of the employer tax rate that are used to determine the amount
  of wages paid into the Supplemental Employment Department Administration Fund each calendar quarter.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act would change the amount of unemployment insurance tax moneys that\
  \ are paid into certain funds used for the UI program. (Flesch Readability Score: 61.4).</b> \n\t[<i>Digest:\
  \ The Act tells the State Treasurer to study public funds. (Flesch Readability Score: 78.2).</i>] \n\
  \t[<i>Requires the State Treasurer to study the administration of public funds. Directs the State Treasurer\
  \ to submit findings to the interim committees of the Legislative Assembly related to ways and means\
  \ not later than September 15, 2026.</i>] \n\t[<i>Sunsets January 2, 2027.</i>] \n\t<b>Increases the\
  \ percentage points of the employer tax rate that are used to determine the amount of wages paid into\
  \ the Supplemental Employment Department Administration Fund each calendar quarter. Changes the formula\
  \ for determining the amount of excess moneys in the Supplemental Employment Department Administration\
  \ Fund that are transferred to the Unemployment Compensation Trust Fund each biennium. \n\tTakes effect\
  \ on the 91st day following adjournment sine die.</b>"
relating_to: Relating to administration of public funds; and prescribing an effective date.
relating_to_full: Relating to administration of public funds; and prescribing an effective date.
...
# SB 143 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 143, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 20604 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB143/Enrolled>.

## Summary

**Catchline:** Increases the percentage points of the employer tax rate that are used to determine the amount of wages paid into the Supplemental Employment Department Administration Fund each calendar quarter.
...
**RelatingToFull (verbatim upstream field):** Relating to administration of public funds; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 291.002, ORS 652.409, ORS 657.462, ORS 657.783, ORS 657.805

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `a1d4be68a0f5780ece45d8a8ae31eb5d0f7b7ff2dcf8731e38f24c87ccdee8b6` (snapshot `_meta/snapshots/measure-2025r1-sb143-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB143/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `d5fa044346c6fd4c6c7bd3bba160d10fd3ba6246d2d05005f9841519a6640c3e` (snapshot `_meta/snapshots/measure-2025r1-sb143-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB143/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 143` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

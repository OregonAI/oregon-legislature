...
jurisdiction: oregon
id: measure-2025r1-hb2309
title: 'HB 2309 (2025R1): Requires an applicant for change of name who has been convicted of some crimes
  to prove necessity of name change by clear and convincing evidence.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2309
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2309/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b1023427b3969475cbb3bb8583e5d46bbf4b660e9256cc04ac397c0bdebba03d
snapshot_id: measure-2025r1-hb2309-introduced
status: current
...
catch_line: Requires an applicant for change of name who has been convicted of some crimes to prove necessity
  of name change by clear and convincing evidence.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes a person who wants to change their name and who has done some\
  \ crimes prove the need to change the name. The Act gets rid of laws letting a person change the name\
  \ on a birth certificate for affirming gender identity without going to court. (Flesch Readability Score:\
  \ 74.9). \n\tRequires an applicant for change of name who has been convicted of some crimes to prove\
  \ necessity of name change by clear and convincing evidence. \n\tRemoves provisions allowing a person\
  \ to request an amendment of a record of live birth to change a name for the purpose of affirming gender\
  \ identity without court approval."
relating_to: Relating to change of name.
relating_to_full: Relating to change of name; creating new provisions; and amending ORS 33.410 and 432.235.
...
# HB 2309 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2309, 2025 Regular Session (2025R1)
- **LC number:** 628
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-23T10:49:55
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 8555 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2309/Introduced>.

## Summary

**Catchline:** Requires an applicant for change of name who has been convicted of some crimes to prove necessity of name change by clear and convincing evidence.
...
**RelatingToFull (verbatim upstream field):** Relating to change of name; creating new provisions; and amending ORS 33.410 and 432.235.
...
LC 628
cordance with this section or rules adopted by the State Registrar of the Center for Health Statistics
...
(b) The state registrar may  not amend a record of live birth to change [ the name of an applicant
...
- From `RelatingToFull`: ORS 33.410, ORS 432.235
- From bill text (Introduced version): ORS 183.484, ORS 33.410, ORS 432.235

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `b1023427b3969475cbb3bb8583e5d46bbf4b660e9256cc04ac397c0bdebba03d` (snapshot `_meta/snapshots/measure-2025r1-hb2309-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2309/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2309` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

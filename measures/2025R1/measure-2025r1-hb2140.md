...
jurisdiction: oregon
id: measure-2025r1-hb2140
title: 'HB 2140 (2025R1): Modifies the method by which the Oregon Department of Administrative Services
  and the Legislative Fiscal Officer project the costs of programs that are funded by the State School
  Fund.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2140
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2140/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 9bbe4f511aece5c8994bee64cac754029c89458d68349c4b75ec8c8ac9dbdafd
snapshot_id: measure-2025r1-hb2140-enrolled
status: current
...
catch_line: Modifies the method by which the Oregon Department of Administrative Services and the Legislative
  Fiscal Officer project the costs of programs that are funded by the State School Fund.
minority_catch_line: null
measure_summary: "\tDigest: Makes changes to how the amount needed to fund the State School Fund is calculated\
  \ and then distributed. (Flesch Readability Score: 61.6). \n\tModifies the method by which the Oregon\
  \ Department of Administrative Services and the Legislative Fiscal Officer project the costs of programs\
  \ that are funded by the State School Fund. \n\tDirects the Department of Education to modify the manner\
  \ in which certain grants from the State School Fund are distributed to school districts. \n\tDeclares\
  \ an emergency, effective on passage."
relating_to: Relating to funding of the State School Fund; and declaring an emergency.
relating_to_full: Relating to funding of the State School Fund; and declaring an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2140`.

# HB 2140 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2140, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 10497 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2140/Enrolled>.

## Summary

**Catchline:** Modifies the method by which the Oregon Department of Administrative Services and the Legislative Fiscal Officer project the costs of programs that are funded by the State School Fund.
...
**RelatingToFull (verbatim upstream field):** Relating to funding of the State School Fund; and declaring an emergency.
...
of this subsection.
Enrolled House Bill 2140 (HB 2140-INTRO) Page 1
...
291.216 (6)(a)(C).
Enrolled House Bill 2140 (HB 2140-INTRO) Page 2
...
July 1, 2025.
Enrolled House Bill 2140 (HB 2140-INTRO) Page 3
...
Enrolled House Bill 2140 (HB 2140-INTRO) Page 4
...
- From bill text (Enrolled version): ORS 291.204, ORS 291.210, ORS 291.216, ORS 291.342, ORS 326.125, ORS 326.545, ORS 327.006, ORS 327.008, ORS 327.011, ORS 327.013, ORS 327.019, ORS 327.022, ORS 327.344, ORS 327.348, ORS 327.359, ORS 329.488, ORS 332.337, ORS 342.953, ORS 343.404, ORS 343.941, ORS 348.398, ORS 396.360

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `9bbe4f511aece5c8994bee64cac754029c89458d68349c4b75ec8c8ac9dbdafd` (snapshot `_meta/snapshots/measure-2025r1-hb2140-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2140/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `05ef4c5f490a7c2e22f4b951e90ec1b6e18db69767a3ed8d52e0d1fe0f524b3e` (snapshot `_meta/snapshots/measure-2025r1-hb2140-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2140/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2140` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hcr29
title: 'HCR 29 (2025R1): In memoriam: David Todd Meyer, 1967-2024.'
doc_type: dataset_doc
citation: 2025 Regular Session House Concurrent Resolution 29
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR29/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 486c006b1907c12504b968bef4e873c779b6ef9969eb7c985fdfb29a4dcc821f
snapshot_id: measure-2025r1-hcr29-enrolled
status: current
...
catch_line: 'In memoriam: David Todd Meyer, 1967-2024.'
minority_catch_line: null
measure_summary: "\tDigest: Honors the life and memory of David Meyer. (Flesch Readability Score: 61.2).\
  \ \n\tIn memoriam: David Todd Meyer, 1967-2024."
relating_to: 'In memoriam: David Todd Meyer.'
relating_to_full: null
at_the_request_of: null
lc_number: 4175
measure_created_date: '2025-02-26T12:23:30'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 29`.

# HCR 29 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Concurrent Resolution 29, 2025 Regular Session (2025R1)
- **LC number:** 4175
- **Created:** 2025-02-26T12:23:30
- **Metadata last modified (upstream):** 2025-06-12T15:59:06
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 5351 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR29/Enrolled>.

## Summary

**Catchline:** In memoriam: David Todd Meyer, 1967-2024.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `486c006b1907c12504b968bef4e873c779b6ef9969eb7c985fdfb29a4dcc821f` (snapshot `_meta/snapshots/measure-2025r1-hcr29-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR29/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `3a0afb54ba4e9c6d922a5fdc9cba33769438f4a7e7cdbe6c56993fa3a811e7c1` (snapshot `_meta/snapshots/measure-2025r1-hcr29-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR29/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 29` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb820
title: 'SB 820 (2025R1): Provides that the State Board of Parole and Post-Prison Supervision is required
  to classify sex offender registrants convicted before January 1, 2014, into a risk level only in specified
  circumstances.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 820
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB820/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 8db0b1120917b3b3971f82e4be74458f9e5e53aa4dc187c02e181e51025665df
snapshot_id: measure-2025r1-sb820-introduced
status: current
...
catch_line: Provides that the State Board of Parole and Post-Prison Supervision is required to classify
  sex offender registrants convicted before January 1, 2014, into a risk level only in specified circumstances.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes when the parole board is required to classify some sex offenders.\
  \ (Flesch Readability Score: 65.6). \n\tProvides that the State Board of Parole and Post-Prison Supervision\
  \ is required to classify sex offender registrants convicted before January 1, 2014, into a risk level\
  \ only in specified circumstances."
relating_to: Relating to sex offender risk levels.
relating_to_full: Relating to sex offender risk levels; amending ORS 163A.125 and section 7, chapter 708,
  Oregon Laws 2013.
...
measure_modified_date: '2025-01-17T14:42:48'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 18068
...
# SB 820 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 820, 2025 Regular Session (2025R1)
...
- **Metadata last modified (upstream):** 2025-01-17T14:42:48
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 18068 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB820/Introduced>.

## Summary

**Catchline:** Provides that the State Board of Parole and Post-Prison Supervision is required to classify sex offender registrants convicted before January 1, 2014, into a risk level only in specified circumstances.
...
**RelatingToFull (verbatim upstream field):** Relating to sex offender risk levels; amending ORS 163A.125 and section 7, chapter 708, Oregon Laws 2013.
...
- From bill text (Introduced version): ORS 137.765, ORS 161.295, ORS 163A.005, ORS 163A.010, ORS 163A.015, ORS 163A.100, ORS 163A.110, ORS 163A.125, ORS 163A.200, ORS 163A.225

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `8db0b1120917b3b3971f82e4be74458f9e5e53aa4dc187c02e181e51025665df` (snapshot `_meta/snapshots/measure-2025r1-sb820-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB820/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 820` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

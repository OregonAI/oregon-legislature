...
jurisdiction: oregon
id: measure-2025r1-hb2169
title: 'HB 2169 (2025R1): Establishes state policy on water reuse.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2169
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2169/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: eacad3cedec46c3012c5fb174ac71a38d9e634f5469be0891770a712caf3a50f
snapshot_id: measure-2025r1-hb2169-enrolled
status: current
...
catch_line: Establishes state policy on water reuse.
minority_catch_line: null
measure_summary: "\tDigest: This Act sets state policy on water reuse and tells DEQ to make a water reuse\
  \ team. (Flesch Readability Score: 85.1). \n\tEstablishes state policy on water reuse. Directs the Department\
  \ of Environmental Quality to establish an interagency water reuse team. \n\tDeclares an emergency,\
  \ effective July 1, 2025."
relating_to: Relating to water reuse; and declaring an emergency.
relating_to_full: Relating to water reuse; and declaring an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2169`.

# HB 2169 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2169, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 5909 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2169/Enrolled>.

## Summary

**Catchline:** Establishes state policy on water reuse.
...
**RelatingToFull (verbatim upstream field):** Relating to water reuse; and declaring an emergency.
...
state;
Enrolled House Bill 2169 (HB 2169-B) Page 1
(d) Identify and propose regulatory changes  needed to overcome barriers to water reuse
...
Enrolled House Bill 2169 (HB 2169-B) Page 2
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `eacad3cedec46c3012c5fb174ac71a38d9e634f5469be0891770a712caf3a50f` (snapshot `_meta/snapshots/measure-2025r1-hb2169-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2169/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `7c4d03b9ffb73fdc555c161f3629ba9498bb4c865706390ce68f190bc6d373db` (snapshot `_meta/snapshots/measure-2025r1-hb2169-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2169/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2169` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

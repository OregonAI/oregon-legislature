...
jurisdiction: oregon
id: measure-2025r1-hb2552
title: 'HB 2552 (2025R1): Creates workplace violence prevention requirements for certain health care entities.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2552
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2552/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5f33733adde3f209c83c12f7c1d8c67bfc2b4edcf4966d5fbb4559476d6123ec
snapshot_id: measure-2025r1-hb2552-introduced
status: current
...
measure_summary: "\tDigest: The Act creates new laws for workplace violence prevention in health care\
  \ settings. The Act takes effect 91 days following sine die. (Flesch Readability Score: 72.6). \n\t\
  Creates workplace violence prevention requirements for certain health care entities. Requires subject\
  \ entities to compile data concerning incidents of workplace violence and submit reports to the Department\
  ...
  \ \n\tRequires the Oregon Health Authority to develop and administer a grant program to provide financial\
  \ assistance to eligible entities for workplace violence prevention efforts. Establishes a timeline\
  \ within which the authority must begin distributing funds to approved grant applicants. \n\tTakes effect\
  \ on the 91st day following adjournment sine die."
relating_to: Relating to violence in health care settings; prescribing an effective date.
relating_to_full: Relating to violence in health care settings; creating new provisions; amending ORS
  441.096, 654.062, 654.182, 654.412, 654.414 and 654.416; and prescribing an effective date.
at_the_request_of: null
lc_number: 3357
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T13:06:32'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 45768
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2552>.

# HB 2552 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2552, 2025 Regular Session (2025R1)
- **LC number:** 3357
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T13:06:32
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 45768 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2552/Introduced>.
...
**RelatingToFull (verbatim upstream field):** Relating to violence in health care settings; creating new provisions; amending ORS 441.096, 654.062, 654.182, 654.412, 654.414 and 654.416; and prescribing an effective date.

## Full text

83rd OREGON LEGISLATIVE ASSEMBLY--2025 Regular Session
House Bill 2552
Sponsored by Representative NELSON, Senator PATTERSON, Representative NOSSE, Senators  MEEK,
REYNOLDS, TAYLOR; Representative PHAM H, Senators FREDERICK, PROZANSKI (Presession filed.)
SUMMARY
...
SECTION 2.
 ORS 654.412 is amended to read:
...
(Reporting)
SECTION 4.
Sections 5, 6, 7 and  8 of this 2025 Act are added to and made a part of ORS
654.412 to 654.423.
...
under this section.
SECTION 6.
Not later than December 31 of each year, the Department of Consumer and
...
the premises of a health care employer during the previous four-year period and  include an
analysis of:
...
SECTION 8.
 The Department of  Consumer and Business Services shall commission the
...
program or a hospital must demonstrate to the authority’s  satisfaction that the home health
...
SECTION 11.
The Oregon Health Authority shall begin distributing the funds specifically
...
U.S.C. 651 et seq.).
SECTION 15.
 ORS 654.416 is amended to read:
...
(Signage)
SECTION 16.
Section 17 of this  2025 Act is added to and made a part of ORS chapter 654.
...
SECTION 20.
(1) As used in this section and section 21 of this 2025 Act:
...
(E) Potential health, safety and electrical hazards.
(Training)
SECTION 21.
(1) To support the safety of home  health care staff while working in a home
...
OPERATIVE DATE
SECTION 23.
(1) Sections 5 to 11, 17  and 19 to 21 of this 2025 Act and the amendments
...
- From `RelatingToFull`: ORS 441.096, ORS 654.062, ORS 654.182, ORS 654.412, ORS 654.414, ORS 654.416
- From bill text (Introduced version): ORS 163.165, ORS 192.245, ORS 192.311, ORS 413.300, ORS 441.096, ORS 441.179, ORS 441.760, ORS 442.015, ORS 442.470, ORS 443.014, ORS 654.001, ORS 654.062, ORS 654.176, ORS 654.182, ORS 654.412, ORS 654.414, ORS 654.416, ORS 659A.030, ORS 659A.820

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `5f33733adde3f209c83c12f7c1d8c67bfc2b4edcf4966d5fbb4559476d6123ec` (snapshot `_meta/snapshots/measure-2025r1-hb2552-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2552/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2552> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

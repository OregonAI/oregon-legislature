...
jurisdiction: oregon
id: measure-2025r1-hb3378
title: 'HB 3378 (2025R1): Requires residential landlords to offer a method of accessing the dwelling unit
  other than software on tenant-owned phones or other electronic devices for the dwelling to be considered
  habitable.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3378
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3378/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: dcfc9ee4153ca304bea43205f93b2d851b15f1d736093fde3fe50bd927491aca
snapshot_id: measure-2025r1-hb3378-enrolled
status: current
...
catch_line: Requires residential landlords to offer a method of accessing the dwelling unit other than
  software on tenant-owned phones or other electronic devices for the dwelling to be considered habitable.
minority_catch_line: null
measure_summary: "\tDigest: This Act requires landlords to offer nonapp keys to tenants. (Flesch Readability\
  \ Score: 69.7). \n\tRequires residential landlords to offer a method of accessing the dwelling unit\
  \ other than software on tenant-owned phones or other electronic devices for the dwelling to be considered\
  \ habitable."
relating_to: Relating to tenant dwelling access to dwelling unit.
relating_to_full: Relating to tenant dwelling access to dwelling unit.
at_the_request_of: null
lc_number: 3314
measure_created_date: '2025-01-22T17:06:58'
...
# HB 3378 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3378, 2025 Regular Session (2025R1)
- **LC number:** 3314
- **Created:** 2025-01-22T17:06:58
- **Metadata last modified (upstream):** 2025-06-11T17:12:27
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 8002 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3378/Enrolled>.

## Summary

**Catchline:** Requires residential landlords to offer a method of accessing the dwelling unit other than software on tenant-owned phones or other electronic devices for the dwelling to be considered habitable.
...
**RelatingToFull (verbatim upstream field):** Relating to tenant dwelling access to dwelling unit.
...
- From bill text (Enrolled version): ORS 431A.430, ORS 458.395, ORS 479.270, ORS 757.612, ORS 90.320, ORS 90.325, ORS 90.355, ORS 90.730

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `dcfc9ee4153ca304bea43205f93b2d851b15f1d736093fde3fe50bd927491aca` (snapshot `_meta/snapshots/measure-2025r1-hb3378-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3378/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `877a528cd0d3647cbbed30936763d32a81e899cf1814a9759ea449834a107384` (snapshot `_meta/snapshots/measure-2025r1-hb3378-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3378/Introduced>.

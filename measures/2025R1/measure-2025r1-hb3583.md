...
jurisdiction: oregon
id: measure-2025r1-hb3583
title: 'HB 3583 (2025R1): Requires the sentencing court to consider as mitigation evidence whether the
  defendant was subjected to domestic violence that was ongoing when the criminal behavior occurred and
  was a significant factor in the criminal behavior, and the criminal behavior was directed against the
  domestic violence perpetrator.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3583
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3583/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 8ec7f1efb106d4f6805f6de22d79dd31f8b0ee730f503f9e7be74b343c147212
snapshot_id: measure-2025r1-hb3583-introduced
status: current
...
catch_line: Requires the sentencing court to consider as mitigation evidence whether the defendant was
  subjected to domestic violence that was ongoing when the criminal behavior occurred and was a significant
  factor in the criminal behavior, and the criminal behavior was directed against the domestic violence
  perpetrator.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes sentencing for people who are domestic violence survivors.\
  \ The Act takes effect on the 91st day after sine die. (Flesch Readability Score: 61.0). \n\tRequires\
  \ the sentencing court to consider as mitigation evidence whether the defendant was subjected to domestic\
  \ violence that was ongoing when the criminal behavior occurred and was a significant factor in the\
  \ criminal behavior, and the criminal behavior was directed against the domestic violence perpetrator.\
  \ Provides that such evidence constitutes substantial and compelling reasons justifying a downward departure\
  \ sentence. Authorizes the court to impose a lesser sentence even if there is a mandatory minimum sentence\
  \ or a sentence otherwise required by law. \n\tTakes effect on the 91st day following adjournment sine\
  \ die."
...
lc_number: 3361
measure_created_date: '2025-02-13T10:28:49'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3583>.

# HB 3583 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3583, 2025 Regular Session (2025R1)
- **LC number:** 3361
- **Created:** 2025-02-13T10:28:49
- **Metadata last modified (upstream):** 2025-02-20T10:59:34
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 81240 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3583/Introduced>.

## Summary

**Catchline:** Requires the sentencing court to consider as mitigation evidence whether the defendant was subjected to domestic violence that was ongoing when the criminal behavior occurred and was a significant factor in the criminal behavior, and the criminal behavior was directed against the domestic violence perpetrator.
...
LC 3361
(4) As used in this section, “domestic violence” has the meaning given that  term in ORS
135.230.
SECTION 2.
...
APPLICABILITY
SECTION 19.
Section 1 of this 2025 Act and  the amendments to ORS 137.635, 137.690,
...
- From bill text (Introduced version): ORS 131.505, ORS 135.230, ORS 135.335, ORS 137.079, ORS 137.120, ORS 137.124, ORS 137.172, ORS 137.635, ORS 137.690, ORS 137.700, ORS 137.707, ORS 137.712, ORS 137.717, ORS 137.750, ORS 138.035, ORS 138.052, ORS 138.071, ORS 138.105, ORS 138.115, ORS 144.087, ORS 144.110, ORS 144.120, ORS 144.285, ORS 144.397, ORS 144.780, ORS 161.605, ORS 161.610, ORS 161.620, ORS 162.165, ORS 163.095, ORS 163.105, ORS 163.107, ORS 163.115, ORS 163.118, ORS 163.125, ORS 163.149, ORS 163.150, ORS 163.155, ORS 163.175, ORS 163.185, ORS 163.205, ORS 163.225, ORS 163.235, ORS 163.365, ORS 163.375, ORS 163.395, ORS 163.405, ORS 163.408, ORS 163.411, ORS 163.427, ORS 163.535, ORS 163.545, ORS 163.670, ORS 164.045, ORS 164.055, ORS 164.057, ORS 164.061, ORS 164.098, ORS 164.135, ORS 164.162, ORS 164.215, ORS 164.225, ORS 164.325, ORS 164.354, ORS 164.365, ORS 164.377, ORS 164.395, ORS 164.405, ORS 164.415, ORS 165.007, ORS 165.013, ORS 165.017, ORS 165.022, ORS 165.055, ORS 165.800, ORS 165.803, ORS 167.017, ORS 181A.355, ORS 419A.255, ORS 419C.067, ORS 419C.349, ORS 419C.352, ORS 419C.364, ORS 419C.411, ORS 420.240, ORS 420A.203, ORS 420A.206, ORS 421.084, ORS 421.120, ORS 421.121, ORS 421.168, ORS 475.907, ORS 475.924, ORS 475.925, ORS 475.930, ORS 819.300, ORS 819.310

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `8ec7f1efb106d4f6805f6de22d79dd31f8b0ee730f503f9e7be74b343c147212` (snapshot `_meta/snapshots/measure-2025r1-hb3583-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3583/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3583> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

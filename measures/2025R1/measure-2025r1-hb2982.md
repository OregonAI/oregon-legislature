...
jurisdiction: oregon
id: measure-2025r1-hb2982
title: 'HB 2982 (2025R1): Increases boating fees and deposits moneys into the Aquatic Invasive Species
  Prevention Fund.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2982
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2982/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 40e6ad2a825d3494aa818c08afa9f9fc20715481181bd215d82a998fc4173a6d
snapshot_id: measure-2025r1-hb2982-enrolled
status: current
...
catch_line: Increases boating fees and deposits moneys into the Aquatic Invasive Species Prevention Fund.
minority_catch_line: null
measure_summary: "\tDigest: The Act increases some boat fees. The money raised will be put into a fund\
  \ to prevent and control plants and animals that do not belong in the waters of this state. (Flesch\
  \ Readability Score: 79.5). \n\tIncreases boating fees and deposits moneys into the Aquatic Invasive\
  \ Species Prevention Fund. \n\tProvides that a waterway access permit is required while operating a\
  \ nonmotorized boat of any length.<b> Creates exceptions.</b>"
relating_to: Relating to small watercraft.
relating_to_full: Relating to small watercraft.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2982`.

# HB 2982 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2982, 2025 Regular Session (2025R1)
- **LC number:** 2655
...
- **Full text below:** Enrolled version, 8185 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2982/Enrolled>.

## Summary

**Catchline:** Increases boating fees and deposits moneys into the Aquatic Invasive Species Prevention Fund.
...
**RelatingToFull (verbatim upstream field):** Relating to small watercraft.
...
Enrolled House Bill 2982 (HB 2982-A) Page 1
(6) For each original or  renewal certificate fee collected under subsection (4)(b) of this
...
Enrolled House Bill 2982 (HB 2982-A) Page 2
(d) A person operating a boat if the person is engaged in law enforcement, public  safety or of-
...
Enrolled House Bill 2982 (HB 2982-A) Page 3
...
- From bill text (Enrolled version): ORS 308.505, ORS 830.575, ORS 830.585, ORS 830.615, ORS 830.624, ORS 830.627, ORS 830.790

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `40e6ad2a825d3494aa818c08afa9f9fc20715481181bd215d82a998fc4173a6d` (snapshot `_meta/snapshots/measure-2025r1-hb2982-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2982/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `0c4110331467ba5ec18e2e16250bb8f722c402013df7c26d247d1defe94ba8aa` (snapshot `_meta/snapshots/measure-2025r1-hb2982-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2982/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2982` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

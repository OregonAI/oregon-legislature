...
jurisdiction: oregon
id: measure-2025r1-hb3920
title: 'HB 3920 (2025R1): Increases the age limit for tuition waivers for qualified students.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3920
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3920/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 6b18a907ea13b44468443e03839c2eee87bdeadd73454ba31a3c12b9e07fa6ee
snapshot_id: measure-2025r1-hb3920-enrolled
status: current
...
catch_line: Increases the age limit for tuition waivers for qualified students.
minority_catch_line: null
measure_summary: "\tDigest: The Act says that certain students may receive free tuition. (Flesch Readability\
  \ Score: 78.2). \n\tIncreases the age limit for tuition waivers for qualified students. Permits a qualified\
  \ student to receive a tuition waiver for a master's degree notwithstanding whether the qualified student\
  \ received a waiver for a baccalaureate degree. Removes the requirement that a qualified student apply\
  \ for a master's degree within 12 months of receiving a baccalaureate degree to receive a tuition waiver\
  \ for a master's degree. Permits a qualified student to receive a tuition waiver for a master's degree\
  \ if the student presents proof of eligibility for specified federal assistance. \n\tTakes effect on\
  \ the 91st day following adjournment sine die."
relating_to: Relating to waiver of tuition for certain qualified students; and prescribing an effective
  date.
relating_to_full: Relating to waiver of tuition for certain qualified students; and prescribing an effective
  date.
at_the_request_of: null
lc_number: 4700
measure_created_date: '2025-03-11T15:32:02'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3920`.

# HB 3920 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3920, 2025 Regular Session (2025R1)
- **LC number:** 4700
- **Created:** 2025-03-11T15:32:02
- **Metadata last modified (upstream):** 2025-06-11T16:46:08
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 5866 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3920/Enrolled>.

## Summary

**Catchline:** Increases the age limit for tuition waivers for qualified students.
...
**RelatingToFull (verbatim upstream field):** Relating to waiver of tuition for certain qualified students; and prescribing an effective date.
...
Enrolled House Bill 3920 (HB 3920-INTRO) Page 1
...
Enrolled House Bill 3920 (HB 3920-INTRO) Page 2
...
Enrolled House Bill 3920 (HB 3920-INTRO) Page 3
...
- From bill text (Enrolled version): ORS 348.205, ORS 350.285, ORS 352.002

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `6b18a907ea13b44468443e03839c2eee87bdeadd73454ba31a3c12b9e07fa6ee` (snapshot `_meta/snapshots/measure-2025r1-hb3920-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3920/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `bd06dbee65af429dfb280adad23461f84393947a92b72ac0b07deef478dff73b` (snapshot `_meta/snapshots/measure-2025r1-hb3920-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3920/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3920` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

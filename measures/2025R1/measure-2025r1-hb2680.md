...
jurisdiction: oregon
id: measure-2025r1-hb2680
title: 'HB 2680 (2025R1): Requires a contractor, as a condition of receiving public funds to install,
  repair or remodel a fenestration product or system in a public building, to have a national certification
  as a glazing contractor and at least one employee that has a national certification as an architectural
  glass and metal technician.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2680
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2680/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b11a2155ef23ddd45fe41ed803c886e647095fedba4e409e8a3c8269b430fe7d
snapshot_id: measure-2025r1-hb2680-enrolled
status: current
...
catch_line: Requires a contractor, as a condition of receiving public funds to install, repair or remodel
  a fenestration product or system in a public building, to have a national certification as a glazing
  contractor and at least one employee that has a national certification as an architectural glass and
  metal technician.
minority_catch_line: null
measure_summary: "\tDigest: Says that a firm that installs, repairs or remodels glass in a public building\
  \ must be properly qualified to do the work if the firm wants to get public funds for the work. (Flesch\
  \ Readability Score: 60.5). \n\tRequires a contractor, as a condition of receiving public funds to install,\
  \ repair or remodel a fenestration product or system in a public building, to have a national certification\
  \ as a glazing contractor and at least one employee that has a national certification as an architectural\
  \ glass and metal technician. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to certifications required for work with fenestration systems in public buildings;
  and prescribing an effective date.
relating_to_full: Relating to certifications required for work with fenestration systems in public buildings;
  and prescribing an effective date.
at_the_request_of: null
lc_number: 1797
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2026-04-14T13:00:44'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2680`.

# HB 2680 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2680, 2025 Regular Session (2025R1)
- **LC number:** 1797
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-04-14T13:00:44
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 8759 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2680/Enrolled>.

## Summary

**Catchline:** Requires a contractor, as a condition of receiving public funds to install, repair or remodel a fenestration product or system in a public building, to have a national certification as a glazing contractor and at least one employee that has a national certification as an architectural glass and metal technician.
...
**RelatingToFull (verbatim upstream field):** Relating to certifications required for work with fenestration systems in public buildings; and prescribing an effective date.
...
Enrolled House Bill 2680 (HB 2680-A) Page 1
(A) Has all licenses and  insurance required to perform construction work in this state;
and
...
Enrolled House Bill 2680 (HB 2680-A) Page 2
(4) A contractor that installs, repairs or remodels a fenestration product or system in  a public
...
Enrolled House Bill 2680 (HB 2680-A) Page 3
...
- From bill text (Enrolled version): ORS 174.109, ORS 455.560

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `b11a2155ef23ddd45fe41ed803c886e647095fedba4e409e8a3c8269b430fe7d` (snapshot `_meta/snapshots/measure-2025r1-hb2680-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2680/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `c30eaf9911a2bfd6e82c9995d3fa3173925f8f65d86afb4d4d39b76c78555319` (snapshot `_meta/snapshots/measure-2025r1-hb2680-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2680/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2680` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

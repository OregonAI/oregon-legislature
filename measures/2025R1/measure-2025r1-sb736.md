...
jurisdiction: oregon
id: measure-2025r1-sb736
title: 'SB 736 (2025R1): Creates an exception to abuse of a child in care provisions when the suspected
  abuse was committed by the parent of the child in care.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 736
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB736/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 47d2d27a3ef6dbf214ac8be824b7ee973e3b73f55baf8222fa34d159c953b891
snapshot_id: measure-2025r1-sb736-enrolled
status: current
...
catch_line: Creates an exception to abuse of a child in care provisions when the suspected abuse was committed
  by the parent of the child in care.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act excludes a child's parents from some laws about abuse of a child\
  \ in care and requires DHS to tell some people that a DHS employee is not a lawyer. (Flesch Readability\
  \ Score: 66.2).</b> \n\t[<i>Digest: The Act excludes a child's parents from some laws about abuse of\
  \ a child in care and requires DHS to give a parent notice of rights before meetings in child abuse\
  \ matters. (Flesch Readability Score: 70.1).</i>] \n\tCreates an exception to abuse of a child in care\
  \ provisions when the suspected abuse was committed by the parent of the child in care. \n\t[<i>Requires\
  \ that the Department of Human Services provide parents and guardians with a notice of rights before\
  \ interviews in child abuse investigations.</i>] \n\t<b>Requires the Department of Human Services to\
  \ notify a child's parents or guardians that the department representative is not an attorney and cannot\
  \ give the parent or guardian legal advice. \n\tDeclares an emergency, effective on passage.</b>"
relating_to: Relating to investigations of child abuse involving the child's parent; and declaring an
  emergency.
relating_to_full: Relating to investigations of child abuse involving the child's parent; and declaring
  an emergency.
at_the_request_of: null
lc_number: 1469
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-06-28T16:38:54'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 736`.

# SB 736 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 736, 2025 Regular Session (2025R1)
- **LC number:** 1469
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-06-28T16:38:54
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 5201 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB736/Enrolled>.

## Summary

**Catchline:** Creates an exception to abuse of a child in care provisions when the suspected abuse was committed by the parent of the child in care.
...
**RelatingToFull (verbatim upstream field):** Relating to investigations of child abuse involving the child's parent; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 409.185, ORS 417.705, ORS 417.815, ORS 418.257, ORS 418.702, ORS 418.747, ORS 418.748

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `47d2d27a3ef6dbf214ac8be824b7ee973e3b73f55baf8222fa34d159c953b891` (snapshot `_meta/snapshots/measure-2025r1-sb736-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB736/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `8f874597db9fa5cee0a1ada5c7711ad75181f42320c0bfc392b06055e1587d86` (snapshot `_meta/snapshots/measure-2025r1-sb736-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB736/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 736` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

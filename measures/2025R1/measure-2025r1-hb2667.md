...
jurisdiction: oregon
id: measure-2025r1-hb2667
title: 'HB 2667 (2025R1): Creates the crime of criminal defamation of a servicemember.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2667
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2667/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: db86f4d3d7ac8e2713ddc16214e9cf696f16ec6d0da2f42f68e5f13f425b1b3a
snapshot_id: measure-2025r1-hb2667-introduced
status: current
...
catch_line: Creates the crime of criminal defamation of a servicemember.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes two new crimes about servicemembers. (Flesch Readability Score:\
  \ 61.2). \n\tCreates the crime of criminal defamation of a servicemember. Punishes by a maximum of 364\
  \ days' imprisonment, $6,250 fine, or both. \n\tCreates the crime of unlawful appropriation of the identity\
  \ of a servicemember. Punishes by a maximum of 364 days' imprisonment, $6,250 fine, or both."
...
# HB 2667 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2667, 2025 Regular Session (2025R1)
- **LC number:** 3168
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:26:35
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4097 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2667/Introduced>.

## Summary

**Catchline:** Creates the crime of criminal defamation of a servicemember.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `db86f4d3d7ac8e2713ddc16214e9cf696f16ec6d0da2f42f68e5f13f425b1b3a` (snapshot `_meta/snapshots/measure-2025r1-hb2667-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2667/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2667> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

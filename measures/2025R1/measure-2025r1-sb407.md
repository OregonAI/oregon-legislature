...
jurisdiction: oregon
id: measure-2025r1-sb407
title: 'SB 407 (2025R1): Reduces the rate of tax on capital gains of personal income and corporate income
  and excise taxpayers.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 407
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB407/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5d737cd627a5d6649fad5e3241c3b41b4c9eb92a99fc59fb1c6a67c23586a92d
snapshot_id: measure-2025r1-sb407-introduced
status: current
...
catch_line: Reduces the rate of tax on capital gains of personal income and corporate income and excise
  taxpayers.
minority_catch_line: null
measure_summary: "\tDigest: The Act reduces tax rates on capital gains. (Flesch Readability Score: 82.3).\
  \ \n\tReduces the rate of tax on capital gains of personal income and corporate income and excise taxpayers.\
  \ \n\tApplies to tax years beginning on or after January 1, 2025. \n\tTakes effect on the 91st day following\
  \ adjournment sine die.\t."
relating_to: Relating to decreases in capital gains tax rates; prescribing an effective date.
relating_to_full: Relating to decreases in capital gains tax rates; creating new provisions; amending
  ORS 316.037, 316.122, 317.061 and 318.020; and prescribing an effective date.
...
# SB 407 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 407, 2025 Regular Session (2025R1)
- **LC number:** 1445
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-24T09:07:12
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 8269 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB407/Introduced>.

## Summary

**Catchline:** Reduces the rate of tax on capital gains of personal income and corporate income and excise taxpayers.

**Relating to:** Relating to decreases in capital gains tax rates; prescribing an effective date.
...
**RelatingToFull (verbatim upstream field):** Relating to decreases in capital gains tax rates; creating new provisions; amending ORS 316.037, 316.122, 317.061 and 318.020; and prescribing an effective date.
...
- From `RelatingToFull`: ORS 316.037, ORS 316.122, ORS 317.061, ORS 318.020
- From bill text (Introduced version): ORS 316.037, ORS 316.045, ORS 316.117, ORS 316.122, ORS 316.367, ORS 317.061, ORS 317.063, ORS 318.020

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `5d737cd627a5d6649fad5e3241c3b41b4c9eb92a99fc59fb1c6a67c23586a92d` (snapshot `_meta/snapshots/measure-2025r1-sb407-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB407/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 407` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

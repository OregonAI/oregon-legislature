...
jurisdiction: oregon
id: measure-2025r1-hb3349
title: 'HB 3349 (2025R1): Authorizes the State Forestry Department to take certain actions related to
  motor vehicles and other equipment used by the department.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3349
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3349/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 09082f956532e0f5d84df0a5641177745fa7b1649376661df7988c9cf33a508d
snapshot_id: measure-2025r1-hb3349-enrolled
status: current
...
catch_line: Authorizes the State Forestry Department to take certain actions related to motor vehicles
  and other equipment used by the department.
minority_catch_line: null
measure_summary: "\tDigest: The Act allows an agency to take certain actions related to items used for\
  \ fighting fires. The Act makes changes related to groups that fight fires in certain rural areas. The\
  \ Act creates a new fund for providing moneys and items to groups. (Flesch Readability Score: 70.8).\
  \ \n\tAuthorizes the State Forestry Department to take certain actions related to motor vehicles and\
  \ other equipment used by the department. \n\tInstructs and authorizes the department to take certain\
  \ actions related to rangeland protection associations. \n\tEstablishes the Rangeland Protection Association\
  \ Fund.<b> Appropriates moneys to the fund and establishes an expenditure limitation for the fund.</b>\
  \ \n\tMakes certain changes related to the authority of the State Forester to assist rangeland protection\
  \ associations. \n\tAuthorizes the State Forester and forest protection associations to acquire or dispose\
  \ of goods, services or equipment for the prevention, mitigation or suppression of fire on forestland.\
  \ \n\tDeclares an emergency, effective on passage."
relating_to: Relating to fire protection; and declaring an emergency.
relating_to_full: Relating to fire protection; and declaring an emergency.
at_the_request_of: (at the request of former Senator Lynn Findley)
lc_number: 1616
measure_created_date: '2025-01-21T10:35:31'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3349`.

# HB 3349 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3349, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of former Senator Lynn Findley)
- **LC number:** 1616
- **Created:** 2025-01-21T10:35:31
- **Metadata last modified (upstream):** 2025-08-07T14:21:52
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 6605 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3349/Enrolled>.

## Summary

**Catchline:** Authorizes the State Forestry Department to take certain actions related to motor vehicles and other equipment used by the department.

**Relating to:** Relating to fire protection; and declaring an emergency.

Digest: The Act allows an agency to take certain actions related to items used for fighting fires. The Act makes changes related to groups that fight fires in certain rural areas. The Act creates a new fund for providing moneys and items to groups. (Flesch Readability Score: 70.8). 
 ...
 Instructs and authorizes the department to take certain actions related to rangeland protection associations. 
 Establishes the Rangeland Protection Association Fund.<b> Appropriates moneys to the fund and establishes an expenditure limitation for the fund.</b> 
 Makes certain changes related to the authority of the State Forester to assist rangeland protection associations. 
 Authorizes the State Forester and forest protection associations to acquire or dispose of goods, services or equipment for the prevention, mitigation or suppression of fire on forestland. 
 Declares an emergency, effective on passage.

**RelatingToFull (verbatim upstream field):** Relating to fire protection; and declaring an emergency.
...
Enrolled House Bill 3349 (HB 3349-B) Page 1
...
on its passage.
Enrolled House Bill 3349 (HB 3349-B) Page 2
...
Enrolled House Bill 3349 (HB 3349-B) Page 3
...
- From bill text (Enrolled version): ORS 283.310, ORS 283.315, ORS 477.230, ORS 477.315, ORS 477.317, ORS 477.320, ORS 477.406

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `09082f956532e0f5d84df0a5641177745fa7b1649376661df7988c9cf33a508d` (snapshot `_meta/snapshots/measure-2025r1-hb3349-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3349/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `58473a295d404e95737217828ef26a880f3ab614c6a43743ed0c3addfc6feb2c` (snapshot `_meta/snapshots/measure-2025r1-hb3349-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3349/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3349` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

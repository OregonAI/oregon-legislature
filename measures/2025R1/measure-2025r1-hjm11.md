...
jurisdiction: oregon
id: measure-2025r1-hjm11
title: 'HJM 11 (2025R1): Urges Congress and federal agencies to adopt land management reforms that will
  improve the prevention and mitigation of wildfires on federal lands.'
doc_type: dataset_doc
citation: 2025 Regular Session House Joint Memorial 11
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJM11/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 058f66abfa2ceb51924953920d97a1012926345ab6f964b78786e3c85842a34a
snapshot_id: measure-2025r1-hjm11-introduced
status: current
...
catch_line: Urges Congress and federal agencies to adopt land management reforms that will improve the
  prevention and mitigation of wildfires on federal lands.
minority_catch_line: null
measure_summary: "\tDigest: Asks the federal government to make changes in laws to prevent wildfires.\
  \ (Flesch Readability Score: 60.7). \n\tUrges Congress and federal agencies to adopt land management\
  \ reforms that will improve the prevention and mitigation of wildfires on federal lands."
relating_to: Urging Congress and federal agencies to adopt land management reforms that will improve the
  prevention and mitigation of wildfires on federal lands.
relating_to_full: null
at_the_request_of: null
lc_number: 4087
measure_created_date: '2025-01-21T10:45:20'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HJM' and MeasureNumber eq 11>.

# HJM 11 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Joint Memorial 11, 2025 Regular Session (2025R1)
- **LC number:** 4087
- **Created:** 2025-01-21T10:45:20
- **Metadata last modified (upstream):** 2025-01-30T13:16:12
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4022 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJM11/Introduced>.

## Summary

**Catchline:** Urges Congress and federal agencies to adopt land management reforms that will improve the prevention and mitigation of wildfires on federal lands.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `058f66abfa2ceb51924953920d97a1012926345ab6f964b78786e3c85842a34a` (snapshot `_meta/snapshots/measure-2025r1-hjm11-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJM11/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HJM' and MeasureNumber eq 11> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2583
title: 'HB 2583 (2025R1): Allows virtual public charter schools that do not provide educational services
  through a for-profit entity that contracts with the governing body of the virtual public charter school
  to be eligible for grants distributed from the Student Investment Account.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2583
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2583/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 097abf8555723b991df581705277c0b4b0abd1317662973661abc46bfe5f645e
snapshot_id: measure-2025r1-hb2583-introduced
status: current
...
catch_line: Allows virtual public charter schools that do not provide educational services through a for-profit
  entity that contracts with the governing body of the virtual public charter school to be eligible for
  grants distributed from the Student Investment Account.
minority_catch_line: null
measure_summary: "\tDigest: Allows some virtual public charter schools to receive an SIA grant. (Flesch\
  \ Readability Score: 64.9). \n\tAllows virtual public charter schools that do not provide educational\
  \ services through a for-profit entity that contracts with the governing body of the virtual public\
  \ charter school to be eligible for grants distributed from the Student Investment Account. \n\tDeclares\
  \ an emergency, effective on passage."
relating_to: Relating to public charter school eligibility for grants from the Student Investment Account;
  declaring an emergency.
relating_to_full: Relating to public charter school eligibility for grants from the Student Investment
  Account; creating new provisions; amending ORS 327.185 and 327.195; and declaring an emergency.
at_the_request_of: null
lc_number: 181
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-04-03T09:57:40'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 13046
...
# HB 2583 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2583, 2025 Regular Session (2025R1)
- **LC number:** 181
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-04-03T09:57:40
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 13046 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2583/Introduced>.

## Summary

**Catchline:** Allows virtual public charter schools that do not provide educational services through a for-profit entity that contracts with the governing body of the virtual public charter school to be eligible for grants distributed from the Student Investment Account.

**Relating to:** Relating to public charter school eligibility for grants from the Student Investment Account; declaring an emergency.

Digest: Allows some virtual public charter schools to receive an SIA grant. (Flesch Readability Score: 64.9). 
 Allows virtual public charter schools that do not provide educational services through a for-profit entity that contracts with the governing body of the virtual public charter school to be eligible for grants distributed from the Student Investment Account. 
 Declares an emergency, effective on passage.

**RelatingToFull (verbatim upstream field):** Relating to public charter school eligibility for grants from the Student Investment Account; creating new provisions; amending ORS 327.185 and 327.195; and declaring an emergency.
...
standards.
Digest: Allows some virtual public charter schools to receive an SIA grant.  (Flesch Readability
Score:  64.9).
Allows  virtual  public charter schools that do not provide educational services through a for-
profit entity that contracts with the governing  body of the virtual public charter school to be eli-
gible for grants distributed from the Student Investment Account.
Declares an emergency, effective on passage.
A BILL FOR AN ACT
Relating to public charter school eligibility for  grants from the Student Investment Account; creat-
ing new provisions; amending ORS 327.185 and 327.195; and declaring an emergency.
...
(a) “Eligible applicant” means any of the following entities:
(A) A common school district or a union high school district.
(B) The Youth Corrections Education Program or the  Juvenile Detention Education
Program.
(C) An eligible public charter school.
(b) “Eligible public charter school” means a public charter school that:
(A) Is not a virtual public charter school for which a  for-profit entity contracts with the
governing body of the virtual public charter school to provide educational management ser-
vices; and
(B) Has a student population of which:
[(A)] (i) At least 35 percent of the student population is  composed of students from the following
student groups:
[(i)] (I) Economically disadvantaged, as described in ORS 327.180 (2)(b)(A);
[(ii)] (II) Racial or ethnic groups  that have historically experienced academic disparities, as
described in ORS 327.180 (2)(b)(B); or
[(iii)] (III) Students with disabilities, as described in ORS 327.180 (2)(b)(C); and
[(B)] (ii) The percentage of the students from  student groups identified under [ subparagraph (A)
NOTE: Matter in  boldfaced type in an amended section is new;  matter [ italic and bracketed] is existing law to be omitted.
New sections are in  boldfaced type.
LC 181
of this paragraph ] sub-subparagraph (i) of this subparagraph  is greater than or equal to:
[(i)] (I) The percentage of all students  in the school district who are economically disadvan-
taged, if eligibility is determined based on  the percentage of students who are economically disad-
vantaged;
[(ii)] (II) The percentage of all students in the school district who  are from racial or ethnic
groups that have historically experienced academic disparities, if eligibility is  determined based on
the percentage of students who are from those racial or ethnic groups; or
[(iii)] (III) The  percentage of all students in the school district who are disabled, if eligibility
is determined based on the percentage of students who are disabled.
(c) “Virtual public charter school” has the meaning given that term in ORS 338.005.
...
(A) A virtual  public charter school, as defined in ORS 338.005 , for which a for-profit entity
contracts with the governing  body of the virtual public charter school to provide educational
management services ;
...
agreement.
SECTION 3.
The amendments to  ORS 327.195 by section 2 of this 2025 Act first apply to
calculations of grants to be distributed for the 2025-2026 school year.
...
- From `RelatingToFull`: ORS 327.185, ORS 327.195
- From bill text (Introduced version): ORS 327.013, ORS 327.026, ORS 327.180, ORS 327.185, ORS 327.190, ORS 327.195, ORS 327.500, ORS 329.095, ORS 338.005, ORS 338.155

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `097abf8555723b991df581705277c0b4b0abd1317662973661abc46bfe5f645e` (snapshot `_meta/snapshots/measure-2025r1-hb2583-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2583/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2583` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

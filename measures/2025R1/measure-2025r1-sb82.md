...
jurisdiction: oregon
id: measure-2025r1-sb82
title: 'SB 82 (2025R1): Makes changes to consultations that are required for a certain grant process.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 82
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB82/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 6f795559cd6a4f866e0a852dfc49a98d1a92b44f2b766be935f7b11ca0058af5
snapshot_id: measure-2025r1-sb82-introduced
status: current
...
catch_line: Makes changes to consultations that are required for a certain grant process.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes changes related to consulting on a grant process. The Act makes\
  \ changes related to a program to reduce wildfire risk. The Act gives money as a match for certain funds.\
  \ (Flesch Readability Score: 75.1). \n\tMakes changes to consultations that are required for a certain\
  \ grant process. \n\tMakes certain changes related to a program to reduce wildfire risk. \n\tAppropriates\
  \ moneys out of the General Fund to the Higher Education Coordinating Commission for funding certain\
  \ grant-supported projects. \n\tDeclares an emergency, effective on passage.\t."
relating_to: Relating to reducing wildfire risk; declaring an emergency.
relating_to_full: Relating to reducing wildfire risk; creating new provisions; amending ORS 476.696, 476.698
  and 477.503; and declaring an emergency.
...
# SB 82 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 82, 2025 Regular Session (2025R1)
...
- **Full text below:** Introduced version, 10872 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB82/Introduced>.

## Summary

**Catchline:** Makes changes to consultations that are required for a certain grant process.
...
**RelatingToFull (verbatim upstream field):** Relating to reducing wildfire risk; creating new provisions; amending ORS 476.696, 476.698 and 477.503; and declaring an emergency.
...
Declares an emergency, effective on passage.
A BILL FOR AN ACT
Relating to reducing wildfire  risk; creating new provisions; amending ORS 476.696 and 477.503; and
...
2025, out of the General Fund:
(1) The amount of $_____, for the  purpose of funding grant-supported projects related to
the Oregon Conservation Corps Program established by ORS 476.694.
(2) The amount of $_____,  to match dollar-for-dollar funds secured from sources other
...
- From `RelatingToFull`: ORS 476.696, ORS 476.698, ORS 477.503
- From bill text (Introduced version): ORS 192.245, ORS 293.640, ORS 390.805, ORS 476.694, ORS 476.696, ORS 476.698, ORS 477.503, ORS 496.172, ORS 660.320

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `6f795559cd6a4f866e0a852dfc49a98d1a92b44f2b766be935f7b11ca0058af5` (snapshot `_meta/snapshots/measure-2025r1-sb82-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB82/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 82` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

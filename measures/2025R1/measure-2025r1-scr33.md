...
jurisdiction: oregon
id: measure-2025r1-scr33
title: 'SCR 33 (2025R1): Recognizes and honors former Wallowa County Commissioner Susan Roberts for her
  service to this state.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Concurrent Resolution 33
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR33/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5d326623ab3a753c839e178e5bb86656652ed80ad73d54bf3854b7d274a681f0
snapshot_id: measure-2025r1-scr33-enrolled
status: current
...
catch_line: Recognizes and honors former Wallowa County Commissioner Susan Roberts for her service to
  this state.
minority_catch_line: null
measure_summary: "\tDigest: Honors Susan Roberts for her service to this state. (Flesch Readability Score:\
  \ 75.5). \n\tRecognizes and honors former Wallowa County Commissioner Susan Roberts for her service\
  \ to this state."
relating_to: Recognizing and honoring former Wallowa County Commissioner Susan Roberts for her service
  to this state.
relating_to_full: null
at_the_request_of: null
lc_number: 4954
measure_created_date: '2025-05-30T14:34:02'
measure_modified_date: '2025-06-25T09:52:22'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SCR' and MeasureNumber eq 33`.

# SCR 33 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Concurrent Resolution 33, 2025 Regular Session (2025R1)
- **LC number:** 4954
- **Created:** 2025-05-30T14:34:02
- **Metadata last modified (upstream):** 2025-06-25T09:52:22
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 8030 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR33/Enrolled>.

## Summary

**Catchline:** Recognizes and honors former Wallowa County Commissioner Susan Roberts for her service to this state.

**Relating to:** Recognizing and honoring former Wallowa County Commissioner Susan Roberts for her service to this state.

Digest: Honors Susan Roberts for her service to this state. (Flesch Readability Score: 75.5). 
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `5d326623ab3a753c839e178e5bb86656652ed80ad73d54bf3854b7d274a681f0` (snapshot `_meta/snapshots/measure-2025r1-scr33-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR33/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `4899c78c25aa1817d649d4e786ce59382f4a21f339b745294f9f72930f862255` (snapshot `_meta/snapshots/measure-2025r1-scr33-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR33/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SCR' and MeasureNumber eq 33` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

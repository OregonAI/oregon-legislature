...
jurisdiction: oregon
id: measure-2025r1-hb3468
title: 'HB 3468 (2025R1): Prohibits a county clerk from using certain information provided by the Department
  of Transportation or the Oregon Health Authority to update any registration information for an elector
  who is already registered to vote.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3468
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3468/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 2d5675d417df36f9ac20e674af3bacff20756f8293e3029caf2bd69e46bcd5ce
snapshot_id: measure-2025r1-hb3468-introduced
status: current
...
catch_line: Prohibits a county clerk from using certain information provided by the Department of Transportation
  or the Oregon Health Authority to update any registration information for an elector who is already
  registered to vote.
minority_catch_line: null
measure_summary: "\tDigest: The Act keeps county clerks from updating voter data by using data that ODOT\
  \ and OHA send. The Act lets voters use voter registration cards to make updates to their data. The\
  \ Act becomes law 91 days after the legislature is done. (Flesch Readability Score: 63.7). \n\tProhibits\
  \ a county clerk from using certain information provided by the Department of Transportation or the\
  \ Oregon Health Authority to update any registration information for an elector who is already registered\
  \ to vote. Provides that an elector may update the elector's registration information by submitting\
  \ a registration card. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to updating voter registration information; prescribing an effective date.
relating_to_full: Relating to updating voter registration information; amending ORS 247.012, 247.013,
  247.017 and 247.018; and prescribing an effective date.
at_the_request_of: null
lc_number: 1038
measure_created_date: '2025-01-28T15:26:29'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3468`.

# HB 3468 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3468, 2025 Regular Session (2025R1)
- **LC number:** 1038
- **Created:** 2025-01-28T15:26:29
- **Metadata last modified (upstream):** 2025-02-06T13:20:12
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 21853 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3468/Introduced>.

## Summary

**Catchline:** Prohibits a county clerk from using certain information provided by the Department of Transportation or the Oregon Health Authority to update any registration information for an elector who is already registered to vote.
...
**RelatingToFull (verbatim upstream field):** Relating to updating voter registration information; amending ORS 247.012, 247.013, 247.017 and 247.018; and prescribing an effective date.
...
termines that the person is qualified to vote under Article II, section  2, of the Oregon Constitution,
...
- From `RelatingToFull`: ORS 247.012, ORS 247.013, ORS 247.017, ORS 247.018
- From bill text (Introduced version): ORS 247.012, ORS 247.013, ORS 247.017, ORS 247.018, ORS 247.019, ORS 247.125, ORS 247.208, ORS 247.563, ORS 254.470

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `2d5675d417df36f9ac20e674af3bacff20756f8293e3029caf2bd69e46bcd5ce` (snapshot `_meta/snapshots/measure-2025r1-hb3468-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3468/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3468` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3312
title: 'HB 3312 (2025R1): Requires schools and school districts to offer lunch and, when applicable, breakfast
  at no charge.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3312
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3312/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e30d6e641ef5db4abea5a5ef28b18c90e535d5245f33d3503ca42704a51daa83
snapshot_id: measure-2025r1-hb3312-introduced
status: current
...
catch_line: Requires schools and school districts to offer lunch and, when applicable, breakfast at no
  charge.
minority_catch_line: null
measure_summary: "\tDigest: Requires school meals to be provided at no charge to students. (Flesch Readability\
  \ Score: 80.3). \n\tRequires schools and school districts to offer lunch and, when applicable, breakfast\
  \ at no charge. \n\tDeclares an emergency, effective July 1, 2025."
relating_to: Relating to school meals; declaring an emergency.
relating_to_full: Relating to school meals; amending ORS 327.531 and 327.545; and declaring an emergency.
at_the_request_of: null
lc_number: 1263
measure_created_date: '2025-01-12T18:31:51'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3312>.

# HB 3312 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3312, 2025 Regular Session (2025R1)
- **LC number:** 1263
- **Created:** 2025-01-12T18:31:51
- **Metadata last modified (upstream):** 2025-01-27T08:04:15
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5304 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3312/Introduced>.

## Summary

**Catchline:** Requires schools and school districts to offer lunch and, when applicable, breakfast at no charge.
...
**RelatingToFull (verbatim upstream field):** Relating to school meals; amending ORS 327.531 and 327.545; and declaring an emergency.
...
- From `RelatingToFull`: ORS 327.531, ORS 327.545
- From bill text (Introduced version): ORS 327.531, ORS 327.535, ORS 327.545

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `e30d6e641ef5db4abea5a5ef28b18c90e535d5245f33d3503ca42704a51daa83` (snapshot `_meta/snapshots/measure-2025r1-hb3312-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3312/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3312> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

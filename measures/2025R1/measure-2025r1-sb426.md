...
jurisdiction: oregon
id: measure-2025r1-sb426
title: 'SB 426 (2025R1): Makes an owner and a direct contractor jointly and severally liable in a civil
  action for any unpaid wages owed to the unrepresented employees of the direct contractor and subcontractors
  at any tier.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 426
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB426/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0f7d5c5da0672fb52b88aee34fbe939463409ee392ed0693e8089e72977c085b
snapshot_id: measure-2025r1-sb426-enrolled
status: current
...
catch_line: Makes an owner and a direct contractor jointly and severally liable in a civil action for
  ...
  any tier.
minority_catch_line: Makes a direct contractor jointly and severally liable in a civil action for any
  unpaid wages owed to the unrepresented employees of the subcontractors at any tier.
measure_summary: "\tDigest: The Act makes laws about unpaid wages for workers who work on construction\
  ...
  \ regarding recovery for unpaid wages. <b>Specifies that the joint and several liability provisions\
  \ for unpaid wages do not apply to construction work relating to real property that is used as the owner's\
  \ principal residence or real property with five or fewer residential or commercial units on a single\
  \ tract.</b> \n\tClarifies that the Attorney General may accept the assignment of claims and bring civil\
  \ actions in the name of the State of Oregon on such claims. Permits the Attorney General to adopt rules\
  \ regarding the assignment of claims. \n\tRequires notice to be sent by certified mail that informs\
  \ the owner and the direct contractor of the alleged violation and specifies the time period within\
  \ which the owner and the direct contractor may correct the alleged violation. \n\tCreates a rebuttable\
  \ presumption that, in any action for unpaid wages, the person performing labor on a construction project\
  \ is an employee. Provides that the party claiming otherwise may rebut the presumption by establishing\
  \ that the person qualifies as an independent contractor. \n\tProvides that an owner may bring an action\
  \ against a direct contractor to recover damages for amounts paid by the owner. \n\tRequires subcontractors\
  \ to provide certain payroll records and other information to the owner or the direct contractor, upon\
  \ request. Provides that subcontractors shall provide certain payroll records to an authorized third\
  \ party representative in certain circumstances. Permits the owner and the direct contractor to withhold\
  \ payment to a subcontractor in certain circumstances. Clarifies that the owner or direct contractor\
  \ may withhold payment in an amount and to the extent that the owner or direct contractor paid, on behalf\
  \ of the subcontractor, wages owed to the subcontractor's employees."
relating_to: Relating to wages.
relating_to_full: Relating to wages.
at_the_request_of: null
lc_number: 2023
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2026-02-25T12:20:32'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 426`.

# SB 426 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 426, 2025 Regular Session (2025R1)
- **LC number:** 2023
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-02-25T12:20:32
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 13329 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB426/Enrolled>.
...
- From bill text (Enrolled version): ORS 215.010, ORS 279C.800, ORS 652.750, ORS 670.600

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `0f7d5c5da0672fb52b88aee34fbe939463409ee392ed0693e8089e72977c085b` (snapshot `_meta/snapshots/measure-2025r1-sb426-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB426/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `b7502c43b95fbe3852f13d4a554f02a93a85ab613788112453125a802909f3b4` (snapshot `_meta/snapshots/measure-2025r1-sb426-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB426/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 426` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sjr14
title: 'SJR 14 (2025R1): Proposes an amendment to the Oregon Constitution to increase the number of Senators
  serving in Legislative Assembly to 36 and to modify Senate legislative districts to be coterminous with
  county boundaries. Refers the proposed amendment to the people for approval or rejection at the next
  regular general election.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Joint Resolution 14
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR14/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 26978acae5ea917fdd026934ba76b77e9f20eed68602b36a8c866f90355c2d05
snapshot_id: measure-2025r1-sjr14-introduced
status: current
...
catch_line: Proposes an amendment to the Oregon Constitution to increase the number of Senators serving
  in Legislative Assembly to 36 and to modify Senate legislative districts to be coterminous with county
  boundaries. Refers the proposed amendment to the people for approval or rejection at the next regular
  general election.
minority_catch_line: null
measure_summary: "\tDigest: The measure asks voters to change the number of Senators in the Oregon Senate\
  \ from 30 to 36 with each Senator from a county. The measure asks voters to say yes or no to this change\
  \ at the next general election. (Flesch Readability Score: 62.2). \n\tProposes an amendment to the Oregon\
  \ Constitution to increase the number of Senators serving in Legislative Assembly to 36 and to modify\
  \ Senate legislative districts to be coterminous with county boundaries. \n\tRefers the proposed amendment\
  \ to the people for approval or rejection at the next regular general election."
relating_to: Proposing an amendment to the Oregon Constitution relating to the legislative districts of
  Senators.
relating_to_full: null
at_the_request_of: null
lc_number: 2398
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T14:47:36'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 9735
...
# SJR 14 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Joint Resolution 14, 2025 Regular Session (2025R1)
- **LC number:** 2398
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T14:47:36
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 9735 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR14/Introduced>.

## Summary

**Catchline:** Proposes an amendment to the Oregon Constitution to increase the number of Senators serving in Legislative Assembly to 36 and to modify Senate legislative districts to be coterminous with county boundaries. Refers the proposed amendment to the people for approval or rejection at the next regular general election.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `26978acae5ea917fdd026934ba76b77e9f20eed68602b36a8c866f90355c2d05` (snapshot `_meta/snapshots/measure-2025r1-sjr14-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR14/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SJR' and MeasureNumber eq 14> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

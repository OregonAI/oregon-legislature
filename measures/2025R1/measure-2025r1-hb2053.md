...
jurisdiction: oregon
id: measure-2025r1-hb2053
title: 'HB 2053 (2025R1): Creates the offense of a minor purchasing or attempting to purchase, possessing
  or attempting to possess or using in public an alternative nicotine product, inhalant delivery system
  or tobacco product.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2053
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2053/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b349e8487c1384c2f92b8d29d0a406c8c8c138c301c11c654aa6e48529f7be28
snapshot_id: measure-2025r1-hb2053-introduced
status: current
...
catch_line: Creates the offense of a minor purchasing or attempting to purchase, possessing or attempting
  to possess or using in public an alternative nicotine product, inhalant delivery system or tobacco product.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes it against the law for a minor to take some actions related\
  \ to tobacco or nicotine. (Flesch Readability Score: 62.8). \n\tCreates the offense of a minor purchasing\
  \ or attempting to purchase, possessing or attempting to possess or using in public an alternative nicotine\
  \ product, inhalant delivery system or tobacco product. Punishes violation by a maximum fine of $50,\
  \ community service or participation in a health promotion and risk reduction program, or a combination\
  \ thereof."
relating_to: Relating to the health of minors.
relating_to_full: Relating to the health of minors.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2053>.

# HB 2053 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2053, 2025 Regular Session (2025R1)
- **LC number:** 2582
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-21T08:37:50
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5345 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2053/Introduced>.

## Summary

**Catchline:** Creates the offense of a minor purchasing or attempting to purchase, possessing or attempting to possess or using in public an alternative nicotine product, inhalant delivery system or tobacco product.
...
**RelatingToFull (verbatim upstream field):** Relating to the health of minors.
...
LC 2582
(b) In addition to the fine described in paragraph (a) of this subsection, a court may order
...
- From bill text (Introduced version): ORS 323.500, ORS 419A.260

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `b349e8487c1384c2f92b8d29d0a406c8c8c138c301c11c654aa6e48529f7be28` (snapshot `_meta/snapshots/measure-2025r1-hb2053-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2053/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2053> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

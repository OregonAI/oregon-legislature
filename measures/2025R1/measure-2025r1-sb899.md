...
jurisdiction: oregon
id: measure-2025r1-sb899
title: 'SB 899 (2025R1): Prohibits physicians from performing irreversible gender reassignment surgery
  on a minor.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 899
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB899/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 1341dcb2ec0849e413df5638ba79f5692bd5b8fb52dae2ae479f3006927bf8a2
snapshot_id: measure-2025r1-sb899-introduced
status: current
...
catch_line: Prohibits physicians from performing irreversible gender reassignment surgery on a minor.
minority_catch_line: null
measure_summary: "\tDigest: The Act raises the age when a person may receive some gender-affirming treatments\
  \ to 18 years of age. (Flesch Readability Score: 61.6). \n\tProhibits physicians from performing irreversible\
  \ gender reassignment surgery on a minor. Creates exceptions."
relating_to: Relating to gender reassignment surgery.
relating_to_full: Relating to gender reassignment surgery.
at_the_request_of: null
lc_number: 1239
measure_created_date: '2025-01-14T11:17:58'
...
# SB 899 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 899, 2025 Regular Session (2025R1)
- **LC number:** 1239
- **Created:** 2025-01-14T11:17:58
- **Metadata last modified (upstream):** 2025-01-21T15:40:44
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 3958 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB899/Introduced>.

## Summary

**Catchline:** Prohibits physicians from performing irreversible gender reassignment surgery on a minor.
...
**RelatingToFull (verbatim upstream field):** Relating to gender reassignment surgery.
...
- From bill text (Introduced version): ORS 435.210

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `1341dcb2ec0849e413df5638ba79f5692bd5b8fb52dae2ae479f3006927bf8a2` (snapshot `_meta/snapshots/measure-2025r1-sb899-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB899/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 899` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb960
title: 'SB 960 (2025R1): Transfers moneys between funds and modifies timing of planned transfers.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 960
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB960/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: d3f9b90f9dd924ca4f6515954964f97aa867ad7657f364c82b48c1c449c1b7cb
snapshot_id: measure-2025r1-sb960-enrolled
status: current
...
catch_line: Transfers moneys between funds and modifies timing of planned transfers.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act makes changes to the law that are related to budget decisions.\
  \ (Flesch Readability Score: 69.9).</b> \n\t[<i>Digest: The Act gives money to the CJC for the Organized\
  \ Retail Theft Grant Program. (Flesch Readability Score: 77.8).</i>] \n\t[<i>Appropriates moneys to\
  \ the Oregon Criminal Justice Commission for the Organized Retail Theft Grant Program.</i>] \n\t<b>Transfers\
  \ moneys between funds and modifies timing of planned transfers. \n\tRepeals the Summer Learning Program\
  \ Account. \n\tAuthorizes the Department of Justice to expend specified moneys for specified purposes.\
  \ \n\tProvides that a specified transfer of moneys to the Oregon Rainy Day Fund may not be made for\
  \ the biennium ending June 30, 2025. \n\tAuthorizes the Oregon Infrastructure Finance Authority to provide\
  \ financial assistance for certain levee projects to municipalities. \n\tModifies eligibility criteria\
  \ of a program to provide grants to entities that provide services to refugees. \n\tExtends deadline\
  \ for the Early Learning Council to develop and implement certain rules for the Employment Related Day\
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 960`.

# SB 960 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 960, 2025 Regular Session (2025R1)
- **LC number:** 3850
...
- **Full text below:** Enrolled version, 14565 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB960/Enrolled>.

## Summary

**Catchline:** Transfers moneys between funds and modifies timing of planned transfers.
...
- From bill text (Enrolled version): ORS 180.060, ORS 180.095, ORS 180.750, ORS 285B.410, ORS 285B.420, ORS 293.146, ORS 327.496, ORS 329A.500, ORS 336.184, ORS 411.139, ORS 541.937, ORS 59.331, ORS 646.605, ORS 646.642, ORS 646A.025, ORS 646A.589, ORS 652.409, ORS 656.605

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `d3f9b90f9dd924ca4f6515954964f97aa867ad7657f364c82b48c1c449c1b7cb` (snapshot `_meta/snapshots/measure-2025r1-sb960-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB960/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `33d01b934412745efef7181a7e06aedaf167d3eb73c352a8928b14054276a17d` (snapshot `_meta/snapshots/measure-2025r1-sb960-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB960/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 960` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

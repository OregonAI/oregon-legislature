...
jurisdiction: oregon
id: measure-2025r1-hb3060
title: 'HB 3060 (2025R1): Enacts the PA Licensure Compact.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3060
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3060/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 785cff50bde9b378b2631687520df8a31784e9b7a12d65dde159fdc15f124fe6
snapshot_id: measure-2025r1-hb3060-introduced
status: current
...
catch_line: Enacts the PA Licensure Compact.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes Oregon join a compact with other states to let physician assistants\
  \ from other states work in this state. (Flesch Readability Score: 64.6). \n\tEnacts the PA Licensure\
  \ Compact. Allows the Oregon Medical Board to disclose specified information to the PA Licensure Compact\
  \ Commission. Exempts individuals authorized to provide medical services by compact privilege from certain\
  \ requirements. Allows the board to use moneys to meet financial obligations imposed on the State of\
  \ Oregon as a result of participation in the Compact. \n\tTakes effect on the 91st day following adjournment\
  \ sine die."
relating_to: Relating to a physician assistant licensure compact; prescribing an effective date.
relating_to_full: Relating to a physician assistant licensure compact; creating new provisions; amending
  ORS 676.177, 677.060, 677.080 and 677.290; and prescribing an effective date.
at_the_request_of: null
lc_number: 668
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-03-20T12:50:06'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 68145
...
# HB 3060 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3060, 2025 Regular Session (2025R1)
- **LC number:** 668
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-03-20T12:50:06
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 68145 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3060/Introduced>.

## Summary

**Catchline:** Enacts the PA Licensure Compact.
...
**RelatingToFull (verbatim upstream field):** Relating to a physician assistant licensure compact; creating new provisions; amending ORS 676.177, 677.060, 677.080 and 677.290; and prescribing an effective date.
...
mean the national administrative body created pursuant to section 7.A of this Compact.
...
rently held due to an adverse action.
...
SECTION 6.
Adverse Actions.
A. A participating state in which a licensee is licensed shall have exclusive power  to im-
...
H. If any participating state takes adverse action, it promptly shall notify the  adminis-
...
assessment or meet the financial obligation  have been deposited in the Oregon Medical Board
...
reasons that the Commission may convene in a  nonpublic meeting as set forth in section
...
antitrust claims under the Sherman Antitrust Act of  1890, the Clayton Antitrust Act of 1914
...
ticipating state before the 180-day period ends, in which case  the Compact privilege shall
continue.
...
(b) The Oregon Medical Board may disclose information described in subsection (1) of this
...
- From `RelatingToFull`: ORS 676.177, ORS 677.060, ORS 677.080, ORS 677.290
- From bill text (Introduced version): ORS 291.234, ORS 441.055, ORS 442.015, ORS 676.110, ORS 676.120, ORS 676.165, ORS 676.177, ORS 676.347, ORS 676.850, ORS 676.860, ORS 677.060, ORS 677.080, ORS 677.137, ORS 677.290, ORS 684.155, ORS 688.240

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `785cff50bde9b378b2631687520df8a31784e9b7a12d65dde159fdc15f124fe6` (snapshot `_meta/snapshots/measure-2025r1-hb3060-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3060/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3060` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3812
title: 'HB 3812 (2025R1): Requires school districts to develop, implement and annually update a health
  services plan for the students of the school district.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3812
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3812/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 28e92112e711d697a960b0950c23725ebad81230c14f75bd69a3d25606d9dccb
snapshot_id: measure-2025r1-hb3812-introduced
status: current
...
catch_line: Requires school districts to develop, implement and annually update a health services plan
  for the students of the school district.
minority_catch_line: null
measure_summary: "\tDigest: Changes the requirements for health services plans in schools and for school\
  \ nursing services. (Flesch Readability Score: 65.7). \n\tRequires school districts to develop, implement\
  \ and annually update a health services plan for the students of the school district. Prescribes standards\
  \ for the health services plans. \n\tModifies the categories of students requiring school nursing services\
  \ and the ratios for students in those categories. \n\tDirects the Teacher Standards and Practices Commission\
  \ to offer professional development on school health services and apply any hours taken toward the renewal\
  \ of an administrative license."
relating_to: Relating to school nursing.
relating_to_full: Relating to school nursing; creating new provisions; and amending ORS 329.105 and 336.201.
at_the_request_of: null
lc_number: 3741
measure_created_date: '2025-02-25T18:08:41'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3812>.

# HB 3812 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3812, 2025 Regular Session (2025R1)
- **LC number:** 3741
- **Created:** 2025-02-25T18:08:41
- **Metadata last modified (upstream):** 2025-03-05T10:28:46
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 18153 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3812/Introduced>.

## Summary

**Catchline:** Requires school districts to develop, implement and annually update a health services plan for the students of the school district.
...
**RelatingToFull (verbatim upstream field):** Relating to school nursing; creating new provisions; and amending ORS 329.105 and 336.201.
...
education and related services are determined by an individualized education program team.
...
678.010 to 678.410.
[(f)] (i) “School nurse” has the meaning given that term in ORS 342.455.
...
program and for whom special education and related services are determined by an individualized ed-
...
- From `RelatingToFull`: ORS 329.105, ORS 336.201
- From bill text (Introduced version): ORS 329.105, ORS 336.201, ORS 342.120, ORS 342.455, ORS 433.269, ORS 516.030, ORS 678.010

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `28e92112e711d697a960b0950c23725ebad81230c14f75bd69a3d25606d9dccb` (snapshot `_meta/snapshots/measure-2025r1-hb3812-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3812/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3812> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3042
title: 'HB 3042 (2025R1): Specifies additional reasons for which the Oregon Board of Naturopathic Medicine
  may impose discipline.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3042
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3042/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5c677f95ba772e0d8b7ca04ac45f5155c958637ad5be97ac782e0e74026a39cb
snapshot_id: measure-2025r1-hb3042-enrolled
status: current
...
catch_line: Specifies additional reasons for which the Oregon Board of Naturopathic Medicine may impose
  discipline.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act lists additional reasons for which the OBNM can discipline a person.\
  \ (Flesch Readability Score: 63.4).</b> \n\t[<i>Digest: The Act lists more ways a person can get in\
  \ trouble with the Oregon Board of Naturopathic Medicine. The Act also lets the board make a person\
  \ who might be in trouble with the board take a test. (Flesch Readability Score: 74.0).</i>] \n\tSpecifies\
  \ additional reasons for which the Oregon Board of Naturopathic Medicine may impose discipline. [<i>Allows\
  \ the board to require a person under investigation by the board to undergo a mental, physical, chemical\
  \ dependency or competency evaluation.</i>] \n\tTakes effect on the 91st day following adjournment sine\
  \ die."
relating_to: Relating to Oregon Board of Naturopathic Medicine; and prescribing an effective date.
relating_to_full: Relating to Oregon Board of Naturopathic Medicine; and prescribing an effective date.
at_the_request_of: (at the request of Governor Tina Kotek for Oregon Board of Naturopathic Medicine)
lc_number: 548
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2026-04-14T12:28:58'
...
# HB 3042 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3042, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Governor Tina Kotek for Oregon Board of Naturopathic Medicine)
- **LC number:** 548
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-04-14T12:28:58
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 6956 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3042/Enrolled>.

## Summary

**Catchline:** Specifies additional reasons for which the Oregon Board of Naturopathic Medicine may impose discipline.
...
**RelatingToFull (verbatim upstream field):** Relating to Oregon Board of Naturopathic Medicine; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 676.303, ORS 685.110, ORS 685.225

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `5c677f95ba772e0d8b7ca04ac45f5155c958637ad5be97ac782e0e74026a39cb` (snapshot `_meta/snapshots/measure-2025r1-hb3042-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3042/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `5c20126ce3db41e782f3f2b455d46e462c0753b7906ebf1053f5233ac3c4bd7c` (snapshot `_meta/snapshots/measure-2025r1-hb3042-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3042/Introduced>.

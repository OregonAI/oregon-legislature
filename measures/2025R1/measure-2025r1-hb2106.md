...
jurisdiction: oregon
id: measure-2025r1-hb2106
title: 'HB 2106 (2025R1): Requires the Attorney General to adopt and maintain a list of foreign adversaries
  who are ineligible to receive conveyances of certain land, mineral or water interests.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2106
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2106/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ff1bd2f8b72c2cc969e99ffdba08ef5fa8e0f23b33a0d75ca3a9d692ada2e9f1
snapshot_id: measure-2025r1-hb2106-introduced
status: current
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2106`.

# HB 2106 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2106, 2025 Regular Session (2025R1)
- **LC number:** 575
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-22T16:10:15
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 3840 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2106/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `ff1bd2f8b72c2cc969e99ffdba08ef5fa8e0f23b33a0d75ca3a9d692ada2e9f1` (snapshot `_meta/snapshots/measure-2025r1-hb2106-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2106/Introduced>.

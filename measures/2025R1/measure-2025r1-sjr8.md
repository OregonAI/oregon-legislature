...
jurisdiction: oregon
id: measure-2025r1-sjr8
title: 'SJR 8 (2025R1): Proposes an amendment to the Oregon Constitution establishing an independent redistricting
...
citation: 2025 Regular Session Senate Joint Resolution 8
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR8/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0eb32847769c45c8dc10d157201e9bc972960e4f5aa2f095f291f2ea40961037
snapshot_id: measure-2025r1-sjr8-introduced
status: current
...
catch_line: Proposes an amendment to the Oregon Constitution establishing an independent redistricting
  commission to adopt redistricting maps for the Senate, House of Representatives and United States House
  of Representatives. Refers the proposed amendment to the people for their approval or rejection at the
  next general election.
...
measure_summary: "\tDigest: Amends the Constitution to create a body that draws district maps. Refers\
  ...
  \ \n\tProposes an amendment to the Oregon Constitution establishing an independent redistricting commission\
  ...
  \ election."
relating_to: Proposing an amendment to the Oregon Constitution relating to an independent redistricting
  commission.
relating_to_full: null
at_the_request_of: null
lc_number: 2370
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T14:47:24'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 7769
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SJR' and MeasureNumber eq 8`.

# SJR 8 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Joint Resolution 8, 2025 Regular Session (2025R1)
- **LC number:** 2370
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T14:47:24
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7769 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR8/Introduced>.

## Summary

**Catchline:** Proposes an amendment to the Oregon Constitution establishing an independent redistricting commission to adopt redistricting maps for the Senate, House of Representatives and United States House of Representatives. Refers the proposed amendment to the people for their approval or rejection at the next general election.

**Relating to:** Proposing an amendment to the Oregon Constitution relating to an independent redistricting commission.
...
Digest: Amends the Constitution to create a body that draws district maps. Refers the amendment to a vote of the people at the next general election. (Flesch Readability Score: 62.1). 
 Proposes an amendment to the Oregon Constitution establishing an independent redistricting commission to adopt redistricting maps for the Senate, House of Representatives and United States House of Representatives. 
...
LC 2370
commission is necessary for the adoption of any final reapportionment plan. The  commission
...
reapportionment plans by August 15, the commission shall be  disbanded and the Supreme
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `0eb32847769c45c8dc10d157201e9bc972960e4f5aa2f095f291f2ea40961037` (snapshot `_meta/snapshots/measure-2025r1-sjr8-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR8/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SJR' and MeasureNumber eq 8` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

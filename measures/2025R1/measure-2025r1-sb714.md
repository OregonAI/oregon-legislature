...
jurisdiction: oregon
id: measure-2025r1-sb714
title: 'SB 714 (2025R1): Authorizes the issuance of lottery bonds to fund Columbia corridor flood safety
  projects in Multnomah County.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 714
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB714/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 6c003e0c343dec3427a7f3f60636b112016857c859f48f5d729f450e8982c8a3
snapshot_id: measure-2025r1-sb714-introduced
status: current
...
catch_line: Authorizes the issuance of lottery bonds to fund Columbia corridor flood safety projects in
  Multnomah County.
minority_catch_line: null
measure_summary: "\tDigest: The Act would let lottery bonds be sold to fund flood safety projects on certain\
  \ parts of the Columbia. (Flesch Readability Score: 62.8). \n\tAuthorizes the issuance of lottery bonds\
  \ to fund Columbia corridor flood safety projects in Multnomah County."
relating_to: Relating to the Columbia corridor flood safety project.
relating_to_full: Relating to the Columbia corridor flood safety project.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 714>.

# SB 714 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 714, 2025 Regular Session (2025R1)
- **LC number:** 958
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:48:42
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 10135 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB714/Introduced>.

## Summary

**Catchline:** Authorizes the issuance of lottery bonds to fund Columbia corridor flood safety projects in Multnomah County.

**Relating to:** Relating to the Columbia corridor flood safety project.

Digest: The Act would let lottery bonds be sold to fund flood safety projects on certain parts of the Columbia. (Flesch Readability Score: 62.8). 
 Authorizes the issuance of lottery bonds to fund Columbia corridor flood safety projects in Multnomah County.

**RelatingToFull (verbatim upstream field):** Relating to the Columbia corridor flood safety project.
...
SECTION 1.
As used in sections 1 to 5 of this 2025 Act, “Columbia corridor flood  safety
...
LC 958
SECTION 3.
(1) For the biennium beginning July 1, 2027, at the request  of the Oregon
Business Development Department, the State Treasurer is authorized to issue  lottery bonds
...
SECTION 5.
(1) The Columbia  Corridor Flood Safety Fund is established separate and
...
- From bill text (Introduced version): ORS 196.600, ORS 286A.560

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `6c003e0c343dec3427a7f3f60636b112016857c859f48f5d729f450e8982c8a3` (snapshot `_meta/snapshots/measure-2025r1-sb714-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB714/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 714> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3101
title: 'HB 3101 (2025R1): Allocates eight-tenths of one percent of net proceeds from the Oregon State
  Lottery to the County Fair Account and two-tenths of one percent of net proceeds from the lottery to
  the Horse Racing Account.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3101
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3101/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ce26e76a7d4edf03b00b3603b5e2f547934dee0ff2b2972f2813fe1bd30f8f8c
snapshot_id: measure-2025r1-hb3101-introduced
status: current
...
catch_line: Allocates eight-tenths of one percent of net proceeds from the Oregon State Lottery to the
  County Fair Account and two-tenths of one percent of net proceeds from the lottery to the Horse Racing
  Account.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act addresses how lottery money is allocated to the County Fair Account.\
  \ The Act allocates lottery money to a new Horse Racing Account. The Act creates the new Horse Racing\
  \ Account. (Flesch Readability Score: 61.1).</b> \n\t[<i>Digest: The Act addresses how lottery money\
  \ is allocated to the County Fair Account. The Act allocates lottery money to a new Horse Racing Account.\
  \ The Act tells an agency to create a master plan for county fair building. The Act gives money related\
  \ to the master plan. The Act creates the new Horse Racing Account. (Flesch Readability Score: 68.0).</i>]\
  \ \n\t[<i>Removes the requirement that the amount of net proceeds from the Oregon State Lottery allocated\
  \ to the County Fair Account not exceed $1.53 million annually.</i>] Allocates eight-tenths of one percent\
  \ of net proceeds from the <b>Oregon State</b> Lottery to the County Fair Account and two-tenths of\
  \ one percent of net proceeds from the lottery to the Horse Racing Account. \n\t[<i>Requires the Oregon\
  \ Business Development Department to prepare and report a master plan for county fairground capital\
  \ construction. Specifies content and procedural requirements for the report.</i>] \n\t[<i>Appropriates\
  \ moneys to the department out of the General Fund for consultant services related to the report.</i>]\
  \ \n\tEstablishes the Horse Racing Account separate and distinct from the General Fund. \n\tDeclares\
  \ an emergency, effective on passage."
relating_to: Relating to events that involve livestock; declaring an emergency.
relating_to_full: Relating to events that involve livestock; creating new provisions; amending ORS 565.446
  and 565.447; and declaring an emergency.
...
# HB 3101 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3101, 2025 Regular Session (2025R1)
- **LC number:** 231
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-04-03T18:05:02
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7155 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3101/Introduced>.

## Summary

**Catchline:** Allocates eight-tenths of one percent of net proceeds from the Oregon State Lottery to the County Fair Account and two-tenths of one percent of net proceeds from the lottery to the Horse Racing Account.

**Relating to:** Relating to events that involve livestock; declaring an emergency.

<b>Digest: The Act addresses how lottery money is allocated to the County Fair Account. The Act allocates lottery money to a new Horse Racing Account. The Act creates the new Horse Racing Account. (Flesch Readability Score: 61.1).</b> 
...
**RelatingToFull (verbatim upstream field):** Relating to events that involve livestock; creating new provisions; amending ORS 565.446 and 565.447; and declaring an emergency.
...
- From `RelatingToFull`: ORS 565.446, ORS 565.447
- From bill text (Introduced version): ORS 192.245, ORS 391.130, ORS 391.140, ORS 462.057, ORS 565.268, ORS 565.275, ORS 565.445, ORS 565.447

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `ce26e76a7d4edf03b00b3603b5e2f547934dee0ff2b2972f2813fe1bd30f8f8c` (snapshot `_meta/snapshots/measure-2025r1-hb3101-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3101/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3101> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

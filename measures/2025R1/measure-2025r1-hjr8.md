...
jurisdiction: oregon
id: measure-2025r1-hjr8
title: 'HJR 8 (2025R1): Proposes an amendment to the Oregon Constitution requiring the Legislative Assembly
  to create an administrative authority for funding public safety in this state. Directs the Legislative
  Assembly to impose a state property tax to fund public safety in this state.'
doc_type: dataset_doc
citation: 2025 Regular Session House Joint Resolution 8
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJR8/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 033d101aee8637d705dada687bbbd02c2e70fd4d1fc25966d5145ca7093c7185
snapshot_id: measure-2025r1-hjr8-introduced
status: current
...
catch_line: Proposes an amendment to the Oregon Constitution requiring the Legislative Assembly to create
  ...
  to impose a state property tax to fund public safety in this state.
...
relating_to: Proposing an amendment to the Oregon Constitution relating to a state property tax.
...
# HJR 8 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Joint Resolution 8, 2025 Regular Session (2025R1)
- **LC number:** 2616
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-21T15:39:10
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 3473 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJR8/Introduced>.

## Summary

**Catchline:** Proposes an amendment to the Oregon Constitution requiring the Legislative Assembly to create an administrative authority for funding public safety in this state. Directs the Legislative Assembly to impose a state property tax to fund public safety in this state.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `033d101aee8637d705dada687bbbd02c2e70fd4d1fc25966d5145ca7093c7185` (snapshot `_meta/snapshots/measure-2025r1-hjr8-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJR8/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HJR' and MeasureNumber eq 8` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

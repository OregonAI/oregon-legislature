...
jurisdiction: oregon
id: measure-2025r1-hb2580
title: 'HB 2580 (2025R1): Authorizes expenditures from the Statewide Education Initiatives Account for
  funding of regional career and technical education programs.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2580
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2580/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 796568fe9344e12f9201901317c46587efc6c8055247b335831bf53723965300
snapshot_id: measure-2025r1-hb2580-introduced
status: current
...
catch_line: Authorizes expenditures from the Statewide Education Initiatives Account for funding of regional
  career and technical education programs.
minority_catch_line: null
measure_summary: "\tDigest: Allows certain state moneys to be used to fund regional CTE programs. (Flesch\
  \ Readability Score: 67.7). \n\tAuthorizes expenditures from the Statewide Education Initiatives Account\
  \ for funding of regional career and technical education programs. \n\tDeclares an emergency, effective\
  \ July 1, 2025."
relating_to: Relating to regional career and technical education; declaring an emergency.
relating_to_full: Relating to regional career and technical education; amending ORS 327.254; and declaring
  an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2580`.

# HB 2580 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2580, 2025 Regular Session (2025R1)
- **LC number:** 1657
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:09:55
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7771 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2580/Introduced>.

## Summary

**Catchline:** Authorizes expenditures from the Statewide Education Initiatives Account for funding of regional career and technical education programs.

**Relating to:** Relating to regional career and technical education; declaring an emergency.

Digest: Allows certain state moneys to be used to fund regional CTE programs. (Flesch Readability Score: 67.7). 
 Authorizes expenditures from the Statewide Education Initiatives Account for funding of regional career and technical education programs. 
 Declares an emergency, effective July 1, 2025.

**RelatingToFull (verbatim upstream field):** Relating to regional career and technical education; amending ORS 327.254; and declaring an emergency.
...
standards.
Digest: Allows  certain state moneys to be used to fund regional CTE programs. (Flesch Read-
ability Score: 67.7).
Authorizes expenditures from the Statewide Education Initiatives Account  for funding of re-
gional career and technical education programs.
Declares an emergency, effective July 1, 2025.
A BILL FOR AN ACT
Relating to regional career and technical  education; amending ORS 327.254; and declaring an
emergency.
...
(r) Funding regional career  and technical education programs that are provided in part-
...
- From bill text (Introduced version): ORS 327.013, ORS 327.029, ORS 327.175, ORS 327.185, ORS 327.195, ORS 327.214, ORS 327.222, ORS 327.254, ORS 327.362, ORS 327.367, ORS 327.833, ORS 327.843, ORS 327.856, ORS 334.015, ORS 334.175, ORS 339.341

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `796568fe9344e12f9201901317c46587efc6c8055247b335831bf53723965300` (snapshot `_meta/snapshots/measure-2025r1-hb2580-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2580/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2580` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb484
title: 'SB 484 (2025R1): Increases the limit for the amount of claims that may be filed in small claims
  court from $10,000 to $20,000.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 484
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB484/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4d35e98ff33256862d6b4de544910d7311807fcef3d00cbfa30b848b8f1571cb
snapshot_id: measure-2025r1-sb484-introduced
status: current
...
catch_line: Increases the limit for the amount of claims that may be filed in small claims court from
  $10,000 to $20,000.
minority_catch_line: null
measure_summary: "\tDigest: The Act raises the dollar limit for claims that can be filed in small claims\
  \ court. (Flesch Readability Score: 90.1). \n\tIncreases the limit for the amount of claims that may\
  \ be filed in small claims court from $10,000 to $20,000."
relating_to: Relating to small claims.
relating_to_full: Relating to small claims; creating new provisions; and amending ORS 46.405, 46.425,
  46.461, 51.080, 55.011, 55.095 and 133.055.
...
# SB 484 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 484, 2025 Regular Session (2025R1)
- **LC number:** 2719
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-24T09:16:13
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 17181 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB484/Introduced>.

## Summary

**Catchline:** Increases the limit for the amount of claims that may be filed in small claims court from $10,000 to $20,000.
...
**RelatingToFull (verbatim upstream field):** Relating to small claims; creating new provisions; and amending ORS 46.405, 46.425, 46.461, 51.080, 55.011, 55.095 and 133.055.
...
LC 2719
simple statement of the claim, including the amount and the date the claim allegedly accrued;
...
51.080. (1) A justice court has jurisdiction, but not exclusive, of the following actions:
...
plaintiff’s claim will not be limited to the amount stated in the claim filed with the justice  of the
...
- From `RelatingToFull`: ORS 133.055, ORS 46.405, ORS 46.425, ORS 46.461, ORS 51.080, ORS 55.011, ORS 55.095
- From bill text (Introduced version): ORS 107.705, ORS 124.005, ORS 133.055, ORS 133.450, ORS 161.705, ORS 163.187, ORS 20.082, ORS 21.160, ORS 30.642, ORS 46.405, ORS 46.425, ORS 46.445, ORS 46.461, ORS 46.570, ORS 51.080, ORS 51.310, ORS 52.320, ORS 55.011, ORS 55.020, ORS 55.045, ORS 55.065, ORS 55.095

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `4d35e98ff33256862d6b4de544910d7311807fcef3d00cbfa30b848b8f1571cb` (snapshot `_meta/snapshots/measure-2025r1-sb484-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB484/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 484` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb63
title: 'SB 63 (2025R1): Imposes personal income tax at flat rate if a taxpayer has an adjusted gross income
  below threshold amount.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 63
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB63/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0b3c1b12ef0f2c3eba55c307a14f6edfbca729a45268c653aa9d186805296b18
snapshot_id: measure-2025r1-sb63-introduced
status: current
...
catch_line: Imposes personal income tax at flat rate if a taxpayer has an adjusted gross income below
  threshold amount.
minority_catch_line: null
measure_summary: "\tDigest: The Act imposes a flat rate income tax. (Flesch Readability Score: 66.1).\
  \ \n\tImposes personal income tax at flat rate if a taxpayer has an adjusted gross income below threshold\
  \ amount. Applies to tax years beginning on or after January 1, 2026. \n\tTakes effect on the 91st day\
  \ following adjournment sine die."
relating_to: Relating to personal income tax rates; prescribing an effective date.
relating_to_full: Relating to personal income tax rates; creating new provisions; amending ORS 316.037,
  316.122 and 316.362; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 63`.

# SB 63 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 63, 2025 Regular Session (2025R1)
- **LC number:** 3017
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-22T16:08:55
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 9641 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB63/Introduced>.

## Summary

**Catchline:** Imposes personal income tax at flat rate if a taxpayer has an adjusted gross income below threshold amount.
...
**RelatingToFull (verbatim upstream field):** Relating to personal income tax rates; creating new provisions; amending ORS 316.037, 316.122 and 316.362; and prescribing an effective date.
...
- From `RelatingToFull`: ORS 316.037, ORS 316.122, ORS 316.362
- From bill text (Introduced version): ORS 316.037, ORS 316.085, ORS 316.117, ORS 316.122, ORS 316.362, ORS 316.367, ORS 316.695

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `0b3c1b12ef0f2c3eba55c307a14f6edfbca729a45268c653aa9d186805296b18` (snapshot `_meta/snapshots/measure-2025r1-sb63-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB63/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 63` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

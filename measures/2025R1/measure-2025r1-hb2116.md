...
jurisdiction: oregon
id: measure-2025r1-hb2116
title: 'HB 2116 (2025R1): Provides that the threshold of the highest personal income tax bracket and the
  corporate excise tax bracket threshold are adjusted for inflation.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2116
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2116/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b65c32d0088233b15081f9273a502dfe14ce29e44f73c717f4a469858368e743
snapshot_id: measure-2025r1-hb2116-introduced
status: current
...
catch_line: Provides that the threshold of the highest personal income tax bracket and the corporate excise
  tax bracket threshold are adjusted for inflation.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes all brackets for personal income tax and corporate excise tax\
  \ adjust for changes in CPI. (Flesch Readability Score: 61.6). \n\tProvides that the threshold of the\
  \ highest personal income tax bracket and the corporate excise tax bracket threshold are adjusted for\
  \ inflation. \n\tApplies to tax years beginning on or after January 1, 2026. \n\tTakes effect on the\
  \ 91st day following adjournment sine die."
relating_to: Relating to tax rates; prescribing an effective date.
relating_to_full: Relating to tax rates; creating new provisions; amending ORS 316.037 and 317.061; and
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2116`.

# HB 2116 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2116, 2025 Regular Session (2025R1)
- **LC number:** 2639
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-22T16:12:31
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5887 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2116/Introduced>.

## Summary

**Catchline:** Provides that the threshold of the highest personal income tax bracket and the corporate excise tax bracket threshold are adjusted for inflation.
...
**RelatingToFull (verbatim upstream field):** Relating to tax rates; creating new provisions; amending ORS 316.037 and 317.061; and prescribing an effective date.
...
- From `RelatingToFull`: ORS 316.037, ORS 317.061
- From bill text (Introduced version): ORS 316.037, ORS 316.117, ORS 317.061

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `b65c32d0088233b15081f9273a502dfe14ce29e44f73c717f4a469858368e743` (snapshot `_meta/snapshots/measure-2025r1-hb2116-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2116/Introduced>.

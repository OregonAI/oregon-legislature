...
jurisdiction: oregon
id: measure-2025r1-hb2781
title: 'HB 2781 (2025R1): Provides that a court may not stay or prohibit a Federal Home Loan Bank from
  exercising rights to collateral pledged by an insurer-member that is subject to a delinquency proceeding.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2781
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2781/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: baf6c735da8b3fb8890b8a8806e2c7746aa0ca96dbdf83ba5ec0027168c1de2c
snapshot_id: measure-2025r1-hb2781-introduced
status: current
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2781`.

# HB 2781 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2781, 2025 Regular Session (2025R1)
- **LC number:** 1947
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:35:15
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6756 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2781/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `baf6c735da8b3fb8890b8a8806e2c7746aa0ca96dbdf83ba5ec0027168c1de2c` (snapshot `_meta/snapshots/measure-2025r1-hb2781-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2781/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2781` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

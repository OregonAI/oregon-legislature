...
jurisdiction: oregon
id: measure-2025r1-hjm2
title: 'HJM 2 (2025R1): Urges Congress to change the funding of veterans'' health care from a discretionary
  entitlement to a permanent and direct entitlement.'
doc_type: dataset_doc
citation: 2025 Regular Session House Joint Memorial 2
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJM2/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 87359ef0a28adcc853d6e242f4791e289cd1bf5cc18c813541305d5081badfce
snapshot_id: measure-2025r1-hjm2-introduced
status: current
...
catch_line: Urges Congress to change the funding of veterans' health care from a discretionary entitlement
  to a permanent and direct entitlement.
minority_catch_line: null
measure_summary: "\tDigest: Urges Congress to change how veterans' health care is funded. (Flesch Readability\
  \ Score: 69.7). \n\tUrges Congress to change the funding of veterans' health care from a discretionary\
  \ entitlement to a permanent and direct entitlement."
relating_to: Urging Congress to change the funding of veterans' health care from a discretionary entitlement
  to a permanent and direct entitlement.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HJM' and MeasureNumber eq 2`.

# HJM 2 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Joint Memorial 2, 2025 Regular Session (2025R1)
- **LC number:** 3274
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-21T15:38:30
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 3495 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJM2/Introduced>.

## Summary

**Catchline:** Urges Congress to change the funding of veterans' health care from a discretionary entitlement to a permanent and direct entitlement.
...
LC 3274
to a permanent and direct entitlement; and be it further
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `87359ef0a28adcc853d6e242f4791e289cd1bf5cc18c813541305d5081badfce` (snapshot `_meta/snapshots/measure-2025r1-hjm2-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJM2/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HJM' and MeasureNumber eq 2` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3040
title: 'HB 3040 (2025R1): Prescribes professional development and coaching requirements under the Early
  Literacy Success School Grant program.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3040
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3040/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 73cbfaa6069bc7ef0f204a612e93591b3d2eacef5e85c257bd390d68a42418c3
snapshot_id: measure-2025r1-hb3040-enrolled
status: current
...
catch_line: Prescribes professional development and coaching requirements under the Early Literacy Success
  School Grant program.
minority_catch_line: null
measure_summary: "\tDigest: Changes the grant program for reading. (Flesch Readability Score: 73.8). \n\
  \tPrescribes professional development and coaching requirements under the Early Literacy Success School\
  \ Grant program. Expands the allowed uses of grants related to curricula. \n\tModifies the reporting\
  \ date related to Early Literacy Success School Grants and the contents of the reports. \n\tExpands\
  \ allowed interventions for the Department of Education to take when a school district or public charter\
  \ school does not meet the goals established in an early literacy success plan."
relating_to: Relating to early literacy.
relating_to_full: Relating to early literacy.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3040>.

# HB 3040 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3040, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 15603 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3040/Enrolled>.

## Summary

**Catchline:** Prescribes professional development and coaching requirements under the Early Literacy Success School Grant program.
...
**RelatingToFull (verbatim upstream field):** Relating to early literacy.
...
Enrolled House Bill 3040 (HB 3040-C) Page 1
...
Enrolled House Bill 3040 (HB 3040-C) Page 2
...
Enrolled House Bill 3040 (HB 3040-C) Page 3
...
Enrolled House Bill 3040 (HB 3040-C) Page 4
...
Enrolled House Bill 3040 (HB 3040-C) Page 5
...
- From bill text (Enrolled version): ORS 327.175, ORS 327.185, ORS 327.827, ORS 327.829, ORS 327.831, ORS 327.833, ORS 327.835, ORS 327.837, ORS 327.843, ORS 327.853, ORS 329.095, ORS 337.050

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `73cbfaa6069bc7ef0f204a612e93591b3d2eacef5e85c257bd390d68a42418c3` (snapshot `_meta/snapshots/measure-2025r1-hb3040-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3040/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `1fda4456de60a818a46c34da756fd60da041edb76092d022ba13e77ace051cf5` (snapshot `_meta/snapshots/measure-2025r1-hb3040-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3040/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3040> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

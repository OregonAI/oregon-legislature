...
jurisdiction: oregon
id: measure-2025r1-hb2400
title: 'HB 2400 (2025R1): Allows the owner of property outside an urban growth boundary to site an additional
  dwelling on the property for occupancy by a relative of the owner.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2400
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2400/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 04eb60dd5ed34215d4c916fd97b38164f5e97b60b32b4a9d02cb3bd47a056263
snapshot_id: measure-2025r1-hb2400-introduced
status: current
...
catch_line: Allows the owner of property outside an urban growth boundary to site an additional dwelling
  on the property for occupancy by a relative of the owner.
minority_catch_line: null
measure_summary: "\tDigest: This Act allows a rural homeowner to build a house for a relative. (Flesch\
  \ Readability Score: 63.4). \n\tAllows the owner of property outside an urban growth boundary to site\
  \ an additional dwelling on the property for occupancy by a relative of the owner. \n\tTakes effect\
...
relating_to_full: Relating to family dwelling units; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2400>.

# HB 2400 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2400, 2025 Regular Session (2025R1)
- **LC number:** 1025
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-23T10:55:51
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5122 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2400/Introduced>.

## Summary

**Catchline:** Allows the owner of property outside an urban growth boundary to site an additional dwelling on the property for occupancy by a relative of the owner.

**Relating to:** Relating to family dwelling units; prescribing an effective date.
...
**RelatingToFull (verbatim upstream field):** Relating to family dwelling units; and prescribing an effective date.
...
LC 1025
(C) Not within an area described in paragraph (a)  or (b) of this subsection, the new
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `04eb60dd5ed34215d4c916fd97b38164f5e97b60b32b4a9d02cb3bd47a056263` (snapshot `_meta/snapshots/measure-2025r1-hb2400-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2400/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2400> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

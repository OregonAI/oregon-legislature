...
jurisdiction: oregon
id: measure-2025r1-sjr6
title: 'SJR 6 (2025R1): Amends the Oregon Constitution to require that a question of whether to recall
  a public officer must appear on the ballot at the next regularly scheduled election. Refers the proposed
  amendment to the people for their approval or rejection at the next regular general election.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Joint Resolution 6
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR6/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 97e00f3489af27adb4bc4d8c46dc1e2e9992d81cebaa6c2b38482a29711e7014
snapshot_id: measure-2025r1-sjr6-introduced
status: current
...
catch_line: Amends the Oregon Constitution to require that a question of whether to recall a public officer
  must appear on the ballot at the next regularly scheduled election. Refers the proposed amendment to
  the people for their approval or rejection at the next regular general election.
minority_catch_line: null
measure_summary: "\tDigest: The Act amends the Constitution. The Act requires that a recall must be on\
  \ the ballot at an election that is already happening. The Act refers the amendment to a vote of the\
  \ people at the next general election. (Flesch Readability Score: 63.4). \n\tAmends the Oregon Constitution\
  \ to require that a question of whether to recall a public officer must appear on the ballot at the\
...
relating_to: Proposing an amendment to the Oregon Constitution relating to elections for recalling public
  officers.
relating_to_full: null
at_the_request_of: null
lc_number: 2654
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T14:47:20'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 4965
...
# SJR 6 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Joint Resolution 6, 2025 Regular Session (2025R1)
- **LC number:** 2654
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T14:47:20
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4965 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR6/Introduced>.

## Summary

**Catchline:** Amends the Oregon Constitution to require that a question of whether to recall a public officer must appear on the ballot at the next regularly scheduled election. Refers the proposed amendment to the people for their approval or rejection at the next regular general election.
...
LC 2654
after five days from the beginning of the first  session after the election of the senator or represen-
tative.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `97e00f3489af27adb4bc4d8c46dc1e2e9992d81cebaa6c2b38482a29711e7014` (snapshot `_meta/snapshots/measure-2025r1-sjr6-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJR6/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SJR' and MeasureNumber eq 6` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

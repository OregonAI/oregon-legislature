...
jurisdiction: oregon
id: measure-2025r1-hb2698
title: 'HB 2698 (2025R1): Establishes a statewide goal for homeownership.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2698
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2698/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e648cb9bbf085acb58b2c7b0506feb2ef38c2707ce25527c2f0d047f33f98bb2
snapshot_id: measure-2025r1-hb2698-enrolled
status: current
...
measure_summary: "\tDigest: This Act establishes a goal for home owning in this state. (Flesch Readability\
  \ Score: 80.3). \n\tEstablishes a statewide goal for homeownership. Requires the Housing and Community\
  \ Services Department to track goal progress [<i>as part of the Oregon Housing Needs Analysis</i>].\
  \ \n\tDeclares an emergency, effective on passage."
relating_to: Relating to homeownership goal; and declaring an emergency.
relating_to_full: Relating to homeownership goal; and declaring an emergency.
...
# HB 2698 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2698, 2025 Regular Session (2025R1)
- **LC number:** 1791
...
- **Full text below:** Enrolled version, 5413 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2698/Enrolled>.

## Summary

**Catchline:** Establishes a statewide goal for homeownership.

**Relating to:** Relating to homeownership goal; and declaring an emergency.

Digest: This Act establishes a goal for home owning in this state. (Flesch Readability Score: 80.3). 
 Establishes a statewide goal for homeownership. Requires the Housing and Community Services Department to track goal progress [<i>as part of the Oregon Housing Needs Analysis</i>]. 
 Declares an emergency, effective on passage.

**RelatingToFull (verbatim upstream field):** Relating to homeownership goal; and declaring an emergency.
...
Enrolled House Bill 2698 (HB 2698-A) Page 1
...
Enrolled House Bill 2698 (HB 2698-A) Page 2
...
- From bill text (Enrolled version): ORS 174.112, ORS 184.453

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `e648cb9bbf085acb58b2c7b0506feb2ef38c2707ce25527c2f0d047f33f98bb2` (snapshot `_meta/snapshots/measure-2025r1-hb2698-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2698/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `4063f62db765e3e7fe20d61fd8eab261b87ab383659db4224c4b5e812777ed8e` (snapshot `_meta/snapshots/measure-2025r1-hb2698-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2698/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2698` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

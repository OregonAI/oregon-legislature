...
jurisdiction: oregon
id: measure-2025r1-sb845
title: 'SB 845 (2025R1): Authorizes the Public Utility Commission to order the sale of an incumbent water
  utility to another water utility or entity when the incumbent water utility is not able to provide safe
  and adequate service.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 845
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB845/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ea23a2d9bd05ece2da14b755da3e78df7a70a50f217b253cf7928f6ae2b1d4c2
snapshot_id: measure-2025r1-sb845-enrolled
status: current
...
catch_line: Authorizes the Public Utility Commission to order the sale of an incumbent water utility to
  another water utility or entity when the incumbent water utility is not able to provide safe and adequate
  service.
minority_catch_line: null
measure_summary: "\t<b>Digest: Allows the PUC to order the sale of a water utility that is not able to\
  \ provide service. (Flesch Readability Score: 61.6).</b> \n\t[<i>Digest: Allows the PUC to order a water\
  \ utility that is not able to provide service to be bought. (Flesch Readability Score: 61.6).</i>] \n\
  \tAuthorizes the Public Utility Commission to order the [<i>acquisition</i>] <b>sale</b> of an incumbent\
  \ water utility [<i>by</i>]<b> to</b> another water utility or entity when the incumbent water utility\
  \ is not able to provide [<i>safe, adequate, efficient and reasonable</i>] <b>safe and adequate</b>\
  \ service. <b>Requires the commission to provide the incumbent water utility reasonable opportunity\
  \ to take alternative actions to the sale. \n\tIncreases, from $5,000 to $100,000, the amount of fees\
  \ that the commission may use to make emergency repairs to public utility plants that provide water\
  \ service. Authorizes the commission to order a public utility that provides water service to make emergency\
  \ repairs.</b>"
relating_to: Relating to water utilities regulated by the Public Utility Commission.
relating_to_full: Relating to water utilities regulated by the Public Utility Commission.
at_the_request_of: (at the request of Governor Tina Kotek for Public Utility Commission)
lc_number: 457
...
# SB 845 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 845, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Governor Tina Kotek for Public Utility Commission)
- **LC number:** 457
...
- **Full text below:** Enrolled version, 7628 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB845/Enrolled>.

## Summary

**Catchline:** Authorizes the Public Utility Commission to order the sale of an incumbent water utility to another water utility or entity when the incumbent water utility is not able to provide safe and adequate service.

**Relating to:** Relating to water utilities regulated by the Public Utility Commission.

<b>Digest: Allows the PUC to order the sale of a water utility that is not able to provide service. (Flesch Readability Score: 61.6).</b> 
 [<i>Digest: Allows the PUC to order a water utility that is not able to provide service to be bought. (Flesch Readability Score: 61.6).</i>] 
 Authorizes the Public Utility Commission to order the [<i>acquisition</i>] <b>sale</b> of an incumbent water utility [<i>by</i>]<b> to</b> another water utility or entity when the incumbent water utility is not able to provide [<i>safe, adequate, efficient and reasonable</i>] <b>safe and adequate</b> service. <b>Requires the commission to provide the incumbent water utility reasonable opportunity to take alternative actions to the sale. 
 Increases, from $5,000 to $100,000, the amount of fees that the commission may use to make emergency repairs to public utility plants that provide water service. Authorizes the commission to order a public utility that provides water service to make emergency repairs.</b>

**RelatingToFull (verbatim upstream field):** Relating to water utilities regulated by the Public Utility Commission.
...
- From bill text (Enrolled version): ORS 756.310, ORS 756.350, ORS 757.005, ORS 757.068, ORS 757.480

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `ea23a2d9bd05ece2da14b755da3e78df7a70a50f217b253cf7928f6ae2b1d4c2` (snapshot `_meta/snapshots/measure-2025r1-sb845-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB845/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `3f54885754b43e14e98d0f240fae5cc4db44f269fe427eadfc7739e613939c2a` (snapshot `_meta/snapshots/measure-2025r1-sb845-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB845/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 845> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

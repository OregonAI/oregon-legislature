...
jurisdiction: oregon
id: measure-2025r1-hb2817
title: 'HB 2817 (2025R1): Eliminates the closure of forestland, due to fire danger, by permit closure.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2817
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2817/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a44e81094d80a34b35326870e55637a57335a48fbcf7cbfe6eedbb6131d9da46
snapshot_id: measure-2025r1-hb2817-enrolled
status: current
...
catch_line: Eliminates the closure of forestland, due to fire danger, by permit closure.
minority_catch_line: null
measure_summary: "\tDigest: The Act removes permit closure of forests. (Flesch Readability Score: 66.7).\
  \ \n\tEliminates the closure of forestland, due to fire danger, by permit closure."
relating_to: Relating to forestland closures.
relating_to_full: Relating to forestland closures.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2817`.

# HB 2817 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2817, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 4516 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2817/Enrolled>.

## Summary

**Catchline:** Eliminates the closure of forestland, due to fire danger, by permit closure.
...
**RelatingToFull (verbatim upstream field):** Relating to forestland closures.
...
- From bill text (Enrolled version): ORS 477.535, ORS 477.540, ORS 477.545

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `a44e81094d80a34b35326870e55637a57335a48fbcf7cbfe6eedbb6131d9da46` (snapshot `_meta/snapshots/measure-2025r1-hb2817-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2817/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `0c95d6cdb24fc1e1be9a75e3641a4f7d1e2b7f8790ca26bc4b139a4256c09a34` (snapshot `_meta/snapshots/measure-2025r1-hb2817-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2817/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2817` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

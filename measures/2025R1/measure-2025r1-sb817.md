...
jurisdiction: oregon
id: measure-2025r1-sb817
title: 'SB 817 (2025R1): Increases fees for filing a notice of intent to appeal and a motion to intervene
  with the Land Use Board of Appeals.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 817
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB817/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f093231de3688ec15c7ac52a81e34924e66e42c8df680716feae209c0be968f9
snapshot_id: measure-2025r1-sb817-enrolled
status: current
...
catch_line: Increases fees for filing a notice of intent to appeal and a motion to intervene with the
  Land Use Board of Appeals.
minority_catch_line: null
measure_summary: "\tDigest: This bill raises fees for some LUBA filings. (Flesch Readability Score: 82.3).\
  \ \n\tIncreases fees for filing a notice of intent to appeal and a motion to intervene with the Land\
  \ Use Board of Appeals. Eliminates the awarding of fees for filing a notice of intent to appeal with\
  \ the board to the respondent if a petitioner does not file a petition for review."
relating_to: Relating to Land Use Board of Appeals fees.
relating_to_full: Relating to Land Use Board of Appeals fees.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 817`.

# SB 817 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 817, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Governor Tina Kotek for Land Use Board of Appeals)
- **LC number:** 337
...
- **Full text below:** Enrolled version, 13337 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB817/Enrolled>.

## Summary

**Catchline:** Increases fees for filing a notice of intent to appeal and a motion to intervene with the Land Use Board of Appeals.
...
**RelatingToFull (verbatim upstream field):** Relating to Land Use Board of Appeals fees.
...
- From bill text (Enrolled version): ORS 197.195, ORS 197.610, ORS 197.615, ORS 197.620, ORS 197.830, ORS 197.832, ORS 197.843, ORS 197.860, ORS 215.416

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `f093231de3688ec15c7ac52a81e34924e66e42c8df680716feae209c0be968f9` (snapshot `_meta/snapshots/measure-2025r1-sb817-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB817/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `5d303625217d74b93a45c4258e3f4038140184e26bc7d7fc4846988261ee6e46` (snapshot `_meta/snapshots/measure-2025r1-sb817-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB817/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 817` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

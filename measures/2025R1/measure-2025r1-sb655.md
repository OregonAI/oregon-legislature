...
jurisdiction: oregon
id: measure-2025r1-sb655
title: 'SB 655 (2025R1): Directs the Secretary of State to establish and maintain a searchable and publicly
  accessible database containing a copy of every ballot cast in each election.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 655
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB655/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 844dd727663cc979b1e2c00556662c661716e8410733c3e5f81758f8a3ede87a
snapshot_id: measure-2025r1-sb655-introduced
status: current
...
catch_line: Directs the Secretary of State to establish and maintain a searchable and publicly accessible
  database containing a copy of every ballot cast in each election.
minority_catch_line: null
measure_summary: "\tDigest: Tells the SOS to create a database of ballots for each election. Tells the\
  \ county clerks to add e-copies of each ballot into the database. Requires each ballot to have an ID.\
  \ Requires the ID to be secret other than to the voter. Allows a voter to view the voter's ballot in\
  \ the database for 90 days following the election. Allows the county clerks to charge a reasonable fee\
  \ for the cost of getting a ballot. Tells the county clerks to allow certain persons to watch the ballots\
  \ being printed and inserted into mailing envelopes. (Flesch Readability Score: 63.4). \n\tDirects the\
  \ Secretary of State to establish and maintain a searchable and publicly accessible database containing\
  \ a copy of every ballot cast in each election. Requires county clerks to scan and upload to the database\
  \ each ballot cast prior to tallying the votes. \n\tRequires each ballot to be printed with a unique\
  \ identifier that an elector may use to search the database for an electronic copy of the elector's\
  \ ballot. Requires a ballot's identifier to be secret except to the elector. \n\tPermits an elector\
  \ to inspect the elector's cast ballot for 90 days following the date of an election. Requires county\
  \ clerks to store ballots in a manner that makes the ballots readily available to retrieve. Requires\
  \ county clerks to store ballots in batches and to maintain an index that records where each ballot\
  \ is stored. Permits county clerks to charge a reasonable fee to cover the cost of retrieving a ballot.\
  \ \n\tRequires county clerks to permit authorized persons to watch the printing of ballots and the inserting\
  \ of ballots in envelopes to be mailed to electors. \n\tApplies to primary, general and special elections\
  \ held on or after January 1, 2027. \n\tBecomes operative January 1, 2027."
relating_to: Relating to ballot security.
relating_to_full: Relating to ballot security; creating new provisions; and amending ORS 254.145, 254.478,
  254.482, 254.483 and 254.535.
...
# SB 655 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 655, 2025 Regular Session (2025R1)
...
- **Full text below:** Introduced version, 14322 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB655/Introduced>.

## Summary

**Catchline:** Directs the Secretary of State to establish and maintain a searchable and publicly accessible database containing a copy of every ballot cast in each election.
...
**RelatingToFull (verbatim upstream field):** Relating to ballot security; creating new provisions; and amending ORS 254.145, 254.478, 254.482, 254.483 and 254.535.
...
SECTION 1.
Sections 2 and 9 of  this 2025 Act are added to and made a part of ORS
chapter 254.
...
NOTE:
 Section 4 was deleted. Subsequent sections were not renumbered.
...
SECTION 10.
(1) Sections 2 and 9 of this  2025 Act and the amendments to ORS 254.145,
...
- From `RelatingToFull`: ORS 254.145, ORS 254.478, ORS 254.482, ORS 254.483, ORS 254.535
- From bill text (Introduced version): ORS 250.125, ORS 254.074, ORS 254.125, ORS 254.135, ORS 254.145, ORS 254.155, ORS 254.470, ORS 254.478, ORS 254.482, ORS 254.483, ORS 254.529, ORS 254.532, ORS 254.535, ORS 260.705

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `844dd727663cc979b1e2c00556662c661716e8410733c3e5f81758f8a3ede87a` (snapshot `_meta/snapshots/measure-2025r1-sb655-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB655/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 655> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

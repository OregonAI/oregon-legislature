...
jurisdiction: oregon
id: measure-2025r1-sb75
title: 'SB 75 (2025R1): Removes requirements related to wildfire hazards for purposes of developing an
  accessory dwelling unit on lands zoned for rural residential uses or a replacement dwelling on lands
  zoned for resource uses.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 75
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB75/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0c503ae23b1ed62027a0dc2458197d090905b277b27f1dea53b4f3a12f8e6135
snapshot_id: measure-2025r1-sb75-enrolled
status: current
...
catch_line: Removes requirements related to wildfire hazards for purposes of developing an accessory dwelling
  unit on lands zoned for rural residential uses or a replacement dwelling on lands zoned for resource
  uses.
minority_catch_line: null
measure_summary: "\t<b>Digest: This Act strikes fire hazards requirements for rural second homes. (Flesch\
  \ Readability Score: 61.3).</b> \n\t[<i>Digest: The Act updates wildfire hazard language for rural homes.\
  \ (Flesch Readability Score: 66.1).</i>] \n\t[<i>Defines \"high wildfire hazard area\"</i>] <b>Removes\
  \ requirements related to wildfire hazards </b>for purposes of developing an accessory dwelling unit\
  \ on lands zoned for rural residential uses or a replacement dwelling on lands zoned for resource uses."
relating_to: Relating to wildfire hazard requirements for nonurban dwellings.
relating_to_full: Relating to wildfire hazard requirements for nonurban dwellings.
...
# SB 75 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 75, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 10871 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB75/Enrolled>.

## Summary

**Catchline:** Removes requirements related to wildfire hazards for purposes of developing an accessory dwelling unit on lands zoned for rural residential uses or a replacement dwelling on lands zoned for resource uses.

**Relating to:** Relating to wildfire hazard requirements for nonurban dwellings.
...
**RelatingToFull (verbatim upstream field):** Relating to wildfire hazard requirements for nonurban dwellings.
...
CHAPTER .................................................
AN ACT
Relating to wildfire hazard requirements for nonurban  dwellings; amending ORS 215.291 and 215.495.
Be It Enacted by the People of the State of Oregon:
SECTION 1.  ORS 215.495 is amended to read:
...
Enrolled Senate Bill 75 (SB 75-A) Page 2
...
- From bill text (Enrolled version): ORS 105.550, ORS 181A.410, ORS 197A.230, ORS 215.213, ORS 215.291, ORS 215.495, ORS 215.501, ORS 455.055, ORS 476.392, ORS 477.490, ORS 537.545, ORS 90.100

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `0c503ae23b1ed62027a0dc2458197d090905b277b27f1dea53b4f3a12f8e6135` (snapshot `_meta/snapshots/measure-2025r1-sb75-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB75/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `e0db5ad30d5f20364855b8d7fdcf671ca56247068a0b812dfe58ed53a9c724db` (snapshot `_meta/snapshots/measure-2025r1-sb75-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB75/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 75` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

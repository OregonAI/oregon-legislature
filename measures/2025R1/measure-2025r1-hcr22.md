...
jurisdiction: oregon
id: measure-2025r1-hcr22
title: 'HCR 22 (2025R1): Encourages Oregon counties that have not already done so to create and adopt
  a natural resource plan and invoke and enforce coordination with all federal and state agencies.'
doc_type: dataset_doc
citation: 2025 Regular Session House Concurrent Resolution 22
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR22/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: bfeb2d103da46dd0a52c63b6e110b5a20f31b9aa421c8d5fe81276a6c66771c9
snapshot_id: measure-2025r1-hcr22-introduced
status: current
...
catch_line: Encourages Oregon counties that have not already done so to create and adopt a natural resource
  plan and invoke and enforce coordination with all federal and state agencies.
minority_catch_line: null
measure_summary: "\tDigest: Tells counties in Oregon that they should make a plan for what to do with\
  \ their natural resources if they don't have one, and that they should coordinate with other agencies\
  \ on that plan. (Flesch Readability Score: 60.3). \n\tEncourages Oregon counties that have not already\
  \ done so to create and adopt a natural resource plan and invoke and enforce coordination with all federal\
  \ and state agencies."
relating_to: Encouraging Oregon counties to adopt a natural resource plan and coordinate with federal
  and state agencies.
relating_to_full: null
at_the_request_of: null
lc_number: 4249
measure_created_date: '2025-02-24T08:44:07'
...
# HCR 22 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Concurrent Resolution 22, 2025 Regular Session (2025R1)
- **LC number:** 4249
- **Created:** 2025-02-24T08:44:07
- **Metadata last modified (upstream):** 2025-02-28T08:29:52
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6244 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR22/Introduced>.

## Summary

**Catchline:** Encourages Oregon counties that have not already done so to create and adopt a natural resource plan and invoke and enforce coordination with all federal and state agencies.

**Relating to:** Encouraging Oregon counties to adopt a natural resource plan and coordinate with federal and state agencies.

Digest: Tells counties in Oregon that they should make a plan for what to do with their natural resources if they don't have one, and that they should coordinate with other agencies on that plan. (Flesch Readability Score: 60.3). 
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `bfeb2d103da46dd0a52c63b6e110b5a20f31b9aa421c8d5fe81276a6c66771c9` (snapshot `_meta/snapshots/measure-2025r1-hcr22-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR22/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 22` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

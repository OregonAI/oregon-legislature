...
jurisdiction: oregon
id: measure-2025r1-sb740
title: 'SB 740 (2025R1): Directs the Department of Human Services to establish and administer the Youth
  Support and Repayment Grant Program to provide financial support to specified persons from whom, while
  in the care or custody of the department, resources to which the persons were entitled were seized and
  used to pay for certain services provided.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 740
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB740/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 896524876d3c44818976b7d822d9cac0e585bae66afb90a1321e970225c58f24
snapshot_id: measure-2025r1-sb740-introduced
status: current
...
catch_line: Directs the Department of Human Services to establish and administer the Youth Support and
  Repayment Grant Program to provide financial support to specified persons from whom, while in the care
  or custody of the department, resources to which the persons were entitled were seized and used to pay
  for certain services provided.
minority_catch_line: null
measure_summary: "\tDigest: The Act directs DHS to set up a grant program for people who had certain resources\
  \ seized while in the care or custody of DHS. (Flesch Readability Score: 73.1). \n\tDirects the Department\
  \ of Human Services to establish and administer the Youth Support and Repayment Grant Program to provide\
  \ financial support to specified persons from whom, while in the care or custody of the department,\
  \ resources to which the persons were entitled were seized and used to pay for certain services provided.\
  \ \n\tSunsets the grant program on later of the date the Youth Support and Repayment Grant Fund is depleted\
  \ or January 2, 2055. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to persons from whom assets were seized by the state when the persons were under
  21 years of age; prescribing an effective date.
relating_to_full: Relating to persons from whom assets were seized by the state when the persons were
  under 21 years of age; and prescribing an effective date.
at_the_request_of: null
lc_number: 1497
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-03-22T17:36:35'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 6627
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 740`.

# SB 740 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 740, 2025 Regular Session (2025R1)
- **LC number:** 1497
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-03-22T17:36:35
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6627 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB740/Introduced>.
...
**RelatingToFull (verbatim upstream field):** Relating to persons from whom assets were seized by the state when the persons were under 21 years of age; and prescribing an effective date.
...
LC 1497
grants awarded to a specific grant recipient may not exceed 125 percent of the total  funds
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `896524876d3c44818976b7d822d9cac0e585bae66afb90a1321e970225c58f24` (snapshot `_meta/snapshots/measure-2025r1-sb740-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB740/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 740` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

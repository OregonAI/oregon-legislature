...
jurisdiction: oregon
id: measure-2025r1-hb2307
title: 'HB 2307 (2025R1): Exempts, until January 2, 2030, lamps purchased by a school district from the
  prohibition on the sale of certain fluorescent lamps.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2307
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2307/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 97d2b72609d599f7c1997a36608547908609551757fa8a1fdcf837692d4cc762
snapshot_id: measure-2025r1-hb2307-enrolled
status: current
...
catch_line: Exempts, until January 2, 2030, lamps purchased by a school district from the prohibition
  on the sale of certain fluorescent lamps.
minority_catch_line: null
measure_summary: "\tDigest: This Act exempts lamps purchased by school districts from a ban on sales of\
  \ some fluorescent lamps. (Flesch Readability Score: 80.0). \n\tExempts, until January 2, 2030, lamps\
  \ purchased by a school district from the prohibition on the sale of certain fluorescent lamps. \n\t\
  Declares an emergency, effective on passage."
relating_to: Relating to fluorescent lamps purchased by school districts; and declaring an emergency.
relating_to_full: Relating to fluorescent lamps purchased by school districts; and declaring an emergency.
...
# HB 2307 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2307, 2025 Regular Session (2025R1)
- **LC number:** 1605
...
- **Full text below:** Enrolled version, 6909 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2307/Enrolled>.

## Summary

**Catchline:** Exempts, until January 2, 2030, lamps purchased by a school district from the prohibition on the sale of certain fluorescent lamps.
...
**RelatingToFull (verbatim upstream field):** Relating to fluorescent lamps purchased by school districts; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 332.002, ORS 459.485, ORS 459.488

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `97d2b72609d599f7c1997a36608547908609551757fa8a1fdcf837692d4cc762` (snapshot `_meta/snapshots/measure-2025r1-hb2307-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2307/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `df53591e4316558c9baef6d1b009c0bcf6bdd76ec4e375af5969122fc93155f7` (snapshot `_meta/snapshots/measure-2025r1-hb2307-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2307/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2307` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

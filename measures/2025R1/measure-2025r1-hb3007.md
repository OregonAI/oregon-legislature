...
jurisdiction: oregon
id: measure-2025r1-hb3007
title: 'HB 3007 (2025R1): Prescribes the requirements for an immediate and temporary accommodations plan
  to be implemented when a public education provider receives notification that a student has been diagnosed
  with a concussion or other brain injury.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3007
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3007/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 13d4da42e361a47dba241957ee642b2be445b2ff5b424c01a65b01c96dde4852
snapshot_id: measure-2025r1-hb3007-enrolled
status: current
...
catch_line: Prescribes the requirements for an immediate and temporary accommodations plan to be implemented
  when a public education provider receives notification that a student has been diagnosed with a concussion
  or other brain injury.
minority_catch_line: null
measure_summary: "\tDigest: Requires schools to implement a plan when a student has a brain injury. (Flesch\
  \ Readability Score: 69.9). \n\tPrescribes the requirements for an immediate and temporary accommodations\
  \ plan to be implemented when a public education provider receives notification that a student has been\
  \ diagnosed with a concussion or other brain injury. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to accommodations for students diagnosed with a brain injury; and declaring an emergency.
relating_to_full: Relating to accommodations for students diagnosed with a brain injury; and declaring
  an emergency.
at_the_request_of: null
lc_number: 3342
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2026-04-15T10:30:30'
...
# HB 3007 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3007, 2025 Regular Session (2025R1)
- **LC number:** 3342
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-04-15T10:30:30
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 6900 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3007/Enrolled>.

## Summary

**Catchline:** Prescribes the requirements for an immediate and temporary accommodations plan to be implemented when a public education provider receives notification that a student has been diagnosed with a concussion or other brain injury.
...
**RelatingToFull (verbatim upstream field):** Relating to accommodations for students diagnosed with a brain injury; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 336.495

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `13d4da42e361a47dba241957ee642b2be445b2ff5b424c01a65b01c96dde4852` (snapshot `_meta/snapshots/measure-2025r1-hb3007-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3007/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `693185a7c8afbbed18eec510a3958f5b0467e332e5e6563bb43ee1b3a48507c9` (snapshot `_meta/snapshots/measure-2025r1-hb3007-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3007/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3007` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

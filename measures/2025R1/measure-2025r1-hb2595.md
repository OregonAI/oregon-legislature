...
jurisdiction: oregon
id: measure-2025r1-hb2595
title: 'HB 2595 (2025R1): Establishes Parkinson''s disease registry.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2595
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2595/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f5bcf62866e902b5e52b5a1326d4c838d24af605a7d6c82a8c16acf31e6223f5
snapshot_id: measure-2025r1-hb2595-introduced
status: current
...
catch_line: Establishes Parkinson's disease registry.
minority_catch_line: null
measure_summary: "\tDigest: The Act creates a system to track Parkinson's disease in Oregon. (Flesch Readability\
  \ Score: 64.9). \n\tEstablishes Parkinson's disease registry."
relating_to: Relating to Parkinson's disease registry; prescribing an effective date.
relating_to_full: Relating to Parkinson's disease registry; and prescribing an effective date.
...
# HB 2595 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2595, 2025 Regular Session (2025R1)
- **LC number:** 149
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:25:05
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 10316 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2595/Introduced>.

## Summary

**Catchline:** Establishes Parkinson's disease registry.
...
**RelatingToFull (verbatim upstream field):** Relating to Parkinson's disease registry; and prescribing an effective date.
...
LC 149
tee must include a neurologist, a movement disorder specialist, a primary care physician,  a
...
- From bill text (Introduced version): ORS 192.245, ORS 413.196, ORS 432.500

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `f5bcf62866e902b5e52b5a1326d4c838d24af605a7d6c82a8c16acf31e6223f5` (snapshot `_meta/snapshots/measure-2025r1-hb2595-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2595/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2595` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb17
title: 'SB 17 (2025R1): Establishes the eligibility for renewable energy certificates for facilities that
  generate electricity from the direct combustion of municipal solid waste and became operational before
  January 1, 1995, if such facilities register with the Western Renewable Energy Generation Information
  System at any time, and for up to 11 average megawatts of electricity generated, per calendar year,
  from the combustion of biogenic material.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 17
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB17/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 556b980521f10f807498928f62eb6e108fa1925010d139539d3ecbff31147999
snapshot_id: measure-2025r1-sb17-introduced
status: current
...
catch_line: Establishes the eligibility for renewable energy certificates for facilities that generate
  electricity from the direct combustion of municipal solid waste and became operational before January
  1, 1995, if such facilities register with the Western Renewable Energy Generation Information System
  at any time, and for up to 11 average megawatts of electricity generated, per calendar year, from the
  combustion of biogenic material.
minority_catch_line: null
measure_summary: "\tDigest: Makes power made from the direct burning of solid waste eligible for RECs.\
  \ (Flesch Readability Score: 63.4). \n\tEstablishes the eligibility for renewable energy certificates\
  \ for facilities that generate electricity from the direct combustion of municipal solid waste and became\
  \ operational before January 1, 1995, if such facilities register with the Western Renewable Energy\
  \ Generation Information System at any time, and for up to 11 average megawatts of electricity generated,\
  \ per calendar year, from the combustion of biogenic material."
relating_to: Relating to the eligibility to use electricity generated from waste for renewable energy
  certificates.
relating_to_full: Relating to the eligibility to use electricity generated from waste for renewable energy
  certificates; amending ORS 469A.020 and 469A.031.
at_the_request_of: (at the request of Marion County Commissioners)
lc_number: 2809
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 17`.

# SB 17 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 17, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Marion County Commissioners)
- **LC number:** 2809
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-22T16:05:58
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4412 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB17/Introduced>.
...
**RelatingToFull (verbatim upstream field):** Relating to the eligibility to use electricity generated from waste for renewable energy certificates; amending ORS 469A.020 and 469A.031.
...
LC 2809
the facility meets the requirements of  the federal Public Utility Regulatory Policies Act of 1978 (P.L.
...
- From `RelatingToFull`: ORS 469A.020, ORS 469A.031
- From bill text (Introduced version): ORS 469A.020, ORS 469A.025, ORS 469A.029, ORS 469A.031

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `556b980521f10f807498928f62eb6e108fa1925010d139539d3ecbff31147999` (snapshot `_meta/snapshots/measure-2025r1-sb17-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB17/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 17` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

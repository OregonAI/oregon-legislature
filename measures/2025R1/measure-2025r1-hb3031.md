...
jurisdiction: oregon
id: measure-2025r1-hb3031
title: 'HB 3031 (2025R1): Establishes a program through which the Oregon Infrastructure Finance Authority
  may provide financial assistance for infrastructure to support housing development.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3031
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3031/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a9066915a70c8cf3e69df03e18cd2e1612b4361b5aaf870c4a28685a00408c83
snapshot_id: measure-2025r1-hb3031-enrolled
status: current
...
catch_line: Establishes a program through which the Oregon Infrastructure Finance Authority may provide
  financial assistance for infrastructure to support housing development.
minority_catch_line: null
measure_summary: "\t<b>Digest: This Act requires OIFA to finance roads and pipes to support new home building.\
  \ (Flesch Readability Score: 77.8).</b> \n\t[<i>Digest: The Act tells OHCS to study housing. (Flesch\
  \ Readability Score: 90.9).</i>] \n\t[<i>Requires the Housing and Community Services Department to study\
  \ housing. Directs the department to submit findings to the interim committees of the Legislative Assembly\
  \ related to housing not later than September 15, 2026.</i>] \n\t<b>Establishes a program through which\
  \ the Oregon Infrastructure Finance Authority may provide financial assistance for infrastructure to\
  \ support housing development. Establishes the Housing Infrastructure Project Fund for the program.\
  \ \n\tDeclares an emergency, effective July 1, 2025.</b>"
...
# HB 3031 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3031, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 7059 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3031/Enrolled>.

## Summary

**Catchline:** Establishes a program through which the Oregon Infrastructure Finance Authority may provide financial assistance for infrastructure to support housing development.

**Relating to:** Relating to housing; and declaring an emergency.

<b>Digest: This Act requires OIFA to finance roads and pipes to support new home building. (Flesch Readability Score: 77.8).</b> 
 ...
 <b>Establishes a program through which the Oregon Infrastructure Finance Authority may provide financial assistance for infrastructure to support housing development. Establishes the Housing Infrastructure Project Fund for the program. 
 Declares an emergency, effective July 1, 2025.</b>
...
- From bill text (Enrolled version): ORS 198.010, ORS 285B.410, ORS 456.005, ORS 456.270, ORS 458.610

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `a9066915a70c8cf3e69df03e18cd2e1612b4361b5aaf870c4a28685a00408c83` (snapshot `_meta/snapshots/measure-2025r1-hb3031-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3031/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `3ed7ae6b4b49700d387303c46ad98b71829d31706437fc967bd35b5724464274` (snapshot `_meta/snapshots/measure-2025r1-hb3031-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3031/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3031` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

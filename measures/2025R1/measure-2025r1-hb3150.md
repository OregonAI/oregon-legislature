...
jurisdiction: oregon
id: measure-2025r1-hb3150
title: 'HB 3150 (2025R1): Establishes an income tax credit for volunteer firefighters.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3150
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3150/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 444cd63b38cd2a18305781b63ec9ca3ad763bc94bc8abeeeed3b420cb7ec2b29
snapshot_id: measure-2025r1-hb3150-introduced
status: current
...
# HB 3150 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3150, 2025 Regular Session (2025R1)
- **LC number:** 930
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-02-24T12:33:21
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4371 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3150/Introduced>.
...
House Bill 3150
Sponsored by Representative CATE, Senators SOLLMAN, GELSER  BLOUIN, Representatives ELMER, LEVY B,
MCINTIRE, PHAM H, SMITH G, WRIGHT, Senators ANDERSON, GIROD; Representatives BOICE, GRAYBER,
JAVADI, LEWIS,  LIVELY, MANNIX, MCLAIN, OWENS, RESCHKE, SCHARF, Senators FREDERICK,
PATTERSON, WEBER, WOODS (Presession filed.)
SUMMARY
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `444cd63b38cd2a18305781b63ec9ca3ad763bc94bc8abeeeed3b420cb7ec2b29` (snapshot `_meta/snapshots/measure-2025r1-hb3150-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3150/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3150` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb735
title: 'SB 735 (2025R1): Provides that abbreviated school day program requirements do not apply to students
  in public charter schools if certain conditions are met.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 735
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB735/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4cbe5ccbdc8f4b448bf295aa85cf5a4ca0bde1d891fc957a902bc48d9fc46379
snapshot_id: measure-2025r1-sb735-enrolled
status: current
...
catch_line: Provides that abbreviated school day program requirements do not apply to students in public
  charter schools if certain conditions are met.
minority_catch_line: null
measure_summary: "\tDigest: Does not apply short school day program standards to a student in a public\
  \ charter school when certain conditions are met. (Flesch Readability Score: 64.6). \n\tProvides that\
  \ abbreviated school day program requirements do not apply to students in public charter schools if\
  \ certain conditions are met. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to the application of abbreviated school day program requirements to students who
  are enrolled in a public charter school; and declaring an emergency.
relating_to_full: Relating to the application of abbreviated school day program requirements to students
  who are enrolled in a public charter school; and declaring an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 735`.

# SB 735 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 735, 2025 Regular Session (2025R1)
- **LC number:** 3452
...
- **Full text below:** Enrolled version, 6927 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB735/Enrolled>.

## Summary

**Catchline:** Provides that abbreviated school day program requirements do not apply to students in public charter schools if certain conditions are met.
...
**RelatingToFull (verbatim upstream field):** Relating to the application of abbreviated school day program requirements to students who are enrolled in a public charter school; and declaring an emergency.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `4cbe5ccbdc8f4b448bf295aa85cf5a4ca0bde1d891fc957a902bc48d9fc46379` (snapshot `_meta/snapshots/measure-2025r1-sb735-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB735/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `91bb42a224016b797fcb7002577cd514b6669e1f4e6c3f68b4708c97d697f904` (snapshot `_meta/snapshots/measure-2025r1-sb735-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB735/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 735` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

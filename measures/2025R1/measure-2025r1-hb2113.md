...
jurisdiction: oregon
id: measure-2025r1-hb2113
title: 'HB 2113 (2025R1): Establishes December 21, 2017, as the connection date for the Internal Revenue
  Code sections governing bonus depreciation and deduction of net business interest.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2113
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2113/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 890f3792bf0717ddda5d362644dc27a4b091cf67154f55fac17f74ec39667e5e
snapshot_id: measure-2025r1-hb2113-introduced
status: current
...
catch_line: Establishes December 21, 2017, as the connection date for the Internal Revenue Code sections
  governing bonus depreciation and deduction of net business interest.
minority_catch_line: null
measure_summary: "\tDigest: The Act cuts off the connection to some tax deductions for business and ties\
  \ to 2017 tax law. (Flesch Readability Score: 62.8). \n\tEstablishes December 21, 2017, as the connection\
  \ date for the Internal Revenue Code sections governing bonus depreciation and deduction of net business\
  \ interest. Allows full bonus depreciation in the first year of service and provides for the addition\
  \ in later year of excess amounts subtracted from federal taxable income. Applies to tax years beginning\
  \ on or after January 1, 2025, and to property placed in service on or after January 1, 2025. \n\tAllows\
  \ the deduction of certain net business interest without limitation. Applies to tax years beginning\
  \ on or after January 1, 2025. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to connection to federal tax allowing business deductions; prescribing an effective
  date.
relating_to_full: Relating to connection to federal tax allowing business deductions; and prescribing
  an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2113>.

# HB 2113 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2113, 2025 Regular Session (2025R1)
- **LC number:** 2357
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-06-02T15:57:43
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4395 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2113/Introduced>.

## Summary

**Catchline:** Establishes December 21, 2017, as the connection date for the Internal Revenue Code sections governing bonus depreciation and deduction of net business interest.
...
**RelatingToFull (verbatim upstream field):** Relating to connection to federal tax allowing business deductions; and prescribing an effective date.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `890f3792bf0717ddda5d362644dc27a4b091cf67154f55fac17f74ec39667e5e` (snapshot `_meta/snapshots/measure-2025r1-hb2113-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2113/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2113> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

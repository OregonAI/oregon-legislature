...
jurisdiction: oregon
id: measure-2025r1-hb3370
title: 'HB 3370 (2025R1): Modifies the time frame in which state agencies may submit information to financial
  institutions related to deceased members or depositors.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3370
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3370/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 3a71bea67882f59beed10d792dd92d199e961df49800c118ecb0bd5922b5f8e3
snapshot_id: measure-2025r1-hb3370-enrolled
status: current
...
catch_line: Modifies the time frame in which state agencies may submit information to financial institutions
  related to deceased members or depositors.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes changes to laws relating to credit unions and banks. (Flesch\
  \ Readability Score: 67.7). \n\tModifies the time frame in which state agencies may submit information\
  \ to financial institutions related to deceased members or depositors. \n\tAuthorizes directors of credit\
  \ unions to delegate the duty to consider requests for reinstatement. \n\tModifies requirements for\
  \ supervisory committees of credit unions."
relating_to: Relating to financial institutions.
relating_to_full: Relating to financial institutions.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3370`.

# HB 3370 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3370, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 19003 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3370/Enrolled>.

## Summary

**Catchline:** Modifies the time frame in which state agencies may submit information to financial institutions related to deceased members or depositors.
...
**RelatingToFull (verbatim upstream field):** Relating to financial institutions.
...
- From bill text (Enrolled version): ORS 113.235, ORS 115.125, ORS 116.253, ORS 192.589, ORS 192.602, ORS 411.640, ORS 411.708, ORS 411.795, ORS 708A.430, ORS 708A.455, ORS 723.202, ORS 723.252, ORS 723.466, ORS 723.474

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `3a71bea67882f59beed10d792dd92d199e961df49800c118ecb0bd5922b5f8e3` (snapshot `_meta/snapshots/measure-2025r1-hb3370-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3370/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `5887cff66616356cb20ada21b21944c4f6cae0967bff19bbe4c0ef884765e931` (snapshot `_meta/snapshots/measure-2025r1-hb3370-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3370/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3370` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

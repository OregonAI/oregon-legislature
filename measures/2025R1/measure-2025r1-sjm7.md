...
jurisdiction: oregon
id: measure-2025r1-sjm7
title: 'SJM 7 (2025R1): Requests discussion between Oregon and Idaho governments regarding the relocation
  of the Oregon and Idaho border.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Joint Memorial 7
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJM7/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 9dff2a31081c32ada7999c3f3df67a66c0fa1529a91b3850f30b7204d414155e
snapshot_id: measure-2025r1-sjm7-introduced
status: current
...
catch_line: Requests discussion between Oregon and Idaho governments regarding the relocation of the Oregon
  and Idaho border.
minority_catch_line: null
measure_summary: "\tDigest: Urges two states to talk about moving state boundaries. (Flesch Readability\
  \ Score: 66.1). \n\tRequests discussion between Oregon and Idaho governments regarding the relocation\
  \ of the Oregon and Idaho border."
relating_to: Requesting discussion regarding the Oregon and Idaho border.
...
measure_modified_date: '2025-01-17T14:47:06'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 5188
...
# SJM 7 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Joint Memorial 7, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of former Senator Dennis Linthicum)
- **LC number:** 213
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T14:47:06
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5188 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJM7/Introduced>.

## Summary

**Catchline:** Requests discussion between Oregon and Idaho governments regarding the relocation of the Oregon and Idaho border.
...
LC 213
be a secondary consideration, as the health of Oregon’s state budget is primarily  determined by
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `9dff2a31081c32ada7999c3f3df67a66c0fa1529a91b3850f30b7204d414155e` (snapshot `_meta/snapshots/measure-2025r1-sjm7-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJM7/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SJM' and MeasureNumber eq 7> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

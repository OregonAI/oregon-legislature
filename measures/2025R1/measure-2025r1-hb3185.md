...
jurisdiction: oregon
id: measure-2025r1-hb3185
title: 'HB 3185 (2025R1): Provides that priority may be given to students in specified courses of study
  to participate in a pilot program to enhance the hiring of public university students by eligible nonprofit
  organizations.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3185
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3185/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 3e355754634ae23ebfdc80c09295c24d2c5ac75bd6eb983c869d7b645b60b820
snapshot_id: measure-2025r1-hb3185-introduced
status: current
...
catch_line: Provides that priority may be given to students in specified courses of study to participate
  in a pilot program to enhance the hiring of public university students by eligible nonprofit organizations.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes the program for hiring certain students by nonprofits. The\
  \ Act gives priority to certain types of courses. The Act increases the payback amount to the nonprofits.\
  \ The Act declares an emergency and becomes law when the Governor signs it. (Flesch Readability Score:\
  \ 61.2). \n\tProvides that priority may be given to students in specified courses of study to participate\
  \ in a pilot program to enhance the hiring of public university students by eligible nonprofit organizations.\
  \ Provides for the reimbursement of eligible nonprofit organizations that participate in the pilot program\
  \ up to 100 percent of the amount the organizations have paid in wages to participating students. Removes\
  \ the requirement that eligible nonprofit organizations must have an annual budget of $5,000,000 or\
  \ less. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to post-secondary students working at nonprofit corporations; declaring an emergency.
relating_to_full: Relating to post-secondary students working at nonprofit corporations; creating new
  provisions; amending section 1, chapter 514, Oregon Laws 2023; and declaring an emergency.
at_the_request_of: (at the request of Portland State University, Eastern Oregon University)
lc_number: 2608
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2026-06-16T11:40:36'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 6857
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3185>.

# HB 3185 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3185, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Portland State University, Eastern Oregon University)
- **LC number:** 2608
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-06-16T11:40:36
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6857 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3185/Introduced>.

## Summary

**Catchline:** Provides that priority may be given to students in specified courses of study to participate in a pilot program to enhance the hiring of public university students by eligible nonprofit organizations.
...
**RelatingToFull (verbatim upstream field):** Relating to post-secondary students working at nonprofit corporations; creating new provisions; amending section 1, chapter 514, Oregon Laws 2023; and declaring an emergency.
...
SECTION 1.
 Section 1, chapter 514, Oregon Laws 2023, is amended to read:
...
established by section 1, chapter 514, Oregon Laws 2023.
SECTION 3.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `3e355754634ae23ebfdc80c09295c24d2c5ac75bd6eb983c869d7b645b60b820` (snapshot `_meta/snapshots/measure-2025r1-hb3185-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3185/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3185> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

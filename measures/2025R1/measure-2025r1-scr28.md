...
jurisdiction: oregon
id: measure-2025r1-scr28
title: 'SCR 28 (2025R1): In memoriam: Charles Benjamin "Chuck" Mawhinney, 1949-2024.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Concurrent Resolution 28
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR28/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c4d0d80dba5255dfa512e1b56d15838e0e322897a601d9b706e36d87eefeb5cd
snapshot_id: measure-2025r1-scr28-enrolled
status: current
...
catch_line: 'In memoriam: Charles Benjamin "Chuck" Mawhinney, 1949-2024.'
minority_catch_line: null
measure_summary: "\tDigest: Honors the life and service of Chuck Mawhinney. (Flesch Readability Score:\
  \ 71.8). \n\tIn memoriam: Charles Benjamin \"Chuck\" Mawhinney, 1949-2024."
relating_to: 'In memoriam: Charles Benjamin "Chuck" Mawhinney.'
relating_to_full: null
at_the_request_of: null
lc_number: 4612
measure_created_date: '2025-03-17T09:53:22'
measure_modified_date: '2025-06-23T08:39:14'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SCR' and MeasureNumber eq 28>.

# SCR 28 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Concurrent Resolution 28, 2025 Regular Session (2025R1)
- **LC number:** 4612
- **Created:** 2025-03-17T09:53:22
- **Metadata last modified (upstream):** 2025-06-23T08:39:14
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 4609 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR28/Enrolled>.

## Summary

**Catchline:** In memoriam: Charles Benjamin "Chuck" Mawhinney, 1949-2024.

**Relating to:** In memoriam: Charles Benjamin "Chuck" Mawhinney.

Digest: Honors the life and service of Chuck Mawhinney. (Flesch Readability Score: 71.8). 
 In memoriam: Charles Benjamin "Chuck" Mawhinney, 1949-2024.
...
Enrolled Senate Concurrent Resolution 28 (SCR 28-A) Page 1
Whereas after the revelation of his feats as  a sniper, Chuck Mawhinney slowly increased his
...
Enrolled Senate Concurrent Resolution 28 (SCR 28-A) Page 2
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `c4d0d80dba5255dfa512e1b56d15838e0e322897a601d9b706e36d87eefeb5cd` (snapshot `_meta/snapshots/measure-2025r1-scr28-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR28/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `dcfa2ee63d7bd7f5b8a374184bd3fbfc4e8d50384e5f4c0ca5f3c50f9dcfbbb4` (snapshot `_meta/snapshots/measure-2025r1-scr28-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR28/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SCR' and MeasureNumber eq 28> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

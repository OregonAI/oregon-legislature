...
jurisdiction: oregon
id: measure-2025r1-hb2441
title: 'HB 2441 (2025R1): Prohibits the amount of tuition that is waived for qualified students from being
  reduced by the amount of specified student aid received by the qualified students.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2441
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2441/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0991e11319fb87b68ffa9a48f5e4fff2a894521c1d03ac013e530c2524eb210a
snapshot_id: measure-2025r1-hb2441-introduced
status: current
...
catch_line: Prohibits the amount of tuition that is waived for qualified students from being reduced by
  the amount of specified student aid received by the qualified students.
minority_catch_line: null
measure_summary: "\tDigest: The Act keeps a tuition waiver from being reduced by other aid amounts. (Flesch\
  \ Readability Score: 76.5). \n\tProhibits the amount of tuition that is waived for qualified students\
  \ from being reduced by the amount of specified student aid received by the qualified students."
relating_to: Relating to waiver of tuition.
relating_to_full: Relating to waiver of tuition; amending ORS 350.285.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2441`.

# HB 2441 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2441, 2025 Regular Session (2025R1)
- **LC number:** 243
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-23T09:50:57
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5131 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2441/Introduced>.

## Summary

**Catchline:** Prohibits the amount of tuition that is waived for qualified students from being reduced by the amount of specified student aid received by the qualified students.

**Relating to:** Relating to waiver of tuition.

Digest: The Act keeps a tuition waiver from being reduced by other aid amounts. (Flesch Readability Score: 76.5). 
...
**RelatingToFull (verbatim upstream field):** Relating to waiver of tuition; amending ORS 350.285.

## Full text

83rd OREGON LEGISLATIVE ASSEMBLY--2025 Regular Session
House Bill 2441
Sponsored by Representatives YUNKER, BOICE, WRIGHT; Representative  OSBORNE, Senators NASH, SMITH DB,
...
standards.
Digest: The Act keeps a tuition waiver from  being reduced by other aid amounts. (Flesch
Readability Score: 76.5).
Prohibits the amount of tuition that is waived  for qualified students from being reduced by the
amount of specified student aid received by the qualified students.
A BILL FOR AN ACT
Relating to waiver of tuition; amending ORS 350.285.
...
master’s degree. A qualified student who  received a tuition waiver for a baccalaureate degree may
also qualify for a tuition waiver for a master’s degree.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `0991e11319fb87b68ffa9a48f5e4fff2a894521c1d03ac013e530c2524eb210a` (snapshot `_meta/snapshots/measure-2025r1-hb2441-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2441/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2441` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

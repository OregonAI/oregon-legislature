...
jurisdiction: oregon
id: measure-2025r1-sb78
title: 'SB 78 (2025R1): Establishes maximum size of replacement dwellings on lands zoned for forest or
  farm use.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 78
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB78/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0e464f201c07fc9c8f62d8c1080de1b3029a205fbbc185406bd6ccae608bd09b
snapshot_id: measure-2025r1-sb78-introduced
status: current
...
measure_summary: "\tDigest: This Act limits the size of replacement homes on forest or farm land. (Flesch\
  \ Readability Score: 76.5). \n\tEstablishes maximum size of replacement dwellings on lands zoned for\
  \ forest or farm use."
relating_to: Relating to replacement dwellings.
relating_to_full: Relating to replacement dwellings; amending ORS 215.291.
...
measure_modified_date: '2025-04-03T11:45:18'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 78`.

# SB 78 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 78, 2025 Regular Session (2025R1)
...
- **Metadata last modified (upstream):** 2025-04-03T11:45:18
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5698 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB78/Introduced>.

## Summary

**Catchline:** Establishes maximum size of replacement dwellings on lands zoned for forest or farm use.

**Relating to:** Relating to replacement dwellings.
...
**RelatingToFull (verbatim upstream field):** Relating to replacement dwellings; amending ORS 215.291.
...
standards.
Digest: This Act limits the size of replacement homes on forest  or farm land. (Flesch Readability
Score: 76.5).
Establishes maximum size of replacement dwellings on lands zoned for forest or farm use.
A BILL FOR AN ACT
Relating to replacement dwellings; amending ORS 215.291.
...
[(C)] (D)  Must comply  with the construction provisions of section R327 of the Oregon Residen-
tial Specialty Code, if:
(i) The dwelling  is in an area identified as extreme or high wildfire risk on the statewide map
of wildfire risk described in ORS 477.490; or
...
- From `RelatingToFull`: ORS 215.291
- From bill text (Introduced version): ORS 215.213, ORS 215.291, ORS 455.055, ORS 477.490

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `0e464f201c07fc9c8f62d8c1080de1b3029a205fbbc185406bd6ccae608bd09b` (snapshot `_meta/snapshots/measure-2025r1-sb78-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB78/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 78` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hcr17
title: 'HCR 17 (2025R1): Recognizes and honors Cambodian Americans in Oregon and the United States and
  all those lost in the Cambodian Genocide.'
doc_type: dataset_doc
citation: 2025 Regular Session House Concurrent Resolution 17
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR17/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0e6914fa939fc91227c41a95fd1e86db250d904232251ce8424419b2d6e78688
snapshot_id: measure-2025r1-hcr17-enrolled
status: current
...
catch_line: Recognizes and honors Cambodian Americans in Oregon and the United States and all those lost
  in the Cambodian Genocide.
minority_catch_line: null
measure_summary: "\tDigest: Honors Cambodian Americans who live in Oregon and the U.S. and all of the\
  \ lives that have been lost in war and conflict in that part of Asia. (Flesch Readability Score: 60.5).\
  \ \n\tRecognizes and honors Cambodian Americans in Oregon and the United States and all those lost in\
  \ the Cambodian Genocide."
relating_to: Recognizing and honoring Cambodian Americans in Oregon and the United States and all those
  lost in the Cambodian Genocide.
relating_to_full: null
at_the_request_of: null
lc_number: 3744
measure_created_date: '2025-02-05T11:11:24'
measure_modified_date: '2025-04-29T15:32:18'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 17`.

# HCR 17 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Concurrent Resolution 17, 2025 Regular Session (2025R1)
- **LC number:** 3744
- **Created:** 2025-02-05T11:11:24
- **Metadata last modified (upstream):** 2025-04-29T15:32:18
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 2862 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR17/Enrolled>.

## Summary

**Catchline:** Recognizes and honors Cambodian Americans in Oregon and the United States and all those lost in the Cambodian Genocide.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `0e6914fa939fc91227c41a95fd1e86db250d904232251ce8424419b2d6e78688` (snapshot `_meta/snapshots/measure-2025r1-hcr17-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR17/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `35b4ab9a64a89111a55f65101c6e9a0b9e0956ca5816dfb851d39a7813095c78` (snapshot `_meta/snapshots/measure-2025r1-hcr17-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR17/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 17` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

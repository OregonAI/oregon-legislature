...
jurisdiction: oregon
id: measure-2025r1-sb1090
title: 'SB 1090 (2025R1): Directs the State Chief Information Officer to adopt a policy and procedure
  for state agencies to follow in requesting funding for information technology budgets and projects.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1090
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1090/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b52fe89f88837f66e9c7ebbc116ad8b526f462eb45af6a92d812d0a810edf2f7
snapshot_id: measure-2025r1-sb1090-enrolled
status: current
...
catch_line: Directs the State Chief Information Officer to adopt a policy and procedure for state agencies
  to follow in requesting funding for information technology budgets and projects.
minority_catch_line: null
measure_summary: "\t<b>Digest: Sets up a process for ranking state IT projects in order of priority. (Flesch\
  \ Readability Score: 63.4).</b> \n\t[<i>Digest: Tells a state agency to start a program to give grants\
  \ and loans to other state agencies so that they can replace their old computers and software, and for\
  \ other purposes. Says that the agencies must pay back the moneys from cost savings. (Flesch Readability\
  \ Score: 66.9).</i>] \n\t[<i>Requires the Oregon Department of Administrative Services to create a program\
  \ to award grants and provide loans to state agencies for replacing outdated information technology\
  \ and for certain other purposes. Creates an advisory board that the department must consult in awarding\
  \ grants and providing loans. Establishes the Technology Modernization Fund and appropriates moneys\
  \ in the fund to the department for the purpose of the department's program.</i>] \n\t<b>Directs the\
  \ State Chief Information Officer to adopt a policy and procedure for state agencies to follow in requesting\
  \ funding for information technology budgets and projects. Requires state agencies that intend to request\
  \ funding for a budget or project to submit requests to the State Chief Information Officer for review.\
  \ Directs the State Chief Information Officer to collaborate with the Legislative Fiscal Office to establish\
  \ criteria for assigning priorities among state agency requests and directs the office of Enterprise\
  \ Information Services to collaborate with state agencies to set priorities for the State Chief Information\
  \ Officer's approval. Specifies reporting requirements.</b> \n\tDeclares an emergency, effective on\
  \ passage."
relating_to: Relating to information technology; and declaring an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1090`.

# SB 1090 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1090, 2025 Regular Session (2025R1)
- **LC number:** 4070
...
- **Full text below:** Enrolled version, 5271 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1090/Enrolled>.

## Summary

**Catchline:** Directs the State Chief Information Officer to adopt a policy and procedure for state agencies to follow in requesting funding for information technology budgets and projects.
...
Enrolled Senate Bill 1090 (SB 1090-A) Page 1
(c) Uses commercially available systems or software;
...
Enrolled Senate Bill 1090 (SB 1090-A) Page 2
...
- From bill text (Enrolled version): ORS 174.112, ORS 276A.203, ORS 352.002

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `b52fe89f88837f66e9c7ebbc116ad8b526f462eb45af6a92d812d0a810edf2f7` (snapshot `_meta/snapshots/measure-2025r1-sb1090-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1090/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `f75e709f9e80fc6cb38c7a9668a84584bfa3e7d37be3929f26d62c37d70d0ce1` (snapshot `_meta/snapshots/measure-2025r1-sb1090-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1090/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1090` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

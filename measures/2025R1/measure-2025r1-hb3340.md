...
jurisdiction: oregon
id: measure-2025r1-hb3340
title: 'HB 3340 (2025R1): Requires the Attorney General to adopt and maintain a list of foreign adversaries
  who are ineligible to receive conveyances of farm or forest lands.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3340
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3340/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f1d46cdd05443ee56e6ffaf6affcd0e342a3a28a91aa6bd814dfe2edc573a285
snapshot_id: measure-2025r1-hb3340-introduced
status: current
...
catch_line: Requires the Attorney General to adopt and maintain a list of foreign adversaries who are
  ineligible to receive conveyances of farm or forest lands.
minority_catch_line: null
measure_summary: "\tDigest: This Act bans foreign adversaries listed by the AG from getting an interest\
  \ in farm or forest lands. (Flesch Readability Score: 61.6). \n\tRequires the Attorney General to adopt\
  \ and maintain a list of foreign adversaries who are ineligible to receive conveyances of farm or forest\
  \ lands. Makes unauthorized conveyances void. \n\tRequires the State Department of Agriculture to create\
  \ and publish an annual report relating to foreign ownership of agricultural lands and to deliver copies\
  \ of the report to the Governor and to relevant interim committees of the Legislative Assembly. \n\t\
  Takes effect on the 91st day following adjournment sine die."
relating_to: Relating to foreign interest in resources lands; prescribing an effective date.
relating_to_full: Relating to foreign interest in resources lands; and prescribing an effective date.
at_the_request_of: null
lc_number: 3826
measure_created_date: '2025-01-18T10:23:06'
...
# HB 3340 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3340, 2025 Regular Session (2025R1)
- **LC number:** 3826
- **Created:** 2025-01-18T10:23:06
- **Metadata last modified (upstream):** 2025-01-30T11:48:49
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6967 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3340/Introduced>.

## Summary

**Catchline:** Requires the Attorney General to adopt and maintain a list of foreign adversaries who are ineligible to receive conveyances of farm or forest lands.

**Relating to:** Relating to foreign interest in resources lands; prescribing an effective date.
...
**RelatingToFull (verbatim upstream field):** Relating to foreign interest in resources lands; and prescribing an effective date.
...
LC 3826
(6) Any action brought pursuant  to subsection (5) of this section must be filed in the
...
(c) Submitted in the manner provided by ORS 192.245 to the interim committees  of the
...
- From bill text (Introduced version): ORS 183.400, ORS 192.245, ORS 215.203

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `f1d46cdd05443ee56e6ffaf6affcd0e342a3a28a91aa6bd814dfe2edc573a285` (snapshot `_meta/snapshots/measure-2025r1-hb3340-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3340/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3340` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

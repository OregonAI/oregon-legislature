...
jurisdiction: oregon
id: measure-2025r1-hb3079
title: 'HB 3079 (2025R1): Requires the Department of Human Services to update its 2022 estimate of costs
  to implement youth experiencing homelessness programs.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3079
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3079/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b86f48ba89f9ddab78ff027094d2db1bb687c84a7f44744df1f68ef1e4235a4c
snapshot_id: measure-2025r1-hb3079-introduced
status: current
...
catch_line: Requires the Department of Human Services to update its 2022 estimate of costs to implement
  youth experiencing homelessness programs.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells DHS to submit some plans to the Legislative Assembly about homeless\
  \ youth and it makes changes to who can get help with housing. (Flesch Readability Score: 60.0). \n\t\
  Requires the Department of Human Services to update its 2022 estimate of costs to implement youth experiencing\
  \ homelessness programs. Requires the Department of Human Services and the Housing and Community Services\
  \ Department to study options for allocating 30 percent of their respective budgets in the 2027-2029\
  \ biennium toward reducing the number of youth aging into adult homelessness. Directs the Department\
  \ of Human Services to submit findings to the interim committees of the Legislative Assembly related\
  \ to housing and human services not later than September 15, 2026. Sunsets on January 2, 2027. \n\t\
  Expands eligibility for emergency housing."
relating_to: Relating to youth homelessness.
relating_to_full: Relating to youth homelessness; creating new provisions; and amending ORS 458.650.
at_the_request_of: null
lc_number: 3515
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-04-02T11:10:06'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 8426
...
# HB 3079 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3079, 2025 Regular Session (2025R1)
- **LC number:** 3515
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-04-02T11:10:06
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 8426 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3079/Introduced>.

## Summary

**Catchline:** Requires the Department of Human Services to update its 2022 estimate of costs to implement youth experiencing homelessness programs.
...
**RelatingToFull (verbatim upstream field):** Relating to youth homelessness; creating new provisions; and amending ORS 458.650.
...
- From bill text (Introduced version): ORS 192.245, ORS 197.746, ORS 197.782, ORS 291.002, ORS 294.187, ORS 401.977, ORS 417.799, ORS 458.650

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `b86f48ba89f9ddab78ff027094d2db1bb687c84a7f44744df1f68ef1e4235a4c` (snapshot `_meta/snapshots/measure-2025r1-hb3079-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3079/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3079` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

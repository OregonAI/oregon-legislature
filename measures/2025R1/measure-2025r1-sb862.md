...
jurisdiction: oregon
id: measure-2025r1-sb862
title: 'SB 862 (2025R1): Makes certain changes related to rural fire protection districts.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 862
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB862/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 2ad5b6ed68b495870ede4bcc47bd7f3b063e90816f8881740d635d2f71dbb4f8
snapshot_id: measure-2025r1-sb862-enrolled
status: current
...
catch_line: Makes certain changes related to rural fire protection districts.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes changes about fire districts. The Act tells an agency to adopt\
  \ a base fire prevention code. (Flesch Readability Score: 76.9). \n\tMakes certain changes related to\
  \ rural fire protection districts. \n\tInstructs the Department of the State Fire Marshal to adopt a\
  \ base fire prevention code. \n\tMakes certain changes related to names for rural fire protection districts."
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 862`.

# SB 862 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 862, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 7951 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB862/Enrolled>.

## Summary

**Catchline:** Makes certain changes related to rural fire protection districts.

**Relating to:** Relating to fire protection.

Digest: The Act makes changes about fire districts. The Act tells an agency to adopt a base fire prevention code. (Flesch Readability Score: 76.9). 
 Makes certain changes related to rural fire protection districts. 
 Instructs the Department of the State Fire Marshal to adopt a base fire prevention code. 
 Makes certain changes related to names for rural fire protection districts.
...
- From bill text (Enrolled version): ORS 478.260, ORS 478.270, ORS 478.940, ORS 478.970, ORS 478.972, ORS 478.980, ORS 478.982, ORS 682.027, ORS 682.062

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `2ad5b6ed68b495870ede4bcc47bd7f3b063e90816f8881740d635d2f71dbb4f8` (snapshot `_meta/snapshots/measure-2025r1-sb862-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB862/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `49e69193c584833148e674d7cba9a9fb9337529db66b5cb19faaf58e5d311aa5` (snapshot `_meta/snapshots/measure-2025r1-sb862-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB862/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 862` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

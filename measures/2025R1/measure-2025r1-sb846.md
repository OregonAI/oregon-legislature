...
jurisdiction: oregon
id: measure-2025r1-sb846
title: 'SB 846 (2025R1): Modifies the requirements for how the Oregon Health Authority monitors the progress
  of coordinated care organizations in improving access to and the quality of health care for children
  and youth in the areas served by the coordinated care organizations.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 846
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB846/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 8684a2e28cf18752f7f1139bb85d513abb2d9bffcb162b4c49050de610071b37
snapshot_id: measure-2025r1-sb846-enrolled
status: current
...
catch_line: Modifies the requirements for how the Oregon Health Authority monitors the progress of coordinated
  care organizations in improving access to and the quality of health care for children and youth in the
  areas served by the coordinated care organizations.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes how OHA monitors the health of children served by CCOs. (Flesch\
  \ Readability Score: 76.5). \n\tModifies the requirements for how the Oregon Health Authority monitors\
  \ the progress of coordinated care organizations in improving access to and the quality of health care\
  \ for children and youth in the areas served by the coordinated care organizations."
relating_to: Relating to health care of children served by coordinated care organizations.
relating_to_full: Relating to health care of children served by coordinated care organizations.
...
# SB 846 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 846, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 5906 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB846/Enrolled>.

## Summary

**Catchline:** Modifies the requirements for how the Oregon Health Authority monitors the progress of coordinated care organizations in improving access to and the quality of health care for children and youth in the areas served by the coordinated care organizations.
...
**RelatingToFull (verbatim upstream field):** Relating to health care of children served by coordinated care organizations.
...
- From bill text (Enrolled version): ORS 414.577, ORS 414.578

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `8684a2e28cf18752f7f1139bb85d513abb2d9bffcb162b4c49050de610071b37` (snapshot `_meta/snapshots/measure-2025r1-sb846-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB846/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `5af11c69cee29e10c89e81bbe40267e8b4096e7085ba282690db6aabbc3dc2e3` (snapshot `_meta/snapshots/measure-2025r1-sb846-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB846/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 846> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

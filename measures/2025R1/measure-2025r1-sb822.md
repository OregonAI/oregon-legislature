...
jurisdiction: oregon
id: measure-2025r1-sb822
title: 'SB 822 (2025R1): Expands network adequacy requirements to health benefit plans offered to large
  employers and modifies requirements.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 822
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB822/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f4d3fe2aa16b895bafb934b9430f026e4d89aef9b30d36896ae60824402820b2
snapshot_id: measure-2025r1-sb822-enrolled
status: current
...
catch_line: Expands network adequacy requirements to health benefit plans offered to large employers and
  modifies requirements.
minority_catch_line: null
measure_summary: "\tDigest: Expands network rules for some health benefit plans. Makes DCBS adopt certain\
  \ rules. Allows some health and dental plans to use remote providers to meet network rules. (Flesch\
  \ Readability Score: 72.3). \n\tExpands network adequacy requirements to health benefit plans offered\
  \ to large employers and modifies requirements. Requires the Department of Consumer and Business Services\
  \ to adopt specified standards for network adequacy. \n\tPermits a health benefit plan and a dental-only\
  \ plan to use telemedicine health care providers to meet network adequacy standards only as permitted\
  \ by rule adopted by the department."
relating_to: Relating to provider networks.
relating_to_full: Relating to provider networks.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 822`.

# SB 822 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 822, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 17711 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB822/Enrolled>.

## Summary

**Catchline:** Expands network adequacy requirements to health benefit plans offered to large employers and modifies requirements.
...
**RelatingToFull (verbatim upstream field):** Relating to provider networks.
...
- From bill text (Enrolled version): ORS 401.165, ORS 433.441, ORS 741.310, ORS 743A.001, ORS 743A.058, ORS 743B.005, ORS 743B.505

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `f4d3fe2aa16b895bafb934b9430f026e4d89aef9b30d36896ae60824402820b2` (snapshot `_meta/snapshots/measure-2025r1-sb822-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB822/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `c26880666934febc699b2e1ad3fc5868575c1ef461be2df75f5832125e737522` (snapshot `_meta/snapshots/measure-2025r1-sb822-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB822/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 822` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

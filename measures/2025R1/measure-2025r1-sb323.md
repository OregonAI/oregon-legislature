...
jurisdiction: oregon
id: measure-2025r1-sb323
title: 'SB 323 (2025R1): Requires a school district and education service district to conduct a cost analysis
  before extending, renewing or entering a new public contract for the procurement of substitute teacher
  services.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 323
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB323/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c80ffa806dfd90bb5215f4d6df7254c9cd77c98636c5cf9dafe1dca49d249305
snapshot_id: measure-2025r1-sb323-introduced
status: current
...
catch_line: Requires a school district and education service district to conduct a cost analysis before
  extending, renewing or entering a new public contract for the procurement of substitute teacher services.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes some education entities take certain steps when contracting\
  \ for a substitute teacher. (Flesch Readability Score: 61.8). \n\tRequires a school district and education\
  \ service district to conduct a cost analysis before extending, renewing or entering a new public contract\
  \ for the procurement of substitute teacher services. Requires a district school board or education\
  \ service district board to make publicly available on its website the current contract, proposed contract\
  \ and cost analysis. \n\tRequires a district school board and education service district board to address\
  \ as an agenda item an extended, renewed or new contract at its next regular meeting, provide notice\
  \ and opportunity for members of the public to testify and make publicly available on its website copies\
  \ of the extended, renewed or new contract and cost analysis. \n\tDirects the Department of Education\
  \ to submit a report to the interim committees of the Legislative Assembly related to education and\
  \ the Legislative Administration Committee no later than September 15 each year. \n\tTakes effect on\
  \ the 91st day following adjournment sine die."
relating_to: Relating to substitute teachers; prescribing an effective date.
relating_to_full: Relating to substitute teachers; and prescribing an effective date.
at_the_request_of: (at the request of Senate Interim Committee on Education)
lc_number: 2696
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-03-31T07:03:24'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 6900
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 323`.

# SB 323 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 323, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Senate Interim Committee on Education)
- **LC number:** 2696
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-03-31T07:03:24
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6900 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB323/Introduced>.

## Summary

**Catchline:** Requires a school district and education service district to conduct a cost analysis before extending, renewing or entering a new public contract for the procurement of substitute teacher services.
...
**RelatingToFull (verbatim upstream field):** Relating to substitute teachers; and prescribing an effective date.
...
- From bill text (Introduced version): ORS 192.245, ORS 279A.010, ORS 279B.030

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `c80ffa806dfd90bb5215f4d6df7254c9cd77c98636c5cf9dafe1dca49d249305` (snapshot `_meta/snapshots/measure-2025r1-sb323-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB323/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 323` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

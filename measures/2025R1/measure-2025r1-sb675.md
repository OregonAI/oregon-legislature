...
jurisdiction: oregon
id: measure-2025r1-sb675
title: 'SB 675 (2025R1): Lowers the interest rate imposed on unpaid property taxes to one-half of one
  percent per month.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 675
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB675/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a78a01baa9ef4b8495a3501faa7c69aae8d38263d665a811b8ba7b2f260469c4
snapshot_id: measure-2025r1-sb675-introduced
status: current
...
measure_summary: "\tDigest: The Act would lower the interest rate on unpaid property taxes to one-half\
  \ of one percent per month. (Flesch Readability Score: 67.3). \n\tLowers the interest rate imposed on\
  \ unpaid property taxes to one-half of one percent per month. \n\tTakes effect on the 91st day following\
  \ adjournment sine die."
relating_to: Relating to interest on unpaid property taxes; prescribing an effective date.
relating_to_full: Relating to interest on unpaid property taxes; creating new provisions; amending ORS
  311.505; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 675`.

# SB 675 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 675, 2025 Regular Session (2025R1)
...
- **Full text below:** Introduced version, 3367 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB675/Introduced>.

## Summary

**Catchline:** Lowers the interest rate imposed on unpaid property taxes to one-half of one percent per month.
...
**RelatingToFull (verbatim upstream field):** Relating to interest on unpaid property taxes; creating new provisions; amending ORS 311.505; and prescribing an effective date.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `a78a01baa9ef4b8495a3501faa7c69aae8d38263d665a811b8ba7b2f260469c4` (snapshot `_meta/snapshots/measure-2025r1-sb675-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB675/Introduced>.

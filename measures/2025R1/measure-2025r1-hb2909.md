...
jurisdiction: oregon
id: measure-2025r1-hb2909
title: 'HB 2909 (2025R1): Establishes the Oregon Public Utility Homeland Security Commission within the
  Oregon Department of Emergency Management.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2909
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2909/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 7107e53b9efbd09f7136a918b7dffa021cf0a6ffc9fd8198159619f0d8506ce0
snapshot_id: measure-2025r1-hb2909-introduced
status: current
...
catch_line: Establishes the Oregon Public Utility Homeland Security Commission within the Oregon Department
  of Emergency Management.
minority_catch_line: null
measure_summary: "\tDigest: The Act creates the OPUHSC as part of the ODEM. (Flesch Readability Score:\
  \ 95.1). \n\tEstablishes the Oregon Public Utility Homeland Security Commission within the Oregon Department\
  \ of Emergency Management. \n\tEstablishes the Oregon Public Utility Homeland Security Fund. \n\tEstablishes\
  \ a grant program for the purpose of providing financial assistance to consumer-owned utilities for\
  \ developing projects associated with natural disaster mitigation, prevention, response and recovery.\
...
relating_to: Relating to public utilities.
relating_to_full: Relating to public utilities.
...
# HB 2909 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2909, 2025 Regular Session (2025R1)
- **LC number:** 1658
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:40:35
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6926 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2909/Introduced>.

## Summary

**Catchline:** Establishes the Oregon Public Utility Homeland Security Commission within the Oregon Department of Emergency Management.
...
**RelatingToFull (verbatim upstream field):** Relating to public utilities.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `7107e53b9efbd09f7136a918b7dffa021cf0a6ffc9fd8198159619f0d8506ce0` (snapshot `_meta/snapshots/measure-2025r1-hb2909-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2909/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2909` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

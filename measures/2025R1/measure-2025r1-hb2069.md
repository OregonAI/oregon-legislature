...
jurisdiction: oregon
id: measure-2025r1-hb2069
title: 'HB 2069 (2025R1): Establishes the Task Force on Tribal Consultation 2025 and specifies the task
  force membership.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2069
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2069/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 8a852609851f18d85f132a237ef3f7f990b119d9da49703710ef6aee988afd4c
snapshot_id: measure-2025r1-hb2069-enrolled
status: current
...
catch_line: Establishes the Task Force on Tribal Consultation 2025 and specifies the task force membership.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes a task force about consulting with tribes. (Flesch Readability\
  \ Score: 86.7). \n\tEstablishes the Task Force on Tribal Consultation 2025 and specifies the task force\
  \ membership. Requires the task force to identify and clarify requirements of state agencies to engage\
  \ in tribal consultation. Requires the task force to report findings and recommendations on tribal consultation\
  \ to an interim committee of the Legislative Assembly related to government by September 15, 2026. \n\
  \tSunsets December 31, 2026. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to tribal consultation; and declaring an emergency.
relating_to_full: Relating to tribal consultation; and declaring an emergency.
...
# HB 2069 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2069, 2025 Regular Session (2025R1)
- **LC number:** 720
...
- **Full text below:** Enrolled version, 4971 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2069/Enrolled>.

## Summary

**Catchline:** Establishes the Task Force on Tribal Consultation 2025 and specifies the task force membership.
...
**RelatingToFull (verbatim upstream field):** Relating to tribal consultation; and declaring an emergency.
...
Enrolled House Bill 2069 (HB 2069-A) Page 1
...
Enrolled House Bill 2069 (HB 2069-A) Page 2
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `8a852609851f18d85f132a237ef3f7f990b119d9da49703710ef6aee988afd4c` (snapshot `_meta/snapshots/measure-2025r1-hb2069-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2069/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `ac6bef84e17d406b2b16decb3b4558ea538c308838ae0a01373fb04e05861b7f` (snapshot `_meta/snapshots/measure-2025r1-hb2069-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2069/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2069` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

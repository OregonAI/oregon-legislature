...
jurisdiction: oregon
id: measure-2025r1-hb3542
title: 'HB 3542 (2025R1): Allows a motorcycle operator to travel between lanes of traffic under certain
  conditions.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3542
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3542/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 96bba3fa517b3a4812a8e56a4ab20601d6b1d3a0aa897f5b3028d7bbc2c017b2
snapshot_id: measure-2025r1-hb3542-introduced
status: current
...
catch_line: Allows a motorcycle operator to travel between lanes of traffic under certain conditions.
minority_catch_line: null
measure_summary: "\tDigest: The Act lets motorcycles drive between lanes of traffic. (Flesch Readability\
...
relating_to: Relating to motorcycles.
relating_to_full: Relating to motorcycles; creating new provisions; and amending ORS 811.295, 811.370,
  811.375, 811.385, 811.415 and 814.240.
at_the_request_of: null
lc_number: 4310
measure_created_date: '2025-02-07T10:48:30'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3542`.

# HB 3542 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3542, 2025 Regular Session (2025R1)
- **LC number:** 4310
- **Created:** 2025-02-07T10:48:30
- **Metadata last modified (upstream):** 2025-02-12T13:30:13
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 10820 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3542/Introduced>.

## Summary

**Catchline:** Allows a motorcycle operator to travel between lanes of traffic under certain conditions.

**Relating to:** Relating to motorcycles.

Digest: The Act lets motorcycles drive between lanes of traffic. (Flesch Readability Score: 66.1). 
 Allows a motorcycle operator to travel between lanes of traffic under certain conditions. 
 Increases the penalty for committing the offense of motorcycle or moped unlawful passing in a lane with a vehicle. Punishes a violation by a maximum $2,000 fine.

**RelatingToFull (verbatim upstream field):** Relating to motorcycles; creating new provisions; and amending ORS 811.295, 811.370, 811.375, 811.385, 811.415 and 814.240.
...
SECTION 1.
 ORS 814.240 is amended to read:
...
LC 4310
torcycle operator is operating a motorcycle in a school zone if the school zone:
...
SECTION 2.
 ORS 811.415 is amended to read:
...
lation.
SECTION 3.
 ORS 811.295 is amended to read:
...
lation.
SECTION 4.
 ORS 811.370 is amended to read:
...
violation.
SECTION 5.
 ORS 811.375 is amended to read:
...
D traffic violation.
SECTION 6.
 ORS 811.385 is amended to read:
...
SECTION 7.
The amendments to ORS 811.295,  811.370, 811.375, 811.385, 811.415 and 814.240
...
- From `RelatingToFull`: ORS 811.295, ORS 811.370, ORS 811.375, ORS 811.385, ORS 811.415, ORS 814.240
- From bill text (Introduced version): ORS 801.462, ORS 810.180, ORS 810.243, ORS 811.111, ORS 811.124, ORS 811.230, ORS 811.295, ORS 811.370, ORS 811.375, ORS 811.380, ORS 811.385, ORS 811.395, ORS 811.400, ORS 811.410, ORS 811.415, ORS 814.240, ORS 814.250

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `96bba3fa517b3a4812a8e56a4ab20601d6b1d3a0aa897f5b3028d7bbc2c017b2` (snapshot `_meta/snapshots/measure-2025r1-hb3542-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3542/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3542` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

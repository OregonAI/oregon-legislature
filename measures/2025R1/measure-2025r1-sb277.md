...
jurisdiction: oregon
id: measure-2025r1-sb277
title: 'SB 277 (2025R1): Allows a law enforcement agency or public body to provide information, or enter
...
citation: 2025 Regular Session Senate Bill 277
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB277/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: bb49eaa523301a91a51dc068cc9872430a11746c5c1990e9868d97fbcffc4015
snapshot_id: measure-2025r1-sb277-enrolled
status: current
...
relating_to: Relating to information sharing between state and federal authorities for the purposes of
  international extraditions; and declaring an emergency.
relating_to_full: Relating to information sharing between state and federal authorities for the purposes
  of international extraditions; and declaring an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 277`.

# SB 277 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 277, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 9221 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB277/Enrolled>.
...
**RelatingToFull (verbatim upstream field):** Relating to information sharing between state and federal authorities for the purposes of international extraditions; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 181A.823, ORS 181A.826, ORS 181A.827, ORS 192.311, ORS 413.161

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `bb49eaa523301a91a51dc068cc9872430a11746c5c1990e9868d97fbcffc4015` (snapshot `_meta/snapshots/measure-2025r1-sb277-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB277/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `1cb8005a47d51cacbc9b7c390fc02a1af1a74555fd85c96248ece245db723f8e` (snapshot `_meta/snapshots/measure-2025r1-sb277-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB277/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 277` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

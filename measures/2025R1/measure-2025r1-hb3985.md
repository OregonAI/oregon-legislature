...
jurisdiction: oregon
id: measure-2025r1-hb3985
title: 'HB 3985 (2025R1): Modifies the minimum standards for staffing plans for direct care registered
  nurses in an emergency department.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3985
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3985/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 9742af7809f17fce126cdfe2e5f3041eb82200d3ffe511e036dc4246625ff280
snapshot_id: measure-2025r1-hb3985-introduced
status: current
...
catch_line: Modifies the minimum standards for staffing plans for direct care registered nurses in an
  emergency department.
minority_catch_line: null
measure_summary: "\tDigest: Changes the standards for staffing plans for direct care registered nurses\
  \ in an ED. (Flesch Readability Score: 65.7). \n\tModifies the minimum standards for staffing plans\
  \ for direct care registered nurses in an emergency department."
relating_to: Relating to staffing plans for health care provider entities.
relating_to_full: Relating to staffing plans for health care provider entities; amending ORS 441.765.
at_the_request_of: null
lc_number: 4828
measure_created_date: '2025-06-12T15:06:11'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3985>.

# HB 3985 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3985, 2025 Regular Session (2025R1)
- **LC number:** 4828
- **Created:** 2025-06-12T15:06:11
- **Metadata last modified (upstream):** 2025-06-18T14:17:47
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 12101 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3985/Introduced>.

## Summary

**Catchline:** Modifies the minimum standards for staffing plans for direct care registered nurses in an emergency department.
...
**RelatingToFull (verbatim upstream field):** Relating to staffing plans for health care provider entities; amending ORS 441.765.
...
- From `RelatingToFull`: ORS 441.765
- From bill text (Introduced version): ORS 441.765, ORS 441.792, ORS 653.261

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `9742af7809f17fce126cdfe2e5f3041eb82200d3ffe511e036dc4246625ff280` (snapshot `_meta/snapshots/measure-2025r1-hb3985-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3985/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3985> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

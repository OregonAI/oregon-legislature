...
jurisdiction: oregon
id: measure-2025r1-sb110
title: 'SB 110 (2025R1): Increases the amount of incremental baseball tax revenues that the Oregon Department
  of Administrative Services may grant for the purpose of constructing a major league baseball stadium.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 110
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB110/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 1b0f2d56f873a86688db026a9235f70245b2391754c3027748a424c77533c645
snapshot_id: measure-2025r1-sb110-enrolled
status: current
...
catch_line: Increases the amount of incremental baseball tax revenues that the Oregon Department of Administrative
  Services may grant for the purpose of constructing a major league baseball stadium.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act raises the amount of incremental tax revenue that DAS may grant\
  \ for an MLB stadium. (Flesch Readability Score: 60.1).</b> \n\t[<i>Digest: The Act tells the LRO to\
  \ study the personal income tax system. (Flesch Readability Score: 74.8).</i>] \n\t[<i>Requires the\
  \ Legislative Revenue Officer to study the personal income tax system. Directs the Legislative Revenue\
  \ Officer to submit findings to the interim committees of the Legislative Assembly related to revenue\
  \ not later than December 1, 2026.</i>] \n\t<b>Increases the amount of incremental baseball tax revenues\
  \ that the Oregon Department of Administrative Services may grant for the purpose of constructing a\
  \ major league baseball stadium. Increases the minimum cost of the stadium. Increases the salary threshold\
  \ for purposes of calculating incremental baseball tax revenues.</b>"
relating_to: Relating to revenue.
relating_to_full: Relating to revenue.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 110`.

# SB 110 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 110, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 10544 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB110/Enrolled>.

## Summary

**Catchline:** Increases the amount of incremental baseball tax revenues that the Oregon Department of Administrative Services may grant for the purpose of constructing a major league baseball stadium.

**Relating to:** Relating to revenue.

<b>Digest: The Act raises the amount of incremental tax revenue that DAS may grant for an MLB stadium. (Flesch Readability Score: 60.1).</b> 
 ...
 <b>Increases the amount of incremental baseball tax revenues that the Oregon Department of Administrative Services may grant for the purpose of constructing a major league baseball stadium. Increases the minimum cost of the stadium. Increases the salary threshold for purposes of calculating incremental baseball tax revenues.</b>

**RelatingToFull (verbatim upstream field):** Relating to revenue.
...
- From bill text (Enrolled version): ORS 184.400, ORS 184.404, ORS 184.408

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `1b0f2d56f873a86688db026a9235f70245b2391754c3027748a424c77533c645` (snapshot `_meta/snapshots/measure-2025r1-sb110-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB110/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `84ebeb901087071568d965602761498eb5bc2d82c62d3405ae2572fed806aa8d` (snapshot `_meta/snapshots/measure-2025r1-sb110-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB110/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 110` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

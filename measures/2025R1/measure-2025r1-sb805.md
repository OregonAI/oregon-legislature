...
jurisdiction: oregon
id: measure-2025r1-sb805
title: 'SB 805 (2025R1): Reduces the duration of time that the Teacher Standards and Practices Commission
  is required to wait for verification that attempts were made to resolve a complaint through the processes
  of the school district before the commission no longer has a duty to investigate the complaint.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 805
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB805/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4a1886b3a52134e4d089e2c9e3484201c51b953b56c8ef0aa3923cab3e326377
snapshot_id: measure-2025r1-sb805-enrolled
status: current
...
catch_line: Reduces the duration of time that the Teacher Standards and Practices Commission is required
  to wait for verification that attempts were made to resolve a complaint through the processes of the
  school district before the commission no longer has a duty to investigate the complaint.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act reduces the length of time that the TSPC must wait for verification\
  \ of a complaint before closing the complaint. The Act gives the TSPC power to impose civil penalties.\
  \ (Flesch Readability Score: 62.8).</b> \n\t[<i>Digest: The Act reduces the length of time that the\
  \ TSPC must wait for verification of a complaint before closing the complaint. (Flesch Readability Score:\
  \ 60.6).</i>] \n\tReduces the duration of time that the Teacher Standards and Practices Commission is\
  \ required to wait for verification that attempts were made to resolve a complaint through the processes\
  \ of the school district before the commission no longer has a duty to investigate the complaint. \n\
  \t<b>Authorizes the commission to impose a civil penalty against a person who has engaged in conduct\
  \ constituting grounds for discipline.</b>"
relating_to: Relating to complaints filed with the Teacher Standards and Practices Commission.
relating_to_full: Relating to complaints filed with the Teacher Standards and Practices Commission.
at_the_request_of: (at the request of Governor Tina Kotek for Teacher Standards and Practices Commission)
lc_number: 313
...
# SB 805 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 805, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Governor Tina Kotek for Teacher Standards and Practices Commission)
- **LC number:** 313
...
- **Full text below:** Enrolled version, 10366 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB805/Enrolled>.

## Summary

**Catchline:** Reduces the duration of time that the Teacher Standards and Practices Commission is required to wait for verification that attempts were made to resolve a complaint through the processes of the school district before the commission no longer has a duty to investigate the complaint.
...
**RelatingToFull (verbatim upstream field):** Relating to complaints filed with the Teacher Standards and Practices Commission.
...
- From bill text (Enrolled version): ORS 183.440, ORS 183.605, ORS 192.660, ORS 339.390, ORS 342.143, ORS 342.175, ORS 342.176, ORS 342.177, ORS 342.553, ORS 419B.035, ORS 44.415

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `4a1886b3a52134e4d089e2c9e3484201c51b953b56c8ef0aa3923cab3e326377` (snapshot `_meta/snapshots/measure-2025r1-sb805-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB805/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `29b7634d35be1a4c5886c0ff4760c9cfb03bd7f7cc47422bc0e38cf159a982a0` (snapshot `_meta/snapshots/measure-2025r1-sb805-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB805/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 805` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

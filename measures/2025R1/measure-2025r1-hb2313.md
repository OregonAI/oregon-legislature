...
jurisdiction: oregon
id: measure-2025r1-hb2313
title: 'HB 2313 (2025R1): Expands the crime of assault in the third degree to include causing physical
  injury to a health care worker while the worker is acting in the course of official duty.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2313
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2313/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: bd69c4bb245e868e6446ccc38cb92d263a4def7ca8b8f49c2409b3e527c59713
snapshot_id: measure-2025r1-hb2313-introduced
status: current
...
catch_line: Expands the crime of assault in the third degree to include causing physical injury to a health
  care worker while the worker is acting in the course of official duty.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes the crime of assault in the third degree to include assault\
  \ of health care workers. The Act makes health care worker employers notify victims if the assaulter\
  \ enters the victim's workplace. (Flesch Readability Score: 62.6). \n\tExpands the crime of assault\
  \ in the third degree to include causing physical injury to a health care worker while the worker is\
  \ acting in the course of official duty. \n\tRequires employers of health care workers to create a notification\
  \ program to notify a health care worker assault victim if the assaulter enters the victim's workplace."
relating_to: Relating to the protection of health care workers.
relating_to_full: Relating to the protection of health care workers; creating new provisions; and amending
  ORS 163.165.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2313>.

# HB 2313 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2313, 2025 Regular Session (2025R1)
- **LC number:** 1630
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-23T10:50:17
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6090 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2313/Introduced>.

## Summary

**Catchline:** Expands the crime of assault in the third degree to include causing physical injury to a health care worker while the worker is acting in the course of official duty.
...
**RelatingToFull (verbatim upstream field):** Relating to the protection of health care workers; creating new provisions; and amending ORS 163.165.
...
- From `RelatingToFull`: ORS 163.165
- From bill text (Introduced version): ORS 162.135, ORS 163.165, ORS 166.116, ORS 181A.355, ORS 682.025, ORS 811.230

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `bd69c4bb245e868e6446ccc38cb92d263a4def7ca8b8f49c2409b3e527c59713` (snapshot `_meta/snapshots/measure-2025r1-hb2313-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2313/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2313> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

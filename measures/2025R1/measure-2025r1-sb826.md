...
jurisdiction: oregon
id: measure-2025r1-sb826
title: 'SB 826 (2025R1): Transfers duties, functions and powers related to the Oregon Statewide Communication
  Interoperability Plan from the State Chief Information Officer to the Oregon Department of Emergency
  Management.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 826
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB826/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5feaafb70bf2ba9f243030b9d77743d119e65c6bed8e6a7684f7dd94faa9e4bc
snapshot_id: measure-2025r1-sb826-enrolled
status: current
...
catch_line: Transfers duties, functions and powers related to the Oregon Statewide Communication Interoperability
  Plan from the State Chief Information Officer to the Oregon Department of Emergency Management.
minority_catch_line: null
measure_summary: "\tDigest: The Act puts ODEM in charge of a plan to make sure that public safety systems\
  \ are compatible with each other. (Flesch Readability Score: 64.6). \n\tTransfers duties, functions\
  \ and powers related to the Oregon Statewide Communication Interoperability Plan from the State Chief\
  \ Information Officer to the Oregon Department of Emergency Management. \n\tDeclares an emergency, effective\
  \ July 1, 2025."
relating_to: Relating to the Oregon Statewide Communication Interoperability Plan; and declaring an emergency.
relating_to_full: Relating to the Oregon Statewide Communication Interoperability Plan; and declaring
  an emergency.
at_the_request_of: (at the request of Governor Tina Kotek for Oregon Department of Emergency Management)
lc_number: 377
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 826`.

# SB 826 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 826, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Governor Tina Kotek for Oregon Department of Emergency Management)
- **LC number:** 377
...
- **Full text below:** Enrolled version, 19580 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB826/Enrolled>.

## Summary

**Catchline:** Transfers duties, functions and powers related to the Oregon Statewide Communication Interoperability Plan from the State Chief Information Officer to the Oregon Department of Emergency Management.
...
**RelatingToFull (verbatim upstream field):** Relating to the Oregon Statewide Communication Interoperability Plan; and declaring an emergency.
...
(g) Shall represent the  State of Oregon in local, regional and national efforts to plan and im-
...
SECTION 14. Notwithstanding the deadline specified in section 12 (1) of this 2025  Act, the
...
- From bill text (Enrolled version): ORS 174.109, ORS 174.111, ORS 276A.203, ORS 292.495, ORS 403.450, ORS 403.455, ORS 403.460, ORS 403.465, ORS 97.740

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `5feaafb70bf2ba9f243030b9d77743d119e65c6bed8e6a7684f7dd94faa9e4bc` (snapshot `_meta/snapshots/measure-2025r1-sb826-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB826/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `ce0183e9c81abd960f3a0942581b80913d1f134df68dda911d7c36703f30be68` (snapshot `_meta/snapshots/measure-2025r1-sb826-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB826/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 826` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hcr3
title: 'HCR 3 (2025R1): Recognizes and honors Dr. Brian Druker for his leadership and service.'
doc_type: dataset_doc
citation: 2025 Regular Session House Concurrent Resolution 3
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR3/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a5ea4ebc1618b6f70c31373cb980bef3b50e9bf799c057f1ec60a7009855ecf4
snapshot_id: measure-2025r1-hcr3-enrolled
status: current
...
catch_line: Recognizes and honors Dr. Brian Druker for his leadership and service.
minority_catch_line: null
measure_summary: "\tDigest: Honors the career of Dr. Brian Druker. (Flesch Readability Score: 66.7). \n\
  \tRecognizes and honors Dr. Brian Druker for his leadership and service."
relating_to: Recognizing and honoring Dr. Brian Druker for his leadership and service.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 3`.

# HCR 3 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Concurrent Resolution 3, 2025 Regular Session (2025R1)
- **LC number:** 1254
...
- **Full text below:** Enrolled version, 4422 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR3/Enrolled>.

## Summary

**Catchline:** Recognizes and honors Dr. Brian Druker for his leadership and service.

**Relating to:** Recognizing and honoring Dr. Brian Druker for his leadership and service.

Digest: Honors the career of Dr. Brian Druker. (Flesch Readability Score: 66.7). 
 Recognizes and honors Dr. Brian Druker for his leadership and service.
...
Enrolled House Concurrent Resolution 3 (HCR 3-INTRO) Page 1
Whereas in 2019, in  the presence of His Majesty the King of Sweden, Brian Druker was awarded
...
Enrolled House Concurrent Resolution 3 (HCR 3-INTRO) Page 2
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `a5ea4ebc1618b6f70c31373cb980bef3b50e9bf799c057f1ec60a7009855ecf4` (snapshot `_meta/snapshots/measure-2025r1-hcr3-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR3/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `3e57a109e5157ae85c5fdf5e5f7f4472dbf1c3a2cdd6b8fd334d98c779bccffd` (snapshot `_meta/snapshots/measure-2025r1-hcr3-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR3/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 3` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

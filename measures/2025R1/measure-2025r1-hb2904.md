...
jurisdiction: oregon
id: measure-2025r1-hb2904
title: 'HB 2904 (2025R1): Establishes the Oregon Quality Education Model Modernization Task Force.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2904
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2904/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4767e70b190fc10cf59a8cc9fd6d9b519687d4b82db62862891ccec31813df63
snapshot_id: measure-2025r1-hb2904-introduced
status: current
...
catch_line: Establishes the Oregon Quality Education Model Modernization Task Force.
minority_catch_line: null
measure_summary: "\tDigest: Creates a task force to study the QEM. (Flesch Readability Score: 100.0).\
  \ \n\tEstablishes the Oregon Quality Education Model Modernization Task Force. \n\tSunsets the task\
  \ force January 2, 2027. \n\tDeclares an emergency, effective on passage."
...
measure_modified_date: '2025-02-04T17:25:59'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 5702
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2904`.

# HB 2904 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2904, 2025 Regular Session (2025R1)
- **LC number:** 1707
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-02-04T17:25:59
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5702 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2904/Introduced>.

## Summary

**Catchline:** Establishes the Oregon Quality Education Model Modernization Task Force.
...
SECTION 1.
(1) The Oregon  Quality Education Model Modernization Task Force is es-
...
LC 1707
of this subsection to be  used by school districts directly in classrooms in the manner deter-
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `4767e70b190fc10cf59a8cc9fd6d9b519687d4b82db62862891ccec31813df63` (snapshot `_meta/snapshots/measure-2025r1-hb2904-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2904/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2904` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3644
title: 'HB 3644 (2025R1): Requires the Housing and Community Services Department to establish a statewide
  shelter program through which regional coordinators are selected to administer funding to shelter providers.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3644
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3644/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c1391205da65e5100d0b32876155569017380dd07d3337eadd062c158d999f8c
snapshot_id: measure-2025r1-hb3644-enrolled
status: current
...
catch_line: Requires the Housing and Community Services Department to establish a statewide shelter program
  through which regional coordinators are selected to administer funding to shelter providers.
minority_catch_line: null
measure_summary: "\tDigest: This Act requires the OHCS to create a statewide shelter program. (Flesch\
  \ Readability Score: 72.6). \n\tRequires the Housing and Community Services Department to establish\
  \ a statewide shelter program through which regional coordinators are selected to administer funding\
  \ to shelter providers.<b> Sunsets January 2, 2034.</b> \n\tRequires the department to adopt rules on\
  \ or before January 1, 2026, and to select regional coordinators on or before May 1, 2026. \n\tDeclares\
  \ an emergency, effective on passage."
relating_to: Relating to a statewide shelter program; and declaring an emergency.
relating_to_full: Relating to a statewide shelter program; and declaring an emergency.
at_the_request_of: (at the request of Governor Tina Kotek)
lc_number: 3983
measure_created_date: '2025-02-18T15:06:11'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3644>.

# HB 3644 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3644, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Governor Tina Kotek)
- **LC number:** 3983
- **Created:** 2025-02-18T15:06:11
- **Metadata last modified (upstream):** 2025-08-07T14:21:52
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 12072 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3644/Enrolled>.

## Summary

**Catchline:** Requires the Housing and Community Services Department to establish a statewide shelter program through which regional coordinators are selected to administer funding to shelter providers.
...
**RelatingToFull (verbatim upstream field):** Relating to a statewide shelter program; and declaring an emergency.
...
Enrolled House Bill 3644 (HB 3644-B) Page 1
(f) “Shelter” means a facility designed to provide temporary living arrangements on  an
...
Act is implemented.
Enrolled House Bill 3644 (HB 3644-B) Page 2
(2) The  department, after consultation with local planning partners, shall establish and
...
Enrolled House Bill 3644 (HB 3644-B) Page 3
(B) “Recovery-based shelter” means shelter that provides optional recovery systems  that
...
Enrolled House Bill 3644 (HB 3644-B) Page 4
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `c1391205da65e5100d0b32876155569017380dd07d3337eadd062c158d999f8c` (snapshot `_meta/snapshots/measure-2025r1-hb3644-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3644/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `57e8d07c36b727e9ef1648b1e5cffb420646c335cb93ed27ef1bf3c3131c5724` (snapshot `_meta/snapshots/measure-2025r1-hb3644-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3644/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3644> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-scr8
title: 'SCR 8 (2025R1): Recognizes and honors Private William Ezra Leon "Billy" Calkins (1925-1942) for
  his service to his country.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Concurrent Resolution 8
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR8/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: aeec39a2b67b279f5407110334940d5ac06fcbfb21c6283fa178c6ca394f39dc
snapshot_id: measure-2025r1-scr8-enrolled
status: current
...
catch_line: Recognizes and honors Private William Ezra Leon "Billy" Calkins (1925-1942) for his service
  to his country.
minority_catch_line: null
measure_summary: "\tDigest: Honors the life and service of Private Billy Calkins. (Flesch Readability\
  \ Score: 66.1). \n\tRecognizes and honors Private William Ezra Leon \"Billy\" Calkins (1925-1942) for\
  \ his service to his country."
relating_to: Recognizing and honoring Private William Ezra Leon "Billy" Calkins for his service to his
  country.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SCR' and MeasureNumber eq 8>.

# SCR 8 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Concurrent Resolution 8, 2025 Regular Session (2025R1)
- **LC number:** 3649
...
- **Full text below:** Enrolled version, 3652 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR8/Enrolled>.

## Summary

**Catchline:** Recognizes and honors Private William Ezra Leon "Billy" Calkins (1925-1942) for his service to his country.

**Relating to:** Recognizing and honoring Private William Ezra Leon "Billy" Calkins for his service to his country.

Digest: Honors the life and service of Private Billy Calkins. (Flesch Readability Score: 66.1). 
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `aeec39a2b67b279f5407110334940d5ac06fcbfb21c6283fa178c6ca394f39dc` (snapshot `_meta/snapshots/measure-2025r1-scr8-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR8/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `89e7f1789557aefeeea7e18a03dc7d4ca5e951605d1abee66d6a2afeb7ee6bf9` (snapshot `_meta/snapshots/measure-2025r1-scr8-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR8/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SCR' and MeasureNumber eq 8> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

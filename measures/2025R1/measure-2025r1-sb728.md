...
jurisdiction: oregon
id: measure-2025r1-sb728
title: 'SB 728 (2025R1): Modifies the definition of "vulnerable person" for purposes of civil action for
  abuse of a vulnerable person to include individuals under 18 years of age.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 728
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB728/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ce378be7e1cead1bee07931d15b10a6df6cdba0810a847ab46dd1c8f045e3b40
snapshot_id: measure-2025r1-sb728-introduced
status: current
...
catch_line: Modifies the definition of "vulnerable person" for purposes of civil action for abuse of a
  vulnerable person to include individuals under 18 years of age.
minority_catch_line: null
measure_summary: "\tDigest: The Act expands who can bring a civil action for abuse of a vulnerable person.\
  \ (Flesch Readability Score: 61.8). \n\tModifies the definition of \"vulnerable person\" for purposes\
  \ of civil action for abuse of a vulnerable person to include individuals under 18 years of age. \n\t\
  Applies a statute of limitations for actions based on conduct constituting child abuse to civil actions\
  \ for abuse of vulnerable persons who are under 18 years of age."
relating_to: Relating to abuse of vulnerable persons.
relating_to_full: Relating to abuse of vulnerable persons; creating new provisions; and amending ORS 124.100
  and 124.130.
at_the_request_of: null
lc_number: 159
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T14:39:46'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 5598
...
# SB 728 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 728, 2025 Regular Session (2025R1)
- **LC number:** 159
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T14:39:46
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5598 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB728/Introduced>.

## Summary

**Catchline:** Modifies the definition of "vulnerable person" for purposes of civil action for abuse of a vulnerable person to include individuals under 18 years of age.
...
**RelatingToFull (verbatim upstream field):** Relating to abuse of vulnerable persons; creating new provisions; and amending ORS 124.100 and 124.130.
...
- From `RelatingToFull`: ORS 124.100, ORS 124.130
- From bill text (Introduced version): ORS 12.117, ORS 12.160, ORS 124.100, ORS 124.105, ORS 124.110, ORS 124.130, ORS 125.005, ORS 31.705

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `ce378be7e1cead1bee07931d15b10a6df6cdba0810a847ab46dd1c8f045e3b40` (snapshot `_meta/snapshots/measure-2025r1-sb728-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB728/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 728` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

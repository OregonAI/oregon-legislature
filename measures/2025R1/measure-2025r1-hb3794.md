...
jurisdiction: oregon
id: measure-2025r1-hb3794
title: 'HB 3794 (2025R1): Establishes the Task Force on Municipal Solid Waste in the Willamette Valley.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3794
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3794/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 8ea27cbe75d42d26575d0ea10421d0a0c3f9c6a97798585f3cfd113589680dea
snapshot_id: measure-2025r1-hb3794-enrolled
status: current
...
catch_line: Establishes the Task Force on Municipal Solid Waste in the Willamette Valley.
minority_catch_line: null
measure_summary: "\tDigest: This Act creates the Task Force on Municipal Solid Waste in the Willamette\
  \ Valley. (Flesch Readability Score: 65.7). \n\tEstablishes the Task Force on Municipal Solid Waste\
  \ in the Willamette Valley. Directs the task force to submit a report to the interim committees of the\
  \ Legislative Assembly related to the environment no later than December 15, 2026. \n\tSunsets the task\
  \ force on December 31, 2026. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to municipal solid waste; and prescribing an effective date.
relating_to_full: Relating to municipal solid waste; and prescribing an effective date.
at_the_request_of: null
lc_number: 4274
measure_created_date: '2025-02-25T13:59:36'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3794>.

# HB 3794 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3794, 2025 Regular Session (2025R1)
- **LC number:** 4274
- **Created:** 2025-02-25T13:59:36
- **Metadata last modified (upstream):** 2025-08-13T12:44:25
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 5456 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3794/Enrolled>.

## Summary

**Catchline:** Establishes the Task Force on Municipal Solid Waste in the Willamette Valley.
...
**RelatingToFull (verbatim upstream field):** Relating to municipal solid waste; and prescribing an effective date.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `8ea27cbe75d42d26575d0ea10421d0a0c3f9c6a97798585f3cfd113589680dea` (snapshot `_meta/snapshots/measure-2025r1-hb3794-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3794/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `6cf19f0d84378e15f2fb6e3e27403a3436ddfaf33fa7bd0bcb85a415e91b0c7e` (snapshot `_meta/snapshots/measure-2025r1-hb3794-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3794/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3794> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2487
title: 'HB 2487 (2025R1): Requires the Oregon Health Authority to study civil commitment criteria.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2487
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2487/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 9a01142b91ee53fb3c84dd0b917f1315fe4a7493b759bbe01db88a66fe440f1c
snapshot_id: measure-2025r1-hb2487-introduced
status: current
...
measure_modified_date: '2025-01-17T13:04:51'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2487`.

# HB 2487 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2487, 2025 Regular Session (2025R1)
...
- **Metadata last modified (upstream):** 2025-01-17T13:04:51
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 1676 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2487/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `9a01142b91ee53fb3c84dd0b917f1315fe4a7493b759bbe01db88a66fe440f1c` (snapshot `_meta/snapshots/measure-2025r1-hb2487-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2487/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2487` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

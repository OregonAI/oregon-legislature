...
jurisdiction: oregon
id: measure-2025r1-hb2519
title: 'HB 2519 (2025R1): Establishes the Oregon Public Utility Homeland Security Commission in the Oregon
  Department of Emergency Management.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2519
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2519/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 26d858336acc099c27efda35deefb27e9063a24b68c79ddab9ad1baf481989e3
snapshot_id: measure-2025r1-hb2519-introduced
status: current
...
catch_line: Establishes the Oregon Public Utility Homeland Security Commission in the Oregon Department
  of Emergency Management.
minority_catch_line: null
measure_summary: "\tDigest: Tells ODEM to give grants to consumer-owned utilities to build projects in\
  \ response to natural disasters. Creates a commission and fund for the grant program. Allows for the\
  \ use of moneys from lottery bonds. (Flesch Readability Score: 60.9). \n\tEstablishes the Oregon Public\
  \ Utility Homeland Security Commission in the Oregon Department of Emergency Management. \n\tEstablishes\
  \ the Oregon Public Utility Homeland Security Fund. \n\tEstablishes a grant program for the purpose\
  \ of providing financial assistance to consumer-owned utilities for developing projects associated with\
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2519`.

# HB 2519 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2519, 2025 Regular Session (2025R1)
- **LC number:** 1345
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:01:05
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7561 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2519/Introduced>.

## Summary

**Catchline:** Establishes the Oregon Public Utility Homeland Security Commission in the Oregon Department of Emergency Management.

**Relating to:** Relating to utilities.

Digest: Tells ODEM to give grants to consumer-owned utilities to build projects in response to natural disasters. Creates a commission and fund for the grant program. Allows for the use of moneys from lottery bonds. (Flesch Readability Score: 60.9). 
 Establishes the Oregon Public Utility Homeland Security Commission in the Oregon Department of Emergency Management. 
 Establishes the Oregon Public Utility Homeland Security Fund. 
 Establishes a grant program for the purpose of providing financial assistance to consumer-owned utilities for developing projects associated with mitigating damage resulting from natural disasters or responding to or recovering from natural disasters. 
 Authorizes the issuance of lottery bonds to finance projects associated with mitigating damage resulting from natural disasters or responding to or recovering from natural disasters.
...
LC 1345
damage resulting from the occurrence  of a natural disaster or responding to or recovering
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `26d858336acc099c27efda35deefb27e9063a24b68c79ddab9ad1baf481989e3` (snapshot `_meta/snapshots/measure-2025r1-hb2519-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2519/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2519` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb599
title: 'SB 599 (2025R1): Prohibits landlords from inquiring about or discriminating on the basis of a
  tenant''s or applicant''s immigration or citizenship status, rejecting an applicant based on the type
  of identifying documentation or disclosing or threatening disclosure of an applicant''s or a tenant''s
  immigration or citizenship status for improper purposes.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 599
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB599/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0596fd2f5a19ca192bcd251f33b3a63807ea55e0b1d36572657b4f8dd25b3239
snapshot_id: measure-2025r1-sb599-enrolled
status: current
...
catch_line: Prohibits landlords from inquiring about or discriminating on the basis of a tenant's or applicant's
  immigration or citizenship status, rejecting an applicant based on the type of identifying documentation
  or disclosing or threatening disclosure of an applicant's or a tenant's immigration or citizenship status
  for improper purposes.
minority_catch_line: null
measure_summary: "\t<b>Digest: This Act bans a landlord from biases in renting a home based on immigration\
  \ status. (Flesch Readability Score: 61.8).</b> \n\t[<i>Digest: This Act bans biases in the rent or\
  \ sale of property based on immigration status. (Flesch Readability Score: 61.8).</i>] \n\tProhibits\
  \ landlords from inquiring about or [<i>disclosing</i>]<b> discriminating on the basis of a tenant's\
  \ or applicant's</b> immigration <b>or citizenship</b> status<b>,</b> [<i>or</i>] rejecting an applicant\
  \ [<i>due to immigration status. Prohibits discrimination based on immigration status for real property\
  \ transactions.</i>] <b>based on the type of identifying documentation or disclosing or threatening\
  \ disclosure of an applicant's or a tenant's immigration or citizenship status for improper purposes.\
  \ Authorizes statutory penalties. \n\tBecomes operative 30 days after the effective date. \n\tDeclares\
  \ an emergency, effective on passage.</b>"
relating_to: Relating to immigration status discrimination in real estate transactions; and declaring
  an emergency.
relating_to_full: Relating to immigration status discrimination in real estate transactions; and declaring
  an emergency.
at_the_request_of: null
lc_number: 2332
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2026-02-25T12:26:30'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 599>.

# SB 599 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 599, 2025 Regular Session (2025R1)
- **LC number:** 2332
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-02-25T12:26:30
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 8728 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB599/Enrolled>.

## Summary

**Catchline:** Prohibits landlords from inquiring about or discriminating on the basis of a tenant's or applicant's immigration or citizenship status, rejecting an applicant based on the type of identifying documentation or disclosing or threatening disclosure of an applicant's or a tenant's immigration or citizenship status for improper purposes.
...
**RelatingToFull (verbatim upstream field):** Relating to immigration status discrimination in real estate transactions; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 105.100, ORS 659A.885, ORS 90.303, ORS 90.390

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `0596fd2f5a19ca192bcd251f33b3a63807ea55e0b1d36572657b4f8dd25b3239` (snapshot `_meta/snapshots/measure-2025r1-sb599-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB599/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `7cddd9c9a02b929d443f869554bae7834e975abe679555f84b610048d25fcf45` (snapshot `_meta/snapshots/measure-2025r1-sb599-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB599/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 599> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3151
title: 'HB 3151 (2025R1): Removes the cap on the amounts distributed from the State School Fund to school
  districts for students who are eligible for special education as children with disabilities.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3151
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3151/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c7ee88c20a4662f510783be320effe2eea2937fc35aa2c397130798bc11c28bb
snapshot_id: measure-2025r1-hb3151-introduced
status: current
...
catch_line: Removes the cap on the amounts distributed from the State School Fund to school districts
  for students who are eligible for special education as children with disabilities.
minority_catch_line: null
measure_summary: "\tDigest: Makes changes to the formula used for deciding how much state money each school\
  \ district receives. (Flesch Readability Score: 63.6). \n\tRemoves the cap on the amounts distributed\
  \ from the State School Fund to school districts for students who are eligible for special education\
  \ as children with disabilities. \n\tAllows for an additional weight for students who are homeless for\
  \ purposes of calculating distributions of State School Fund moneys to school districts. \n\tDeclares\
...
# HB 3151 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3151, 2025 Regular Session (2025R1)
- **LC number:** 931
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-28T14:37:23
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7170 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3151/Introduced>.

## Summary

**Catchline:** Removes the cap on the amounts distributed from the State School Fund to school districts for students who are eligible for special education as children with disabilities.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `c7ee88c20a4662f510783be320effe2eea2937fc35aa2c397130798bc11c28bb` (snapshot `_meta/snapshots/measure-2025r1-hb3151-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3151/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3151` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

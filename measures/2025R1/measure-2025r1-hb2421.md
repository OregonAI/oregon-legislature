...
jurisdiction: oregon
id: measure-2025r1-hb2421
title: 'HB 2421 (2025R1): Includes certain private post-secondary institutions in the direct admissions
  program established by the Higher Education Coordinating Commission.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2421
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2421/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b92b33256cdb7152ae6e39f1d441f6b64e37ef7938c502837f53bf7a554621b3
snapshot_id: measure-2025r1-hb2421-enrolled
status: current
...
catch_line: Includes certain private post-secondary institutions in the direct admissions program established
  by the Higher Education Coordinating Commission.
minority_catch_line: null
measure_summary: "\tDigest: The Act adds private higher learning schools to the direct admissions program\
  \ created by HECC. (Flesch Readability Score: 61.8). \n\tIncludes [<i>independent institutions</i>]\
  \ <b>certain private post-secondary institutions</b> in the direct admissions program established by\
  \ the Higher Education Coordinating Commission."
relating_to: Relating to direct admissions.
relating_to_full: Relating to direct admissions.
at_the_request_of: (at the request of House Interim Committee on Higher Education for former Senator Michael
  Dembrow for Oregon Alliance of Independent Colleges and Universities)
lc_number: 792
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2421`.

# HB 2421 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2421, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of House Interim Committee on Higher Education for former Senator Michael Dembrow for Oregon Alliance of Independent Colleges and Universities)
- **LC number:** 792
...
- **Full text below:** Enrolled version, 14606 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2421/Enrolled>.

## Summary

**Catchline:** Includes certain private post-secondary institutions in the direct admissions program established by the Higher Education Coordinating Commission.
...
**RelatingToFull (verbatim upstream field):** Relating to direct admissions.
...
- From bill text (Enrolled version): ORS 192.311, ORS 341.009, ORS 345.010, ORS 348.594, ORS 348.597, ORS 350.001, ORS 350.005, ORS 350.009, ORS 350.014, ORS 350.075, ORS 350.095, ORS 352.002

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `b92b33256cdb7152ae6e39f1d441f6b64e37ef7938c502837f53bf7a554621b3` (snapshot `_meta/snapshots/measure-2025r1-hb2421-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2421/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `0ce61db8956a828c08cccebf0dde54edd5b6cb9c3076d760b9a7c4c2d32e78c1` (snapshot `_meta/snapshots/measure-2025r1-hb2421-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2421/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2421` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb910
title: 'SB 910 (2025R1): Prescribes requirements for sharing information, training and guidelines for
  student athletes related to symptoms of a cardiac event.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 910
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB910/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: fcb981bfcf6ea7b9076144539a5696da5bf4671e8684fb3468df0e169d6bf66c
snapshot_id: measure-2025r1-sb910-introduced
status: current
...
catch_line: Prescribes requirements for sharing information, training and guidelines for student athletes
  related to symptoms of a cardiac event.
minority_catch_line: null
measure_summary: "\tDigest: Makes students and school coaches learn about and respond to cardiac events.\
  \ (Flesch Readability Score: 60.7). \n\tPrescribes requirements for sharing information, training and\
  \ guidelines for student athletes related to symptoms of a cardiac event."
relating_to: Relating to cardiac events of student athletes.
relating_to_full: Relating to cardiac events of student athletes.
at_the_request_of: null
lc_number: 1463
measure_created_date: '2025-01-15T12:22:48'
measure_modified_date: '2025-01-21T15:41:15'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 4966
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 910`.

# SB 910 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 910, 2025 Regular Session (2025R1)
- **LC number:** 1463
- **Created:** 2025-01-15T12:22:48
- **Metadata last modified (upstream):** 2025-01-21T15:41:15
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4966 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB910/Introduced>.

## Summary

**Catchline:** Prescribes requirements for sharing information, training and guidelines for student athletes related to symptoms of a cardiac event.
...
**RelatingToFull (verbatim upstream field):** Relating to cardiac events of student athletes.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `fcb981bfcf6ea7b9076144539a5696da5bf4671e8684fb3468df0e169d6bf66c` (snapshot `_meta/snapshots/measure-2025r1-sb910-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB910/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 910` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

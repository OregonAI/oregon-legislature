...
jurisdiction: oregon
id: measure-2025r1-hb3748
title: 'HB 3748 (2025R1): Requires the Oregon Health Authority to establish a program for the purpose
  of providing to credentialing organizations access to information that is necessary to credential or
  recredential health care practitioners.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3748
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3748/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 25ea3a8bfe4bbeeffd7bfd36046a978e4916a5bbd74f6955255654905fb96677
snapshot_id: measure-2025r1-hb3748-introduced
status: current
...
catch_line: Requires the Oregon Health Authority to establish a program for the purpose of providing to
  credentialing organizations access to information that is necessary to credential or recredential health
  care practitioners.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells OHA to create a common credentialing program. (Flesch Readability\
  \ Score: 61.3). \n\tRequires the Oregon Health Authority to establish a program for the purpose of providing\
  \ to credentialing organizations access to information that is necessary to credential or recredential\
  \ health care practitioners. \n\tRequires the establishment of an electronic database for purposes of\
  \ submitting and accessing credentialing information. \n\tSets a January 1, 2028, operative date for\
  \ provisions related to the establishment of a program and an electronic database. \n\tRequires the\
  \ authority to report on the implementation of the electronic database and the adoption of rules related\
  \ to the program on or before specified dates. \n\tAppropriates moneys from the General Fund to the\
  \ authority to establish the program and the electronic database."
relating_to: Relating to credentialing of health care practitioners.
relating_to_full: Relating to credentialing of health care practitioners.
at_the_request_of: null
lc_number: 4484
measure_created_date: '2025-02-24T18:46:12'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3748>.

# HB 3748 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3748, 2025 Regular Session (2025R1)
- **LC number:** 4484
- **Created:** 2025-02-24T18:46:12
- **Metadata last modified (upstream):** 2025-03-05T10:25:50
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 10887 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3748/Introduced>.

## Summary

**Catchline:** Requires the Oregon Health Authority to establish a program for the purpose of providing to credentialing organizations access to information that is necessary to credential or recredential health care practitioners.
...
**RelatingToFull (verbatim upstream field):** Relating to credentialing of health care practitioners.
...
LC 4484
electronic database and accessed. The system must operate and be  accessible by credential-
...
vided under this subsection for the purposes established by the authority  under section 3
...
- From bill text (Introduced version): ORS 171.010, ORS 192.245, ORS 192.311, ORS 414.025

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `25ea3a8bfe4bbeeffd7bfd36046a978e4916a5bbd74f6955255654905fb96677` (snapshot `_meta/snapshots/measure-2025r1-hb3748-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3748/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3748> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

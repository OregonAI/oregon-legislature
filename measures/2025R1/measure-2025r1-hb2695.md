...
jurisdiction: oregon
id: measure-2025r1-hb2695
title: 'HB 2695 (2025R1): Requires the Oregon Health and Science University Board of Directors to include
  specified individuals in the search and hiring committees for a president of the university.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2695
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2695/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4a41fd77d08653ca2ea49b40aa7d6d32c5c22491b60a4c82d55534bcdd7f26a7
snapshot_id: measure-2025r1-hb2695-enrolled
status: current
...
catch_line: Requires the Oregon Health and Science University Board of Directors to include specified
  individuals in the search and hiring committees for a president of the university.
minority_catch_line: null
measure_summary: "\tDigest: The Act directs the OHSU board to include certain people in the process to\
  \ hire a president. The Act directs the board to let campus union representatives talk to the board.\
  \ (Flesch Readability Score: 62.8). \n\tRequires the Oregon Health and Science University Board of Directors\
  \ to include specified individuals in the search and hiring committees for a president of the university.\
  \ Requires the board to allow a representative from campus labor organizations to communicate with the\
  \ board upon the representative's request."
relating_to: Relating to duties of the Oregon Health and Science University Board of Directors.
relating_to_full: Relating to duties of the Oregon Health and Science University Board of Directors.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2695`.

# HB 2695 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2695, 2025 Regular Session (2025R1)
- **LC number:** 1279
...
- **Full text below:** Enrolled version, 10685 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2695/Enrolled>.

## Summary

**Catchline:** Requires the Oregon Health and Science University Board of Directors to include specified individuals in the search and hiring committees for a president of the university.
...
**RelatingToFull (verbatim upstream field):** Relating to duties of the Oregon Health and Science University Board of Directors.
...
Enrolled House Bill 2695 (HB 2695-INTRO) Page 1
...
Enrolled House Bill 2695 (HB 2695-INTRO) Page 2
...
Enrolled House Bill 2695 (HB 2695-INTRO) Page 3
...
Enrolled House Bill 2695 (HB 2695-INTRO) Page 4
...
- From bill text (Enrolled version): ORS 352.002, ORS 352.118, ORS 353.050, ORS 353.060

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `4a41fd77d08653ca2ea49b40aa7d6d32c5c22491b60a4c82d55534bcdd7f26a7` (snapshot `_meta/snapshots/measure-2025r1-hb2695-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2695/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `99af44d40f43a50f3725137bfa61395fffd2bdc517a6ecc170ca9154402e0f9d` (snapshot `_meta/snapshots/measure-2025r1-hb2695-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2695/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2695` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2852
title: 'HB 2852 (2025R1): Directs contracting agencies to give preference to a bidder or proposer who
  is certified by the Oregon Department of Emergency Management as an emergency preparedness partner.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2852
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2852/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 3e1c8e027c7ddde11b224673bb49c1ed018612e9b975d3148add2c72a3cedab1
snapshot_id: measure-2025r1-hb2852-introduced
status: current
...
catch_line: Directs contracting agencies to give preference to a bidder or proposer who is certified by
  the Oregon Department of Emergency Management as an emergency preparedness partner.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells state agencies to try to contract with bidders who agree to\
  \ help with emergency readiness. The Act tells ODEM to start a program to certify such bidders. (Flesch\
  \ Readability Score: 64.7). \n\tDirects contracting agencies to give preference to a bidder or proposer\
  \ who is certified by the Oregon Department of Emergency Management as an emergency preparedness partner.\
  \ \n\tDirects the department to establish a program for certification of business organizations as emergency\
  \ preparedness partners. Provides that organizations shall be certified if a minimum number of individuals\
  \ in the organization complete the required training and meet other requirements."
relating_to: Relating to emergency preparedness public contracting preferences.
relating_to_full: Relating to emergency preparedness public contracting preferences.
at_the_request_of: null
lc_number: 1098
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-31T12:42:09'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2852`.

# HB 2852 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2852, 2025 Regular Session (2025R1)
- **LC number:** 1098
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-31T12:42:09
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 3595 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2852/Introduced>.

## Summary

**Catchline:** Directs contracting agencies to give preference to a bidder or proposer who is certified by the Oregon Department of Emergency Management as an emergency preparedness partner.
...
**RelatingToFull (verbatim upstream field):** Relating to emergency preparedness public contracting preferences.
...
- From bill text (Introduced version): ORS 401.358

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `3e1c8e027c7ddde11b224673bb49c1ed018612e9b975d3148add2c72a3cedab1` (snapshot `_meta/snapshots/measure-2025r1-hb2852-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2852/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2852` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

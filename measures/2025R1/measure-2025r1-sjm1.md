...
jurisdiction: oregon
id: measure-2025r1-sjm1
title: 'SJM 1 (2025R1): Urges Congress to conduct public hearings on anti-military bias and improve enforcement
  of hate-crime protections for military families.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Joint Memorial 1
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJM1/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 19d2c79c25955d08e6449eba7b4b4227222064a681c344ce2ab45bd0cec8c078
snapshot_id: measure-2025r1-sjm1-introduced
status: current
...
catch_line: Urges Congress to conduct public hearings on anti-military bias and improve enforcement of
  hate-crime protections for military families.
minority_catch_line: null
measure_summary: "\tDigest: Urges Congress to protect rights of armed forces and their families. (Flesch\
  \ Readability Score: 72.6). \n\tUrges Congress to conduct public hearings on anti-military bias and\
  \ improve enforcement of hate-crime protections for military families."
relating_to: Urging Congress to conduct public hearings on anti-military bias and improve enforcement
  of hate-crime protections for military families.
...
measure_modified_date: '2025-02-06T09:56:06'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 4350
...
# SJM 1 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Joint Memorial 1, 2025 Regular Session (2025R1)
...
- **Metadata last modified (upstream):** 2025-02-06T09:56:06
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4350 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJM1/Introduced>.

## Summary

**Catchline:** Urges Congress to conduct public hearings on anti-military bias and improve enforcement of hate-crime protections for military families.
...
LC 2984
Whereas Senator Ron Wyden of Oregon sent a Congressional  inquiry to United States Attorney
...
- From bill text (Introduced version): ORS 659A.003

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `19d2c79c25955d08e6449eba7b4b4227222064a681c344ce2ab45bd0cec8c078` (snapshot `_meta/snapshots/measure-2025r1-sjm1-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJM1/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SJM' and MeasureNumber eq 1` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

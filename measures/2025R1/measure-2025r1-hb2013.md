...
jurisdiction: oregon
id: measure-2025r1-hb2013
title: 'HB 2013 (2025R1): Includes outpatient facilities with a certified substance use disorder program
  that employ certified alcohol and drug counselors as providers for the purposes of mental health treatment
  insurance coverage.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2013
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2013/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 52d5781c5c6d2330707697cab5cffdb671b093993a9201aa402269e84dacc21d
snapshot_id: measure-2025r1-hb2013-enrolled
status: current
...
catch_line: Includes outpatient facilities with a certified substance use disorder program that employ
  certified alcohol and drug counselors as providers for the purposes of mental health treatment insurance
  coverage.
minority_catch_line: Includes outpatient facilities with a certified substance use disorder program that
  employ certified alcohol and drug counselors as providers for the purposes of mental health treatment
  insurance coverage.
measure_summary: "\t<b>Digest: Includes certain places that employ CADCs as providers for mental health\
  \ treatment. (Flesch Readability Score: 60.7).</b> \n\t[<i>Digest: Includes places that employ CADCs\
  \ as providers for mental health treatment. (Flesch Readability Score: 64.9).</i>] \n\tIncludes outpatient\
  \ facilities <b>with a</b> <b>certified substance use disorder program</b> that employ certified alcohol\
  \ and drug counselors as providers for the purposes of mental health treatment insurance coverage."
relating_to: Relating to mental health treatment providers.
relating_to_full: Relating to mental health treatment providers.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2013`.

# HB 2013 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2013, 2025 Regular Session (2025R1)
- **LC number:** 712
...
- **Full text below:** Enrolled version, 23726 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2013/Enrolled>.

## Summary

**Catchline:** Includes outpatient facilities with a certified substance use disorder program that employ certified alcohol and drug counselors as providers for the purposes of mental health treatment insurance coverage.

**Relating to:** Relating to mental health treatment providers.

<b>Digest: Includes certain places that employ CADCs as providers for mental health treatment. (Flesch Readability Score: 60.7).</b> 
 [<i>Digest: Includes places that employ CADCs as providers for mental health treatment. (Flesch Readability Score: 64.9).</i>] 
 Includes outpatient facilities <b>with a</b> <b>certified substance use disorder program</b> that employ certified alcohol and drug counselors as providers for the purposes of mental health treatment insurance coverage.

**RelatingToFull (verbatim upstream field):** Relating to mental health treatment providers.
...
- From bill text (Enrolled version): ORS 40.230, ORS 40.235, ORS 40.240, ORS 40.250, ORS 40.262, ORS 413.101, ORS 430.010, ORS 433.060, ORS 675.580, ORS 677.100, ORS 743A.168, ORS 743B.001, ORS 743B.005, ORS 743B.460, ORS 743B.505

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `52d5781c5c6d2330707697cab5cffdb671b093993a9201aa402269e84dacc21d` (snapshot `_meta/snapshots/measure-2025r1-hb2013-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2013/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `052782ef851ca3384f83600593ba7fd3b7538d727e8f3134e08acebf04800a6a` (snapshot `_meta/snapshots/measure-2025r1-hb2013-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2013/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2013` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

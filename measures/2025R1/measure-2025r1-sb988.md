...
jurisdiction: oregon
id: measure-2025r1-sb988
title: 'SB 988 (2025R1): Permits a child''s parent or guardian to admit the child, with or without the
...
citation: 2025 Regular Session Senate Bill 988
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB988/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 48dc173842790dc909ea666777a2d9230c245db1872c8d58387df2cee653e0c8
snapshot_id: measure-2025r1-sb988-introduced
status: current
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 988>.

# SB 988 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 988, 2025 Regular Session (2025R1)
- **LC number:** 1015
- **Created:** 2025-02-04T11:42:32
- **Metadata last modified (upstream):** 2025-02-11T09:12:01
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 8383 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB988/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `48dc173842790dc909ea666777a2d9230c245db1872c8d58387df2cee653e0c8` (snapshot `_meta/snapshots/measure-2025r1-sb988-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB988/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 988> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

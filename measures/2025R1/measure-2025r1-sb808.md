...
jurisdiction: oregon
id: measure-2025r1-sb808
title: 'SB 808 (2025R1): Provides hiring and promotion preferences in public employment to members and
  former members of the Oregon National Guard.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 808
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB808/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 34215197abc4e43faef2331d168857fe63c51e36473e24289ea4177c1150fa24
snapshot_id: measure-2025r1-sb808-enrolled
status: current
...
catch_line: Provides hiring and promotion preferences in public employment to members and former members
  of the Oregon National Guard.
minority_catch_line: null
measure_summary: "\tDigest: Gives job preferences in civil service jobs to current and former members\
  \ of the state national guard. (Flesch Readability Score: 60.1). \n\tProvides hiring and promotion preferences\
  \ in public employment to members and former members of the Oregon National Guard."
relating_to: Relating to preference given to servicemembers in public employment.
relating_to_full: Relating to preference given to servicemembers in public employment.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 808`.

# SB 808 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 808, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 11506 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB808/Enrolled>.

## Summary

**Catchline:** Provides hiring and promotion preferences in public employment to members and former members of the Oregon National Guard.
...
**RelatingToFull (verbatim upstream field):** Relating to preference given to servicemembers in public employment.
...
Enrolled Senate Bill 808 (SB 808-INTRO) Page 1
...
Enrolled Senate Bill 808 (SB 808-INTRO) Page 2
of an application examination for an applicant who is not a state servicemember, former state
...
Enrolled Senate Bill 808 (SB 808-INTRO) Page 3
...
Enrolled Senate Bill 808 (SB 808-INTRO) Page 4
...
- From bill text (Enrolled version): ORS 174.109, ORS 408.225, ORS 408.230, ORS 408.235, ORS 659A.820

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `34215197abc4e43faef2331d168857fe63c51e36473e24289ea4177c1150fa24` (snapshot `_meta/snapshots/measure-2025r1-sb808-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB808/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `806919330726d5eefe28840874e490d612fb7bf4daba239aff69d4b6b8a8dfdb` (snapshot `_meta/snapshots/measure-2025r1-sb808-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB808/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 808` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2903
title: 'HB 2903 (2025R1): Grants the Governor authority to declare an economic emergency.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2903
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2903/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 270d7771d5468c34ca4e553b8c7b366076679dedee945a69c536b30b650cbe3a
snapshot_id: measure-2025r1-hb2903-introduced
status: current
...
catch_line: Grants the Governor authority to declare an economic emergency.
minority_catch_line: null
measure_summary: "\tDigest: The Act says when the Governor may declare an economic emergency. The Act\
  \ would allow a state agency to change the employment status of certain jobs to at-will status. The\
  \ Act would require a review and a report of the changes that were made. (Flesch Readability Score:\
  \ 65.0). \n\tGrants the Governor authority to declare an economic emergency. Authorizes state agencies\
  \ to reclassify management service employees to at-will employment status and to adjust staffing levels\
  \ of management service employees. \n\tRequires a state agency that reclassified management service\
  \ employees to at-will employment status to review personnel adjustments made during the economic emergency\
  \ to determine the value of those adjustments and to report findings to the Governor and the Legislative\
  \ Assembly."
relating_to: Relating to adjustment of classification of management service employees during an economic
  emergency.
relating_to_full: Relating to adjustment of classification of management service employees during an economic
  emergency.
at_the_request_of: null
lc_number: 1710
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-27T10:40:34'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 3746
...
# HB 2903 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2903, 2025 Regular Session (2025R1)
- **LC number:** 1710
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:40:34
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 3746 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2903/Introduced>.

## Summary

**Catchline:** Grants the Governor authority to declare an economic emergency.
...
**RelatingToFull (verbatim upstream field):** Relating to adjustment of classification of management service employees during an economic emergency.
...
LC 1710
adjusted positions without regard to  the specific personnel that have been reclassified,
...
- From bill text (Introduced version): ORS 192.245, ORS 240.570, ORS 401.165

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `270d7771d5468c34ca4e553b8c7b366076679dedee945a69c536b30b650cbe3a` (snapshot `_meta/snapshots/measure-2025r1-hb2903-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2903/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2903` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3936
title: 'HB 3936 (2025R1): Prohibits any hardware, software or service that uses artificial intelligence
  from being installed or downloaded onto or used or accessed by state information technology assets if
  the artificial intelligence is developed or owned by a covered vendor.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3936
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3936/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: d6145ddf8d6329c95bbce4cf82a831dd64e425c577b026d8c0bab36dd8090d08
snapshot_id: measure-2025r1-hb3936-enrolled
status: current
...
catch_line: Prohibits any hardware, software or service that uses artificial intelligence from being installed
  or downloaded onto or used or accessed by state information technology assets if the artificial intelligence
  is developed or owned by a covered vendor.
minority_catch_line: null
measure_summary: "\t<b>Digest: Bans the use of AI on state assets if the AI is developed or owned by a\
  \ covered vendor. (Flesch Readability Score: 80.6).</b> \n\t[<i>Digest: Bans the use of AI on state\
  \ assets if the AI is owned or developed by a foreign corporate entity. (Flesch Readability Score: 68.0).</i>]\
  \ \n\tProhibits any hardware, software or service that uses artificial intelligence from being installed\
  \ or downloaded onto or used or accessed by state information technology assets if the artificial intelligence\
  \ is developed or owned by a [<i>corporate entity that is incorporated or registered under the laws\
  \ of a foreign country</i>]<b> covered vendor</b>. Provides for exceptions."
relating_to: Relating to the security of state assets.
relating_to_full: Relating to the security of state assets.
at_the_request_of: null
lc_number: 4745
measure_created_date: '2025-03-16T10:31:11'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3936`.

# HB 3936 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3936, 2025 Regular Session (2025R1)
- **LC number:** 4745
- **Created:** 2025-03-16T10:31:11
- **Metadata last modified (upstream):** 2025-07-25T10:52:12
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 10942 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3936/Enrolled>.

## Summary

**Catchline:** Prohibits any hardware, software or service that uses artificial intelligence from being installed or downloaded onto or used or accessed by state information technology assets if the artificial intelligence is developed or owned by a covered vendor.
...
**RelatingToFull (verbatim upstream field):** Relating to the security of state assets.
...
- From bill text (Enrolled version): ORS 174.111, ORS 276A.340, ORS 276A.342, ORS 276A.344, ORS 276A.346, ORS 276A.348

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `d6145ddf8d6329c95bbce4cf82a831dd64e425c577b026d8c0bab36dd8090d08` (snapshot `_meta/snapshots/measure-2025r1-hb3936-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3936/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `7cc99a889b90af5db4648d224dd1400fde2ed91a6f2768014704ce89f124e77d` (snapshot `_meta/snapshots/measure-2025r1-hb3936-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3936/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3936` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

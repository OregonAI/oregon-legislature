...
jurisdiction: oregon
id: measure-2025r1-sb863
title: 'SB 863 (2025R1): Authorizes the State Fire Marshal to seek cost recovery for the actual cost of
  fire abatement.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 863
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB863/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ed3e0cdedfb2665e5e5ba69cb93d9dce603910a31c9536c401318152a0220623
snapshot_id: measure-2025r1-sb863-enrolled
status: current
...
catch_line: Authorizes the State Fire Marshal to seek cost recovery for the actual cost of fire abatement.
minority_catch_line: null
measure_summary: "\tDigest: The Act allows the State Fire Marshal to recover costs from persons who start\
  \ fires. The Act allows certain actions related to cost recovery. (Flesch Readability Score: 64.2).\
  \ \n\tAuthorizes the State Fire Marshal to seek cost recovery for the actual cost of fire abatement.\
  \ \n\tAuthorizes the Attorney General to take certain actions to investigate liability for the actual\
  \ cost of fire abatement, upon request by the State Fire Marshal. \n\tAuthorizes deputy state fire marshals\
  \ to take certain actions to preserve evidence and investigate liability for the actual cost of fire\
  \ abatement."
relating_to: Relating to cost recovery for fire protection.
relating_to_full: Relating to cost recovery for fire protection.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 863`.

# SB 863 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 863, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 6792 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB863/Enrolled>.

## Summary

**Catchline:** Authorizes the State Fire Marshal to seek cost recovery for the actual cost of fire abatement.

**Relating to:** Relating to cost recovery for fire protection.

Digest: The Act allows the State Fire Marshal to recover costs from persons who start fires. The Act allows certain actions related to cost recovery. (Flesch Readability Score: 64.2). 
 Authorizes the State Fire Marshal to seek cost recovery for the actual cost of fire abatement. 
 Authorizes the Attorney General to take certain actions to investigate liability for the actual cost of fire abatement, upon request by the State Fire Marshal. 
 Authorizes deputy state fire marshals to take certain actions to preserve evidence and investigate liability for the actual cost of fire abatement.

**RelatingToFull (verbatim upstream field):** Relating to cost recovery for fire protection.
...
- From bill text (Enrolled version): ORS 33.055, ORS 44.415, ORS 476.510

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `ed3e0cdedfb2665e5e5ba69cb93d9dce603910a31c9536c401318152a0220623` (snapshot `_meta/snapshots/measure-2025r1-sb863-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB863/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `1f7c52ff59510a0a270bfddfa4c9856abc6ed14701548f042a0e9ee824520230` (snapshot `_meta/snapshots/measure-2025r1-sb863-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB863/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 863` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

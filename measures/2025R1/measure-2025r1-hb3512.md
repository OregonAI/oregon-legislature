...
jurisdiction: oregon
id: measure-2025r1-hb3512
title: 'HB 3512 (2025R1): Prohibits the distribution or sale of certain covered products that contain
  intentionally added perfluoroalkyl or polyfluoroalkyl substances.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3512
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3512/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 1ad8f8edc10fc01bcfb8ae7dcc61633d364b4547c5afea5bbd786cf2d0b9c156
snapshot_id: measure-2025r1-hb3512-introduced
status: current
...
catch_line: Prohibits the distribution or sale of certain covered products that contain intentionally
  added perfluoroalkyl or polyfluoroalkyl substances.
minority_catch_line: null
measure_summary: "\tDigest: This Act prohibits the sale of certain products that contain PFAS. (Flesch\
  \ Readability Score: 72.6). \n\tProhibits the distribution or sale of certain covered products that\
  \ contain intentionally added perfluoroalkyl or polyfluoroalkyl substances. Requires a manufacturer\
  \ of covered products to provide a certificate of compliance to persons that sell or distribute covered\
  \ products in this state. \n\tAuthorizes the Attorney General to investigate and bring an action to\
  \ obtain an injunction or a civil penalty for violations of the Act. \n\tBecomes operative on January\
  \ 1, 2027."
relating_to: Relating to PFAS.
relating_to_full: Relating to PFAS.
at_the_request_of: null
lc_number: 1708
measure_created_date: '2025-02-04T10:10:46'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3512>.

# HB 3512 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3512, 2025 Regular Session (2025R1)
- **LC number:** 1708
- **Created:** 2025-02-04T10:10:46
- **Metadata last modified (upstream):** 2025-02-11T09:09:21
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 17225 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3512/Introduced>.

## Summary

**Catchline:** Prohibits the distribution or sale of certain covered products that contain intentionally added perfluoroalkyl or polyfluoroalkyl substances.
...
and menstrual cups.
(15) “Packaging” means:
(a) A  package or container that provides a means of marketing, protecting or handling
a product; or
...
by ORS 646.622 and may be enforced in the manner provided by ORS 646.626.
...
(b) “Cosmetic” does not include soap.
(7) “Covered  product” means any of the following products, including any of the products’ com-
ponents:
(a) Aqueous film-forming foam;
(b) Artificial turf;
(c) Cleaning products;
...
- From bill text (Introduced version): ORS 192.311, ORS 192.345, ORS 646.622, ORS 646.626

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `1ad8f8edc10fc01bcfb8ae7dcc61633d364b4547c5afea5bbd786cf2d0b9c156` (snapshot `_meta/snapshots/measure-2025r1-hb3512-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3512/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3512> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

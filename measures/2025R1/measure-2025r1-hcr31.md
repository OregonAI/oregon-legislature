...
jurisdiction: oregon
id: measure-2025r1-hcr31
title: 'HCR 31 (2025R1): In memoriam: Lyllye Reynolds-Parker, 1946-2024.'
doc_type: dataset_doc
citation: 2025 Regular Session House Concurrent Resolution 31
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR31/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 7c96666ce16d3d1f181af3abf6fde75f95c1e4d38b763372022bedd0940145a3
snapshot_id: measure-2025r1-hcr31-enrolled
status: current
...
catch_line: 'In memoriam: Lyllye Reynolds-Parker, 1946-2024.'
minority_catch_line: null
measure_summary: "\tDigest: Honors the life and memory of a beloved mentor and civil rights leader. (Flesch\
  \ Readability Score: 63.4). \n\tIn memoriam: Lyllye Reynolds-Parker, 1946-2024."
relating_to: 'In memoriam: Lyllye Reynolds-Parker.'
relating_to_full: null
at_the_request_of: null
lc_number: 4653
measure_created_date: '2025-02-28T10:49:02'
measure_modified_date: '2025-05-15T13:03:07'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 31`.

# HCR 31 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Concurrent Resolution 31, 2025 Regular Session (2025R1)
- **LC number:** 4653
- **Created:** 2025-02-28T10:49:02
- **Metadata last modified (upstream):** 2025-05-15T13:03:07
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 6972 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR31/Enrolled>.

## Summary

**Catchline:** In memoriam: Lyllye Reynolds-Parker, 1946-2024.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `7c96666ce16d3d1f181af3abf6fde75f95c1e4d38b763372022bedd0940145a3` (snapshot `_meta/snapshots/measure-2025r1-hcr31-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR31/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `cdeafe7f11ef7292cbcbebe61393e32907769eac557a6b0a16be36e15f3d6713` (snapshot `_meta/snapshots/measure-2025r1-hcr31-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR31/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 31` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3263
title: 'HB 3263 (2025R1): Requires the State Forestry Department to establish the Western Oregon Regional
  Carbon Sink as a geographical area and take certain actions regarding the area on or before January
  1, 2035.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3263
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3263/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5dcb90996d79f39cf2d894427ee4361444e462e65689ac9fef557d1a56f7976c
snapshot_id: measure-2025r1-hb3263-introduced
status: current
...
measure_summary: "\tDigest: The Act tells an agency to create a specific area in which trees must be replanted.\
  \ The Act creates a task force. The Act ends the task force a while later and creates an advisory board.\
  \ (Flesch Readability Score: 84.2). \n\tRequires the State Forestry Department to establish the Western\
  \ Oregon Regional Carbon Sink as a geographical area and take certain actions regarding the area on\
  \ or before January 1, 2035. \n\tEstablishes the Task Force on the Western Oregon Regional Carbon Sink.\
  \ Sunsets the task force on December 31, 2026. \n\tEstablishes the Western Oregon Regional Carbon Sink\
...
lc_number: 3370
measure_created_date: '2025-01-12T14:09:45'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3263`.

# HB 3263 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3263, 2025 Regular Session (2025R1)
- **LC number:** 3370
- **Created:** 2025-01-12T14:09:45
- **Metadata last modified (upstream):** 2025-01-27T08:01:08
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5676 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3263/Introduced>.

## Summary

**Catchline:** Requires the State Forestry Department to establish the Western Oregon Regional Carbon Sink as a geographical area and take certain actions regarding the area on or before January 1, 2035.

**Relating to:** Relating to carbon sequestration; declaring an emergency.

Digest: The Act tells an agency to create a specific area in which trees must be replanted. The Act creates a task force. The Act ends the task force a while later and creates an advisory board. (Flesch Readability Score: 84.2). 
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `5dcb90996d79f39cf2d894427ee4361444e462e65689ac9fef557d1a56f7976c` (snapshot `_meta/snapshots/measure-2025r1-hb3263-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3263/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3263` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb906
title: 'SB 906 (2025R1): Requires employers to provide to all employees, at the time of hire, a written
  explanation of earnings and deductions shown on itemized statements.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 906
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB906/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: bd2946557cc9990a594960f1a92a66ea19d1f06f82b11f86bb3229ba1b8d7e58
snapshot_id: measure-2025r1-sb906-enrolled
status: current
...
catch_line: Requires employers to provide to all employees, at the time of hire, a written explanation
  of earnings and deductions shown on itemized statements.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act makes new laws that require employers to explain certain details\
  \ about employee pay stubs. The Act tells BOLI to make a sample document for employers to use to explain\
  \ those details. (Flesch Readability Score: 61.9).</b> \n\t[<i>Digest: The Act makes new requirements\
  \ for employee pay stubs. (Flesch Readability Score: 66.1).</i>] \n\t[<i>Requires that itemized statements\
  \ provided to employees show, in plain language, the amount and purpose of each deduction.</i>] \n\t\
  <b>Requires employers to provide to all employees, at the time of hire, a written explanation of earnings\
  \ and deductions shown on itemized statements. Describes the ways in which an employer may satisfy the\
  \ requirement. Establishes specifications for the contents of the written explanation. Requires employers\
  \ to review and update the information provided in the written explanation by January 1 of each year.\
  \ Authorizes the Commissioner of the Bureau of Labor and Industries to impose civil penalties for violations\
  \ of the requirements. \n\tDirects the Bureau of Labor and Industries to develop and make available\
  \ to employers a model written guidance document in English and in Spanish and, if requested, in other\
  \ languages, to the extent practicable.</b>"
relating_to: Relating to transparency concerning employer deductions from wages.
relating_to_full: Relating to transparency concerning employer deductions from wages.
at_the_request_of: (at the request of OFNHP)
lc_number: 4067
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 906`.

# SB 906 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 906, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of OFNHP)
- **LC number:** 4067
...
- **Full text below:** Enrolled version, 10317 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB906/Enrolled>.

## Summary

**Catchline:** Requires employers to provide to all employees, at the time of hire, a written explanation of earnings and deductions shown on itemized statements.
...
**RelatingToFull (verbatim upstream field):** Relating to transparency concerning employer deductions from wages.
...
- From bill text (Enrolled version): ORS 18.385, ORS 18.736, ORS 183.745, ORS 292.026, ORS 652.020, ORS 652.110, ORS 652.140, ORS 652.145, ORS 652.260, ORS 652.610, ORS 652.900, ORS 663.110, ORS 84.001

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `bd2946557cc9990a594960f1a92a66ea19d1f06f82b11f86bb3229ba1b8d7e58` (snapshot `_meta/snapshots/measure-2025r1-sb906-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB906/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `c6c15e2c9053f7fd2b9ea820e65e31ae5e76c5670e3d6e2399e3801bfc07b97b` (snapshot `_meta/snapshots/measure-2025r1-sb906-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB906/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 906` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

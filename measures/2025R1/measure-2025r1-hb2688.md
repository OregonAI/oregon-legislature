...
jurisdiction: oregon
id: measure-2025r1-hb2688
title: 'HB 2688 (2025R1): Applies the prevailing rate of wage to certain off-site bespoke work fabricated,
  preconstructed, assembled or constructed in accordance with specifications for a particular public works.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2688
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2688/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 6c167cd7a5b68e73c735c1999902e90836becbbce715df8a0e81d4bf00db6cb3
snapshot_id: measure-2025r1-hb2688-enrolled
status: current
...
catch_line: Applies the prevailing rate of wage to certain off-site bespoke work fabricated, preconstructed,
  assembled or constructed in accordance with specifications for a particular public works.
minority_catch_line: null
measure_summary: "\tDigest: Makes a certain wage apply to custom work done off-site but for a particular\
  \ public works project. (Flesch Readability Score: 67.3). \n\tApplies the prevailing rate of wage to\
  \ certain off-site bespoke work fabricated, preconstructed, assembled or constructed in accordance with\
  \ specifications for a particular public works. Specifies examples of such bespoke work. \n\tTakes effect\
  \ on the 91st day following adjournment sine die."
relating_to: Relating to the application of a prevailing rate of wage to off-site custom work for use
  in public works; and prescribing an effective date.
relating_to_full: Relating to the application of a prevailing rate of wage to off-site custom work for
  use in public works; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2688`.

# HB 2688 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2688, 2025 Regular Session (2025R1)
- **LC number:** 929
...
- **Full text below:** Enrolled version, 10153 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2688/Enrolled>.

## Summary

**Catchline:** Applies the prevailing rate of wage to certain off-site bespoke work fabricated, preconstructed, assembled or constructed in accordance with specifications for a particular public works.
...
**RelatingToFull (verbatim upstream field):** Relating to the application of a prevailing rate of wage to off-site custom work for use in public works; and prescribing an effective date.
...
Enrolled House Bill 2688 (HB 2688-B) Page 1
...
Enrolled House Bill 2688 (HB 2688-B) Page 2
(VII) Roofing, flashing and architectural panel  systems or components other than glazing
...
Enrolled House Bill 2688 (HB 2688-B) Page 3
...
Enrolled House Bill 2688 (HB 2688-B) Page 4
...
- From bill text (Enrolled version): ORS 174.109, ORS 279A.065, ORS 279C.800, ORS 279C.810, ORS 279C.815, ORS 352.002, ORS 456.055, ORS 479.510

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `6c167cd7a5b68e73c735c1999902e90836becbbce715df8a0e81d4bf00db6cb3` (snapshot `_meta/snapshots/measure-2025r1-hb2688-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2688/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `103acf945eb758ec322264d2e96066a332d2dd282eb098065e14dbf688c05f03` (snapshot `_meta/snapshots/measure-2025r1-hb2688-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2688/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2688` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

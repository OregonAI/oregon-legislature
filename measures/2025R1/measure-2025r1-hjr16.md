...
jurisdiction: oregon
id: measure-2025r1-hjr16
title: 'HJR 16 (2025R1): Proposes an amendment to the Oregon Constitution to establish the office of Lieutenant
  Governor and places the Lieutenant Governor first in the line to succeed the Governor if the Governor''s
  office becomes vacant mid-term. Establishes the duration of the term of office of Lieutenant Governor
  at four years, but provides that the first term of office, elected in the 2028 regular general election,
  is only two years.'
doc_type: dataset_doc
citation: 2025 Regular Session House Joint Resolution 16
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJR16/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a8d5ed483e8494feb94ee82b6be97acbfb8056ccc0f791c9b7f1def294cb87a9
snapshot_id: measure-2025r1-hjr16-introduced
status: current
...
catch_line: Proposes an amendment to the Oregon Constitution to establish the office of Lieutenant Governor
  and places the Lieutenant Governor first in the line to succeed the Governor if the Governor's office
  becomes vacant mid-term. Establishes the duration of the term of office of Lieutenant Governor at four
  years, but provides that the first term of office, elected in the 2028 regular general election, is
  only two years.
minority_catch_line: null
measure_summary: "\tDigest: The measure creates the office of Lt. Governor. The measure places the Lt.\
  \ Governor as first in the line to succeed the Governor if that office is vacant. The measure asks voters\
  \ to say yes or no to the proposal at the 2026 general election. (Flesch Readability Score: 63.7). \n\
  \tProposes an amendment to the Oregon Constitution to establish the office of Lieutenant Governor and\
  \ places the Lieutenant Governor first in the line to succeed the Governor if the Governor's office\
  \ becomes vacant mid-term. Establishes the duration of the term of office of Lieutenant Governor at\
  \ four years, but provides that the first term of office, elected in the 2028 regular general election,\
  \ is only two years. \n\tRefers the proposed amendment to the people for their approval or rejection\
  \ at the next regular general election."
relating_to: Proposing an amendment to the Oregon Constitution relating to the office of Lieutenant Governor.
relating_to_full: null
at_the_request_of: null
lc_number: 3791
measure_created_date: '2025-02-06T15:06:38'
measure_modified_date: '2025-02-12T13:31:06'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 4952
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HJR' and MeasureNumber eq 16`.

# HJR 16 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Joint Resolution 16, 2025 Regular Session (2025R1)
- **LC number:** 3791
- **Created:** 2025-02-06T15:06:38
- **Metadata last modified (upstream):** 2025-02-12T13:31:06
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4952 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJR16/Introduced>.

## Summary

**Catchline:** Proposes an amendment to the Oregon Constitution to establish the office of Lieutenant Governor and places the Lieutenant Governor first in the line to succeed the Governor if the Governor's office becomes vacant mid-term. Establishes the duration of the term of office of Lieutenant Governor at four years, but provides that the first term of office, elected in the 2028 regular general election, is only two years.
...
LC 3791-2
by law,  then the President of the Senate; or if there be none, or in case of [ his] the  removal from
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `a8d5ed483e8494feb94ee82b6be97acbfb8056ccc0f791c9b7f1def294cb87a9` (snapshot `_meta/snapshots/measure-2025r1-hjr16-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJR16/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HJR' and MeasureNumber eq 16` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

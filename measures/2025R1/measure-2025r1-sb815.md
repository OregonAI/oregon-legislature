...
jurisdiction: oregon
id: measure-2025r1-sb815
title: 'SB 815 (2025R1): Modifies juvenile dependency procedures regarding when the Department of Human
  Services is recognized as a party in a proceeding.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 815
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB815/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 99efb0f87cbc0cab1786c05c7bc6897a08077a82d5290ea3d682d69049ba1336
snapshot_id: measure-2025r1-sb815-enrolled
status: current
...
catch_line: Modifies juvenile dependency procedures regarding when the Department of Human Services is
  recognized as a party in a proceeding.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes changes to when DHS is a party in a dependency case. (Flesch\
  \ Readability Score: 77.8). \n\tModifies juvenile dependency procedures regarding when the Department\
  \ of Human Services is recognized as a party in a proceeding."
relating_to: Relating to the Department of Human Services as a party in dependency proceedings.
relating_to_full: Relating to the Department of Human Services as a party in dependency proceedings.
...
# SB 815 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 815, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 8716 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB815/Enrolled>.

## Summary

**Catchline:** Modifies juvenile dependency procedures regarding when the Department of Human Services is recognized as a party in a proceeding.
...
**RelatingToFull (verbatim upstream field):** Relating to the Department of Human Services as a party in dependency proceedings.
...
- From bill text (Enrolled version): ORS 419B.100, ORS 419B.116, ORS 419B.185, ORS 419B.310, ORS 419B.325, ORS 419B.337, ORS 419B.449, ORS 419B.476, ORS 419B.500, ORS 419B.600, ORS 419B.646, ORS 419B.809, ORS 419B.875, ORS 45.275, ORS 45.285

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `99efb0f87cbc0cab1786c05c7bc6897a08077a82d5290ea3d682d69049ba1336` (snapshot `_meta/snapshots/measure-2025r1-sb815-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB815/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `84e810b070fa2fadf68058422dfaae086347e58fb3862cb6bfc5d335dd92c35f` (snapshot `_meta/snapshots/measure-2025r1-sb815-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB815/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 815` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

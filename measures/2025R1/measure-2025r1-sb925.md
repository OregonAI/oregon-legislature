...
jurisdiction: oregon
id: measure-2025r1-sb925
title: 'SB 925 (2025R1): Prohibits the Oregon Transportation Commission from establishing a toll on Interstate
  205.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 925
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB925/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0c29e575afc971976aacd682169faa8a2e9c753512cc053f626f024d649cae9b
snapshot_id: measure-2025r1-sb925-introduced
status: current
...
measure_summary: "\tDigest: The Act says that the OTC may not toll I-205. (Flesch Readability Score: 100).\
...
measure_modified_date: '2025-02-04T17:27:57'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 4047
...
# SB 925 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 925, 2025 Regular Session (2025R1)
- **LC number:** 4154
- **Created:** 2025-01-17T08:51:30
- **Metadata last modified (upstream):** 2025-02-04T17:27:57
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4047 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB925/Introduced>.
...
Digest: The Act says that the OTC may not toll I-205. (Flesch Readability Score: 100). 
 Prohibits the Oregon Transportation Commission from establishing a toll on Interstate 205.
...
Commission is prohibited from establishing any toll on Interstate 205.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `0c29e575afc971976aacd682169faa8a2e9c753512cc053f626f024d649cae9b` (snapshot `_meta/snapshots/measure-2025r1-sb925-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB925/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 925> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb914
title: 'SB 914 (2025R1): Requires that certain billboards related to the state lottery include information
  about a problem gambling helpline.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 914
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB914/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e9cd79b03534f49cc1fb00806b96c6793dcd2235beebdd908e64eb245e539e45
snapshot_id: measure-2025r1-sb914-enrolled
status: current
...
catch_line: Requires that certain billboards related to the state lottery include information about a
  problem gambling helpline.
minority_catch_line: null
measure_summary: "\tDigest: The Act requires billboards for the state lottery to have a phone number for\
  \ problem gambling help. (Flesch Readability Score: 70.1). \n\tRequires that certain billboards related\
  \ to the state lottery include information about a problem gambling helpline."
relating_to: Relating to problem gambling.
relating_to_full: Relating to problem gambling.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 914`.

# SB 914 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 914, 2025 Regular Session (2025R1)
- **LC number:** 3862
...
- **Full text below:** Enrolled version, 6077 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB914/Enrolled>.

## Summary

**Catchline:** Requires that certain billboards related to the state lottery include information about a problem gambling helpline.

**Relating to:** Relating to problem gambling.

Digest: The Act requires billboards for the state lottery to have a phone number for problem gambling help. (Flesch Readability Score: 70.1). 
 Requires that certain billboards related to the state lottery include information about a problem gambling helpline.

**RelatingToFull (verbatim upstream field):** Relating to problem gambling.
...
Enrolled Senate Bill 914 (SB 914-A) Page 1
(6) All  television, radio and newspaper advertising of lottery games funded by the lottery com-
...
Enrolled Senate Bill 914 (SB 914-A) Page 2
...
- From bill text (Enrolled version): ORS 461.220

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `e9cd79b03534f49cc1fb00806b96c6793dcd2235beebdd908e64eb245e539e45` (snapshot `_meta/snapshots/measure-2025r1-sb914-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB914/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `f84bfcf6e7f8db784eaf858b078e3fa74e0f36252506513f284ce10abe8bb993` (snapshot `_meta/snapshots/measure-2025r1-sb914-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB914/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 914` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

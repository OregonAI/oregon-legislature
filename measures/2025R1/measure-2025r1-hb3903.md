...
jurisdiction: oregon
id: measure-2025r1-hb3903
title: 'HB 3903 (2025R1): Requires local governments to require at least one parking space per multiunit
  unit with limited exceptions.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3903
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3903/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0faee4851e68837628885978becc1ba7d029002fbdf3b90ec4f05cfe6796e89b
snapshot_id: measure-2025r1-hb3903-introduced
status: current
...
catch_line: Requires local governments to require at least one parking space per multiunit unit with limited
  exceptions.
minority_catch_line: null
measure_summary: "\tDigest: This Act requires one parking spot per multiunit unit in urban areas. (Flesch\
  \ Readability Score: 60.7). \n\tRequires local governments to require at least one parking space per\
  \ multiunit unit with limited exceptions."
relating_to: Relating to parking minimums for residential development.
relating_to_full: Relating to parking minimums for residential development; creating new provisions; and
  amending section 38, chapter 110, Oregon Laws 2024.
at_the_request_of: null
lc_number: 4558
measure_created_date: '2025-02-26T13:19:10'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3903`.

# HB 3903 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3903, 2025 Regular Session (2025R1)
- **LC number:** 4558
- **Created:** 2025-02-26T13:19:10
- **Metadata last modified (upstream):** 2025-03-05T10:33:48
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 10301 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3903/Introduced>.

## Summary

**Catchline:** Requires local governments to require at least one parking space per multiunit unit with limited exceptions.
...
**RelatingToFull (verbatim upstream field):** Relating to parking minimums for residential development; creating new provisions; and amending section 38, chapter 110, Oregon Laws 2024.
...
- From bill text (Introduced version): ORS 197A.420, ORS 456.270

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `0faee4851e68837628885978becc1ba7d029002fbdf3b90ec4f05cfe6796e89b` (snapshot `_meta/snapshots/measure-2025r1-hb3903-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3903/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3903` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

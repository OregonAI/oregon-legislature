...
jurisdiction: oregon
id: measure-2025r1-sb403
title: 'SB 403 (2025R1): Requires that ballots that are returned by mail must be received by the date
  of the election.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 403
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB403/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 565270c587e8662b53a4c481810bb7be6d6aebdf658b449e6c9f3815bcde8ac8
snapshot_id: measure-2025r1-sb403-introduced
status: current
...
catch_line: Requires that ballots that are returned by mail must be received by the date of the election.
minority_catch_line: null
measure_summary: "\tDigest: The Act requires ballots that are returned by mail to be received by the date\
  \ of the election. (Flesch Readability Score: 72.5). \n\tRequires that ballots that are returned by\
  \ mail must be received by the date of the election."
relating_to: Relating to ballot return date.
relating_to_full: Relating to ballot return date; creating new provisions; and amending ORS 247.018, 253.065,
  253.070, 253.585, 253.690, 254.408, 254.458, 254.470, 254.485 and 260.695.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 403>.

# SB 403 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 403, 2025 Regular Session (2025R1)
- **LC number:** 1961
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-24T09:07:12
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 38168 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB403/Introduced>.

## Summary

**Catchline:** Requires that ballots that are returned by mail must be received by the date of the election.

**Relating to:** Relating to ballot return date.

Digest: The Act requires ballots that are returned by mail to be received by the date of the election. (Flesch Readability Score: 72.5). 
 Requires that ballots that are returned by mail must be received by the date of the election.

**RelatingToFull (verbatim upstream field):** Relating to ballot return date; creating new provisions; and amending ORS 247.018, 253.065, 253.070, 253.585, 253.690, 254.408, 254.458, 254.470, 254.485 and 260.695.
...
standards.
Digest: The Act  requires ballots that are returned by mail to be received by the date of the
election. (Flesch Readability Score: 72.5).
Requires that ballots that are returned by mail must be received by the date of the election.
A BILL FOR AN ACT
Relating to ballot return date;  creating new provisions; and amending ORS 247.018, 253.065, 253.070,
253.585, 253.690, 254.408, 254.458, 254.470, 254.485 and 260.695.
...
ignated by the county clerk or at any location described  in ORS 254.472 or 254.474, ] The ballot must
...
of this section, the return  identification envelope must contain: ] The back of the return identifica-
tion envelope shall include a statement to be signed  by the absent elector, stating that the
elector:
...
253.070. A ballot from an absent elector must be  received by a county clerk not later than
8 p.m. on the date of the election.
[(1) Upon receipt of a ballot the absent elector shall mark it and comply  with the instructions
provided with the  ballot. The absent elector may return the marked ballot to the office of the clerk, by
...
SECTION 4.  ORS 254.485, as amended by section 3, chapter 56, Oregon Laws 2024, is  amended
to read:
...
NOTE:
 Section 5 was deleted. Subsequent sections were not renumbered.
SECTION 6.  ORS 253.690 is amended to read:
...
(B) The county  clerk shall inform the elector of any alterations to the process described in
subparagraph (A) of this paragraph that are necessary if the Secretary of State has approved  a
procedure under ORS 254.458 to be used in lieu of the envelope procedures.
...
(3) A ballot received by the Secretary of  State not later than 8 p.m. on the date of the
election under this section shall be considered  to have been received by the county clerk as de-
scribed in ORS 253.070 . [ if:]
...
signature that can be verified, in the manner described in ORS 254.470 [ (11)] (9), for the purpose of
tallying ballots.
SECTION 12.
The amendments to ORS 247.018,  253.065, 253.070, 253.585, 253.690, 254.408,
254.458, 254.470, 254.485 and 260.695 by sections 1 to 11 of this 2025 Act apply to elections held
...
- From `RelatingToFull`: ORS 247.018, ORS 253.065, ORS 253.070, ORS 253.585, ORS 253.690, ORS 254.408, ORS 254.458, ORS 254.470, ORS 254.485, ORS 260.695
- From bill text (Introduced version): ORS 247.018, ORS 247.025, ORS 247.203, ORS 251.005, ORS 253.065, ORS 253.070, ORS 253.501, ORS 253.510, ORS 253.585, ORS 253.690, ORS 254.165, ORS 254.365, ORS 254.408, ORS 254.431, ORS 254.445, ORS 254.458, ORS 254.470, ORS 254.472, ORS 254.474, ORS 254.476, ORS 254.480, ORS 254.485, ORS 260.695

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `565270c587e8662b53a4c481810bb7be6d6aebdf658b449e6c9f3815bcde8ac8` (snapshot `_meta/snapshots/measure-2025r1-sb403-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB403/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 403> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

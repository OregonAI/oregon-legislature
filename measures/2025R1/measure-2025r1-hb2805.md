...
jurisdiction: oregon
id: measure-2025r1-hb2805
title: 'HB 2805 (2025R1): Makes permanent the authority of the State Department of Agriculture to annually
  increase license fees for food establishments by up to three percent.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2805
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2805/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: df7c6918a065d4093a78df896ac31b797e0cb82740e59d65927b53138f9f268f
snapshot_id: measure-2025r1-hb2805-enrolled
status: current
...
catch_line: Makes permanent the authority of the State Department of Agriculture to annually increase
  license fees for food establishments by up to three percent.
...
measure_summary: "\tDigest: The Act allows an agency to increase certain license fees. (Flesch Readability\
  ...
  \ increase license fees for food establishments by up to three percent."
relating_to: Relating to food establishment licenses.
relating_to_full: Relating to food establishment licenses.
...
# HB 2805 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2805, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 5958 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2805/Enrolled>.

## Summary

**Catchline:** Makes permanent the authority of the State Department of Agriculture to annually increase license fees for food establishments by up to three percent.

**Relating to:** Relating to food establishment licenses.
...
**RelatingToFull (verbatim upstream field):** Relating to food establishment licenses.
...
- From bill text (Enrolled version): ORS 603.025, ORS 616.695, ORS 616.706

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `df7c6918a065d4093a78df896ac31b797e0cb82740e59d65927b53138f9f268f` (snapshot `_meta/snapshots/measure-2025r1-hb2805-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2805/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `d6acbfd70c1e1740946cead381f57806797bf0fc30cc24007f9b4a1ece73d97b` (snapshot `_meta/snapshots/measure-2025r1-hb2805-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2805/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2805> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

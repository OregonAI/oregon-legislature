...
jurisdiction: oregon
id: measure-2025r1-hb3829
title: 'HB 3829 (2025R1): Provides that certain traffic offenses may be set aside.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3829
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3829/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: cbae390516c962530962fc171303d0e877b2470f5d34e73aa042ee78caa49b57
snapshot_id: measure-2025r1-hb3829-introduced
status: current
...
catch_line: Provides that certain traffic offenses may be set aside.
minority_catch_line: null
measure_summary: "\tDigest: The Act lets a person set aside a conviction for certain traffic offenses.\
  \ The Act takes effect on the 91st day after sine die. (Flesch Readability Score: 71.2). \n\tProvides\
  \ that certain traffic offenses may be set aside. Specifies when a person is not eligible. \n\tTakes\
  \ effect on the 91st day following adjournment sine die."
relating_to: Relating to the expungement of traffic offenses; prescribing an effective date.
relating_to_full: Relating to the expungement of traffic offenses; amending ORS 137.225; and prescribing
  an effective date.
at_the_request_of: null
lc_number: 4365
measure_created_date: '2025-02-25T19:10:05'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3829>.

# HB 3829 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3829, 2025 Regular Session (2025R1)
- **LC number:** 4365
- **Created:** 2025-02-25T19:10:05
- **Metadata last modified (upstream):** 2025-03-05T10:29:56
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 16742 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3829/Introduced>.

## Summary

**Catchline:** Provides that certain traffic offenses may be set aside.

**Relating to:** Relating to the expungement of traffic offenses; prescribing an effective date.

Digest: The Act lets a person set aside a conviction for certain traffic offenses. The Act takes effect on the 91st day after sine die. (Flesch Readability Score: 71.2). 
 Provides that certain traffic offenses may be set aside. Specifies when a person is not eligible. 
 Takes effect on the 91st day following adjournment sine die.

**RelatingToFull (verbatim upstream field):** Relating to the expungement of traffic offenses; amending ORS 137.225; and prescribing an effective date.
...
standards.
Digest: The  Act lets a person set aside a conviction for certain traffic offenses. The Act takes
effect on the 91st day after sine die. (Flesch Readability Score: 71.2).
Provides that certain traffic offenses may be set aside. Specifies when a person is not eligible.
Takes effect on the 91st day following adjournment sine die.
A BILL FOR AN ACT
Relating to the expungement of traffic offenses; amending ORS 137.225; and prescribing  an effective
date.
...
do not apply to:
(a) A conviction for a state or municipal traffic offense , unless:
(A) The offense is described in ORS 807.570, 811.140, 811.182 (4), 811.540 or 811.700; and
(B) The person did not have a commercial driver license or commercial learner driver
permit at the time of the offense or  at the time of the filing of the motion, and was not
driving a commercial vehicle at the time of the offense .
...
(b) “Commercial driver license” has the meaning given that term in ORS 801.207.
(c) “Commercial motor vehicle” has the meaning given that term in ORS 801.208.
...
- From `RelatingToFull`: ORS 137.225
- From bill text (Introduced version): ORS 137.225, ORS 161.705, ORS 163.145, ORS 163.165, ORS 163.200, ORS 163.205, ORS 163.575, ORS 163A.005, ORS 163A.140, ORS 163A.145, ORS 166.429, ORS 21.135, ORS 419B.005, ORS 801.207, ORS 801.208, ORS 807.570, ORS 811.140, ORS 811.182, ORS 811.540, ORS 813.200

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `cbae390516c962530962fc171303d0e877b2470f5d34e73aa042ee78caa49b57` (snapshot `_meta/snapshots/measure-2025r1-hb3829-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3829/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3829> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3556
title: 'HB 3556 (2025R1): Extends the permissible uses of net revenue from a new or increased local transient
  lodging tax to include public safety services and certain costs related to "community infrastructure."'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3556
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3556/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ece23abfe5a9ba34331356c09d9a19bc5f0a06bb0618e7a36765c043ee7a2fac
snapshot_id: measure-2025r1-hb3556-introduced
status: current
...
catch_line: Extends the permissible uses of net revenue from a new or increased local transient lodging
  tax to include public safety services and certain costs related to "community infrastructure."
minority_catch_line: null
measure_summary: "\tDigest: The Act would let a city or county use net revenue from its hotel tax to fund\
  \ the costs of public safety and costs that are tied to infrastructure. (Flesch Readability Score: 60.7).\
...
relating_to_full: Relating to the use of local transient tax revenue; amending ORS 320.300, 320.305, 320.350
  and 320.360; and prescribing an effective date.
at_the_request_of: null
lc_number: 1500
measure_created_date: '2025-02-10T12:58:54'
measure_modified_date: '2026-02-25T12:05:28'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 12940
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3556>.

# HB 3556 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3556, 2025 Regular Session (2025R1)
- **LC number:** 1500
- **Created:** 2025-02-10T12:58:54
- **Metadata last modified (upstream):** 2026-02-25T12:05:28
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 12940 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3556/Introduced>.

## Summary

**Catchline:** Extends the permissible uses of net revenue from a new or increased local transient lodging tax to include public safety services and certain costs related to "community infrastructure."

**Relating to:** Relating to the use of local transient tax revenue; prescribing an effective date.
...
**RelatingToFull (verbatim upstream field):** Relating to the use of local transient tax revenue; amending ORS 320.300, 320.305, 320.350 and 320.360; and prescribing an effective date.
...
LC 1500
(a) Fund tourism promotion , [ or] tourism-related facilities  or tourism-impacted services ;
...
- From `RelatingToFull`: ORS 320.300, ORS 320.305, ORS 320.350, ORS 320.360
- From bill text (Introduced version): ORS 190.003, ORS 320.300, ORS 320.305, ORS 320.350, ORS 320.360

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `ece23abfe5a9ba34331356c09d9a19bc5f0a06bb0618e7a36765c043ee7a2fac` (snapshot `_meta/snapshots/measure-2025r1-hb3556-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3556/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3556> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

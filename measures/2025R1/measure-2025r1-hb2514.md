...
jurisdiction: oregon
id: measure-2025r1-hb2514
title: 'HB 2514 (2025R1): Permits an education service district to contract bonded indebtedness for capital
  costs in excess of limits applicable to component school districts.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2514
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2514/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 86ca730107505ceabe3933dea869e74e571d237b25c1805572ddf4c203b1301c
snapshot_id: measure-2025r1-hb2514-enrolled
status: current
...
catch_line: Permits an education service district to contract bonded indebtedness for capital costs in
  excess of limits applicable to component school districts.
minority_catch_line: null
measure_summary: "\tDigest: This Act raises the cap on the funds an education service district can raise\
  \ for capital costs by issuing bonds. (Flesch Readability Score: 63.8). \n\tPermits an education service\
  \ district to contract bonded indebtedness for capital costs in excess of limits applicable to component\
  \ school districts."
relating_to: Relating to education service district indebtedness.
relating_to_full: Relating to education service district indebtedness.
...
measure_modified_date: '2026-04-15T10:27:26'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2514`.

# HB 2514 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2514, 2025 Regular Session (2025R1)
...
- **Metadata last modified (upstream):** 2026-04-15T10:27:26
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 6871 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2514/Enrolled>.

## Summary

**Catchline:** Permits an education service district to contract bonded indebtedness for capital costs in excess of limits applicable to component school districts.
...
**RelatingToFull (verbatim upstream field):** Relating to education service district indebtedness.
...
district;
Enrolled House Bill 2514 (HB 2514-B) Page 1
(c) Shall provide funds as specified in ORS 327.019 (9) to  a school district located within the
...
Enrolled House Bill 2514 (HB 2514-B) Page 2
...
Enrolled House Bill 2514 (HB 2514-B) Page 3
...
- From bill text (Enrolled version): ORS 280.060, ORS 308.207, ORS 327.019, ORS 328.205, ORS 328.245, ORS 328.304, ORS 334.015, ORS 334.125, ORS 334.175

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `86ca730107505ceabe3933dea869e74e571d237b25c1805572ddf4c203b1301c` (snapshot `_meta/snapshots/measure-2025r1-hb2514-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2514/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `52f7d7ac328273930fc197ba4cc3885d477a851d64cdf8e7ebba99b656cd5330` (snapshot `_meta/snapshots/measure-2025r1-hb2514-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2514/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2514` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

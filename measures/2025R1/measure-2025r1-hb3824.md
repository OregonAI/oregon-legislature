...
jurisdiction: oregon
id: measure-2025r1-hb3824
title: 'HB 3824 (2025R1): Allows a physical therapist to perform dry needling.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3824
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3824/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 8f90d3267a681beb6713aeb8be0afc11e2c7ba3eb254ec726144cae5473bb941
snapshot_id: measure-2025r1-hb3824-enrolled
status: current
...
catch_line: Allows a physical therapist to perform dry needling.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes some changes to the laws that govern physical therapy in this\
  \ state. (Flesch Readability Score: 73.1). \n\t[<i>Authorizes a physical therapist to prescribe durable\
  \ medical equipment. Authorizes a physical therapist to administer vaccines to specified individuals.</i>]<b>\
  \ Allows a physical therapist to perform dry needling. Directs the Oregon Board of Physical Therapy\
  \ to adopt rules related to dry needling.</b> Allows a physical therapist to sign and date a certificate\
  \ for a disabled person parking permit application. Exempts a physical therapist from the requirement\
  \ to obtain a license to use sonographic equipment if the sonographic equipment is used for physical\
  \ therapy purposes. Changes membership requirements for members of the [<i>Oregon Board of Physical\
  \ Therapy</i>] <b>board</b>. <b>Requires specified reporters to report a claim against a physical therapist\
  \ to the board. \n\tBecomes operative on July 1, 2027.</b> \n\tTakes effect on the 91st day following\
  \ adjournment sine die."
relating_to: Relating to physical therapy; and prescribing an effective date.
relating_to_full: Relating to physical therapy; and prescribing an effective date.
at_the_request_of: null
lc_number: 3443
measure_created_date: '2025-02-25T18:52:19'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3824`.

# HB 3824 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3824, 2025 Regular Session (2025R1)
- **LC number:** 3443
- **Created:** 2025-02-25T18:52:19
- **Metadata last modified (upstream):** 2025-08-13T13:54:50
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 61321 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3824/Enrolled>.

## Summary

**Catchline:** Allows a physical therapist to perform dry needling.
...
**RelatingToFull (verbatim upstream field):** Relating to physical therapy; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 171.562, ORS 171.565, ORS 181A.195, ORS 182.456, ORS 192.553, ORS 292.495, ORS 30.260, ORS 41.675, ORS 441.015, ORS 656.250, ORS 670.280, ORS 676.150, ORS 676.160, ORS 676.303, ORS 677.505, ORS 678.375, ORS 680.040, ORS 683.010, ORS 684.040, ORS 686.040, ORS 688.010, ORS 688.015, ORS 688.020, ORS 688.030, ORS 688.040, ORS 688.050, ORS 688.055, ORS 688.080, ORS 688.090, ORS 688.100, ORS 688.110, ORS 688.135, ORS 688.140, ORS 688.145, ORS 688.160, ORS 688.240, ORS 688.405, ORS 688.435, ORS 742.400, ORS 750.005, ORS 811.602, ORS 811.604

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `8f90d3267a681beb6713aeb8be0afc11e2c7ba3eb254ec726144cae5473bb941` (snapshot `_meta/snapshots/measure-2025r1-hb3824-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3824/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `55e058abfb6065131d0968a9ad39d1a3dbdf865e0fcd6f67c34f085bef4c85ae` (snapshot `_meta/snapshots/measure-2025r1-hb3824-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3824/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3824` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

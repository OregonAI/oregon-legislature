...
jurisdiction: oregon
id: measure-2025r1-hb2709
title: 'HB 2709 (2025R1): Prohibits a warrantor from accepting a fee from a resident for an extended warranty
  unless the warrantor knows that the resident''s motor vehicle qualifies for coverage under the extended
  warranty.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2709
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2709/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0f411b250914906926ba80d0943be6195eff95da323bd14c21a79693910fb804
snapshot_id: measure-2025r1-hb2709-introduced
status: current
...
catch_line: Prohibits a warrantor from accepting a fee from a resident for an extended warranty unless
  the warrantor knows that the resident's motor vehicle qualifies for coverage under the extended warranty.
minority_catch_line: null
measure_summary: "\tDigest: Says a person may not get a fee from a resident to cover the resident's car\
  \ with an extended warranty if the person knows that the car does not qualify for the warranty. Tells\
  \ the person to ask for enough information to decide whether the car qualifies. Says that the person\
  \ must cover the car even if it doesn't qualify if the person takes a fee from the resident. Takes effect\
  \ 91 days after the session ends. (Flesch Readability Score: 63.1). \n\tProhibits a warrantor from accepting\
  \ a fee from a resident for an extended warranty unless the warrantor knows that the resident's motor\
  \ vehicle qualifies for coverage under the extended warranty. Requires the warrantor to request and\
  \ obtain information needed to assess whether the motor vehicle qualifies for coverage. \n\tRequires\
  \ a warrantor to provide coverage under an extended warranty for a motor vehicle that does not qualify\
  \ for coverage if the warrantor accepted a fee to provide the extended warranty. \n\tPunishes a violation\
  \ of the Act as an unlawful practice under the Unlawful Trade Practices Act. \n\tTakes effect on the\
  \ 91st day following adjournment sine die."
relating_to: Relating to a warrantor's obligations with respect to extended warranties for motor vehicles;
  prescribing an effective date.
relating_to_full: Relating to a warrantor's obligations with respect to extended warranties for motor
  vehicles; creating new provisions; amending ORS 646.608; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2709>.

# HB 2709 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2709, 2025 Regular Session (2025R1)
- **LC number:** 3014
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:28:20
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 15331 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2709/Introduced>.

## Summary

**Catchline:** Prohibits a warrantor from accepting a fee from a resident for an extended warranty unless the warrantor knows that the resident's motor vehicle qualifies for coverage under the extended warranty.
...
**RelatingToFull (verbatim upstream field):** Relating to a warrantor's obligations with respect to extended warranties for motor vehicles; creating new provisions; amending ORS 646.608; and prescribing an effective date.
...
standards.
Digest: Says a person may not get a fee from a resident to cover the resident’s car with  an ex-
tended warranty if the person knows that the car  does not qualify for the warranty. Tells the person
to ask for enough  information to decide whether the car qualifies. Says that the person must cover
the car even if it doesn’t qualify  if the person takes a fee from the resident. Takes effect 91 days
after the session ends. (Flesch Readability Score: 63.1).
Prohibits a warrantor from accepting a fee  from a resident for an extended warranty unless the
warrantor  knows  that the resident’s motor vehicle qualifies for coverage under the extended war-
ranty. Requires the warrantor to request and  obtain information needed to assess whether the motor
vehicle qualifies for coverage.
Requires a warrantor to provide coverage under an extended warranty  for a motor vehicle that
does not qualify for coverage if the warrantor accepted a fee to provide the extended warranty.
Punishes a violation of the Act as an  unlawful practice under the Unlawful Trade Practices Act.
Takes effect on the 91st day following adjournment sine die.
A BILL FOR AN ACT
Relating to a warrantor’s obligations with respect to extended warranties for motor vehicles;  cre-
ating new provisions; amending ORS 646.608; and prescribing an effective date.
Be It Enacted by the People of the State of Oregon:
SECTION 1.
(1) As used in this section:
(a) “Extended warranty” means an  agreement between a warrantor and a resident that
specifies:
(A) The scope of the warrantor’s responsibility  to cover the cost of parts and services
necessary to maintain, repair or replace a motor vehicle or a component  of a motor vehicle;
(B) The amount the resident must pay as  a fee to obtain from the warrantor the cover-
age described in subparagraph (A) of this paragraph;
(C) The effective date and duration of  the agreement or any condition or event, such as
the expiration of a manufacturer’s warranty, that gives  rise to the warrantor’s obligation to
provide coverage under the agreement; and
(D) Any conditions, qualifications or limitations on the warrantor’s coverage.
(b) “Fee” means  compensation that a warrantor receives for providing an extended war-
ranty to a resident, whether the compensation is denominated as a fee,  premium, charge or
other payment.
(c) “Motor  vehicle” means a passenger motor vehicle, as defined in ORS 801.360, that is
purchased in this state or is purchased outside this state but is registered in this state.
(d) “Resident” means a natural person who resides in this state.
(e) “Warrantor” means a person that in return  for a fee provides an extended warranty
to a resident.
(2)(a) A warrantor may not accept a fee from a resident for an extended warranty unless
NOTE: Matter in  boldfaced type in an amended section is new;  matter [ italic and bracketed] is existing law to be omitted.
New sections are in  boldfaced type.
LC 3014
the warrantor knows that the resident’s motor vehicle  qualifies for coverage under the
warrantor’s extended warranty.
(b) As part of an application for an extended warranty, and before entering  into an
agreement to provide the extended  warranty, a warrantor shall request and obtain sufficient
information from the resident about the resident’s motor vehicle to verify  that the motor
vehicle qualifies for coverage. The warrantor may  request commercially reasonable infor-
mation that is suited to assessing the warrantor’s risks under the  extended warranty, such
as the age and condition of the  motor vehicle, the purposes for which the resident uses the
motor vehicle, any accessories or replacement parts  installed in or on the motor vehicle and
whether the motor  vehicle was modified or altered in a way that significantly changed the
motor vehicle’s design, condition or operation from the design, condition or  operation in
which the manufacturer originally delivered the motor vehicle.
(3) If a warrantor accepts a fee for an extended warranty for a motor vehicle that the
warrantor later determines does not qualify for coverage under the extended  warranty, the
warrantor nevertheless for the duration of the extended warranty agreement shall  treat the
motor vehicle as if the motor vehicle qualified for coverage and shall provide the coverage
for the motor vehicle that the extended warranty provides for other motor vehicles that or-
dinarily qualify for coverage.
(4) A provision of an extended warranty that requires a resident to  bring an action to
settle a dispute or obtain a  remedy in a jurisdiction outside this state is void and
unenforceable.
(5) A warrantor’s violation of subsection (2) or (3) of this section is an unlawful  practice
under ORS 646.608.
SECTION 2.
...
(bbbb) Violates section 1 (2) or (3) of this 2025 Act.
...
fees.
SECTION 3.
Section 1 of this 2025 Act and the amendments to ORS 646.608 by  section 2
of this 2025  Act apply to extended warranties into which a warrantor and resident enter on
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `0f411b250914906926ba80d0943be6195eff95da323bd14c21a79693910fb804` (snapshot `_meta/snapshots/measure-2025r1-hb2709-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2709/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2709> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

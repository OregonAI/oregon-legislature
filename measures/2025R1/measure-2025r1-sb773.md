...
jurisdiction: oregon
id: measure-2025r1-sb773
title: 'SB 773 (2025R1): Establishes a mandatory minimum sentence of 48 months'' imprisonment for assault
  committed by a correctional facility inmate against a corrections officer.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 773
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB773/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 76781efc3a08a37e2844fe1261fc62cbea644d8d12310b107ece1bc5b78e9923
snapshot_id: measure-2025r1-sb773-introduced
status: current
...
catch_line: Establishes a mandatory minimum sentence of 48 months' imprisonment for assault committed
  by a correctional facility inmate against a corrections officer.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes laws concerning certain crimes. The Act tells courts to impose\
  \ a minimum prison term for inmates who cause physical injury to certain public safety officers. The\
  \ Act tells courts to impose a minimum term of 48 months. (Flesch Readability Score: 60.0). \n\tEstablishes\
  \ a mandatory minimum sentence of 48 months' imprisonment for assault committed by a correctional facility\
  \ inmate against a corrections officer."
relating_to: Relating to assaults committed against corrections officers.
relating_to_full: Relating to assaults committed against corrections officers; amending ORS 163.208 and
  421.121.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 773`.

# SB 773 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 773, 2025 Regular Session (2025R1)
- **LC number:** 1241
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T11:08:04
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5082 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB773/Introduced>.

## Summary

**Catchline:** Establishes a mandatory minimum sentence of 48 months' imprisonment for assault committed by a correctional facility inmate against a corrections officer.
...
**RelatingToFull (verbatim upstream field):** Relating to assaults committed against corrections officers; amending ORS 163.208 and 421.121.
...
LC 1241
(A) A corrections officer as defined in ORS 181A.355, a youth correction officer,  a Department
...
- From `RelatingToFull`: ORS 163.208, ORS 421.121
- From bill text (Introduced version): ORS 137.635, ORS 137.700, ORS 137.707, ORS 163.105, ORS 163.107, ORS 163.208, ORS 181A.355, ORS 421.084, ORS 421.121, ORS 609.500

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `76781efc3a08a37e2844fe1261fc62cbea644d8d12310b107ece1bc5b78e9923` (snapshot `_meta/snapshots/measure-2025r1-sb773-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB773/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 773` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

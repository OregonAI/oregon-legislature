...
jurisdiction: oregon
id: measure-2025r1-sb838
title: 'SB 838 (2025R1): Provides that the Public Contracting Code does not apply to the contracting activities
  of the State Parks and Recreation Department, except with respect to surplus property, information technology,
  photogrammetric mapping or telecommunications.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 838
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB838/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0c119ed79ef4aadd6266832eed8b2c2280a742f4c3e21434554bd33bda356731
snapshot_id: measure-2025r1-sb838-enrolled
status: current
...
catch_line: Provides that the Public Contracting Code does not apply to the contracting activities of
  the State Parks and Recreation Department, except with respect to surplus property, information technology,
  photogrammetric mapping or telecommunications.
minority_catch_line: null
measure_summary: "\tDigest: Lets the state parks agency do contracts without needing to follow the rules\
  \ for state contracting. Lets the agency print without needing to follow the rules for state printing.\
  \ Takes effect 91 days after the session ends. (Flesch Readability Score: 68.5). \n\tProvides that the\
  \ Public Contracting Code does not apply to the contracting activities of the State Parks and Recreation\
  \ Department, except with respect to surplus property<b>, information technology, photogrammetric mapping\
  \ or telecommunications</b>. Exempts the department from the requirements that apply to state printing\
  \ for printing and binding the department does for the purposes of communicating with persons who are\
  \ interested in the state's recreational sites and resources or advertising, promoting or providing\
  \ education concerning the state's recreational sites and resources. \n\tTakes effect on the 91st day\
  \ following adjournment sine die."
relating_to: Relating to State Parks and Recreation Department procurements; and prescribing an effective
  date.
relating_to_full: Relating to State Parks and Recreation Department procurements; and prescribing an effective
  date.
...
# SB 838 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 838, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 10879 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB838/Enrolled>.

## Summary

**Catchline:** Provides that the Public Contracting Code does not apply to the contracting activities of the State Parks and Recreation Department, except with respect to surplus property, information technology, photogrammetric mapping or telecommunications.
...
**RelatingToFull (verbatim upstream field):** Relating to State Parks and Recreation Department procurements; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 171.206, ORS 178.010, ORS 182.454, ORS 243.105, ORS 243.125, ORS 243.221, ORS 243.275, ORS 243.291, ORS 243.303, ORS 243.565, ORS 243.860, ORS 276A.206, ORS 276A.230, ORS 279.835, ORS 279A.025, ORS 279A.100, ORS 279A.200, ORS 279A.250, ORS 279B.050, ORS 282.010, ORS 282.020, ORS 286A.100, ORS 287A.310, ORS 352.002, ORS 414.115, ORS 414.125, ORS 414.135, ORS 414.145, ORS 456.625, ORS 471.001, ORS 471.230, ORS 477.406, ORS 672.002

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `0c119ed79ef4aadd6266832eed8b2c2280a742f4c3e21434554bd33bda356731` (snapshot `_meta/snapshots/measure-2025r1-sb838-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB838/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `391b8abce87a7af6dfe54e7360cfad7d70a0df81bd187965fef0b30544fc72e7` (snapshot `_meta/snapshots/measure-2025r1-sb838-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB838/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 838> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

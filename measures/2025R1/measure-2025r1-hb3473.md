...
jurisdiction: oregon
id: measure-2025r1-hb3473
title: 'HB 3473 (2025R1): Repeals the automatic transfer of voter registration information from the Department
  of Transportation and the Oregon Health Authority to the Secretary of State.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3473
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3473/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 8f136eef86bf3d32f1d53d75682ceeae14e90e1c2e11fe4eb11868a811682e1a
snapshot_id: measure-2025r1-hb3473-introduced
status: current
...
measure_summary: "\tDigest: The Act ends the transfer of voter registration data from ODOT and the OHA\
  \ to the SOS. The Act declares an emergency and becomes law when the Governor signs it. (Flesch Readability\
  \ Score: 64.7). \n\tRepeals the automatic transfer of voter registration information from the Department\
...
relating_to_full: Relating to registering to vote by voter registration card; creating new provisions;
  ...
  247.018 and section 9, chapter 492, Oregon Laws 2023; and declaring an emergency.
at_the_request_of: null
lc_number: 2943
measure_created_date: '2025-01-28T15:42:08'
measure_modified_date: '2025-03-31T13:23:29'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3473`.

# HB 3473 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3473, 2025 Regular Session (2025R1)
- **LC number:** 2943
- **Created:** 2025-01-28T15:42:08
- **Metadata last modified (upstream):** 2025-03-31T13:23:29
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 20513 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3473/Introduced>.
...
**RelatingToFull (verbatim upstream field):** Relating to registering to vote by voter registration card; creating new provisions; amending ORS 247.002, 247.012, 247.014, 247.017, 247.019, 247.171, 247.292 and 247.302; repealing ORS 247.018 and section 9, chapter 492, Oregon Laws 2023; and declaring an emergency.
...
- From `RelatingToFull`: ORS 247.002, ORS 247.012, ORS 247.014, ORS 247.017, ORS 247.018, ORS 247.019, ORS 247.171, ORS 247.292, ORS 247.302
- From bill text (Introduced version): ORS 247.002, ORS 247.012, ORS 247.014, ORS 247.017, ORS 247.018, ORS 247.019, ORS 247.125, ORS 247.171, ORS 247.174, ORS 247.181, ORS 247.208, ORS 247.292, ORS 247.296, ORS 247.302, ORS 801.245, ORS 801.250, ORS 807.400

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `8f136eef86bf3d32f1d53d75682ceeae14e90e1c2e11fe4eb11868a811682e1a` (snapshot `_meta/snapshots/measure-2025r1-hb3473-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3473/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3473` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

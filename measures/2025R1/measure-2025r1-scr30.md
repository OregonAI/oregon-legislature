...
jurisdiction: oregon
id: measure-2025r1-scr30
title: 'SCR 30 (2025R1): Designates  April  10,  2025,  as  Purple  Up!  Day  for  Month  of  the  Military  Child.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Concurrent Resolution 30
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR30/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: d6ed6ba19cee0a5a745e0498b13e5ad010ee61df27b4c5a9eb0f4b0398bc72e4
snapshot_id: measure-2025r1-scr30-enrolled
status: current
...
catch_line: Designates  April  10,  2025,  as  Purple  Up!  Day  for  Month  of  the  Military  Child.
minority_catch_line: null
measure_summary: 'Digest:  Names  a  day  in  April  2025  Purple  Up!  Day  for  Month  of  the  Military  Child  in  Oregon.

  (Flesch  Readability  Score:  63.8).

  Designates  April  10,  2025,  as  Purple  Up!  Day  for  Month  of  the  Military  Child.'
relating_to: Designates  April  10,  2025,  as  Purple  Up!  Day  for  Month  of  the  Military  Child.
relating_to_full: null
at_the_request_of: null
lc_number: 4814
measure_created_date: '2025-03-25T12:34:48'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SCR' and MeasureNumber eq 30`.

# SCR 30 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Concurrent Resolution 30, 2025 Regular Session (2025R1)
- **LC number:** 4814
- **Created:** 2025-03-25T12:34:48
- **Metadata last modified (upstream):** 2025-06-09T09:42:17
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 3251 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR30/Enrolled>.

## Summary

**Catchline:** Designates  April  10,  2025,  as  Purple  Up!  Day  for  Month  of  the  Military  Child.

**Relating to:** Designates  April  10,  2025,  as  Purple  Up!  Day  for  Month  of  the  Military  Child.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `d6ed6ba19cee0a5a745e0498b13e5ad010ee61df27b4c5a9eb0f4b0398bc72e4` (snapshot `_meta/snapshots/measure-2025r1-scr30-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR30/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `82f36a0f605ca01b3c912d7de8b20cf6433e530b640f555cf8ca029d0eb665d1` (snapshot `_meta/snapshots/measure-2025r1-scr30-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR30/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SCR' and MeasureNumber eq 30` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2066
title: 'HB 2066 (2025R1): Directs the Public Utility Commission to establish a regulatory framework to
  allow the ownership, deployment and use of microgrids and community microgrids within the service territories
  of electric companies.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2066
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2066/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b57e6204f8fcbfe59b08b75bc0b6248872735e79d7ed23fb37afe42a148c9b0d
snapshot_id: measure-2025r1-hb2066-enrolled
status: current
...
catch_line: Directs the Public Utility Commission to establish a regulatory framework to allow the ownership,
  deployment and use of microgrids and community microgrids within the service territories of electric
  companies.
minority_catch_line: null
measure_summary: "\tDigest: Tells the PUC to create rules and a framework to allow microgrids. (Flesch\
  \ Readability Score: 72.6). \n\tDirects the Public Utility Commission to establish a regulatory framework\
  \ to allow the ownership, deployment and use of microgrids and community microgrids within the service\
  \ territories of electric companies. \n\tRequires the Department of Consumer and Business Services to\
  ...
  \ area as a microgrid zone, subject to the approval of the commission or local consumer-owned utility.\
...
# HB 2066 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2066, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 10731 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2066/Enrolled>.

## Summary

**Catchline:** Directs the Public Utility Commission to establish a regulatory framework to allow the ownership, deployment and use of microgrids and community microgrids within the service territories of electric companies.
...
- From bill text (Enrolled version): ORS 757.300, ORS 757.600

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `b57e6204f8fcbfe59b08b75bc0b6248872735e79d7ed23fb37afe42a148c9b0d` (snapshot `_meta/snapshots/measure-2025r1-hb2066-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2066/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `ac7e6915a7f473fa5f2fff8c9512bc4e9f8b840c0009e03c51b47aa786842000` (snapshot `_meta/snapshots/measure-2025r1-hb2066-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2066/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2066` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

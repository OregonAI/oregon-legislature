...
jurisdiction: oregon
id: measure-2025r1-sb1011
title: 'SB 1011 (2025R1): Allows a federally recognized Indian tribe located in this state to submit a
  request to the Governor for retrocession of Public Law 280 jurisdiction.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1011
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1011/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 15fd6e1d1d5dc9432fd1393fb9d9d12c4e20f084660716fe6574f26fcdc17b90
snapshot_id: measure-2025r1-sb1011-enrolled
status: current
...
catch_line: Allows a federally recognized Indian tribe located in this state to submit a request to the
  Governor for retrocession of Public Law 280 jurisdiction.
minority_catch_line: null
measure_summary: "\tDigest: The Act says an Indian tribe in this state can ask the Governor to help retrocede\
  \ P.L. 280 for the tribe. (Flesch Readability Score: 64.6). \n\tAllows a federally recognized Indian\
  \ tribe located in this state to submit a request to the Governor for retrocession of Public Law 280\
  \ jurisdiction. Prescribes the Governor's duties. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to Public Law 280; and declaring an emergency.
relating_to_full: Relating to Public Law 280; and declaring an emergency.
at_the_request_of: null
lc_number: 4073
measure_created_date: '2025-02-06T09:45:53'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1011>.

# SB 1011 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1011, 2025 Regular Session (2025R1)
- **LC number:** 4073
- **Created:** 2025-02-06T09:45:53
- **Metadata last modified (upstream):** 2025-06-06T14:34:20
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 4721 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1011/Enrolled>.

## Summary

**Catchline:** Allows a federally recognized Indian tribe located in this state to submit a request to the Governor for retrocession of Public Law 280 jurisdiction.
...
**RelatingToFull (verbatim upstream field):** Relating to Public Law 280; and declaring an emergency.
...
Enrolled Senate Bill 1011 (SB 1011-INTRO) Page 1
declare intent to petition the  United States Secretary of the Interior as described in this
...
Enrolled Senate Bill 1011 (SB 1011-INTRO) Page 2
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `15fd6e1d1d5dc9432fd1393fb9d9d12c4e20f084660716fe6574f26fcdc17b90` (snapshot `_meta/snapshots/measure-2025r1-sb1011-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1011/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `ba7389fc79f10026b096040e61dcace7dd293973f4d31f3e82f2d2b25ce9ed9d` (snapshot `_meta/snapshots/measure-2025r1-sb1011-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1011/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1011> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

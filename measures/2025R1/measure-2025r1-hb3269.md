...
jurisdiction: oregon
id: measure-2025r1-hb3269
title: 'HB 3269 (2025R1): Establishes a correctional facility staffing committee within each Department
  of Corrections facility.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3269
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3269/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c60bafe98e5dc71079a7ad08cbf95f7568e40c7a5ea5455f52f4416362599305
snapshot_id: measure-2025r1-hb3269-introduced
status: current
...
catch_line: Establishes a correctional facility staffing committee within each Department of Corrections
  facility.
minority_catch_line: null
measure_summary: "\tDigest: The Act would create a staffing committee at each DOC facility. (Flesch Readability\
  \ Score: 64.9). \n\tEstablishes a correctional facility staffing committee within each Department of\
  \ Corrections facility. Directs the committee to develop a written facility-wide staffing plan. Directs\
  \ department facilities to implement the staffing plan. Directs the committee to periodically review\
  \ and modify the staffing plan."
relating_to: Relating to correctional facility staffing plans.
relating_to_full: Relating to correctional facility staffing plans.
at_the_request_of: null
lc_number: 3183
measure_created_date: '2025-01-12T14:44:28'
...
# HB 3269 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3269, 2025 Regular Session (2025R1)
- **LC number:** 3183
- **Created:** 2025-01-12T14:44:28
- **Metadata last modified (upstream):** 2025-01-27T08:01:49
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7383 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3269/Introduced>.

## Summary

**Catchline:** Establishes a correctional facility staffing committee within each Department of Corrections facility.
...
**RelatingToFull (verbatim upstream field):** Relating to correctional facility staffing plans.
...
LC 3183
30-day period, the committee remains unable to reach an  agreement on the staffing plan, one
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `c60bafe98e5dc71079a7ad08cbf95f7568e40c7a5ea5455f52f4416362599305` (snapshot `_meta/snapshots/measure-2025r1-hb3269-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3269/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3269` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2364
title: 'HB 2364 (2025R1): Provides that compensation for loss or injury to livestock or working dogs under
  the wolf depredation compensation and financial assistance grant program must be based on certain multipliers
  of fair market value.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2364
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2364/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 8304f9548abd1769e0e64df03d8b0670b5ff2cbb6ced1068cc273dcc096b3499
snapshot_id: measure-2025r1-hb2364-introduced
status: current
...
measure_summary: "\tDigest: The Act provides that payment for loss or injury to livestock or working dogs\
  ...
  \ for missing livestock. (Flesch Readability Score: 66.8). \n\tProvides that compensation for loss or\
  \ injury to livestock or working dogs under the wolf depredation compensation and financial assistance\
  \ grant program must be based on certain multipliers of fair market value. Caps compensation at $15,000\
  \ per animal. Removes provision authorizing compensation for missing livestock."
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2364`.

# HB 2364 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2364, 2025 Regular Session (2025R1)
- **LC number:** 600
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-23T10:53:36
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 9963 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2364/Introduced>.
...
Digest: The Act provides that payment for loss or injury to livestock or working dogs must be based on a multiplier of fair market value. The Act caps payment. The Act removes payment for missing livestock. (Flesch Readability Score: 66.8). 
...
House Bill 2364
Sponsored by Representatives LEVY B, RESCHKE; Representatives OSBORNE, WRIGHT, Senators  NASH, WEBER
(Presession filed.)
SUMMARY
...
based on a multiplier of fair market value. The Act  caps payment. The Act removes payment for
missing livestock. (Flesch Readability Score: 66.8).
...
(B) Financial assistance provide  an estimate of the potential cost of any livestock man-
agement techniques or nonlethal wolf deterrence techniques the person plans to use; and
...
sory committee described in subsection (3)(d) of this section[ .] as to fair market value and:
...
nancial assistance provided  by counties and  financial assistance provided to counties under the
wolf depredation compensation and financial assistance grant program[ , and];
...
(6) The State Department of Agriculture may use moneys in the Wolf Management Compensation
and Proactive Trust Fund established under ORS 610.155 to pay expenses incurred in  administering
the wolf depredation compensation and financial assistance grant program.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `8304f9548abd1769e0e64df03d8b0670b5ff2cbb6ced1068cc273dcc096b3499` (snapshot `_meta/snapshots/measure-2025r1-hb2364-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2364/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2364` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

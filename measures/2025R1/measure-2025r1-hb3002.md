...
jurisdiction: oregon
id: measure-2025r1-hb3002
title: 'HB 3002 (2025R1): Establishes the Task Force on Data Modernization and directs the task force
  to report to an interim committee of the Legislative Assembly related to general government no later
  than September 15, 2026.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3002
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3002/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 8c87319eec9a7777d96b944565ffd1474ba3fdf0ccf30cc6c3d8845e4c633a8c
snapshot_id: measure-2025r1-hb3002-introduced
status: current
...
catch_line: Establishes the Task Force on Data Modernization and directs the task force to report to an
  interim committee of the Legislative Assembly related to general government no later than September
  15, 2026.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes the Task Force on Data Modernization and tells the task force\
  \ to make a report. (Flesch Readability Score: 75.7). \n\tEstablishes the Task Force on Data Modernization\
  \ and directs the task force to report to an interim committee of the Legislative Assembly related to\
  \ general government no later than September 15, 2026. \n\tTakes effect on the 91st day following adjournment\
  \ sine die."
relating_to: Relating to demographic data; prescribing an effective date.
relating_to_full: Relating to demographic data; and prescribing an effective date.
at_the_request_of: null
lc_number: 2666
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T13:18:36'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 4068
...
# HB 3002 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3002, 2025 Regular Session (2025R1)
- **LC number:** 2666
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T13:18:36
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4068 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3002/Introduced>.

## Summary

**Catchline:** Establishes the Task Force on Data Modernization and directs the task force to report to an interim committee of the Legislative Assembly related to general government no later than September 15, 2026.
...
**RelatingToFull (verbatim upstream field):** Relating to demographic data; and prescribing an effective date.
...
- From bill text (Introduced version): ORS 174.111, ORS 192.245, ORS 413.161, ORS 413.162, ORS 413.163, ORS 413.164, ORS 413.166, ORS 413.167

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `8c87319eec9a7777d96b944565ffd1474ba3fdf0ccf30cc6c3d8845e4c633a8c` (snapshot `_meta/snapshots/measure-2025r1-hb3002-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3002/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3002> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2369
title: 'HB 2369 (2025R1): Provides that a person who receives a finding under the wolf depredation compensation
  and financial assistance grant program may appeal the finding to a county advisory committee.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2369
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2369/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 67a26af0b24831ac22a45aff00e46cdffd57ae725bdcb0145a11dd864a3ecca1
snapshot_id: measure-2025r1-hb2369-introduced
status: current
...
catch_line: Provides that a person who receives a finding under the wolf depredation compensation and
  financial assistance grant program may appeal the finding to a county advisory committee.
minority_catch_line: null
measure_summary: "\tDigest: The Act concerns wolves preying on livestock. The Act allows people to appeal\
  \ certain findings. (Flesch Readability Score: 63.8). \n\tProvides that a person who receives a finding\
  \ under the wolf depredation compensation and financial assistance grant program may appeal the finding\
  \ to a county advisory committee."
relating_to: Relating to the depredation of livestock.
relating_to_full: Relating to the depredation of livestock; amending ORS 610.150.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2369`.

# HB 2369 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2369, 2025 Regular Session (2025R1)
- **LC number:** 607
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-23T10:53:36
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 9492 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2369/Introduced>.

## Summary

**Catchline:** Provides that a person who receives a finding under the wolf depredation compensation and financial assistance grant program may appeal the finding to a county advisory committee.

**Relating to:** Relating to the depredation of livestock.

Digest: The Act concerns wolves preying on livestock. The Act allows people to appeal certain findings. (Flesch Readability Score: 63.8). 
...
**RelatingToFull (verbatim upstream field):** Relating to the depredation of livestock; amending ORS 610.150.
...
standards.
Digest: The Act concerns wolves preying on livestock. The Act allows people  to appeal certain
findings. (Flesch Readability Score: 63.8).
Provides that a person who receives a finding under  the wolf depredation compensation and fi-
nancial assistance grant program may appeal the finding to a county advisory committee.
A BILL FOR AN ACT
...
(A) Are  applying for compensation [ under the county program ] provide evidence of the  probable
or confirmed loss or injury to livestock or working dogs due  to wolf depredation[ . Evidence of the
loss or injury must include ], including a finding by the State Department of Fish and Wildlife or the
department’s designated agent that wolf depredation was the probable cause of the loss or injury.
(B) Have applied for compensation may appeal a finding described in subparagraph (A)
of this paragraph to the  county advisory committee described in paragraph (d) of this sub-
section.
(C) Are  applying for financial assistance provide an estimate of any potential cost of the
livestock management techniques or  nonlethal wolf deterrence techniques the person plans
to use.
...
depredation of livestock; and ] financial assistance.
[(C)] (d) Establish compensation rates for  probable or confirmed  loss or injury to livestock or
working dogs due to wolf depredation  that are based on  a multiplier of not more than seven
times the  fair market value  of the livestock or working dogs  and the recommendation of the
county advisory committee described in subsection (3)(d) of this section.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `67a26af0b24831ac22a45aff00e46cdffd57ae725bdcb0145a11dd864a3ecca1` (snapshot `_meta/snapshots/measure-2025r1-hb2369-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2369/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2369` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2302
title: 'HB 2302 (2025R1): Modifies the definition of "vulnerable person" for purposes of civil action
  for abuse of a vulnerable person to include individuals under 18 years of age.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2302
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2302/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 9e3fe954f63598f01bff24d6430905f8a66dd17b8119430f85edc7d74ce2dfac
snapshot_id: measure-2025r1-hb2302-introduced
status: current
...
relating_to: Relating to abuse of vulnerable persons; declaring an emergency.
relating_to_full: Relating to abuse of vulnerable persons; creating new provisions; amending ORS 124.100
  and 124.130; and declaring an emergency.
...
# HB 2302 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2302, 2025 Regular Session (2025R1)
- **LC number:** 924
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-23T10:49:55
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5699 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2302/Introduced>.
...
**Relating to:** Relating to abuse of vulnerable persons; declaring an emergency.
...
**RelatingToFull (verbatim upstream field):** Relating to abuse of vulnerable persons; creating new provisions; amending ORS 124.100 and 124.130; and declaring an emergency.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `9e3fe954f63598f01bff24d6430905f8a66dd17b8119430f85edc7d74ce2dfac` (snapshot `_meta/snapshots/measure-2025r1-hb2302-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2302/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2302> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

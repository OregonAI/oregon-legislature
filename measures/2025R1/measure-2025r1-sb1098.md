...
jurisdiction: oregon
id: measure-2025r1-sb1098
title: 'SB 1098 (2025R1): Prohibits discrimination when selecting or retaining school library materials,
  textbooks or instructional materials or when developing and implementing a curriculum.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1098
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1098/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 6ecfd9fde22aee2cd9f1199e406b98bc72994c3ef430564b09d3085815540c5f
snapshot_id: measure-2025r1-sb1098-enrolled
status: current
...
catch_line: Prohibits discrimination when selecting or retaining school library materials, textbooks or
  instructional materials or when developing and implementing a curriculum.
minority_catch_line: Directs each school district board to adopt a policy related to the selection and
  removal of materials available at a school library.
measure_summary: "\tDigest: Prohibits the exclusion of certain school books based on the topic or author\
  \ of the book. (Flesch Readability Score: 68.9). \n\tProhibits discrimination when selecting or retaining\
  \ school library materials, textbooks or instructional materials or when developing and implementing\
  \ a curriculum. \n\tPrescribes requirements for the removal of library materials, textbooks and instructional\
  \ materials. Directs the Department of Education to provide technical assistance for school library\
  \ programs. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to access to materials in schools; and declaring an emergency.
relating_to_full: Relating to access to materials in schools; and declaring an emergency.
at_the_request_of: null
lc_number: 4587
measure_created_date: '2025-02-24T14:15:45'
measure_modified_date: '2026-02-25T12:15:03'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1098`.

# SB 1098 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1098, 2025 Regular Session (2025R1)
- **LC number:** 4587
- **Created:** 2025-02-24T14:15:45
- **Metadata last modified (upstream):** 2026-02-25T12:15:03
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 11899 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1098/Enrolled>.

## Summary

**Catchline:** Prohibits discrimination when selecting or retaining school library materials, textbooks or instructional materials or when developing and implementing a curriculum.
...
**RelatingToFull (verbatim upstream field):** Relating to access to materials in schools; and declaring an emergency.
...
materials unless:
Enrolled Senate Bill 1098 (SB 1098-INTRO) Page 1
...
Enrolled Senate Bill 1098 (SB 1098-INTRO) Page 2
...
Enrolled Senate Bill 1098 (SB 1098-INTRO) Page 3
materials include a perspective, study or story of, or are created  by, any individual or group
...
Enrolled Senate Bill 1098 (SB 1098-INTRO) Page 4
...
- From bill text (Enrolled version): ORS 336.082, ORS 337.030, ORS 337.050, ORS 337.075, ORS 337.120, ORS 337.141, ORS 337.260, ORS 659.850

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `6ecfd9fde22aee2cd9f1199e406b98bc72994c3ef430564b09d3085815540c5f` (snapshot `_meta/snapshots/measure-2025r1-sb1098-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1098/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `ba37a545f256145f4b889b2a1393596da8985c5233dee3cfdc664c953d514e56` (snapshot `_meta/snapshots/measure-2025r1-sb1098-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1098/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1098` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

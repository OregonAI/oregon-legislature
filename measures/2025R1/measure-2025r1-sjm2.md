...
jurisdiction: oregon
id: measure-2025r1-sjm2
title: 'SJM 2 (2025R1): Urges Congress to enact legislation alleviating the funding crisis in the Crime
  Victims Fund.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Joint Memorial 2
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJM2/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a6f4b7abc200eb5bb953fac62aafd1fbaba927475f05df8b419f31e503f20fcd
snapshot_id: measure-2025r1-sjm2-enrolled
status: current
...
catch_line: Urges Congress to enact legislation alleviating the funding crisis in the Crime Victims Fund.
minority_catch_line: null
measure_summary: "\tDigest: Urges Congress to pass a law about crime victims. (Flesch Readability Score:\
  \ 75.5). \n\tUrges Congress to enact legislation alleviating the funding crisis in the Crime Victims\
  \ Fund."
relating_to: Urging Congress to enact legislation alleviating the funding crisis in the Crime Victims
  Fund.
relating_to_full: null
at_the_request_of: (at the request of former Senator Tim Knopp)
lc_number: 2781
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-05-07T11:29:16'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SJM' and MeasureNumber eq 2`.

# SJM 2 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Joint Memorial 2, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of former Senator Tim Knopp)
- **LC number:** 2781
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-05-07T11:29:16
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 3580 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJM2/Enrolled>.

## Summary

**Catchline:** Urges Congress to enact legislation alleviating the funding crisis in the Crime Victims Fund.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `a6f4b7abc200eb5bb953fac62aafd1fbaba927475f05df8b419f31e503f20fcd` (snapshot `_meta/snapshots/measure-2025r1-sjm2-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJM2/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `e6b63f3a3c2527b7fb01f8ae4008f391c74fe1bc57f352c266a2aeaa5b31d3f2` (snapshot `_meta/snapshots/measure-2025r1-sjm2-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SJM2/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SJM' and MeasureNumber eq 2` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2924
title: 'HB 2924 (2025R1): Modifies the number and description of members on the System of Care Advisory
  Council.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2924
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2924/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ac4258d7d9d470b543764798df2aa5ecc26d4fc5f5101c5500b5a7ffeaaef6fe
snapshot_id: measure-2025r1-hb2924-enrolled
status: current
...
catch_line: Modifies the number and description of members on the System of Care Advisory Council.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes changes to the SOCAC membership. (Flesch Readability Score:\
  \ 71.8). \n\tModifies the number and description of members on the System of Care Advisory Council."
relating_to: Relating to the System of Care Advisory Council.
relating_to_full: Relating to the System of Care Advisory Council.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2924`.

# HB 2924 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2924, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 6279 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2924/Enrolled>.

## Summary

**Catchline:** Modifies the number and description of members on the System of Care Advisory Council.
...
**RelatingToFull (verbatim upstream field):** Relating to the System of Care Advisory Council.
...
Enrolled House Bill 2924 (HB 2924-INTRO) Page 1
(ii) Are currently or were previously [ a ward, youth or adjudicated youth, as those terms are de-
...
ness.
Enrolled House Bill 2924 (HB 2924-INTRO) Page 2
...
Enrolled House Bill 2924 (HB 2924-INTRO) Page 3
...
- From bill text (Enrolled version): ORS 414.572, ORS 418.978, ORS 419A.004

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `ac4258d7d9d470b543764798df2aa5ecc26d4fc5f5101c5500b5a7ffeaaef6fe` (snapshot `_meta/snapshots/measure-2025r1-hb2924-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2924/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `602ef31fa6b567fe9cea4cec53c1da80010208be72f82089f64dc9894717a9de` (snapshot `_meta/snapshots/measure-2025r1-hb2924-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2924/Introduced>.

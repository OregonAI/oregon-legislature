...
jurisdiction: oregon
id: measure-2025r1-sb1103
title: 'SB 1103 (2025R1): Requires the Oregon Business Development Department to establish a program to
  provide loans to cities and tribes to develop infrastructure to support housing in climate-friendly
  areas.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1103
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1103/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 015830e0c7babca40fa31226db24a84c35d25bead056ac75920bb2c9132baff9
snapshot_id: measure-2025r1-sb1103-introduced
status: current
...
catch_line: Requires the Oregon Business Development Department to establish a program to provide loans
  to cities and tribes to develop infrastructure to support housing in climate-friendly areas.
minority_catch_line: null
measure_summary: "\tDigest: This Act makes Business Oregon lend money to build water or sewer lines or\
  \ roads for homes in certain areas. (Flesch Readability Score: 63.8). \n\tRequires the Oregon Business\
  \ Development Department to establish a program to provide loans to cities and tribes to develop infrastructure\
  \ to support housing in climate-friendly areas. Requires rulemaking for the program no later than July\
  \ 1, 2026. \n\tEstablishes the Climate-Friendly Housing Infrastructure Revolving Fund. Continously appropriates\
  \ moneys to the department to implement the program. \n\tDeclares an emergency, effective July 1, 2025."
relating_to: Relating to infrastructure development to support housing; declaring an emergency.
relating_to_full: Relating to infrastructure development to support housing; and declaring an emergency.
at_the_request_of: null
lc_number: 4303
measure_created_date: '2025-02-25T09:50:00'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1103>.

# SB 1103 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1103, 2025 Regular Session (2025R1)
- **LC number:** 4303
- **Created:** 2025-02-25T09:50:00
- **Metadata last modified (upstream):** 2025-03-19T16:20:20
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4699 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1103/Introduced>.

## Summary

**Catchline:** Requires the Oregon Business Development Department to establish a program to provide loans to cities and tribes to develop infrastructure to support housing in climate-friendly areas.
...
**RelatingToFull (verbatim upstream field):** Relating to infrastructure development to support housing; and declaring an emergency.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `015830e0c7babca40fa31226db24a84c35d25bead056ac75920bb2c9132baff9` (snapshot `_meta/snapshots/measure-2025r1-sb1103-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1103/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1103> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

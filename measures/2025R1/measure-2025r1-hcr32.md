...
jurisdiction: oregon
id: measure-2025r1-hcr32
title: 'HCR 32 (2025R1): Designates the Corgi as the official state dog.'
doc_type: dataset_doc
citation: 2025 Regular Session House Concurrent Resolution 32
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR32/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e741d677a56f230073a96b6766e9a1860db42e63a1b577c1836efa7114d02ca7
snapshot_id: measure-2025r1-hcr32-introduced
status: current
...
catch_line: Designates the Corgi as the official state dog.
minority_catch_line: null
measure_summary: "\tDigest: Designates the Corgi as the official state dog. (Flesch Readability Score:\
  \ 61.2). \n\tDesignates the Corgi as the official state dog."
relating_to: Designating the Corgi as the official state dog.
relating_to_full: null
at_the_request_of: null
lc_number: 4757
measure_created_date: '2025-03-14T08:19:52'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 32>.

# HCR 32 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Concurrent Resolution 32, 2025 Regular Session (2025R1)
- **LC number:** 4757
- **Created:** 2025-03-14T08:19:52
- **Metadata last modified (upstream):** 2025-03-19T11:05:57
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 3345 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR32/Introduced>.

## Summary

**Catchline:** Designates the Corgi as the official state dog.
...
LC 4757
whether it’s hiking, beach time or a road trip; now, therefore,
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `e741d677a56f230073a96b6766e9a1860db42e63a1b577c1836efa7114d02ca7` (snapshot `_meta/snapshots/measure-2025r1-hcr32-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR32/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 32> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

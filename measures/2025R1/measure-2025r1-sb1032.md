...
jurisdiction: oregon
id: measure-2025r1-sb1032
title: 'SB 1032 (2025R1): Prohibits the retail sale of an aerosol duster that contains 1,1-Difluoroethane
  to an individual under 18 years of age.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1032
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1032/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 8e08a833ab077237b7539553a0b6d8533e065501a12d69f6528b2d7e6b791b35
snapshot_id: measure-2025r1-sb1032-enrolled
status: current
...
catch_line: Prohibits the retail sale of an aerosol duster that contains 1,1-Difluoroethane to an individual
  under 18 years of age.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act says that an entity may not sell an aerosol duster that contains\
  \ DFE to a person who is under 18 years old. (Flesch Readability Score: 66.1).</b> \n\t[<i>Digest: The\
  \ Act says that an entity may not sell an aerosol duster that has DFE in it to a person who is under\
  \ 21 years old. (Flesch Readability Score: 69.8).</i>] \n\tProhibits the retail sale of an aerosol duster\
  \ that contains 1,1-Difluoroethane to an individual under [<i>21</i>] <b>18</b> years of age. <b> Allows\
  \ the sale or delivery of an aerosol duster that contains 1,1-Difluoroethane through an order pick-up\
  \ or delivery system if the recipient is at least 18 years of age.</b> Punishes a violation by a maximum\
  \ of 30 days' imprisonment, $1,250 fine, or both. \n\tRequires an aerosol duster that contains 1,1-Difluoroethane\
  \ to bear a warning label. Defines \"1,1-Difluoroethane.\""
relating_to: Relating to aerosol dusters that contain 1,1-Difluoroethane.
relating_to_full: Relating to aerosol dusters that contain 1,1-Difluoroethane.
at_the_request_of: (at the request of Ray Thomas, Kim Braasch)
lc_number: 4470
...
# SB 1032 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1032, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Ray Thomas, Kim Braasch)
- **LC number:** 4470
...
- **Full text below:** Enrolled version, 5268 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1032/Enrolled>.

## Summary

**Catchline:** Prohibits the retail sale of an aerosol duster that contains 1,1-Difluoroethane to an individual under 18 years of age.
...
**RelatingToFull (verbatim upstream field):** Relating to aerosol dusters that contain 1,1-Difluoroethane.
...
formula C 2H4F2, often used as a refrigerant or propellant and that has  a Chemical Abstract
...
- From bill text (Enrolled version): ORS 807.400

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `8e08a833ab077237b7539553a0b6d8533e065501a12d69f6528b2d7e6b791b35` (snapshot `_meta/snapshots/measure-2025r1-sb1032-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1032/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `08dd55b5490e35e98a7f24bd93fb3dccfd8554f49f7b70e6f48f56c111713666` (snapshot `_meta/snapshots/measure-2025r1-sb1032-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1032/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1032` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

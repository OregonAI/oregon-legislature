...
jurisdiction: oregon
id: measure-2025r1-hb2390
title: 'HB 2390 (2025R1): Increases the amount of income tax credit allowed to rural medical providers.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2390
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2390/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 23fbeaeee4495e1927044729decec94d38f6fd53958ab0c2bc6874244002209f
snapshot_id: measure-2025r1-hb2390-introduced
status: current
...
catch_line: Increases the amount of income tax credit allowed to rural medical providers.
minority_catch_line: null
measure_summary: "\tDigest: The Act raises the amount of the tax credit that rural medical providers can\
  \ get. The Act also says that the provider can get the tax credit no matter how much money they make.\
  \ (Flesch Readability Score: 70.1). \n\tIncreases the amount of income tax credit allowed to rural medical\
  \ providers. Removes the eligibility limitation based on the adjusted gross income of the medical provider.\
  \ \n\tApplies to tax years beginning on or after January 1, 2025. \n\tTakes effect on the 91st day following\
  \ adjournment sine die."
relating_to: Relating to tax credits for rural medical providers; prescribing an effective date.
relating_to_full: Relating to tax credits for rural medical providers; creating new provisions; amending
  ORS 315.613 and 315.616; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2390`.

# HB 2390 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2390, 2025 Regular Session (2025R1)
- **LC number:** 988
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-23T10:54:36
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7711 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2390/Introduced>.

## Summary

**Catchline:** Increases the amount of income tax credit allowed to rural medical providers.

**Relating to:** Relating to tax credits for rural medical providers; prescribing an effective date.
...
**RelatingToFull (verbatim upstream field):** Relating to tax credits for rural medical providers; creating new provisions; amending ORS 315.613 and 315.616; and prescribing an effective date.
...
medical staff if the Office of Rural Health certifies that the individual:
...
- From `RelatingToFull`: ORS 315.613, ORS 315.616
- From bill text (Introduced version): ORS 315.613, ORS 315.616, ORS 315.619, ORS 316.117, ORS 442.470, ORS 442.561, ORS 442.562, ORS 442.563, ORS 677.505, ORS 678.010, ORS 678.375, ORS 683.010

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `23fbeaeee4495e1927044729decec94d38f6fd53958ab0c2bc6874244002209f` (snapshot `_meta/snapshots/measure-2025r1-hb2390-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2390/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2390` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb726
title: 'SB 726 (2025R1): Requires the owner or operator of a municipal solid waste landfill located in
  Benton County to conduct surface emissions monitoring and report data as specified in the Act.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 726
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB726/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 6069eb4ba474ba4c89a5de3eb7d910c226d625f98f469a73de8733737ceadabc
snapshot_id: measure-2025r1-sb726-enrolled
status: current
...
catch_line: Requires the owner or operator of a municipal solid waste landfill located in Benton County
  to conduct surface emissions monitoring and report data as specified in the Act.
minority_catch_line: null
measure_summary: "\t<b>Digest: This Act tells the EQC to make landfills in Benton County test and fix\
  \ methane gas leaks. (Flesch Readability Score: 85.0).</b> \n\t[<i>Digest: This Act tells the EQC to\
  \ make landfills test and fix methane gas leaks. (Flesch Readability Score: 95.9).</i>] \n\tRequires\
  \ the owner or operator of a municipal solid waste landfill <b>located in Benton County</b> to conduct\
  \ surface emissions monitoring and report data as specified in the Act. \n\tTakes effect on the 91st\
  \ day following adjournment sine die."
relating_to: Relating to landfill emissions monitoring; and prescribing an effective date.
relating_to_full: Relating to landfill emissions monitoring; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 726`.

# SB 726 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 726, 2025 Regular Session (2025R1)
- **LC number:** 866
...
- **Full text below:** Enrolled version, 4605 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB726/Enrolled>.

## Summary

**Catchline:** Requires the owner or operator of a municipal solid waste landfill located in Benton County to conduct surface emissions monitoring and report data as specified in the Act.
...
**RelatingToFull (verbatim upstream field):** Relating to landfill emissions monitoring; and prescribing an effective date.
...
Enrolled Senate Bill 726 (SB 726-B) Page 1
(d)(A) Monitor  the site of any exceedance within 10 days of first detecting the
...
Enrolled Senate Bill 726 (SB 726-B) Page 2
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `6069eb4ba474ba4c89a5de3eb7d910c226d625f98f469a73de8733737ceadabc` (snapshot `_meta/snapshots/measure-2025r1-sb726-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB726/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `b814976f979c00765d6fc9f63017c917f9acd12b09ddd8c10de6b1851b55f7c7` (snapshot `_meta/snapshots/measure-2025r1-sb726-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB726/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 726` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

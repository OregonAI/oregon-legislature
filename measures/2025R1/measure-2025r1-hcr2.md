...
jurisdiction: oregon
id: measure-2025r1-hcr2
title: 'HCR 2 (2025R1): Declares a commitment to the health and safety of firefighters and to finding
  an urgent solution to the problem of firefighting personal protective gear that contains cancer-causing
  chemicals.'
doc_type: dataset_doc
citation: 2025 Regular Session House Concurrent Resolution 2
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR2/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 000b571b6b1da57d46b6ccf957c440a1d71a6a1bf1e1fd6dee0100b851370d93
snapshot_id: measure-2025r1-hcr2-enrolled
status: current
...
catch_line: Declares a commitment to the health and safety of firefighters and to finding an urgent solution
  to the problem of firefighting personal protective gear that contains cancer-causing chemicals.
minority_catch_line: null
measure_summary: "\tDigest: Declares the urgent need to find safer gear for firefighters. (Flesch Readability\
  \ Score: 61.3). \n\tDeclares a commitment to the health and safety of firefighters and to finding an\
  \ urgent solution to the problem of firefighting personal protective gear that contains cancer-causing\
  \ chemicals."
relating_to: Declaring a commitment to the health and safety of firefighters and to finding an urgent
  solution to the problem of firefighting personal protective gear that contains cancer-causing chemicals.
relating_to_full: null
at_the_request_of: null
lc_number: 1983
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-04-03T15:14:54'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 2>.

# HCR 2 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Concurrent Resolution 2, 2025 Regular Session (2025R1)
- **LC number:** 1983
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-04-03T15:14:54
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 3253 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR2/Enrolled>.

## Summary

**Catchline:** Declares a commitment to the health and safety of firefighters and to finding an urgent solution to the problem of firefighting personal protective gear that contains cancer-causing chemicals.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `000b571b6b1da57d46b6ccf957c440a1d71a6a1bf1e1fd6dee0100b851370d93` (snapshot `_meta/snapshots/measure-2025r1-hcr2-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR2/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `1e4253544624ca149b04ef8023e4e3644f093b96343b78e99215bffc9e290dc3` (snapshot `_meta/snapshots/measure-2025r1-hcr2-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR2/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 2> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

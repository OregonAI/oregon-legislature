...
jurisdiction: oregon
id: measure-2025r1-sb802
title: 'SB 802 (2025R1): Modifies the event to start calculating the 90-day period during which an applicant
  for a teaching license may be employed in a public school of this state pending evaluation of their
  application by the Teacher Standards and Practices Commission.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 802
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB802/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 1188bd75af163510186bcb603f6478e0dce2319c59d4a06e52094ce8773acbd4
snapshot_id: measure-2025r1-sb802-enrolled
status: current
...
catch_line: Modifies the event to start calculating the 90-day period during which an applicant for a
  teaching license may be employed in a public school of this state pending evaluation of their application
  by the Teacher Standards and Practices Commission.
minority_catch_line: null
measure_summary: "\tDigest: The Act gives a teacher more time to work in the public schools of this state\
  \ without a license while waiting for the TSPC to review their application for a license. (Flesch Readability\
  \ Score: 60.7). \n\tModifies the event to start calculating the 90-day period during which an applicant\
  \ for a teaching license may be employed in a public school of this state pending evaluation of their\
  \ application by the Teacher Standards and Practices Commission. \n\tDeclares an emergency, effective\
  \ July 1, 2025."
relating_to: Relating to the Teacher Standards and Practices Commission; and declaring an emergency.
relating_to_full: Relating to the Teacher Standards and Practices Commission; and declaring an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 802`.

# SB 802 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 802, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 8028 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB802/Enrolled>.

## Summary

**Catchline:** Modifies the event to start calculating the 90-day period during which an applicant for a teaching license may be employed in a public school of this state pending evaluation of their application by the Teacher Standards and Practices Commission.
...
**RelatingToFull (verbatim upstream field):** Relating to the Teacher Standards and Practices Commission; and declaring an emergency.
...
Enrolled Senate Bill 802 (SB 802-INTRO) Page 1
...
Enrolled Senate Bill 802 (SB 802-INTRO) Page 2
SECTION 2. The amendments to ORS 342.125 by section 1 of this 2025 Act apply to  ap-
...
Enrolled Senate Bill 802 (SB 802-INTRO) Page 3
...
- From bill text (Enrolled version): ORS 181A.195, ORS 339.374, ORS 342.120, ORS 342.125, ORS 342.127, ORS 342.130, ORS 342.143

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `1188bd75af163510186bcb603f6478e0dce2319c59d4a06e52094ce8773acbd4` (snapshot `_meta/snapshots/measure-2025r1-sb802-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB802/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `c75e1cfb0f26e5e81c8939ea5c5733768e8f782dc73d1a9c85afe3f8ef3b6552` (snapshot `_meta/snapshots/measure-2025r1-sb802-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB802/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 802` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

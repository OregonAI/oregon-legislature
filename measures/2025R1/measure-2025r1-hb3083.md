...
jurisdiction: oregon
id: measure-2025r1-hb3083
title: 'HB 3083 (2025R1): Directs the governing body of a school to consider the installation of a panic
  alarm system as part of the policies and procedures relating to school building security.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3083
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3083/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: d33def30635bfe2302c40868879a52c82f7a9d8aeb6502d40581e379aef007dd
snapshot_id: measure-2025r1-hb3083-enrolled
status: current
...
catch_line: Directs the governing body of a school to consider the installation of a panic alarm system
  as part of the policies and procedures relating to school building security.
minority_catch_line: null
measure_summary: "\t<b>Digest: Directs schools to consider use of a panic alarm system as part of a school\
  \ safety plan. (Flesch Readability Score: 65.1).</b> \n\t[<i>Digest: Directs schools to consider use\
  \ of a panic alert device as part of a school safety plan. (Flesch Readability Score: 65.1).</i>] \n\
  \tDirects the governing body of a school to consider the installation of a panic [<i>alert device</i>]\
  \ <b>alarm system</b> as part of the policies and procedures relating to school building security."
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3083>.

# HB 3083 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3083, 2025 Regular Session (2025R1)
- **LC number:** 3425
...
- **Full text below:** Enrolled version, 5983 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3083/Enrolled>.

## Summary

**Catchline:** Directs the governing body of a school to consider the installation of a panic alarm system as part of the policies and procedures relating to school building security.
...
Enrolled House Bill 3083 (HB 3083-A) Page 1
...
[(b) Educational institution having an average daily attendance of 50 or more students. ]
Enrolled House Bill 3083 (HB 3083-A) Page 2
...
Enrolled House Bill 3083 (HB 3083-A) Page 3
...
- From bill text (Enrolled version): ORS 336.071, ORS 339.324

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `d33def30635bfe2302c40868879a52c82f7a9d8aeb6502d40581e379aef007dd` (snapshot `_meta/snapshots/measure-2025r1-hb3083-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3083/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `38fbc704f9d30f33b578f5f7cffa6173a00447ef0d7a5bcd99755e283b97c925` (snapshot `_meta/snapshots/measure-2025r1-hb3083-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3083/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3083> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

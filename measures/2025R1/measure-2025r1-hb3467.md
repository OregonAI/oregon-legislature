...
jurisdiction: oregon
id: measure-2025r1-hb3467
title: 'HB 3467 (2025R1): Prohibits an individual from collecting and returning the ballot of another
  individual, subject to specified exceptions.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3467
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3467/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e8da1d4ddfc406f4270b3677103da95f531c2fbeec2ba370491f7bd09c97cd1c
snapshot_id: measure-2025r1-hb3467-introduced
status: current
...
catch_line: Prohibits an individual from collecting and returning the ballot of another individual, subject
  to specified exceptions.
minority_catch_line: null
measure_summary: "\tDigest: The Act provides that a person may not return someone else's ballot. The Act\
  \ has exceptions. The Act declares an emergency and becomes law when the Governor signs it. (Flesch\
  \ Readability Score: 65.7). \n\tProhibits an individual from collecting and returning the ballot of\
  \ another individual, subject to specified exceptions. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to ballots; declaring an emergency.
relating_to_full: Relating to ballots; creating new provisions; amending ORS 254.470; and declaring an
  emergency.
at_the_request_of: null
lc_number: 1037
measure_created_date: '2025-01-28T15:23:31'
measure_modified_date: '2025-02-06T13:20:12'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 14873
...
# HB 3467 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3467, 2025 Regular Session (2025R1)
- **LC number:** 1037
- **Created:** 2025-01-28T15:23:31
- **Metadata last modified (upstream):** 2025-02-06T13:20:12
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 14873 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3467/Introduced>.

## Summary

**Catchline:** Prohibits an individual from collecting and returning the ballot of another individual, subject to specified exceptions.

**Relating to:** Relating to ballots; declaring an emergency.

Digest: The Act provides that a person may not return someone else's ballot. The Act has exceptions. The Act declares an emergency and becomes law when the Governor signs it. (Flesch Readability Score: 65.7). 
 Prohibits an individual from collecting and returning the ballot of another individual, subject to specified exceptions. 
 Declares an emergency, effective on passage.

**RelatingToFull (verbatim upstream field):** Relating to ballots; creating new provisions; amending ORS 254.470; and declaring an emergency.
...
standards.
Digest: The Act provides that a person may not return  someone else’s ballot. The Act has ex-
ceptions. The Act declares an emergency and becomes  law when the Governor signs it. (Flesch
Readability Score: 65.7).
Prohibits an individual from collecting  and returning the ballot of another individual, subject to
specified  exceptions.
Declares an emergency, effective on passage.
A BILL FOR AN ACT
Relating to ballots; creating new provisions; amending ORS 254.470; and declaring an emergency.
...
manner permitted under section 2 of this 2025 Act , the person shall deposit the ballot in a
...
- From `RelatingToFull`: ORS 254.470
- From bill text (Introduced version): ORS 247.025, ORS 247.203, ORS 254.165, ORS 254.365, ORS 254.431, ORS 254.458, ORS 254.470, ORS 254.472, ORS 254.476, ORS 254.480

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `e8da1d4ddfc406f4270b3677103da95f531c2fbeec2ba370491f7bd09c97cd1c` (snapshot `_meta/snapshots/measure-2025r1-hb3467-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3467/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3467` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

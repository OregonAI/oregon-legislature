...
jurisdiction: oregon
id: measure-2025r1-hjr18
title: 'HJR 18 (2025R1): Amends the Oregon Constitution to require an initiative petition to be accompanied
  by a signed form providing for the means by which an increase in state or county expenditures of greater
  than $50,000 must be paid. Provides that an initiative petition may not be placed on the ballot unless
  the Secretary of State makes a finding of sufficiency of the means.'
doc_type: dataset_doc
citation: 2025 Regular Session House Joint Resolution 18
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJR18/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5044a412e60267fb10c6d7219f5309f3f3580328bc556d6f8eada2b351881534
snapshot_id: measure-2025r1-hjr18-introduced
status: current
...
catch_line: Amends the Oregon Constitution to require an initiative petition to be accompanied by a signed
  form providing for the means by which an increase in state or county expenditures of greater than $50,000
  must be paid. Provides that an initiative petition may not be placed on the ballot unless the Secretary
  of State makes a finding of sufficiency of the means.
minority_catch_line: null
measure_summary: "\tDigest: Amends the state Constitution. Requires a petitioner to provide a means by\
  \ which added costs from an IM will be paid. Refers the amendment to the people at the next election.\
  \ (Flesch Readability Score: 68.0). \n\tAmends the Oregon Constitution to require an initiative petition\
  \ to be accompanied by a signed form providing for the means by which an increase in state or county\
  \ expenditures of greater than $50,000 must be paid. Provides that an initiative petition may not be\
  \ placed on the ballot unless the Secretary of State makes a finding of sufficiency of the means. \n\
  \tRefers the proposed amendment to the people for their approval or rejection at the next regular general\
  \ election."
relating_to: Proposing an amendment to the Oregon Constitution relating to increased expenditures under
  initiated measures.
relating_to_full: null
at_the_request_of: null
lc_number: 4229
measure_created_date: '2025-02-14T18:45:53'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HJR' and MeasureNumber eq 18`.

# HJR 18 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Joint Resolution 18, 2025 Regular Session (2025R1)
- **LC number:** 4229
- **Created:** 2025-02-14T18:45:53
- **Metadata last modified (upstream):** 2025-02-20T11:02:18
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6764 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJR18/Introduced>.

## Summary

**Catchline:** Amends the Oregon Constitution to require an initiative petition to be accompanied by a signed form providing for the means by which an increase in state or county expenditures of greater than $50,000 must be paid. Provides that an initiative petition may not be placed on the ballot unless the Secretary of State makes a finding of sufficiency of the means.

**Relating to:** Proposing an amendment to the Oregon Constitution relating to increased expenditures under initiated measures.

Digest: Amends the state Constitution. Requires a petitioner to provide a means by which added costs from an IM will be paid. Refers the amendment to the people at the next election. (Flesch Readability Score: 68.0). 
...
LC 4229
not be placed on the ballot unless the secretary makes a finding of sufficiency  of the means
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `5044a412e60267fb10c6d7219f5309f3f3580328bc556d6f8eada2b351881534` (snapshot `_meta/snapshots/measure-2025r1-hjr18-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HJR18/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HJR' and MeasureNumber eq 18` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb859
title: 'SB 859 (2025R1): Authorizes the Director of the Employment Department to compromise or adjust
  certain debts and overpayments relating to the paid family and medical leave program.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 859
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB859/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b48e41c32ccf5432cd56431c25b47b79a1ba2b334e44166f4d1a8fa43e5406d6
snapshot_id: measure-2025r1-sb859-enrolled
status: current
...
catch_line: Authorizes the Director of the Employment Department to compromise or adjust certain debts
  and overpayments relating to the paid family and medical leave program.
minority_catch_line: null
measure_summary: "\tDigest: The Act allows the Director of OED to make some accounting adjustments with\
  \ respect to paid family and medical leave insurance. The Act becomes law 91 days from sine die. (Flesch\
  \ Readability Score: 61.8). \n\tAuthorizes the Director of the Employment Department to compromise or\
  \ adjust certain debts and overpayments relating to the paid family and medical leave program. \n\t\
  Takes effect on the 91st day following adjournment sine die."
relating_to: Relating to accounting adjustments concerning the paid leave program; and prescribing an
  effective date.
relating_to_full: Relating to accounting adjustments concerning the paid leave program; and prescribing
  an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 859`.

# SB 859 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 859, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 4595 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB859/Enrolled>.

## Summary

**Catchline:** Authorizes the Director of the Employment Department to compromise or adjust certain debts and overpayments relating to the paid family and medical leave program.
...
**RelatingToFull (verbatim upstream field):** Relating to accounting adjustments concerning the paid leave program; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 657B.150, ORS 657B.200, ORS 657B.210, ORS 657B.320, ORS 657B.332, ORS 657B.339, ORS 657B.925

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `b48e41c32ccf5432cd56431c25b47b79a1ba2b334e44166f4d1a8fa43e5406d6` (snapshot `_meta/snapshots/measure-2025r1-sb859-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB859/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `232b922f07a623b2bbfc6e02732537bd7e964f0de8522d4f645c5fd002fd56aa` (snapshot `_meta/snapshots/measure-2025r1-sb859-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB859/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 859` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3650
title: 'HB 3650 (2025R1): Establishes the Latino Health System Task Force.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3650
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3650/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: bd043e5d4f669d0cf8435b375781324f2b93d725581cc6eed987f78f48b0bd97
snapshot_id: measure-2025r1-hb3650-introduced
status: current
...
catch_line: Establishes the Latino Health System Task Force.
minority_catch_line: null
measure_summary: "\tDigest: The Act creates the Latino Health System Task Force. (Flesch Readability Score:\
  \ 84.9). \n\tEstablishes the Latino Health System Task Force. Prescribes the task force's membership\
  \ and duties. Directs the task force to report to the Legislative Assembly no later than December 15,\
  \ 2026. Sunsets on December 31, 2026. \n\t[<i>Takes effect on the 91st day following adjournment sine\
  \ die.</i>] \n\t<b>Declares an emergency, effective on passage.</b>"
relating_to: Relating to the Latino Health System Task Force; declaring an emergency.
relating_to_full: Relating to the Latino Health System Task Force; and declaring an emergency.
at_the_request_of: null
lc_number: 3788
measure_created_date: '2025-02-19T11:00:54'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3650`.

# HB 3650 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3650, 2025 Regular Session (2025R1)
- **LC number:** 3788
- **Created:** 2025-02-19T11:00:54
- **Metadata last modified (upstream):** 2025-04-08T18:05:02
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5961 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3650/Introduced>.

## Summary

**Catchline:** Establishes the Latino Health System Task Force.

**Relating to:** Relating to the Latino Health System Task Force; declaring an emergency.

Digest: The Act creates the Latino Health System Task Force. (Flesch Readability Score: 84.9). 
 Establishes the Latino Health System Task Force. Prescribes the task force's membership and duties. Directs the task force to report to the Legislative Assembly no later than December 15, 2026. Sunsets on December 31, 2026. 
 [<i>Takes effect on the 91st day following adjournment sine die.</i>] 
 <b>Declares an emergency, effective on passage.</b>

**RelatingToFull (verbatim upstream field):** Relating to the Latino Health System Task Force; and declaring an emergency.
...
- From bill text (Introduced version): ORS 174.111, ORS 192.245, ORS 413.550, ORS 414.025, ORS 414.665, ORS 660.300

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `bd043e5d4f669d0cf8435b375781324f2b93d725581cc6eed987f78f48b0bd97` (snapshot `_meta/snapshots/measure-2025r1-hb3650-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3650/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3650` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

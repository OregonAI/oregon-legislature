...
jurisdiction: oregon
id: measure-2025r1-hb2660
title: 'HB 2660 (2025R1): Allows vehicle dealers to issue a recreational vehicle trip permit that is valid
  for 30 consecutive days if the vehicle is bought by a person who does not reside in Oregon and does
  not intend to title the vehicle in Oregon.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2660
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2660/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 17dae613d9e7e2b31c1cdb7c25a6e00a7a78d4bb9080fcf3c8f900df97f57613
snapshot_id: measure-2025r1-hb2660-enrolled
status: current
...
catch_line: Allows vehicle dealers to issue a recreational vehicle trip permit that is valid for 30 consecutive
  days if the vehicle is bought by a person who does not reside in Oregon and does not intend to title
  the vehicle in Oregon.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act says vehicle dealers may issue a trip permit for RVs bought by\
  \ those who live out of Oregon and plan to title the RV in a state that is not Oregon. (Flesch Readability\
  \ Score: 63.1).</b> \n\t[<i>Digest: The Act says vehicle dealers may issue trip permits for RVs bought\
  \ by those who live out of Oregon and plan to title the RV in a state that is not Oregon. (Flesch Readability\
  \ Score: 63.3).</i>] \n\tAllows vehicle dealers to issue <b>a</b> recreational vehicle trip [<i>permits\
  \ that are</i>]<b> permit that is</b> valid for 30 consecutive days if the vehicle is bought by a person\
  \ who does not reside in Oregon and does not intend to title the vehicle in Oregon."
relating_to: Relating to trip permits.
relating_to_full: Relating to trip permits.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2660`.

# HB 2660 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2660, 2025 Regular Session (2025R1)
- **LC number:** 3246
...
- **Full text below:** Enrolled version, 11439 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2660/Enrolled>.

## Summary

**Catchline:** Allows vehicle dealers to issue a recreational vehicle trip permit that is valid for 30 consecutive days if the vehicle is bought by a person who does not reside in Oregon and does not intend to title the vehicle in Oregon.
...
**RelatingToFull (verbatim upstream field):** Relating to trip permits.
...
Enrolled House Bill 2660 (HB 2660-A) Page 1
the person is the  owner of the camper, travel trailer or motor home for which the permit will be
...
Enrolled House Bill 2660 (HB 2660-A) Page 2
[(6)] (7) The department may  also sell heavy motor vehicle, heavy trailer and registration weight
...
certificate, $70.
Enrolled House Bill 2660 (HB 2660-A) Page 3
...
Enrolled House Bill 2660 (HB 2660-A) Page 4
...
- From bill text (Enrolled version): ORS 390.134, ORS 802.200, ORS 803.300, ORS 803.305, ORS 803.565, ORS 803.600, ORS 803.601, ORS 803.602, ORS 803.645, ORS 805.050, ORS 806.080, ORS 818.200, ORS 822.020, ORS 822.040, ORS 822.205, ORS 822.210, ORS 822.310

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `17dae613d9e7e2b31c1cdb7c25a6e00a7a78d4bb9080fcf3c8f900df97f57613` (snapshot `_meta/snapshots/measure-2025r1-hb2660-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2660/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `f73b073b5537c5dd892d7e33ee28148b1c7142a54adaeb5ee4cf8e4a3990098c` (snapshot `_meta/snapshots/measure-2025r1-hb2660-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2660/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2660` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

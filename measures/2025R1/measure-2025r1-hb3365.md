...
jurisdiction: oregon
id: measure-2025r1-hb3365
title: 'HB 3365 (2025R1): Directs the State Board of Education to ensure that any revisions to the academic
  content standards for certain core subjects include standards that address the causes and effects of
  climate change and strategies for mitigating, adapting to and strengthening community resilience to
  those causes and effects.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3365
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3365/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: fa434bd6ecb79fde3ccaac135200b226171f99e51dacdd2d9a1d93d917c4844f
snapshot_id: measure-2025r1-hb3365-enrolled
status: current
...
catch_line: Directs the State Board of Education to ensure that any revisions to the academic content
  standards for certain core subjects include standards that address the causes and effects of climate
  change and strategies for mitigating, adapting to and strengthening community resilience to those causes
  and effects.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act would make new laws with respect to updates to academic content\
  \ standards in certain core subjects. The updates must include standards about the causes and effects\
  \ of climate change. (Flesch Readability Score: 62.8).</b> \n\t[<i>Digest: The Act would make new laws\
  \ that would require climate change instruction to be included in certain subjects taught in public\
  \ schools. (Flesch Readability Score: 65.2).</i>] \n\tDirects the State Board of Education to ensure\
  \ that [<i>academic content standards for core subjects include sufficient instruction on the causes\
  \ and effects of climate change and strategies for responding to such causes and effects</i>] <b>any\
  \ revisions to the academic content standards for certain core subjects include standards that address\
  \ the causes and effects of climate change and strategies for mitigating, adapting to and strengthening\
  \ community resilience to those causes and effects</b>. \n\tApplies to academic content standards that\
  \ are reviewed and revised on or after the effective date of the Act."
relating_to: Relating to climate change instruction in public schools.
relating_to_full: Relating to climate change instruction in public schools.
at_the_request_of: null
lc_number: 1624
measure_created_date: '2025-01-22T14:11:58'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3365`.

# HB 3365 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3365, 2025 Regular Session (2025R1)
- **LC number:** 1624
- **Created:** 2025-01-22T14:11:58
- **Metadata last modified (upstream):** 2025-07-25T10:52:12
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 8691 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3365/Enrolled>.

## Summary

**Catchline:** Directs the State Board of Education to ensure that any revisions to the academic content standards for certain core subjects include standards that address the causes and effects of climate change and strategies for mitigating, adapting to and strengthening community resilience to those causes and effects.
...
**RelatingToFull (verbatim upstream field):** Relating to climate change instruction in public schools.
...
- From bill text (Enrolled version): ORS 329.025, ORS 329.045

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `fa434bd6ecb79fde3ccaac135200b226171f99e51dacdd2d9a1d93d917c4844f` (snapshot `_meta/snapshots/measure-2025r1-hb3365-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3365/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `f82df4e4777c6e9e4b27886673f26b4ea6a099772e290f12a0abc9f3f0725fa5` (snapshot `_meta/snapshots/measure-2025r1-hb3365-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3365/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3365` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

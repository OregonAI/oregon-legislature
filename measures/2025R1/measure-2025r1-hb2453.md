...
jurisdiction: oregon
id: measure-2025r1-hb2453
title: 'HB 2453 (2025R1): Removes the requirement that an educational equity advisory committee must advise
  a school district board.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2453
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2453/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: eee97c2b883ff4c26581fe7d561d6661c832a1267f4a1c86bdff097ac8842dac
snapshot_id: measure-2025r1-hb2453-enrolled
status: current
...
catch_line: Removes the requirement that an educational equity advisory committee must advise a school
  district board.
minority_catch_line: null
measure_summary: "\t<b>Digest: Limits the duties of an equity committee that serves a school district.\
  \ (Flesch Readability Score: 60.7).</b> \n\t[<i>Digest: Directs ODE to study the state of education\
  \ in this state. (Flesch Readability Score: 72.6).</i>] \n\t[<i>Requires the Department of Education\
  \ to study the adequacy of public education in this state. Directs the department to submit findings\
  \ to the interim committees of the Legislative Assembly related to education not later than September\
  \ 15, 2026.</i>] \n\t<b>Removes the requirement that an educational equity advisory committee must advise\
...
measure_modified_date: '2026-04-15T10:26:38'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2453`.

# HB 2453 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2453, 2025 Regular Session (2025R1)
- **LC number:** 926
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-04-15T10:26:38
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 4433 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2453/Enrolled>.

## Summary

**Catchline:** Removes the requirement that an educational equity advisory committee must advise a school district board.
...
- From bill text (Enrolled version): ORS 329.711

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `eee97c2b883ff4c26581fe7d561d6661c832a1267f4a1c86bdff097ac8842dac` (snapshot `_meta/snapshots/measure-2025r1-hb2453-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2453/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `76c2c023c67c04dcfbd513808175fdb98f4dfb7daaed0b1e9cf55af32447a202` (snapshot `_meta/snapshots/measure-2025r1-hb2453-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2453/Introduced>.

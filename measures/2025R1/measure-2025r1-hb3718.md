...
jurisdiction: oregon
id: measure-2025r1-hb3718
title: 'HB 3718 (2025R1): Prohibits a police officer involved in a use of deadly physical force incident
  from reviewing body camera recordings before participating in an interview about the incident.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3718
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3718/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5c3aa6ec76ed04eb67dd4ce7c5098a19b9641ea0c4ae713c5c7483a2497b93ae
snapshot_id: measure-2025r1-hb3718-introduced
status: current
...
measure_summary: "\tDigest: The Act changes some laws about police body camera footage. (Flesch Readability\
  \ Score: 61.3). \n\tProhibits a police officer involved in a use of deadly physical force incident from\
  \ reviewing body camera recordings before participating in an interview about the incident. \n\tCreates\
  \ an alternative court process for a person denied access to a public record consisting of a body camera\
  \ recording of a law enforcement use of deadly physical force incident. \n\tDirects the Department of\
  \ Public Safety Standards and Training to create technical standards for the maintenance and secure\
  \ storage of body camera recordings."
relating_to: Relating to police body camera recordings.
relating_to_full: Relating to police body camera recordings; creating new provisions; and amending ORS
  181A.785, 181A.790 and 181A.800.
at_the_request_of: null
lc_number: 3752
measure_created_date: '2025-02-23T20:43:14'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3718`.

# HB 3718 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3718, 2025 Regular Session (2025R1)
- **LC number:** 3752
- **Created:** 2025-02-23T20:43:14
- **Metadata last modified (upstream):** 2025-02-28T08:28:03
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 9622 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3718/Introduced>.
...
**RelatingToFull (verbatim upstream field):** Relating to police body camera recordings; creating new provisions; and amending ORS 181A.785, 181A.790 and 181A.800.
...
- From bill text (Introduced version): ORS 181A.355, ORS 181A.780, ORS 181A.785, ORS 181A.790, ORS 181A.800, ORS 181A.805, ORS 192.311, ORS 192.345, ORS 192.415, ORS 192.422, ORS 192.431

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `5c3aa6ec76ed04eb67dd4ce7c5098a19b9641ea0c4ae713c5c7483a2497b93ae` (snapshot `_meta/snapshots/measure-2025r1-hb3718-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3718/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3718` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb1014
title: 'SB 1014 (2025R1): Requires the Secretary of State to allow to be included in the translated version
  of each state voters'' pamphlet that is made available on the website of the secretary or of a county
  the translations of a party''s statement of arguments for the success of its principles and election
  of its candidates.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1014
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1014/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c2d6bf955256557d8d3ca7f8d13fe6268c33ce856e1c57e88a802fe18a99ca78
snapshot_id: measure-2025r1-sb1014-enrolled
status: current
...
catch_line: Requires the Secretary of State to allow to be included in the translated version of each
  state voters' pamphlet that is made available on the website of the secretary or of a county the translations
  of a party's statement of arguments for the success of its principles and election of its candidates.
minority_catch_line: null
measure_summary: "\tDigest: The Act says that the SOS must include translations of party statements in\
  \ voters' booklets. (Flesch Readability Score: 61.8). \n\tRequires the Secretary of State to allow to\
  \ be included in the translated version of each state voters' pamphlet that is made available on the\
  \ website of the secretary or of a county the translations of a party's statement of arguments for the\
  \ success of its principles and election of its candidates. Sets forth the requirements for a statement\
  \ to be included by the secretary."
relating_to: Relating to statements of arguments by political parties.
relating_to_full: Relating to statements of arguments by political parties.
at_the_request_of: null
lc_number: 3543
measure_created_date: '2025-02-07T11:37:32'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1014>.

# SB 1014 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1014, 2025 Regular Session (2025R1)
- **LC number:** 3543
- **Created:** 2025-02-07T11:37:32
- **Metadata last modified (upstream):** 2025-07-02T16:44:03
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 7124 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1014/Enrolled>.

## Summary

**Catchline:** Requires the Secretary of State to allow to be included in the translated version of each state voters' pamphlet that is made available on the website of the secretary or of a county the translations of a party's statement of arguments for the success of its principles and election of its candidates.
...
**RelatingToFull (verbatim upstream field):** Relating to statements of arguments by political parties.
...
chapter; and
Enrolled Senate Bill 1014 (SB 1014-INTRO) Page 1
...
2026.
Enrolled Senate Bill 1014 (SB 1014-INTRO) Page 2
...
Enrolled Senate Bill 1014 (SB 1014-INTRO) Page 3
...
- From bill text (Enrolled version): ORS 137.685, ORS 174.109, ORS 250.125, ORS 250.141, ORS 251.026, ORS 251.055, ORS 251.065, ORS 251.115, ORS 251.167, ORS 251.170, ORS 251.245, ORS 251.255

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `c2d6bf955256557d8d3ca7f8d13fe6268c33ce856e1c57e88a802fe18a99ca78` (snapshot `_meta/snapshots/measure-2025r1-sb1014-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1014/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `4ce34ca3bd015c30372f654b0f0289c19ee282faea622111ccbe141b7cefe198` (snapshot `_meta/snapshots/measure-2025r1-sb1014-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1014/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1014> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

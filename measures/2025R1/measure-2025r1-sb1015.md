...
jurisdiction: oregon
id: measure-2025r1-sb1015
title: 'SB 1015 (2025R1): Requires the Department of Justice to develop and implement a grant program
  to award moneys to eligible entities to reduce community violence in communities experiencing disproportionately
  high rates of community violence.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1015
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1015/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 454086861d17208300f4f27073db6369811f851a64265a3410ee52a1e1681afe
snapshot_id: measure-2025r1-sb1015-introduced
status: current
...
catch_line: Requires the Department of Justice to develop and implement a grant program to award moneys
  to eligible entities to reduce community violence in communities experiencing disproportionately high
  rates of community violence.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells the DOJ to create a grant program to give moneys to certain\
  \ entities. The Act directs the entities to use the moneys to reduce community violence. (Flesch Readability\
  \ Score: 63.7). \n\tRequires the Department of Justice to develop and implement a grant program to award\
  \ moneys to eligible entities to reduce community violence in communities experiencing disproportionately\
  \ high rates of community violence. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to community violence; prescribing an effective date.
relating_to_full: Relating to community violence; and prescribing an effective date.
at_the_request_of: null
lc_number: 790
measure_created_date: '2025-02-10T09:50:11'
measure_modified_date: '2025-04-14T12:46:24'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 5731
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1015`.

# SB 1015 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1015, 2025 Regular Session (2025R1)
- **LC number:** 790
- **Created:** 2025-02-10T09:50:11
- **Metadata last modified (upstream):** 2025-04-14T12:46:24
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5731 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1015/Introduced>.

## Summary

**Catchline:** Requires the Department of Justice to develop and implement a grant program to award moneys to eligible entities to reduce community violence in communities experiencing disproportionately high rates of community violence.
...
**RelatingToFull (verbatim upstream field):** Relating to community violence; and prescribing an effective date.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `454086861d17208300f4f27073db6369811f851a64265a3410ee52a1e1681afe` (snapshot `_meta/snapshots/measure-2025r1-sb1015-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1015/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1015` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

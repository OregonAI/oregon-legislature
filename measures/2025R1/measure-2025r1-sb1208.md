...
jurisdiction: oregon
id: measure-2025r1-sb1208
title: 'SB 1208 (2025R1): Designates March of each year as Plastics Appreciation Month.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1208
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1208/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 7d3eb04adf3d9bbd4b880f8d9ae687a10c5b20a55d9b401613f3340b544421f0
snapshot_id: measure-2025r1-sb1208-introduced
status: current
...
catch_line: Designates March of each year as Plastics Appreciation Month.
minority_catch_line: null
measure_summary: "\tDigest: Declares a month in praise of plastics. (Flesch Readability Score: 90.9).\
  \ \n\tDesignates March of each year as Plastics Appreciation Month. \n\tDesignates certain plastics\
  \ and their uses to celebrate daily during March."
relating_to: Relating to plastics.
relating_to_full: Relating to plastics.
at_the_request_of: null
lc_number: 4855
measure_created_date: '2025-04-22T12:50:36'
measure_modified_date: '2025-04-23T15:15:21'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 8701
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1208`.

# SB 1208 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1208, 2025 Regular Session (2025R1)
- **LC number:** 4855
- **Created:** 2025-04-22T12:50:36
- **Metadata last modified (upstream):** 2025-04-23T15:15:21
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 8701 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1208/Introduced>.

## Summary

**Catchline:** Designates March of each year as Plastics Appreciation Month.
...
**RelatingToFull (verbatim upstream field):** Relating to plastics.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `7d3eb04adf3d9bbd4b880f8d9ae687a10c5b20a55d9b401613f3340b544421f0` (snapshot `_meta/snapshots/measure-2025r1-sb1208-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1208/Introduced>.

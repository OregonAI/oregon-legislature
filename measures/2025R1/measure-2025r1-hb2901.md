...
jurisdiction: oregon
id: measure-2025r1-hb2901
title: 'HB 2901 (2025R1): Modifies the safe haven law to allow a parent to anonymously leave an infant
  in a newborn safety device.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2901
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2901/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 573a987c422eb0130193526e7d7e20edbb97ae8e62192b2357407f95a057738f
snapshot_id: measure-2025r1-hb2901-introduced
status: current
...
catch_line: Modifies the safe haven law to allow a parent to anonymously leave an infant in a newborn
  safety device.
minority_catch_line: null
measure_summary: "\tDigest: The Act allows a parent to leave a newborn in a safety device if the device\
  \ meets certain standards. (Flesch Readability Score: 63.8). \n\tModifies the safe haven law to allow\
  \ a parent to anonymously leave an infant in a newborn safety device. Allows an authorized facility\
  \ to install a newborn safety device. Prescribes standards for newborn safety devices."
relating_to: Relating to newborn safety devices.
relating_to_full: Relating to newborn safety devices; amending ORS 418.017.
at_the_request_of: null
lc_number: 948
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-03-03T14:19:58'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 5157
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2901`.

# HB 2901 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2901, 2025 Regular Session (2025R1)
- **LC number:** 948
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-03-03T14:19:58
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5157 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2901/Introduced>.

## Summary

**Catchline:** Modifies the safe haven law to allow a parent to anonymously leave an infant in a newborn safety device.
...
**RelatingToFull (verbatim upstream field):** Relating to newborn safety devices; amending ORS 418.017.
...
- From `RelatingToFull`: ORS 418.017
- From bill text (Introduced version): ORS 418.017, ORS 419B.005, ORS 419B.100, ORS 419B.150, ORS 442.015

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `573a987c422eb0130193526e7d7e20edbb97ae8e62192b2357407f95a057738f` (snapshot `_meta/snapshots/measure-2025r1-hb2901-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2901/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2901` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

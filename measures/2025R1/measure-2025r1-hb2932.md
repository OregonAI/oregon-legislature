...
jurisdiction: oregon
id: measure-2025r1-hb2932
title: 'HB 2932 (2025R1): Provides an exception to the prohibition against a public official using official
  position or office for financial gain or avoidance of financial detriment.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2932
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2932/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0e5c036360bd2d33860a97400599ebc619ee08384703ae1c69b1a2f69ccd9815
snapshot_id: measure-2025r1-hb2932-enrolled
status: current
...
catch_line: Provides an exception to the prohibition against a public official using official position
  or office for financial gain or avoidance of financial detriment.
minority_catch_line: null
measure_summary: "\tDigest: Allows a public official to get paid for teaching at certain schools. (Flesch\
  \ Readability Score: 67.7). \n\tProvides an exception to the prohibition against a public official using\
  \ official position or office for financial gain or avoidance of financial detriment. Permits a public\
  \ official to receive compensation from a post-secondary institution in exchange for teaching one or\
  \ more courses at the institution."
relating_to: Relating to exceptions to prohibited use of official position or office.
relating_to_full: Relating to exceptions to prohibited use of official position or office.
...
# HB 2932 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2932, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 5266 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2932/Enrolled>.

## Summary

**Catchline:** Provides an exception to the prohibition against a public official using official position or office for financial gain or avoidance of financial detriment.
...
**RelatingToFull (verbatim upstream field):** Relating to exceptions to prohibited use of official position or office.
...
Enrolled House Bill 2932 (HB 2932-INTRO) Page 2
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `0e5c036360bd2d33860a97400599ebc619ee08384703ae1c69b1a2f69ccd9815` (snapshot `_meta/snapshots/measure-2025r1-hb2932-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2932/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `7094151e90a97c8b8e5b6fac418e2d3cb40045b2832d7a3d28a0e420906932e8` (snapshot `_meta/snapshots/measure-2025r1-hb2932-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2932/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2932` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb830
title: 'SB 830 (2025R1): Modifies provisions of the on-site septic system loan program to allow for grants.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 830
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB830/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: db06077a7d92df017970109d9a74ec84993c2921d3dc7f74178ab70abae71337
snapshot_id: measure-2025r1-sb830-enrolled
status: current
...
measure_summary: "\tDigest: This Act changes laws for the on-site septic system loan program to allow\
  \ for grants and to expand who qualifies for help. (Flesch Readability Score: 65.2). \n\tModifies provisions\
  \ of the on-site septic system loan program to allow for grants. Expands eligibility for the program.\
  \ \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to on-site septic systems; and prescribing an effective date.
relating_to_full: Relating to on-site septic systems; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 830>.

# SB 830 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 830, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 8114 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB830/Enrolled>.

## Summary

**Catchline:** Modifies provisions of the on-site septic system loan program to allow for grants.
...
**RelatingToFull (verbatim upstream field):** Relating to on-site septic systems; and prescribing an effective date.
...
wastewater per day.
Enrolled Senate Bill 830 (SB 830-INTRO) Page 1
...
Enrolled Senate Bill 830 (SB 830-INTRO) Page 2
...
Enrolled Senate Bill 830 (SB 830-INTRO) Page 3
...
- From bill text (Enrolled version): ORS 454.605, ORS 454.777, ORS 454.779

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `db06077a7d92df017970109d9a74ec84993c2921d3dc7f74178ab70abae71337` (snapshot `_meta/snapshots/measure-2025r1-sb830-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB830/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `344da578151e468733769b69e286f52c498fcbd7358d1c74c85206a26b85f69d` (snapshot `_meta/snapshots/measure-2025r1-sb830-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB830/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 830> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

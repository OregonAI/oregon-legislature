...
jurisdiction: oregon
id: measure-2025r1-sb89
title: 'SB 89 (2025R1): Requires the State Department of Energy to coordinate with other organizations,
  conduct outreach, establish a statewide navigation and support system and provide information in multiple
  languages, as part of the department''s single resource for providing information and assistance related
  to available energy efficiency incentives and programs.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 89
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB89/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 029a5d478661b2899fd91526130ce61f56347d7a0b9f5633284aedad96c746ec
snapshot_id: measure-2025r1-sb89-introduced
status: current
...
catch_line: Requires the State Department of Energy to coordinate with other organizations, conduct outreach,
  establish a statewide navigation and support system and provide information in multiple languages, as
  part of the department's single resource for providing information and assistance related to available
...
measure_summary: "\tDigest: Makes ODOE do outreach and provide certain support. (Flesch Readability Score:\
  ...
  \ outreach, establish a statewide navigation and support system and provide information in multiple\
  \ languages, as part of the department's single resource for providing information and assistance related\
  \ to available energy efficiency incentives and programs. \n\tRequires the department to create a statewide\
...
measure_modified_date: '2025-01-22T16:11:01'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 7028
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 89`.

# SB 89 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 89, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Senate Interim Committee on Energy and Environment)
- **LC number:** 1823
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-22T16:11:01
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7028 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB89/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `029a5d478661b2899fd91526130ce61f56347d7a0b9f5633284aedad96c746ec` (snapshot `_meta/snapshots/measure-2025r1-sb89-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB89/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 89` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

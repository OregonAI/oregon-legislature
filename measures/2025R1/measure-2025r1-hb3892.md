...
jurisdiction: oregon
id: measure-2025r1-hb3892
title: 'HB 3892 (2025R1): Establishes the Task Force on Community College Adult Reconnect.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3892
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3892/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b8bbdf5382e5095511fb8e260a93da6bc7ab4909b5bfdd9334fc55da37b713b7
snapshot_id: measure-2025r1-hb3892-introduced
status: current
...
catch_line: Establishes the Task Force on Community College Adult Reconnect.
minority_catch_line: null
measure_summary: "\tDigest: The Act creates a task force to help adult learners go back to community college.\
  \ (Flesch Readability Score: 73.1). \n\tEstablishes the Task Force on Community College Adult Reconnect.\
  \ Directs the task force to study and make recommendations related to assisting adult learners to overcome\
  \ barriers to earning a degree or credential. \n\tSunsets the task force on December 31, 2026. \n\t\
  Declares an emergency, effective July 1, 2025."
relating_to: Relating to the Task Force on Community College Adult Reconnect; declaring an emergency.
relating_to_full: Relating to the Task Force on Community College Adult Reconnect; and declaring an emergency.
at_the_request_of: null
lc_number: 4555
measure_created_date: '2025-02-26T12:54:09'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3892`.

# HB 3892 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3892, 2025 Regular Session (2025R1)
- **LC number:** 4555
- **Created:** 2025-02-26T12:54:09
- **Metadata last modified (upstream):** 2025-03-05T10:33:19
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5484 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3892/Introduced>.

## Summary

**Catchline:** Establishes the Task Force on Community College Adult Reconnect.
...
**RelatingToFull (verbatim upstream field):** Relating to the Task Force on Community College Adult Reconnect; and declaring an emergency.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `b8bbdf5382e5095511fb8e260a93da6bc7ab4909b5bfdd9334fc55da37b713b7` (snapshot `_meta/snapshots/measure-2025r1-hb3892-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3892/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3892` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2853
title: 'HB 2853 (2025R1): Authorizes cities to bring certain lands within their urban growth boundaries
  for light industrial and open space uses.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2853
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2853/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 2d7dcbb476c5c192da2413c71ac8dcbcb30995f3e3005acda48fdd559cd564ee
snapshot_id: measure-2025r1-hb2853-introduced
status: current
...
catch_line: Authorizes cities to bring certain lands within their urban growth boundaries for light industrial
  and open space uses.
minority_catch_line: null
measure_summary: "\tDigest: This Act replaces an old industrial siting program with a new program that\
  \ allows for UGB growth. (Flesch Readability Score: 65.1). \n\tAuthorizes cities to bring certain lands\
  \ within their urban growth boundaries for light industrial and open space uses. \n\tSunsets January\
  \ 2, 2037. \n\tSunsets 2011 program under which the Economic Recovery Review Council designated regionally\
  \ significant industrial areas."
relating_to: Relating to urban growth boundaries.
relating_to_full: Relating to urban growth boundaries; creating new provisions; amending ORS 285B.637;
  and repealing ORS 197.722, 197.723, 197.724, 197.726, 197.727 and 197.728.
at_the_request_of: null
lc_number: 1115
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T13:14:33'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 7429
...
# HB 2853 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2853, 2025 Regular Session (2025R1)
- **LC number:** 1115
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T13:14:33
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7429 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2853/Introduced>.

## Summary

**Catchline:** Authorizes cities to bring certain lands within their urban growth boundaries for light industrial and open space uses.
...
**RelatingToFull (verbatim upstream field):** Relating to urban growth boundaries; creating new provisions; amending ORS 285B.637; and repealing ORS 197.722, 197.723, 197.724, 197.726, 197.727 and 197.728.
...
certified by the department as ready for development within six months or less as of  the date on
...
- From `RelatingToFull`: ORS 197.722, ORS 197.723, ORS 197.724, ORS 197.726, ORS 197.727, ORS 197.728, ORS 285B.637
- From bill text (Introduced version): ORS 197.716, ORS 197.722, ORS 197.723, ORS 197.724, ORS 197.726, ORS 197.727, ORS 197.728, ORS 197.830, ORS 285B.637, ORS 285B.640, ORS 34.010

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `2d7dcbb476c5c192da2413c71ac8dcbcb30995f3e3005acda48fdd559cd564ee` (snapshot `_meta/snapshots/measure-2025r1-hb2853-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2853/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2853> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2563
title: 'HB 2563 (2025R1): Requires an insurer to provide to an insured a clear and reasonable explanation
  of the reasons for any increase in the premium amount for a qualified policy upon renewal of the qualified
  policy.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2563
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2563/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 71b6c4252181414335e5fc8b665b2ab2f1d53859b9bd4daacb6caba2f59381f8
snapshot_id: measure-2025r1-hb2563-enrolled
status: current
...
catch_line: Requires an insurer to provide to an insured a clear and reasonable explanation of the reasons
  for any increase in the premium amount for a qualified policy upon renewal of the qualified policy.
minority_catch_line: null
measure_summary: "\tDigest: Tells insurers to explain to policy holders why the premium will go up when\
  \ the policy is renewed. Tells insurers what they must say to policy holders. Goes into effect 91 days\
  \ after the session ends. (Flesch Readability Score: 60.7). \n\tRequires an insurer to provide to an\
  \ insured a clear and reasonable explanation of the reasons for any increase in the premium amount for\
  \ a qualified policy upon renewal of the qualified policy. Specifies standards for a clear and reasonable\
  \ explanation. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to explanations required in connection with premium increases upon renewals of certain
  insurance policies; and prescribing an effective date.
relating_to_full: Relating to explanations required in connection with premium increases upon renewals
  of certain insurance policies; and prescribing an effective date.
...
measure_modified_date: '2026-04-15T10:28:12'
...
# HB 2563 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2563, 2025 Regular Session (2025R1)
...
- **Metadata last modified (upstream):** 2026-04-15T10:28:12
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 6804 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2563/Enrolled>.

## Summary

**Catchline:** Requires an insurer to provide to an insured a clear and reasonable explanation of the reasons for any increase in the premium amount for a qualified policy upon renewal of the qualified policy.

**Relating to:** Relating to explanations required in connection with premium increases upon renewals of certain insurance policies; and prescribing an effective date.

Digest: Tells insurers to explain to policy holders why the premium will go up when the policy is renewed. Tells insurers what they must say to policy holders. Goes into effect 91 days after the session ends. (Flesch Readability Score: 60.7). 
 Requires an insurer to provide to an insured a clear and reasonable explanation of the reasons for any increase in the premium amount for a qualified policy upon renewal of the qualified policy. Specifies standards for a clear and reasonable explanation. 
 Takes effect on the 91st day following adjournment sine die.

**RelatingToFull (verbatim upstream field):** Relating to explanations required in connection with premium increases upon renewals of certain insurance policies; and prescribing an effective date.
...
(b) Any other information the  insurer wishes to disclose concerning the insurer’s deter-
...
- From bill text (Enrolled version): ORS 746.600

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `71b6c4252181414335e5fc8b665b2ab2f1d53859b9bd4daacb6caba2f59381f8` (snapshot `_meta/snapshots/measure-2025r1-hb2563-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2563/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `683f7bc34f18270fb264e9d85ebdb89f009469b0206e191e1b8ee622b5a28c6e` (snapshot `_meta/snapshots/measure-2025r1-hb2563-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2563/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2563> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

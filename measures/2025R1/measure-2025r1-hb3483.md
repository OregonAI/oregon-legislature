...
jurisdiction: oregon
id: measure-2025r1-hb3483
title: 'HB 3483 (2025R1): Provides that a camping site is not "established" until it has been continuously
  occupied for 72 hours for purposes of the rule requiring 72-hour notice before homeless individuals
  may be removed from the camping site.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3483
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3483/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: db9a52ec2053e6fb0fec9e903345008f527af9dc803e3df45bcbb43525fb0936
snapshot_id: measure-2025r1-hb3483-introduced
status: current
...
catch_line: Provides that a camping site is not "established" until it has been continuously occupied
  for 72 hours for purposes of the rule requiring 72-hour notice before homeless individuals may be removed
  from the camping site.
minority_catch_line: null
measure_summary: "\tDigest: The Act says that a homeless camp site must be occupied for 72 hours before\
  \ a 72-hour notice of removal of the camp site may be posted. (Flesch Readability Score: 60.5). \n\t\
  Provides that a camping site is not \"established\" until it has been continuously occupied for 72 hours\
  \ for purposes of the rule requiring 72-hour notice before homeless individuals may be removed from\
  \ the camping site. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to established camping sites; declaring an emergency.
relating_to_full: Relating to established camping sites; amending ORS 195.505; and declaring an emergency.
at_the_request_of: null
lc_number: 4453
measure_created_date: '2025-01-30T10:35:36'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3483`.

# HB 3483 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3483, 2025 Regular Session (2025R1)
- **LC number:** 4453
- **Created:** 2025-01-30T10:35:36
- **Metadata last modified (upstream):** 2025-02-06T13:21:11
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6690 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3483/Introduced>.

## Summary

**Catchline:** Provides that a camping site is not "established" until it has been continuously occupied for 72 hours for purposes of the rule requiring 72-hour notice before homeless individuals may be removed from the camping site.
...
**RelatingToFull (verbatim upstream field):** Relating to established camping sites; amending ORS 195.505; and declaring an emergency.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `db9a52ec2053e6fb0fec9e903345008f527af9dc803e3df45bcbb43525fb0936` (snapshot `_meta/snapshots/measure-2025r1-hb3483-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3483/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3483` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

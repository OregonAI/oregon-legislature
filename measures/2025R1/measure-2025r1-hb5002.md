...
jurisdiction: oregon
id: measure-2025r1-hb5002
title: 'HB 5002 (2025R1): Appropriates moneys from the General Fund to the Oregon Department of Administrative
  Services for certain biennial expenses.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 5002
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB5002/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4a8176b20825dfddfa7a97b1e9e8f361f811bf25704fa5b739472424e43e1693
snapshot_id: measure-2025r1-hb5002-enrolled
status: current
...
measure_summary: "\tDigest: The Act creates an agency budget. (Flesch Readability Score: 73.8). \n\tAppropriates\
  \ moneys from the General Fund to the Oregon Department of Administrative Services for certain biennial\
  ...
  \ collected or received by the department. \n\tLimits biennial expenditures by the department from certain\
...
measure_modified_date: '2026-05-11T10:44:24'
...
# HB 5002 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 5002, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Oregon Department of Administrative Services)
- **LC number:** 9002
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-05-11T10:44:24
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 6772 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB5002/Enrolled>.

## Summary

**Catchline:** Appropriates moneys from the General Fund to the Oregon Department of Administrative Services for certain biennial expenses.
...
(2) Chief Financial Office ........... $ 33,674,580
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `4a8176b20825dfddfa7a97b1e9e8f361f811bf25704fa5b739472424e43e1693` (snapshot `_meta/snapshots/measure-2025r1-hb5002-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB5002/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `5786bc80cfecc53bf28a3f631502b30a8e0abd723862404591cc49f0caaeb745` (snapshot `_meta/snapshots/measure-2025r1-hb5002-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB5002/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 5002` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

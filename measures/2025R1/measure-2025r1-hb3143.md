...
jurisdiction: oregon
id: measure-2025r1-hb3143
title: 'HB 3143 (2025R1): Establishes the Landowners Living with Beavers Grant Program Subaccount in the
  Oregon Conservation and Recreation Fund.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3143
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3143/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: dbfdba106ae6d78b5fb0aa821d042c9af1d1981f806bb5caf339e4aad9bab6cd
snapshot_id: measure-2025r1-hb3143-introduced
status: current
...
catch_line: Establishes the Landowners Living with Beavers Grant Program Subaccount in the Oregon Conservation
  and Recreation Fund.
...
measure_summary: "\tDigest: The Act allows agencies to award moneys under a grant program related to living\
  ...
  \ after the 2025 session ends. (Flesch Readability Score: 62.3). \n\tEstablishes the Landowners Living\
  \ with Beavers Grant Program Subaccount in the Oregon Conservation and Recreation Fund. Authorizes the\
  \ State Department of Fish and Wildlife to award block grants from the subaccount under the Landowners\
  \ Living with Beavers Grant Program, on recommendations from the Oregon Conservation and Recreation\
  \ Advisory Committee. \n\tDirects the department and the committee to jointly report on the grant program\
  \ to committees or interim committees of the Legislative Assembly related to the environment on or before\
  \ September 15, 2027. \n\tAppropriates moneys from the General Fund to the department for deposit in\
  \ the subaccount for purposes related to the grant program. \n\tTakes effect on the 91st day following\
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3143`.

# HB 3143 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3143, 2025 Regular Session (2025R1)
- **LC number:** 611
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-05-09T14:59:10
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 17285 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3143/Introduced>.

## Summary

**Catchline:** Establishes the Landowners Living with Beavers Grant Program Subaccount in the Oregon Conservation and Recreation Fund.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `dbfdba106ae6d78b5fb0aa821d042c9af1d1981f806bb5caf339e4aad9bab6cd` (snapshot `_meta/snapshots/measure-2025r1-hb3143-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3143/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3143` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

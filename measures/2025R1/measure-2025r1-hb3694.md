...
jurisdiction: oregon
id: measure-2025r1-hb3694
title: 'HB 3694 (2025R1): Modifies provisions of law related to compensation for student athletes enrolled
  in a post-secondary institution of education.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3694
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3694/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 47bf9867a2b9e12d17fa11a7973c2f87d9e17afda6c7158858bba457dfd4df9f
snapshot_id: measure-2025r1-hb3694-enrolled
status: current
...
catch_line: Modifies provisions of law related to compensation for student athletes enrolled in a post-secondary
  institution of education.
minority_catch_line: null
measure_summary: "\tDigest: The Act updates the law related to pay for student athletes. (Flesch Readability\
  \ Score: 74.8). \n\tModifies provisions of law related to compensation for student athletes enrolled\
...
lc_number: 1562
measure_created_date: '2025-02-21T12:21:25'
measure_modified_date: '2026-04-14T12:34:31'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3694`.

# HB 3694 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3694, 2025 Regular Session (2025R1)
- **LC number:** 1562
- **Created:** 2025-02-21T12:21:25
- **Metadata last modified (upstream):** 2026-04-14T12:34:31
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 9328 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3694/Enrolled>.

## Summary

**Catchline:** Modifies provisions of law related to compensation for student athletes enrolled in a post-secondary institution of education.

**Relating to:** Relating to student athletes; and declaring an emergency.

Digest: The Act updates the law related to pay for student athletes. (Flesch Readability Score: 74.8). 
...
- From bill text (Enrolled version): ORS 192.311, ORS 352.002, ORS 702.200

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `47bf9867a2b9e12d17fa11a7973c2f87d9e17afda6c7158858bba457dfd4df9f` (snapshot `_meta/snapshots/measure-2025r1-hb3694-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3694/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `f312c837aef39d34f101d027b588bb109a3716b252357786a36785b3e6628c0f` (snapshot `_meta/snapshots/measure-2025r1-hb3694-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3694/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3694` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

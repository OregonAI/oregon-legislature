...
jurisdiction: oregon
id: measure-2025r1-hb3851
title: 'HB 3851 (2025R1): Allows a residential landlord to give 59 days'' notice after accepting an offer
  from a buyer who intends to occupy the premises, to terminate a tenancy.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3851
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3851/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ccb26b1386556c0c1be6c3090196b62711ff32406f512adcde83991c35b8d120
snapshot_id: measure-2025r1-hb3851-introduced
status: current
...
catch_line: Allows a residential landlord to give 59 days' notice after accepting an offer from a buyer
  who intends to occupy the premises, to terminate a tenancy.
minority_catch_line: null
measure_summary: "\tDigest: This bill amends the notices to end a tenancy needed from landlords selling\
  \ their homes. (Flesch Readability Score: 63.6). \n\tAllows a residential landlord to give 59 days'\
  \ notice after accepting an offer from a buyer who intends to occupy the premises, to terminate a tenancy.\
  \ Requires the landlord to first give tenants at least 31 days' notice before listing the property for\
  \ sale. Replaces the current 90 days' notice requirement for termination. \n\tTakes effect on the 91st\
...
relating_to_full: Relating to termination of residential tenancies; amending ORS 90.427 and 105.124; and
  prescribing an effective date.
at_the_request_of: null
lc_number: 4539
measure_created_date: '2025-02-26T10:35:01'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3851>.

# HB 3851 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3851, 2025 Regular Session (2025R1)
- **LC number:** 4539
- **Created:** 2025-02-26T10:35:01
- **Metadata last modified (upstream):** 2025-03-05T10:31:00
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 16804 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3851/Introduced>.

## Summary

**Catchline:** Allows a residential landlord to give 59 days' notice after accepting an offer from a buyer who intends to occupy the premises, to terminate a tenancy.
...
**RelatingToFull (verbatim upstream field):** Relating to termination of residential tenancies; amending ORS 90.427 and 105.124; and prescribing an effective date.
...
the dwelling unit is listed for  sale or the date of making or accepting an offer to sell, given
...
- From `RelatingToFull`: ORS 105.124, ORS 90.427
- From bill text (Introduced version): ORS 105.123, ORS 105.124, ORS 105.137, ORS 106.310, ORS 86.782, ORS 90.220, ORS 90.255, ORS 90.392, ORS 90.394, ORS 90.395, ORS 90.396, ORS 90.398, ORS 90.405, ORS 90.427, ORS 90.429, ORS 90.445, ORS 90.505, ORS 90.630, ORS 90.632

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `ccb26b1386556c0c1be6c3090196b62711ff32406f512adcde83991c35b8d120` (snapshot `_meta/snapshots/measure-2025r1-hb3851-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3851/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3851> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

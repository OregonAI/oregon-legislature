...
jurisdiction: oregon
id: measure-2025r1-hb2668
title: 'HB 2668 (2025R1): Requires certain private persons, before engaging in search and rescue efforts,
  to make specified disclosures to the family of the missing person and to notify county sheriffs.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2668
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2668/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 160dc9e733a5377743cd310043456a1fa932a971b62a0d4ea2614df779abfd6a
snapshot_id: measure-2025r1-hb2668-enrolled
status: current
...
catch_line: Requires certain private persons, before engaging in search and rescue efforts, to make specified
  disclosures to the family of the missing person and to notify county sheriffs.
minority_catch_line: null
measure_summary: "\tDigest: The Act says that private persons who help look for a missing person must\
  \ first tell certain things to the family of the missing person and to the county sheriff. (Flesch Readability\
  \ Score: 60.7). \n\tRequires certain private persons, before engaging in search and rescue efforts,\
  \ to make specified disclosures to the family of the missing person and to notify county sheriffs."
relating_to: Relating to search and rescue.
relating_to_full: Relating to search and rescue.
...
# HB 2668 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2668, 2025 Regular Session (2025R1)
- **LC number:** 198
...
- **Full text below:** Enrolled version, 4603 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2668/Enrolled>.

## Summary

**Catchline:** Requires certain private persons, before engaging in search and rescue efforts, to make specified disclosures to the family of the missing person and to notify county sheriffs.
...
**RelatingToFull (verbatim upstream field):** Relating to search and rescue.
...
Enrolled House Bill 2668 (HB 2668-A) Page 1
...
Enrolled House Bill 2668 (HB 2668-A) Page 2
...
- From bill text (Enrolled version): ORS 163.730, ORS 174.109, ORS 404.095, ORS 404.200

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `160dc9e733a5377743cd310043456a1fa932a971b62a0d4ea2614df779abfd6a` (snapshot `_meta/snapshots/measure-2025r1-hb2668-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2668/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `235f4c9669d31892987e6e07da093c2c76d99f2dfb3b441778f555086d98d3c4` (snapshot `_meta/snapshots/measure-2025r1-hb2668-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2668/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2668` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3525
title: 'HB 3525 (2025R1): Requires, for each dwelling unit rented by a landlord for which the source of
  drinking water is an exempt well in a ground water quality management area, that the landlord collect
  and test samples of drinking water from the dwelling unit for arsenic, coliform bacteria, lead and nitrates.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3525
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3525/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 376f96798f326be35b605808f89fc6670b24699835a803da52b6968ec5040749
snapshot_id: measure-2025r1-hb3525-enrolled
status: current
...
catch_line: Requires, for each dwelling unit rented by a landlord for which the source of drinking water
  is an exempt well in a ground water quality management area, that the landlord collect and test samples
  of drinking water from the dwelling unit for arsenic, coliform bacteria, lead and nitrates.
minority_catch_line: null
measure_summary: "\tDigest: This Act requires landlords to test tenants' wells for contaminants. (Flesch\
  \ Readability Score: 61.3). \n\tRequires, for each dwelling unit rented by a landlord for which the\
  \ source of drinking water is an exempt well in a ground water <b>quality</b> management area, that\
  \ the landlord collect and test samples of drinking water from the dwelling unit for arsenic, coliform\
...
relating_to_full: Relating to exempt wells that supply ground water for domestic purposes.
at_the_request_of: null
lc_number: 2769
measure_created_date: '2025-02-06T12:23:09'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3525>.

# HB 3525 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3525, 2025 Regular Session (2025R1)
- **LC number:** 2769
- **Created:** 2025-02-06T12:23:09
- **Metadata last modified (upstream):** 2025-08-13T12:44:25
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 15082 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3525/Enrolled>.

## Summary

**Catchline:** Requires, for each dwelling unit rented by a landlord for which the source of drinking water is an exempt well in a ground water quality management area, that the landlord collect and test samples of drinking water from the dwelling unit for arsenic, coliform bacteria, lead and nitrates.

**Relating to:** Relating to exempt wells that supply ground water for domestic purposes.
...
**RelatingToFull (verbatim upstream field):** Relating to exempt wells that supply ground water for domestic purposes.
...
- From bill text (Enrolled version): ORS 438.615, ORS 448.119, ORS 468B.150, ORS 537.545

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `376f96798f326be35b605808f89fc6670b24699835a803da52b6968ec5040749` (snapshot `_meta/snapshots/measure-2025r1-hb3525-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3525/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `b3288514015d9fa5529b3f21a75b3133043c17701ef39bddb22e9a1cad2b4a41` (snapshot `_meta/snapshots/measure-2025r1-hb3525-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3525/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3525> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

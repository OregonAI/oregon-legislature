...
jurisdiction: oregon
id: measure-2025r1-hb3041
title: 'HB 3041 (2025R1): Modifies the source of law that establishes the Educator Advancement Council
  from intergovernmental agreement to state statute.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3041
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3041/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c3bb3b70c2096a797752b6a1134975044619eac82cda939038551ec871234c7d
snapshot_id: measure-2025r1-hb3041-enrolled
status: current
...
catch_line: Modifies the source of law that establishes the Educator Advancement Council from intergovernmental
  agreement to state statute.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes the type of law that provides for a council related to educators.\
  \ (Flesch Readability Score: 61.8). \n\tModifies the source of law that establishes the Educator Advancement\
  \ Council from intergovernmental agreement to state statute. \n\tTakes effect on the 91st day following\
  \ adjournment sine die."
relating_to: Relating to the Educator Advancement Council; and prescribing an effective date.
relating_to_full: Relating to the Educator Advancement Council; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3041`.

# HB 3041 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3041, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 17304 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3041/Enrolled>.

## Summary

**Catchline:** Modifies the source of law that establishes the Educator Advancement Council from intergovernmental agreement to state statute.

**Relating to:** Relating to the Educator Advancement Council; and prescribing an effective date.

Digest: The Act changes the type of law that provides for a council related to educators. (Flesch Readability Score: 61.8). 
 Modifies the source of law that establishes the Educator Advancement Council from intergovernmental agreement to state statute. 
 Takes effect on the 91st day following adjournment sine die.

**RelatingToFull (verbatim upstream field):** Relating to the Educator Advancement Council; and prescribing an effective date.
...
Enrolled House Bill 3041 (HB 3041-INTRO) Page 1
...
Enrolled House Bill 3041 (HB 3041-INTRO) Page 2
...
Enrolled House Bill 3041 (HB 3041-INTRO) Page 3
(3)(a) A majority of the standing  members and a majority of the rotating members con-
...
Enrolled House Bill 3041 (HB 3041-INTRO) Page 4
...
Enrolled House Bill 3041 (HB 3041-INTRO) Page 5
...
Enrolled House Bill 3041 (HB 3041-INTRO) Page 6
...
- From bill text (Enrolled version): ORS 190.003, ORS 292.495, ORS 329.788, ORS 342.120, ORS 342.490, ORS 342.940, ORS 342.943, ORS 350.014

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `c3bb3b70c2096a797752b6a1134975044619eac82cda939038551ec871234c7d` (snapshot `_meta/snapshots/measure-2025r1-hb3041-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3041/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `b96995ec754fb5dc25b6d4b3d16849c4de320d287d28db5af13737ff439ae7a2` (snapshot `_meta/snapshots/measure-2025r1-hb3041-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3041/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3041` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-scr22
title: 'SCR 22 (2025R1): Commends the 2024 University of Oregon Ducks football team for their outstanding
  season.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Concurrent Resolution 22
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR22/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4cbef67a0af01e38347aedb14a53733dc7f7f4cb14414ce1f022bfd6132fc760
snapshot_id: measure-2025r1-scr22-enrolled
status: current
...
catch_line: Commends the 2024 University of Oregon Ducks football team for their outstanding season.
minority_catch_line: null
measure_summary: "\tDigest: Honors the UO Ducks football team. (Flesch Readability Score: 87.9). \n\t\
  Commends the 2024 University of Oregon Ducks football team for their outstanding season."
relating_to: Commending the 2024 University of Oregon Ducks football team.
relating_to_full: null
at_the_request_of: (at the request of Bill Hansell)
lc_number: 4368
measure_created_date: '2025-02-20T12:12:07'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SCR' and MeasureNumber eq 22`.

# SCR 22 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Concurrent Resolution 22, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Bill Hansell)
- **LC number:** 4368
- **Created:** 2025-02-20T12:12:07
- **Metadata last modified (upstream):** 2025-05-15T12:56:32
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 4260 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR22/Enrolled>.

## Summary

**Catchline:** Commends the 2024 University of Oregon Ducks football team for their outstanding season.

**Relating to:** Commending the 2024 University of Oregon Ducks football team.

Digest: Honors the UO Ducks football team. (Flesch Readability Score: 87.9). 
 Commends the 2024 University of Oregon Ducks football team for their outstanding season.
...
and
Enrolled Senate Concurrent Resolution 22 (SCR 22-INTRO) Page 1
Whereas the Ducks ended their superb season ranked third in the final Associated Press na-
tional poll; and
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `4cbef67a0af01e38347aedb14a53733dc7f7f4cb14414ce1f022bfd6132fc760` (snapshot `_meta/snapshots/measure-2025r1-scr22-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR22/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `7804dbf3ebf1e2c608909d78c9d7ffc5dc58f72d1ec121d5a7a1d02169817df0` (snapshot `_meta/snapshots/measure-2025r1-scr22-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR22/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SCR' and MeasureNumber eq 22` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb95
title: 'SB 95 (2025R1): Creates new circuit court judge positions in certain judicial districts.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 95
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB95/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5f7f53808f82da8b5bfe54dbe4e5612ecc2903d809449df4c5c522f9315287ce
snapshot_id: measure-2025r1-sb95-enrolled
status: current
...
measure_summary: "\tDigest: The Act adds new circuit court judges. (Flesch Readability Score: 89.8). \n\
  \tCreates new circuit court judge positions in certain judicial districts. \n\tDeclares an emergency,\
  \ effective on passage."
relating_to: Relating to judicial positions; and declaring an emergency.
relating_to_full: Relating to judicial positions; and declaring an emergency.
...
# SB 95 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 95, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 9452 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB95/Enrolled>.
...
**RelatingToFull (verbatim upstream field):** Relating to judicial positions; and declaring an emergency.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `5f7f53808f82da8b5bfe54dbe4e5612ecc2903d809449df4c5c522f9315287ce` (snapshot `_meta/snapshots/measure-2025r1-sb95-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB95/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `f66c4549f456e198262443926fca7851b46bdd83cdb6b23d0d8b52ec6da7cc64` (snapshot `_meta/snapshots/measure-2025r1-sb95-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB95/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 95> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb374
title: 'SB 374 (2025R1): Establishes certain limitation on projects under the Good Neighbor Authority
  Agreement.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 374
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB374/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5597f50027097ec76d43426ae1f3704a32c8b011fed536bab4c6fe049e2403dd
snapshot_id: measure-2025r1-sb374-introduced
status: current
...
catch_line: Establishes certain limitation on projects under the Good Neighbor Authority Agreement.
minority_catch_line: null
measure_summary: "\tDigest: The Act sets limits on projects under a certain agreement. (Flesch Readability\
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 374`.

# SB 374 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 374, 2025 Regular Session (2025R1)
- **LC number:** 2709
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-23T09:30:19
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 3032 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB374/Introduced>.

## Summary

**Catchline:** Establishes certain limitation on projects under the Good Neighbor Authority Agreement.

**Relating to:** Relating to the Good Neighbor Authority Agreement.

Digest: The Act sets limits on projects under a certain agreement. (Flesch Readability Score: 61.3). 
 Establishes certain limitation on projects under the Good Neighbor Authority Agreement.
...
LC 2709
on the gross appraised timber value of federal timber sales resulting from the projects.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `5597f50027097ec76d43426ae1f3704a32c8b011fed536bab4c6fe049e2403dd` (snapshot `_meta/snapshots/measure-2025r1-sb374-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB374/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 374` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3942
title: 'HB 3942 (2025R1): Directs the Oregon Health Authority to provide for an expedited licensure process
  for health care facilities, except long term care facilities and residential facilities that primarily
  serve persons under 21 years of age.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3942
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3942/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: dab431669b02b7f0560af89e24b845fdcbf57ab71ad134a4fc597039f743934c
snapshot_id: measure-2025r1-hb3942-enrolled
status: current
...
catch_line: Directs the Oregon Health Authority to provide for an expedited licensure process for health
  care facilities, except long term care facilities and residential facilities that primarily serve persons
  under 21 years of age.
minority_catch_line: null
measure_summary: "\t<b>Digest: Tells OHA to create a fast process for the issuance of licenses for health\
  \ care facilities. (Flesch Readability Score: 63.6).</b> \n\t[<i>Digest: Tells OHA and DHS to create\
  \ a fast process for issuing licenses for health care facilities. (Flesch Readability Score: 63.6).</i>]\
  \ \n\t<b>Directs the Oregon Health Authority to provide for an expedited licensure process for health\
  \ care facilities, except long term care facilities and residential facilities that primarily serve\
  \ persons under 21 years of age.</b> \n\tAllows a person or governmental unit to use [<i>an</i>] <b>the</b>\
  \ expedited licensure process to [<i>operate a health care facility, if the license is</i>] <b>apply\
  \ for a license</b> to operate a health care facility <b>that is</b> in the same physical location and\
  \ of the same type as a health care facility that previously operated at the location and the previously\
  \ operated health care facility <b>was</b> closed within the last [<i>24</i>] <b>60</b> months voluntarily\
  \ or due to financial hardship. \n\tAllows an applicant to be issued a provisional license to operate\
  \ the health care facility while the applicant's application is being processed and reviewed. \n\t<b>Makes\
  \ a person or governmental unit ineligible to use the expedited licensure process if the person or governmental\
  \ unit voluntarily surrendered a license to operate a health care facility under certain circumstances.</b>"
relating_to: Relating to an expedited licensure process for health care facilities.
relating_to_full: Relating to an expedited licensure process for health care facilities.
at_the_request_of: null
lc_number: 4776
measure_created_date: '2025-03-18T10:44:42'
measure_modified_date: '2026-04-15T10:21:27'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3942`.

# HB 3942 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3942, 2025 Regular Session (2025R1)
- **LC number:** 4776
- **Created:** 2025-03-18T10:44:42
- **Metadata last modified (upstream):** 2026-04-15T10:21:27
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 5424 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3942/Enrolled>.

## Summary

**Catchline:** Directs the Oregon Health Authority to provide for an expedited licensure process for health care facilities, except long term care facilities and residential facilities that primarily serve persons under 21 years of age.
...
**RelatingToFull (verbatim upstream field):** Relating to an expedited licensure process for health care facilities.
...
Enrolled House Bill 3942 (HB 3942-C) Page 1
cility meet the requirements listed  under paragraph (a) of this subsection or receive a waiver
...
Enrolled House Bill 3942 (HB 3942-C) Page 2
...
- From bill text (Enrolled version): ORS 441.015, ORS 441.025, ORS 442.315

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `dab431669b02b7f0560af89e24b845fdcbf57ab71ad134a4fc597039f743934c` (snapshot `_meta/snapshots/measure-2025r1-hb3942-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3942/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `a39790d3bf0460ae5af763ab48150a5baa45777f205177707ab56f2cb489cc7a` (snapshot `_meta/snapshots/measure-2025r1-hb3942-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3942/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3942` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb387
title: 'SB 387 (2025R1): Grants higher property tax exemptions for the property of veterans with disabilities.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 387
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB387/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 1bfbae1994ee9a8c0c8105ecb067de0347539faf36b2c0328519839c8a1892b8
snapshot_id: measure-2025r1-sb387-introduced
status: current
...
measure_summary: "\tDigest: The Act would grant higher property tax breaks for disabled veterans and their\
  \ spouses if they survive them. (Flesch Readability Score: 61.6). \n\tGrants higher property tax exemptions\
  \ for the property of veterans with disabilities. Grants exemptions for a veteran's surviving spouse\
...
measure_modified_date: '2025-05-23T08:36:20'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 387>.

# SB 387 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 387, 2025 Regular Session (2025R1)
- **LC number:** 861
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-05-23T08:36:20
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 17023 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB387/Introduced>.

## Summary

**Catchline:** Grants higher property tax exemptions for the property of veterans with disabilities.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `1bfbae1994ee9a8c0c8105ecb067de0347539faf36b2c0328519839c8a1892b8` (snapshot `_meta/snapshots/measure-2025r1-sb387-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB387/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 387> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2298
title: 'HB 2298 (2025R1): Modifies when a person can obtain an order setting aside a conviction, arrest,
  charge or guilty except for insanity judgment.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2298
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2298/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 9436e06a3dedc4167611517a64cb59553a3754e8469016d539e63a5add39ae5a
snapshot_id: measure-2025r1-hb2298-introduced
status: current
...
catch_line: Modifies when a person can obtain an order setting aside a conviction, arrest, charge or guilty
  except for insanity judgment.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes when a person can set aside a conviction, arrest or GEI finding.\
  \ (Flesch Readability Score: 67.5). \n\tModifies when a person can obtain an order setting aside a conviction,\
  \ arrest, charge or guilty except for insanity judgment."
relating_to: Relating to expungements.
relating_to_full: Relating to expungements; amending ORS 137.223 and 137.225.
...
# HB 2298 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2298, 2025 Regular Session (2025R1)
- **LC number:** 2032
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-18T19:11:54
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 25035 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2298/Introduced>.

## Summary

**Catchline:** Modifies when a person can obtain an order setting aside a conviction, arrest, charge or guilty except for insanity judgment.
...
**RelatingToFull (verbatim upstream field):** Relating to expungements; amending ORS 137.223 and 137.225.
...
arrest or  citation charge, the conviction charge, if different from the original, the date of charge,
...
ORS 813.200.
(b) An arrest, citation or charge for a Class A felony, if the district attorney objects to
the motion.
...
- From bill text (Introduced version): ORS 135.230, ORS 137.223, ORS 137.225, ORS 161.705, ORS 163.145, ORS 163.165, ORS 163.200, ORS 163.205, ORS 163.575, ORS 163A.005, ORS 163A.140, ORS 163A.145, ORS 166.429, ORS 21.135, ORS 419B.005, ORS 813.200

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `9436e06a3dedc4167611517a64cb59553a3754e8469016d539e63a5add39ae5a` (snapshot `_meta/snapshots/measure-2025r1-hb2298-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2298/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2298` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

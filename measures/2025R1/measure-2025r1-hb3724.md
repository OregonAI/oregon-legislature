...
jurisdiction: oregon
id: measure-2025r1-hb3724
title: 'HB 3724 (2025R1): Prohibits advertising, packaging and labeling of marijuana items in a manner
  likely to cause minors to unlawfully possess or consume marijuana items.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3724
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3724/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 222ac0d2df0e0158017fa23fb9a698bbf35141840a64fb3f3141e9cbdd62a812
snapshot_id: measure-2025r1-hb3724-enrolled
status: current
...
catch_line: Prohibits advertising, packaging and labeling of marijuana items in a manner likely to cause
  minors to unlawfully possess or consume marijuana items.
minority_catch_line: null
measure_summary: "\tDigest: The Act says that marijuana items may not be labeled or packed in a way that\
  \ makes minors want the marijuana items. (Flesch Readability Score: 61.4). \n\tProhibits advertising,\
  \ packaging and labeling of marijuana items in a manner likely to cause minors to unlawfully possess\
  \ or consume marijuana items. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to cannabis; and prescribing an effective date.
relating_to_full: Relating to cannabis; and prescribing an effective date.
at_the_request_of: null
lc_number: 4338
measure_created_date: '2025-02-24T11:21:27'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3724`.

# HB 3724 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3724, 2025 Regular Session (2025R1)
- **LC number:** 4338
- **Created:** 2025-02-24T11:21:27
- **Metadata last modified (upstream):** 2025-06-06T13:58:42
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 9987 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3724/Enrolled>.

## Summary

**Catchline:** Prohibits advertising, packaging and labeling of marijuana items in a manner likely to cause minors to unlawfully possess or consume marijuana items.
...
**RelatingToFull (verbatim upstream field):** Relating to cannabis; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 431A.175, ORS 475C.005, ORS 475C.017, ORS 475C.065, ORS 475C.085, ORS 475C.093, ORS 475C.097, ORS 475C.297, ORS 475C.540, ORS 475C.548, ORS 475C.612, ORS 475C.770, ORS 475C.777, ORS 475C.833

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `222ac0d2df0e0158017fa23fb9a698bbf35141840a64fb3f3141e9cbdd62a812` (snapshot `_meta/snapshots/measure-2025r1-hb3724-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3724/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `df05c9f69dd9748f8a600cea2eb179501077c6cbfe9726fae4bd3e12a3abd63d` (snapshot `_meta/snapshots/measure-2025r1-hb3724-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3724/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3724` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

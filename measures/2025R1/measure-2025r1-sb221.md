...
jurisdiction: oregon
id: measure-2025r1-sb221
title: 'SB 221 (2025R1): Directs the State Department of Fish and Wildlife to assist in the establishment
  of fall Chinook fish incubation nursery programs, and to report on the programs to the Legislative Assembly.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 221
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB221/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4c38c4072e1fb89fc1839fcf04178a79a9b5dc7c12c6b04a2754b93c88fab5fa
snapshot_id: measure-2025r1-sb221-enrolled
status: current
...
catch_line: Directs the State Department of Fish and Wildlife to assist in the establishment of fall Chinook
  fish incubation nursery programs, and to report on the programs to the Legislative Assembly.
minority_catch_line: null
measure_summary: "\tDigest: The Act directs ODFW to support certain fish rearing projects. The Act starts\
  \ when signed. (Flesch Readability Score: 86.4). \n\tDirects the State Department of Fish and Wildlife\
  \ to assist in the establishment of fall Chinook fish incubation nursery programs, and to report on\
  \ the programs to the Legislative Assembly. <b>Sunsets January 2, 2040.</b> \n\tDeclares an emergency,\
  \ effective on passage."
relating_to: Relating to a fish enhancement program; and declaring an emergency.
relating_to_full: Relating to a fish enhancement program; and declaring an emergency.
...
# SB 221 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 221, 2025 Regular Session (2025R1)
- **LC number:** 1380
...
- **Full text below:** Enrolled version, 6897 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB221/Enrolled>.

## Summary

**Catchline:** Directs the State Department of Fish and Wildlife to assist in the establishment of fall Chinook fish incubation nursery programs, and to report on the programs to the Legislative Assembly.
...
**RelatingToFull (verbatim upstream field):** Relating to a fish enhancement program; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 192.245, ORS 496.440, ORS 496.445, ORS 496.458

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `4c38c4072e1fb89fc1839fcf04178a79a9b5dc7c12c6b04a2754b93c88fab5fa` (snapshot `_meta/snapshots/measure-2025r1-sb221-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB221/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `c2d6f952cc31bcd277fd950d70ff80a048aadd6bc5f8abc90fb217e9a4f58fe3` (snapshot `_meta/snapshots/measure-2025r1-sb221-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB221/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 221` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3212
title: 'HB 3212 (2025R1): Creates additional rules and requirements for pharmacy benefit managers and
  a policy or certificate of health insurance or other contract providing for the reimbursement of the
  cost of a prescription drug.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3212
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3212/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e803b06211d8dae0e925d11d71aec0edd5c9bcb94471a1c964cc4808b668637f
snapshot_id: measure-2025r1-hb3212-introduced
status: current
...
catch_line: Creates additional rules and requirements for pharmacy benefit managers and a policy or certificate
  of health insurance or other contract providing for the reimbursement of the cost of a prescription
  drug.
minority_catch_line: null
measure_summary: "\tDigest: Makes changes to the rules for PBMs and prescription drug benefits. (Flesch\
  \ Readability Score: 64.9). \n\tCreates additional rules and requirements for pharmacy benefit managers\
  \ and a policy or certificate of health insurance or other contract providing for the reimbursement\
  \ of the cost of a prescription drug."
relating_to: Relating to pharmacy benefits.
relating_to_full: Relating to pharmacy benefits; amending ORS 735.534 and 743A.062.
...
# HB 3212 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3212, 2025 Regular Session (2025R1)
- **LC number:** 2723
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-04-15T17:18:14
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 14614 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3212/Introduced>.

## Summary

**Catchline:** Creates additional rules and requirements for pharmacy benefit managers and a policy or certificate of health insurance or other contract providing for the reimbursement of the cost of a prescription drug.
...
**RelatingToFull (verbatim upstream field):** Relating to pharmacy benefits; amending ORS 735.534 and 743A.062.
...
(p) May not sign  or enter into a contract with a pharmacy or pharmacy services admin-
...
- From `RelatingToFull`: ORS 735.534, ORS 743A.062
- From bill text (Introduced version): ORS 414.025, ORS 414.353, ORS 414.688, ORS 689.515, ORS 735.530, ORS 735.532, ORS 735.534, ORS 735.540, ORS 743A.001, ORS 743A.062, ORS 750.005, ORS 750.055

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `e803b06211d8dae0e925d11d71aec0edd5c9bcb94471a1c964cc4808b668637f` (snapshot `_meta/snapshots/measure-2025r1-hb3212-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3212/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3212> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

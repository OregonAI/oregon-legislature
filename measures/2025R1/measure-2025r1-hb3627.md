...
jurisdiction: oregon
id: measure-2025r1-hb3627
title: 'HB 3627 (2025R1): Establishes the Disabled Veterans Assistance Fund.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3627
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3627/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 37228459d09f4761f5cb051adc5f43802d685337f2ca279a02379a63e721fe07
snapshot_id: measure-2025r1-hb3627-introduced
status: current
...
measure_summary: "\tDigest: The Act creates the Disabled Veterans Assistance Fund. The Act tells a state\
  \ agency to give money from the fund to disabled veterans for some purposes. (Flesch Readability Score:\
  \ 60.2). \n\tEstablishes the Disabled Veterans Assistance Fund. Requires the Department of Veterans'\
  \ Affairs to provide grants to disabled veterans for accessibility resources at residences inhabited\
  \ by the veteran if the residence is owned by the veteran or a family member of the veteran. \n\tTakes\
...
relating_to_full: Relating to funding for disabled veterans; and prescribing an effective date.
at_the_request_of: null
lc_number: 4294
measure_created_date: '2025-02-17T18:52:06'
...
# HB 3627 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3627, 2025 Regular Session (2025R1)
- **LC number:** 4294
- **Created:** 2025-02-17T18:52:06
- **Metadata last modified (upstream):** 2025-03-28T14:35:39
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4305 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3627/Introduced>.

## Summary

**Catchline:** Establishes the Disabled Veterans Assistance Fund.
...
**RelatingToFull (verbatim upstream field):** Relating to funding for disabled veterans; and prescribing an effective date.
...
LC 4294
earned by the Disabled Veterans Assistance Fund shall be credited to the fund.
...
- From bill text (Introduced version): ORS 192.245, ORS 408.225

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `37228459d09f4761f5cb051adc5f43802d685337f2ca279a02379a63e721fe07` (snapshot `_meta/snapshots/measure-2025r1-hb3627-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3627/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3627` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

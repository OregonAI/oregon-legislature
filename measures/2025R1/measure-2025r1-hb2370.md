...
jurisdiction: oregon
id: measure-2025r1-hb2370
title: 'HB 2370 (2025R1): Increases the annual fee amount that the Public Utility Commission may impose
  on public utilities for the purpose of defraying costs of the commission.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2370
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2370/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b47e45f81a955c5834f13144d92f0941d446e28059ba42f062954a5c208537cf
snapshot_id: measure-2025r1-hb2370-enrolled
status: current
...
catch_line: Increases the annual fee amount that the Public Utility Commission may impose on public utilities
  for the purpose of defraying costs of the commission.
minority_catch_line: null
measure_summary: "\tDigest: Raises the annual fee amount that the PUC may impose on public utilities to\
  \ cover costs of the commission. Takes effect when the Governor signs it. (Flesch Readability Score:\
  \ 63.4). \n\tIncreases the annual fee amount that the Public Utility Commission may impose on public\
  \ utilities for the purpose of defraying costs of the commission. \n\tDeclares an emergency, effective\
  \ on passage."
relating_to: Relating to fees imposed by the Public Utility Commission; and declaring an emergency.
relating_to_full: Relating to fees imposed by the Public Utility Commission; and declaring an emergency.
at_the_request_of: (at the request of Governor Tina Kotek for Public Utility Commission of Oregon)
lc_number: 452
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2370`.

# HB 2370 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2370, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Governor Tina Kotek for Public Utility Commission of Oregon)
- **LC number:** 452
...
- **Full text below:** Enrolled version, 5683 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2370/Enrolled>.

## Summary

**Catchline:** Increases the annual fee amount that the Public Utility Commission may impose on public utilities for the purpose of defraying costs of the commission.
...
**RelatingToFull (verbatim upstream field):** Relating to fees imposed by the Public Utility Commission; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 756.310, ORS 757.005, ORS 759.005

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `b47e45f81a955c5834f13144d92f0941d446e28059ba42f062954a5c208537cf` (snapshot `_meta/snapshots/measure-2025r1-hb2370-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2370/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `c21a143d0c2bec023abe6aff13ef05b7039aa6f2743a46743af74b8854c8437a` (snapshot `_meta/snapshots/measure-2025r1-hb2370-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2370/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2370` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

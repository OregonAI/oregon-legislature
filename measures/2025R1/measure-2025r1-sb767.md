...
jurisdiction: oregon
id: measure-2025r1-sb767
title: 'SB 767 (2025R1): Directs each school district board to adopt a prevention curriculum that addresses
  child sex trafficking.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 767
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB767/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5629ddd3ad3378e654a32145d45127cdd8a5214c8fba417bf4733a8ef1a9fbab
snapshot_id: measure-2025r1-sb767-introduced
status: current
...
catch_line: Directs each school district board to adopt a prevention curriculum that addresses child sex
  trafficking.
minority_catch_line: null
measure_summary: "\tDigest: Directs each school district board to teach about preventing child sex trafficking.\
  \ (Flesch Readability Score: 60.7). \n\tDirects each school district board to adopt a prevention curriculum\
  \ that addresses child sex trafficking. \n\tDeclares an emergency, effective July 1, 2025."
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 767`.

# SB 767 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 767, 2025 Regular Session (2025R1)
- **LC number:** 1223
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T11:07:54
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4273 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB767/Introduced>.

## Summary

**Catchline:** Directs each school district board to adopt a prevention curriculum that addresses child sex trafficking.
...
LC 1223
(C) Making and receiving child sexual abuse and child sex trafficking reports and disclosures
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `5629ddd3ad3378e654a32145d45127cdd8a5214c8fba417bf4733a8ef1a9fbab` (snapshot `_meta/snapshots/measure-2025r1-sb767-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB767/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 767` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3337
title: 'HB 3337 (2025R1): Makes changes to the highway worker photo radar laws.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3337
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3337/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 96896166bfa8b021fc410befc196547ba52889e923e5b2b0c051ab8251c2a993
snapshot_id: measure-2025r1-hb3337-introduced
status: current
...
lc_number: 651
measure_created_date: '2025-01-17T14:27:50'
measure_modified_date: '2025-02-04T17:24:17'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 10759
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3337`.

# HB 3337 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3337, 2025 Regular Session (2025R1)
- **LC number:** 651
- **Created:** 2025-01-17T14:27:50
- **Metadata last modified (upstream):** 2025-02-04T17:24:17
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 10759 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3337/Introduced>.
...
House Bill 3337
Sponsored by Representative NERON; Representative TRAN
SUMMARY
...
within [ a] highway work [ zone that is ] zones that are  located  on [ a state highway] state
...
registered owner and only if the [ jurisdiction] Oregon State Police  verifies that the registered
...
photo radar program under ORS 810.441. Any revenue generated  that exceeds program costs
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `96896166bfa8b021fc410befc196547ba52889e923e5b2b0c051ab8251c2a993` (snapshot `_meta/snapshots/measure-2025r1-hb3337-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3337/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3337` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

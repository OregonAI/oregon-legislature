...
jurisdiction: oregon
id: measure-2025r1-hcr28
title: 'HCR 28 (2025R1): Designates the week of August 17 to 23, 2025, as Community Healthcare Workers
  Week.'
doc_type: dataset_doc
citation: 2025 Regular Session House Concurrent Resolution 28
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR28/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 6d4fa0919a93818bfd9826aa94861ac4c87e9b42c7afbd66ec8ed2c515dc41b7
snapshot_id: measure-2025r1-hcr28-enrolled
status: current
...
catch_line: Designates the week of August 17 to 23, 2025, as Community Healthcare Workers Week.
minority_catch_line: null
measure_summary: "\t<b>Digest: Names a week in August of this year to honor community healthcare workers.\
  \ (Flesch Readability Score: 63.4).</b> \n\t[<i>Digest: Shows support for a week each year that celebrates\
  \ and honors community health care workers. (Flesch Readability Score: 61.8).</i>] \n\t[<i>Supports\
  \ the goals and ideals of National Community Health Worker Awareness Week.</i>] \n\t<b>Designates the\
  \ week of August 17 to 23, 2025, as Community Healthcare Workers Week.</b>"
relating_to: Designating the week of August 17 to 23, 2025, as Community Healthcare Workers Week.
relating_to_full: null
at_the_request_of: null
lc_number: 3700
measure_created_date: '2025-02-26T10:52:57'
measure_modified_date: '2025-05-01T12:58:50'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 28`.

# HCR 28 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Concurrent Resolution 28, 2025 Regular Session (2025R1)
- **LC number:** 3700
- **Created:** 2025-02-26T10:52:57
- **Metadata last modified (upstream):** 2025-05-01T12:58:50
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 3802 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR28/Enrolled>.

## Summary

**Catchline:** Designates the week of August 17 to 23, 2025, as Community Healthcare Workers Week.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `6d4fa0919a93818bfd9826aa94861ac4c87e9b42c7afbd66ec8ed2c515dc41b7` (snapshot `_meta/snapshots/measure-2025r1-hcr28-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR28/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `1195cc22767e9bd0f9e5de47be359f029ddc36d35aa6709190fef97bf2efe824` (snapshot `_meta/snapshots/measure-2025r1-hcr28-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR28/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 28` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

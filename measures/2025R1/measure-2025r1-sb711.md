...
jurisdiction: oregon
id: measure-2025r1-sb711
title: 'SB 711 (2025R1): Makes changes to the highway worker photo radar laws.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 711
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB711/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 3680925c9a123bc07bfcb67d32a60b533c457b6eb9db877d646dea2fc2bc8ce6
snapshot_id: measure-2025r1-sb711-introduced
status: current
...
measure_modified_date: '2025-05-14T18:52:37'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 10775
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 711`.

# SB 711 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 711, 2025 Regular Session (2025R1)
- **LC number:** 234
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-05-14T18:52:37
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 10775 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB711/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `3680925c9a123bc07bfcb67d32a60b533c457b6eb9db877d646dea2fc2bc8ce6` (snapshot `_meta/snapshots/measure-2025r1-sb711-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB711/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 711` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

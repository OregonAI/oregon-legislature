...
jurisdiction: oregon
id: measure-2025r1-hb3140
title: 'HB 3140 (2025R1): Provides that an operator may require a person who engages in a sport, fitness
  or recreational activity in various ways to release the operator from claims for ordinary negligence.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3140
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3140/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 458b319ca771b3892ae54b4ba92ed43d2510755b7bc070dc18b281af55a72e0f
snapshot_id: measure-2025r1-hb3140-introduced
status: current
...
measure_summary: "\tDigest: The Act says that an operator can make a person who does recreation release\
  \ the operator from some types of claims. Tells OBDD to study issues for the recreation industry and\
  \ make a report. (Flesch Readability Score: 62.6). \n\tProvides that an operator may require a person\
  \ who engages in a sport, fitness or recreational activity in various ways to release the operator from\
  \ claims for ordinary negligence. \n\tDirects the Oregon Business Development Department, with the assistance\
  \ of the Department of Consumer and Business Services, to study issues facing the recreation industry\
  \ and report to a committee of the Legislative Assembly related to the environment no later than September\
  \ 15, 2026. Appropriates moneys for study. \n\tDeclares an emergency, effective on passage."
...
measure_modified_date: '2025-02-26T15:18:59'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3140`.

# HB 3140 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3140, 2025 Regular Session (2025R1)
- **LC number:** 787
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-02-26T15:18:59
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6505 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3140/Introduced>.
...
LC 787
from a release for ordinary negligence required by the  operator. A release that is broader
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `458b319ca771b3892ae54b4ba92ed43d2510755b7bc070dc18b281af55a72e0f` (snapshot `_meta/snapshots/measure-2025r1-hb3140-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3140/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3140` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb103
title: 'SB 103 (2025R1): Modifies experience and education requirements to take the certified public accountant
  examination and qualify for a certificate of certified public accountant.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 103
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB103/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 2221bf281bef6c1a204d6a437ef7b1899a4119ace269ad40179cd67cbc709192
snapshot_id: measure-2025r1-sb103-introduced
status: current
...
catch_line: Modifies experience and education requirements to take the certified public accountant examination
  and qualify for a certificate of certified public accountant.
minority_catch_line: null
measure_summary: "\tDigest: The Act modifies the experience and education required to take the CPA exam\
  \ and to be a CPA. (Flesch Readability Score: 61.6). \n\tModifies experience and education requirements\
  \ to take the certified public accountant examination and qualify for a certificate of certified public\
  \ accountant."
relating_to: Relating to requirements to become a certified public accountant.
relating_to_full: Relating to requirements to become a certified public accountant; creating new provisions;
  and amending ORS 673.010, 673.040 and 673.050.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 103>.

# SB 103 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 103, 2025 Regular Session (2025R1)
...
- **Full text below:** Introduced version, 19105 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB103/Introduced>.

## Summary

**Catchline:** Modifies experience and education requirements to take the certified public accountant examination and qualify for a certificate of certified public accountant.

**Relating to:** Relating to requirements to become a certified public accountant.

Digest: The Act modifies the experience and education required to take the CPA exam and to be a CPA. (Flesch Readability Score: 61.6). 
 Modifies experience and education requirements to take the certified public accountant examination and qualify for a certificate of certified public accountant.

**RelatingToFull (verbatim upstream field):** Relating to requirements to become a certified public accountant; creating new provisions; and amending ORS 673.010, 673.040 and 673.050.
...
(b) Does not include assurances by the person that the representations in the financial statement
...
one year of experience, verified by a license holder, in providing any type of service  involving
...
- From `RelatingToFull`: ORS 673.010, ORS 673.040, ORS 673.050
- From bill text (Introduced version): ORS 673.010, ORS 673.040, ORS 673.050, ORS 673.060, ORS 673.100, ORS 673.150, ORS 673.160, ORS 673.310

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `2221bf281bef6c1a204d6a437ef7b1899a4119ace269ad40179cd67cbc709192` (snapshot `_meta/snapshots/measure-2025r1-sb103-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB103/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 103> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

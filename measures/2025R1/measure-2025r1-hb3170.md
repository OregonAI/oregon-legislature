...
jurisdiction: oregon
id: measure-2025r1-hb3170
title: 'HB 3170 (2025R1): Modifies the definitions of and grant requirements for Resilience Hubs and Resilience
  Networks.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3170
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3170/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a8f84c8d7fb82a5ea0dbd82dd437cdb1f10233295eae03b0d69c1043b48713f4
snapshot_id: measure-2025r1-hb3170-introduced
status: current
...
catch_line: Modifies the definitions of and grant requirements for Resilience Hubs and Resilience Networks.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes changes to laws about networks that help people prepare for\
  \ and respond to disasters. (Flesch Readability Score: 65.1). \n\tModifies the definitions of and grant\
  \ requirements for Resilience Hubs and Resilience Networks. \n\tAppropriates moneys from the General\
  \ Fund to the Department of Human Services for providing grants for Resilience Hubs and Resilience Networks.\
  \ \n\tDeclares an emergency, effective July 1, 2025."
relating_to: Relating to community resilience; declaring an emergency.
relating_to_full: Relating to community resilience; creating new provisions; amending ORS 409.760; and
  declaring an emergency.
at_the_request_of: null
lc_number: 1210
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-03-06T16:19:47'
...
# HB 3170 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3170, 2025 Regular Session (2025R1)
- **LC number:** 1210
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-03-06T16:19:47
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7280 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3170/Introduced>.

## Summary

**Catchline:** Modifies the definitions of and grant requirements for Resilience Hubs and Resilience Networks.

**Relating to:** Relating to community resilience; declaring an emergency.

Digest: The Act makes changes to laws about networks that help people prepare for and respond to disasters. (Flesch Readability Score: 65.1). 
 Modifies the definitions of and grant requirements for Resilience Hubs and Resilience Networks. 
 Appropriates moneys from the General Fund to the Department of Human Services for providing grants for Resilience Hubs and Resilience Networks. 
 Declares an emergency, effective July 1, 2025.

**RelatingToFull (verbatim upstream field):** Relating to community resilience; creating new provisions; amending ORS 409.760; and declaring an emergency.
...
the General Fund, the amount of $10,000,000, which may be expended to  provide grants under
ORS 409.760.
SECTION 3.
...
- From `RelatingToFull`: ORS 409.760
- From bill text (Introduced version): ORS 409.760

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `a8f84c8d7fb82a5ea0dbd82dd437cdb1f10233295eae03b0d69c1043b48713f4` (snapshot `_meta/snapshots/measure-2025r1-hb3170-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3170/Introduced>.

...
jurisdiction: oregon
id: measure-2025r1-hb2926
title: 'HB 2926 (2025R1): Allows the Department of Public Safety Standards and Training to proceed with
  an investigation of, or action to deny the application for training or deny the certification of, a
  public safety officer or instructor notwithstanding a subsequent change in the employment status of
  the officer or instructor.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2926
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2926/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b294b15e66fad447c726d36664ce0b34a29321c5c266ad58a9f8c7359b19fa97
snapshot_id: measure-2025r1-hb2926-introduced
status: current
...
catch_line: Allows the Department of Public Safety Standards and Training to proceed with an investigation
  of, or action to deny the application for training or deny the certification of, a public safety officer
  or instructor notwithstanding a subsequent change in the employment status of the officer or instructor.
minority_catch_line: null
measure_summary: "\tDigest: The Act allows DPSST to act against an officer or instructor even if the officer\
  \ or instructor leaves the job. Lets DPSST make rules. (Flesch Readability Score: 64.2). \n\tAllows\
  \ the Department of Public Safety Standards and Training to proceed with an investigation of, or action\
  \ to deny the application for training or deny the certification of, a public safety officer or instructor\
  \ notwithstanding a subsequent change in the employment status of the officer or instructor. \n\tAllows\
  \ the department to adopt rules. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to the jurisdiction of the Department of Public Safety Standards and Training in
  cases of denial; prescribing an effective date.
relating_to_full: Relating to the jurisdiction of the Department of Public Safety Standards and Training
  in cases of denial; creating new provisions; amending ORS 181A.640; and prescribing an effective date.
at_the_request_of: (at the request of Governor Tina Kotek for Department of Public Safety Standards and
  Training)
lc_number: 432
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-05-19T15:10:23'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2926`.

# HB 2926 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2926, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Governor Tina Kotek for Department of Public Safety Standards and Training)
- **LC number:** 432
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-05-19T15:10:23
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 9261 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2926/Introduced>.

## Summary

**Catchline:** Allows the Department of Public Safety Standards and Training to proceed with an investigation of, or action to deny the application for training or deny the certification of, a public safety officer or instructor notwithstanding a subsequent change in the employment status of the officer or instructor.

**Relating to:** Relating to the jurisdiction of the Department of Public Safety Standards and Training in cases of denial; prescribing an effective date.

Digest: The Act allows DPSST to act against an officer or instructor even if the officer or instructor leaves the job. Lets DPSST make rules. (Flesch Readability Score: 64.2). 
 ...
 Allows the department to adopt rules. 
 Takes effect on the 91st day following adjournment sine die.

**RelatingToFull (verbatim upstream field):** Relating to the jurisdiction of the Department of Public Safety Standards and Training in cases of denial; creating new provisions; amending ORS 181A.640; and prescribing an effective date.
...
standards.
Digest: The Act allows DPSST to  act against an officer or instructor even if the officer or in-
structor leaves the job. Lets DPSST make rules. (Flesch Readability Score: 64.2).
Allows the Department of  Public Safety Standards and Training to proceed with an investigation
of, or action to deny the application for training or deny the certification of, a public safety officer
or instructor notwithstanding a subsequent change in the employment status of the officer or in-
structor.
Allows the department to adopt rules.
Takes effect on the 91st day following adjournment sine die.
A BILL FOR AN ACT
Relating to the  jurisdiction of the Department of Public Safety Standards and Training in cases of
denial; creating new provisions; amending ORS 181A.640; and prescribing an effective date.
...
[(10) In cases involving a proposed denial of training or certification of a public  safety officer or
instructor by the department, the department has  jurisdiction to proceed with any action against the
public safety officer or instructor notwithstanding a  subsequent change in the employment status of the
officer or instructor, if: ]
...
(10) The department has jurisdiction and  may proceed with any investigation of, or action
to deny the application for training or deny  the certification of, a public safety officer or
instructor notwithstanding a subsequent change  in the employment status of the officer or
instructor. The department may adopt rules to implement this subsection.
SECTION 2.
(1) The amendments to  ORS 181A.640 by section 1 of this 2025 Act become
operative January 1, 2026.
(2) The Department of  Public Safety Standards and Training may take any action before
the operative date specified in subsection (1) of this section to enable  the department to ex-
...
181A.640 by section 1 of this 2025 Act.
SECTION 3.
...
- From `RelatingToFull`: ORS 181A.640
- From bill text (Introduced version): ORS 107.705, ORS 135.230, ORS 137.700, ORS 163A.005, ORS 181A.410, ORS 181A.630, ORS 181A.640, ORS 181A.790, ORS 670.280

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `b294b15e66fad447c726d36664ce0b34a29321c5c266ad58a9f8c7359b19fa97` (snapshot `_meta/snapshots/measure-2025r1-hb2926-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2926/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2926` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

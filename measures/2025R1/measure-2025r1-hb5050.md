...
jurisdiction: oregon
id: measure-2025r1-hb5050
title: 'HB 5050 (2025R1): Modifies the amounts authorized for issuance of general obligation bonds in
  the 2023-2025 biennium.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 5050
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB5050/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 790602289dfd4d2a1acc0c653f735a7e3e8bd2a4c18ad32950c68fd45ab95e5e
snapshot_id: measure-2025r1-hb5050-enrolled
status: current
...
catch_line: Modifies the amounts authorized for issuance of general obligation bonds in the 2023-2025
  biennium.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act changes the amounts authorized for bonding. (Flesch Readability\
  ...
  \ from federal funds.</i>] \n\t<b>Modifies the amounts authorized for issuance of general obligation\
  \ bonds in the 2023-2025 biennium.</b> \n\tDeclares an emergency, effective [<i>July 1, 2025</i>]<b>\
  \ on passage</b>."
...
measure_modified_date: '2026-03-24T13:36:34'
...
# HB 5050 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 5050, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Oregon Department of Administrative Services)
- **LC number:** 9050
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-03-24T13:36:34
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 9740 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB5050/Enrolled>.

## Summary

**Catchline:** Modifies the amounts authorized for issuance of general obligation bonds in the 2023-2025 biennium.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `790602289dfd4d2a1acc0c653f735a7e3e8bd2a4c18ad32950c68fd45ab95e5e` (snapshot `_meta/snapshots/measure-2025r1-hb5050-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB5050/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `fb0da97542108dd26d2204cdf151353343d4402a14cb0c654634d1ed84bc12fe` (snapshot `_meta/snapshots/measure-2025r1-hb5050-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB5050/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 5050` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

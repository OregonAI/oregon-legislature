...
jurisdiction: oregon
id: measure-2025r1-hb3941
title: 'HB 3941 (2025R1): Directs the Department of Education to establish and administer a grant program
  for community schools.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3941
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3941/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ba38e8638ce6e70dbeda2a9ee9d0d17eff576d10500b60d8bcb6fb4c0af3ccf0
snapshot_id: measure-2025r1-hb3941-introduced
status: current
...
catch_line: Directs the Department of Education to establish and administer a grant program for community
  schools.
minority_catch_line: null
measure_summary: "\tDigest: Tells ODE to create a grant program for community schools. (Flesch Readability\
  \ Score: 78.2). \n\tDirects the Department of Education to establish and administer a grant program\
  \ for community schools. Prescribes the requirements of the grant program. \n\tAllocates lottery funds\
  \ for the grant program. \n\tDeclares an emergency, effective July 1, 2025."
relating_to: Relating to community schools; declaring an emergency.
relating_to_full: Relating to community schools; and declaring an emergency.
at_the_request_of: null
lc_number: 4721
measure_created_date: '2025-03-17T15:15:02'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3941`.

# HB 3941 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3941, 2025 Regular Session (2025R1)
- **LC number:** 4721
- **Created:** 2025-03-17T15:15:02
- **Metadata last modified (upstream):** 2025-04-25T08:37:28
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4787 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3941/Introduced>.

## Summary

**Catchline:** Directs the Department of Education to establish and administer a grant program for community schools.

**Relating to:** Relating to community schools; declaring an emergency.

Digest: Tells ODE to create a grant program for community schools. (Flesch Readability Score: 78.2). 
 Directs the Department of Education to establish and administer a grant program for community schools. Prescribes the requirements of the grant program. 
 Allocates lottery funds for the grant program. 
 Declares an emergency, effective July 1, 2025.

**RelatingToFull (verbatim upstream field):** Relating to community schools; and declaring an emergency.
...
SECTION 1.
(1) The Department of Education shall  establish and administer a grant
...
LC 4721
experience in trauma-informed school systems,  culturally specific community engagement,
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `ba38e8638ce6e70dbeda2a9ee9d0d17eff576d10500b60d8bcb6fb4c0af3ccf0` (snapshot `_meta/snapshots/measure-2025r1-hb3941-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3941/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3941` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

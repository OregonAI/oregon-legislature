...
jurisdiction: oregon
id: measure-2025r1-hb3731
title: 'HB 3731 (2025R1): Provides additional data to be included by institutions of higher education
  in an annual report regarding allegations of sexual misconduct and violence on the campus of the institution.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3731
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3731/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 972a02c4a8edf65207fcee522f8adbafeb835eb27eb602d3c23422d0a061a79e
snapshot_id: measure-2025r1-hb3731-enrolled
status: current
...
catch_line: Provides additional data to be included by institutions of higher education in an annual report
  regarding allegations of sexual misconduct and violence on the campus of the institution.
minority_catch_line: null
measure_summary: "\tDigest: The Act adds data to be added to the yearly reports made by higher learning\
  \ schools. (Flesch Readability Score: 77.9). \n\tProvides additional data to be included by institutions\
  \ of higher education in an annual report regarding allegations of sexual misconduct and violence on\
  \ the campus of the institution. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to reporting by institutions of higher education; and declaring an emergency.
relating_to_full: Relating to reporting by institutions of higher education; and declaring an emergency.
at_the_request_of: null
lc_number: 4450
measure_created_date: '2025-02-24T14:12:57'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3731`.

# HB 3731 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3731, 2025 Regular Session (2025R1)
- **LC number:** 4450
- **Created:** 2025-02-24T14:12:57
- **Metadata last modified (upstream):** 2025-07-07T12:29:57
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 7226 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3731/Enrolled>.

## Summary

**Catchline:** Provides additional data to be included by institutions of higher education in an annual report regarding allegations of sexual misconduct and violence on the campus of the institution.

**Relating to:** Relating to reporting by institutions of higher education; and declaring an emergency.

Digest: The Act adds data to be added to the yearly reports made by higher learning schools. (Flesch Readability Score: 77.9). 
...
**RelatingToFull (verbatim upstream field):** Relating to reporting by institutions of higher education; and declaring an emergency.
...
- From bill text (Enrolled version): ORS 192.245, ORS 345.010, ORS 350.345

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `972a02c4a8edf65207fcee522f8adbafeb835eb27eb602d3c23422d0a061a79e` (snapshot `_meta/snapshots/measure-2025r1-hb3731-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3731/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `fd5b50a013179775b5f9cd05d5d97e7f49bd2fbd3ef13c9be486395297fea8f3` (snapshot `_meta/snapshots/measure-2025r1-hb3731-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3731/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3731` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2725
title: 'HB 2725 (2025R1): Limits the kind of port districts that are required to be involved in strategic
  investment program agreements with respect to eligible projects that are located in the port district''s
  territory.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2725
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2725/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: c116b65c8ca2d82bbf2da72400d4452118972e3bc6ba1afc7f5683e36c328c58
snapshot_id: measure-2025r1-hb2725-enrolled
status: current
...
catch_line: Limits the kind of port districts that are required to be involved in strategic investment
  program agreements with respect to eligible projects that are located in the port district's territory.
minority_catch_line: null
measure_summary: "\tDigest: The Act would limit the kind of port district that must be a party to a contract\
  \ in the strategic investment program. (Flesch Readability Score: 65.2). \n\tLimits the kind of port\
  \ districts that are required to be involved in strategic investment program agreements with respect\
  \ to eligible projects that are located in the port district's territory. \n\tTakes effect on the 91st\
  \ day following adjournment sine die."
relating_to: Relating to the inclusion of ports in strategic investment program agreements; and prescribing
  an effective date.
relating_to_full: Relating to the inclusion of ports in strategic investment program agreements; and prescribing
  an effective date.
...
# HB 2725 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2725, 2025 Regular Session (2025R1)
- **LC number:** 594
...
- **Full text below:** Enrolled version, 7806 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2725/Enrolled>.

## Summary

**Catchline:** Limits the kind of port districts that are required to be involved in strategic investment program agreements with respect to eligible projects that are located in the port district's territory.

**Relating to:** Relating to the inclusion of ports in strategic investment program agreements; and prescribing an effective date.

Digest: The Act would limit the kind of port district that must be a party to a contract in the strategic investment program. (Flesch Readability Score: 65.2). 
...
**RelatingToFull (verbatim upstream field):** Relating to the inclusion of ports in strategic investment program agreements; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 198.010, ORS 285C.050, ORS 285C.600, ORS 285C.606, ORS 285C.609, ORS 285C.623, ORS 307.123

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `c116b65c8ca2d82bbf2da72400d4452118972e3bc6ba1afc7f5683e36c328c58` (snapshot `_meta/snapshots/measure-2025r1-hb2725-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2725/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `df3a77c82efeb448ab0b59dff060341b382d3e215136c7f7c9cc306d5dc4116d` (snapshot `_meta/snapshots/measure-2025r1-hb2725-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2725/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2725` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb1137
title: 'SB 1137 (2025R1): Requires health benefit plans to cover autologous breast reconstruction procedures
  and related services with specific requirements related to out-of-pocket costs, cost-sharing, utilization
  review, reimbursement rates and network adequacy.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1137
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1137/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 61b2b85826944bc71b95d655512669b5233ad07a002db31a9f907cc11242b81c
snapshot_id: measure-2025r1-sb1137-enrolled
status: current
...
catch_line: Requires health benefit plans to cover autologous breast reconstruction procedures and related
  services with specific requirements related to out-of-pocket costs, cost-sharing, utilization review,
  reimbursement rates and network adequacy.
minority_catch_line: null
measure_summary: "\tDigest: This Act tells a health benefit plan to cover certain types of breast reconstruction\
  \ services with certain rules. (Flesch Readability Score: 61.6). \n\tRequires health benefit plans to\
  \ cover autologous breast reconstruction procedures and related services with specific requirements\
  \ related to out-of-pocket costs, cost-sharing, utilization review, reimbursement rates and network\
  \ adequacy."
relating_to: Relating to autologous breast reconstruction.
relating_to_full: Relating to autologous breast reconstruction.
at_the_request_of: null
lc_number: 4246
measure_created_date: '2025-02-25T13:28:54'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1137`.

# SB 1137 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1137, 2025 Regular Session (2025R1)
- **LC number:** 4246
- **Created:** 2025-02-25T13:28:54
- **Metadata last modified (upstream):** 2025-07-25T10:20:37
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 13732 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1137/Enrolled>.

## Summary

**Catchline:** Requires health benefit plans to cover autologous breast reconstruction procedures and related services with specific requirements related to out-of-pocket costs, cost-sharing, utilization review, reimbursement rates and network adequacy.
...
**RelatingToFull (verbatim upstream field):** Relating to autologous breast reconstruction.
...
- From bill text (Enrolled version): ORS 293.525, ORS 731.098, ORS 743.008, ORS 743.029, ORS 743.035, ORS 743A.001, ORS 743A.190, ORS 743B.001, ORS 743B.005, ORS 743B.195, ORS 743B.197, ORS 743B.200, ORS 743B.202, ORS 743B.204, ORS 743B.220, ORS 743B.225, ORS 743B.227, ORS 743B.250, ORS 743B.252, ORS 743B.253, ORS 743B.254, ORS 743B.255, ORS 743B.256, ORS 743B.257, ORS 743B.258, ORS 743B.280, ORS 743B.310, ORS 743B.400, ORS 743B.403, ORS 743B.405, ORS 743B.420, ORS 743B.422, ORS 743B.423, ORS 743B.424, ORS 743B.450, ORS 743B.451, ORS 743B.452, ORS 743B.453, ORS 743B.454, ORS 743B.505, ORS 743B.550, ORS 743B.555, ORS 743B.602, ORS 750.005

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `61b2b85826944bc71b95d655512669b5233ad07a002db31a9f907cc11242b81c` (snapshot `_meta/snapshots/measure-2025r1-sb1137-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1137/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `87a73b973e475b10bf3044c3538b68d8458d3802f1701b3094f49bb06994e4c0` (snapshot `_meta/snapshots/measure-2025r1-sb1137-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1137/Introduced>.

...
jurisdiction: oregon
id: measure-2025r1-hb3447
title: 'HB 3447 (2025R1): Requires a business that makes retail sales of certain nitrous oxide canisters
  to verify the recipient is at least 18 years of age.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3447
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3447/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 19bcd863e0bebd220a70700e70b7921cd232eaaf150548509c365f0dff15efd9
snapshot_id: measure-2025r1-hb3447-enrolled
status: current
...
catch_line: Requires a business that makes retail sales of certain nitrous oxide canisters to verify the
  recipient is at least 18 years of age.
minority_catch_line: null
measure_summary: "\tDigest: The Act says that a business has to make sure that a person is at least 18\
  \ years of age before they buy nitrous oxide. (Flesch Readability Score: 72.9). \n\tRequires a business\
  \ that makes retail sales of certain nitrous oxide canisters to verify the recipient is at least 18\
  \ years of age. Prohibits a business that makes retail sales of the nitrous oxide canisters through\
  \ an online ordering system from completing the delivery of a nitrous oxide canister unless the business\
  \ first verifies that the recipient is at least 18 years of age."
relating_to: Relating to nitrous oxide.
relating_to_full: Relating to nitrous oxide.
at_the_request_of: null
lc_number: 3731
measure_created_date: '2025-01-27T14:15:02'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3447`.

# HB 3447 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3447, 2025 Regular Session (2025R1)
- **LC number:** 3731
- **Created:** 2025-01-27T14:15:02
- **Metadata last modified (upstream):** 2025-06-06T14:14:58
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 5301 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3447/Enrolled>.

## Summary

**Catchline:** Requires a business that makes retail sales of certain nitrous oxide canisters to verify the recipient is at least 18 years of age.
...
**RelatingToFull (verbatim upstream field):** Relating to nitrous oxide.
...
a Class A violation.
Enrolled House Bill 3447 (HB 3447-INTRO) Page 1
(b) Violation of this  section is a Class C misdemeanor if at the time of sentencing the person
...
Enrolled House Bill 3447 (HB 3447-INTRO) Page 2
...
- From bill text (Enrolled version): ORS 475.390, ORS 807.400

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `19bcd863e0bebd220a70700e70b7921cd232eaaf150548509c365f0dff15efd9` (snapshot `_meta/snapshots/measure-2025r1-hb3447-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3447/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `4ed0fdf96e86d6cfe3694322ec91bf39495af0a6b349e8f2bd32d0f7cac6a574` (snapshot `_meta/snapshots/measure-2025r1-hb3447-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3447/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3447` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

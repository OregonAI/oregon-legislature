...
jurisdiction: oregon
id: measure-2025r1-hb2131
title: 'HB 2131 (2025R1): Requires a license to provide earned income access services in this state.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2131
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2131/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 118747e61c95acac1b016ca69d684651622be141e44f1c192d7cba938eecfffa
snapshot_id: measure-2025r1-hb2131-introduced
status: current
...
catch_line: Requires a license to provide earned income access services in this state.
minority_catch_line: null
measure_summary: "\tDigest: Says that a person must get a license to provide earned income access services\
  \ in this state. Says what the person must do to get the license and how a state agency can decide whether\
  \ to issue the license. Says what the person can and cannot do in providing the services. (Flesch Readability\
  \ Score: 73.4). \n\tRequires a license to provide earned income access services in this state. Specifies\
  \ procedures for applying for a license, the contents of an application and criteria under which the\
  \ Director of the Department of Consumer and Business Services may issue a license. Specifies requirements\
  \ that a licensee or service provider must meet and prohibitions on certain actions. Imposes a civil\
  \ penalty of not more than $2,500 for each violation of a provision of the Act. \n\tTakes effect on\
  \ the 91st day following adjournment sine die."
relating_to: Relating to earned income access services; prescribing an effective date.
relating_to_full: Relating to earned income access services; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2131>.

# HB 2131 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2131, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of House Interim Committee on Commerce and Consumer Protection for Daily Pay)
- **LC number:** 3215
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-22T16:14:31
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 43613 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2131/Introduced>.

## Summary

**Catchline:** Requires a license to provide earned income access services in this state.

**Relating to:** Relating to earned income access services; prescribing an effective date.

Digest: Says that a person must get a license to provide earned income access services in this state. Says what the person must do to get the license and how a state agency can decide whether to issue the license. Says what the person can and cannot do in providing the services. (Flesch Readability Score: 73.4). 
...
**RelatingToFull (verbatim upstream field):** Relating to earned income access services; and prescribing an effective date.
...
on Commerce and Consumer Protection for Daily Pay)
SUMMARY
...
SECTION 2.
(1) A person may not directly or  indirectly provide earned income access
...
SECTION 3.
(1)(a) A person that is subject  to the requirement to obtain a license under
...
SECTION 4.
(1) Except as provided  in subsection (2) of this section, a licensee shall des-
...
SECTION 5.
(1)(a) A licensee shall notify the  Director of the Department of Consumer
...
SECTION 6.
(1) The Director of the Department of Consumer and Business  Services has
...
2025 Act.
SECTION 7.
(1) A licensee or a service provider shall:
...
cess services.
SECTION 9.
(1) On or before February 15 of each year, or a date that the Director of the
...
SECTION 10.
(1) If, after  conducting an investigation, the Director of the Department
...
SECTION 11.
(1) Sections 1 to 10 of this 2025 Act become operative on January 1, 2026.
...
- From bill text (Introduced version): ORS 183.745, ORS 646.639, ORS 697.005, ORS 705.137, ORS 706.008, ORS 717.200, ORS 725.010

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `118747e61c95acac1b016ca69d684651622be141e44f1c192d7cba938eecfffa` (snapshot `_meta/snapshots/measure-2025r1-hb2131-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2131/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2131> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

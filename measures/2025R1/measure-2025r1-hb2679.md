...
jurisdiction: oregon
id: measure-2025r1-hb2679
title: 'HB 2679 (2025R1): Directs the State Department of Agriculture to classify certain pesticides containing
  neonicotinoids as restricted-use.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2679
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2679/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: dfeac5525e0af1cba218a276605e2c66c2c7ad134f89f2ea17bf82e76f7888c1
snapshot_id: measure-2025r1-hb2679-introduced
status: current
...
catch_line: Directs the State Department of Agriculture to classify certain pesticides containing neonicotinoids
  as restricted-use.
minority_catch_line: null
measure_summary: "\tDigest: This Act puts limits on the use of pesticides that have some neonicotinoids\
  \ in them. (Flesch Readability Score: 61.8). \n\tDirects the State Department of Agriculture to classify\
  \ certain pesticides containing neonicotinoids as restricted-use. Prohibits application of restricted-use\
  \ neonicotinoid pesticides on residential landscapes, subject to certain exceptions. Becomes operative\
  \ on January 1, 2027. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to neonicotinoid pesticides; prescribing an effective date.
relating_to_full: Relating to neonicotinoid pesticides; and prescribing an effective date.
at_the_request_of: null
lc_number: 676
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-04-02T11:08:28'
...
# HB 2679 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2679, 2025 Regular Session (2025R1)
- **LC number:** 676
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-04-02T11:08:28
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4518 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2679/Introduced>.

## Summary

**Catchline:** Directs the State Department of Agriculture to classify certain pesticides containing neonicotinoids as restricted-use.
...
**RelatingToFull (verbatim upstream field):** Relating to neonicotinoid pesticides; and prescribing an effective date.
...
LC 676
a restricted neonicotinoid pesticide by a licensed applicator:
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `dfeac5525e0af1cba218a276605e2c66c2c7ad134f89f2ea17bf82e76f7888c1` (snapshot `_meta/snapshots/measure-2025r1-hb2679-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2679/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2679` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

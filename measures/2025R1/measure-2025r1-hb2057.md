...
jurisdiction: oregon
id: measure-2025r1-hb2057
title: 'HB 2057 (2025R1): Prohibits insurers offering policies or certificates of health insurance and
  pharmacy benefit managers from requiring that a claim for reimbursement of a prescription drug include
  a modifier or other indicator that the drug is a 340B drug.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2057
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2057/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f2f3a1058425f5586e48d8e51fad63a3d390a8b9a26ff319152bc508ccff4508
snapshot_id: measure-2025r1-hb2057-introduced
status: current
...
catch_line: Prohibits insurers offering policies or certificates of health insurance and pharmacy benefit
  managers from requiring that a claim for reimbursement of a prescription drug include a modifier or
  other indicator that the drug is a 340B drug.
minority_catch_line: null
measure_summary: "\tDigest: Tells insurers and PBMs not to require that drugs be labeled as 340B drugs\
  \ in a claim for repayment. (Flesch Readability Score: 62.8). \n\tProhibits insurers offering policies\
  \ or certificates of health insurance and pharmacy benefit managers from requiring that a claim for\
  \ reimbursement of a prescription drug include a modifier or other indicator that the drug is a 340B\
  \ drug. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to prescription drugs; prescribing an effective date.
relating_to_full: Relating to prescription drugs; amending ORS 735.530, 735.534 and 743A.062; and prescribing
  an effective date.
at_the_request_of: null
lc_number: 1125
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-04-04T13:50:10'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 16414
...
# HB 2057 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2057, 2025 Regular Session (2025R1)
- **LC number:** 1125
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-04-04T13:50:10
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 16414 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2057/Introduced>.

## Summary

**Catchline:** Prohibits insurers offering policies or certificates of health insurance and pharmacy benefit managers from requiring that a claim for reimbursement of a prescription drug include a modifier or other indicator that the drug is a 340B drug.
...
**RelatingToFull (verbatim upstream field):** Relating to prescription drugs; amending ORS 735.530, 735.534 and 743A.062; and prescribing an effective date.
...
- From `RelatingToFull`: ORS 735.530, ORS 735.534, ORS 743A.062
- From bill text (Introduced version): ORS 414.025, ORS 414.312, ORS 414.353, ORS 414.688, ORS 442.015, ORS 443.400, ORS 443.705, ORS 689.005, ORS 689.515, ORS 731.106, ORS 735.530, ORS 735.532, ORS 735.534, ORS 735.540, ORS 743A.001, ORS 743A.062, ORS 743B.005, ORS 744.702, ORS 750.005, ORS 750.055

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `f2f3a1058425f5586e48d8e51fad63a3d390a8b9a26ff319152bc508ccff4508` (snapshot `_meta/snapshots/measure-2025r1-hb2057-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2057/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2057> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

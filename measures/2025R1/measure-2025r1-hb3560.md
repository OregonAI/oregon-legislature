...
jurisdiction: oregon
id: measure-2025r1-hb3560
title: 'HB 3560 (2025R1): Expands areas where a child care facility may be sited.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3560
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3560/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 609976410b0b848e339afd58fa8f02c3535bbfe19ae534c7fb5f769cc6c57ae8
snapshot_id: measure-2025r1-hb3560-enrolled
status: current
...
measure_summary: "\tDigest: This Act expands allowable sites for child care centers. (Flesch Readability\
  \ Score: 66.1). \n\tExpands areas where a child care facility may be sited. Requires local governments\
  \ to update their land use laws to comply within one year after the effective date of the Act."
relating_to: Relating to the siting of child care facilities.
relating_to_full: Relating to the siting of child care facilities.
at_the_request_of: null
lc_number: 845
measure_created_date: '2025-02-10T19:54:00'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3560`.

# HB 3560 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3560, 2025 Regular Session (2025R1)
- **LC number:** 845
- **Created:** 2025-02-10T19:54:00
- **Metadata last modified (upstream):** 2025-06-11T17:12:27
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 6675 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3560/Enrolled>.

## Summary

**Catchline:** Expands areas where a child care facility may be sited.
...
**RelatingToFull (verbatim upstream field):** Relating to the siting of child care facilities.
...
- From bill text (Enrolled version): ORS 197.015, ORS 197.646, ORS 243.550, ORS 243.560, ORS 329A.250, ORS 329A.255, ORS 329A.280, ORS 329A.330, ORS 329A.440

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `609976410b0b848e339afd58fa8f02c3535bbfe19ae534c7fb5f769cc6c57ae8` (snapshot `_meta/snapshots/measure-2025r1-hb3560-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3560/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `2de427c2238e8df0bcb1c19cb6b2e7e05b0fee65684309d8a71a1531d717d3f1` (snapshot `_meta/snapshots/measure-2025r1-hb3560-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3560/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3560` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

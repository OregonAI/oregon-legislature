...
jurisdiction: oregon
id: measure-2025r1-hb3458
title: 'HB 3458 (2025R1): Directs the Department of Education to develop model policies related to the
  use of student cellular telephones and other personal electronic devices.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3458
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3458/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f7dbd1c4901c05cf623954dd8b559dae2ab1f35de36b8b1c4301374807e8ec66
snapshot_id: measure-2025r1-hb3458-introduced
status: current
...
catch_line: Directs the Department of Education to develop model policies related to the use of student
  cellular telephones and other personal electronic devices.
minority_catch_line: null
measure_summary: "\tDigest: Directs each district school board to adopt a policy related to the use of\
  \ student cell phones. (Flesch Readability Score: 65.1). \n\tDirects the Department of Education to\
  \ develop model policies related to the use of student cellular telephones and other personal electronic\
  \ devices. \n\tRequires each district school board to adopt a policy that, at a minimum, complies with\
  \ the least restrictive model policy developed by the department. Provides that a school district may\
  \ be considered nonstandard for failure to comply with the requirements for the adoption of a policy."
relating_to: Relating to school policies regarding student use of personal electronic devices.
relating_to_full: Relating to school policies regarding student use of personal electronic devices; amending
  ORS 336.840.
at_the_request_of: null
lc_number: 1907
measure_created_date: '2025-01-28T14:56:39'
measure_modified_date: '2025-03-31T16:07:48'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3458`.

# HB 3458 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3458, 2025 Regular Session (2025R1)
- **LC number:** 1907
- **Created:** 2025-01-28T14:56:39
- **Metadata last modified (upstream):** 2025-03-31T16:07:48
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5441 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3458/Introduced>.

## Summary

**Catchline:** Directs the Department of Education to develop model policies related to the use of student cellular telephones and other personal electronic devices.

**Relating to:** Relating to school policies regarding student use of personal electronic devices.

Digest: Directs each district school board to adopt a policy related to the use of student cell phones. (Flesch Readability Score: 65.1). 
 ...
 Requires each district school board to adopt a policy that, at a minimum, complies with the least restrictive model policy developed by the department. Provides that a school district may be considered nonstandard for failure to comply with the requirements for the adoption of a policy.

**RelatingToFull (verbatim upstream field):** Relating to school policies regarding student use of personal electronic devices; amending ORS 336.840.
...
LC 1907
their own personal electronic devices for the curriculum.
...
- From bill text (Introduced version): ORS 327.103, ORS 336.840

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `f7dbd1c4901c05cf623954dd8b559dae2ab1f35de36b8b1c4301374807e8ec66` (snapshot `_meta/snapshots/measure-2025r1-hb3458-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3458/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3458` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb551
title: 'SB 551 (2025R1): Prohibits restaurants and retailers from providing single-use checkout bags to
  consumers.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 551
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB551/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 61762a2e4986a80ac9ddef9f1d816fd8f843ae3d3f9e78bd511d0c3f2cdd4ee3
snapshot_id: measure-2025r1-sb551-enrolled
status: current
...
catch_line: Prohibits restaurants and retailers from providing single-use checkout bags to consumers.
minority_catch_line: null
measure_summary: "\t<b>Digest: This Act changes restrictions on checkout bags. (Flesch Readability Score:\
  \ 66.7).</b> \n\t[<i>Digest: This Act changes restrictions on checkout bags and restricts some plastic\
  \ products. (Flesch Readability Score: 60.7).</i>] \n\tProhibits restaurants and retailers from providing\
  \ single-use checkout bags to consumers. \n\t[<i>Prohibits food and beverage providers and convenience\
  \ stores from providing single-use plastic utensils or single-use plastic condiment packaging to consumers\
  \ unless requested.</i>] \n\t[<i>Prohibits lodging establishments from providing small plastic personal\
  \ health or beauty product containers unless requested.</i>]."
relating_to: Relating to plastic waste.
relating_to_full: Relating to plastic waste.
...
# SB 551 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 551, 2025 Regular Session (2025R1)
- **LC number:** 799
...
- **Full text below:** Enrolled version, 7619 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB551/Enrolled>.

## Summary

**Catchline:** Prohibits restaurants and retailers from providing single-use checkout bags to consumers.
...
**RelatingToFull (verbatim upstream field):** Relating to plastic waste.
...
(b) Recycled paper checkout bags[, reusable fabric checkout bags or reusable plastic checkout
...
- From bill text (Enrolled version): ORS 174.116, ORS 413.500, ORS 459.993, ORS 459A.755, ORS 459A.757, ORS 459A.759

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `61762a2e4986a80ac9ddef9f1d816fd8f843ae3d3f9e78bd511d0c3f2cdd4ee3` (snapshot `_meta/snapshots/measure-2025r1-sb551-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB551/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `fcb9088e00e8fe5f133b461cbd5ea697a14db4e1691f2af6a251295dea8b76bb` (snapshot `_meta/snapshots/measure-2025r1-sb551-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB551/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 551` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

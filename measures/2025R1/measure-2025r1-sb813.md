...
jurisdiction: oregon
id: measure-2025r1-sb813
title: 'SB 813 (2025R1): Adds employees of the Oregon Youth Authority or a county juvenile department
  to the list of people who are authorized to petition the circuit court for an order compelling a third
  party to complete a test for communicable diseases under certain circumstances.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 813
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB813/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: deb6e4279cddf2a11017d8477d8bc26e068fa852f47a8c46906a8c678a994cfa
snapshot_id: measure-2025r1-sb813-enrolled
status: current
...
catch_line: Adds employees of the Oregon Youth Authority or a county juvenile department to the list of
  people who are authorized to petition the circuit court for an order compelling a third party to complete
  a test for communicable diseases under certain circumstances.
minority_catch_line: null
measure_summary: "\tDigest: The Act adds some government employees to the list of people who can ask a\
  \ court to make a person get tested for some diseases. (Flesch Readability Score: 66.4). \n\tAdds employees\
  \ of the Oregon Youth Authority or a county juvenile department to the list of people who are authorized\
  \ to petition the circuit court for an order compelling a third party to complete a test for communicable\
  \ diseases under certain circumstances."
relating_to: Relating to exposure to bodily fluids.
relating_to_full: Relating to exposure to bodily fluids.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 813`.

# SB 813 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 813, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 7250 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB813/Enrolled>.

## Summary

**Catchline:** Adds employees of the Oregon Youth Authority or a county juvenile department to the list of people who are authorized to petition the circuit court for an order compelling a third party to complete a test for communicable diseases under certain circumstances.

**Relating to:** Relating to exposure to bodily fluids.

Digest: The Act adds some government employees to the list of people who can ask a court to make a person get tested for some diseases. (Flesch Readability Score: 66.4). 
...
**RelatingToFull (verbatim upstream field):** Relating to exposure to bodily fluids.
...
- From bill text (Enrolled version): ORS 181A.355, ORS 192.311, ORS 414.805, ORS 431A.005, ORS 431A.570, ORS 433.060, ORS 682.025

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `deb6e4279cddf2a11017d8477d8bc26e068fa852f47a8c46906a8c678a994cfa` (snapshot `_meta/snapshots/measure-2025r1-sb813-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB813/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `99446b3108958d303f509e877d822cd36d938035b7d48dd0b79be5d40b6c7606` (snapshot `_meta/snapshots/measure-2025r1-sb813-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB813/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 813` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

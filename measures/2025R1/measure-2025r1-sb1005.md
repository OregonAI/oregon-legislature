...
jurisdiction: oregon
id: measure-2025r1-sb1005
title: 'SB 1005 (2025R1): Provides that when offering a service with age restrictions, a private entity
  is allowed to swipe a driver license or identification card to verify a person''s age, regardless of
  how old the person looks.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1005
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1005/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b4af10e8d70832a88410ed5b788e428bf50ef3394bf044f732b8f95f31924a4e
snapshot_id: measure-2025r1-sb1005-enrolled
status: current
...
catch_line: Provides that when offering a service with age restrictions, a private entity is allowed to
  swipe a driver license or identification card to verify a person's age, regardless of how old the person
  looks.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act says that a private entity may swipe a driver license to confirm\
  \ a person's age, regardless of how old the person looks. Increases the amount a person can get from\
  \ an entity that swipes a license against the law. (Flesch Readability Score: 64.2).</b> \n\t[<i>Digest:\
  \ The Act says that a private entity may swipe a driver's license to confirm a person's age, regardless\
  \ of how old the person looks. (Flesch Readability Score: 62.6).</i>] \n\tProvides that when offering\
  \ a service with age restrictions, a private entity is allowed to swipe a driver license<b> or identification\
  \ card</b> to verify a person's age, regardless of how old the person looks. \n\t<b>Increases the amount\
  \ a person may recover against an entity that swipes a driver license or identification card in violation\
  \ of the law.</b>"
relating_to: Relating to swiping driver licenses.
relating_to_full: Relating to swiping driver licenses.
at_the_request_of: null
lc_number: 4602
measure_created_date: '2025-02-06T09:35:28'
...
# SB 1005 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1005, 2025 Regular Session (2025R1)
- **LC number:** 4602
- **Created:** 2025-02-06T09:35:28
- **Metadata last modified (upstream):** 2025-08-08T08:11:04
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 8650 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1005/Enrolled>.

## Summary

**Catchline:** Provides that when offering a service with age restrictions, a private entity is allowed to swipe a driver license or identification card to verify a person's age, regardless of how old the person looks.
...
**RelatingToFull (verbatim upstream field):** Relating to swiping driver licenses.
...
- From bill text (Enrolled version): ORS 475.230, ORS 689.005, ORS 706.008, ORS 807.400, ORS 807.750

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `b4af10e8d70832a88410ed5b788e428bf50ef3394bf044f732b8f95f31924a4e` (snapshot `_meta/snapshots/measure-2025r1-sb1005-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1005/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `77763ee313615847a204021c3143ca87b1f646367192f16580d42c2bbe9c97a8` (snapshot `_meta/snapshots/measure-2025r1-sb1005-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1005/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1005` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3195
title: 'HB 3195 (2025R1): Modifies eligibility requirements for distributions from the Children''s Advocacy
  Center One-Time Grant Fund.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3195
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3195/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4d325e07797b9a725ffd34958ce5648aaf37bc6c8c1fd2a9593ec7a0dd0f32df
snapshot_id: measure-2025r1-hb3195-enrolled
status: current
...
catch_line: Modifies eligibility requirements for distributions from the Children's Advocacy Center One-Time
  Grant Fund.
minority_catch_line: null
measure_summary: "\tDigest: The Act removes the limit on the maximum amount that a CAC can receive from\
  \ the CAC One-Time Grant Fund. (Flesch Readability Score: 67.2). \n\tModifies eligibility requirements\
  \ for distributions from the Children's Advocacy Center One-Time Grant Fund. \n\tDeclares an emergency,\
  \ effective on passage."
relating_to: Relating to children's advocacy centers; and declaring an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3195`.

# HB 3195 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3195, 2025 Regular Session (2025R1)
- **LC number:** 2411
...
- **Full text below:** Enrolled version, 7415 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3195/Enrolled>.

## Summary

**Catchline:** Modifies eligibility requirements for distributions from the Children's Advocacy Center One-Time Grant Fund.
...
- From bill text (Enrolled version): ORS 418.746, ORS 418.747, ORS 418.782, ORS 418.788, ORS 419B.023

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `4d325e07797b9a725ffd34958ce5648aaf37bc6c8c1fd2a9593ec7a0dd0f32df` (snapshot `_meta/snapshots/measure-2025r1-hb3195-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3195/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `73e831c9d8da3c22e3ebfdc319d26428b342b32359fa9d6c28e9af8c06b13c36` (snapshot `_meta/snapshots/measure-2025r1-hb3195-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3195/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3195` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

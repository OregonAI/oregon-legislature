...
jurisdiction: oregon
id: measure-2025r1-hb3939
title: 'HB 3939 (2025R1): Extends the temporary Oregon Business Development Department residential infrastructure
  grant program by two years.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3939
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3939/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: dad51eab7d374fa4004de900c978870dd80e756cb88d27604c0fd2a379f4e589
snapshot_id: measure-2025r1-hb3939-introduced
status: current
...
catch_line: Extends the temporary Oregon Business Development Department residential infrastructure grant
  program by two years.
minority_catch_line: null
measure_summary: "\tDigest: This Act gives OBDD moneys to grant to cities for housing infrastructure.\
  \ (Flesch Readability Score: 67.7). \n\tExtends the temporary Oregon Business Development Department\
  \ residential infrastructure grant program by two years. Appropriates moneys for specified cities and\
  \ projects. \n\tDeclares an emergency, effective July 1, 2025."
relating_to: Relating to infrastructure projects; declaring an emergency.
relating_to_full: Relating to infrastructure projects; creating new provisions; amending sections 1, 3
  and 4, chapter 103, Oregon Laws 2024; and declaring an emergency.
at_the_request_of: null
lc_number: 4690
measure_created_date: '2025-03-17T13:19:39'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3939>.

# HB 3939 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3939, 2025 Regular Session (2025R1)
- **LC number:** 4690
- **Created:** 2025-03-17T13:19:39
- **Metadata last modified (upstream):** 2025-04-15T23:01:32
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6822 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3939/Introduced>.

## Summary

**Catchline:** Extends the temporary Oregon Business Development Department residential infrastructure grant program by two years.

**Relating to:** Relating to infrastructure projects; declaring an emergency.
...
**RelatingToFull (verbatim upstream field):** Relating to infrastructure projects; creating new provisions; amending sections 1, 3 and 4, chapter 103, Oregon Laws 2024; and declaring an emergency.

## Full text

83rd OREGON LEGISLATIVE ASSEMBLY--2025 Regular Session
House Bill 3939
Sponsored by Representatives ELMER, OWENS, WRIGHT; Representative SCHARF, Senators MCLANE, STARR
SUMMARY
...
(8) The City of Carlton for a two-part water loop system.
SECTION 3.
...
2, [2030] 2032.
SECTION 6. In addition to and not in lieu of any other appropriation, there  are appro-
priated to the Oregon Business Development Department,  for the biennium beginning July
1, 2025, out of the General Fund, $15,850,000 to provide the following grants:
...
- From bill text (Introduced version): ORS 227.175, ORS 456.270, ORS 94.504

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `dad51eab7d374fa4004de900c978870dd80e756cb88d27604c0fd2a379f4e589` (snapshot `_meta/snapshots/measure-2025r1-hb3939-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3939/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3939> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

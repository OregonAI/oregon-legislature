...
jurisdiction: oregon
id: measure-2025r1-sb1085
title: 'SB 1085 (2025R1): Quarters the minimum acreage for farm, forest and rangeland lots or parcels.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1085
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1085/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 57e4e3c4f00d0308f6665013bae4cb0cf7b2a7a06842d00e36ce1de01c0861c1
snapshot_id: measure-2025r1-sb1085-introduced
status: current
...
measure_summary: "\tDigest: This Act reduces minimum lot sizes for farm and forest lands. (Flesch Readability\
  \ Score: 72.6). \n\tQuarters the minimum acreage for farm, forest and rangeland lots or parcels. Allows\
  \ farm, forest or rangeland lots to be created from land without water rights if the land is subdivided\
  \ to establish at least four dwellings that will share infrastructure and amenities. \n\tDeclares an\
  \ emergency, effective on passage."
relating_to: Relating to minimum lot sizes for resource lands; declaring an emergency.
relating_to_full: Relating to minimum lot sizes for resource lands; amending ORS 215.263, 215.304 and
  215.780; and declaring an emergency.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1085>.

# SB 1085 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1085, 2025 Regular Session (2025R1)
- **LC number:** 4325
- **Created:** 2025-02-21T14:37:23
- **Metadata last modified (upstream):** 2025-02-26T10:33:29
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 24411 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1085/Introduced>.

## Summary

**Catchline:** Quarters the minimum acreage for farm, forest and rangeland lots or parcels.

**Relating to:** Relating to minimum lot sizes for resource lands; declaring an emergency.
...
**RelatingToFull (verbatim upstream field):** Relating to minimum lot sizes for resource lands; amending ORS 215.263, 215.304 and 215.780; and declaring an emergency.
...
(D) On each resulting  lot will be developed a dwelling unit which shall share
...
identifying units of land that  are not capable of producing adequate herbaceous forage for grazing
...
- From `RelatingToFull`: ORS 215.263, ORS 215.304, ORS 215.780
- From bill text (Introduced version): ORS 195.120, ORS 197.015, ORS 197.230, ORS 197.247, ORS 197.251, ORS 197.628, ORS 197.660, ORS 197.732, ORS 215.010, ORS 215.203, ORS 215.213, ORS 215.243, ORS 215.255, ORS 215.263, ORS 215.283, ORS 215.284, ORS 215.291, ORS 215.304, ORS 215.700, ORS 215.780, ORS 215.783, ORS 321.257, ORS 321.805, ORS 527.620, ORS 527.630

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `57e4e3c4f00d0308f6665013bae4cb0cf7b2a7a06842d00e36ce1de01c0861c1` (snapshot `_meta/snapshots/measure-2025r1-sb1085-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1085/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1085> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

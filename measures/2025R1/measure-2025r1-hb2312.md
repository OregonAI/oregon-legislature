...
jurisdiction: oregon
id: measure-2025r1-hb2312
title: 'HB 2312 (2025R1): Establishes the Task Force on Staffing at Correctional Facilities.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2312
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2312/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 43c9f4599aac185ba77f8bb456eee264ad0b900e644906251719fc2f9747993e
snapshot_id: measure-2025r1-hb2312-introduced
status: current
...
catch_line: Establishes the Task Force on Staffing at Correctional Facilities.
minority_catch_line: null
measure_summary: "\tDigest: The Act would create a task force to look into staffing at corrections facilities.\
  \ (Flesch Readability Score: 65.7). \n\tEstablishes the Task Force on Staffing at Correctional Facilities.\
  \ Requires the task force to submit a report to an interim committee of the Legislative Assembly related\
  \ to the judiciary no later than December 15, 2026. \n\tSunsets on January 2, 2027. \n\tTakes effect\
  \ on the 91st day following adjournment sine die."
relating_to: Relating to staffing correctional facilities; prescribing an effective date.
relating_to_full: Relating to staffing correctional facilities; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2312>.

# HB 2312 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2312, 2025 Regular Session (2025R1)
- **LC number:** 1743
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-23T10:50:17
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5038 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2312/Introduced>.

## Summary

**Catchline:** Establishes the Task Force on Staffing at Correctional Facilities.
...
**RelatingToFull (verbatim upstream field):** Relating to staffing correctional facilities; and prescribing an effective date.
...
- From bill text (Introduced version): ORS 174.111, ORS 181A.355, ORS 192.245, ORS 420.905

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `43c9f4599aac185ba77f8bb456eee264ad0b900e644906251719fc2f9747993e` (snapshot `_meta/snapshots/measure-2025r1-hb2312-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2312/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2312> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

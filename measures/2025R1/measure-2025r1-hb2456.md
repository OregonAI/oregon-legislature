...
jurisdiction: oregon
id: measure-2025r1-hb2456
title: 'HB 2456 (2025R1): Modifies provisions relating to the Sexual Assault Victims'' Emergency Medical
  Response Fund.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2456
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2456/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5330d2b1ebb0ee50ac166b7286eb47e02ce1d741d9d69223a71eeaf7d25f084f
snapshot_id: measure-2025r1-hb2456-enrolled
status: current
...
catch_line: Modifies provisions relating to the Sexual Assault Victims' Emergency Medical Response Fund.
minority_catch_line: null
measure_summary: "\tDigest: The Act changes laws about the SAVE Fund. (Flesch Readability Score: 92.9).\
  \ \n\tModifies provisions relating to the Sexual Assault Victims' Emergency Medical Response Fund."
relating_to: Relating to the Sexual Assault Victims' Emergency Medical Response Fund.
relating_to_full: Relating to the Sexual Assault Victims' Emergency Medical Response Fund.
at_the_request_of: (at the request of Attorney General Dan Rayfield)
lc_number: 491
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2026-04-14T12:38:59'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2456`.

# HB 2456 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2456, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Attorney General Dan Rayfield)
- **LC number:** 491
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-04-14T12:38:59
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 11039 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2456/Enrolled>.

## Summary

**Catchline:** Modifies provisions relating to the Sexual Assault Victims' Emergency Medical Response Fund.
...
**RelatingToFull (verbatim upstream field):** Relating to the Sexual Assault Victims' Emergency Medical Response Fund.
...
- From bill text (Enrolled version): ORS 147.035, ORS 147.395, ORS 147.397, ORS 181A.323, ORS 435.254, ORS 435.256, ORS 441.025, ORS 441.044

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `5330d2b1ebb0ee50ac166b7286eb47e02ce1d741d9d69223a71eeaf7d25f084f` (snapshot `_meta/snapshots/measure-2025r1-hb2456-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2456/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `5cdb7f984d9e090985039c7d1ae67654b289101d1e05d75de3e3df435a1746db` (snapshot `_meta/snapshots/measure-2025r1-hb2456-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2456/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2456` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

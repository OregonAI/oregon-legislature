...
jurisdiction: oregon
id: measure-2025r1-hb2135
title: 'HB 2135 (2025R1): Allows battery-charged fences on properties not used as residences.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2135
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2135/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: abc829a491b114ff20d26afdabe9b8b93ab47c15953cd23f7b6c0b1b46a2ad29
snapshot_id: measure-2025r1-hb2135-introduced
status: current
...
catch_line: Allows battery-charged fences on properties not used as residences.
minority_catch_line: null
measure_summary: "\tDigest: This Act amends where battery-charged fences are allowed. (Flesch Readability\
  \ Score: 61.2). \n\tAllows battery-charged fences on properties not used as residences."
relating_to: Relating to battery-charged fences.
relating_to_full: Relating to battery-charged fences; amending ORS 195.870.
at_the_request_of: null
lc_number: 721
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-02-06T14:36:33'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 3139
...
# HB 2135 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2135, 2025 Regular Session (2025R1)
- **LC number:** 721
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-02-06T14:36:33
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 3139 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2135/Introduced>.

## Summary

**Catchline:** Allows battery-charged fences on properties not used as residences.

**Relating to:** Relating to battery-charged fences.

Digest: This Act amends where battery-charged fences are allowed. (Flesch Readability Score: 61.2). 
 Allows battery-charged fences on properties not used as residences.

**RelatingToFull (verbatim upstream field):** Relating to battery-charged fences; amending ORS 195.870.

## Full text

83rd OREGON LEGISLATIVE ASSEMBLY--2025 Regular Session
House Bill 2135
Sponsored by Representative WALLAN; Representatives HELM, OWENS (Presession filed.)
SUMMARY
...
Allows battery-charged fences on properties not used as residences.
A BILL FOR AN ACT
Relating to battery-charged fences; amending ORS 195.870.
...
or used ] zoned to allow for commercial or industrial use and not used  for residential use that:
...
- From `RelatingToFull`: ORS 195.870
- From bill text (Introduced version): ORS 195.870, ORS 197.015

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `abc829a491b114ff20d26afdabe9b8b93ab47c15953cd23f7b6c0b1b46a2ad29` (snapshot `_meta/snapshots/measure-2025r1-hb2135-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2135/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2135` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hcr36
title: 'HCR 36 (2025R1): In memoriam: Christine Chin Ryan.'
doc_type: dataset_doc
citation: 2025 Regular Session House Concurrent Resolution 36
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR36/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 9973dd9180036fd39f3ad64070c338ec30d7c3646e9dc056e014bafcc106415a
snapshot_id: measure-2025r1-hcr36-enrolled
status: current
...
catch_line: 'In memoriam: Christine Chin Ryan.'
minority_catch_line: null
measure_summary: "\tDigest: Honors the life and memory of Christine Chin Ryan. (Flesch Readability Score:\
  \ 75.5). \n\tIn memoriam: Christine Chin Ryan."
relating_to: 'In memoriam: Christine Chin Ryan.'
relating_to_full: null
at_the_request_of: null
lc_number: 4849
measure_created_date: '2025-04-15T10:39:09'
measure_modified_date: '2025-06-17T12:58:14'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 36`.

# HCR 36 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Concurrent Resolution 36, 2025 Regular Session (2025R1)
- **LC number:** 4849
- **Created:** 2025-04-15T10:39:09
- **Metadata last modified (upstream):** 2025-06-17T12:58:14
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 4383 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR36/Enrolled>.

## Summary

**Catchline:** In memoriam: Christine Chin Ryan.

**Relating to:** In memoriam: Christine Chin Ryan.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `9973dd9180036fd39f3ad64070c338ec30d7c3646e9dc056e014bafcc106415a` (snapshot `_meta/snapshots/measure-2025r1-hcr36-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR36/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `aad3a79b246c77ab06235d1429fba25c808ca3f2fd1908d9782faf9dee84ad02` (snapshot `_meta/snapshots/measure-2025r1-hcr36-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR36/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 36` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2021
title: 'HB 2021 (2025R1): Modifies the certificate of need process to allow only applicants to challenge
  proposed decisions of the Oregon Health Authority.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2021
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2021/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 90922552e9db621c42033869f733be66a67f5221d7ec24d6031d7000a4488ec1
snapshot_id: measure-2025r1-hb2021-introduced
status: current
...
catch_line: Modifies the certificate of need process to allow only applicants to challenge proposed decisions
  of the Oregon Health Authority.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes changes to the certificate of need process. (Flesch Readability\
  \ Score: 69.7). \n\tModifies the certificate of need process to allow only applicants to challenge proposed\
  \ decisions of the Oregon Health Authority."
relating_to: Relating to certificates of need.
relating_to_full: Relating to certificates of need; amending ORS 442.015 and 442.315.
...
# HB 2021 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2021, 2025 Regular Session (2025R1)
- **LC number:** 698
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2026-05-29T10:25:20
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 16324 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2021/Introduced>.

## Summary

**Catchline:** Modifies the certificate of need process to allow only applicants to challenge proposed decisions of the Oregon Health Authority.
...
**RelatingToFull (verbatim upstream field):** Relating to certificates of need; amending ORS 442.015 and 442.315.
...
LC 698
a final order granting, with or without limitations, or denying the certificate of need.
...
- From `RelatingToFull`: ORS 442.015, ORS 442.315
- From bill text (Introduced version): ORS 183.310, ORS 430.335, ORS 430.620, ORS 441.026, ORS 441.065, ORS 442.015, ORS 442.315, ORS 442.470, ORS 443.205, ORS 443.400, ORS 443.415

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `90922552e9db621c42033869f733be66a67f5221d7ec24d6031d7000a4488ec1` (snapshot `_meta/snapshots/measure-2025r1-hb2021-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2021/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2021` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3078
title: 'HB 3078 (2025R1): Directs the Oregon Drinking Water Services of the Oregon Health Authority to
  establish a pilot program for training drinking water system operators.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3078
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3078/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b960f8ffdfb755a37c5538da95c4fafc5cd295d72b092b8bebec5a15359474e5
snapshot_id: measure-2025r1-hb3078-introduced
status: current
...
catch_line: Directs the Oregon Drinking Water Services of the Oregon Health Authority to establish a pilot
  program for training drinking water system operators.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells an agency to create a pilot program for training certain water\
  \ system operators. The Act tells an agency to create a program for giving grants to certain water providers.\
  ...
  \ the Oregon Drinking Water Services of the Oregon Health Authority to establish a pilot program for\
  \ training drinking water system operators. Sunsets the program on January 2, 2028. \n\tDirects the\
  \ Water Resources Department to establish a matching funds grant program that awards grants to certain\
  \ municipal water providers. \n\tExtends the sunset on rules for the Deschutes Basin ground water study\
  \ area to January 2, 2039. \n\tAppropriates moneys to the Oregon Health Authority out of the General\
  \ Fund for distribution to the Oregon Drinking Water Services for the pilot program. \n\tAppropriates\
  \ moneys from the General Fund to the department for the matching funds grant program. \n\tAppropriates\
  \ moneys from the General Fund to state agencies for purposes related to the treatment of western juniper.\
  \ \n\tDeclares an emergency, effective on passage."
relating_to: Relating to water; declaring an emergency.
relating_to_full: Relating to water; creating new provisions; amending section 5, chapter 669, Oregon
  Laws 2005; and declaring an emergency.
at_the_request_of: null
lc_number: 3511
measure_created_date: '2024-12-31T13:18:07'
measure_modified_date: '2025-01-17T13:20:43'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 6656
...
# HB 3078 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3078, 2025 Regular Session (2025R1)
- **LC number:** 3511
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T13:20:43
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6656 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3078/Introduced>.

## Summary

**Catchline:** Directs the Oregon Drinking Water Services of the Oregon Health Authority to establish a pilot program for training drinking water system operators.
...
**RelatingToFull (verbatim upstream field):** Relating to water; creating new provisions; amending section 5, chapter 669, Oregon Laws 2005; and declaring an emergency.
...
LC 3511
chapter 669, Oregon Laws 2005, on January 2, [ 2029] 2039.
...
- From bill text (Introduced version): ORS 192.245, ORS 568.970

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `b960f8ffdfb755a37c5538da95c4fafc5cd295d72b092b8bebec5a15359474e5` (snapshot `_meta/snapshots/measure-2025r1-hb3078-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3078/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3078> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb1023
title: 'SB 1023 (2025R1): Requires the Attorney General to adopt and maintain a list of foreign adversaries
  who are ineligible to receive conveyances of certain land, mineral or water interests.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1023
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1023/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f433f294b85b551e2666ba6d45fb3345bf23444e5291f6bc364d0e6f42ffa270
snapshot_id: measure-2025r1-sb1023-introduced
status: current
...
catch_line: Requires the Attorney General to adopt and maintain a list of foreign adversaries who are
  ineligible to receive conveyances of certain land, mineral or water interests.
minority_catch_line: null
measure_summary: "\tDigest: This Act blocks US adversaries from getting land, water or mineral rights.\
  \ (Flesch Readability Score: 60.7). \n\tRequires the Attorney General to adopt and maintain a list of\
  \ foreign adversaries who are ineligible to receive conveyances of certain land, mineral or water interests.\
  \ Makes unauthorized conveyances void."
relating_to: Relating to conveyances to foreign adversaries.
relating_to_full: Relating to conveyances to foreign adversaries.
...
# SB 1023 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1023, 2025 Regular Session (2025R1)
- **LC number:** 4496
- **Created:** 2025-02-11T10:50:51
- **Metadata last modified (upstream):** 2025-02-18T13:29:58
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 3816 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1023/Introduced>.

## Summary

**Catchline:** Requires the Attorney General to adopt and maintain a list of foreign adversaries who are ineligible to receive conveyances of certain land, mineral or water interests.
...
**RelatingToFull (verbatim upstream field):** Relating to conveyances to foreign adversaries.
...
LC 4496
(2) Involves the transfer of a mining claim, mineral rights or a water right.
SECTION 5.
...
- From bill text (Introduced version): ORS 183.400, ORS 540.010, ORS 540.020, ORS 540.023, ORS 540.505

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `f433f294b85b551e2666ba6d45fb3345bf23444e5291f6bc364d0e6f42ffa270` (snapshot `_meta/snapshots/measure-2025r1-sb1023-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1023/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1023` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

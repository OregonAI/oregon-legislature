...
jurisdiction: oregon
id: measure-2025r1-sb451
title: 'SB 451 (2025R1): Prohibits cost-sharing on certain health insurance coverage of cervical cancer
  screenings and follow-up examinations.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 451
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB451/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 02f01b43e9728ee2257d530d5fac7ba6568307a4b6deff225ee218de3211c6cc
snapshot_id: measure-2025r1-sb451-introduced
status: current
...
catch_line: Prohibits cost-sharing on certain health insurance coverage of cervical cancer screenings
  and follow-up examinations.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act tells health insurance to pay for some cancer screenings and exams.\
  \ (Flesch Readability Score: 76.5).</b> \n\t[<i>Digest: The Act tells health insurance to pay for some\
  \ cancer exams. (Flesch Readability Score: 80.3).</i>] \n\tProhibits cost-sharing on certain health\
  \ insurance coverage of cervical cancer <b>screenings and follow-up</b> examinations."
relating_to: Relating to health care.
relating_to_full: Relating to health care; creating new provisions; and amending ORS 743B.005.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 451`.

# SB 451 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 451, 2025 Regular Session (2025R1)
- **LC number:** 115
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-04-01T13:56:13
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 14035 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB451/Introduced>.

## Summary

**Catchline:** Prohibits cost-sharing on certain health insurance coverage of cervical cancer screenings and follow-up examinations.

**Relating to:** Relating to health care.

<b>Digest: The Act tells health insurance to pay for some cancer screenings and exams. (Flesch Readability Score: 76.5).</b> 
 [<i>Digest: The Act tells health insurance to pay for some cancer exams. (Flesch Readability Score: 80.3).</i>] 
 Prohibits cost-sharing on certain health insurance coverage of cervical cancer <b>screenings and follow-up</b> examinations.

**RelatingToFull (verbatim upstream field):** Relating to health care; creating new provisions; and amending ORS 743B.005.

## Full text

83rd OREGON LEGISLATIVE ASSEMBLY--2025 Regular Session
Senate Bill 451
Sponsored by Senator  PATTERSON, Representative NOSSE; Senator REYNOLDS, Representatives GRAYBER,
PHAM H (Presession filed.)
SUMMARY
The following summary  is not prepared by the sponsors of the measure and is not a part of the body thereof subject
to consideration by the Legislative Assembly. It is an editor’s brief statement of the essential features  of the
measure as introduced. The statement includes a measure digest written in compliance with applicable readability
standards.
Digest: The Act tells health insurance  to pay for some cancer exams. (Flesch Readability Score:
80.3).
...
(a)(A) “Cervical  cancer examination” means a screening test as recommended by the
United States Preventive Services Task Force, for the purpose  of detecting the presence of
cervical cancer or precancerous lesions.
(B) “Cervical cancer examination” does not include services that occur primarily for  the
treatment of diagnosed cervical cancer.
(b) “Follow-up examination” means additional cervical  cancer examinations used to
evaluate an abnormality seen or suspected by  a screening test or other means of examina-
tion.
(c) “Screening test” means health  care services or products provided to an individual
without apparent symptoms of an  illness, injury or disease for the purpose of identifying or
...
this state that reimburses the cost of cervical cancer examinations  may not impose deduct-
ibles, coinsurance, copayments or other out-of-pocket costs on the coverage of medically
necessary:
(a) Cervical cancer examinations; and
(b) Follow-up examinations  used to evaluate an abnormality seen or suspected from a
cervical cancer  examination regardless of whether different samples from the prior exam-
ination are used or the examination is performed on a different date than the  prior exam-
ination. Follow-up examinations  include human papillomavirus examinations with typing,
cytology, dual stain or colposcopy with biopsy.
SECTION 3.
...
by rule.
SECTION 4.
Section 2 of this 2025 Act applies to policies or certificates of insurance is-
sued, renewed or extended on or after the effective date of this 2025 Act.
...
- From bill text (Introduced version): ORS 732.548, ORS 741.300, ORS 742.065, ORS 743.004, ORS 743.007, ORS 743.022, ORS 743.416, ORS 743.417, ORS 743.535, ORS 743A.101, ORS 743B.003, ORS 743B.005, ORS 743B.010, ORS 743B.012, ORS 750.005, ORS 750.301, ORS 750.303

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `02f01b43e9728ee2257d530d5fac7ba6568307a4b6deff225ee218de3211c6cc` (snapshot `_meta/snapshots/measure-2025r1-sb451-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB451/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 451` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb3715
title: 'HB 3715 (2025R1): Defines "dangerous to self or others" for the purpose of taking a person with
  mental illness into custody.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3715
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3715/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 28bf0d0126fcf0a34071ca5e658050c19937ee312670f34d94862d6568d94735
snapshot_id: measure-2025r1-hb3715-introduced
status: current
...
measure_summary: "\tDigest: The Act makes changes to some laws regarding persons with mental illness.\
  \ (Flesch Readability Score: 67.7). \n\tDefines \"dangerous to self or others\" for the purpose of taking\
  \ a person with mental illness into custody. Describes evidence that the court must consider in civil\
  \ commitment proceedings. \n\tDirects the Oregon State Hospital to ensure a minimum bed capacity for\
  \ individuals who have been civilly committed. \n\tDirects the Oregon Department of Administrative Services\
  \ to contract with a qualified community mental health provider to provide certain services in eastern\
  ...
  \ to health care no later than September 15 of each even-numbered year. \n\tModifies a declaration for\
  \ mental health treatment to allow the principal to authorize inpatient treatment for up to 180 days.\
  \ \n\tProhibits a criminal court from committing certain defendants who lack fitness to proceed. \n\t\
  Declares an emergency, effective on passage."
relating_to: Relating to persons with mental illness; declaring an emergency.
relating_to_full: Relating to persons with mental illness; creating new provisions; amending ORS 127.700,
  127.736, 161.370, 161.371, 163.738, 426.005, 426.070, 426.074, 426.130, 426.133, 426.160, 426.180, 426.225,
  426.228, 426.231, 426.232, 426.233, 426.234 and 430.399; and declaring an emergency.
at_the_request_of: null
lc_number: 3277
measure_created_date: '2025-02-23T20:32:23'
measure_modified_date: '2025-05-01T20:26:09'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 102686
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3715`.

# HB 3715 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3715, 2025 Regular Session (2025R1)
- **LC number:** 3277
- **Created:** 2025-02-23T20:32:23
- **Metadata last modified (upstream):** 2025-05-01T20:26:09
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 102686 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3715/Introduced>.
...
**RelatingToFull (verbatim upstream field):** Relating to persons with mental illness; creating new provisions; amending ORS 127.700, 127.736, 161.370, 161.371, 163.738, 426.005, 426.070, 426.074, 426.130, 426.133, 426.160, 426.180, 426.225, 426.228, 426.231, 426.232, 426.233, 426.234 and 430.399; and declaring an emergency.
...
havior, how recently the past behavior occurred and the frequency and severity of the past
behavior.
...
this section and collaborate with the authority to  ensure that the cost of the services pro-
...
cian or provider may withdraw from providing treatment consistent with professional judgment and
...
community; or]
[(B) Determines that the defendant requires a hospital level of care after making all of the following
written findings:]
...
- From `RelatingToFull`: ORS 127.700, ORS 127.736, ORS 161.370, ORS 161.371, ORS 163.738, ORS 426.005, ORS 426.070, ORS 426.074, ORS 426.130, ORS 426.133, ORS 426.160, ORS 426.180, ORS 426.225, ORS 426.228, ORS 426.231, ORS 426.232, ORS 426.233, ORS 426.234, ORS 430.399
- From bill text (Introduced version): ORS 127.505, ORS 127.540, ORS 127.700, ORS 127.736, ORS 133.110, ORS 135.230, ORS 135.755, ORS 137.700, ORS 161.365, ORS 161.367, ORS 161.370, ORS 161.371, ORS 161.372, ORS 163.730, ORS 163.732, ORS 163.738, ORS 163.744, ORS 163.750, ORS 166.273, ORS 181A.290, ORS 19.450, ORS 192.245, ORS 40.230, ORS 40.235, ORS 40.240, ORS 426.005, ORS 426.010, ORS 426.060, ORS 426.070, ORS 426.074, ORS 426.090, ORS 426.095, ORS 426.100, ORS 426.123, ORS 426.125, ORS 426.127, ORS 426.130, ORS 426.133, ORS 426.140, ORS 426.160, ORS 426.180, ORS 426.200, ORS 426.210, ORS 426.225, ORS 426.228, ORS 426.231, ORS 426.232, ORS 426.233, ORS 426.234, ORS 426.235, ORS 426.237, ORS 426.250, ORS 426.273, ORS 426.495, ORS 426.701, ORS 430.010, ORS 430.397, ORS 430.399, ORS 430.610, ORS 430.626, ORS 430.630, ORS 430.640, ORS 443.400, ORS 443.465, ORS 677.010, ORS 677.505, ORS 678.375, ORS 678.390

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `28bf0d0126fcf0a34071ca5e658050c19937ee312670f34d94862d6568d94735` (snapshot `_meta/snapshots/measure-2025r1-hb3715-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3715/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3715` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

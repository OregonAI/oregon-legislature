...
jurisdiction: oregon
id: measure-2025r1-hb3240
title: 'HB 3240 (2025R1): Establishes the Oregon Public Places Are Safe Places Investment Fund.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3240
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3240/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f94daac4181bb4b2fd670841d27618c6aa5130279b849ef16c25ceb95d7171e1
snapshot_id: measure-2025r1-hb3240-introduced
status: current
...
catch_line: Establishes the Oregon Public Places Are Safe Places Investment Fund.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells ODEM to develop staging areas for emergency response in the\
  \ state. The Act sets up a committee to give advice to ODEM about the staging areas. (Flesch Readability\
  \ Score: 60.8). \n\tEstablishes the Oregon Public Places Are Safe Places Investment Fund. Continuously\
  \ appropriates moneys in the fund to the Oregon Department of Emergency Management for the implementation\
  \ of strategies for identifying and developing staging areas for emergency response. \n\tCreates an\
  \ advisory committee within the department to provide recommendations and advice regarding expenditures\
  \ from the fund."
...
measure_modified_date: '2025-01-17T13:25:21'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 6014
...
# HB 3240 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3240, 2025 Regular Session (2025R1)
- **LC number:** 2042
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-17T13:25:21
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6014 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3240/Introduced>.

## Summary

**Catchline:** Establishes the Oregon Public Places Are Safe Places Investment Fund.

**Relating to:** Relating to development of staging areas for emergency response.

Digest: The Act tells ODEM to develop staging areas for emergency response in the state. The Act sets up a committee to give advice to ODEM about the staging areas. (Flesch Readability Score: 60.8). 
 Establishes the Oregon Public Places Are Safe Places Investment Fund. Continuously appropriates moneys in the fund to the Oregon Department of Emergency Management for the implementation of strategies for identifying and developing staging areas for emergency response. 
 Creates an advisory committee within the department to provide recommendations and advice regarding expenditures from the fund.
...
SECTION 3.
(1) There is created within  the Oregon Department of Emergency Manage-
...
public service may be reimbursed  by their employing agency for their actual and necessary
...
- From bill text (Introduced version): ORS 292.210, ORS 293.701

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `f94daac4181bb4b2fd670841d27618c6aa5130279b849ef16c25ceb95d7171e1` (snapshot `_meta/snapshots/measure-2025r1-hb3240-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3240/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3240` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

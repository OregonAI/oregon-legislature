...
jurisdiction: oregon
id: measure-2025r1-scr15
title: 'SCR 15 (2025R1): Recognizes and honors Hector Hinojosa Robles for his remarkable contributions
  to the people of this state.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Concurrent Resolution 15
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR15/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: f88dc193a8d1ac05e60a9179c4a59c0054efa0aed84a4eeaabf609ea775170de
snapshot_id: measure-2025r1-scr15-enrolled
status: current
...
catch_line: Recognizes and honors Hector Hinojosa Robles for his remarkable contributions to the people
  of this state.
minority_catch_line: null
measure_summary: "\tDigest: Honors Hector Hinojosa Robles for all he has done for the people of this state.\
  \ (Flesch Readability Score: 67.5). \n\tRecognizes and honors Hector Hinojosa Robles for his remarkable\
  \ contributions to the people of this state."
relating_to: Recognizing and honoring Hector Hinojosa Robles for his remarkable contributions to the people
  of this state.
relating_to_full: null
at_the_request_of: null
lc_number: 3882
measure_created_date: '2025-01-14T11:19:43'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SCR' and MeasureNumber eq 15`.

# SCR 15 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Concurrent Resolution 15, 2025 Regular Session (2025R1)
- **LC number:** 3882
- **Created:** 2025-01-14T11:19:43
- **Metadata last modified (upstream):** 2025-06-12T16:20:09
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 3454 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR15/Enrolled>.

## Summary

**Catchline:** Recognizes and honors Hector Hinojosa Robles for his remarkable contributions to the people of this state.

**Relating to:** Recognizing and honoring Hector Hinojosa Robles for his remarkable contributions to the people of this state.

Digest: Honors Hector Hinojosa Robles for all he has done for the people of this state. (Flesch Readability Score: 67.5). 
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `f88dc193a8d1ac05e60a9179c4a59c0054efa0aed84a4eeaabf609ea775170de` (snapshot `_meta/snapshots/measure-2025r1-scr15-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR15/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `b32f95c30550d0baf0a571df1ffe554a2d468bf499d165975b33fcaff36b9012` (snapshot `_meta/snapshots/measure-2025r1-scr15-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SCR15/Introduced>.

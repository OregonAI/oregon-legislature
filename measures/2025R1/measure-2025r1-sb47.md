...
jurisdiction: oregon
id: measure-2025r1-sb47
title: 'SB 47 (2025R1): Eliminates obsolete public entities and modifies laws about obsolete activities
  of public entities.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 47
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB47/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 2bf13f2ba072f66a597659a114f7a0def6a7631f23a1e1a7db5b3ef5f4014048
snapshot_id: measure-2025r1-sb47-enrolled
status: current
...
catch_line: Eliminates obsolete public entities and modifies laws about obsolete activities of public
  entities.
minority_catch_line: null
measure_summary: "\tDigest: The Act gets rid of old public entities and changes laws about old activities\
  \ of public entities. (Flesch Readability Score: 62.8). \n\tEliminates obsolete public entities and\
  \ modifies laws about obsolete activities of public entities."
relating_to: Relating to obsolete activities of public entities.
relating_to_full: Relating to obsolete activities of public entities.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 47>.

# SB 47 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 47, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 27382 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB47/Enrolled>.

## Summary

**Catchline:** Eliminates obsolete public entities and modifies laws about obsolete activities of public entities.

**Relating to:** Relating to obsolete activities of public entities.

Digest: The Act gets rid of old public entities and changes laws about old activities of public entities. (Flesch Readability Score: 62.8). 
 Eliminates obsolete public entities and modifies laws about obsolete activities of public entities.

**RelatingToFull (verbatim upstream field):** Relating to obsolete activities of public entities.
...
- From bill text (Enrolled version): ORS 182.310, ORS 182.320, ORS 182.330, ORS 182.360, ORS 183.335, ORS 291.375, ORS 31.260, ORS 31.262, ORS 31.264, ORS 31.268, ORS 31.276, ORS 31.280, ORS 344.530, ORS 344.735, ORS 353.450, ORS 409.162, ORS 410.070, ORS 410.210, ORS 410.320, ORS 411.072, ORS 411.075, ORS 411.093, ORS 411.404, ORS 411.806, ORS 411.816, ORS 411.877, ORS 411.878, ORS 411.886, ORS 411.888, ORS 411.890, ORS 411.892, ORS 411.896, ORS 412.006, ORS 412.009, ORS 412.014, ORS 418.005, ORS 430.050, ORS 430.631, ORS 431A.300, ORS 431A.303, ORS 431A.305, ORS 431A.308, ORS 431A.310, ORS 431A.313, ORS 431A.315, ORS 431A.318, ORS 431A.320, ORS 431A.323, ORS 431A.325, ORS 431A.500, ORS 431A.505, ORS 431A.510, ORS 442.475, ORS 442.507, ORS 442.870

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `2bf13f2ba072f66a597659a114f7a0def6a7631f23a1e1a7db5b3ef5f4014048` (snapshot `_meta/snapshots/measure-2025r1-sb47-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB47/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `986809e33c39304368abe9249a8a1a3b6e6e943e77e948161c508ab734d3c6f2` (snapshot `_meta/snapshots/measure-2025r1-sb47-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB47/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 47> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb967
title: 'SB 967 (2025R1): Authorizes local governments to enter into agreements governing local improvements
  proposed for unincorporated areas within an urban growth boundary.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 967
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB967/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e553f1436fddada619d7344d092aa8025804a1798d32c76b9b3f024e3212c228
snapshot_id: measure-2025r1-sb967-enrolled
status: current
...
catch_line: Authorizes local governments to enter into agreements governing local improvements proposed
  for unincorporated areas within an urban growth boundary.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act would let local bodies enter into an IGA that says how they will\
  \ deal with a local improvement in a UGB. (Flesch Readability Score: 65.7).</b> \n\t[<i>Digest: The\
  \ Act would let local bodies enter into an IGA that says how they will deal with a local improvement\
  \ in a city's UGB. (Flesch Readability Score: 62.6).</i>] \n\tAuthorizes local governments to enter\
  \ into agreements governing local improvements proposed for unincorporated areas within [<i>a city's</i>]\
  \ <b>an</b> urban growth boundary."
relating_to: Relating to local improvements.
relating_to_full: Relating to local improvements.
at_the_request_of: null
lc_number: 4227
measure_created_date: '2025-01-29T09:35:26'
...
# SB 967 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 967, 2025 Regular Session (2025R1)
- **LC number:** 4227
- **Created:** 2025-01-29T09:35:26
- **Metadata last modified (upstream):** 2025-06-06T14:34:20
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 5152 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB967/Enrolled>.

## Summary

**Catchline:** Authorizes local governments to enter into agreements governing local improvements proposed for unincorporated areas within an urban growth boundary.

**Relating to:** Relating to local improvements.
...
**RelatingToFull (verbatim upstream field):** Relating to local improvements.
...
- From bill text (Enrolled version): ORS 223.389

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `e553f1436fddada619d7344d092aa8025804a1798d32c76b9b3f024e3212c228` (snapshot `_meta/snapshots/measure-2025r1-sb967-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB967/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `ca541c65a5f8183574e555c7df0a6de7bd44a5f60e069109a70177359c95afe6` (snapshot `_meta/snapshots/measure-2025r1-sb967-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB967/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 967> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

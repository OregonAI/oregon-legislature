...
jurisdiction: oregon
id: measure-2025r1-sb1087
title: 'SB 1087 (2025R1): Directs the Public Employees Retirement Board to study the treatment of the
  salary of chaplains under the Public Employees Retirement System.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1087
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1087/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 792aeb9ed493d7d7af5806ddd35f8c951b100ca9e2de9dcf448d2779be114e7c
snapshot_id: measure-2025r1-sb1087-introduced
status: current
...
catch_line: Directs the Public Employees Retirement Board to study the treatment of the salary of chaplains
  under the Public Employees Retirement System.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells the PERB to study the salary of chaplains and make a report.\
  \ The Act makes some groups of workers police officers for PERS. (Flesch Readability Score: 79.7). \n\
  \tDirects the Public Employees Retirement Board to study the treatment of the salary of chaplains under\
  \ the Public Employees Retirement System. \n\tProvides that certain members of the system qualify as\
  \ police officers under the system."
relating_to: Relating to public employee retirement.
relating_to_full: Relating to public employee retirement; creating new provisions; and amending ORS 238.005.
at_the_request_of: null
lc_number: 4213
measure_created_date: '2025-02-21T14:47:03'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1087`.

# SB 1087 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1087, 2025 Regular Session (2025R1)
- **LC number:** 4213
- **Created:** 2025-02-21T14:47:03
- **Metadata last modified (upstream):** 2025-02-26T10:33:29
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 25346 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1087/Introduced>.

## Summary

**Catchline:** Directs the Public Employees Retirement Board to study the treatment of the salary of chaplains under the Public Employees Retirement System.
...
**RelatingToFull (verbatim upstream field):** Relating to public employee retirement; creating new provisions; and amending ORS 238.005.
...
(aa) Assistant attorneys general in the division of the Department of Justice  responsible
...
(b)(A) Is employed as an assistant attorney general in the  division of the Department of
...
- From bill text (Introduced version): ORS 181A.355, ORS 181A.540, ORS 192.245, ORS 238.005, ORS 238.008, ORS 238.015, ORS 238.035, ORS 238.095, ORS 238.225, ORS 238.250, ORS 238.260, ORS 238.280, ORS 238.430, ORS 238.442, ORS 238A.330, ORS 238A.335, ORS 240.190, ORS 243.726, ORS 276.021, ORS 332.531, ORS 341.005, ORS 341.556, ORS 350.370, ORS 352.002, ORS 352.121, ORS 352.232, ORS 353.270, ORS 419A.012, ORS 419A.016, ORS 419A.050, ORS 419A.052, ORS 420.005, ORS 421.005, ORS 423.549, ORS 443.400, ORS 461.110, ORS 477.064, ORS 652.190, ORS 824.020

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `792aeb9ed493d7d7af5806ddd35f8c951b100ca9e2de9dcf448d2779be114e7c` (snapshot `_meta/snapshots/measure-2025r1-sb1087-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1087/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1087` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

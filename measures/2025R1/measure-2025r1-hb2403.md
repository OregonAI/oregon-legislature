...
jurisdiction: oregon
id: measure-2025r1-hb2403
title: 'HB 2403 (2025R1): Authorizes landowners who meet certain criteria to petition for formation of
  a predator damage control district as a funding mechanism to pay the actual costs to the county of preventing,
  reducing and mitigating damage to property from predatory animals.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2403
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2403/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 671a2acc29f0817ec1b688164ace91c140a220ebd2f4002d4666160a2e8bcd5d
snapshot_id: measure-2025r1-hb2403-introduced
status: current
...
catch_line: Authorizes landowners who meet certain criteria to petition for formation of a predator damage
  control district as a funding mechanism to pay the actual costs to the county of preventing, reducing
  and mitigating damage to property from predatory animals.
minority_catch_line: null
measure_summary: "\tDigest: The Act would let owners of land form a district in order to pay the costs\
  \ to the county of staving off damage to their land caused by predators, by both nonlethal and lethal\
  \ means. (Flesch Readability Score: 60.1). \n\tAuthorizes landowners who meet certain criteria to petition\
  \ for formation of a predator damage control district as a funding mechanism to pay the actual costs\
  \ to the county of preventing, reducing and mitigating damage to property from predatory animals. Defines\
  \ \"prevent, reduce and mitigate damage to property from predatory animals\" to include both nonlethal\
  \ and lethal methods of prevention, reduction and mitigation. Establishes presumptive charges of $2\
  \ per acre for tax lots of 10 or more acres and a $50 flat rate charge for tax lots of less than 10\
  \ acres. Creates a cause of action under the district program for counties, landowners, districts and\
  \ cities involved in the program. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to a principal Act for predator damage control districts; prescribing an effective
  date.
relating_to_full: Relating to a principal Act for predator damage control districts; and prescribing an
  effective date.
...
# HB 2403 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2403, 2025 Regular Session (2025R1)
- **LC number:** 1310
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-04-15T17:18:14
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 15343 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2403/Introduced>.

## Summary

**Catchline:** Authorizes landowners who meet certain criteria to petition for formation of a predator damage control district as a funding mechanism to pay the actual costs to the county of preventing, reducing and mitigating damage to property from predatory animals.
...
**RelatingToFull (verbatim upstream field):** Relating to a principal Act for predator damage control districts; and prescribing an effective date.
...
LC 1310
boundaries must be identified  by tax lots and may be noncontiguous. All signatures must
...
the signature requirements of section 2 (2)(a) of this 2025 Act and  states why the district is
...
(b) The governing body of the  county may, with the consent of the governing body of the
...
determine the deadline for the collection of charges by direct billing within the district.
...
- From bill text (Introduced version): ORS 198.705, ORS 477.001, ORS 497.655

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `671a2acc29f0817ec1b688164ace91c140a220ebd2f4002d4666160a2e8bcd5d` (snapshot `_meta/snapshots/measure-2025r1-hb2403-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2403/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2403` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

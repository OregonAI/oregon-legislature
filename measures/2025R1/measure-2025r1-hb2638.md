...
jurisdiction: oregon
id: measure-2025r1-hb2638
title: 'HB 2638 (2025R1): Modifies the court''s authority regarding the parties'' property rights while
  a proceeding to terminate a marriage is pending.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2638
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2638/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 2fc8a60e53a4da929f18a6d90b792196eb5f0511f2d5cfee4820de36e39a18e4
snapshot_id: measure-2025r1-hb2638-introduced
status: current
...
catch_line: Modifies the court's authority regarding the parties' property rights while a proceeding to
  terminate a marriage is pending.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes changes to what a court can order with regard to the parties'\
  \ property rights while a case to end the marriage is pending. (Flesch Readability Score: 66.5). \n\t\
  Modifies the court's authority regarding the parties' property rights while a proceeding to terminate\
  \ a marriage is pending."
relating_to: Relating to family law.
relating_to_full: Relating to family law; amending ORS 107.095.
...
measure_modified_date: '2025-03-14T13:06:11'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 5464
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2638`.

# HB 2638 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2638, 2025 Regular Session (2025R1)
...
- **Metadata last modified (upstream):** 2025-03-14T13:06:11
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5464 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2638/Introduced>.

## Summary

**Catchline:** Modifies the court's authority regarding the parties' property rights while a proceeding to terminate a marriage is pending.
...
**RelatingToFull (verbatim upstream field):** Relating to family law; amending ORS 107.095.
...
- From `RelatingToFull`: ORS 107.095
- From bill text (Introduced version): ORS 107.095, ORS 107.105, ORS 107.720, ORS 18.005, ORS 19.255

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `2fc8a60e53a4da929f18a6d90b792196eb5f0511f2d5cfee4820de36e39a18e4` (snapshot `_meta/snapshots/measure-2025r1-hb2638-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2638/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2638` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

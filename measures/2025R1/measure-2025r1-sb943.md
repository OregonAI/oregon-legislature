...
jurisdiction: oregon
id: measure-2025r1-sb943
title: 'SB 943 (2025R1): Changes the definitions of "audiologist" and "practice of audiology."'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 943
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB943/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 900ac5d41f347c31b79eed755f7fa7cd7bcef33e834d52310da080af273d67f5
snapshot_id: measure-2025r1-sb943-introduced
status: current
...
catch_line: Changes the definitions of "audiologist" and "practice of audiology."
minority_catch_line: null
measure_summary: "\tDigest: The Act makes some changes to the laws on the practice of audiology. (Flesch\
  \ Readability Score: 69.9). \n\tChanges the definitions of \"audiologist\" and \"practice of audiology.\"\
  \ Specifies actions within the audiologist scope of practice. Requires the State Board of Examiners\
  \ for Speech-Language Pathology and Audiology to establish by rule a timeline for investigations and\
  \ provide certain information to a person under investigation by the board. \n\tTakes effect on the\
  \ 91st day following adjournment sine die."
relating_to: Relating to audiology; prescribing an effective date.
relating_to_full: Relating to audiology; creating new provisions; amending ORS 681.205, 681.230, 681.250,
  681.270, 681.290, 681.300, 681.490 and 681.495; and prescribing an effective date.
at_the_request_of: null
lc_number: 2703
measure_created_date: '2025-01-23T10:00:04'
measure_modified_date: '2026-02-25T12:32:20'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 18583
...
# SB 943 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 943, 2025 Regular Session (2025R1)
- **LC number:** 2703
- **Created:** 2025-01-23T10:00:04
- **Metadata last modified (upstream):** 2026-02-25T12:32:20
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 18583 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB943/Introduced>.

## Summary

**Catchline:** Changes the definitions of "audiologist" and "practice of audiology."

**Relating to:** Relating to audiology; prescribing an effective date.

Digest: The Act makes some changes to the laws on the practice of audiology. (Flesch Readability Score: 69.9). 
 Changes the definitions of "audiologist" and "practice of audiology." Specifies actions within the audiologist scope of practice. Requires the State Board of Examiners for Speech-Language Pathology and Audiology to establish by rule a timeline for investigations and provide certain information to a person under investigation by the board. 
 Takes effect on the 91st day following adjournment sine die.

**RelatingToFull (verbatim upstream field):** Relating to audiology; creating new provisions; amending ORS 681.205, 681.230, 681.250, 681.270, 681.290, 681.300, 681.490 and 681.495; and prescribing an effective date.
...
LC 2703
of study in speech-language pathology  or audiology, leading to a master’s or doctoral degree, that
...
(a) “Consultation”  means the approval and review of the activities of a person not li-
...
the examination described in ORS 681.290 and [ grant] issue  a license to:
...
tigations under this section. The rules must include specified  times for at least the following:
...
- From `RelatingToFull`: ORS 681.205, ORS 681.230, ORS 681.250, ORS 681.270, ORS 681.290, ORS 681.300, ORS 681.490, ORS 681.495
- From bill text (Introduced version): ORS 183.745, ORS 676.160, ORS 676.165, ORS 681.205, ORS 681.230, ORS 681.250, ORS 681.270, ORS 681.290, ORS 681.300, ORS 681.325, ORS 681.420, ORS 681.490, ORS 681.495

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `900ac5d41f347c31b79eed755f7fa7cd7bcef33e834d52310da080af273d67f5` (snapshot `_meta/snapshots/measure-2025r1-sb943-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB943/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 943> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

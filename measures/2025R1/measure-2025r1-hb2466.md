...
jurisdiction: oregon
id: measure-2025r1-hb2466
title: 'HB 2466 (2025R1): Allows a law enforcement agency or public body to provide information, or enter
  into an agreement to provide information, as required to effect an international extradition and return
  of a person charged with or convicted of a crime in this state and for whom a warrant of arrest has
  been issued.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2466
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2466/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 001709e069fafa82f7b982137cbd67afc221784b263ee878842a4d0cebf4eafc
snapshot_id: measure-2025r1-hb2466-introduced
status: current
...
catch_line: Allows a law enforcement agency or public body to provide information, or enter into an agreement
  to provide information, as required to effect an international extradition and return of a person charged
  with or convicted of a crime in this state and for whom a warrant of arrest has been issued.
minority_catch_line: null
measure_summary: "\tDigest: Allows for the sharing of data as needed to effect an extradition for a crime\
  \ of a person from outside of this country to this state. (Flesch Readability Score: 60.0). \n\tAllows\
  \ a law enforcement agency or public body to provide information, or enter into an agreement to provide\
  \ information, as required to effect an international extradition and return of a person charged with\
  \ or convicted of a crime in this state and for whom a warrant of arrest has been issued. \n\tProhibits\
  \ a law enforcement agency or public body from entering into an agreement to provide information about\
  \ an individual in custody to a federal immigration authority. Provides for exceptions."
relating_to: Relating to information sharing between state and federal authorities.
relating_to_full: Relating to information sharing between state and federal authorities; amending ORS
  181A.823 and 181A.826.
...
measure_modified_date: '2025-01-17T13:04:19'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 9162
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2466`.

# HB 2466 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2466, 2025 Regular Session (2025R1)
...
- **Metadata last modified (upstream):** 2025-01-17T13:04:19
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 9162 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2466/Introduced>.

## Summary

**Catchline:** Allows a law enforcement agency or public body to provide information, or enter into an agreement to provide information, as required to effect an international extradition and return of a person charged with or convicted of a crime in this state and for whom a warrant of arrest has been issued.

**Relating to:** Relating to information sharing between state and federal authorities.
...
**RelatingToFull (verbatim upstream field):** Relating to information sharing between state and federal authorities; amending ORS 181A.823 and 181A.826.
...
standards.
Digest: Allows for the sharing of  data as needed to effect an extradition for a crime of a person
from outside of this country to this state. (Flesch Readability Score: 60.0).
Allows a law enforcement agency or public body to provide  information, or enter into an
agreement to provide information, as required to effect an international extradition and return of a
person charged with or convicted of a crime in  this state and for whom a warrant of arrest has been
issued.
Prohibits a law enforcement agency or public body from entering  into an agreement to provide
information about an individual in custody to a federal  immigration authority. Provides for ex-
ceptions.
A BILL FOR AN ACT
Relating to information sharing between state  and federal authorities; amending ORS 181A.823 and
181A.826.
...
LC 1107
(C) To the extent that the information is  available to the general public and under the same
...
- From `RelatingToFull`: ORS 181A.823, ORS 181A.826
- From bill text (Introduced version): ORS 181A.823, ORS 181A.826, ORS 181A.827, ORS 192.311, ORS 413.161

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `001709e069fafa82f7b982137cbd67afc221784b263ee878842a4d0cebf4eafc` (snapshot `_meta/snapshots/measure-2025r1-hb2466-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2466/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2466` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

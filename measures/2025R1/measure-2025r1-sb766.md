...
jurisdiction: oregon
id: measure-2025r1-sb766
title: 'SB 766 (2025R1): Imposes a cap on the percentage increase that the minimum wage rate may be adjusted
  for inflation.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 766
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB766/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e9c5c65718e7398b7661e66f44e903543aa97d97e904249b01d1723cb67664ed
snapshot_id: measure-2025r1-sb766-introduced
status: current
...
catch_line: Imposes a cap on the percentage increase that the minimum wage rate may be adjusted for inflation.
minority_catch_line: null
measure_summary: "\tDigest: The Act puts a cap on the amount that the minimum wage rate may be adjusted\
  \ for inflation. (Flesch Readability Score: 71.0). \n\tImposes a cap on the percentage increase that\
  \ the minimum wage rate may be adjusted for inflation."
relating_to: Relating to minimum wage.
relating_to_full: Relating to minimum wage; amending ORS 653.025.
...
# SB 766 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 766, 2025 Regular Session (2025R1)
- **LC number:** 1222
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T11:07:54
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5349 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB766/Introduced>.

## Summary

**Catchline:** Imposes a cap on the percentage increase that the minimum wage rate may be adjusted for inflation.
...
**RelatingToFull (verbatim upstream field):** Relating to minimum wage; amending ORS 653.025.
...
- From `RelatingToFull`: ORS 653.025
- From bill text (Introduced version): ORS 652.020, ORS 653.025, ORS 653.026, ORS 653.030, ORS 653.261

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `e9c5c65718e7398b7661e66f44e903543aa97d97e904249b01d1723cb67664ed` (snapshot `_meta/snapshots/measure-2025r1-sb766-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB766/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 766` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

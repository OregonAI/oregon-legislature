...
jurisdiction: oregon
id: measure-2025r1-hb2214
title: 'HB 2214 (2025R1): Modifies the minimum financial requirements for coordinated care organizations.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2214
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2214/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: de270892176e9189739024a5e5790a8fff60c944819f8e659faa0948c55d3f99
snapshot_id: measure-2025r1-hb2214-introduced
status: current
...
catch_line: Modifies the minimum financial requirements for coordinated care organizations.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes changes to the financial requirements for CCOs. (Flesch Readability\
  \ Score: 61.3). \n\tModifies the minimum financial requirements for coordinated care organizations."
...
measure_modified_date: '2025-04-05T23:03:24'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 13739
...
# HB 2214 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2214, 2025 Regular Session (2025R1)
...
- **Metadata last modified (upstream):** 2025-04-05T23:03:24
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 13739 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2214/Introduced>.

## Summary

**Catchline:** Modifies the minimum financial requirements for coordinated care organizations.

**Relating to:** Relating to coordinated care organizations.

Digest: The Act makes changes to the financial requirements for CCOs. (Flesch Readability Score: 61.3). 
 Modifies the minimum financial requirements for coordinated care organizations.

**RelatingToFull (verbatim upstream field):** Relating to coordinated care organizations; creating new provisions; and amending ORS 414.572.
...
standards.
Digest: The Act makes changes to the financial requirements for CCOs. (Flesch  Readability
Score: 61.3).
Modifies the minimum financial requirements for coordinated care organizations.
A BILL FOR AN ACT
Relating to coordinated care organizations; creating new provisions; and amending ORS 414.572.
...
that [ exceed ] exceeds the financial requirements specified  in this paragraph on services  that meet
the requirements under 45 C.F.R. 158.150 or  45 C.F.R. 158.151 for activities that improve
health care quality  [ designed to address health disparities and the  social determinants of health ] or
that are  consistent with the coordinated care  organization’s community health improvement plan
and transformation plan and the terms and conditions of the  Medicaid demonstration project under
...
- From bill text (Introduced version): ORS 413.022, ORS 413.259, ORS 413.550, ORS 414.018, ORS 414.570, ORS 414.572, ORS 414.575, ORS 414.581, ORS 414.584, ORS 414.605, ORS 414.766, ORS 442.372, ORS 442.373, ORS 678.375, ORS 731.554, ORS 732.225, ORS 732.230, ORS 750.045

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `de270892176e9189739024a5e5790a8fff60c944819f8e659faa0948c55d3f99` (snapshot `_meta/snapshots/measure-2025r1-hb2214-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2214/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2214` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

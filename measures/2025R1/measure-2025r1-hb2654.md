...
jurisdiction: oregon
id: measure-2025r1-hb2654
title: 'HB 2654 (2025R1): Establishes the emergency veterans housing program within the Housing and Community
  Services Department.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2654
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2654/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: d5bc687c720d3b6fb451fda4a982015bc3140c73f601c7e6b1e7195a372b6418
snapshot_id: measure-2025r1-hb2654-introduced
status: current
...
catch_line: Establishes the emergency veterans housing program within the Housing and Community Services
  Department.
minority_catch_line: null
measure_summary: "\tDigest: This Act creates and funds an OHCS program for housing disabled veterans.\
  \ (Flesch Readability Score: 67.7). \n\tEstablishes the emergency veterans housing program within the\
  \ Housing and Community Services Department. Requires the department, in coordination with the Department\
  \ of Veterans' Affairs and an advisory board, to award grants for the project costs of residential housing\
  \ for persons of lower income who are service-disabled veterans and their families. \n\tAppropriates\
  \ moneys from the General Fund for the program. \n\tSunsets January 2, 2030."
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2654>.

# HB 2654 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2654, 2025 Regular Session (2025R1)
- **LC number:** 3299
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:26:00
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4239 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2654/Introduced>.

## Summary

**Catchline:** Establishes the emergency veterans housing program within the Housing and Community Services Department.
...
- From bill text (Introduced version): ORS 456.548

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `d5bc687c720d3b6fb451fda4a982015bc3140c73f601c7e6b1e7195a372b6418` (snapshot `_meta/snapshots/measure-2025r1-hb2654-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2654/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2654> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

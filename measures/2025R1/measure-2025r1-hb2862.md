...
jurisdiction: oregon
id: measure-2025r1-hb2862
title: 'HB 2862 (2025R1): Establishes the Local Markets Small Business Capital Loan Program to be administered
  by the Oregon Business Development Department for the purpose of making interest-only loans to allow
  businesses with not more than 50 employees to hire new employees.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2862
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2862/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 83053cdb9809881889f61ade956681d9dd684bfc4372c9cc0e6db82008a16da9
snapshot_id: measure-2025r1-hb2862-introduced
status: current
...
catch_line: Establishes the Local Markets Small Business Capital Loan Program to be administered by the
  Oregon Business Development Department for the purpose of making interest-only loans to allow businesses
  with not more than 50 employees to hire new employees.
minority_catch_line: null
measure_summary: "\tDigest: The Act would create a loan program to support small businesses. (Flesch Readability\
  \ Score: 72.6). \n\tEstablishes the Local Markets Small Business Capital Loan Program to be administered\
  \ by the Oregon Business Development Department for the purpose of making interest-only loans to allow\
  \ businesses with not more than 50 employees to hire new employees. Requires the payment of principal\
  \ plus penalty for failure to hire and retain employees for at least two years. \n\tEstablishes the\
  \ Local Markets Small Business Capital Loan Fund for the purpose of administering the loan program.\
  \ \n\tAppropriates moneys to the department for the purpose of administering the loan program and loan\
  \ fund."
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2862`.

# HB 2862 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2862, 2025 Regular Session (2025R1)
- **LC number:** 2127
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:37:10
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 8713 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2862/Introduced>.

## Summary

**Catchline:** Establishes the Local Markets Small Business Capital Loan Program to be administered by the Oregon Business Development Department for the purpose of making interest-only loans to allow businesses with not more than 50 employees to hire new employees.

**Relating to:** Relating to interest-only loans to assist small businesses to increase employment.

Digest: The Act would create a loan program to support small businesses. (Flesch Readability Score: 72.6). 
 ...
 Establishes the Local Markets Small Business Capital Loan Fund for the purpose of administering the loan program. 
 Appropriates moneys to the department for the purpose of administering the loan program and loan fund.
...
this section.
SECTION 2.
(1) The Local Markets Small  Business Capital Loan Fund is established in
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `83053cdb9809881889f61ade956681d9dd684bfc4372c9cc0e6db82008a16da9` (snapshot `_meta/snapshots/measure-2025r1-hb2862-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2862/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2862` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

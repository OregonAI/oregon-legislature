...
jurisdiction: oregon
id: measure-2025r1-hb3243
title: 'HB 3243 (2025R1): Prohibits balance billing for ambulance ground transportation services in certain
  circumstances and creates rules for health benefit plan reimbursement of ambulance services.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3243
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3243/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: cdd1cb3da35cbc23f64cf954e2f805f42155fe7b56302fea59a83b7deefb270f
snapshot_id: measure-2025r1-hb3243-enrolled
status: current
...
catch_line: Prohibits balance billing for ambulance ground transportation services in certain circumstances
  and creates rules for health benefit plan reimbursement of ambulance services.
minority_catch_line: null
measure_summary: "\tDigest: Tells ambulance service providers not to balance bill some patients and makes\
  \ them report local rates to DCBS. Makes some rules about health insurance for ambulance services. Tells\
  \ DCBS to make a new database of local rates and allows for penalties. Tells DCBS to submit a report.\
  \ (Flesch Readability Score: 63.5). \n\tProhibits balance billing for ambulance ground transportation\
  \ services in certain circumstances and creates rules for health benefit plan reimbursement of ambulance\
  \ services. Requires ground ambulance services to submit established local rates to the Department of\
  \ Consumer and Business Services. Establishes a database of local rates for ambulance services and allows\
  \ for penalties to be imposed for violations. Requires the department to submit a report on the implementation\
  \ of this Act."
relating_to: Relating to billing for ground ambulance services.
relating_to_full: Relating to billing for ground ambulance services.
...
# HB 3243 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3243, 2025 Regular Session (2025R1)
- **LC number:** 711
...
- **Full text below:** Enrolled version, 7063 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3243/Enrolled>.

## Summary

**Catchline:** Prohibits balance billing for ambulance ground transportation services in certain circumstances and creates rules for health benefit plan reimbursement of ambulance services.
...
**RelatingToFull (verbatim upstream field):** Relating to billing for ground ambulance services.
...
Enrolled House Bill 3243 (HB 3243-B) Page 1
(2) A ground ambulance service  may not bill an enrollee for covered ground ambulance
...
Enrolled House Bill 3243 (HB 3243-B) Page 2
...
Enrolled House Bill 3243 (HB 3243-B) Page 3
...
- From bill text (Enrolled version): ORS 192.245, ORS 682.045, ORS 731.988, ORS 743A.001, ORS 743B.005, ORS 743B.280

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `cdd1cb3da35cbc23f64cf954e2f805f42155fe7b56302fea59a83b7deefb270f` (snapshot `_meta/snapshots/measure-2025r1-hb3243-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3243/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `5e3128a564b745b2430c4ad11cd4b97df76db8fcb1f60f69fcaa52c5196faa0d` (snapshot `_meta/snapshots/measure-2025r1-hb3243-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3243/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3243> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb811
title: 'SB 811 (2025R1): Adds new requirements for obtaining a license to operate a residential facility
  or adult foster home.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 811
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB811/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 798435e9ada09f0ef59aaa0d5279779a05fbf51c0457f493859a922008c73d6b
snapshot_id: measure-2025r1-sb811-introduced
status: current
...
catch_line: Adds new requirements for obtaining a license to operate a residential facility or adult foster
  home.
minority_catch_line: null
measure_summary: "\tDigest: The Act adds new requirements for getting a license to run certain types of\
  \ long term care facilities. (Flesch Readability Score: 61.6). \n\tAdds new requirements for obtaining\
  \ a license to operate a residential facility or adult foster home. Requires the Department of Human\
  \ Services and the Oregon Health Authority to inspect residential facilities and adult foster homes\
  \ under certain conditions. Permits the department to extend the duration of an adult foster home license\
  \ to two years if the home has been found in substantial compliance for three consecutive years. Directs\
  \ the department to adopt additional standards for obtaining a memory care endorsement. \n\tTakes effect\
  \ on the 91st day following adjournment sine die."
relating_to: Relating to community-based care; prescribing an effective date.
relating_to_full: Relating to community-based care; creating new provisions; amending ORS 443.415, 443.416,
  443.425, 443.735, 443.755 and 443.886; and prescribing an effective date.
...
measure_modified_date: '2025-03-31T10:00:07'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 24380
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 811`.

# SB 811 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 811, 2025 Regular Session (2025R1)
- **At the request of:** (at the request of Governor Tina Kotek for Department of Human Services)
- **LC number:** 322
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-03-31T10:00:07
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 24380 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB811/Introduced>.

## Summary

**Catchline:** Adds new requirements for obtaining a license to operate a residential facility or adult foster home.
...
**RelatingToFull (verbatim upstream field):** Relating to community-based care; creating new provisions; amending ORS 443.415, 443.416, 443.425, 443.735, 443.755 and 443.886; and prescribing an effective date.
...
communities; and
(d) Minimum required qualifications for an administrator  of a facility with a memory
care endorsement.
...
- From `RelatingToFull`: ORS 443.415, ORS 443.416, ORS 443.425, ORS 443.735, ORS 443.755, ORS 443.886
- From bill text (Introduced version): ORS 181A.195, ORS 427.021, ORS 441.678, ORS 443.001, ORS 443.002, ORS 443.012, ORS 443.400, ORS 443.415, ORS 443.416, ORS 443.417, ORS 443.425, ORS 443.705, ORS 443.725, ORS 443.735, ORS 443.755, ORS 443.886, ORS 443.889, ORS 479.220

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `798435e9ada09f0ef59aaa0d5279779a05fbf51c0457f493859a922008c73d6b` (snapshot `_meta/snapshots/measure-2025r1-sb811-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB811/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 811` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

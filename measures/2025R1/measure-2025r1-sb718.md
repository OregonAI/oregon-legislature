...
jurisdiction: oregon
id: measure-2025r1-sb718
title: 'SB 718 (2025R1): Establishes the Parkinson''s disease registry.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 718
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB718/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a20465acedd38814d5d3c9220de8e667f6be9758cf17f6d06f2b894fa0381880
snapshot_id: measure-2025r1-sb718-introduced
status: current
...
catch_line: Establishes the Parkinson's disease registry.
minority_catch_line: null
measure_summary: "\tDigest: The Act would create the Parkinson's disease registry. (Flesch Readability\
...
# SB 718 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 718, 2025 Regular Session (2025R1)
- **LC number:** 1868
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-03-06T15:15:38
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 10652 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB718/Introduced>.

## Summary

**Catchline:** Establishes the Parkinson's disease registry.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `a20465acedd38814d5d3c9220de8e667f6be9758cf17f6d06f2b894fa0381880` (snapshot `_meta/snapshots/measure-2025r1-sb718-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB718/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 718` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

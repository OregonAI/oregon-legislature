...
jurisdiction: oregon
id: measure-2025r1-hb2922
title: 'HB 2922 (2025R1): Provides that State Parks and Recreation Department employees whose job classification
  is a park manager or a park ranger are eligible to request that records kept by the Department of Transportation
  contain the employer''s address instead of the employee''s home address.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2922
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2922/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: e4c349ce107f8b7c2faf623ea81f601d4901fb1af9bd4f8f3b357d340619abc5
snapshot_id: measure-2025r1-hb2922-enrolled
status: current
...
catch_line: Provides that State Parks and Recreation Department employees whose job classification is
  a park manager or a park ranger are eligible to request that records kept by the Department of Transportation
  contain the employer's address instead of the employee's home address.
minority_catch_line: null
measure_summary: "\tDigest: The Act allows employees of State Parks to keep their home address private\
  \ in ODOT records. (Flesch Readability Score: 68.9). \n\tProvides that State Parks and Recreation Department\
  \ employees<b> whose job classification is a park manager or a park ranger</b> are eligible to request\
  \ that records kept by the Department of Transportation contain the employer's address instead of the\
  \ employee's home address."
relating_to: Relating to address confidentiality.
relating_to_full: Relating to address confidentiality.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2922`.

# HB 2922 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2922, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 7978 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2922/Enrolled>.

## Summary

**Catchline:** Provides that State Parks and Recreation Department employees whose job classification is a park manager or a park ranger are eligible to request that records kept by the Department of Transportation contain the employer's address instead of the employee's home address.
...
**RelatingToFull (verbatim upstream field):** Relating to address confidentiality.
...
- From bill text (Enrolled version): ORS 131.005, ORS 147.380, ORS 181A.355, ORS 192.345, ORS 276.021, ORS 421.005, ORS 801.395, ORS 802.250, ORS 803.220

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `e4c349ce107f8b7c2faf623ea81f601d4901fb1af9bd4f8f3b357d340619abc5` (snapshot `_meta/snapshots/measure-2025r1-hb2922-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2922/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `9b5d151fbc5b4cf1cb940a380727cee4650fbb107f792562dd50eb3c97df8aa7` (snapshot `_meta/snapshots/measure-2025r1-hb2922-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2922/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2922` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

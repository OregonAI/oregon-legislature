...
jurisdiction: oregon
id: measure-2025r1-sb1167
title: 'SB 1167 (2025R1): Appropriates moneys from the General Fund to the Department of Early Learning
  and Care for distribution to seven entities to support the development of successful children in this
  state.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 1167
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1167/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: cd71521876e5535db84ca66aa1623cd26a0f298b42ab4e8edbef58baf494d72a
snapshot_id: measure-2025r1-sb1167-introduced
status: current
...
catch_line: Appropriates moneys from the General Fund to the Department of Early Learning and Care for
  distribution to seven entities to support the development of successful children in this state.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act gives money to DELC to give to entities for the development of\
  \ successful children in this state. (Flesch Readability Score: 62.8).</b> \n\t[<i>Digest: The Act gives\
  \ money to DAS to give to entities for the development of successful children in this state. (Flesch\
  \ Readability Score: 62.8).</i>] \n\tAppropriates moneys from the General Fund to the [<i>Oregon Department\
  \ of Administrative Services</i>]<b> Department of Early Learning and Care</b> for distribution to seven\
  \ entities to support the development of successful children in this state. \n\tDeclares an emergency,\
  \ effective July 1, 2025."
relating_to: Relating to funding to develop successful children; declaring an emergency.
relating_to_full: Relating to funding to develop successful children; and declaring an emergency.
at_the_request_of: null
lc_number: 4139
measure_created_date: '2025-02-25T16:25:38'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1167`.

# SB 1167 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 1167, 2025 Regular Session (2025R1)
- **LC number:** 4139
- **Created:** 2025-02-25T16:25:38
- **Metadata last modified (upstream):** 2025-04-07T18:05:02
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 8038 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1167/Introduced>.

## Summary

**Catchline:** Appropriates moneys from the General Fund to the Department of Early Learning and Care for distribution to seven entities to support the development of successful children in this state.

**Relating to:** Relating to funding to develop successful children; declaring an emergency.

<b>Digest: The Act gives money to DELC to give to entities for the development of successful children in this state. (Flesch Readability Score: 62.8).</b> 
 [<i>Digest: The Act gives money to DAS to give to entities for the development of successful children in this state. (Flesch Readability Score: 62.8).</i>] 
 Appropriates moneys from the General Fund to the [<i>Oregon Department of Administrative Services</i>]<b> Department of Early Learning and Care</b> for distribution to seven entities to support the development of successful children in this state. 
 Declares an emergency, effective July 1, 2025.

**RelatingToFull (verbatim upstream field):** Relating to funding to develop successful children; and declaring an emergency.

## Full text

83rd OREGON LEGISLATIVE ASSEMBLY--2025 Regular Session
Senate Bill 1167
Sponsored by Senator REYNOLDS, Representative BOWMAN, Senator PROZANSKI; Senator  GOLDEN, Represen-
tatives FRAGALA, ISADORE, LEVY B, LIVELY, MANNIX, NELSON, NERON
SUMMARY
The following summary  is not prepared by the sponsors of the measure and is not a part of the body thereof subject
to consideration by the Legislative Assembly. It is an editor’s brief statement of the essential features  of the
measure as introduced. The statement includes a measure digest written in compliance with applicable readability
standards.
Digest: The Act gives money to DAS to give to entities for the development  of successful chil-
dren in this state. (Flesch Readability Score: 62.8).
Appropriates moneys from the General Fund to the  Oregon Department of Administrative Ser-
vices for distribution  to seven entities to support the development of successful children in this
state.
Declares an emergency, effective July 1, 2025.
A BILL FOR AN ACT
...
moneys from the Oregon Department of  Administrative Services under section 1 of this 2025
Act shall, in the manner provided by  ORS 192.245, submit a report to the Early Learning
Council and the interim committees of the Legislative  Assembly related to early childhood.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `cd71521876e5535db84ca66aa1623cd26a0f298b42ab4e8edbef58baf494d72a` (snapshot `_meta/snapshots/measure-2025r1-sb1167-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB1167/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1167` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

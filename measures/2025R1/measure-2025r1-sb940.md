...
jurisdiction: oregon
id: measure-2025r1-sb940
title: 'SB 940 (2025R1): Allows development of certain accessory dwelling units, recreational vehicles
  or emergency shelters on farmland on which is sited certain nonfarm dwellings.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 940
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB940/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 930380e090f3935ff08f2e9dbb494c8bbf6c62ae846f80b612cd66d5004e6e0e
snapshot_id: measure-2025r1-sb940-introduced
status: current
...
catch_line: Allows development of certain accessory dwelling units, recreational vehicles or emergency
  shelters on farmland on which is sited certain nonfarm dwellings.
minority_catch_line: null
measure_summary: "\tDigest: This Act expands the meaning of \"area zoned for rural residential use\" for\
  \ land use planning. (Flesch Readability Score: 60.1). \n\tAllows development of certain accessory dwelling\
  \ units, recreational vehicles or emergency shelters on farmland on which is sited certain nonfarm dwellings.\
  \ Subjects such lands to other land use planning requirements."
relating_to: Relating to rural residential lands.
relating_to_full: Relating to rural residential lands; amending ORS 215.501.
at_the_request_of: null
lc_number: 1667
measure_created_date: '2025-01-22T10:20:50'
measure_modified_date: '2025-02-10T09:49:29'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 4234
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 940>.

# SB 940 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 940, 2025 Regular Session (2025R1)
- **LC number:** 1667
- **Created:** 2025-01-22T10:20:50
- **Metadata last modified (upstream):** 2025-02-10T09:49:29
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4234 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB940/Introduced>.

## Summary

**Catchline:** Allows development of certain accessory dwelling units, recreational vehicles or emergency shelters on farmland on which is sited certain nonfarm dwellings.
...
**RelatingToFull (verbatim upstream field):** Relating to rural residential lands; amending ORS 215.501.
...
- From bill text (Introduced version): ORS 197.015, ORS 197A.230, ORS 215.213, ORS 215.501

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `930380e090f3935ff08f2e9dbb494c8bbf6c62ae846f80b612cd66d5004e6e0e` (snapshot `_meta/snapshots/measure-2025r1-sb940-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB940/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 940> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

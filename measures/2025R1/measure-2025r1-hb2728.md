...
jurisdiction: oregon
id: measure-2025r1-hb2728
title: 'HB 2728 (2025R1): Directs the Public Employees Retirement System to include information about
  the use of overtime hours in calculating the final average salary of a member of the system who is retiring.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2728
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2728/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 63a9c43f569b4cf085e7eb3da8f3862e70694c10f8f1a16a11f234ca90d64e23
snapshot_id: measure-2025r1-hb2728-enrolled
status: current
...
catch_line: Directs the Public Employees Retirement System to include information about the use of overtime
  hours in calculating the final average salary of a member of the system who is retiring.
minority_catch_line: null
measure_summary: "\tDigest: The Act tells PERS to put data about overtime in the letter sent to a retiring\
  \ member of PERS. (Flesch Readability Score: 63.8). \n\tDirects the Public Employees Retirement System\
  \ to include information about the use of overtime hours in calculating the final average salary of\
  \ a member of the system who is retiring. \n\tTakes effect on the 91st day following adjournment sine\
  \ die."
relating_to: Relating to member data under the Public Employees Retirement System; and prescribing an
  effective date.
relating_to_full: Relating to member data under the Public Employees Retirement System; and prescribing
  an effective date.
...
# HB 2728 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2728, 2025 Regular Session (2025R1)
- **LC number:** 1147
...
- **Full text below:** Enrolled version, 6007 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2728/Enrolled>.

## Summary

**Catchline:** Directs the Public Employees Retirement System to include information about the use of overtime hours in calculating the final average salary of a member of the system who is retiring.
...
**RelatingToFull (verbatim upstream field):** Relating to member data under the Public Employees Retirement System; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 183.484, ORS 238.156, ORS 238.450

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `63a9c43f569b4cf085e7eb3da8f3862e70694c10f8f1a16a11f234ca90d64e23` (snapshot `_meta/snapshots/measure-2025r1-hb2728-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2728/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `0b64af22b6ed831fa9d7c6d3a8203dcd2193e547ea33cc6322dcfc2093ff7205` (snapshot `_meta/snapshots/measure-2025r1-hb2728-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2728/Introduced>.

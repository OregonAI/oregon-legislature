...
jurisdiction: oregon
id: measure-2025r1-hb2434
title: 'HB 2434 (2025R1): Requires the Oregon Department of Administrative Services to conduct a study
  on voter registration in this state.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2434
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2434/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 1cba96790a7a8b01e0229b6cf0925052e8767ca0e5e5304cae2dde0500039543
snapshot_id: measure-2025r1-hb2434-introduced
status: current
...
catch_line: Requires the Oregon Department of Administrative Services to conduct a study on voter registration
  in this state.
minority_catch_line: null
measure_summary: "\tDigest: Tells DAS to study voter registration in this state. (Flesch Readability Score:\
  \ 66.1). \n\tRequires the Oregon Department of Administrative Services to conduct a study on voter registration\
  \ in this state. Directs the department to submit findings to the interim committees of the Legislative\
  \ Assembly related to elections not later than September 15, 2026. \n\tSunsets on January 2, 2027."
relating_to: Relating to voter registration.
relating_to_full: Relating to voter registration.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2434>.

# HB 2434 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2434, 2025 Regular Session (2025R1)
- **LC number:** 1198
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-23T09:50:16
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 4114 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2434/Introduced>.

## Summary

**Catchline:** Requires the Oregon Department of Administrative Services to conduct a study on voter registration in this state.
...
**RelatingToFull (verbatim upstream field):** Relating to voter registration.
...
LC 1198
the Secretary of State, the Department of Transportation and the Oregon Health  Authority,
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `1cba96790a7a8b01e0229b6cf0925052e8767ca0e5e5304cae2dde0500039543` (snapshot `_meta/snapshots/measure-2025r1-hb2434-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2434/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2434> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-sb5525
title: 'SB 5525 (2025R1): Appropriates moneys from the General Fund to the Higher Education Coordinating
  Commission for certain biennial expenses.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 5525
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB5525/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: ebe102da5ad9295437b8000cb7c91b4106c5799ac1fa51ecf431022ec319e266
snapshot_id: measure-2025r1-sb5525-enrolled
status: current
...
measure_summary: "\tDigest: The Act creates an agency budget. (Flesch Readability Score: 73.8). \n\tAppropriates\
  \ moneys from the General Fund to the Higher Education Coordinating Commission for certain biennial\
  ...
  \ but excluding lottery funds and federal funds, collected or received by the commission for certain\
  \ purposes. \n\tLimits biennial expenditures by the commission from federal funds for certain purposes.\
  \ \n\tLimits biennial expenditures by the commission from timber tax funds for the Community College\
...
# SB 5525 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 5525, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 10014 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB5525/Enrolled>.

## Summary

**Catchline:** Appropriates moneys from the General Fund to the Higher Education Coordinating Commission for certain biennial expenses.
...
and student support
for distribution to
public universities.................  $ 1,068,825,130
...
- From bill text (Enrolled version): ORS 660.380, ORS 660.385, ORS 660.400, ORS 660.405

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `ebe102da5ad9295437b8000cb7c91b4106c5799ac1fa51ecf431022ec319e266` (snapshot `_meta/snapshots/measure-2025r1-sb5525-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB5525/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `70f603be050d38009913df4955a45e1478aaa762fe7a74c0a2309c51a9223522` (snapshot `_meta/snapshots/measure-2025r1-sb5525-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB5525/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 5525` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

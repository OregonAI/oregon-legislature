...
jurisdiction: oregon
id: measure-2025r1-hcr33
title: 'HCR 33 (2025R1): In memoriam: Frank David Cutsforth, 1943-2023.'
doc_type: dataset_doc
citation: 2025 Regular Session House Concurrent Resolution 33
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR33/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4c116261cf7ba1abd51272b7412e0e08bf3e696f31fa6e524f7e3efec80d5b0b
snapshot_id: measure-2025r1-hcr33-enrolled
status: current
...
catch_line: 'In memoriam: Frank David Cutsforth, 1943-2023.'
minority_catch_line: null
measure_summary: "\tDigest: Honors the life and memory of Frank Cutsforth. (Flesch Readability Score:\
  \ 71.8). \n\tIn memoriam: Frank David Cutsforth, 1943-2023."
relating_to: 'In memoriam: Frank Cutsforth.'
relating_to_full: null
at_the_request_of: null
lc_number: 4711
measure_created_date: '2025-03-18T10:50:08'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 33`.

# HCR 33 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Concurrent Resolution 33, 2025 Regular Session (2025R1)
- **LC number:** 4711
- **Created:** 2025-03-18T10:50:08
- **Metadata last modified (upstream):** 2025-05-14T11:20:23
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 3750 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR33/Enrolled>.

## Summary

**Catchline:** In memoriam: Frank David Cutsforth, 1943-2023.
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `4c116261cf7ba1abd51272b7412e0e08bf3e696f31fa6e524f7e3efec80d5b0b` (snapshot `_meta/snapshots/measure-2025r1-hcr33-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR33/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `e01ffc59693aa1c6496e384d4c97d9ae5f14e1476d3e0d95e9d5e6323f487f13` (snapshot `_meta/snapshots/measure-2025r1-hcr33-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HCR33/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HCR' and MeasureNumber eq 33` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2750
title: 'HB 2750 (2025R1): Establishes the Task Force on Improving Safety in Health Care Settings and directs
  the task force to report to an interim committee of the Legislative Assembly related to health care
  no later than December 15, 2026.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2750
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2750/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 6aa5b930cae466a5a01c6cb3dcf82f3ffd3b08b5826961514aa9fc6a3a09fe26
snapshot_id: measure-2025r1-hb2750-introduced
status: current
...
catch_line: Establishes the Task Force on Improving Safety in Health Care Settings and directs the task
...
measure_summary: "\tDigest: The Act makes a task force on improving safety in health care settings. Tells\
  \ the task force to make a report. (Flesch Readability Score: 87.4). \n\tEstablishes the Task Force\
  \ on Improving Safety in Health Care Settings and directs the task force to report to an interim committee\
  \ of the Legislative Assembly related to health care no later than December 15, 2026."
relating_to: Relating to the Task Force on Improving Safety in Health Care Settings.
relating_to_full: Relating to the Task Force on Improving Safety in Health Care Settings.
...
# HB 2750 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2750, 2025 Regular Session (2025R1)
- **LC number:** 3360
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-27T10:34:00
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 5018 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2750/Introduced>.

## Summary

**Catchline:** Establishes the Task Force on Improving Safety in Health Care Settings and directs the task force to report to an interim committee of the Legislative Assembly related to health care no later than December 15, 2026.
...
**RelatingToFull (verbatim upstream field):** Relating to the Task Force on Improving Safety in Health Care Settings.
...
LC 3360
(H) A representative of a state police office, a municipal  police department or sheriff’s
office.
...
- From bill text (Introduced version): ORS 174.111, ORS 192.245, ORS 441.760, ORS 442.015, ORS 443.014, ORS 663.005

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `6aa5b930cae466a5a01c6cb3dcf82f3ffd3b08b5826961514aa9fc6a3a09fe26` (snapshot `_meta/snapshots/measure-2025r1-hb2750-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2750/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2750` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

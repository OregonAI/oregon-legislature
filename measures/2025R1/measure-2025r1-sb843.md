...
jurisdiction: oregon
id: measure-2025r1-sb843
title: 'SB 843 (2025R1): Removes the requirement that the Public Utility Commission provide a biennial
  report to the Legislative Assembly on the volumetric incentive rates pilot program.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 843
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB843/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 6250b2f4ada57548ad7678645848f6656c47b23feb2074af6619214e620ffdb1
snapshot_id: measure-2025r1-sb843-enrolled
status: current
...
catch_line: Removes the requirement that the Public Utility Commission provide a biennial report to the
  Legislative Assembly on the volumetric incentive rates pilot program.
minority_catch_line: null
measure_summary: "\tDigest: Removes the requirement that the PUC report on the VIR pilot program. (Flesch\
  \ Readability Score: 60.7). \n\tRemoves the requirement that the Public Utility Commission provide a\
  \ biennial report to the Legislative Assembly on the volumetric incentive rates pilot program."
relating_to: Relating to reports by the Public Utility Commission.
relating_to_full: Relating to reports by the Public Utility Commission.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 843`.

# SB 843 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 843, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 6395 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB843/Enrolled>.

## Summary

**Catchline:** Removes the requirement that the Public Utility Commission provide a biennial report to the Legislative Assembly on the volumetric incentive rates pilot program.

**Relating to:** Relating to reports by the Public Utility Commission.

Digest: Removes the requirement that the PUC report on the VIR pilot program. (Flesch Readability Score: 60.7). 
...
**RelatingToFull (verbatim upstream field):** Relating to reports by the Public Utility Commission.
...
- From bill text (Enrolled version): ORS 469A.052, ORS 469A.130, ORS 469B.100, ORS 757.365, ORS 757.612

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `6250b2f4ada57548ad7678645848f6656c47b23feb2074af6619214e620ffdb1` (snapshot `_meta/snapshots/measure-2025r1-sb843-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB843/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `f15be6243fa17679e08e4535b979af86bdd514974242681418b2542290bab09f` (snapshot `_meta/snapshots/measure-2025r1-sb843-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB843/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 843` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

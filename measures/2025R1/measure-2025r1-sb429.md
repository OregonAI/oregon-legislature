...
jurisdiction: oregon
id: measure-2025r1-sb429
title: 'SB 429 (2025R1): Prohibits a gun dealer from transferring a firearm or unfinished frame or receiver
  until 72 hours have elapsed from the time the gun dealer requested a criminal background check, and
  the gun dealer has received the background check approval number from the Department of State Police.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 429
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB429/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: dbd42dfce92c5edeed4a683a5fc34ff92061461a5d2f008f2ef18a88ca9bfb2d
snapshot_id: measure-2025r1-sb429-introduced
status: current
...
catch_line: Prohibits a gun dealer from transferring a firearm or unfinished frame or receiver until 72
  hours have elapsed from the time the gun dealer requested a criminal background check, and the gun dealer
  has received the background check approval number from the Department of State Police.
minority_catch_line: null
measure_summary: "\tDigest: The Act requires gun dealers to wait 72 hours from the time of asking for\
  \ a background check, and to have the approval number from the check, before giving a firearm or certain\
  \ unfinished firearm parts to a buyer. The Act takes effect on the 91st day after sine die. (Flesch\
  \ Readability Score: 64.7). \n\tProhibits a gun dealer from transferring a firearm or unfinished frame\
  \ or receiver until 72 hours have elapsed from the time the gun dealer requested a criminal background\
  \ check, and the gun dealer has received the background check approval number from the Department of\
  \ State Police. Provides that a gun dealer who has the approval number and allows the required time\
  \ period to elapse before transfer has immunity from civil liability for use of the transferred firearm\
  \ or unfinished frame or receiver by the purchaser. \n\tTakes effect on the 91st day following sine\
  \ die."
relating_to: Relating to firearms; prescribing an effective date.
relating_to_full: Relating to firearms; amending ORS 166.412; and prescribing an effective date.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 429`.

# SB 429 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 429, 2025 Regular Session (2025R1)
- **LC number:** 2030
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-24T09:12:39
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 14867 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB429/Introduced>.

## Summary

**Catchline:** Prohibits a gun dealer from transferring a firearm or unfinished frame or receiver until 72 hours have elapsed from the time the gun dealer requested a criminal background check, and the gun dealer has received the background check approval number from the Department of State Police.
...
**RelatingToFull (verbatim upstream field):** Relating to firearms; amending ORS 166.412; and prescribing an effective date.
...
[or transferee ] who does not have a valid [ permit-to-purchase] permit to  purchase a firearm in vio-
...
- From `RelatingToFull`: ORS 166.412
- From bill text (Introduced version): ORS 166.210, ORS 166.250, ORS 166.255, ORS 166.412, ORS 166.435, ORS 166.470, ORS 166.505

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `dbd42dfce92c5edeed4a683a5fc34ff92061461a5d2f008f2ef18a88ca9bfb2d` (snapshot `_meta/snapshots/measure-2025r1-sb429-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB429/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 429` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

...
jurisdiction: oregon
id: measure-2025r1-hb2351
title: 'HB 2351 (2025R1): Makes changes to certain statutes related to the release and reporting of businesses''
  economic development information.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2351
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2351/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a649da386e76d7d386a576fbbe9a92ab6879b469fedcce0f4d07ce1e2382743f
snapshot_id: measure-2025r1-hb2351-enrolled
status: current
...
catch_line: Makes changes to certain statutes related to the release and reporting of businesses' economic
  development information.
minority_catch_line: null
measure_summary: "\tDigest: The Act would make some changes to how a business reports data from certain\
  \ state benefit programs. (Flesch Readability Score: 60.1). \n\tMakes changes to certain statutes related\
  \ to the release and reporting of businesses' economic development information. \n\tTakes effect on\
  \ the 91st day following adjournment sine die."
relating_to: Relating to the economic development information of businesses; and prescribing an effective
  date.
relating_to_full: Relating to the economic development information of businesses; and prescribing an effective
  date.
...
# HB 2351 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2351, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 66197 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2351/Enrolled>.

## Summary

**Catchline:** Makes changes to certain statutes related to the release and reporting of businesses' economic development information.
...
**RelatingToFull (verbatim upstream field):** Relating to the economic development information of businesses; and prescribing an effective date.
...
- From bill text (Enrolled version): ORS 137.077, ORS 151.485, ORS 173.800, ORS 174.109, ORS 174.112, ORS 174.114, ORS 174.116, ORS 174.117, ORS 192.311, ORS 192.355, ORS 192.360, ORS 192.363, ORS 192.368, ORS 225.085, ORS 243.650, ORS 244.040, ORS 25.020, ORS 25.080, ORS 254.074, ORS 261.348, ORS 285A.176, ORS 285A.224, ORS 285B.627, ORS 285C.050, ORS 285C.105, ORS 285C.110, ORS 285C.125, ORS 285C.130, ORS 285C.140, ORS 285C.145, ORS 285C.150, ORS 285C.155, ORS 285C.160, ORS 285C.165, ORS 285C.170, ORS 285C.175, ORS 285C.180, ORS 285C.185, ORS 285C.190, ORS 285C.220, ORS 285C.225, ORS 285C.230, ORS 285C.235, ORS 285C.240, ORS 285C.403, ORS 285C.409, ORS 285C.412, ORS 285C.415, ORS 285C.420, ORS 285C.600, ORS 285C.609, ORS 285C.615, ORS 285C.635, ORS 293.761, ORS 293.766, ORS 297.405, ORS 306.126, ORS 307.123, ORS 307.162, ORS 308.149, ORS 308.250, ORS 308.290, ORS 308.295, ORS 308.296, ORS 308.297, ORS 308.525, ORS 308.810, ORS 308.875, ORS 317.131, ORS 342.815, ORS 40.225, ORS 408.225, ORS 408.425, ORS 414.312, ORS 431A.860, ORS 431A.865, ORS 453.005, ORS 469.530, ORS 469B.256, ORS 656.005, ORS 777.005, ORS 86A.095, ORS 98.302, ORS 98.352, ORS 98.392, ORS 98.412

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `a649da386e76d7d386a576fbbe9a92ab6879b469fedcce0f4d07ce1e2382743f` (snapshot `_meta/snapshots/measure-2025r1-hb2351-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2351/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `a3d232d2bc0f8f869f52364396c88d55f3c59315a6e86fa3a5d956678dd1507a` (snapshot `_meta/snapshots/measure-2025r1-hb2351-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2351/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2351` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

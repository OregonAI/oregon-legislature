...
jurisdiction: oregon
id: measure-2025r1-hb3808
title: 'HB 3808 (2025R1): Requires the Teacher Standards and Practices Commission to adopt rules related
  to the certification of deafblind interveners.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 3808
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3808/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 052cb7d0d38256ecf30f24f31c248cf1e6990a5f5bbbbc8f390f7e816ef334b4
snapshot_id: measure-2025r1-hb3808-introduced
status: current
...
catch_line: Requires the Teacher Standards and Practices Commission to adopt rules related to the certification
  of deafblind interveners.
minority_catch_line: null
measure_summary: "\tDigest: Tells TSPC to make standards for people who help deafblind students and gives\
  \ ODE money to send to ESDs and school districts to hire and keep those people. (Flesch Readability\
  \ Score: 69.6). \n\tRequires the Teacher Standards and Practices Commission to adopt rules related to\
  \ the certification of deafblind interveners. \n\tDirects the Department of Education to establish a\
  \ program to increase the number of certified deafblind interveners who are employed in the education\
  \ service districts and school districts of this state."
relating_to: Relating to interveners for deafblind students.
relating_to_full: Relating to interveners for deafblind students; creating new provisions; and amending
  ORS 329.007, 342.120 and 342.223.
at_the_request_of: null
lc_number: 4559
measure_created_date: '2025-02-25T14:53:12'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3808`.

# HB 3808 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 3808, 2025 Regular Session (2025R1)
- **LC number:** 4559
- **Created:** 2025-02-25T14:53:12
- **Metadata last modified (upstream):** 2025-03-05T10:28:46
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 19274 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3808/Introduced>.

## Summary

**Catchline:** Requires the Teacher Standards and Practices Commission to adopt rules related to the certification of deafblind interveners.
...
**RelatingToFull (verbatim upstream field):** Relating to interveners for deafblind students; creating new provisions; and amending ORS 329.007, 342.120 and 342.223.
...
LC 4559
has submitted to a criminal records check by the commission.
...
- From `RelatingToFull`: ORS 329.007, ORS 342.120, ORS 342.223
- From bill text (Introduced version): ORS 181A.195, ORS 183.413, ORS 329.007, ORS 329.045, ORS 329.157, ORS 329.494, ORS 329.704, ORS 332.002, ORS 336.505, ORS 338.005, ORS 342.120, ORS 342.125, ORS 342.143, ORS 342.147, ORS 342.175, ORS 342.223, ORS 342.455, ORS 342.475, ORS 342.805, ORS 343.035, ORS 343.146, ORS 343.221, ORS 417.725

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `052cb7d0d38256ecf30f24f31c248cf1e6990a5f5bbbbc8f390f7e816ef334b4` (snapshot `_meta/snapshots/measure-2025r1-hb3808-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB3808/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3808` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

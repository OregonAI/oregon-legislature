...
jurisdiction: oregon
id: measure-2025r1-hb2915
title: 'HB 2915 (2025R1): Allows disclosure without authorization of written accounts containing individually
  identifiable health information to the Psychiatric Security Review Board for an individual who is under
  the jurisdiction of the board and conditionally released to the Department of Corrections.'
doc_type: dataset_doc
citation: 2025 Regular Session House Bill 2915
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2915/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a51020ee2eb7b10366fab238c44a2b7298db19019c2856ac79e866e04af7d46c
snapshot_id: measure-2025r1-hb2915-enrolled
status: current
...
catch_line: Allows disclosure without authorization of written accounts containing individually identifiable
  health information to the Psychiatric Security Review Board for an individual who is under the jurisdiction
  of the board and conditionally released to the Department of Corrections.
minority_catch_line: null
measure_summary: "\tDigest: The Act lets some health records be sent to PSRB without the person's permission\
  \ when a person is released to DOC. (Flesch Readability Score: 68.6). \n\tAllows disclosure without\
  \ authorization of written accounts containing individually identifiable health information to the Psychiatric\
  \ Security Review Board for an individual who is under the jurisdiction of the board and conditionally\
  \ released to the Department of Corrections."
relating_to: Relating to disclosures of written accounts to the Psychiatric Security Review Board.
relating_to_full: Relating to disclosures of written accounts to the Psychiatric Security Review Board.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2915`.

# HB 2915 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** House Bill 2915, 2025 Regular Session (2025R1)
...
- **Full text below:** Enrolled version, 17155 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2915/Enrolled>.

## Summary

**Catchline:** Allows disclosure without authorization of written accounts containing individually identifiable health information to the Psychiatric Security Review Board for an individual who is under the jurisdiction of the board and conditionally released to the Department of Corrections.
...
**RelatingToFull (verbatim upstream field):** Relating to disclosures of written accounts to the Psychiatric Security Review Board.
...
- From bill text (Enrolled version): ORS 124.088, ORS 125.305, ORS 127.505, ORS 127.700, ORS 146.750, ORS 146.760, ORS 161.336, ORS 179.505, ORS 192.515, ORS 192.517, ORS 192.567, ORS 30.260, ORS 34.105, ORS 40.010, ORS 414.025, ORS 419B.010, ORS 419B.015, ORS 419B.020, ORS 419B.025, ORS 419B.030, ORS 419B.035, ORS 419B.040, ORS 419B.045, ORS 419B.372, ORS 419C.481, ORS 421.005, ORS 430.610, ORS 430.620, ORS 430.630, ORS 430.738, ORS 431.001, ORS 676.190

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `a51020ee2eb7b10366fab238c44a2b7298db19019c2856ac79e866e04af7d46c` (snapshot `_meta/snapshots/measure-2025r1-hb2915-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2915/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `e14bff78b5fbe4e0b237ac5172b0bc31c42797873da5f76a11f50cc8507f7307` (snapshot `_meta/snapshots/measure-2025r1-hb2915-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/HB2915/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2915` (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

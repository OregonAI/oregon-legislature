...
jurisdiction: oregon
id: measure-2025r1-sb329
title: 'SB 329 (2025R1): Requires a distributor cooperative to implement a managed system for reusable
  beverage containers that achieves certain sales and return rates.'
doc_type: dataset_doc
citation: 2025 Regular Session Senate Bill 329
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB329/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 1023441fd1d25e13e9c00b08cf3a7c17c3264286097720d5ac04ea535db789a0
snapshot_id: measure-2025r1-sb329-introduced
status: current
...
catch_line: Requires a distributor cooperative to implement a managed system for reusable beverage containers
  that achieves certain sales and return rates.
minority_catch_line: null
measure_summary: "\tDigest: This Act tells a cooperative and retail stores to expand the use of reusable\
  \ cans or bottles. (Flesch Readability Score: 65.1). \n\tRequires a distributor cooperative to implement\
  \ a managed system for reusable beverage containers that achieves certain sales and return rates. \n\
  \tRequires certain beverage container dealers to provide shelf space for reusable beverage containers."
relating_to: Relating to reusable beverage containers.
relating_to_full: Relating to reusable beverage containers; creating new provisions; and amending ORS
  459A.718.
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 329>.

# SB 329 — 2025 Regular Session (2025R1)

## At a glance

- **Measure:** Senate Bill 329, 2025 Regular Session (2025R1)
- **LC number:** 3309
- **Created:** 2024-12-31T13:18:07
- **Metadata last modified (upstream):** 2025-01-23T09:28:36
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 10739 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB329/Introduced>.

## Summary

**Catchline:** Requires a distributor cooperative to implement a managed system for reusable beverage containers that achieves certain sales and return rates.
...
**RelatingToFull (verbatim upstream field):** Relating to reusable beverage containers; creating new provisions; and amending ORS 459A.718.
...
- From `RelatingToFull`: ORS 459A.718
- From bill text (Introduced version): ORS 192.245, ORS 459A.700, ORS 459A.705, ORS 459A.717, ORS 459A.718

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `1023441fd1d25e13e9c00b08cf3a7c17c3264286097720d5ac04ea535db789a0` (snapshot `_meta/snapshots/measure-2025r1-sb329-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2025R1/Downloads/MeasureDocument/SB329/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 from <https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2025R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 329> (part of the batched per-session fetch), sha256 `e40a05360b33eebe9b5b19ce4acefebfc6814eb72b66f93552f417d3cedeb802` of the shared session snapshot `_meta/snapshots/measures-2025r1.json`.

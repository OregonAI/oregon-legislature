...
jurisdiction: oregon
id: measure-2017r1-hb2724
title: 'HB 2724 (2017R1): Directs Housing and Community Services Department to develop and implement Rent
  Guarantee Program to provide incentives and financial assistance to landlords that rent or lease to
  low income households by guaranteeing payments to landlords for unpaid rent and for eviction and property
  damage costs within certain limits.'
doc_type: dataset_doc
citation: 2017 Regular Session House Bill 2724
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2017R1/Downloads/MeasureDocument/HB2724/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 20ba46e58609bb8a7b6b71c6dc27b1d44be65c25798243b3c080a6b7a0586e4d
snapshot_id: measure-2017r1-hb2724-enrolled
status: current
...
catch_line: Directs Housing and Community Services Department to develop and implement Rent Guarantee
  Program to provide incentives and financial assistance to landlords that rent or lease to low income
  households by guaranteeing payments to landlords for unpaid rent and for eviction and property damage
  costs within certain limits.
minority_catch_line: null
measure_summary: "\tDirects Housing and Community Services Department to develop and implement Rent Guarantee\
  \ Program to provide incentives and financial assistance to landlords that rent or lease to low income\
  \ households by guaranteeing payments to landlords for unpaid rent and for eviction and property damage\
  \ costs within certain limits. \n\tAuthorizes department to request proposals from and contract with\
  \ program providers to administer program. Requires collection of performance outcome measures and annual\
  \ report to interim committees of Legislative Assembly on housing. \n\tEstablishes Rent Guarantee Program\
  \ Fund and continuously appropriates moneys to department for Rent Guarantee Program."
relating_to: Relating to the Rent Guarantee Program.
relating_to_full: Relating to the Rent Guarantee Program.
...
# HB 2724 — 2017 Regular Session (2017R1)

## At a glance

- **Measure:** House Bill 2724, 2017 Regular Session (2017R1)
- **LC number:** 1912
...
**RelatingToFull (verbatim upstream field):** Relating to the Rent Guarantee Program.
...
Enrolled
House Bill 2724
Sponsored by Representative  KENY-GUYER, Senator DEMBROW, Representative HEARD; Repre-
...
SECTION 1.
As used in this section and section 2 of this 2017 Act:
...
SECTION 3.
(1) The Rent Guarantee Program Fund is established within the State
...
- From bill text (Enrolled version): ORS 456.375

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `20ba46e58609bb8a7b6b71c6dc27b1d44be65c25798243b3c080a6b7a0586e4d` (snapshot `_meta/snapshots/measure-2017r1-hb2724-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2017R1/Downloads/MeasureDocument/HB2724/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `3f374fe927d515b3b3e69bee1498db6d48b16a00caab050ffce39d9343d04bb3` (snapshot `_meta/snapshots/measure-2017r1-hb2724-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2017R1/Downloads/MeasureDocument/HB2724/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2017R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2724` (part of the batched per-session fetch), sha256 `8a531c771f7c0531d1b6a422bf18d037d210e0e6cb92f247a009fd99e6400c68` of the shared session snapshot `_meta/snapshots/measures-2017r1.json`.

...
jurisdiction: oregon
id: measure-2021r1-hb3004
title: 'HB 3004 (2021R1): Provides additional weight for students who are homeless for purposes of calculating
  distributions of State School Fund moneys to school districts.'
doc_type: dataset_doc
citation: 2021 Regular Session House Bill 3004
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2021R1/Downloads/MeasureDocument/HB3004/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 026768cdd5678535a959a4182663af340e847bb3c7bf27c404c14ae72a385e30
snapshot_id: measure-2021r1-hb3004-introduced
status: current
...
catch_line: Provides additional weight for students who are homeless for purposes of calculating distributions
  of State School Fund moneys to school districts.
minority_catch_line: null
measure_summary: "\tProvides additional weight for students who are homeless for purposes of calculating\
  \ distributions of State School Fund moneys to school districts. \n\tDeclares emergency, effective July\
  \ 1, 2021."
relating_to: Relating to additional weights for calculations made to distribute State School Fund moneys;
  declaring an emergency.
relating_to_full: Relating to additional weights for calculations made to distribute State School Fund
  moneys; creating new provisions; amending ORS 327.013; and declaring an emergency.
at_the_request_of: null
lc_number: 2761
measure_created_date: '2021-01-12T08:53:04'
measure_modified_date: '2021-02-16T13:17:13'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 7408
...
# HB 3004 — 2021 Regular Session (2021R1)

## At a glance

- **Measure:** House Bill 3004, 2021 Regular Session (2021R1)
- **LC number:** 2761
- **Created:** 2021-01-12T08:53:04
- **Metadata last modified (upstream):** 2021-02-16T13:17:13
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7408 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2021R1/Downloads/MeasureDocument/HB3004/Introduced>.

## Summary

**Catchline:** Provides additional weight for students who are homeless for purposes of calculating distributions of State School Fund moneys to school districts.

**Relating to:** Relating to additional weights for calculations made to distribute State School Fund moneys; declaring an emergency.
...
**RelatingToFull (verbatim upstream field):** Relating to additional weights for calculations made to distribute State School Fund moneys; creating new provisions; amending ORS 327.013; and declaring an emergency.
...
Declares emergency, effective July 1, 2021.
A BILL FOR AN ACT
Relating to additional  weights for calculations made to distribute State School Fund moneys; creat-
ing new provisions; amending ORS 327.013; and declaring an emergency.
...
SECTION 2.
The amendments to ORS 327.013 by section 1 of this 2021 Act  apply to State
School Fund distributions commencing with the 2021-2022 distributions.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `026768cdd5678535a959a4182663af340e847bb3c7bf27c404c14ae72a385e30` (snapshot `_meta/snapshots/measure-2021r1-hb3004-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2021R1/Downloads/MeasureDocument/HB3004/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2021R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3004` (part of the batched per-session fetch), sha256 `5da569ca758abb18ddc62b98b159745491357dbe8bf5488fc371a795d58c4c1e` of the shared session snapshot `_meta/snapshots/measures-2021r1.json`.

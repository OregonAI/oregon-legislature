...
jurisdiction: oregon
id: measure-2021r1-sb48
title: 'SB 48 (2021R1): Directs presiding judge in each judicial district to enter standing pretrial release
  orders.'
doc_type: dataset_doc
citation: 2021 Regular Session Senate Bill 48
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2021R1/Downloads/MeasureDocument/SB48/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 08455f45f9c1ae1572ba4d10d51a3ef6c368c21d80b079b2c2d93fee25b31c38
snapshot_id: measure-2021r1-sb48-enrolled
status: current
...
catch_line: Directs presiding judge in each judicial district to enter standing pretrial release orders.
minority_catch_line: null
measure_summary: "\tDirects presiding judge in each judicial district to enter standing pretrial release\
  \ orders. Directs Chief Justice of Supreme Court to establish guidelines for order. \n\tDirects release\
  \ assistance officers to make reasonable efforts to contact victim concerning release when defendant\
  \ is charged with certain offenses. \n\tRequires magistrate to make release decision at arraignment\
  \ or first appearance except in specified circumstances. Directs district attorney to make reasonable\
  \ efforts to inform victim of time and place of appearance. Requires magistrate to find that release\
  \ on personal recognizance is unwarranted before considering conditional release, and requires magistrate\
  \ to find that conditional release is unwarranted before considering security release. \n\tRepeals minimum\
  \ bail amounts for persons charged with Ballot Measure 11 (1994) crimes and certain methamphetamine\
  \ offenses. \n\tAuthorizes court to receive copy of booking photo as part of pretrial release process.\
  \ \n\t<b>Appropriates moneys to Judicial Department for purpose of implementing Act.</b>"
relating_to: Relating to pretrial release.
relating_to_full: Relating to pretrial release.
...
measure_modified_date: '2021-11-18T12:38:27'
...
# SB 48 — 2021 Regular Session (2021R1)

## At a glance

- **Measure:** Senate Bill 48, 2021 Regular Session (2021R1)
...
- **Metadata last modified (upstream):** 2021-11-18T12:38:27
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 19428 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2021R1/Downloads/MeasureDocument/SB48/Enrolled>.

## Summary

**Catchline:** Directs presiding judge in each judicial district to enter standing pretrial release orders.
...
Directs presiding judge in each judicial district to enter standing pretrial release orders. Directs Chief Justice of Supreme Court to establish guidelines for order. 
 Directs release assistance officers to make reasonable efforts to contact victim concerning release when defendant is charged with certain offenses. 
 Requires magistrate to make release decision at arraignment or first appearance except in specified circumstances. Directs district attorney to make reasonable efforts to inform victim of time and place of appearance. Requires magistrate to find that release on personal recognizance is unwarranted before considering conditional release, and requires magistrate to find that conditional release is unwarranted before considering security release. 
 Repeals minimum bail amounts for persons charged with Ballot Measure 11 (1994) crimes and certain methamphetamine offenses. 
 Authorizes court to receive copy of booking photo as part of pretrial release process. 
 <b>Appropriates moneys to Judicial Department for purpose of implementing Act.</b>

**RelatingToFull (verbatim upstream field):** Relating to pretrial release.
...
decision under subsection (3) of this section.  If the release assistance officer is able to con-
tact the victim:
...
Enrolled Senate Bill 48 (SB 48-C) Page 2
...
Enrolled Senate Bill 48 (SB 48-C) Page 3
required by ORS 135.230 to 135.290, may the  magistrate proceed to consider security release
under ORS 135.265.
...
SECTION 6.
 ORS 135.247 is amended to read:
...
SECTION 7.
ORS 135.242 is repealed.
Enrolled Senate Bill 48 (SB 48-C) Page 4
SECTION 8.  If House Bill 3273 becomes law, section 1, chapter , Oregon Laws 2021
...
ment agency.
SECTION 9.
(1) Section 2 of this 2021 Act, the amendments to ORS 135.235, 135.240,
...
Enrolled Senate Bill 48 (SB 48-C) Page 5
...
Enrolled Senate Bill 48 (SB 48-C) Page 6
...
- From bill text (Enrolled version): ORS 131.915, ORS 135.060, ORS 135.065, ORS 135.230, ORS 135.235, ORS 135.240, ORS 135.242, ORS 135.245, ORS 135.247, ORS 135.260, ORS 135.265, ORS 135.270, ORS 135.970, ORS 137.700, ORS 147.417, ORS 163A.005, ORS 192.311, ORS 40.015

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `08455f45f9c1ae1572ba4d10d51a3ef6c368c21d80b079b2c2d93fee25b31c38` (snapshot `_meta/snapshots/measure-2021r1-sb48-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2021R1/Downloads/MeasureDocument/SB48/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `16355e0d2f286007b45c6ae0d3e5179c4034c34262c17c26a0f0c05f6d9beff3` (snapshot `_meta/snapshots/measure-2021r1-sb48-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2021R1/Downloads/MeasureDocument/SB48/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2021R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 48` (part of the batched per-session fetch), sha256 `5da569ca758abb18ddc62b98b159745491357dbe8bf5488fc371a795d58c4c1e` of the shared session snapshot `_meta/snapshots/measures-2021r1.json`.

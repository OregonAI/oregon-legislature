...
jurisdiction: oregon
id: measure-2021r1-hb2711
title: 'HB 2711 (2021R1): Directs Department of Education to establish voucher program for students of
  this state.'
doc_type: dataset_doc
citation: 2021 Regular Session House Bill 2711
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2021R1/Downloads/MeasureDocument/HB2711/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 9d2f5f0b307cce93a8a78d7ea5e926b482eaf29c279f8167b51cf53b07c009d2
snapshot_id: measure-2021r1-hb2711-introduced
status: current
...
catch_line: Directs Department of Education to establish voucher program for students of this state.
minority_catch_line: null
measure_summary: "\tDirects Department of Education to establish voucher program for students of this\
...
relating_to: Relating to school vouchers; declaring an emergency.
relating_to_full: Relating to school vouchers; creating new provisions; amending ORS 327.008, 339.030
  and 339.505; and declaring an emergency.
at_the_request_of: null
lc_number: 2959
measure_created_date: '2020-12-27T18:35:44'
measure_modified_date: '2021-02-01T14:30:33'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 27204
...
# HB 2711 — 2021 Regular Session (2021R1)

## At a glance

- **Measure:** House Bill 2711, 2021 Regular Session (2021R1)
- **LC number:** 2959
- **Created:** 2020-12-27T18:35:44
- **Metadata last modified (upstream):** 2021-02-01T14:30:33
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 27204 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2021R1/Downloads/MeasureDocument/HB2711/Introduced>.

## Summary

**Catchline:** Directs Department of Education to establish voucher program for students of this state.

**Relating to:** Relating to school vouchers; declaring an emergency.
...
**RelatingToFull (verbatim upstream field):** Relating to school vouchers; creating new provisions; amending ORS 327.008, 339.030 and 339.505; and declaring an emergency.
...
Declares emergency, effective on passage.
A BILL FOR AN ACT
Relating to school vouchers;  creating new provisions; amending ORS 327.008, 339.030 and 339.505;
...
(3) “Qualified expenses” means the following expenses of an enrolled student:
...
(4) “Statewide average distribution” means an amount determined by the  Department of
...
attendance boundaries of a school of this state.
(c) In the case of a parent seeking reenrollment for a student,  the student must have
participated in the program during the previous school year.
...
meets the qualifications described in section 2 (2) of this 2021 Act.
SECTION 4.
...
(a) Moneys transferred as provided by section 2 (5)(c)(C) of this 2021 Act;
...
(a) Moneys transferred as provided by section 2 (5)(c)(D) of this 2021 Act;
(b) Moneys appropriated to the account by the Legislative Assembly; and
(c) Any other moneys from state or federal sources.
SECTION 6.
...
for the purpose of making transfers under section 2 (5)(c) of this 2021 Act.
...
required by section 2 (5)(c) of this 2021 Act.
SECTION 11.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `9d2f5f0b307cce93a8a78d7ea5e926b482eaf29c279f8167b51cf53b07c009d2` (snapshot `_meta/snapshots/measure-2021r1-hb2711-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2021R1/Downloads/MeasureDocument/HB2711/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2021R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2711` (part of the batched per-session fetch), sha256 `5da569ca758abb18ddc62b98b159745491357dbe8bf5488fc371a795d58c4c1e` of the shared session snapshot `_meta/snapshots/measures-2021r1.json`.

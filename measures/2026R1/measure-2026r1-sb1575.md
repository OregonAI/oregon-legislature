...
jurisdiction: oregon
id: measure-2026r1-sb1575
title: 'SB 1575 (2026R1): Adds new requirements for obtaining an initial license to operate and maintain
  a hospice program.'
doc_type: dataset_doc
citation: 2026 Regular Session Senate Bill 1575
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1575/Enrolled
source_format: pdf
retrieved: '2026-07-28'
source_sha256: d71ec4c3f3d074ca4cf1303e0d8ec45f031f5d962cfdd10858177d6fc8da88f9
snapshot_id: measure-2026r1-sb1575-enrolled
status: current
...
catch_line: Adds new requirements for obtaining an initial license to operate and maintain a hospice program.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes changes to licensing laws for hospice programs. (Flesch Readability\
  \ Score: 69.7). \n\tAdds new requirements for obtaining an initial license to operate and maintain a\
  \ hospice program. [<i>Requires a hospice program to apply for a new initial license after a change\
  \ in ownership.</i>] Prohibits individuals who have been excluded from participation in Medicare or\
  \ Medicaid or have been found liable for fraud or abuse from holding an ownership interest in a hospice\
  \ program. \n\tRequires the Oregon Health Authority to complete rulemaking within 24 months. Subject\
  \ to exceptions, prohibits the authority from issuing new hospice licenses until rulemaking is complete.\
  \ \n\tDeclares an emergency, effective on passage."
relating_to: Relating to hospice licensure; and declaring an emergency.
relating_to_full: Relating to hospice licensure; and declaring an emergency.
...
# SB 1575 — 2026 Regular Session (2026R1)

## At a glance

- **Measure:** Senate Bill 1575, 2026 Regular Session (2026R1)
- **LC number:** 151
...
- **Full text below:** Enrolled version, 12380 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1575/Enrolled>.

## Summary

**Catchline:** Adds new requirements for obtaining an initial license to operate and maintain a hospice program.

**Relating to:** Relating to hospice licensure; and declaring an emergency.

Digest: The Act makes changes to licensing laws for hospice programs. (Flesch Readability Score: 69.7). 
 Adds new requirements for obtaining an initial license to operate and maintain a hospice program. [<i>Requires a hospice program to apply for a new initial license after a change in ownership.</i>] Prohibits individuals who have been excluded from participation in Medicare or Medicaid or have been found liable for fraud or abuse from holding an ownership interest in a hospice program. 
 Requires the Oregon Health Authority to complete rulemaking within 24 months. Subject to exceptions, prohibits the authority from issuing new hospice licenses until rulemaking is complete. 
 Declares an emergency, effective on passage.

**RelatingToFull (verbatim upstream field):** Relating to hospice licensure; and declaring an emergency.
...
SECTION 2.
Section 3 of  this 2026 Act is added to and made a part of ORS 443.850 to
443.869.
...
SECTION 4.
The Oregon Health Authority shall complete rulemaking required  under the
...
lation.
SECTION 6.
Section 5 of this 2026 Act is repealed on January 2, 2029.
...
- From bill text (Enrolled version): ORS 181A.195, ORS 442.015, ORS 443.400, ORS 443.850, ORS 443.860

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-28, sha256 `d71ec4c3f3d074ca4cf1303e0d8ec45f031f5d962cfdd10858177d6fc8da88f9` (snapshot `_meta/snapshots/measure-2026r1-sb1575-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1575/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `64728044f9d12613f1dde7dbc14cfdd5ec20136d37b601eb24b94f829b39eea9` (snapshot `_meta/snapshots/measure-2026r1-sb1575-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1575/Introduced>.
- **Measure metadata:** retrieved 2026-07-28 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2026R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1575` (part of the batched per-session fetch), sha256 `24ae6bdc7627edf95bbe00a05a147417c7b8bb4753dc857212807a4403e9e192` of the shared session snapshot `_meta/snapshots/measures-2026r1.json`.

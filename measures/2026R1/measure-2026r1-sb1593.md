...
jurisdiction: oregon
id: measure-2026r1-sb1593
title: 'SB 1593 (2026R1): Provides that an operator may require a person who engages in a sport, fitness
  or recreational activity in various ways to release the operator from claims for ordinary negligence.'
doc_type: dataset_doc
citation: 2026 Regular Session Senate Bill 1593
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1593/Introduced
source_format: pdf
retrieved: '2026-07-28'
source_sha256: c2e7ad79404e4e1ee1f7d35d3583e825fa6b7fdd464d6e52f93a5e8d2c689620
snapshot_id: measure-2026r1-sb1593-introduced
status: current
...
catch_line: Provides that an operator may require a person who engages in a sport, fitness or recreational
  activity in various ways to release the operator from claims for ordinary negligence.
minority_catch_line: null
measure_summary: "\t<b>Digest: The Act says that an operator may require a person who does recreation\
  \ to waive some kinds of claims. (Flesch Readability Score: 71.7).</b> \n\t[<i>Digest: The Act says\
  \ that an operator may require a person who does recreation to release the operator from some types\
  \ of claims. Tells OBDD to study issues for the recreation industry and make a report. (Flesch Readability\
  \ Score: 60.9).</i>] \n\tProvides that an operator may require [<i>an adult</i>] <b>a </b>person who\
  \ engages in a sport, fitness or recreational activity in various ways to release the operator from\
  \ claims for ordinary negligence. \n\t[<i>Directs the Oregon Business Development Department to study\
  \ recreation commerce and report to an appropriate committee or interim committee of the Legislative\
  \ Assembly no later than December 15, 2026.</i>] \n\tDeclares an emergency, effective on passage."
...
measure_modified_date: '2026-05-20T13:49:17'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 8576
...
# SB 1593 — 2026 Regular Session (2026R1)

## At a glance

- **Measure:** Senate Bill 1593, 2026 Regular Session (2026R1)
- **LC number:** 215
- **Created:** 2026-01-20T09:39:59
- **Metadata last modified (upstream):** 2026-05-20T13:49:17
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 8576 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1593/Introduced>.

## Summary

**Catchline:** Provides that an operator may require a person who engages in a sport, fitness or recreational activity in various ways to release the operator from claims for ordinary negligence.

**Relating to:** Relating to recreation; declaring an emergency.

<b>Digest: The Act says that an operator may require a person who does recreation to waive some kinds of claims. (Flesch Readability Score: 71.7).</b> 
 [<i>Digest: The Act says that an operator may require a person who does recreation to release the operator from some types of claims. Tells OBDD to study issues for the recreation industry and make a report. (Flesch Readability Score: 60.9).</i>] 
 Provides that an operator may require [<i>an adult</i>] <b>a </b>person who engages in a sport, fitness or recreational activity in various ways to release the operator from claims for ordinary negligence. 
 [<i>Directs the Oregon Business Development Department to study recreation commerce and report to an appropriate committee or interim committee of the Legislative Assembly no later than December 15, 2026.</i>] 
 Declares an emergency, effective on passage.
...
SECTION 2.
(1) The Oregon  Business Development Department shall study recreation
...
SECTION 3.
Section 2 of this 2026 Act is repealed on January 2, 2027.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-28, sha256 `c2e7ad79404e4e1ee1f7d35d3583e825fa6b7fdd464d6e52f93a5e8d2c689620` (snapshot `_meta/snapshots/measure-2026r1-sb1593-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1593/Introduced>.
- **Measure metadata:** retrieved 2026-07-28 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2026R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1593` (part of the batched per-session fetch), sha256 `24ae6bdc7627edf95bbe00a05a147417c7b8bb4753dc857212807a4403e9e192` of the shared session snapshot `_meta/snapshots/measures-2026r1.json`.

...
jurisdiction: oregon
id: measure-2026r1-sb1523
title: 'SB 1523 (2026R1): Defines "tenant portal" for the purposes of residential tenancies.'
doc_type: dataset_doc
citation: 2026 Regular Session Senate Bill 1523
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1523/Enrolled
source_format: pdf
retrieved: '2026-07-28'
source_sha256: 6f536b49f232b22bfc18175601a1d4e88e130674169bfd36ca21749acfb98111
snapshot_id: measure-2026r1-sb1523-enrolled
status: current
...
measure_summary: "\tDigest: This Act allows a tenant or applicant for housing to opt not to use a tenant\
  \ portal or to pay by card or electronic means. (Flesch Readability Score: 63.0). \n\tDefines \"tenant\
  \ portal\" for the purposes of residential tenancies. Requires landlords to provide an alternative to\
  \ a tenant portal in response to a request from an applicant or tenant<b> under certain circumstances</b>.\
  \ Prohibits landlords from requiring payments via a tenant portal, card or electronic means. Requires\
  \ landlords to provide an alternative to a tenant portal to access common areas of the premises. Allows\
  \ landlords to charge tenants for payment processing fees for payments made by credit card or tenant\
  \ portal. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to electronic access to residential tenancies; and prescribing an effective date.
relating_to_full: Relating to electronic access to residential tenancies; and prescribing an effective
  date.
...
# SB 1523 — 2026 Regular Session (2026R1)

## At a glance

- **Measure:** Senate Bill 1523, 2026 Regular Session (2026R1)
...
- **Full text below:** Enrolled version, 32820 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1523/Enrolled>.

## Summary

**Catchline:** Defines "tenant portal" for the purposes of residential tenancies.

**Relating to:** Relating to electronic access to residential tenancies; and prescribing an effective date.
...
**RelatingToFull (verbatim upstream field):** Relating to electronic access to residential tenancies; and prescribing an effective date.
...
(B) Within seven days following receipt of  a written request by any prospective applicant,
provide a printed or printable copy of the application to the prospective applicant  by mail or
electronic mail.
(b) Process all applications whether received through the tenant portal or outside of the
portal.
...
(b) Review and sign addenda or other legal agreements; or
(c) Submit documents relating to the tenancy.
(3) This section does  not prohibit a landlord from entering tenant information into a
tenant portal or otherwise using a tenant portal.
(4) If a landlord fails to comply with this section,  an individual who applied as described
...
ever is greater.
SECTION 3.
(1) A landlord shall allow a tenant to make payments by  check or other
...
Enrolled Senate Bill 1523 (SB 1523-A) Page 1
...
Enrolled Senate Bill 1523 (SB 1523-A) Page 2
...
Enrolled Senate Bill 1523 (SB 1523-A) Page 3
...
Enrolled Senate Bill 1523 (SB 1523-A) Page 4
...
Enrolled Senate Bill 1523 (SB 1523-A) Page 5
(b) A dishonored check, pursuant to ORS 30.701  (5). The amount of the fee may not exceed the
amount described in ORS 30.701  (5) plus any amount that a bank has charged the landlord for
...
Enrolled Senate Bill 1523 (SB 1523-A) Page 6
...
Enrolled Senate Bill 1523 (SB 1523-A) Page 7
...
the time of installation and are maintained in good working order;
...
Enrolled Senate Bill 1523 (SB 1523-A) Page 8
...
SECTION 7.
(1) Sections 2 and 3 of this 2026 Act and the amendments  to ORS 90.302 and
...
Enrolled Senate Bill 1523 (SB 1523-A) Page 9
...
- From bill text (Enrolled version): ORS 100.005, ORS 100.405, ORS 105.836, ORS 107.705, ORS 109.697, ORS 147.380, ORS 147.450, ORS 163.732, ORS 174.101, ORS 197.492, ORS 30.701, ORS 446.003, ORS 479.270, ORS 479.990, ORS 671.560, ORS 699.005, ORS 830.700, ORS 90.100, ORS 90.148, ORS 90.222, ORS 90.243, ORS 90.255, ORS 90.260, ORS 90.262, ORS 90.295, ORS 90.302, ORS 90.315, ORS 90.320, ORS 90.325, ORS 90.392, ORS 90.394, ORS 90.405, ORS 90.410, ORS 90.427, ORS 90.453, ORS 90.472, ORS 90.505, ORS 90.510, ORS 90.530, ORS 90.562, ORS 90.730, ORS 94.550, ORS 94.625

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-28, sha256 `6f536b49f232b22bfc18175601a1d4e88e130674169bfd36ca21749acfb98111` (snapshot `_meta/snapshots/measure-2026r1-sb1523-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1523/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `edb3487eb4fd8fe426cd678a948c166b318e0f4ca6407ac5af21fc43346b14f5` (snapshot `_meta/snapshots/measure-2026r1-sb1523-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1523/Introduced>.
- **Measure metadata:** retrieved 2026-07-28 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2026R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1523` (part of the batched per-session fetch), sha256 `24ae6bdc7627edf95bbe00a05a147417c7b8bb4753dc857212807a4403e9e192` of the shared session snapshot `_meta/snapshots/measures-2026r1.json`.

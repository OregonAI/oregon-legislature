...
jurisdiction: oregon
id: measure-2026r1-sb1588
title: 'SB 1588 (2026R1): Requires each electric company to develop an inclusive utility investment program
  to provide financing for customers'' energy efficiency upgrades or renewable energy projects.'
doc_type: dataset_doc
citation: 2026 Regular Session Senate Bill 1588
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1588/Introduced
source_format: pdf
retrieved: '2026-07-28'
source_sha256: 24db6aded81655da3197cee8c70726cbb1a3c6f97aa5f0808a6b89ef1e8d77ad
snapshot_id: measure-2026r1-sb1588-introduced
status: current
...
catch_line: Requires each electric company to develop an inclusive utility investment program to provide
  financing for customers' energy efficiency upgrades or renewable energy projects.
minority_catch_line: null
measure_summary: "\tDigest: Tells each power company to make a program to help pay for energy projects\
  \ that reduce customers' costs. Sets out program standards. (Flesch Readability Score: 64.9). \n\tRequires\
  \ each electric company to develop an inclusive utility investment program to provide financing for\
  \ customers' energy efficiency upgrades or renewable energy projects. Requires an inclusive utility\
  \ investment program to provide savings reflected in the reduction in a customer's electricity or energy\
  \ utility costs. Allows the Public Utility Commission to establish minimum financial savings standards\
  \ and adopt and provide electric companies with performance incentives."
relating_to: Relating to inclusive utility investment programs.
relating_to_full: Relating to inclusive utility investment programs.
at_the_request_of: null
lc_number: 123
measure_created_date: '2026-01-16T16:52:22'
measure_modified_date: '2026-02-10T15:24:12'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 8135
...
# SB 1588 — 2026 Regular Session (2026R1)

## At a glance

- **Measure:** Senate Bill 1588, 2026 Regular Session (2026R1)
- **LC number:** 123
- **Created:** 2026-01-16T16:52:22
- **Metadata last modified (upstream):** 2026-02-10T15:24:12
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 8135 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1588/Introduced>.

## Summary

**Catchline:** Requires each electric company to develop an inclusive utility investment program to provide financing for customers' energy efficiency upgrades or renewable energy projects.

**Relating to:** Relating to inclusive utility investment programs.

Digest: Tells each power company to make a program to help pay for energy projects that reduce customers' costs. Sets out program standards. (Flesch Readability Score: 64.9). 
 Requires each electric company to develop an inclusive utility investment program to provide financing for customers' energy efficiency upgrades or renewable energy projects. Requires an inclusive utility investment program to provide savings reflected in the reduction in a customer's electricity or energy utility costs. Allows the Public Utility Commission to establish minimum financial savings standards and adopt and provide electric companies with performance incentives.

**RelatingToFull (verbatim upstream field):** Relating to inclusive utility investment programs.
...
SECTION 3.
(1) In developing an inclusive utility investment program under section 2 of
...
- From bill text (Introduced version): ORS 757.600, ORS 757.612

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-28, sha256 `24db6aded81655da3197cee8c70726cbb1a3c6f97aa5f0808a6b89ef1e8d77ad` (snapshot `_meta/snapshots/measure-2026r1-sb1588-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1588/Introduced>.
- **Measure metadata:** retrieved 2026-07-28 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2026R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1588` (part of the batched per-session fetch), sha256 `24ae6bdc7627edf95bbe00a05a147417c7b8bb4753dc857212807a4403e9e192` of the shared session snapshot `_meta/snapshots/measures-2026r1.json`.

...
jurisdiction: oregon
id: measure-2026r1-sb1577
title: 'SB 1577 (2026R1): Provides that a manufactured-protein food product that bears a label suggesting
  that the food product is made from meat is misbranded unless the food product label contains text disclosing
  that the food product is not made from meat.'
doc_type: dataset_doc
citation: 2026 Regular Session Senate Bill 1577
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1577/Introduced
source_format: pdf
retrieved: '2026-07-28'
source_sha256: 5852c12b6deceaa969f6fe8b032a964025e5503fef8635e05c1ff45e84c821e8
snapshot_id: measure-2026r1-sb1577-introduced
status: current
...
measure_summary: "\tDigest: The Act says that foods made with plant-based, insect-based or lab-grown proteins\
  \ are misbranded if their labels imply that they are made of meat or eggs. (Flesch Readability Score:\
  \ 66.5). \n\tProvides that a manufactured-protein food product that bears a label suggesting that the\
  \ food product is made from meat is misbranded unless the food product label contains text disclosing\
  \ that the food product is not made from meat. \n\tProvides that a fabricated-egg food product that\
  \ bears a label suggesting that the food product is made from eggs is misbranded unless the food product\
  \ label contains text disclosing that the food product is not made from eggs."
relating_to: Relating to the labeling of alternative protein food products.
relating_to_full: Relating to the labeling of alternative protein food products; creating new provisions;
  and amending ORS 616.205 and 616.250.
at_the_request_of: null
lc_number: 138
measure_created_date: '2026-01-16T15:12:52'
measure_modified_date: '2026-02-16T07:21:16'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 18333
...
# SB 1577 — 2026 Regular Session (2026R1)

## At a glance

- **Measure:** Senate Bill 1577, 2026 Regular Session (2026R1)
- **LC number:** 138
- **Created:** 2026-01-16T15:12:52
- **Metadata last modified (upstream):** 2026-02-16T07:21:16
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 18333 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1577/Introduced>.

## Summary

**Catchline:** Provides that a manufactured-protein food product that bears a label suggesting that the food product is made from meat is misbranded unless the food product label contains text disclosing that the food product is not made from meat.

**Relating to:** Relating to the labeling of alternative protein food products.

Digest: The Act says that foods made with plant-based, insect-based or lab-grown proteins are misbranded if their labels imply that they are made of meat or eggs. (Flesch Readability Score: 66.5). 
 ...
 Provides that a fabricated-egg food product that bears a label suggesting that the food product is made from eggs is misbranded unless the food product label contains text disclosing that the food product is not made from eggs.

**RelatingToFull (verbatim upstream field):** Relating to the labeling of alternative protein food products; creating new provisions; and amending ORS 616.205 and 616.250.
...
SECTION 3.
The amendments to ORS 616.205 and 616.250 by sections 1 and 2 of this 2026
...
- From bill text (Introduced version): ORS 616.205, ORS 616.230, ORS 616.250, ORS 616.325, ORS 619.010, ORS 632.705, ORS 634.006

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-28, sha256 `5852c12b6deceaa969f6fe8b032a964025e5503fef8635e05c1ff45e84c821e8` (snapshot `_meta/snapshots/measure-2026r1-sb1577-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1577/Introduced>.
- **Measure metadata:** retrieved 2026-07-28 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2026R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1577` (part of the batched per-session fetch), sha256 `24ae6bdc7627edf95bbe00a05a147417c7b8bb4753dc857212807a4403e9e192` of the shared session snapshot `_meta/snapshots/measures-2026r1.json`.

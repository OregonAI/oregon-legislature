...
jurisdiction: oregon
id: measure-2026r1-hb4137
title: 'HB 4137 (2026R1): Provides that, in lieu of making a first appearance for a traffic violation
  citation, the person who is the previous owner of a vehicle may notify the court that the person has
  transferred interest in the vehicle and is not liable for the citation.'
doc_type: dataset_doc
citation: 2026 Regular Session House Bill 4137
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4137/Enrolled
source_format: pdf
retrieved: '2026-07-28'
source_sha256: 43c9d0e53fbd86e1fb65f156f6bd54902f0e0a249bf622ffe28ea271373d1ba4
snapshot_id: measure-2026r1-hb4137-enrolled
status: current
...
catch_line: Provides that, in lieu of making a first appearance for a traffic violation citation, the
  person who is the previous owner of a vehicle may notify the court that the person has transferred interest
  in the vehicle and is not liable for the citation.
minority_catch_line: null
measure_summary: "\tDigest: If a traffic ticket is sent to a person who sold a car before the traffic\
  \ offense happened, the old owner may let the court know that they are not required to pay the ticket.\
  \ (Flesch Readability Score: 62.5). \n\tProvides that, in lieu of making a first appearance for a traffic\
  \ violation citation, the person who is the previous owner of a vehicle may notify the court that the\
  \ person has transferred interest in the vehicle and is not liable for the citation."
relating_to: Relating to the transfer of interest in motor vehicles.
relating_to_full: Relating to the transfer of interest in motor vehicles.
at_the_request_of: null
lc_number: 251
measure_created_date: '2026-01-18T13:32:13'
...
# HB 4137 — 2026 Regular Session (2026R1)

## At a glance

- **Measure:** House Bill 4137, 2026 Regular Session (2026R1)
- **LC number:** 251
- **Created:** 2026-01-18T13:32:13
- **Metadata last modified (upstream):** 2026-04-06T10:38:28
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 6916 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4137/Enrolled>.

## Summary

**Catchline:** Provides that, in lieu of making a first appearance for a traffic violation citation, the person who is the previous owner of a vehicle may notify the court that the person has transferred interest in the vehicle and is not liable for the citation.

**Relating to:** Relating to the transfer of interest in motor vehicles.

Digest: If a traffic ticket is sent to a person who sold a car before the traffic offense happened, the old owner may let the court know that they are not required to pay the ticket. (Flesch Readability Score: 62.5). 
...
**RelatingToFull (verbatim upstream field):** Relating to the transfer of interest in motor vehicles.
...
SECTION 2.
The amendments to  ORS 153.061 by section 1 of this 2026 Act apply to con-
...
- From bill text (Enrolled version): ORS 153.019, ORS 153.020, ORS 153.061, ORS 153.800, ORS 153.806, ORS 471.430, ORS 801.557, ORS 803.112, ORS 803.117, ORS 809.220, ORS 811.135

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-28, sha256 `43c9d0e53fbd86e1fb65f156f6bd54902f0e0a249bf622ffe28ea271373d1ba4` (snapshot `_meta/snapshots/measure-2026r1-hb4137-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4137/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `b7ee076e72e77d9bd4f3fca9ecdc193228214fa740b6b9812da77992739a9a25` (snapshot `_meta/snapshots/measure-2026r1-hb4137-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4137/Introduced>.
- **Measure metadata:** retrieved 2026-07-28 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2026R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 4137` (part of the batched per-session fetch), sha256 `24ae6bdc7627edf95bbe00a05a147417c7b8bb4753dc857212807a4403e9e192` of the shared session snapshot `_meta/snapshots/measures-2026r1.json`.

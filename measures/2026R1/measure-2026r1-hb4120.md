...
jurisdiction: oregon
id: measure-2026r1-hb4120
title: 'HB 4120 (2026R1): Allows residential landlords of multifamily housing to convert premises to nonsmoking
  for existing tenants upon 180 days'' written notice.'
doc_type: dataset_doc
citation: 2026 Regular Session House Bill 4120
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4120/Enrolled
source_format: pdf
retrieved: '2026-07-28'
source_sha256: c5d5c23512016be6e96ee58d0a3a9655473bc3a69d7a45c65cad11b5d3c670c3
snapshot_id: measure-2026r1-hb4120-enrolled
status: current
...
catch_line: Allows residential landlords of multifamily housing to convert premises to nonsmoking for
  existing tenants upon 180 days' written notice.
minority_catch_line: null
measure_summary: "\tDigest: This Act lets landlords restrict smoking in apartments. (Flesch Readability\
  \ Score: 61.2). \n\tAllows residential landlords of multifamily housing to convert premises to nonsmoking\
  \ for existing tenants upon [<i>90</i>]<b> 180</b> days' written notice. Applies to new and existing\
  \ rental agreements."
relating_to: Relating to smoking policies in residential tenancies.
relating_to_full: Relating to smoking policies in residential tenancies.
at_the_request_of: null
lc_number: 32
measure_created_date: '2026-01-17T15:12:12'
measure_modified_date: '2026-05-20T13:54:35'
...
# HB 4120 — 2026 Regular Session (2026R1)

## At a glance

- **Measure:** House Bill 4120, 2026 Regular Session (2026R1)
- **LC number:** 32
- **Created:** 2026-01-17T15:12:12
- **Metadata last modified (upstream):** 2026-05-20T13:54:35
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 5480 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4120/Enrolled>.

## Summary

**Catchline:** Allows residential landlords of multifamily housing to convert premises to nonsmoking for existing tenants upon 180 days' written notice.

**Relating to:** Relating to smoking policies in residential tenancies.
...
**RelatingToFull (verbatim upstream field):** Relating to smoking policies in residential tenancies.
...
included.
SECTION 2.
 ORS 479.305 is amended to read:
...
- From bill text (Enrolled version): ORS 197A.421, ORS 431A.175, ORS 479.305, ORS 659A.421, ORS 90.100, ORS 90.260, ORS 90.262, ORS 90.505, ORS 94.504

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-28, sha256 `c5d5c23512016be6e96ee58d0a3a9655473bc3a69d7a45c65cad11b5d3c670c3` (snapshot `_meta/snapshots/measure-2026r1-hb4120-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4120/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `bb4f7eb6bbddd0479664364d6df188894ef25620fb01f2b3fc995925acdd8f10` (snapshot `_meta/snapshots/measure-2026r1-hb4120-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4120/Introduced>.
- **Measure metadata:** retrieved 2026-07-28 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2026R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 4120` (part of the batched per-session fetch), sha256 `24ae6bdc7627edf95bbe00a05a147417c7b8bb4753dc857212807a4403e9e192` of the shared session snapshot `_meta/snapshots/measures-2026r1.json`.

...
jurisdiction: oregon
id: measure-2026r1-hb4071
title: 'HB 4071 (2026R1): Provides that an operator may require an adult person who engages in a sport,
  fitness or recreational activity in various ways to release the operator from claims for ordinary negligence.'
doc_type: dataset_doc
citation: 2026 Regular Session House Bill 4071
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4071/Introduced
source_format: pdf
retrieved: '2026-07-28'
source_sha256: eb83163bfc4ad44693b92d41a9598bf6403595e2ef08b843e68b173a910cda8d
snapshot_id: measure-2026r1-hb4071-introduced
status: current
...
catch_line: Provides that an operator may require an adult person who engages in a sport, fitness or recreational
  activity in various ways to release the operator from claims for ordinary negligence.
minority_catch_line: null
measure_summary: "\tDigest: The Act says that an operator may require a person who does recreation to\
  \ release the operator from some types of claims. Tells OBDD to study issues for the recreation industry\
  \ and make a report. (Flesch Readability Score: 60.9). \n\tProvides that an operator may require an\
  \ adult person who engages in a sport, fitness or recreational activity in various ways to release the\
  \ operator from claims for ordinary negligence. \n\tDirects the Oregon Business Development Department\
  \ to study recreation commerce and report to an appropriate committee or interim committee of the Legislative\
...
lc_number: 204
measure_created_date: '2026-01-16T13:16:15'
...
# HB 4071 — 2026 Regular Session (2026R1)

## At a glance

- **Measure:** House Bill 4071, 2026 Regular Session (2026R1)
- **LC number:** 204
- **Created:** 2026-01-16T13:16:15
- **Metadata last modified (upstream):** 2026-02-02T11:42:47
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 8525 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4071/Introduced>.

## Summary

**Catchline:** Provides that an operator may require an adult person who engages in a sport, fitness or recreational activity in various ways to release the operator from claims for ordinary negligence.

**Relating to:** Relating to recreation; declaring an emergency.

Digest: The Act says that an operator may require a person who does recreation to release the operator from some types of claims. Tells OBDD to study issues for the recreation industry and make a report. (Flesch Readability Score: 60.9). 
 ...
 Directs the Oregon Business Development Department to study recreation commerce and report to an appropriate committee or interim committee of the Legislative Assembly no later than December 15, 2026. 
 Declares an emergency, effective on passage.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-28, sha256 `eb83163bfc4ad44693b92d41a9598bf6403595e2ef08b843e68b173a910cda8d` (snapshot `_meta/snapshots/measure-2026r1-hb4071-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4071/Introduced>.
- **Measure metadata:** retrieved 2026-07-28 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2026R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 4071` (part of the batched per-session fetch), sha256 `24ae6bdc7627edf95bbe00a05a147417c7b8bb4753dc857212807a4403e9e192` of the shared session snapshot `_meta/snapshots/measures-2026r1.json`.

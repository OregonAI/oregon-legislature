...
jurisdiction: oregon
id: measure-2026r1-sb1567
title: 'SB 1567 (2026R1): Authorizes the Housing and Community Services Department to fund mixed income
  housing.'
doc_type: dataset_doc
citation: 2026 Regular Session Senate Bill 1567
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1567/Enrolled
source_format: pdf
retrieved: '2026-07-28'
source_sha256: 855a1dd9c5caf1cb595728ffdac21a379cec5aad2bd10f8f1b101e5e6fb284e5
snapshot_id: measure-2026r1-sb1567-enrolled
status: current
...
measure_summary: "\tDigest: This Act lets OHCS make loans for mixed income housing projects. (Flesch Readability\
  \ Score: 87.9). \n\tAuthorizes the Housing and Community Services Department to fund mixed income housing.\
  \ Requires the department to develop a mixed income housing loan program. Establishes the Mixed Income\
  \ Development Loan Fund for such purposes. <b>Transfers moneys to the fund from the Housing Project\
  \ Revolving Loan Fund.</b> Requires the department to adopt initial program rules by January 1, 2027.\
  \ \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to mixed income housing; and prescribing an effective date.
relating_to_full: Relating to mixed income housing; and prescribing an effective date.
at_the_request_of: null
lc_number: 156
measure_created_date: '2026-01-16T14:00:23'
...
# SB 1567 — 2026 Regular Session (2026R1)

## At a glance

- **Measure:** Senate Bill 1567, 2026 Regular Session (2026R1)
- **LC number:** 156
- **Created:** 2026-01-16T14:00:23
- **Metadata last modified (upstream):** 2026-04-06T11:53:20
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 10639 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1567/Enrolled>.

## Summary

**Catchline:** Authorizes the Housing and Community Services Department to fund mixed income housing.

**Relating to:** Relating to mixed income housing; and prescribing an effective date.

Digest: This Act lets OHCS make loans for mixed income housing projects. (Flesch Readability Score: 87.9). 
 Authorizes the Housing and Community Services Department to fund mixed income housing. Requires the department to develop a mixed income housing loan program. Establishes the Mixed Income Development Loan Fund for such purposes. <b>Transfers moneys to the fund from the Housing Project Revolving Loan Fund.</b> Requires the department to adopt initial program rules by January 1, 2027. 
 Takes effect on the 91st day following adjournment sine die.

**RelatingToFull (verbatim upstream field):** Relating to mixed income housing; and prescribing an effective date.
...
SECTION 1.
Sections 2 and 3 of this 2026 Act are added to and made a part of ORS 456.548
to 456.828.
...
SECTION 3.
(1) The Mixed Income Development Loan Fund is established in the State
...
SECTION 4.
On or before January 1, 2027, the Housing and Community Services Depart-
...
SECTION 6.
 ORS 456.612 is amended to read:
...
- From bill text (Enrolled version): ORS 307.237, ORS 456.270, ORS 456.548, ORS 456.550, ORS 456.612, ORS 456.620, ORS 456.717, ORS 458.610, ORS 92.840

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-28, sha256 `855a1dd9c5caf1cb595728ffdac21a379cec5aad2bd10f8f1b101e5e6fb284e5` (snapshot `_meta/snapshots/measure-2026r1-sb1567-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1567/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `143f2761b1cca81225912fc67e42daa2ee3772e932280bb56ae4e1fe4ccff85c` (snapshot `_meta/snapshots/measure-2026r1-sb1567-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/SB1567/Introduced>.
- **Measure metadata:** retrieved 2026-07-28 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2026R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 1567` (part of the batched per-session fetch), sha256 `24ae6bdc7627edf95bbe00a05a147417c7b8bb4753dc857212807a4403e9e192` of the shared session snapshot `_meta/snapshots/measures-2026r1.json`.

...
jurisdiction: oregon
id: measure-2026r1-hb4115
title: 'HB 4115 (2026R1): Provides that a criminal records check on certain caregivers shall last for
  three years, subject to exceptions.'
doc_type: dataset_doc
citation: 2026 Regular Session House Bill 4115
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4115/Enrolled
source_format: pdf
retrieved: '2026-07-28'
source_sha256: dca1f9e0ff8cdc2deae5ad754ad2e2b4513c41213f8e432d1e1cf380f9f0939d
snapshot_id: measure-2026r1-hb4115-enrolled
status: current
...
catch_line: Provides that a criminal records check on certain caregivers shall last for three years, subject
  to exceptions.
minority_catch_line: null
measure_summary: "\tDigest: The Act makes changes to how often DHS and OHA may require caregivers to get\
  \ a new background check. The Act requires a CCO to pay certain providers back to the date that the\
  \ provider enrolled in the state Medicaid program. The Act makes other changes related to the process\
  \ for vetting certain health care providers. (Flesch Readability Score: 62.4). \n\tProvides that a criminal\
  \ records check on certain caregivers shall last for three years, subject to exceptions. Requires certain\
  \ valid criminal records checks to be portable to other care settings. \n\tRequires the authority to\
  \ publish information about when a credentialed behavioral health provider must undergo a new background\
  \ check. \n\tRequires a coordinated care organization to reimburse a<b> contracted</b> behavioral health\
  \ provider retroactively to the date the provider submitted a successful application for enrollment\
  \ in the state medical assistance program. Prohibits a coordinated care organization from requiring\
  \ a credentialed behavioral health provider to submit a new credentialing application when the provider\
  \ changes employer. \n\tTakes effect on the 91st day following adjournment sine die."
relating_to: Relating to health care providers; and prescribing an effective date.
relating_to_full: Relating to health care providers; and prescribing an effective date.
at_the_request_of: null
lc_number: 112
measure_created_date: '2026-01-17T14:51:40'
...
# HB 4115 — 2026 Regular Session (2026R1)

## At a glance

- **Measure:** House Bill 4115, 2026 Regular Session (2026R1)
- **LC number:** 112
- **Created:** 2026-01-17T14:51:40
- **Metadata last modified (upstream):** 2026-04-06T10:38:28
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 36500 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4115/Enrolled>.

## Summary

**Catchline:** Provides that a criminal records check on certain caregivers shall last for three years, subject to exceptions.

**Relating to:** Relating to health care providers; and prescribing an effective date.

Digest: The Act makes changes to how often DHS and OHA may require caregivers to get a new background check. The Act requires a CCO to pay certain providers back to the date that the provider enrolled in the state Medicaid program. The Act makes other changes related to the process for vetting certain health care providers. (Flesch Readability Score: 62.4). 
 Provides that a criminal records check on certain caregivers shall last for three years, subject to exceptions. Requires certain valid criminal records checks to be portable to other care settings. 
 Requires the authority to publish information about when a credentialed behavioral health provider must undergo a new background check. 
 Requires a coordinated care organization to reimburse a<b> contracted</b> behavioral health provider retroactively to the date the provider submitted a successful application for enrollment in the state medical assistance program. Prohibits a coordinated care organization from requiring a credentialed behavioral health provider to submit a new credentialing application when the provider changes employer. 
 Takes effect on the 91st day following adjournment sine die.

**RelatingToFull (verbatim upstream field):** Relating to health care providers; and prescribing an effective date.
...
SECTION 3.
The amendments to ORS 443.004 by section 1 of this 2026 Act  apply to
...
SECTION 7.
 ORS 181A.200 is amended to read:
...
SECTION 8.
 ORS 443.008 is amended to read:
...
- From bill text (Enrolled version): ORS 163.095, ORS 163.107, ORS 163.115, ORS 163.118, ORS 163.125, ORS 163.145, ORS 163.149, ORS 163.165, ORS 163.175, ORS 163.185, ORS 163.187, ORS 163.200, ORS 163.205, ORS 163.225, ORS 163.235, ORS 163.263, ORS 163.264, ORS 163.266, ORS 163.275, ORS 163.375, ORS 163.405, ORS 163.411, ORS 163.465, ORS 163.467, ORS 163.535, ORS 163.537, ORS 163.547, ORS 163.689, ORS 163.700, ORS 163.701, ORS 163A.005, ORS 164.055, ORS 164.057, ORS 164.098, ORS 164.125, ORS 174.111, ORS 181A.010, ORS 181A.190, ORS 181A.195, ORS 181A.200, ORS 181A.205, ORS 181A.210, ORS 181A.215, ORS 181A.400, ORS 181A.875, ORS 329A.250, ORS 329A.280, ORS 329A.430, ORS 332.002, ORS 342.143, ORS 342.223, ORS 410.600, ORS 414.025, ORS 418.016, ORS 418.205, ORS 427.101, ORS 443.004, ORS 443.008, ORS 443.014, ORS 443.305, ORS 443.400, ORS 443.415, ORS 443.705, ORS 443.735, ORS 475C.770, ORS 670.280, ORS 682.025, ORS 813.010

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-28, sha256 `dca1f9e0ff8cdc2deae5ad754ad2e2b4513c41213f8e432d1e1cf380f9f0939d` (snapshot `_meta/snapshots/measure-2026r1-hb4115-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4115/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `64bd32a79f89dcc8554eb1dae1cba94d02510c3fa2abeffddccb0aa4ee5c4a54` (snapshot `_meta/snapshots/measure-2026r1-hb4115-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4115/Introduced>.
- **Measure metadata:** retrieved 2026-07-28 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2026R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 4115` (part of the batched per-session fetch), sha256 `24ae6bdc7627edf95bbe00a05a147417c7b8bb4753dc857212807a4403e9e192` of the shared session snapshot `_meta/snapshots/measures-2026r1.json`.

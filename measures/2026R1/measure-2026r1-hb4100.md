...
jurisdiction: oregon
id: measure-2026r1-hb4100
title: 'HB 4100 (2026R1): Requires owners or operators of bulk oils or liquid fuels terminals to obtain
  a certificate of financial responsibility from the Department of Environmental Quality.'
doc_type: dataset_doc
citation: 2026 Regular Session House Bill 4100
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4100/Enrolled
source_format: pdf
retrieved: '2026-07-28'
source_sha256: 1554a517270274c1a8f7b66abd96c89a208a99bbf7ab47b9761115f55c52320f
...
measure_summary: "\tDigest: This Act makes owners of bulk oils and liquid fuels terminals show they can\
  \ cover the costs of oil or fuel spills. (Flesch Readability Score: 80.6). \n\tRequires owners or operators\
  \ of bulk oils or liquid fuels terminals to obtain a certificate of financial responsibility from the\
  \ Department of Environmental Quality. \n\tDirects the Environmental Quality Commission to establish\
  \ rules pertaining to certificates of financial responsibility. Requires the department to report to\
  \ the Legislative Assembly on the implementation of the Act each even-numbered year. \n\tPreempts local\
  \ governments from requiring financial assurance that exceeds or is in addition to the requirements\
  \ of the Act. \n\tDeclares an emergency, effective on passage."
relating_to: Relating to bulk fuel terminals; and declaring an emergency.
relating_to_full: Relating to bulk fuel terminals; and declaring an emergency.
at_the_request_of: null
lc_number: 108
measure_created_date: '2026-01-17T12:32:34'
...
# HB 4100 — 2026 Regular Session (2026R1)

## At a glance

- **Measure:** House Bill 4100, 2026 Regular Session (2026R1)
- **LC number:** 108
- **Created:** 2026-01-17T12:32:34
- **Metadata last modified (upstream):** 2026-04-06T10:38:28
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 17293 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4100/Enrolled>.
...
**Relating to:** Relating to bulk fuel terminals; and declaring an emergency.

Digest: This Act makes owners of bulk oils and liquid fuels terminals show they can cover the costs of oil or fuel spills. (Flesch Readability Score: 80.6). 
 ...
 Directs the Environmental Quality Commission to establish rules pertaining to certificates of financial responsibility. Requires the department to report to the Legislative Assembly on the implementation of the Act each even-numbered year. 
 Preempts local governments from requiring financial assurance that exceeds or is in addition to the requirements of the Act. 
 Declares an emergency, effective on passage.

**RelatingToFull (verbatim upstream field):** Relating to bulk fuel terminals; and declaring an emergency.
...
SECTION 3.
As used in sections 2 to 5 of this 2026 Act:
...
SECTION 4.
(1) The owner or operator of a bulk oils or  liquid fuels terminal shall acquire
...
SECTION 5.
No later than September 15 of each even-numbered year, the Department
...
- From bill text (Enrolled version): ORS 174.116, ORS 192.245, ORS 466.605, ORS 468.130, ORS 468B.345, ORS 468B.510, ORS 468B.513, ORS 468B.525

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-28, sha256 `1554a517270274c1a8f7b66abd96c89a208a99bbf7ab47b9761115f55c52320f` (snapshot `_meta/snapshots/measure-2026r1-hb4100-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4100/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `a23d4a8671f349a0b481e51e777d43f4605fb55726e9cc395d3d163761b3d9ec` (snapshot `_meta/snapshots/measure-2026r1-hb4100-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4100/Introduced>.
- **Measure metadata:** retrieved 2026-07-28 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2026R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 4100` (part of the batched per-session fetch), sha256 `24ae6bdc7627edf95bbe00a05a147417c7b8bb4753dc857212807a4403e9e192` of the shared session snapshot `_meta/snapshots/measures-2026r1.json`.

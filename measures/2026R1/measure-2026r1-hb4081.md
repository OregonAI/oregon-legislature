...
jurisdiction: oregon
id: measure-2026r1-hb4081
title: 'HB 4081 (2026R1): Makes changes to the highway worker photo radar laws.'
doc_type: dataset_doc
citation: 2026 Regular Session House Bill 4081
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4081/Introduced
source_format: pdf
retrieved: '2026-07-28'
source_sha256: eeb7b14cdbd884124fd2116310f7400b79ae604863254eab261d814cd63daefd
snapshot_id: measure-2026r1-hb4081-introduced
status: current
...
catch_line: Makes changes to the highway worker photo radar laws.
minority_catch_line: null
measure_summary: "\tDigest: Makes changes to the highway worker photo radar laws. (Flesch Readability\
  \ Score: 66.1). \n\tMakes changes to the highway worker photo radar laws."
relating_to: Relating to photo radar in highway work zones.
relating_to_full: Relating to photo radar in highway work zones; creating new provisions; and amending
  ORS 810.441 and 810.442.
at_the_request_of: null
lc_number: 11
measure_created_date: '2026-01-16T16:03:47'
...
# HB 4081 — 2026 Regular Session (2026R1)

## At a glance

- **Measure:** House Bill 4081, 2026 Regular Session (2026R1)
- **LC number:** 11
- **Created:** 2026-01-16T16:03:47
- **Metadata last modified (upstream):** 2026-02-18T18:05:01
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 11575 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4081/Introduced>.

## Summary

**Catchline:** Makes changes to the highway worker photo radar laws.

**Relating to:** Relating to photo radar in highway work zones.

Digest: Makes changes to the highway worker photo radar laws. (Flesch Readability Score: 66.1). 
 Makes changes to the highway worker photo radar laws.

**RelatingToFull (verbatim upstream field):** Relating to photo radar in highway work zones; creating new provisions; and amending ORS 810.441 and 810.442.

## Full text

83rd OREGON LEGISLATIVE ASSEMBLY--2026 Regular Session
House Bill 4081
Sponsored by Representative MCLAIN, Senators NERON MISSLIN,  FREDERICK, Representative WATANABE;
Representatives BOWMAN, DOBSON, HELM, MANNIX, MARSH, OWENS, Senator WEBER (Presession filed.)
SUMMARY
...
Makes changes to the highway worker photo radar laws.
A BILL FOR AN ACT
Relating to photo radar in highway work zones; amending ORS 810.441 and 810.442.
Be It Enacted by the People of the State of Oregon:
SECTION 1.
 ORS 810.441 is amended to read:
810.441. [(1) The Department of Transportation  may operate photo radar within a highway work
zone that is located on a state highway. The photo radar unit may be operated only: ]
...
nouncing that photo radar is in use. The sign posted under this subsection must be all of the
following: ]
...
(1) The Department of Transportation shall, in collaboration with  the Oregon State Po-
lice, establish a highway worker photo radar program and operate photo radar units  within
highway work zones that are located on state highways. The department is responsible for
procuring and administering contracts necessary to:
(a) Implement the program, which  includes but is not limited to contracts for photo ra-
dar units, training and administration; and
NOTE: Matter in  boldfaced type in an amended section is new;  matter [ italic and bracketed] is existing law to be omitted.
New sections are in  boldfaced type.
LC 11
(b) Ensure the photo radar units:
(A) Measure vehicle speed within the accuracy tolerance level determined by  the Oregon
State Police;
(B) Produce clear digital images that  show the motor vehicle, registration plate, date,
time, location, recorded speed and individual driving the vehicle;
(C) Are regularly inspected by a qualified technician no less than once every 60 days;
(D) Are installed and operating properly; and
(E) Are calibrated in accordance with the manufacturer’s instructions,  and at least once
per year by an independent calibration laboratory.
(2) The photo radar units may be operated only in the  area within a highway work zone
when highway workers, as defined in ORS 811.230, are present and, in  the case of a divided
...
year.
(6) Before March 1  of any year in which photo radar units will be deployed under this
section, the department shall notify the Judicial Department of the number  of photo radar
units that are intended to be deployed over  the following 12 months, the counties within
which the photo radar units are  likely to be deployed and the number of citations expected
to be issued based on traffic volume and expected driver behavior.
[(6)] (7) As used in this section, “highway work zone” has the meaning given  that term in ORS
811.230.
SECTION 2.
 ORS 810.442 is amended to read:
...
[(G)] (F)  The [ jurisdiction operating photo radar ] Oregon State Police  complies with  the re-
quirements described in ORS 810.441.
...
and the signature may be  electronic in accordance with the provisions of ORS 84.001 to 84.061.  The
Oregon State Police is responsible for accurately transmitting citations, and  corresponding
data and evidence, issued under this section to the Judicial  Department for processing. The
Oregon State Police shall include in the citations information that allows courts  to identify
that the citations were issued under this section.
...
time of  the violation, the court  shall dismiss the citation without requiring a court appearance
...
owner and only if the [ jurisdiction] court  verifies that the registered owner  appears to have been
the driver at the time of the violation. A registered owner may not submit  a certificate of innocence
...
- From `RelatingToFull`: ORS 810.441, ORS 810.442
- From bill text (Introduced version): ORS 153.102, ORS 153.105, ORS 810.438, ORS 810.441, ORS 810.442, ORS 811.230, ORS 84.001

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-28, sha256 `eeb7b14cdbd884124fd2116310f7400b79ae604863254eab261d814cd63daefd` (snapshot `_meta/snapshots/measure-2026r1-hb4081-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4081/Introduced>.
- **Measure metadata:** retrieved 2026-07-28 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2026R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 4081` (part of the batched per-session fetch), sha256 `24ae6bdc7627edf95bbe00a05a147417c7b8bb4753dc857212807a4403e9e192` of the shared session snapshot `_meta/snapshots/measures-2026r1.json`.

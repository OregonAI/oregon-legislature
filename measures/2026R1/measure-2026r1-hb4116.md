...
jurisdiction: oregon
id: measure-2026r1-hb4116
title: 'HB 4116 (2026R1): Declares that this state does not want the amendments set forth in section 521
...
citation: 2026 Regular Session House Bill 4116
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4116/Enrolled
source_format: pdf
retrieved: '2026-07-28'
source_sha256: 1cf9d24e41138d2043a919547af2422397d06679639e721bb007e415a9b0bcaa
snapshot_id: measure-2026r1-hb4116-enrolled
status: current
...
catch_line: Declares that this state does not want the amendments set forth in section 521 of the Depository
  ...
  this state.
minority_catch_line: Establishes the Task Force on Equitable Access to Short-Term Financial Products.
measure_summary: "\tDigest: Declares that this state does not want a certain federal law to apply to consumer\
  \ finance loans made in this state. Says who the laws that govern consumer finance loans in this state\
  \ apply to and when. Says what needs to be in an application for a license to make consumer finance\
  \ loans in this state. (Flesch Readability Score: 73.0). \n\tDeclares that this state does not want\
  \ the amendments set forth in section 521 of the Depository Institutions Deregulation and Monetary Control\
  \ Act of 1980 to apply to consumer finance loans made in this state. Specifies persons to whom the consumer\
  \ finance laws of this state apply and circumstances in which the laws apply. Specifies the requirements\
  \ for an application for a license to make consumer finance loans in this state. \n\tTakes effect on\
  \ the 91st day following adjournment sine die."
relating_to: Relating to consumer finance loans; and prescribing an effective date.
relating_to_full: Relating to consumer finance loans; and prescribing an effective date.
at_the_request_of: null
lc_number: 221
measure_created_date: '2026-01-17T14:55:17'
...
# HB 4116 — 2026 Regular Session (2026R1)

## At a glance

- **Measure:** House Bill 4116, 2026 Regular Session (2026R1)
- **LC number:** 221
- **Created:** 2026-01-17T14:55:17
- **Metadata last modified (upstream):** 2026-04-13T08:35:02
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 7285 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4116/Enrolled>.
...
**RelatingToFull (verbatim upstream field):** Relating to consumer finance loans; and prescribing an effective date.
...
SECTION 3.
 ORS 725.370 is amended to read:
...
- From bill text (Enrolled version): ORS 706.008, ORS 725.015, ORS 725.045, ORS 725.120, ORS 725.185, ORS 725.370

## Provenance & related versions

- **Embedded full text:** Enrolled version, retrieved 2026-07-28, sha256 `1cf9d24e41138d2043a919547af2422397d06679639e721bb007e415a9b0bcaa` (snapshot `_meta/snapshots/measure-2026r1-hb4116-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4116/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `23cf1721d24dfaf89d1f128308f39af0e80f10fd191441998fed2071bbb0bbd1` (snapshot `_meta/snapshots/measure-2026r1-hb4116-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2026R1/Downloads/MeasureDocument/HB4116/Introduced>.
- **Measure metadata:** retrieved 2026-07-28 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2026R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 4116` (part of the batched per-session fetch), sha256 `24ae6bdc7627edf95bbe00a05a147417c7b8bb4753dc857212807a4403e9e192` of the shared session snapshot `_meta/snapshots/measures-2026r1.json`.

...
jurisdiction: oregon
id: measure-2023r1-sb906
title: 'SB 906 (2023R1): Removes restriction on distribution of Student Investment Account moneys to virtual
  public charter schools.'
doc_type: dataset_doc
citation: 2023 Regular Session Senate Bill 906
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB906/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 9601f448d0169a905bf95b9462027ce8d513ae016da6738fa1cb8e9a7096188b
snapshot_id: measure-2023r1-sb906-introduced
status: current
...
lc_number: 3390
measure_created_date: '2023-02-10T14:21:26'
measure_modified_date: '2023-03-06T09:06:34'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 10752
...
# SB 906 — 2023 Regular Session (2023R1)

## At a glance

- **Measure:** Senate Bill 906, 2023 Regular Session (2023R1)
- **LC number:** 3390
- **Created:** 2023-02-10T14:21:26
- **Metadata last modified (upstream):** 2023-03-06T09:06:34
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 10752 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB906/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `9601f448d0169a905bf95b9462027ce8d513ae016da6738fa1cb8e9a7096188b` (snapshot `_meta/snapshots/measure-2023r1-sb906-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB906/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 906` (part of the batched per-session fetch), sha256 `93fbdf58369388064230f7ba2c78bd17b78e15ffa1d19e5c25089297c647cbe1` of the shared session snapshot `_meta/snapshots/measures-2023r1.json`.

...
jurisdiction: oregon
id: measure-2023r1-sb260
title: 'SB 260 (2023R1): Establishes education savings account (ESA) program.'
doc_type: dataset_doc
citation: 2023 Regular Session Senate Bill 260
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB260/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 5bcc619e2a76d41746c9d2f2a7a3bb2775a9ed48ed637e6b54edbc7d4c999336
snapshot_id: measure-2023r1-sb260-introduced
status: current
...
lc_number: 719
measure_created_date: '2022-12-16T11:13:08'
...
# SB 260 — 2023 Regular Session (2023R1)

## At a glance

- **Measure:** Senate Bill 260, 2023 Regular Session (2023R1)
- **At the request of:** (at the request of Representative Kevin Mannix)
- **LC number:** 719
- **Created:** 2022-12-16T11:13:08
- **Metadata last modified (upstream):** 2023-01-19T09:27:12
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 37659 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB260/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `5bcc619e2a76d41746c9d2f2a7a3bb2775a9ed48ed637e6b54edbc7d4c999336` (snapshot `_meta/snapshots/measure-2023r1-sb260-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB260/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 260` (part of the batched per-session fetch), sha256 `93fbdf58369388064230f7ba2c78bd17b78e15ffa1d19e5c25089297c647cbe1` of the shared session snapshot `_meta/snapshots/measures-2023r1.json`.

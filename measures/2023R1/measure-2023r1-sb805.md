...
jurisdiction: oregon
id: measure-2023r1-sb805
title: 'SB 805 (2023R1): Directs Oregon Youth Authority to adopt rules for the use of staff interventions
  on adjudicated youth.'
doc_type: dataset_doc
citation: 2023 Regular Session Senate Bill 805
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB805/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 1c5776cdb475b37f0249255bd15ca6bbdfb193398b7e06ef329426dd1180ff01
snapshot_id: measure-2023r1-sb805-introduced
status: current
...
catch_line: Directs Oregon Youth Authority to adopt rules for the use of staff interventions on adjudicated
  youth.
minority_catch_line: null
measure_summary: "\tDirects Oregon Youth Authority to adopt rules for the use of staff interventions on\
  \ adjudicated youth. \n\tModifies definition of \"abuse\" for purposes of child abuse to include inappropriate\
  \ use of restraint or seclusion of youth in custody of authority or juvenile department. \n\tDeclares\
  \ emergency, effective on passage."
relating_to: Relating to prohibitions of certain treatments of youth in custody; declaring an emergency.
relating_to_full: Relating to prohibitions of certain treatments of youth in custody; creating new provisions;
  amending ORS 419B.005; and declaring an emergency.
at_the_request_of: null
lc_number: 1005
measure_created_date: '2023-01-25T12:47:06'
measure_modified_date: '2023-02-06T09:25:07'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 18108
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 805`.

# SB 805 — 2023 Regular Session (2023R1)

## At a glance

- **Measure:** Senate Bill 805, 2023 Regular Session (2023R1)
- **LC number:** 1005
- **Created:** 2023-01-25T12:47:06
- **Metadata last modified (upstream):** 2023-02-06T09:25:07
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 18108 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB805/Introduced>.

## Summary

**Catchline:** Directs Oregon Youth Authority to adopt rules for the use of staff interventions on adjudicated youth.

**Relating to:** Relating to prohibitions of certain treatments of youth in custody; declaring an emergency.

Directs Oregon Youth Authority to adopt rules for the use of staff interventions on adjudicated youth. 
 Modifies definition of "abuse" for purposes of child abuse to include inappropriate use of restraint or seclusion of youth in custody of authority or juvenile department. 
 Declares emergency, effective on passage.

**RelatingToFull (verbatim upstream field):** Relating to prohibitions of certain treatments of youth in custody; creating new provisions; amending ORS 419B.005; and declaring an emergency.
...
Directs Oregon Youth Authority to adopt rules for the use  of staff interventions on adjudicated
youth.
Modifies definition of “abuse” for purposes of child abuse to include inappropriate use  of re-
straint or seclusion of youth in custody of authority or juvenile department.
Declares emergency, effective on passage.
A BILL FOR AN ACT
Relating to prohibitions of certain treatments of youth in custody;  creating new provisions; amend-
ing ORS 419B.005; and declaring an emergency.
Be It Enacted by the People of the State of Oregon:
SECTION 1.
Section 2 of this 2023 Act is added to and made a part of ORS 420A.005 to
420A.155.
SECTION 2. The Oregon Youth Authority shall adopt  rules providing guidance and di-
rection on the use of staff interventions,  including physical interventions, isolation, re-
straints and time-outs, consistent with state and federal law.
...
(K) The use of  restraint or involuntary seclusion of a youth in custody in violation of
ORS 169.740, 169.750, 169.760, 419A.240 or 419A.245 or the use of interventions on  a youth in
custody in violation of the rules adopted under section 2 of this 2023 Act.
...
(7) “Youth in custody”  means a child in the physical custody of a county juvenile de-
partment or the Oregon Youth Authority.
SECTION 4.
...
partment or the Oregon Youth Authority.
SECTION 5.
Section 2 of this 2023 Act and the amendments to ORS 419B.005 by sections
3 and 4 of this 2023 Act apply to  incidents involving intervention or the use of restraint or
seclusion occurring on or after the effective date of this 2023 Act.
...
- From bill text (Introduced version): ORS 109.056, ORS 147.600, ORS 163.266, ORS 163.413, ORS 163.537, ORS 163.665, ORS 163.670, ORS 167.002, ORS 167.007, ORS 167.008, ORS 169.740, ORS 169.750, ORS 169.760, ORS 329A.030, ORS 329A.250, ORS 329A.255, ORS 341.005, ORS 352.002, ORS 352.121, ORS 410.600, ORS 418.205, ORS 418.351, ORS 419A.004, ORS 419A.240, ORS 419B.005, ORS 419B.020, ORS 420A.005, ORS 430.215, ORS 475.005, ORS 475C.009, ORS 609.500

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `1c5776cdb475b37f0249255bd15ca6bbdfb193398b7e06ef329426dd1180ff01` (snapshot `_meta/snapshots/measure-2023r1-sb805-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB805/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 805` (part of the batched per-session fetch), sha256 `93fbdf58369388064230f7ba2c78bd17b78e15ffa1d19e5c25089297c647cbe1` of the shared session snapshot `_meta/snapshots/measures-2023r1.json`.

...
jurisdiction: oregon
id: measure-2023r1-hb2694
title: 'HB 2694 (2023R1): Permits person who will be 17 years old on date of primary election and 18 years
...
citation: 2023 Regular Session House Bill 2694
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB2694/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: d4b517cb97c265b7a8f0c4fcdafcb182e4741fcb2d9c9fa47b058596aac7f293
snapshot_id: measure-2023r1-hb2694-introduced
status: current
...
lc_number: 3035
measure_created_date: '2022-12-22T22:00:39'
measure_modified_date: '2023-01-23T09:42:12'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 26464
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2694`.

# HB 2694 — 2023 Regular Session (2023R1)

## At a glance

- **Measure:** House Bill 2694, 2023 Regular Session (2023R1)
- **LC number:** 3035
- **Created:** 2022-12-22T22:00:39
- **Metadata last modified (upstream):** 2023-01-23T09:42:12
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 26464 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB2694/Introduced>.
...
(2)(a) Except as provided in paragraphs (b) to (d) of this subsection, the county clerk shall mail
...
before the date of the election.
(d) The county clerk is not required to mail  a secrecy envelope under this subsection if the
...
ated to  the Secretary of State, for the biennium beginning July 1, 2023, out of the General
...
6 and 7 of this 2023 Act.
SECTION 9. The amendments to ORS 247.016, 253.540, 253.565,  254.115, 254.365, 254.370 and
254.470 by sections 1 to  7 of this 2023 Act apply to primary elections held on or after the ef-
...
- From bill text (Introduced version): ORS 171.185, ORS 192.311, ORS 247.016, ORS 247.025, ORS 247.203, ORS 249.013, ORS 249.078, ORS 250.125, ORS 253.540, ORS 253.565, ORS 254.115, ORS 254.165, ORS 254.365, ORS 254.370, ORS 254.431, ORS 254.458, ORS 254.470, ORS 254.472, ORS 254.480

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `d4b517cb97c265b7a8f0c4fcdafcb182e4741fcb2d9c9fa47b058596aac7f293` (snapshot `_meta/snapshots/measure-2023r1-hb2694-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB2694/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2694` (part of the batched per-session fetch), sha256 `93fbdf58369388064230f7ba2c78bd17b78e15ffa1d19e5c25089297c647cbe1` of the shared session snapshot `_meta/snapshots/measures-2023r1.json`.

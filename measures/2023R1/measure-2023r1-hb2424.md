...
jurisdiction: oregon
id: measure-2023r1-hb2424
title: 'HB 2424 (2023R1): Requires Oregon Health Authority to establish grant program for purpose of making
...
citation: 2023 Regular Session House Bill 2424
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB2424/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 0d73ff9cc599b5bb75ffbb42efc6efe771b32aca3fca457f8beb8c64eee6530b
snapshot_id: measure-2023r1-hb2424-introduced
status: current
...
lc_number: 889
measure_created_date: '2022-12-19T13:42:58'
measure_modified_date: '2023-02-03T17:24:46'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 6671
...
# HB 2424 — 2023 Regular Session (2023R1)

## At a glance

- **Measure:** House Bill 2424, 2023 Regular Session (2023R1)
- **LC number:** 889
- **Created:** 2022-12-19T13:42:58
- **Metadata last modified (upstream):** 2023-02-03T17:24:46
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 6671 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB2424/Introduced>.
...
House Bill 2424
Sponsored by Representative BREESE-IVERSON; Representative DIEHL (Presession filed.)
SUMMARY
...
of this 2023 Act. Under the program, the authority shall make grants to entities:
...
purposes described in section 1 of this 2023 Act.
...
(1) For the biennium beginning July  1, 2023, the average amount of moneys per biennium
expended by the Oregon Health Authority on  reimbursing abortions as part of the state’s
medical assistance  program during the biennia beginning July 1, 2009, July 1, 2011, July 1,
2013, July 1, 2015, July 1, 2017, July 1, 2019, and July 1, 2021; and
(2) For each biennium subsequent to the biennium beginning on July 1, 2023:
...
SECTION 5.
This 2023 Act shall be submitted to the people for their  approval or rejection
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `0d73ff9cc599b5bb75ffbb42efc6efe771b32aca3fca457f8beb8c64eee6530b` (snapshot `_meta/snapshots/measure-2023r1-hb2424-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB2424/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2424` (part of the batched per-session fetch), sha256 `93fbdf58369388064230f7ba2c78bd17b78e15ffa1d19e5c25089297c647cbe1` of the shared session snapshot `_meta/snapshots/measures-2023r1.json`.

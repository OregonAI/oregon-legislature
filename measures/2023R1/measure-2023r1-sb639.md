...
jurisdiction: oregon
id: measure-2023r1-sb639
title: 'SB 639 (2023R1): Requires Department of Education to transfer funds to school districts necessary
  to pay for school resource officers.'
doc_type: dataset_doc
citation: 2023 Regular Session Senate Bill 639
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB639/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: b16678dcb6ea48981d52b98d5de3d6f88623cb559036c6e33724207e5284ad62
snapshot_id: measure-2023r1-sb639-introduced
status: current
...
measure_modified_date: '2023-04-18T16:46:36'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 8443
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 639`.

# SB 639 — 2023 Regular Session (2023R1)

## At a glance

- **Measure:** Senate Bill 639, 2023 Regular Session (2023R1)
- **LC number:** 3681
- **Created:** 2022-12-22T16:53:06
- **Metadata last modified (upstream):** 2023-04-18T16:46:36
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 8443 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB639/Introduced>.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `b16678dcb6ea48981d52b98d5de3d6f88623cb559036c6e33724207e5284ad62` (snapshot `_meta/snapshots/measure-2023r1-sb639-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB639/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 639` (part of the batched per-session fetch), sha256 `93fbdf58369388064230f7ba2c78bd17b78e15ffa1d19e5c25089297c647cbe1` of the shared session snapshot `_meta/snapshots/measures-2023r1.json`.

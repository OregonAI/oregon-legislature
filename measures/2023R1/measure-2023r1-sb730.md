...
jurisdiction: oregon
id: measure-2023r1-sb730
title: 'SB 730 (2023R1): Declares policy of state to use zero-based budgeting in developing biennial budget
  plan.'
doc_type: dataset_doc
citation: 2023 Regular Session Senate Bill 730
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB730/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 4cb45c2f0140956ae92abbdcdab51ad92ae88069c6d8ae6c3dddb08a009da381
snapshot_id: measure-2023r1-sb730-introduced
status: current
...
catch_line: Declares policy of state to use zero-based budgeting in developing biennial budget plan.
minority_catch_line: null
measure_summary: "\tDeclares policy of state to use zero-based budgeting in developing biennial budget\
  \ plan. \n\tRequires state agencies to include information justifying proposed expenditures in agency\
  \ request budgets filed with Oregon Department of Administrative Services. \n\tApplies to biennia beginning\
  \ on or after July 1, 2025."
relating_to: Relating to zero-based budgeting.
relating_to_full: Relating to zero-based budgeting.
at_the_request_of: null
lc_number: 2839
measure_created_date: '2022-12-23T10:51:59'
measure_modified_date: '2023-01-23T12:01:20'
...
# SB 730 — 2023 Regular Session (2023R1)

## At a glance

- **Measure:** Senate Bill 730, 2023 Regular Session (2023R1)
- **LC number:** 2839
- **Created:** 2022-12-23T10:51:59
- **Metadata last modified (upstream):** 2023-01-23T12:01:20
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 2811 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB730/Introduced>.

## Summary

**Catchline:** Declares policy of state to use zero-based budgeting in developing biennial budget plan.
...
Declares policy of state to use zero-based budgeting in developing biennial budget plan. 
 ...
 Applies to biennia beginning on or after July 1, 2025.

**RelatingToFull (verbatim upstream field):** Relating to zero-based budgeting.
...
quest budgets filed with Oregon Department of Administrative Services.
Applies to biennia beginning on or after July 1, 2025.
A BILL FOR AN ACT
Relating to zero-based budgeting.
Be It Enacted by the People of the State of Oregon:
SECTION 1.
Section 2 of this  2023 Act is added to and made a part of ORS 291.201 to
291.222.
...
SECTION 3.
Section 2 of this 2023 Act applies  to agency request budgets prepared for
...
- From bill text (Introduced version): ORS 291.201, ORS 291.208

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `4cb45c2f0140956ae92abbdcdab51ad92ae88069c6d8ae6c3dddb08a009da381` (snapshot `_meta/snapshots/measure-2023r1-sb730-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB730/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 730` (part of the batched per-session fetch), sha256 `93fbdf58369388064230f7ba2c78bd17b78e15ffa1d19e5c25089297c647cbe1` of the shared session snapshot `_meta/snapshots/measures-2023r1.json`.

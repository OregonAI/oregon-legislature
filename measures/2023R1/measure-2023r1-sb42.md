...
jurisdiction: oregon
id: measure-2023r1-sb42
title: 'SB 42 (2023R1): Modifies provisions relating to fiscal impact statements for administrative rules.'
doc_type: dataset_doc
citation: 2023 Regular Session Senate Bill 42
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB42/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: cee27c432d10a2938b5c25d59294c6a01b1ee997884d0f4cddcd44885003e3b4
snapshot_id: measure-2023r1-sb42-introduced
status: current
...
catch_line: Modifies provisions relating to fiscal impact statements for administrative rules.
minority_catch_line: null
measure_summary: "\tModifies provisions relating to fiscal impact statements for administrative rules.\
  \ \n\tRequires agencies to report to Legislative Fiscal Officer on fiscal impacts of administrative\
  \ rules as part of the process of presenting budget requests during each odd-numbered year regular session\
...
lc_number: 876
measure_created_date: '2022-12-09T15:27:37'
measure_modified_date: '2023-01-13T13:54:00'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 20031
...
# SB 42 — 2023 Regular Session (2023R1)

## At a glance

- **Measure:** Senate Bill 42, 2023 Regular Session (2023R1)
- **At the request of:** (at the request of Oregon Business and Industry)
- **LC number:** 876
- **Created:** 2022-12-09T15:27:37
- **Metadata last modified (upstream):** 2023-01-13T13:54:00
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 20031 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB42/Introduced>.

## Summary

**Catchline:** Modifies provisions relating to fiscal impact statements for administrative rules.

**Relating to:** Relating to administrative rules.

Modifies provisions relating to fiscal impact statements for administrative rules. 
 Requires agencies to report to Legislative Fiscal Officer on fiscal impacts of administrative rules as part of the process of presenting budget requests during each odd-numbered year regular session of Legislative Assembly.

**RelatingToFull (verbatim upstream field):** Relating to administrative rules; creating new provisions; and amending ORS 183.335.

## Full text

82nd OREGON LEGISLATIVE ASSEMBLY--2023 Regular Session
Senate Bill 42
Sponsored by Senator FINDLEY, Representative OWENS (at the request of Oregon Business and  Industry) (Pre-
session filed.)
SUMMARY
...
Modifies provisions relating to fiscal impact statements for administrative rules.
Requires agencies to report to Legislative Fiscal Officer on fiscal impacts of administrative rules
as part of the process of presenting budget requests during  each odd-numbered year regular session
of Legislative Assembly.
A BILL FOR AN ACT
Relating to administrative rules; creating new provisions; and amending ORS 183.335.
Be It Enacted by the People of the State of Oregon:
SECTION 1.
 ORS 183.335, as amended by section 6, chapter 97, Oregon Laws 2022, is  amended
to read:
...
include a cost of compliance effect on small businesses affected , and shall consider resultant job
loss and consumer cost impacts . For  an agency specified in ORS 183.530, the statement of fiscal
impact shall also  include a housing cost impact statement as described in ORS 183.534 . An agency
may not state that the fiscal impact of the adoption, amendment or repeal of a rule  is inde-
terminate if the rule is expected to have a total fiscal impact on  all parties that exceeds
$100,000;
...
(e) If requested by at least 10 persons or by an association having not less  than 10
members before the  earliest date that the rule could become effective after the giving of
notice pursuant to subsection (1) of this section, the  agency shall, before the rule becomes
effective, provide a third-party analysis of the fiscal impact of  the rule, as described in sub-
section (2)(b)(E)  of this section. The analysis required by this paragraph must be supported
by substantial evidence.
[(e)] (f) An agency  that receives data or views concerning proposed rules from interested per-
sons shall maintain a record of the data or views submitted. The record shall contain:
...
SECTION 2.
(1) As  used in this section, “agency” and “rule” have the meanings given
those terms in ORS 183.310.
(2) As part of the process of presenting budget  requests during each odd-numbered year
regular session of the Legislative Assembly, an agency  shall report to the Legislative Fiscal
Officer detailing the fiscal impact of rules adopted, amended or repealed by  the agency in the
current biennium. The report must describe rules adopted by the agency  that required or
caused:
(a) An increase in fees charged by the agency;
(b) Transfer of funds available to the agency of more than $50,000;
(c) Rededication of more than .5 full-time employees; or
(d) A need for new state resources in the next biennium of $100,000 or more.
SECTION 3.
The amendments to ORS 183.335 by section 1 of this 2023 Act apply to rules
for which notice of intended action is given on or after the effective date of this 2023 Act.

## Candidate ORS citations (not a finding — see PHASE5-MCP-SPEC.md §2.2)

`RelatingToFull` is a summary field, and a regex over the bill text is still mechanically derived, not a verified amend list. Both sets below are **candidates**, to be resolved against `oregon-policy-repo` in a later step (§5.7), never presented as the authoritative amend list.

- From `RelatingToFull`: ORS 183.335
- From bill text (Introduced version): ORS 183.310, ORS 183.333, ORS 183.335, ORS 183.341, ORS 183.355, ORS 183.360, ORS 183.530, ORS 183.534, ORS 183.715, ORS 279.835

## Provenance & related versions

- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `cee27c432d10a2938b5c25d59294c6a01b1ee997884d0f4cddcd44885003e3b4` (snapshot `_meta/snapshots/measure-2023r1-sb42-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/SB42/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'SB' and MeasureNumber eq 42` (part of the batched per-session fetch), sha256 `93fbdf58369388064230f7ba2c78bd17b78e15ffa1d19e5c25089297c647cbe1` of the shared session snapshot `_meta/snapshots/measures-2023r1.json`.

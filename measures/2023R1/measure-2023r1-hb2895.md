...
jurisdiction: oregon
id: measure-2023r1-hb2895
title: 'HB 2895 (2023R1): Removes cap on amounts distributed from State School Fund to school districts
  for students eligible for special education as children with disabilities.'
doc_type: dataset_doc
citation: 2023 Regular Session House Bill 2895
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB2895/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 7776f45ee55ef4c47c200077358f224dddaa22b06a58fed1e169550e7d9ae5e6
snapshot_id: measure-2023r1-hb2895-introduced
status: current
...
catch_line: Removes cap on amounts distributed from State School Fund to school districts for students
  eligible for special education as children with disabilities.
minority_catch_line: null
measure_summary: "\tRemoves cap on amounts distributed from State School Fund to school districts for\
  \ students eligible for special education as children with disabilities. \n\tProvides additional weight\
  \ for students who are homeless for purposes of calculating distributions of State School Fund moneys\
  \ to school districts. Specifies that Department of Education will collect information related to homeless\
...
lc_number: 2978
measure_created_date: '2022-12-27T11:17:26'
...
# HB 2895 — 2023 Regular Session (2023R1)

## At a glance

- **Measure:** House Bill 2895, 2023 Regular Session (2023R1)
- **LC number:** 2978
- **Created:** 2022-12-27T11:17:26
- **Metadata last modified (upstream):** 2023-04-04T09:15:16
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 7732 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB2895/Introduced>.

## Summary

**Catchline:** Removes cap on amounts distributed from State School Fund to school districts for students eligible for special education as children with disabilities.

**Relating to:** Relating to State School Fund distributions; declaring an emergency.
...
**RelatingToFull (verbatim upstream field):** Relating to State School Fund distributions; creating new provisions; amending ORS 327.013; and declaring an emergency.
...
Removes cap on amounts distributed from State School Fund to school districts for  students el-
igible for special education as children with disabilities.
Provides additional weight for students who  are homeless for purposes of calculating distrib-
utions of State School Fund moneys to school districts. Specifies that Department of  Education will
collect information related to homeless students.
Declares emergency, effective July 1, 2023.
A BILL FOR AN ACT
...
under rules adopted by the State Board of Education based on standards adopted by the De-
partment of Human Services and based  on information collected by the Department of Edu-
cation related to homeless students.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `7776f45ee55ef4c47c200077358f224dddaa22b06a58fed1e169550e7d9ae5e6` (snapshot `_meta/snapshots/measure-2023r1-hb2895-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB2895/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2895` (part of the batched per-session fetch), sha256 `93fbdf58369388064230f7ba2c78bd17b78e15ffa1d19e5c25089297c647cbe1` of the shared session snapshot `_meta/snapshots/measures-2023r1.json`.

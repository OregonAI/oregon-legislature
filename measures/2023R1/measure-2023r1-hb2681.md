...
jurisdiction: oregon
id: measure-2023r1-hb2681
title: 'HB 2681 (2023R1): Removes restriction on distribution of Student Investment Account moneys to
  virtual public charter schools.'
doc_type: dataset_doc
citation: 2023 Regular Session House Bill 2681
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB2681/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: fb9479cdb0a0d0f1ab47b349ac3890bbbdabf606c11ac40125151f67f876f31e
snapshot_id: measure-2023r1-hb2681-introduced
status: current
...
relating_to: Relating to moneys available to virtual public charter schools.
relating_to_full: Relating to moneys available to virtual public charter schools; amending ORS 327.185
  and 327.195.
at_the_request_of: (at the request of Baker Charter Schools)
lc_number: 945
measure_created_date: '2022-12-22T20:57:00'
measure_modified_date: '2023-01-23T09:41:34'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 10922
...
# HB 2681 — 2023 Regular Session (2023R1)

## At a glance

- **Measure:** House Bill 2681, 2023 Regular Session (2023R1)
- **At the request of:** (at the request of Baker Charter Schools)
- **LC number:** 945
- **Created:** 2022-12-22T20:57:00
- **Metadata last modified (upstream):** 2023-01-23T09:41:34
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 10922 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB2681/Introduced>.

## Summary

**Catchline:** Removes restriction on distribution of Student Investment Account moneys to virtual public charter schools.

**Relating to:** Relating to moneys available to virtual public charter schools.

Removes restriction on distribution of Student Investment Account moneys to virtual public charter schools.

**RelatingToFull (verbatim upstream field):** Relating to moneys available to virtual public charter schools; amending ORS 327.185 and 327.195.

## Full text

82nd OREGON LEGISLATIVE ASSEMBLY--2023 Regular Session
House Bill 2681
Sponsored by Representative OWENS, Senator  FINDLEY, Representative DIEHL; Representatives HIEB, LEWIS,
MORGAN, SCHARF, WRIGHT, Senator WEBER (at the request of Public Affairs Counsel) (Presession filed.)
SUMMARY
...
charter schools.
A BILL FOR AN ACT
Relating to moneys available to virtual public charter schools; amending ORS 327.185 and 327.195.
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `fb9479cdb0a0d0f1ab47b349ac3890bbbdabf606c11ac40125151f67f876f31e` (snapshot `_meta/snapshots/measure-2023r1-hb2681-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB2681/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 2681` (part of the batched per-session fetch), sha256 `93fbdf58369388064230f7ba2c78bd17b78e15ffa1d19e5c25089297c647cbe1` of the shared session snapshot `_meta/snapshots/measures-2023r1.json`.

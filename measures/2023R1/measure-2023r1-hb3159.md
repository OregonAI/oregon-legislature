...
jurisdiction: oregon
id: measure-2023r1-hb3159
title: 'HB 3159 (2023R1): Increases state transient lodging tax.'
doc_type: dataset_doc
citation: 2023 Regular Session House Bill 3159
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB3159/Introduced
source_format: pdf
retrieved: '2026-07-27'
source_sha256: a9f8f9c23b6b49abe3f452eee1974b19f75da0d199f985bfcd7e0225830c19a4
snapshot_id: measure-2023r1-hb3159-introduced
status: current
...
catch_line: Increases state transient lodging tax.
minority_catch_line: null
measure_summary: "\tIncreases state transient lodging tax. Changes name of Oregon Conservation Strategy\
  \ Subaccount to Recovering Oregon's Wildlife Fund Subaccount. Transfers moneys attributable to increase\
  \ of state transient lodging tax to Recovering Oregon's Wildlife Fund Subaccount. \n\tTakes effect on\
...
relating_to_full: Relating to funding to support species conservation; creating new provisions; amending
  ORS 320.305, 320.335, 496.303 and 496.571; prescribing an effective date; and providing for revenue
  raising that requires approval by a three-fifths majority.
at_the_request_of: null
lc_number: 2584
measure_created_date: '2023-01-25T12:04:16'
measure_modified_date: '2023-02-06T09:34:59'
bill_text_versions_available:
- Introduced
bill_text_versions_captured:
- Introduced
bill_text_embedded_version: Introduced
bill_text_chars: 16664
...
# HB 3159 — 2023 Regular Session (2023R1)

## At a glance

- **Measure:** House Bill 3159, 2023 Regular Session (2023R1)
- **LC number:** 2584
- **Created:** 2023-01-25T12:04:16
- **Metadata last modified (upstream):** 2023-02-06T09:34:59
- **Introduced/Enrolled documents on file:** Introduced
- **Full text below:** Introduced version, 16664 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB3159/Introduced>.

## Summary

**Catchline:** Increases state transient lodging tax.
...
Increases state transient lodging tax. Changes name of Oregon Conservation Strategy Subaccount to Recovering Oregon's Wildlife Fund Subaccount. Transfers moneys attributable to increase of state transient lodging tax to Recovering Oregon's Wildlife Fund Subaccount. 
 Takes effect on 91st day following adjournment sine die.

**RelatingToFull (verbatim upstream field):** Relating to funding to support species conservation; creating new provisions; amending ORS 320.305, 320.335, 496.303 and 496.571; prescribing an effective date; and providing for revenue raising that requires approval by a three-fifths majority.

## Full text

82nd OREGON LEGISLATIVE ASSEMBLY--2023 Regular Session
House Bill 3159
Sponsored by Representative HELM; Representatives GAMBA, HUDSON, Senators DEMBROW, GORSEK
SUMMARY
The following summary  is not prepared by the sponsors of the measure and is not a part of the body thereof subject
to consideration by  the Legislative Assembly. It is an editor’s brief statement of the essential features of the
measure as introduced.
Increases state transient lodging tax. Changes name  of Oregon Conservation Strategy Subac-
count to Recovering Oregon’s Wildlife Fund Subaccount. Transfers moneys  attributable to increase
of state transient lodging tax to Recovering Oregon’s Wildlife Fund Subaccount.
Takes effect on 91st day following adjournment sine die.
A BILL FOR AN ACT
...
Whereas population growth, development, climate change and  other natural and manmade im-
...
320.305. (1)(a) A tax of [ 1.5] 3  percent  is imposed on any consideration charged for the sale,
...
this subsection are continuously appropriated to the [ Oregon Tourism Commission ] commission  for
the purposes set forth in ORS 284.131.
(3) Moneys received from the state transient lodging tax imposed under ORS  320.305 at
a rate in excess of 1.5 percent shall be transferred to the subaccount  of the Fish and Wildlife
Account established under ORS 496.303 (13). The moneys transferred  under this subsection
are continuously  appropriated to the department for the purposes set forth in ORS 496.303
(13).
SECTION 3.  ORS 496.303, as amended by section 8, chapter 56, Oregon Laws 2022, is  amended
to read:
...
(13) The [ Oregon Conservation Strategy ] Recovering Oregon’s Wildlife Fund  Subaccount is
established in the Fish and Wildlife Account.
(a) The subaccount shall consist of:
...
(c) of  this subsection that are received by the State Department of Fish and Wildlife from
any public or private source and  caused to be deposited in the subaccount or otherwise
transferred to the subaccount.
(b) Interest earnings on moneys in the subaccount shall be credited to the subaccount.
...
those policies, as determined by the State Department of Fish and Wildlife; and
...
and the habitats essential to conservation of those species,  as determined by the State De-
...
under ORS 496.571.
[All moneys received by the commission from the sale of habitat  conservation stamps and from the
sale of any art works and prints  related to the habitat conservation stamp shall be deposited in the
subaccount. Moneys in the subaccount may be expended  only to promote and implement habitat and
species restoration,  enhancement and viewing activities identified in the “Oregon Conservation
Strategy,” 2006, by the State Department of Fish and Wildlife, and for activities  related to the design,
production, issuance and arrangements for sale of the habitat conservation  stamps and related art
works and prints. ]
...
SECTION 5. The amendments to ORS 320.305 and 320.335 by sections 1 and 2 of this 2023
Act apply to consideration charged on or after January 1, 2024, for the sale, service or fur-
...
- From `RelatingToFull`: ORS 320.305, ORS 320.335, ORS 496.303, ORS 496.571
...
- **Embedded full text:** Introduced version, retrieved 2026-07-27, sha256 `a9f8f9c23b6b49abe3f452eee1974b19f75da0d199f985bfcd7e0225830c19a4` (snapshot `_meta/snapshots/measure-2023r1-hb3159-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2023R1/Downloads/MeasureDocument/HB3159/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2023R1' and MeasurePrefix eq 'HB' and MeasureNumber eq 3159` (part of the batched per-session fetch), sha256 `93fbdf58369388064230f7ba2c78bd17b78e15ffa1d19e5c25089297c647cbe1` of the shared session snapshot `_meta/snapshots/measures-2023r1.json`.

...
jurisdiction: oregon
id: measure-2021s2-sb5561
title: 'SB 5561 (2021S2): Appropriates moneys from General Fund to specified state agencies for specified
  expenses.'
doc_type: dataset_doc
citation: 2021 2nd Special Session Senate Bill 5561
issuing_body: Oregon State Legislature
source_url: https://olis.oregonlegislature.gov/liz/2021S2/Downloads/MeasureDocument/SB5561/Enrolled
source_format: pdf
retrieved: '2026-07-27'
source_sha256: 41dfb234f0334da7188d8de3e5c5022177855fda4e74feb022fe6581111eb561
snapshot_id: measure-2021s2-sb5561-enrolled
status: current
...
catch_line: Appropriates moneys from General Fund to specified state agencies for specified expenses.
minority_catch_line: null
measure_summary: "\tAppropriates moneys from General Fund to specified state agencies for specified expenses.\
...
lc_number: 6
measure_created_date: '2021-12-12T08:25:40'
measure_modified_date: '2021-12-17T10:13:28'
...
> **NON-AUTHORITATIVE — AI-friendly reference only.** This is a mirrored copy of one measure's metadata (and, where captured, its bill text) from the Oregon Legislature's OData feed. It is a point-in-time snapshot, retrieved 2026-07-27 — **not** the measure's current status. For current location, history, or votes, this corpus's live proxy tools (not yet built — PHASE5-MCP-SPEC.md step 5) must be used instead of anything in this file. Official record: `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2021S2' and MeasurePrefix eq 'SB' and MeasureNumber eq 5561`.

# SB 5561 — 2021 2nd Special Session (2021S2)

## At a glance

- **Measure:** Senate Bill 5561, 2021 2nd Special Session (2021S2)
- **LC number:** 6
- **Created:** 2021-12-12T08:25:40
- **Metadata last modified (upstream):** 2021-12-17T10:13:28
- **Introduced/Enrolled documents on file:** Enrolled, Introduced
- **Full text below:** Enrolled version, 19929 chars extracted from the source PDF; page furniture (left-margin line numbers, the running bill-number header/footer) mechanically stripped -- see `clean_bill_text` in `src/ingest_measures.py`. Source: <https://olis.oregonlegislature.gov/liz/2021S2/Downloads/MeasureDocument/SB5561/Enrolled>.

## Summary

**Catchline:** Appropriates moneys from General Fund to specified state agencies for specified expenses.
...
Disaster Relief Fund established  under section 5, chapter 
, Oregon Laws 2021 (second
special session) (Enrolled Senate Bill 892).
...
Passed by Senate December 13, 2021
..................................................................................
...
- **Embedded full text:** Enrolled version, retrieved 2026-07-27, sha256 `41dfb234f0334da7188d8de3e5c5022177855fda4e74feb022fe6581111eb561` (snapshot `_meta/snapshots/measure-2021s2-sb5561-enrolled.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2021S2/Downloads/MeasureDocument/SB5561/Enrolled>.
- **Also captured, not embedded:** Introduced version, sha256 `a1f18f482d420ca7f80abb5d9dc2d3d2ca00f310450a9c819f9f876f44c51549` (snapshot `_meta/snapshots/measure-2021s2-sb5561-introduced.pdf`). Source: <https://olis.oregonlegislature.gov/liz/2021S2/Downloads/MeasureDocument/SB5561/Introduced>.
- **Measure metadata:** retrieved 2026-07-27 via `https://api.oregonlegislature.gov/odata/odataservice.svc/Measures?$filter=SessionKey eq '2021S2' and MeasurePrefix eq 'SB' and MeasureNumber eq 5561` (part of the batched per-session fetch), sha256 `8aca956913b06b7c7ad482674f3c719f626308ce1223fb9b20d0c38d0a53edbb` of the shared session snapshot `_meta/snapshots/measures-2021s2.json`.
